...
Install [alsa-utils](https://www.archlinux.org/packages/?name=alsa-utils). Run `alsamixer`, select the "HDA Intel PCH" sound card, and adjust the "Headphone" slider to your liking. To make this persistent you may need to run `sudo alsactl store`.
This page assumes that you will be using it for additional reference to [Installation guide](/index.php/Installation_guide "Installation guide") and [Acer Aspire One](/index.php/Acer_Aspire_One "Acer Aspire One"). Note that this netbook does **not** come with Recovery CDs.

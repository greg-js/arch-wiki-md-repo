...
| [intel-compute-runtime](https://www.archlinux.org/packages/?name=intel-compute-runtime) | For OpenCL CPU support |
...
The device is `Bus 001 Device 005: ID 06cb:0081 Synaptics, Inc.` Nether [fprint](https://www.archlinux.org/groups/x86_64/fprint/) nor [thinkfinger](https://aur.archlinux.org/packages/thinkfinger/) work, but there is a prototype driver [here](https://github.com/nmikhailov/Validity90).

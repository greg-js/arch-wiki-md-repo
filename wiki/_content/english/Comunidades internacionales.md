[https://archlinux.org](https://archlinux.org) es la dirección web del sitio oficial de Arch Linux, el foro y la wiki. Sin embargo varios sitios comunitarios y no oficiales están disponibles para usuarios internacionales que prefieren comunicarse en su propio idioma. Puede encontrar un lista de estas comunidades a continuación. Tenga en cuenta que la wiki oficial también admite contenido internacional. Además, tenemos foros internacionales donde puede escribir en su lengua nativa. Estás herramientas pueden ser utilizadas en paralelo como parte de las comunidades enumeradas a continuación.

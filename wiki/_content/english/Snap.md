...
Both Gnome Software Center and KDE Discover can provide native snap support. For KDE Discover install [discover-snap](https://aur.archlinux.org/packages/discover-snap/) package.

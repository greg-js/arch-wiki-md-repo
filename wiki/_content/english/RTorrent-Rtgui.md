[rtGui](https://code.google.com/archive/p/rtgui/) is a web based front end for rTorrent - the Linux command line BitTorrent client. It is written in PHP and uses XML-RPC to communicate with the rTorrent client.

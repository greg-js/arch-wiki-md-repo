...
An Arch package is no more than a tar archive, or 'tarball', compressed using [xz](https://tukaani.org/xz/), which contains the following files generated by makepkg:

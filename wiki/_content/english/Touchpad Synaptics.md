...
*   [2 Configuration](#Configuration)
    ...
    *   [2.3 Xfce4/Cinnamon](#Xfce4/Cinnamon)
    *   [2.4 MATE](#MATE)
*   [3 Advanced configuration](#Advanced_configuration)
    ...
    *   [3.8 Disable touchpad while typing](#Disable_touchpad_while_typing)
        *   [3.8.1 Using the driver's automatic palm detection](#Using_the_driver's_automatic_palm_detection)
    ...
    *   [3.10 Buttonless touchpads (aka ClickPads)](#Buttonless_touchpads_(aka_ClickPads))
...
*   [4 Troubleshooting](#Troubleshooting)
    ...
    *   [4.7 Touchpad device is not located at /dev/input/*](#Touchpad_device_is_not_located_at_/dev/input/*)
    ...
    *   [4.13 Xorg.log.0 shows SynPS/2 Synaptics touchpad can not grab event device, errno=16](#Xorg.log.0_shows_SynPS/2_Synaptics_touchpad_can_not_grab_event_device,_errno=16)
...
*   **[Synclient](#Synclient)** — command line utility to configure and query Synaptics driver settings
...
*   **[xinput](#Using_xinput_to_determine_touchpad_capabilities)** — general-purpose utility to configure X input devices
...
Use `xinput list-props "SynPS/2 Synaptics TouchPad"` to list all device properties. See [synaptics(4)](https://jlk.fjfi.cvut.cz/arch/manpages/man/synaptics.4) for full documentation of the Synaptics properties.

### Synclient

Synclient can configure every option available to the user as documented in [synaptics(4)](https://jlk.fjfi.cvut.cz/arch/manpages/man/synaptics.4). A full list of the current user settings can be brought up:
...
The format for the SoftButtonAreas option is (from [synaptics(4)](https://jlk.fjfi.cvut.cz/arch/manpages/man/synaptics.4)):

...
*   [3 Other options](#Other_options)
    ...
    *   [3.3 Shutdown, reboot, suspend, exit, launch terminal from SLiM](#Shutdown,_reboot,_suspend,_exit,_launch_terminal_from_SLiM)
    ...
    *   [3.12 Automatically mount your encrypted /home on login](#Automatically_mount_your_encrypted_/home_on_login)

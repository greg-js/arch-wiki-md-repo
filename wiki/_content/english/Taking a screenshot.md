...
**Note:** According to [this thread](http://comments.gmane.org/gmane.comp.misc.suckless/6901), `scrot -s` does not work with [dwm](https://www.archlinux.org/packages/?name=dwm).

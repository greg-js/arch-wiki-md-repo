...
*   [1 Fans](#Fans)
*   [2 Using multiple monitors with NVIDIA-Optimus](#Using_multiple_monitors_with_NVIDIA-Optimus)
    *   [2.1 Example X.org-Configuration using Intel and NVIDIA together](#Example_X.org-Configuration_using_Intel_and_NVIDIA_together)
...
To make sound work, make sure all channels are unmuted via alsamixer or similar, and configure the snd-hda-intel module to load specifically for a thinkpad.
 ...
 `/etc/modprobe.d/modprobe.conf`  `options snd-hda-intel model=thinkpad` 

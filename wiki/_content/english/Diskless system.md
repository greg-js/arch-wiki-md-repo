...
The [mkinitcpio-nbd](https://aur.archlinux.org/packages/mkinitcpio-nbd/) package needs to be installed on the client. Build it with [makepkg](/index.php/Makepkg "Makepkg") and install it:
...
PXELINUX is provided by [syslinux](https://www.archlinux.org/packages/?name=syslinux), see [PXELINUX](/index.php/PXELINUX "PXELINUX") for details.

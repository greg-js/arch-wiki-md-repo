...
[install](/index.php/Install "Install") the [icewm](https://www.archlinux.org/packages/?name=icewm) package.

A forked version of IceWM exists on [GitHub](https://github.com/bbidulock/icewm). It can be installed with [icewm2](https://aur.archlinux.org/packages/icewm2/) or [icewm-git](https://aur.archlinux.org/packages/icewm-git/).
...
*   [IceWM - A desktop for Windows emigrants](https://web.archive.org/web/20100613011705/http://polishlinux.org/apps/window-managers/icewm-a-desktop-for-windows-emmigrants/) - Overview and tutorial from polishlinux.org
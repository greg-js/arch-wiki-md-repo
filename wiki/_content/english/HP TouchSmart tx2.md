...
*   [2 Configuration details](#Configuration_details)
    ...
    *   [2.5 Audio](#Audio)
    *   [2.6 VGA](#VGA)
    *   [2.7 SmartCard Reader](#SmartCard_Reader)
    *   [2.8 Webcam](#Webcam)
    *   [2.9 Modem](#Modem)
    *   [2.10 Input](#Input)
        *   [2.10.1 Keyboard](#Keyboard)
        *   [2.10.2 Touchpad](#Touchpad)
        *   [2.10.3 Stylus](#Stylus)
        *   [2.10.4 Remote](#Remote)
        *   [2.10.5 Fingerprint Scanner](#Fingerprint_Scanner)
...
currently the touch screen works with the drivers from the [xf86-input-synaptics](https://www.archlinux.org/packages/?name=xf86-input-synaptics) package from the repos. To set up amazing multitouch functionality, see [Touchpad Synaptics](/index.php/Touchpad_Synaptics "Touchpad Synaptics").
...
edited from [http://ubuntuforums.org/showthread.php?t=1038898](http://ubuntuforums.org/showthread.php?t=1038898)

driver installed: [xf86-video-ati](https://www.archlinux.org/packages/?name=xf86-video-ati). See [ATI](/index.php/ATI "ATI")
...
works. see [ALSA](/index.php/ALSA "ALSA")

### VGA

Follow instructions in the [ATI](/index.php/ATI "ATI") wiki page.
...
works. followed setup as in [Webcam](/index.php/Webcam "Webcam") tested using:
...
Not tested yet. Chances are you probably won't need this. Add some info if you find out how to set this up!
...
*   [nema.arpit getting Ntrig to work in arch](https://bbs.archlinux.org/viewtopic.php?id=66596%7C)
...
*   Doesn't work by default: Power, DVD, Play, Stop, Forward, Backward, previous, next, up, info, ok?
*   Update coming soon. ;) [Trusktr](/index.php/User:Trusktr "User:Trusktr") 03:07, 2 May 2011 (EDT)
...
*   [Gentoo forums - HP tx2z touchsmart](http://forums.gentoo.org/viewtopic-t-776327.html?sid=0b3055ce10370bde5b137bd15a4bed82%7C)
*   [HOWTO setting up Ubuntu 8.10 intrepid on the HP tx2z tablet PC](http://ubuntuforums.org/showthread.php?t=1038898%7C)

...
*   [25 Hack 'n' Slash](#Hack_.27n.27_Slash)
    *   [25.1 Troubleshooting](#Troubleshooting_10)
        *   [25.1.1 The game starts but craches when loading a new or saved game](#The_game_starts_but_craches_when_loading_a_new_or_saved_game)
*   [26 Hacker Evolution [Untold, Duality]](#Hacker_Evolution_.5BUntold.2C_Duality.5D)
    *   [26.1 Dependencies](#Dependencies_11)
*   [27 Half-Life 2 & episodes](#Half-Life_2_.26_episodes)
    *   [27.1 Cyrillic fonts problem](#Cyrillic_fonts_problem)
*   [28 Hammerwatch](#Hammerwatch)
    *   [28.1 Troubleshooting](#Troubleshooting_11)
        *   [28.1.1 The game not starting from Steam GUI](#The_game_not_starting_from_Steam_GUI)
        *   [28.1.2 No sound](#No_sound_3)
*   [29 Harvest: Massive Encounter](#Harvest:_Massive_Encounter)
    *   [29.1 Dependencies](#Dependencies_12)
    *   [29.2 Compatibility](#Compatibility_4)
*   [30 Hatoful Boyfriend](#Hatoful_Boyfriend)
    *   [30.1 Japanese text invisible](#Japanese_text_invisible)
*   [31 The inner world](#The_inner_world)
    *   [31.1 Bringing up the inventory or main menu](#Bringing_up_the_inventory_or_main_menu)
    *   [31.2 Dependencies](#Dependencies_13)
        *   [31.2.1 Sound support](#Sound_support)
        *   [31.2.2 Cutscenes](#Cutscenes)
*   [32 Interloper](#Interloper)
    *   [32.1 Dependencies](#Dependencies_14)
    *   [32.2 Game does not launch](#Game_does_not_launch)
*   [33 Invisible Apartment](#Invisible_Apartment)
    *   [33.1 Dependencies](#Dependencies_15)
    *   [33.2 Game does not run](#Game_does_not_run)
*   [34 Joe Danger 2: The Movie](#Joe_Danger_2:_The_Movie)
    *   [34.1 Dependencies](#Dependencies_16)
    *   [34.2 Compatibility](#Compatibility_5)
*   [35 Kerbal Space Program](#Kerbal_Space_Program)
    *   [35.1 Troubleshooting](#Troubleshooting_12)
    *   [35.2 Game never progresses past initial loading](#Game_never_progresses_past_initial_loading)
    *   [35.3 No text display](#No_text_display)
    *   [35.4 Graphics flickering when using primusrun](#Graphics_flickering_when_using_primusrun)
    *   [35.5 Game crashes when accessing settings or saves on 64 bit systems on Steam](#Game_crashes_when_accessing_settings_or_saves_on_64_bit_systems_on_Steam)
    *   [35.6 Locale settings](#Locale_settings)
    *   [35.7 No audio on 64-bit systems](#No_audio_on_64-bit_systems)
    *   [35.8 Black ingame textures](#Black_ingame_textures)
    *   [35.9 See also](#See_also)
*   [36 Killing Floor](#Killing_Floor)
    *   [36.1 Troubleshooting](#Troubleshooting_13)
        *   [36.1.1 Screen resolution](#Screen_resolution)
        *   [36.1.2 Windowed mode](#Windowed_mode)
        *   [36.1.3 Stuttering Sound](#Stuttering_Sound)
*   [37 Lethal League](#Lethal_League)
    *   [37.1 Dependencies](#Dependencies_17)
*   [38 Metro: Last Light](#Metro:_Last_Light)
    *   [38.1 Attempted fixes](#Attempted_fixes)
    *   [38.2 Hacky solution](#Hacky_solution)
    *   [38.3 Possible solutions](#Possible_solutions)
*   [39 Mark of the Ninja](#Mark_of_the_Ninja)
    *   [39.1 Troubleshooting](#Troubleshooting_14)
...
*   [42 Penumbra: Overture](#Penumbra:_Overture)
    ...
    *   [42.2 Troubleshooting](#Troubleshooting_15)
        *   [42.2.1 Windowed mode](#Windowed_mode_2)
*   [43 Portal 2](#Portal_2)
    *   [43.1 Troubleshooting](#Troubleshooting_16)
        *   [43.1.1 Game does not start](#Game_does_not_start_6)
*   [44 Prison Architect](#Prison_Architect)
    *   [44.1 Troubleshooting](#Troubleshooting_17)
        *   [44.1.1 ALSA error when using PulseAudio](#ALSA_error_when_using_PulseAudio)
*   [45 Project Zomboid](#Project_Zomboid)
    *   [45.1 Dependencies](#Dependencies_20)
    *   [45.2 No sound](#No_sound_5)
*   [46 Redshirt](#Redshirt)
    *   [46.1 Dependencies (x86_64)](#Dependencies_.28x86_64.29_3)
*   [47 Revenge of the Titans](#Revenge_of_the_Titans)
    *   [47.1 Dependencies](#Dependencies_21)
*   [48 Rock Boshers DX: Directors Cut](#Rock_Boshers_DX:_Directors_Cut)
    *   [48.1 Dependencies](#Dependencies_22)
*   [49 Serious Sam 3: BFE](#Serious_Sam_3:_BFE)
    *   [49.1 Dependencies](#Dependencies_23)
    *   [49.2 Troubleshooting](#Troubleshooting_18)
        *   [49.2.1 No audio](#No_audio_2)
*   [50 Sir, you are being hunted](#Sir.2C_you_are_being_hunted)
    *   [50.1 Dependencies](#Dependencies_24)
*   [51 Spacechem](#Spacechem)
    *   [51.1 Dependencies](#Dependencies_25)
    *   [51.2 Troubleshooting](#Troubleshooting_19)
        *   [51.2.1 Game crash](#Game_crash)
*   [52 Space Pirates and Zombies](#Space_Pirates_and_Zombies)
    *   [52.1 Dependencies](#Dependencies_26)
    *   [52.2 Troubleshooting](#Troubleshooting_20)
        *   [52.2.1 No audio](#No_audio_3)
*   [53 Splice](#Splice)
    *   [53.1 Dependencies](#Dependencies_27)
*   [54 Steel Storm: Burning Retribution](#Steel_Storm:_Burning_Retribution)
    *   [54.1 Troubleshooting](#Troubleshooting_21)
        *   [54.1.1 Start with black screen](#Start_with_black_screen)
        *   [54.1.2 No English fonts](#No_English_fonts)
*   [55 Strike Suite Zero](#Strike_Suite_Zero)
    *   [55.1 Dependencies](#Dependencies_28)
*   [56 Superbrothers: Sword & Sworcery EP](#Superbrothers:_Sword_.26_Sworcery_EP)
    *   [56.1 Dependencies](#Dependencies_29)
*   [57 Team Fortress 2](#Team_Fortress_2)
    *   [57.1 Dependencies](#Dependencies_30)
    *   [57.2 Making HRTF work](#Making_HRTF_work)
    *   [57.3 Troubleshooting](#Troubleshooting_22)
...
*   [60 The Book of Unwritten Tales: The Critter Chronicles](#The_Book_of_Unwritten_Tales:_The_Critter_Chronicles)
*   [61 The Clockwork Man](#The_Clockwork_Man)
...
*   [62 The Polynomial](#The_Polynomial)
    ...
    *   [62.2 Troubleshooting](#Troubleshooting_23)
        *   [62.2.1 Segfaults during program start on 64-bit systems](#Segfaults_during_program_start_on_64-bit_systems)
*   [63 This War of Mine](#This_War_of_Mine)
    *   [63.1 Troubleshooting](#Troubleshooting_24)
        *   [63.1.1 Game doesn't load](#Game_doesn.27t_load)
*   [64 Towns / Towns Demo](#Towns_.2F_Towns_Demo)
    *   [64.1 Crash on launch](#Crash_on_launch)
*   [65 Transistor](#Transistor)
    *   [65.1 Crash on launch / FMOD binding crash / Audio issues](#Crash_on_launch_.2F_FMOD_binding_crash_.2F_Audio_issues)
*   [66 Trine 2](#Trine_2)
    *   [66.1 Dependencies](#Dependencies_34)
    *   [66.2 Troubleshooting](#Troubleshooting_25)
*   [67 Unity3D](#Unity3D)
    *   [67.1 Locale Settings](#Locale_Settings_2)
    *   [67.2 Unity 5 and PulseAudio](#Unity_5_and_PulseAudio)
*   [68 Unity of Command](#Unity_of_Command)
    *   [68.1 Dependencies](#Dependencies_35)
    *   [68.2 Troubleshooting](#Troubleshooting_26)
        *   [68.2.1 No audio](#No_audio_5)
*   [69 Unrest](#Unrest)
    *   [69.1 Dependencies](#Dependencies_36)
*   [70 War Thunder](#War_Thunder)
    *   [70.1 Troubleshooting](#Troubleshooting_27)
*   [71 Witcher 2: Assassin of Kings](#Witcher_2:_Assassin_of_Kings)
    *   [71.1 Dependencies](#Dependencies_37)
    *   [71.2 Troubleshooting](#Troubleshooting_28)
*   [72 Wizardry 6: Bane of the Cosmic Forge](#Wizardry_6:_Bane_of_the_Cosmic_Forge)
    *   [72.1 Dependencies](#Dependencies_38)
*   [73 World of Goo](#World_of_Goo)
    *   [73.1 Changing resolution](#Changing_resolution)
*   [74 Worms Reloaded](#Worms_Reloaded)
    *   [74.1 Dependencies](#Dependencies_39)
*   [75 XCOM](#XCOM)
    *   [75.1 Dependencies](#Dependencies_40)
    *   [75.2 Hangs on startup](#Hangs_on_startup)
    *   [75.3 Graphical glitches on Intel HD](#Graphical_glitches_on_Intel_HD)

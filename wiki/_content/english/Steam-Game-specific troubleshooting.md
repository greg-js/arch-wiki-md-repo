...
*   [5 Games](#Games)
    ...
    *   [5.9 Crash on joining a game](#Crash_on_joining_a_game)
    *   [5.10 Audiosurf 2](#Audiosurf_2)
        *   [5.10.1 error. unable to load song <filename> ,came back with zero duration](#error._unable_to_load_song_<filename>_,came_back_with_zero_duration)
    *   [5.11 BADLAND: Game of the Year Edition](#BADLAND:_Game_of_the_Year_Edition)
    *   [5.12 Beat Cop](#Beat_Cop)
        *   [5.12.1 "BeatCop.x86_64" is not responding](#"BeatCop.x86_64"_is_not_responding)
    *   [5.13 Binding of Isaac: Rebirth](#Binding_of_Isaac:_Rebirth)
        *   [5.13.1 No sound](#No_sound)
    *   [5.14 BioShock Infinite](#BioShock_Infinite)
        *   [5.14.1 Game launching on wrong monitor in fullscreen mode](#Game_launching_on_wrong_monitor_in_fullscreen_mode)
    *   [5.15 BLACKHOLE](#BLACKHOLE)
    *   [5.16 Black Mesa](#Black_Mesa)
    *   [5.17 Block'hood](#Block'hood)
        *   [5.17.1 White screen on startup](#White_screen_on_startup)
    *   [5.18 The Book of Unwritten Tales](#The_Book_of_Unwritten_Tales)
    *   [5.19 BRAIN/OUT](#BRAIN/OUT)
    *   [5.20 The Book of Unwritten Tales: The Critter Chronicles](#The_Book_of_Unwritten_Tales:_The_Critter_Chronicles)
    *   [5.21 Borderlands 2](#Borderlands_2)
        *   [5.21.1 Migrating saves from other platforms](#Migrating_saves_from_other_platforms)
        *   [5.21.2 Using Ctrl Key](#Using_Ctrl_Key)
        *   [5.21.3 Logging into SHiFT](#Logging_into_SHiFT)
        *   [5.21.4 Game crashes nearly instantly](#Game_crashes_nearly_instantly)
    *   [5.22 Borderlands: The Pre-Sequel](#Borderlands:_The_Pre-Sequel)
        *   [5.22.1 Keyboard not working](#Keyboard_not_working)
        *   [5.22.2 Not starting via Steam](#Not_starting_via_Steam)
    *   [5.23 Chaos Engine](#Chaos_Engine)
    *   [5.24 Cities in Motion 2](#Cities_in_Motion_2)
        *   [5.24.1 Dialog boxes fail to display properly](#Dialog_boxes_fail_to_display_properly)
    *   [5.25 Cities Skylines](#Cities_Skylines)
        *   [5.25.1 Textures not rendering properly](#Textures_not_rendering_properly)
    *   [5.26 Civilization V](#Civilization_V)
        *   [5.26.1 Stuttering sound with PulseAudio](#Stuttering_sound_with_PulseAudio)
    ...
    *   [5.28 Civilization VI](#Civilization_VI)
        *   [5.28.1 If Segfault Immediately on Start](#If_Segfault_Immediately_on_Start)
        *   [5.28.2 If Crash with Error "undefined symbol FT_Done_MM_Var"](#If_Crash_with_Error_"undefined_symbol_FT_Done_MM_Var")
        *   [5.28.3 If the game ends up being a grey-color blank screen](#If_the_game_ends_up_being_a_grey-color_blank_screen)
    *   [5.29 CrossCode](#CrossCode)
        *   [5.29.1 If FontConfig Errors on Start](#If_FontConfig_Errors_on_Start)
    *   [5.30 Deus Ex: Mankind Divided](#Deus_Ex:_Mankind_Divided)
    *   [5.31 The Clockwork Man](#The_Clockwork_Man)
    *   [5.32 Company of Heroes 2](#Company_of_Heroes_2)
        *   [5.32.1 Missing libpcre.so.3](#Missing_libpcre.so.3)
    *   [5.33 Cossacks 3](#Cossacks_3)
        *   [5.33.1 No sound](#No_sound_2)
        *   [5.33.2 Flashing screen with primus](#Flashing_screen_with_primus)
    *   [5.34 Counter-Strike: Source (CS:S)](#Counter-Strike:_Source_(CS:S))
        *   [5.34.1 Invisible symbols, special characters and cyrillic letters](#Invisible_symbols,_special_characters_and_cyrillic_letters)
    *   [5.35 Counter-Strike: Global Offensive (CS:GO)](#Counter-Strike:_Global_Offensive_(CS:GO))
        *   [5.35.1 Game starts on the wrong screen](#Game_starts_on_the_wrong_screen)
        *   [5.35.2 Cannot reach bottom of the screen on menus](#Cannot_reach_bottom_of_the_screen_on_menus)
        *   [5.35.3 Sound is played slightly delayed](#Sound_is_played_slightly_delayed)
        *   [5.35.4 Mouse not working in-game](#Mouse_not_working_in-game)
        *   [5.35.5 Brightness slider not working](#Brightness_slider_not_working)
        *   [5.35.6 Microphone not working](#Microphone_not_working)
        *   [5.35.7 Mouse is unrensponsive or moves slowly](#Mouse_is_unrensponsive_or_moves_slowly)
        *   [5.35.8 Game crashes on startup with game controller plugged in](#Game_crashes_on_startup_with_game_controller_plugged_in)
    *   [5.36 Creeper World 3: Arc Eternal](#Creeper_World_3:_Arc_Eternal)
        *   [5.36.1 Game does not start](#Game_does_not_start_2)
    *   [5.37 Crusader Kings II](#Crusader_Kings_II)
        *   [5.37.1 No audio](#No_audio)
    ...
    *   [5.39 The Curious Expedition](#The_Curious_Expedition)
        *   [5.39.1 Game stuck on loading screen](#Game_stuck_on_loading_screen)
    *   [5.40 Death Road To Canada](#Death_Road_To_Canada)
        *   [5.40.1 No music](#No_music)
    *   [5.41 Defender's Quest: Valley of the Forgotten](#Defender's_Quest:_Valley_of_the_Forgotten)
    *   [5.42 Dirt](#Dirt)
    *   [5.43 Dirt Rally](#Dirt_Rally)
    *   [5.44 Divinity: Original Sin - Enhanced Edition](#Divinity:_Original_Sin_-_Enhanced_Edition)
        *   [5.44.1 Game does not start when using Bumblebee optirun or primusrun](#Game_does_not_start_when_using_Bumblebee_optirun_or_primusrun)
        *   [5.44.2 Game does not work with mesa](#Game_does_not_work_with_mesa)
    *   [5.45 Don't Starve](#Don't_Starve)
        *   [5.45.1 No sound](#No_sound_3)
    *   [5.46 Doki Doki Literature Club](#Doki_Doki_Literature_Club)
    *   [5.47 Dota 2](#Dota_2)
        *   [5.47.1 In-game font is unreadable](#In-game_font_is_unreadable)
        *   [5.47.2 Error with libpangoft2](#Error_with_libpangoft2)
        *   [5.47.3 The game does not start](#The_game_does_not_start)
        *   [5.47.4 Game runs on the wrong screen](#Game_runs_on_the_wrong_screen)
        *   [5.47.5 Game does not start with libxcb-dri3 error message](#Game_does_not_start_with_libxcb-dri3_error_message)
        *   [5.47.6 Steam overlay](#Steam_overlay)
        *   [5.47.7 Chinese tips and player names not shown](#Chinese_tips_and_player_names_not_shown)
        *   [5.47.8 Chinese input method problem](#Chinese_input_method_problem)
    *   [5.48 Devil Daggers](#Devil_Daggers)
    *   [5.49 Drox Operative](#Drox_Operative)
    *   [5.50 Dungeon Souls](#Dungeon_Souls)
    *   [5.51 Dwarfs F2P](#Dwarfs_F2P)
        *   [5.51.1 Game does not start](#Game_does_not_start_3)
        *   [5.51.2 Game crashes](#Game_crashes)
    *   [5.52 Dynamite Jack](#Dynamite_Jack)
        *   [5.52.1 Sound Issues](#Sound_Issues)
        *   [5.52.2 Game does not start](#Game_does_not_start_4)
    *   [5.53 Empire Total War](#Empire_Total_War)
        *   [5.53.1 Weird unreadable fonts](#Weird_unreadable_fonts)
    *   [5.54 Euro Truck Simulator 2](#Euro_Truck_Simulator_2)
        *   [5.54.1 Shows only a black screen](#Shows_only_a_black_screen)
    *   [5.55 Firewatch](#Firewatch)
    *   [5.56 Football Manager 2014](#Football_Manager_2014)
    *   [5.57 FORCED](#FORCED)
    *   [5.58 For the King](#For_the_King)
    *   [5.59 FTL: Faster than Light](#FTL:_Faster_than_Light)
        *   [5.59.1 Compatibility](#Compatibility)
        *   [5.59.2 Problems with open-source video driver](#Problems_with_open-source_video_driver)
        *   [5.59.3 Artifacts when launching, Problems with openGL](#Artifacts_when_launching,_Problems_with_openGL)
    *   [5.60 Game Dev Tycoon](#Game_Dev_Tycoon)
        *   [5.60.1 Game does not start](#Game_does_not_start_5)
    *   [5.61 Garry's Mod](#Garry's_Mod)
        *   [5.61.1 Game does not start](#Game_does_not_start_6)
        *   [5.61.2 Opening some menus causes the game to crash](#Opening_some_menus_causes_the_game_to_crash)
        *   [5.61.3 Game crashes after attempting to join server](#Game_crashes_after_attempting_to_join_server)
    *   [5.62 Gods will be watching](#Gods_will_be_watching)
    *   [5.63 GRID Autosport](#GRID_Autosport)
        *   [5.63.1 Black screen when trying to play](#Black_screen_when_trying_to_play)
    *   [5.64 Hack 'n' Slash](#Hack_'n'_Slash)
        *   [5.64.1 Crashes when trying to load a game](#Crashes_when_trying_to_load_a_game)
    *   [5.65 Hacker Evolution](#Hacker_Evolution)
    *   [5.66 Half-Life 2 and episodes](#Half-Life_2_and_episodes)
        *   [5.66.1 Cyrillic fonts problem](#Cyrillic_fonts_problem)
    *   [5.67 Hammerwatch](#Hammerwatch)
        *   [5.67.1 The game does not start via Steam](#The_game_does_not_start_via_Steam)
        *   [5.67.2 No sound](#No_sound_4)
    *   [5.68 Harvest: Massive Encounter](#Harvest:_Massive_Encounter)
        *   [5.68.1 Compatibility](#Compatibility_2)
    *   [5.69 Hatoful Boyfriend](#Hatoful_Boyfriend)
        *   [5.69.1 Japanese text invisible](#Japanese_text_invisible)
    *   [5.70 HEARTBEAT](#HEARTBEAT)
        *   [5.70.1 If FontConfig Errors on Start](#If_FontConfig_Errors_on_Start_2)
    *   [5.71 HuniePop](#HuniePop)
        *   [5.71.1 Game crashes upon launch](#Game_crashes_upon_launch)
    *   [5.72 Hyper Light Drifter](#Hyper_Light_Drifter)
        *   [5.72.1 The controller does not work](#The_controller_does_not_work)
        *   [5.72.2 Missing libcurl.so.4 or version CURL_OPENSSL_3 not found](#Missing_libcurl.so.4_or_version_CURL_OPENSSL_3_not_found)
    *   [5.73 The Impossible Game](#The_Impossible_Game)
    *   [5.74 The Inner World](#The_Inner_World)
        *   [5.74.1 Bringing up the inventory or main menu](#Bringing_up_the_inventory_or_main_menu)
            *   [5.74.1.1 Cutscenes](#Cutscenes)
    *   [5.75 Interloper](#Interloper)
        *   [5.75.1 Game does not start](#Game_does_not_start_7)
    *   [5.76 Invisible Apartment](#Invisible_Apartment)
        *   [5.76.1 Game does not start](#Game_does_not_start_8)
    *   [5.77 Joe Danger 2: The Movie](#Joe_Danger_2:_The_Movie)
        *   [5.77.1 Compatibility](#Compatibility_3)
    *   [5.78 Kerbal Space Program](#Kerbal_Space_Program)
    *   [5.79 Killing Floor](#Killing_Floor)
        *   [5.79.1 Cannot change screen resolution](#Cannot_change_screen_resolution)
        *   [5.79.2 Windowed mode](#Windowed_mode)
        *   [5.79.3 Stuttering sound](#Stuttering_sound)
    *   [5.80 Left for Dead 2](#Left_for_Dead_2)
        *   [5.80.1 Missing Chinese font](#Missing_Chinese_font)
    *   [5.81 Lethal League](#Lethal_League)
    *   [5.82 Life is Strange](#Life_is_Strange)
    *   [5.83 Little Racers STREET](#Little_Racers_STREET)
    *   [5.84 The Long Dark](#The_Long_Dark)
        *   [5.84.1 Game does not start](#Game_does_not_start_9)
        *   [5.84.2 Game starts, but some overlay text is missing and cutscenes shows black screen](#Game_starts,_but_some_overlay_text_is_missing_and_cutscenes_shows_black_screen)
        *   [5.84.3 Cutscenes are still black](#Cutscenes_are_still_black)
        *   [5.84.4 Cursor disappears](#Cursor_disappears)
    *   [5.85 Grand Theft Auto V](#Grand_Theft_Auto_V)
        *   [5.85.1 Game crashes in Online](#Game_crashes_in_Online)
    *   [5.86 Graphical Issues using a NVIDIA GPU](#Graphical_Issues_using_a_NVIDIA_GPU)
    *   [5.87 Magicka 2](#Magicka_2)
        *   [5.87.1 Indefinitely stuck at start](#Indefinitely_stuck_at_start)
    *   [5.88 Mark of the Ninja](#Mark_of_the_Ninja)
        *   [5.88.1 Bad sound](#Bad_sound)
    *   [5.89 Metro: Last Light](#Metro:_Last_Light)
    *   [5.90 Metro: 2033 Redux](#Metro:_2033_Redux)
        *   [5.90.1 No sound](#No_sound_5)
        *   [5.90.2 No image](#No_image)
    *   [5.91 Middle-earth: Shadow of Mordor](#Middle-earth:_Shadow_of_Mordor)
        *   [5.91.1 Floating heads](#Floating_heads)
    *   [5.92 Mount & Blade: Warband](#Mount_&_Blade:_Warband)
        *   [5.92.1 Segmentation fault (core dumped) with wayland](#Segmentation_fault_(core_dumped)_with_wayland)
        *   [5.92.2 DLC Chooser](#DLC_Chooser)
        *   [5.92.3 Crash on startup](#Crash_on_startup)
    *   [5.93 Move or Die](#Move_or_Die)
        *   [5.93.1 No Sound](#No_Sound_6)
    *   [5.94 Multiwinia](#Multiwinia)
        *   [5.94.1 Crash on startup](#Crash_on_startup_2)
    *   [5.95 Natural Selection 2](#Natural_Selection_2)
    *   [5.96 Nuclear Throne](#Nuclear_Throne)
        *   [5.96.1 Missing libcurl.so.4 or version CURL_OPENSSL_3 not found](#Missing_libcurl.so.4_or_version_CURL_OPENSSL_3_not_found_2)
    *   [5.97 OneShot](#OneShot)
        *   [5.97.1 Game fails to start](#Game_fails_to_start)
    *   [5.98 Oxygen Not Included](#Oxygen_Not_Included)
        *   [5.98.1 World generation hangs](#World_generation_hangs)
    *   [5.99 Penumbra: Overture](#Penumbra:_Overture)
        *   [5.99.1 Windowed mode](#Windowed_mode_2)
    *   [5.100 The Polynomial](#The_Polynomial)
        *   [5.100.1 Segfaults during program start on 64-bit systems](#Segfaults_during_program_start_on_64-bit_systems)
    *   [5.101 Portal 2](#Portal_2)
        *   [5.101.1 Game does not start](#Game_does_not_start_10)
        *   [5.101.2 Resolution too low](#Resolution_too_low)
        *   [5.101.3 Missing non Latin font](#Missing_non_Latin_font)
    *   [5.102 Prison Architect](#Prison_Architect)
        *   [5.102.1 ALSA error when using PulseAudio](#ALSA_error_when_using_PulseAudio)
        *   [5.102.2 Game only starting in safe mode](#Game_only_starting_in_safe_mode)
    *   [5.103 Project Zomboid](#Project_Zomboid)
        *   [5.103.1 No sound](#No_sound_7)
    *   [5.104 Pyre](#Pyre)
        *   [5.104.1 Game does not start](#Game_does_not_start_11)
    *   [5.105 Redshirt](#Redshirt)
    *   [5.106 Revenge of the Titans](#Revenge_of_the_Titans)
    *   [5.107 Rise of the Tomb Raider](#Rise_of_the_Tomb_Raider)
    *   [5.108 Risk of Rain](#Risk_of_Rain)
    *   [5.109 Rock Boshers DX: Directors Cut](#Rock_Boshers_DX:_Directors_Cut)
    *   [5.110 Saints Row IV](#Saints_Row_IV)
        *   [5.110.1 Game fails to launch after update to new Nvidia drivers](#Game_fails_to_launch_after_update_to_new_Nvidia_drivers)
        *   [5.110.2 Game causes GPU lockup with mesa drivers](#Game_causes_GPU_lockup_with_mesa_drivers)
    *   [5.111 Serious Sam 3: BFE](#Serious_Sam_3:_BFE)
        *   [5.111.1 No audio](#No_audio_2)
    *   [5.112 Slay the Spire](#Slay_the_Spire)
    *   [5.113 Songbringer](#Songbringer)
        *   [5.113.1 Launch error with Wayland](#Launch_error_with_Wayland)
    *   [5.114 Space Pirates and Zombies](#Space_Pirates_and_Zombies)
        *   [5.114.1 No audio](#No_audio_3)
    *   [5.115 Spacechem](#Spacechem)
        *   [5.115.1 Game crash](#Game_crash)
    *   [5.116 Splice](#Splice)
    *   [5.117 The Stanley Parable](#The_Stanley_Parable)
        *   [5.117.1 Game won't start](#Game_won't_start)
    *   [5.118 Shadow Tactics: Blades of the Shogun](#Shadow_Tactics:_Blades_of_the_Shogun)
    *   [5.119 Stardew Valley](#Stardew_Valley)
        *   [5.119.1 Unable to move](#Unable_to_move)
    *   [5.120 Steel Storm: Burning Retribution](#Steel_Storm:_Burning_Retribution)
        *   [5.120.1 Start with black screen](#Start_with_black_screen)
    *   [5.121 Stellaris](#Stellaris)
        *   [5.121.1 No window opening, only sound](#No_window_opening,_only_sound)
        *   [5.121.2 Immediate crash to desktop](#Immediate_crash_to_desktop)
    *   [5.122 Stephen's Sausage Roll](#Stephen's_Sausage_Roll)
        *   [5.122.1 No sound](#No_sound_8)
    *   [5.123 Superbrothers: Sword & Sworcery EP](#Superbrothers:_Sword_&_Sworcery_EP)
    *   [5.124 System Shock 2](#System_Shock_2)
        *   [5.124.1 Game won't launch](#Game_won't_launch)
        *   [5.124.2 Resolution fix](#Resolution_fix)
    *   [5.125 Tabletop Simulator](#Tabletop_Simulator)
        *   [5.125.1 CJK characters not showing in game](#CJK_characters_not_showing_in_game)
    *   [5.126 Team Fortress 2](#Team_Fortress_2)
        *   [5.126.1 HRTF setup](#HRTF_setup)
        *   [5.126.2 Loading screen freeze](#Loading_screen_freeze)
        *   [5.126.3 No audio](#No_audio_4)
        *   [5.126.4 Slow loading textures](#Slow_loading_textures)
        *   [5.126.5 "Invalid color format" Error at loading screen on integrated Intel Atom/BayTrail HD Graphics](#"Invalid_color_format"_Error_at_loading_screen_on_integrated_Intel_Atom/BayTrail_HD_Graphics)
    *   [5.127 Terraria](#Terraria)
        *   [5.127.1 Input Issues](#Input_Issues)
    *   [5.128 This War of Mine](#This_War_of_Mine)
        *   [5.128.1 Game does not start](#Game_does_not_start_12)
        *   [5.128.2 Sound glitches with Steam native](#Sound_glitches_with_Steam_native)
    *   [5.129 Ticket to Ride](#Ticket_to_Ride)
    *   [5.130 The Tiny Bang Story](#The_Tiny_Bang_Story)
        *   [5.130.1 Missing libGLEW.so.1.6](#Missing_libGLEW.so.1.6)
    *   [5.131 Tomb Raider](#Tomb_Raider)
        *   [5.131.1 Game immediately closes when running with steam-native](#Game_immediately_closes_when_running_with_steam-native)
        *   [5.131.2 Steam Controller not working in-game](#Steam_Controller_not_working_in-game)
    *   [5.132 Torchlight 2](#Torchlight_2)
        *   [5.132.1 Libfreetype/libfontconfig Incompatibility](#Libfreetype/libfontconfig_Incompatibility)
        *   [5.132.2 Locale incompatibility](#Locale_incompatibility)
    *   [5.133 Tower Unite](#Tower_Unite)
        *   [5.133.1 Graphical Glitches](#Graphical_Glitches)
    *   [5.134 Towns / Towns Demo](#Towns_/_Towns_Demo)
    *   [5.135 Transistor](#Transistor)
        *   [5.135.1 Crash on launch / FMOD binding crash / audio issues](#Crash_on_launch_/_FMOD_binding_crash_/_audio_issues)
    *   [5.136 Transmissions: Element 120](#Transmissions:_Element_120)
        *   [5.136.1 Troubleshooting](#Troubleshooting)
    *   [5.137 Transport Fever 2](#Transport_Fever_2)
        *   [5.137.1 Game won't launch](#Game_won't_launch_2)
    *   [5.138 Trine 2](#Trine_2)
        *   [5.138.1 Fullscreen](#Fullscreen)
        *   [5.138.2 Colors](#Colors)
        *   [5.138.3 Sound](#Sound)
        *   [5.138.4 Resolution](#Resolution)
        *   [5.138.5 Crash on start in libX11.so.6.3.0](#Crash_on_start_in_libX11.so.6.3.0)
    *   [5.139 Tropico 5](#Tropico_5)
        *   [5.139.1 Blank screen with sound only on startup](#Blank_screen_with_sound_only_on_startup)
    *   [5.140 Unity of Command](#Unity_of_Command)
        *   [5.140.1 Squares](#Squares)
        *   [5.140.2 No audio](#No_audio_5)
    *   [5.141 Unity3D](#Unity3D)
        *   [5.141.1 Locale settings](#Locale_settings)
        *   [5.141.2 Unity 5 sound problems](#Unity_5_sound_problems)
        *   [5.141.3 Game launching on wrong monitor in fullscreen mode](#Game_launching_on_wrong_monitor_in_fullscreen_mode_2)
        *   [5.141.4 Chinese/Japanese/Korean display bug](#Chinese/Japanese/Korean_display_bug)
        *   [5.141.5 Game does not respond](#Game_does_not_respond)
    *   [5.142 Unrest](#Unrest)
    *   [5.143 Volgarr the Viking](#Volgarr_the_Viking)
    *   [5.144 War Thunder](#War_Thunder)
        *   [5.144.1 No audio](#No_audio_6)
        *   [5.144.2 Blank screen](#Blank_screen)
    *   [5.145 Warhammer 40,000: Dawn of War II](#Warhammer_40,000:_Dawn_of_War_II)
    *   [5.146 Wasteland 2](#Wasteland_2)
    *   [5.147 We Were Here](#We_Were_Here)
        *   [5.147.1 Stuck on black screen or logo on launch](#Stuck_on_black_screen_or_logo_on_launch)
    *   [5.148 Worms W.M.D](#Worms_W.M.D)
    *   [5.149 Witcher 2: Assassin of Kings](#Witcher_2:_Assassin_of_Kings)
        *   [5.149.1 Game does not start](#Game_does_not_start_13)
    *   [5.150 Wizardry 6: Bane of the Cosmic Forge](#Wizardry_6:_Bane_of_the_Cosmic_Forge)
    *   [5.151 World of Goo](#World_of_Goo)
        *   [5.151.1 Changing resolution](#Changing_resolution)
    *   [5.152 X3: Terran Conflict](#X3:_Terran_Conflict)
        *   [5.152.1 Game crashes on startup](#Game_crashes_on_startup)
    *   [5.153 XCOM](#XCOM)
        *   [5.153.1 Hangs on startup](#Hangs_on_startup)
        *   [5.153.2 Graphical glitches on Intel HD](#Graphical_glitches_on_Intel_HD)
...
Download the latest version of nwjs from [here](https://nwjs.io/) and extract it's contents into your CrossCode directory, overwriting the files.
...
Workaround[[8]](https://www.gamingonlinux.com/articles/divinity-original-sin-may-soon-work-with-mesa-drivers.8867/comment_id=81524) (see [step by step guide](https://bugs.freedesktop.org/show_bug.cgi?id=93551#c46))

Get the following file: [https://bugs.freedesktop.org/attachment.cgi?id=125302](https://bugs.freedesktop.org/attachment.cgi?id=125302) and rename it to `divos-hack.c`
...
Install [sdl2](https://www.archlinux.org/packages/?name=sdl2).
...
Rename or delete the following files in game directory (~/.steam/steam/steamapps/common/Transport Fever 2) as discussed in [[17]](https://steamcommunity.com/app/1066780/discussions/0/1740010344363244243/)
...
If having a green or blank screen on startup, run the game with `MESA_GL_VERSION_OVERRIDE=4.1COMPAT`. [[18]](https://forum.warthunder.com/index.php?/topic/267809-linux-potential-workaround-for-mesa-drivers-black-screen/) [[19]](http://forum.warthunder.com/index.php?search_term=0030709&app=core&module=search&do=search&fromMainBar=1&search_app=forums%3Aforum%3A920&sort_field=&sort_order=&search_in=posts)
...
Add `-screen-fullscreen 0` to launch options. [[20]](https://steamcommunity.com/app/582500/discussions/1/1470840994974091613/)
...
Now the game should run using the default "Play Worms W.M.D" option. See also Steam community discussions [[21]](https://steamcommunity.com/app/327030/discussions/2/133257959065155871/) and [[22]](https://steamcommunity.com/app/327030/discussions/1/343785380902286766/).

...
*   [4 Games](#Games)
    ...
    *   [4.15 BRAIN/OUT](#BRAIN.2FOUT)
    *   [4.16 The Book of Unwritten Tales: The Critter Chronicles](#The_Book_of_Unwritten_Tales:_The_Critter_Chronicles)
    *   [4.17 Borderlands 2](#Borderlands_2)
        *   [4.17.1 Migrating saves from other platforms](#Migrating_saves_from_other_platforms)
        *   [4.17.2 Using Ctrl Key](#Using_Ctrl_Key)
        *   [4.17.3 Logging into SHiFT](#Logging_into_SHiFT)
        *   [4.17.4 Game crashes nearly instantly](#Game_crashes_nearly_instantly)
    *   [4.18 Borderlands: The Pre-Sequel](#Borderlands:_The_Pre-Sequel)
        *   [4.18.1 Keyboard not working](#Keyboard_not_working)
        *   [4.18.2 Not starting via Steam](#Not_starting_via_Steam)
    *   [4.19 Cities in Motion 2](#Cities_in_Motion_2)
        *   [4.19.1 Dialog boxes fail to display properly](#Dialog_boxes_fail_to_display_properly)
    *   [4.20 Cities Skylines](#Cities_Skylines)
        *   [4.20.1 Textures not rendering properly](#Textures_not_rendering_properly)
    *   [4.21 Civilization V](#Civilization_V)
        *   [4.21.1 Stuttering sound with PulseAudio](#Stuttering_sound_with_PulseAudio)
        *   [4.21.2 Game crashes seconds after loading a map](#Game_crashes_seconds_after_loading_a_map)
        *   [4.21.3 Game crashes after intro video with "Unable to load texture (LoadingBaseGame.dds)"](#Game_crashes_after_intro_video_with_.22Unable_to_load_texture_.28LoadingBaseGame.dds.29.22)
    *   [4.22 Civilization: Beyond earth](#Civilization:_Beyond_earth)
        *   [4.22.1 Segfault after a few minutes](#Segfault_after_a_few_minutes)
    *   [4.23 Civilization VI](#Civilization_VI)
        *   [4.23.1 If Segfault Immediately on Start](#If_Segfault_Immediately_on_Start)
    *   [4.24 Deus Ex: Mankind divided](#Deus_Ex:_Mankind_divided)
    *   [4.25 The Clockwork Man](#The_Clockwork_Man)
    *   [4.26 Company of Heroes 2](#Company_of_Heroes_2)
        *   [4.26.1 Missing libpcre.so.3](#Missing_libpcre.so.3_2)
    *   [4.27 Cossacks 3](#Cossacks_3)
        *   [4.27.1 No sound](#No_sound_2)
        *   [4.27.2 Flashing screen with primus](#Flashing_screen_with_primus)
    *   [4.28 Counter-Strike: Global Offensive (CS:GO)](#Counter-Strike:_Global_Offensive_.28CS:GO.29)
        *   [4.28.1 Game starts on the wrong screen](#Game_starts_on_the_wrong_screen)
        *   [4.28.2 Cannot reach bottom of the screen on menus](#Cannot_reach_bottom_of_the_screen_on_menus)
        *   [4.28.3 Sound is played slightly delayed](#Sound_is_played_slightly_delayed)
    ...
    *   [4.29 Crusader Kings II](#Crusader_Kings_II)
        ...
        *   [4.29.3 DLCs not detected](#DLCs_not_detected)
    *   [4.30 Crypt of the NecroDancer](#Crypt_of_the_NecroDancer)
        *   [4.30.1 Crashes after splash screen](#Crashes_after_splash_screen)
    *   [4.31 The Curious Expedition](#The_Curious_Expedition)
        *   [4.31.1 Game stuck on loading screen](#Game_stuck_on_loading_screen)
    *   [4.32 Death Road To Canada](#Death_Road_To_Canada)
        *   [4.32.1 No music](#No_music)
    *   [4.33 Defender's Quest: Valley of the Forgotten](#Defender.27s_Quest:_Valley_of_the_Forgotten)
    *   [4.34 Dirt](#Dirt)
    *   [4.35 Dirt Rally](#Dirt_Rally)
    *   [4.36 Divinity: Original Sin - Enhanced Edition](#Divinity:_Original_Sin_-_Enhanced_Edition)
        *   [4.36.1 Game does not start when using Bumblebee optirun or primusrun](#Game_does_not_start_when_using_Bumblebee_optirun_or_primusrun)
        *   [4.36.2 Game does not work with amdgpu](#Game_does_not_work_with_amdgpu)
    *   [4.37 Don't Starve](#Don.27t_Starve)
        *   [4.37.1 No sound](#No_sound_3)
    *   [4.38 Dota 2](#Dota_2)
        *   [4.38.1 In-game font is unreadable](#In-game_font_is_unreadable)
        *   [4.38.2 Error with libpangoft2](#Error_with_libpangoft2)
        *   [4.38.3 The game does not start](#The_game_does_not_start)
        *   [4.38.4 Game runs on the wrong screen](#Game_runs_on_the_wrong_screen)
        *   [4.38.5 Game does not start with libxcb-dri3 error message](#Game_does_not_start_with_libxcb-dri3_error_message)
        *   [4.38.6 Steam overlay](#Steam_overlay)
        *   [4.38.7 Chinese tips and player names not shown](#Chinese_tips_and_player_names_not_shown)
        *   [4.38.8 Chinese input method problem](#Chinese_input_method_problem)
    *   [4.39 Devil Daggers](#Devil_Daggers)
    *   [4.40 Drox Operative](#Drox_Operative)
    *   [4.41 Dwarfs F2P](#Dwarfs_F2P)
        *   [4.41.1 Game does not start](#Game_does_not_start_2)
        *   [4.41.2 Game crashes](#Game_crashes)
    *   [4.42 Dynamite Jack](#Dynamite_Jack)
        *   [4.42.1 Sound Issues](#Sound_Issues)
        *   [4.42.2 Game does not start](#Game_does_not_start_3)
    *   [4.43 Empire Total War](#Empire_Total_War)
        *   [4.43.1 Weird unreadable fonts](#Weird_unreadable_fonts)
    *   [4.44 Euro Truck Simulator 2](#Euro_Truck_Simulator_2)
        *   [4.44.1 Shows only a black screen](#Shows_only_a_black_screen)
    *   [4.45 Football Manager 2014](#Football_Manager_2014)
    *   [4.46 FORCED](#FORCED)
    *   [4.47 FTL: Faster than Light](#FTL:_Faster_than_Light)
        *   [4.47.1 Compatibility](#Compatibility)
        *   [4.47.2 Problems with open-source video driver](#Problems_with_open-source_video_driver)
    *   [4.48 Game Dev Tycoon](#Game_Dev_Tycoon)
        *   [4.48.1 Game does not start](#Game_does_not_start_4)
    *   [4.49 Garry's Mod](#Garry.27s_Mod)
        *   [4.49.1 Game does not start](#Game_does_not_start_5)
        *   [4.49.2 Opening some menus causes the game to crash](#Opening_some_menus_causes_the_game_to_crash)
        *   [4.49.3 Game crashes after attempting to join server](#Game_crashes_after_attempting_to_join_server)
    *   [4.50 Gods will be watching](#Gods_will_be_watching)
    *   [4.51 GRID Autosport](#GRID_Autosport)
        *   [4.51.1 Black screen when trying to play](#Black_screen_when_trying_to_play)
    *   [4.52 Hack 'n' Slash](#Hack_.27n.27_Slash)
        *   [4.52.1 Crashes when trying to load a game](#Crashes_when_trying_to_load_a_game)
    *   [4.53 Hacker Evolution](#Hacker_Evolution)
    *   [4.54 Half-Life 2 and episodes](#Half-Life_2_and_episodes)
        *   [4.54.1 Cyrillic fonts problem](#Cyrillic_fonts_problem)
    *   [4.55 Hammerwatch](#Hammerwatch)
        *   [4.55.1 The game does not start via Steam](#The_game_does_not_start_via_Steam)
        *   [4.55.2 No sound](#No_sound_4)
    *   [4.56 Harvest: Massive Encounter](#Harvest:_Massive_Encounter)
        *   [4.56.1 Compatibility](#Compatibility_2)
    *   [4.57 Hatoful Boyfriend](#Hatoful_Boyfriend)
        *   [4.57.1 Japanese text invisible](#Japanese_text_invisible)
    *   [4.58 HuniePop](#HuniePop)
        *   [4.58.1 Game crashes upon launch](#Game_crashes_upon_launch)
    *   [4.59 Hyper Light Drifter](#Hyper_Light_Drifter)
        *   [4.59.1 The controller does not work](#The_controller_does_not_work)
        *   [4.59.2 Missing libcurl.so.4 or version CURL_OPENSSL_3 not found](#Missing_libcurl.so.4_or_version_CURL_OPENSSL_3_not_found)
    *   [4.60 The Impossible Game](#The_Impossible_Game)
    *   [4.61 The Inner World](#The_Inner_World)
        *   [4.61.1 Bringing up the inventory or main menu](#Bringing_up_the_inventory_or_main_menu)
            *   [4.61.1.1 Cutscenes](#Cutscenes)
    *   [4.62 Interloper](#Interloper)
        *   [4.62.1 Game does not start](#Game_does_not_start_6)
    *   [4.63 Invisible Apartment](#Invisible_Apartment)
        *   [4.63.1 Game does not start](#Game_does_not_start_7)
    *   [4.64 Joe Danger 2: The Movie](#Joe_Danger_2:_The_Movie)
        *   [4.64.1 Compatibility](#Compatibility_3)
    *   [4.65 Kerbal Space Program](#Kerbal_Space_Program)
    *   [4.66 Killing Floor](#Killing_Floor)
        *   [4.66.1 Cannot change screen resolution](#Cannot_change_screen_resolution)
        *   [4.66.2 Windowed mode](#Windowed_mode)
        *   [4.66.3 Stuttering sound](#Stuttering_sound)
    *   [4.67 Left for Dead 2](#Left_for_Dead_2)
        *   [4.67.1 Missing Chinese font](#Missing_Chinese_font)
    *   [4.68 Lethal League](#Lethal_League)
    *   [4.69 Life is Strange](#Life_is_Strange)
    *   [4.70 Little Racers STREET](#Little_Racers_STREET)
    *   [4.71 The Long Dark](#The_Long_Dark)
        *   [4.71.1 Game does not start](#Game_does_not_start_8)
        *   [4.71.2 Game starts, but some overlay text is missing and cutscenes shows black screen](#Game_starts.2C_but_some_overlay_text_is_missing_and_cutscenes_shows_black_screen)
        *   [4.71.3 Cutscenes are still black](#Cutscenes_are_still_black)
        *   [4.71.4 Cursor disappears](#Cursor_disappears)
    *   [4.72 Magicka 2](#Magicka_2)
        *   [4.72.1 Indefinitely stuck at start](#Indefinitely_stuck_at_start)
    *   [4.73 Mark of the Ninja](#Mark_of_the_Ninja)
        *   [4.73.1 Bad sound](#Bad_sound)
    *   [4.74 Metro: Last Light](#Metro:_Last_Light)
    *   [4.75 Metro: 2033 Redux](#Metro:_2033_Redux)
        *   [4.75.1 No sound](#No_sound_5)
    *   [4.76 No image](#No_image)
    *   [4.77 Middle-earth: Shadow of Mordor](#Middle-earth:_Shadow_of_Mordor)
        *   [4.77.1 Floating heads](#Floating_heads)
    ...
    *   [4.82 Oxygen Not Included](#Oxygen_Not_Included)
        *   [4.82.1 World generation hangs](#World_generation_hangs)
    *   [4.83 Penumbra: Overture](#Penumbra:_Overture)
        *   [4.83.1 Windowed mode](#Windowed_mode_2)
    *   [4.84 The Polynomial](#The_Polynomial)
        *   [4.84.1 Segfaults during program start on 64-bit systems](#Segfaults_during_program_start_on_64-bit_systems)
    *   [4.85 Portal 2](#Portal_2)
        *   [4.85.1 Game does not start](#Game_does_not_start_9)
        *   [4.85.2 Resolution too low](#Resolution_too_low)
        *   [4.85.3 Missing non Latin font](#Missing_non_Latin_font)
    *   [4.86 Prison Architect](#Prison_Architect)
        *   [4.86.1 ALSA error when using PulseAudio](#ALSA_error_when_using_PulseAudio)
    *   [4.87 Project Zomboid](#Project_Zomboid)
        *   [4.87.1 No sound](#No_sound_6)
    *   [4.88 Pyre](#Pyre)
        *   [4.88.1 Game does not start](#Game_does_not_start_10)
    *   [4.89 Redshirt](#Redshirt)
    *   [4.90 Revenge of the Titans](#Revenge_of_the_Titans)
    *   [4.91 Risk of Rain](#Risk_of_Rain)
    *   [4.92 Rock Boshers DX: Directors Cut](#Rock_Boshers_DX:_Directors_Cut)
    *   [4.93 Saints Row IV](#Saints_Row_IV)
        *   [4.93.1 Game fails to launch after update to new Nvidia drivers](#Game_fails_to_launch_after_update_to_new_Nvidia_drivers)
        *   [4.93.2 Game causes GPU lockup with mesa drivers](#Game_causes_GPU_lockup_with_mesa_drivers)
    *   [4.94 Serious Sam 3: BFE](#Serious_Sam_3:_BFE)
        *   [4.94.1 No audio](#No_audio_2)
    *   [4.95 Slay the Spire](#Slay_the_Spire)
    *   [4.96 Songbringer](#Songbringer)
        *   [4.96.1 Launch error with Wayland](#Launch_error_with_Wayland)
    *   [4.97 Space Pirates and Zombies](#Space_Pirates_and_Zombies)
        *   [4.97.1 No audio](#No_audio_3)
    *   [4.98 Spacechem](#Spacechem)
        *   [4.98.1 Game crash](#Game_crash)
    *   [4.99 Splice](#Splice)
    *   [4.100 The Stanley Parable](#The_Stanley_Parable)
        *   [4.100.1 Game won't start](#Game_won.27t_start)
    *   [4.101 Shadow Tactics: Blades of the Shogun](#Shadow_Tactics:_Blades_of_the_Shogun)
    *   [4.102 Steel Storm: Burning Retribution](#Steel_Storm:_Burning_Retribution)
        *   [4.102.1 Start with black screen](#Start_with_black_screen)
    *   [4.103 Stellaris](#Stellaris)
        *   [4.103.1 No window opening, only sound](#No_window_opening.2C_only_sound)
    *   [4.104 Stephen's Sausage Roll](#Stephen.27s_Sausage_Roll)
        *   [4.104.1 No sound](#No_sound_7)
    *   [4.105 Superbrothers: Sword & Sworcery EP](#Superbrothers:_Sword_.26_Sworcery_EP)
    *   [4.106 System Shock 2](#System_Shock_2)
    *   [4.107 Tabletop Simulator](#Tabletop_Simulator)
        *   [4.107.1 CJK characters not showing in game](#CJK_characters_not_showing_in_game)
    *   [4.108 Team Fortress 2](#Team_Fortress_2)
        *   [4.108.1 HRTF setup](#HRTF_setup)
        *   [4.108.2 Loading screen freeze](#Loading_screen_freeze)
        *   [4.108.3 No audio](#No_audio_4)
        *   [4.108.4 Slow loading textures](#Slow_loading_textures)
    *   [4.109 Terraria](#Terraria)
    *   [4.110 This War of Mine](#This_War_of_Mine)
        *   [4.110.1 Game does not start](#Game_does_not_start_11)
        *   [4.110.2 Sound glitches with Steam native](#Sound_glitches_with_Steam_native)
    *   [4.111 Ticket to Ride](#Ticket_to_Ride)
    *   [4.112 The Tiny Bang Story](#The_Tiny_Bang_Story)
        *   [4.112.1 Missing libGLEW.so.1.6](#Missing_libGLEW.so.1.6)

...
*   [4 Games](#Games)
    ...
    *   [4.7 BADLAND: Game of the Year Edition](#BADLAND:_Game_of_the_Year_Edition)
    *   [4.8 Beat Cop](#Beat_Cop)
        *   [4.8.1 "BeatCop.x86_64" is not responding](#.22BeatCop.x86_64.22_is_not_responding)
    *   [4.9 Binding of Isaac: Rebirth](#Binding_of_Isaac:_Rebirth)
        *   [4.9.1 No sound](#No_sound)
    *   [4.10 BLACKHOLE](#BLACKHOLE)
    *   [4.11 The Book of Unwritten Tales](#The_Book_of_Unwritten_Tales)
    *   [4.12 The Book of Unwritten Tales: The Critter Chronicles](#The_Book_of_Unwritten_Tales:_The_Critter_Chronicles)
    *   [4.13 Borderlands 2](#Borderlands_2)
        *   [4.13.1 Migrating saves from other platforms](#Migrating_saves_from_other_platforms)
        *   [4.13.2 Using Ctrl Key](#Using_Ctrl_Key)
        *   [4.13.3 Logging into SHiFT](#Logging_into_SHiFT)
        *   [4.13.4 Game crashes nearly instantly](#Game_crashes_nearly_instantly)
    *   [4.14 Borderlands: The Pre-Sequel](#Borderlands:_The_Pre-Sequel)
        *   [4.14.1 Keyboard not working](#Keyboard_not_working)
        *   [4.14.2 Not starting via Steam](#Not_starting_via_Steam)
    *   [4.15 Cities in Motion 2](#Cities_in_Motion_2)
        *   [4.15.1 Dialog boxes fail to display properly](#Dialog_boxes_fail_to_display_properly)
    *   [4.16 Cities Skylines](#Cities_Skylines)
        *   [4.16.1 Textures not rendering properly](#Textures_not_rendering_properly)
    *   [4.17 Civilization V](#Civilization_V)
        *   [4.17.1 Stuttering sound with PulseAudio](#Stuttering_sound_with_PulseAudio)
        *   [4.17.2 Game crashes seconds after loading a map](#Game_crashes_seconds_after_loading_a_map)
        *   [4.17.3 Game crashes after intro video with "Unable to load texture (LoadingBaseGame.dds)"](#Game_crashes_after_intro_video_with_.22Unable_to_load_texture_.28LoadingBaseGame.dds.29.22)
    *   [4.18 Civilization: Beyond earth](#Civilization:_Beyond_earth)
        *   [4.18.1 Segfault after a few minutes](#Segfault_after_a_few_minutes)
    *   [4.19 Civilization VI](#Civilization_VI)
        *   [4.19.1 If Segfault Immediately on Start](#If_Segfault_Immediately_on_Start)
    *   [4.20 Deus Ex: Mankind divided](#Deus_Ex:_Mankind_divided)
    *   [4.21 The Clockwork Man](#The_Clockwork_Man)
    *   [4.22 Company of Heroes 2](#Company_of_Heroes_2)
        *   [4.22.1 Missing libpcre.so.3](#Missing_libpcre.so.3_2)
    *   [4.23 Cossacks 3](#Cossacks_3)
        *   [4.23.1 No sound](#No_sound_2)
    *   [4.24 Counter-Strike: Global Offensive (CS:GO)](#Counter-Strike:_Global_Offensive_.28CS:GO.29)
        *   [4.24.1 Game starts on the wrong screen](#Game_starts_on_the_wrong_screen)
        *   [4.24.2 Cannot reach bottom of the screen on menus](#Cannot_reach_bottom_of_the_screen_on_menus)
        *   [4.24.3 Sound is played slightly delayed](#Sound_is_played_slightly_delayed)
        *   [4.24.4 Mouse not working in-game](#Mouse_not_working_in-game)
        *   [4.24.5 Brightness slider not working](#Brightness_slider_not_working)
        *   [4.24.6 Microphone not working](#Microphone_not_working)
    ...
    *   [4.27 The Curious Expedition](#The_Curious_Expedition)
        *   [4.27.1 Game stuck on loading screen](#Game_stuck_on_loading_screen)
    *   [4.28 Death Road To Canada](#Death_Road_To_Canada)
        *   [4.28.1 No music](#No_music)
    *   [4.29 Defender's Quest: Valley of the Forgotten](#Defender.27s_Quest:_Valley_of_the_Forgotten)
    *   [4.30 Dirt](#Dirt)
    *   [4.31 Dirt Rally](#Dirt_Rally)
    *   [4.32 Divinity: Original Sin - Enhanced Edition](#Divinity:_Original_Sin_-_Enhanced_Edition)
        *   [4.32.1 Game does not start when using Bumblebee optirun or primusrun](#Game_does_not_start_when_using_Bumblebee_optirun_or_primusrun)
        *   [4.32.2 Game does not work with amdgpu](#Game_does_not_work_with_amdgpu)
    *   [4.33 Don't Starve](#Don.27t_Starve)
        *   [4.33.1 No sound](#No_sound_3)
    *   [4.34 Dota 2](#Dota_2)
        *   [4.34.1 In-game font is unreadable](#In-game_font_is_unreadable)
        *   [4.34.2 Error with libpangoft2](#Error_with_libpangoft2)
        *   [4.34.3 The game does not start](#The_game_does_not_start)
        *   [4.34.4 Game runs on the wrong screen](#Game_runs_on_the_wrong_screen)
        *   [4.34.5 Game does not start with libxcb-dri3 error message](#Game_does_not_start_with_libxcb-dri3_error_message)
        *   [4.34.6 Steam overlay](#Steam_overlay)
        *   [4.34.7 Chinese tips and player names not shown](#Chinese_tips_and_player_names_not_shown)
        *   [4.34.8 Chinese input method problem](#Chinese_input_method_problem)
    *   [4.35 Devil Daggers](#Devil_Daggers)
    *   [4.36 Drox Operative](#Drox_Operative)
    *   [4.37 Dwarfs F2P](#Dwarfs_F2P)
        *   [4.37.1 Game does not start](#Game_does_not_start_2)
        *   [4.37.2 Game crashes](#Game_crashes)
    *   [4.38 Dynamite Jack](#Dynamite_Jack)
        *   [4.38.1 Sound Issues](#Sound_Issues)
        *   [4.38.2 Game does not start](#Game_does_not_start_3)
    *   [4.39 Empire Total War](#Empire_Total_War)
        *   [4.39.1 Weird unreadable fonts](#Weird_unreadable_fonts)
    *   [4.40 Euro Truck Simulator 2](#Euro_Truck_Simulator_2)
        *   [4.40.1 Shows only a black screen](#Shows_only_a_black_screen)
    *   [4.41 Football Manager 2014](#Football_Manager_2014)
    *   [4.42 FORCED](#FORCED)
    *   [4.43 FTL: Faster than Light](#FTL:_Faster_than_Light)
        *   [4.43.1 Compatibility](#Compatibility)
        *   [4.43.2 Problems with open-source video driver](#Problems_with_open-source_video_driver)
    *   [4.44 Game Dev Tycoon](#Game_Dev_Tycoon)
        *   [4.44.1 Game does not start](#Game_does_not_start_4)
    *   [4.45 Garry's Mod](#Garry.27s_Mod)
        *   [4.45.1 Game does not start](#Game_does_not_start_5)
        *   [4.45.2 Opening some menus causes the game to crash](#Opening_some_menus_causes_the_game_to_crash)
        *   [4.45.3 Game crashes after attempting to join server](#Game_crashes_after_attempting_to_join_server)
    *   [4.46 Gods will be watching](#Gods_will_be_watching)
    *   [4.47 GRID Autosport](#GRID_Autosport)
        *   [4.47.1 Black screen when trying to play](#Black_screen_when_trying_to_play)
    *   [4.48 Hack 'n' Slash](#Hack_.27n.27_Slash)
        *   [4.48.1 Crashes when trying to load a game](#Crashes_when_trying_to_load_a_game)
    *   [4.49 Hacker Evolution](#Hacker_Evolution)
    *   [4.50 Half-Life 2 and episodes](#Half-Life_2_and_episodes)
        *   [4.50.1 Cyrillic fonts problem](#Cyrillic_fonts_problem)
    *   [4.51 Hammerwatch](#Hammerwatch)
        *   [4.51.1 The game does not start via Steam](#The_game_does_not_start_via_Steam)
        *   [4.51.2 No sound](#No_sound_4)
    *   [4.52 Harvest: Massive Encounter](#Harvest:_Massive_Encounter)
        *   [4.52.1 Compatibility](#Compatibility_2)
    *   [4.53 Hatoful Boyfriend](#Hatoful_Boyfriend)
        *   [4.53.1 Japanese text invisible](#Japanese_text_invisible)
    *   [4.54 Hyper Light Drifter](#Hyper_Light_Drifter)
        *   [4.54.1 The controller does not work](#The_controller_does_not_work)
        *   [4.54.2 Missing libcurl.so.4 or version CURL_OPENSSL_3 not found](#Missing_libcurl.so.4_or_version_CURL_OPENSSL_3_not_found)
    *   [4.55 The Impossible Game](#The_Impossible_Game)
    *   [4.56 The Inner World](#The_Inner_World)
        *   [4.56.1 Bringing up the inventory or main menu](#Bringing_up_the_inventory_or_main_menu)
            *   [4.56.1.1 Cutscenes](#Cutscenes)
    *   [4.57 Interloper](#Interloper)
        *   [4.57.1 Game does not start](#Game_does_not_start_6)
    *   [4.58 Invisible Apartment](#Invisible_Apartment)
        *   [4.58.1 Game does not start](#Game_does_not_start_7)
    *   [4.59 Joe Danger 2: The Movie](#Joe_Danger_2:_The_Movie)
        *   [4.59.1 Compatibility](#Compatibility_3)
    *   [4.60 Kerbal Space Program](#Kerbal_Space_Program)
    *   [4.61 Killing Floor](#Killing_Floor)
        *   [4.61.1 Cannot change screen resolution](#Cannot_change_screen_resolution)
        *   [4.61.2 Windowed mode](#Windowed_mode)
        *   [4.61.3 Stuttering sound](#Stuttering_sound)
    *   [4.62 Left for Dead 2](#Left_for_Dead_2)
        *   [4.62.1 Missing Chinese font](#Missing_Chinese_font)
    *   [4.63 Lethal League](#Lethal_League)
    *   [4.64 Life is Strange](#Life_is_Strange)
    *   [4.65 Little Racers STREET](#Little_Racers_STREET)
    *   [4.66 The Long Dark](#The_Long_Dark)
        *   [4.66.1 Game does not start](#Game_does_not_start_8)
        *   [4.66.2 Game starts, but some overlay text is missing and cutscenes shows black screen](#Game_starts.2C_but_some_overlay_text_is_missing_and_cutscenes_shows_black_screen)
        *   [4.66.3 Cutscenes are still black](#Cutscenes_are_still_black)
        *   [4.66.4 Cursor disappears](#Cursor_disappears)
    *   [4.67 Magicka 2](#Magicka_2)
        *   [4.67.1 Indefinitely stuck at start](#Indefinitely_stuck_at_start)
    *   [4.68 Mark of the Ninja](#Mark_of_the_Ninja)
        *   [4.68.1 Bad sound](#Bad_sound)
    *   [4.69 Metro: Last Light](#Metro:_Last_Light)
    *   [4.70 Metro: 2033 Redux](#Metro:_2033_Redux)
        *   [4.70.1 No sound](#No_sound_5)
    *   [4.71 Middle-earth: Shadow of Mordor](#Middle-earth:_Shadow_of_Mordor)
        *   [4.71.1 Floating heads](#Floating_heads)
    *   [4.72 Mount & Blade: Warband](#Mount_.26_Blade:_Warband)
        *   [4.72.1 Segmentation fault (core dumped) with wayland](#Segmentation_fault_.28core_dumped.29_with_wayland)
        *   [4.72.2 DLC Chooser](#DLC_Chooser)
    *   [4.73 Multiwinia](#Multiwinia)
        *   [4.73.1 Crash on startup](#Crash_on_startup)
    *   [4.74 Natural Selection 2](#Natural_Selection_2)
    *   [4.75 Nuclear Throne](#Nuclear_Throne)
        *   [4.75.1 Missing libcurl.so.4 or version CURL_OPENSSL_3 not found](#Missing_libcurl.so.4_or_version_CURL_OPENSSL_3_not_found_2)
    *   [4.76 Oxygen Not Included](#Oxygen_Not_Included)
        *   [4.76.1 World generation hangs](#World_generation_hangs)
    *   [4.77 Penumbra: Overture](#Penumbra:_Overture)
        *   [4.77.1 Windowed mode](#Windowed_mode_2)
    *   [4.78 The Polynomial](#The_Polynomial)
        *   [4.78.1 Segfaults during program start on 64-bit systems](#Segfaults_during_program_start_on_64-bit_systems)
    *   [4.79 Portal 2](#Portal_2)
        *   [4.79.1 Game does not start](#Game_does_not_start_9)
        *   [4.79.2 Resolution too low](#Resolution_too_low)
        *   [4.79.3 Missing non Latin font](#Missing_non_Latin_font)
    *   [4.80 Prison Architect](#Prison_Architect)
        *   [4.80.1 ALSA error when using PulseAudio](#ALSA_error_when_using_PulseAudio)
    *   [4.81 Project Zomboid](#Project_Zomboid)
        *   [4.81.1 No sound](#No_sound_6)
    *   [4.82 Pyre](#Pyre)
        *   [4.82.1 Game does not start](#Game_does_not_start_10)
    *   [4.83 Redshirt](#Redshirt)
    *   [4.84 Revenge of the Titans](#Revenge_of_the_Titans)
    *   [4.85 Risk of Rain](#Risk_of_Rain)
    *   [4.86 Rock Boshers DX: Directors Cut](#Rock_Boshers_DX:_Directors_Cut)
    *   [4.87 Saints Row IV](#Saints_Row_IV)
        *   [4.87.1 Game fails to launch after update to new Nvidia drivers](#Game_fails_to_launch_after_update_to_new_Nvidia_drivers)
        *   [4.87.2 Game causes GPU lockup with mesa drivers](#Game_causes_GPU_lockup_with_mesa_drivers)
    *   [4.88 Serious Sam 3: BFE](#Serious_Sam_3:_BFE)
        *   [4.88.1 No audio](#No_audio_2)
    *   [4.89 Slay the Spire](#Slay_the_Spire)
    *   [4.90 Songbringer](#Songbringer)
        *   [4.90.1 Launch error with wanyland](#Launch_error_with_wanyland)
    *   [4.91 Space Pirates and Zombies](#Space_Pirates_and_Zombies)
        *   [4.91.1 No audio](#No_audio_3)
    *   [4.92 Spacechem](#Spacechem)
        *   [4.92.1 Game crash](#Game_crash)
    *   [4.93 Splice](#Splice)
    *   [4.94 The Stanley Parable](#The_Stanley_Parable)
        *   [4.94.1 Game won't start](#Game_won.27t_start)
    *   [4.95 Shadow Tactics: Blades of the Shogun](#Shadow_Tactics:_Blades_of_the_Shogun)
    *   [4.96 Steel Storm: Burning Retribution](#Steel_Storm:_Burning_Retribution)
        *   [4.96.1 Start with black screen](#Start_with_black_screen)
    *   [4.97 Stephen's Sausage Roll](#Stephen.27s_Sausage_Roll)
        *   [4.97.1 No sound](#No_sound_7)
    *   [4.98 Superbrothers: Sword & Sworcery EP](#Superbrothers:_Sword_.26_Sworcery_EP)
    *   [4.99 System Shock 2](#System_Shock_2)
    *   [4.100 Tabletop Simulator](#Tabletop_Simulator)
        *   [4.100.1 CJK characters not showing in game](#CJK_characters_not_showing_in_game)
    *   [4.101 Team Fortress 2](#Team_Fortress_2)
        *   [4.101.1 HRTF setup](#HRTF_setup)
        *   [4.101.2 Loading screen freeze](#Loading_screen_freeze)
        *   [4.101.3 No audio](#No_audio_4)
        *   [4.101.4 Slow loading textures](#Slow_loading_textures)
    *   [4.102 Terraria](#Terraria)
    *   [4.103 This War of Mine](#This_War_of_Mine)
        *   [4.103.1 Game does not start](#Game_does_not_start_11)
        *   [4.103.2 Sound glitches with Steam native](#Sound_glitches_with_Steam_native)
    *   [4.104 Ticket to Ride](#Ticket_to_Ride)
    *   [4.105 Tomb Raider](#Tomb_Raider)
        *   [4.105.1 Game immediately closes when running with steam-native](#Game_immediately_closes_when_running_with_steam-native)
        *   [4.105.2 Steam Controller not working in-game](#Steam_Controller_not_working_in-game)
    *   [4.106 Tower Unite](#Tower_Unite)
        *   [4.106.1 Graphical Glitches](#Graphical_Glitches)
    *   [4.107 Towns / Towns Demo](#Towns_.2F_Towns_Demo)
    *   [4.108 Transistor](#Transistor)
        *   [4.108.1 Crash on launch / FMOD binding crash / audio issues](#Crash_on_launch_.2F_FMOD_binding_crash_.2F_audio_issues)
    *   [4.109 Transmissions: Element 120](#Transmissions:_Element_120)
        *   [4.109.1 Troubleshooting](#Troubleshooting)
    *   [4.110 Trine 2](#Trine_2)
        *   [4.110.1 Colors](#Colors)
        *   [4.110.2 Sound](#Sound)
        *   [4.110.3 Resolution](#Resolution)
    *   [4.111 Tropico 5](#Tropico_5)
        *   [4.111.1 Blank screen with sound only on startup](#Blank_screen_with_sound_only_on_startup)
    *   [4.112 Unity of Command](#Unity_of_Command)
        *   [4.112.1 Squares](#Squares)
        *   [4.112.2 No audio](#No_audio_5)
    *   [4.113 Unity3D](#Unity3D)
        *   [4.113.1 Locale settings](#Locale_settings)
        *   [4.113.2 Unity 5 sound problems](#Unity_5_sound_problems)
        *   [4.113.3 Game launching on wrong monitor in fullscreen mode](#Game_launching_on_wrong_monitor_in_fullscreen_mode)
        *   [4.113.4 Chinese/Japanese/Korean display bug](#Chinese.2FJapanese.2FKorean_display_bug)
    *   [4.114 Unrest](#Unrest)
    *   [4.115 Volgarr the Viking](#Volgarr_the_Viking)
    *   [4.116 War Thunder](#War_Thunder)
        *   [4.116.1 No audio](#No_audio_6)
        *   [4.116.2 Blank screen](#Blank_screen)
    *   [4.117 Warhammer 40,000: Dawn of War II](#Warhammer_40.2C000:_Dawn_of_War_II)
    *   [4.118 We Were Here](#We_Were_Here)
        *   [4.118.1 Stuck on black screen or logo on launch](#Stuck_on_black_screen_or_logo_on_launch)
    *   [4.119 Worms W.M.D](#Worms_W.M.D)
    *   [4.120 Witcher 2: Assassin of Kings](#Witcher_2:_Assassin_of_Kings)
        *   [4.120.1 Game does not start](#Game_does_not_start_12)
    *   [4.121 Wizardry 6: Bane of the Cosmic Forge](#Wizardry_6:_Bane_of_the_Cosmic_Forge)
    *   [4.122 World of Goo](#World_of_Goo)
        *   [4.122.1 Changing resolution](#Changing_resolution)
    *   [4.123 X3: Terran Conflict](#X3:_Terran_Conflict)
        *   [4.123.1 Game crashes on startup](#Game_crashes_on_startup)
    *   [4.124 XCOM](#XCOM)
        *   [4.124.1 Hangs on startup](#Hangs_on_startup)
        *   [4.124.2 Graphical glitches on Intel HD](#Graphical_glitches_on_Intel_HD)

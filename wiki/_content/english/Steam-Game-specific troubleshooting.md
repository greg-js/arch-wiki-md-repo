...
*   [17 Civilization VI](#Civilization_VI)
    *   [17.1 Extra LD_PRELOAD variable](#Extra_LD_PRELOAD_variable_2)
*   [18 The Clockwork Man](#The_Clockwork_Man)
    *   [18.1 Dependencies](#Dependencies_7)
*   [19 Company of Heroes 2](#Company_of_Heroes_2)
*   [20 Counter-Strike: Global Offensive (CS:GO)](#Counter-Strike:_Global_Offensive_.28CS:GO.29)
    *   [20.1 Game runs on the wrong screen](#Game_runs_on_the_wrong_screen)
...
*   [21 Crusader Kings II](#Crusader_Kings_II)
    ...
    *   [21.3 No audio](#No_audio)
    *   [21.4 Odd Sized Starting Window](#Odd_Sized_Starting_Window)
*   [22 Death Road To Canada](#Death_Road_To_Canada)
    *   [22.1 No music](#No_music)
*   [23 Defender's Quest: Valley of the Forgotten](#Defender.27s_Quest:_Valley_of_the_Forgotten)
    *   [23.1 Dependencies](#Dependencies_8)
    *   [23.2 Game does not start](#Game_does_not_start)
*   [24 Divinity: Original Sin - Enhanced Edition](#Divinity:_Original_Sin_-_Enhanced_Edition)
    *   [24.1 Game doesn't start when using Bumblebee optirun or primusrun](#Game_doesn.27t_start_when_using_Bumblebee_optirun_or_primusrun)
*   [25 Don't Starve](#Don.27t_Starve)
    *   [25.1 Dependencies](#Dependencies_9)
    *   [25.2 No sound](#No_sound_2)
*   [26 Dota 2](#Dota_2)
    *   [26.1 Dependencies](#Dependencies_10)
    *   [26.2 In-game font is unreadable](#In-game_font_is_unreadable)
    *   [26.3 Everything seems OK but the game doesn't start](#Everything_seems_OK_but_the_game_doesn.27t_start)
    *   [26.4 Game runs on the wrong screen](#Game_runs_on_the_wrong_screen_2)
    *   [26.5 Game does not start with libxcb-dri3 error message](#Game_does_not_start_with_libxcb-dri3_error_message)
    *   [26.6 Steam overlay](#Steam_overlay)
    *   [26.7 Chinese Tips and player's name display problem](#Chinese_Tips_and_player.27s_name_display_problem)
    *   [26.8 Chinese input method problem](#Chinese_input_method_problem)
*   [27 Dwarfs F2P](#Dwarfs_F2P)
    *   [27.1 Dependencies](#Dependencies_11)
    *   [27.2 Game does not start](#Game_does_not_start_2)
    *   [27.3 Game crashes](#Game_crashes)
*   [28 Dynamite Jack](#Dynamite_Jack)
    *   [28.1 Dependencies](#Dependencies_12)
    *   [28.2 Sound Issues](#Sound_Issues)
    *   [28.3 Game does not start](#Game_does_not_start_3)
*   [29 Euro Truck Simulator 2](#Euro_Truck_Simulator_2)
    *   [29.1 Shows only a black screen](#Shows_only_a_black_screen)
*   [30 Football Manager 2014](#Football_Manager_2014)
*   [31 FORCED](#FORCED)
    *   [31.1 Dependencies](#Dependencies_13)
*   [32 FTL: Faster than Light](#FTL:_Faster_than_Light)
    *   [32.1 Dependencies](#Dependencies_14)
    *   [32.2 Compatibility](#Compatibility_3)
    *   [32.3 Problems with open-source video driver](#Problems_with_open-source_video_driver)
*   [33 Game Dev Tycoon](#Game_Dev_Tycoon)
    *   [33.1 Game does not start](#Game_does_not_start_4)
*   [34 Garry's Mod](#Garry.27s_Mod)
    *   [34.1 Game does not start](#Game_does_not_start_5)
    *   [34.2 Opening some menus causes the game to crash](#Opening_some_menus_causes_the_game_to_crash)
    *   [34.3 Game crashes after attempting to join server](#Game_crashes_after_attempting_to_join_server)
*   [35 GRID Autosport](#GRID_Autosport)
    *   [35.1 Game does not start (Black screen)](#Game_does_not_start_.28Black_screen.29)
*   [36 Hack 'n' Slash](#Hack_.27n.27_Slash)
    *   [36.1 The game starts but craches when loading a new or saved game](#The_game_starts_but_craches_when_loading_a_new_or_saved_game)
*   [37 Hacker Evolution [Untold, Duality]](#Hacker_Evolution_.5BUntold.2C_Duality.5D)
    *   [37.1 Dependencies](#Dependencies_15)
*   [38 Half-Life 2 and episodes](#Half-Life_2_and_episodes)
    *   [38.1 Cyrillic fonts problem](#Cyrillic_fonts_problem)
*   [39 Hammerwatch](#Hammerwatch)
    *   [39.1 The game not starting from Steam GUI](#The_game_not_starting_from_Steam_GUI)
    *   [39.2 No sound](#No_sound_3)
*   [40 Halo: Custom Edition](#Halo:_Custom_Edition)
*   [41 Harvest: Massive Encounter](#Harvest:_Massive_Encounter)
    *   [41.1 Dependencies](#Dependencies_16)
    *   [41.2 Compatibility](#Compatibility_4)
*   [42 Hatoful Boyfriend](#Hatoful_Boyfriend)
    *   [42.1 Japanese text invisible](#Japanese_text_invisible)
*   [43 Hyper Light Drifter](#Hyper_Light_Drifter)
    *   [43.1 The controller doesn't work](#The_controller_doesn.27t_work)
*   [44 The Impossible Game](#The_Impossible_Game)
    *   [44.1 Dependencies](#Dependencies_17)
*   [45 The Inner World](#The_Inner_World)
    *   [45.1 Bringing up the inventory or main menu](#Bringing_up_the_inventory_or_main_menu)
    *   [45.2 Dependencies](#Dependencies_18)
        *   [45.2.1 Sound support](#Sound_support)
        *   [45.2.2 Cutscenes](#Cutscenes)
*   [46 Interloper](#Interloper)
    *   [46.1 Dependencies](#Dependencies_19)
    *   [46.2 Game does not launch](#Game_does_not_launch)
*   [47 Invisible Apartment](#Invisible_Apartment)
    *   [47.1 Dependencies](#Dependencies_20)
    *   [47.2 Game does not run](#Game_does_not_run)
*   [48 Joe Danger 2: The Movie](#Joe_Danger_2:_The_Movie)
    *   [48.1 Dependencies](#Dependencies_21)
    *   [48.2 Compatibility](#Compatibility_5)
*   [49 Kerbal Space Program](#Kerbal_Space_Program)
*   [50 Killing Floor](#Killing_Floor)
    *   [50.1 Screen resolution](#Screen_resolution)
    *   [50.2 Windowed mode](#Windowed_mode)
    *   [50.3 Stuttering Sound](#Stuttering_Sound)
*   [51 Lethal League](#Lethal_League)
    *   [51.1 Dependencies](#Dependencies_22)
*   [52 Life is Strange](#Life_is_Strange)
    *   [52.1 Dependencies](#Dependencies_23)
*   [53 Mark of the Ninja](#Mark_of_the_Ninja)
    *   [53.1 Bad sound](#Bad_sound)
*   [54 Metro: Last Light](#Metro:_Last_Light)
    *   [54.1 Attempted fixes](#Attempted_fixes)
    *   [54.2 Hacky solution](#Hacky_solution)
    *   [54.3 Possible solutions](#Possible_solutions)
*   [55 Middle-earth: Shadow of Mordor](#Middle-earth:_Shadow_of_Mordor)
    *   [55.1 Floating heads](#Floating_heads)
*   [56 Multiwinia](#Multiwinia)
    *   [56.1 Dependencies](#Dependencies_24)
    *   [56.2 Crash on startup](#Crash_on_startup)
*   [57 Natural Selection 2](#Natural_Selection_2)
    *   [57.1 No Sound](#No_Sound_4)
*   [58 Penumbra: Overture](#Penumbra:_Overture)
    *   [58.1 Dependencies](#Dependencies_25)
    *   [58.2 Windowed mode](#Windowed_mode_2)
*   [59 The Polynomial](#The_Polynomial)
    *   [59.1 Dependencies](#Dependencies_26)
    *   [59.2 Segfaults during program start on 64-bit systems](#Segfaults_during_program_start_on_64-bit_systems)
*   [60 Portal 2](#Portal_2)
    *   [60.1 Game does not start](#Game_does_not_start_6)
    *   [60.2 resolution too low](#resolution_too_low)
*   [61 Prison Architect](#Prison_Architect)
    *   [61.1 ALSA error when using PulseAudio](#ALSA_error_when_using_PulseAudio)
*   [62 Project Zomboid](#Project_Zomboid)
    *   [62.1 Dependencies](#Dependencies_27)
    *   [62.2 No sound](#No_sound_5)
*   [63 Redshirt](#Redshirt)
    *   [63.1 Dependencies](#Dependencies_28)
*   [64 Revenge of the Titans](#Revenge_of_the_Titans)
    *   [64.1 Dependencies](#Dependencies_29)
*   [65 Rock Boshers DX: Directors Cut](#Rock_Boshers_DX:_Directors_Cut)
    *   [65.1 Dependencies](#Dependencies_30)
*   [66 Saints Row IV](#Saints_Row_IV)
...
*   [81 Ticket to Ride](#Ticket_to_Ride)
    *   [81.1 Dependencies](#Dependencies_37)
...
*   [85 Transmissions: Element 120](#Transmissions:_Element_120)
    ...
    *   [85.2 Dependencies](#Dependencies_38)
*   [86 Trine 2](#Trine_2)
    *   [86.1 Dependencies](#Dependencies_39)
    *   [86.2 Colors](#Colors)
    *   [86.3 Sound](#Sound)
...
*   [88 Unity of Command](#Unity_of_Command)
    *   [88.1 Dependencies](#Dependencies_40)
...
*   [90 Unrest](#Unrest)
    *   [90.1 Dependencies](#Dependencies_41)

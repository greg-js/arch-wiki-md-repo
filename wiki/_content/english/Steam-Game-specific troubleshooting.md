...
*   [16 The Clockwork Man](#The_Clockwork_Man)
    *   [16.1 Dependencies](#Dependencies_7)
*   [17 Company of Heroes 2](#Company_of_Heroes_2)
*   [18 Counter-Strike: Global Offensive (CS:GO)](#Counter-Strike:_Global_Offensive_.28CS:GO.29)
    *   [18.1 Game runs on the wrong screen](#Game_runs_on_the_wrong_screen)
    *   [18.2 Cannot reach bottom of the screen on menues](#Cannot_reach_bottom_of_the_screen_on_menues)
    *   [18.3 Audio is not synced](#Audio_is_not_synced)
    *   [18.4 Unable to aim when in game](#Unable_to_aim_when_in_game)
    *   [18.5 Mouse Deadzone](#Mouse_Deadzone)
    *   [18.6 Low Performance on AMD card using Catalyst proprietary driver ( <= 15.7 )](#Low_Performance_on_AMD_card_using_Catalyst_proprietary_driver_.28_.3C.3D_15.7_.29)
    *   [18.7 Brightness slider not working](#Brightness_slider_not_working)
*   [19 Crusader Kings II](#Crusader_Kings_II)
    *   [19.1 Dependencies (x86_64)](#Dependencies_.28x86_64.29)
    *   [19.2 Tips and tricks](#Tips_and_tricks)
    *   [19.3 No audio](#No_audio)
    *   [19.4 Odd Sized Starting Window](#Odd_Sized_Starting_Window)
*   [20 Death Road To Canada](#Death_Road_To_Canada)
    *   [20.1 No music](#No_music)
*   [21 Defender's Quest: Valley of the Forgotten](#Defender.27s_Quest:_Valley_of_the_Forgotten)
    *   [21.1 Dependencies](#Dependencies_8)
    *   [21.2 Game does not start](#Game_does_not_start)
*   [22 Divinity: Original Sin - Enhanced Edition](#Divinity:_Original_Sin_-_Enhanced_Edition)
    *   [22.1 Game doesn't start when using Bumblebee optirun or primusrun](#Game_doesn.27t_start_when_using_Bumblebee_optirun_or_primusrun)
*   [23 Don't Starve](#Don.27t_Starve)
...
*   [24 Dota 2](#Dota_2)
    ...
    *   [24.5 Game does not start with libxcb-dri3 error message](#Game_does_not_start_with_libxcb-dri3_error_message)
    *   [24.6 Steam overlay](#Steam_overlay)
    *   [24.7 Chinese Tips and player's name display problem](#Chinese_Tips_and_player.27s_name_display_problem)
    *   [24.8 Chinese input method problem](#Chinese_input_method_problem)
*   [25 Dwarfs F2P](#Dwarfs_F2P)
    *   [25.1 Dependencies](#Dependencies_11)
    *   [25.2 Game does not start](#Game_does_not_start_2)
    *   [25.3 Game crashes](#Game_crashes)
*   [26 Dynamite Jack](#Dynamite_Jack)
    *   [26.1 Dependencies](#Dependencies_12)
    *   [26.2 Sound Issues](#Sound_Issues)
    *   [26.3 Game does not start](#Game_does_not_start_3)
*   [27 Football Manager 2014](#Football_Manager_2014)
*   [28 FORCED](#FORCED)
    *   [28.1 Dependencies](#Dependencies_13)
*   [29 FTL: Faster than Light](#FTL:_Faster_than_Light)
    *   [29.1 Dependencies](#Dependencies_14)
    *   [29.2 Compatibility](#Compatibility_3)
    *   [29.3 Problems with open-source video driver](#Problems_with_open-source_video_driver)
*   [30 Game Dev Tycoon](#Game_Dev_Tycoon)
    *   [30.1 Game does not start](#Game_does_not_start_4)
*   [31 Garry's Mod](#Garry.27s_Mod)
    *   [31.1 Game does not start](#Game_does_not_start_5)
    *   [31.2 Opening some menus causes the game to crash](#Opening_some_menus_causes_the_game_to_crash)
    *   [31.3 Game crashes after attempting to join server](#Game_crashes_after_attempting_to_join_server)
*   [32 Hack 'n' Slash](#Hack_.27n.27_Slash)
    *   [32.1 The game starts but craches when loading a new or saved game](#The_game_starts_but_craches_when_loading_a_new_or_saved_game)
*   [33 Hacker Evolution [Untold, Duality]](#Hacker_Evolution_.5BUntold.2C_Duality.5D)
    *   [33.1 Dependencies](#Dependencies_15)
*   [34 Half-Life 2 and episodes](#Half-Life_2_and_episodes)
    *   [34.1 Cyrillic fonts problem](#Cyrillic_fonts_problem)
*   [35 Hammerwatch](#Hammerwatch)
    *   [35.1 The game not starting from Steam GUI](#The_game_not_starting_from_Steam_GUI)
    *   [35.2 No sound](#No_sound_3)
*   [36 Harvest: Massive Encounter](#Harvest:_Massive_Encounter)
    *   [36.1 Dependencies](#Dependencies_16)
    *   [36.2 Compatibility](#Compatibility_4)
*   [37 Hatoful Boyfriend](#Hatoful_Boyfriend)
    *   [37.1 Japanese text invisible](#Japanese_text_invisible)
*   [38 The Impossible Game](#The_Impossible_Game)
    *   [38.1 Dependencies](#Dependencies_17)
*   [39 The Inner World](#The_Inner_World)
    *   [39.1 Bringing up the inventory or main menu](#Bringing_up_the_inventory_or_main_menu)
    *   [39.2 Dependencies](#Dependencies_18)
        *   [39.2.1 Sound support](#Sound_support)
        *   [39.2.2 Cutscenes](#Cutscenes)
*   [40 Interloper](#Interloper)
    *   [40.1 Dependencies](#Dependencies_19)
    *   [40.2 Game does not launch](#Game_does_not_launch)
*   [41 Invisible Apartment](#Invisible_Apartment)
    *   [41.1 Dependencies](#Dependencies_20)
    *   [41.2 Game does not run](#Game_does_not_run)
*   [42 Joe Danger 2: The Movie](#Joe_Danger_2:_The_Movie)
    *   [42.1 Dependencies](#Dependencies_21)
    *   [42.2 Compatibility](#Compatibility_5)
*   [43 Kerbal Space Program](#Kerbal_Space_Program)
*   [44 Killing Floor](#Killing_Floor)
    *   [44.1 Screen resolution](#Screen_resolution)
    *   [44.2 Windowed mode](#Windowed_mode)
    *   [44.3 Stuttering Sound](#Stuttering_Sound)
*   [45 Lethal League](#Lethal_League)
    *   [45.1 Dependencies](#Dependencies_22)
*   [46 Life is Strange](#Life_is_Strange)
    *   [46.1 Dependencies](#Dependencies_23)
*   [47 Mark of the Ninja](#Mark_of_the_Ninja)
    *   [47.1 Bad sound](#Bad_sound)
*   [48 Metro: Last Light](#Metro:_Last_Light)
    *   [48.1 Attempted fixes](#Attempted_fixes)
    *   [48.2 Hacky solution](#Hacky_solution)
    *   [48.3 Possible solutions](#Possible_solutions)
*   [49 Middle-earth: Shadow of Mordor](#Middle-earth:_Shadow_of_Mordor)
    *   [49.1 Floating heads](#Floating_heads)
*   [50 Multiwinia](#Multiwinia)
    *   [50.1 Dependencies](#Dependencies_24)
    *   [50.2 Crash on startup](#Crash_on_startup)
*   [51 Natural Selection 2](#Natural_Selection_2)
    *   [51.1 No Sound](#No_Sound_4)
*   [52 Penumbra: Overture](#Penumbra:_Overture)
    *   [52.1 Dependencies](#Dependencies_25)
    *   [52.2 Windowed mode](#Windowed_mode_2)
*   [53 The Polynomial](#The_Polynomial)
    *   [53.1 Dependencies](#Dependencies_26)
    *   [53.2 Segfaults during program start on 64-bit systems](#Segfaults_during_program_start_on_64-bit_systems)
*   [54 Portal 2](#Portal_2)
    *   [54.1 Game does not start](#Game_does_not_start_6)
*   [55 Prison Architect](#Prison_Architect)
    *   [55.1 ALSA error when using PulseAudio](#ALSA_error_when_using_PulseAudio)
*   [56 Project Zomboid](#Project_Zomboid)
    *   [56.1 Dependencies](#Dependencies_27)
    *   [56.2 No sound](#No_sound_5)
*   [57 Redshirt](#Redshirt)
    *   [57.1 Dependencies](#Dependencies_28)
*   [58 Revenge of the Titans](#Revenge_of_the_Titans)
    *   [58.1 Dependencies](#Dependencies_29)
*   [59 Rock Boshers DX: Directors Cut](#Rock_Boshers_DX:_Directors_Cut)
    *   [59.1 Dependencies](#Dependencies_30)
*   [60 Saints Row IV](#Saints_Row_IV)
    *   [60.1 Game fails to launch after update to new Nvidia drivers](#Game_fails_to_launch_after_update_to_new_Nvidia_drivers)
    *   [60.2 Game causes GPU lockup with mesa drivers](#Game_causes_GPU_lockup_with_mesa_drivers)
*   [61 Serious Sam 3: BFE](#Serious_Sam_3:_BFE)
    *   [61.1 Dependencies](#Dependencies_31)
    *   [61.2 No audio](#No_audio_2)
*   [62 Sir, You Are Being Hunted](#Sir.2C_You_Are_Being_Hunted)
    *   [62.1 Dependencies](#Dependencies_32)
*   [63 Space Pirates and Zombies](#Space_Pirates_and_Zombies)
    *   [63.1 Dependencies](#Dependencies_33)
    *   [63.2 No audio](#No_audio_3)
*   [64 Spacechem](#Spacechem)
    *   [64.1 Dependencies](#Dependencies_34)
    *   [64.2 Game crash](#Game_crash)
*   [65 Splice](#Splice)
    *   [65.1 Dependencies](#Dependencies_35)
*   [66 Star Wars Battlefront II](#Star_Wars_Battlefront_II)
*   [67 The Stanley Parable](#The_Stanley_Parable)
    *   [67.1 Game won't start](#Game_won.27t_start)
*   [68 Steel Storm: Burning Retribution](#Steel_Storm:_Burning_Retribution)
    *   [68.1 Start with black screen](#Start_with_black_screen)
    *   [68.2 No English fonts](#No_English_fonts)
*   [69 Stephen's Sausage Roll](#Stephen.27s_Sausage_Roll)
    *   [69.1 No sound](#No_sound_6)
*   [70 Strike Suite Zero](#Strike_Suite_Zero)
    *   [70.1 Dependencies](#Dependencies_36)
*   [71 Superbrothers: Sword & Sworcery EP](#Superbrothers:_Sword_.26_Sworcery_EP)
    *   [71.1 Dependencies](#Dependencies_37)
*   [72 Tabletop Simulator](#Tabletop_Simulator)
    *   [72.1 CJK characters not showing in game](#CJK_characters_not_showing_in_game)
*   [73 Team Fortress 2](#Team_Fortress_2)
    *   [73.1 Dependencies](#Dependencies_38)
    *   [73.2 Making HRTF work](#Making_HRTF_work)
    *   [73.3 Loading screen freeze](#Loading_screen_freeze)
    *   [73.4 No audio](#No_audio_4)
    *   [73.5 Slow loading textures](#Slow_loading_textures)
*   [74 Terraria](#Terraria)
*   [75 This War of Mine](#This_War_of_Mine)
    *   [75.1 Game doesn't load](#Game_doesn.27t_load)
*   [76 Tomb Raider](#Tomb_Raider)
    *   [76.1 Game immediately closes when running with steam-native](#Game_immediately_closes_when_running_with_steam-native)
    *   [76.2 Steam Controller not working ingame while being correctly recognised* by Steam outside of the game](#Steam_Controller_not_working_ingame_while_being_correctly_recognised.2A_by_Steam_outside_of_the_game)
*   [77 Towns / Towns Demo](#Towns_.2F_Towns_Demo)
    *   [77.1 Crash on launch](#Crash_on_launch)
*   [78 Transistor](#Transistor)
    *   [78.1 Crash on launch / FMOD binding crash / Audio issues](#Crash_on_launch_.2F_FMOD_binding_crash_.2F_Audio_issues)
*   [79 Transmissions: Element 120](#Transmissions:_Element_120)
    *   [79.1 Troubleshooting](#Troubleshooting)
    *   [79.2 Dependencies](#Dependencies_39)
*   [80 Trine 2](#Trine_2)
    *   [80.1 Dependencies](#Dependencies_40)
    *   [80.2 Colors](#Colors)
    *   [80.3 Sound](#Sound)
    *   [80.4 Resolution](#Resolution)
*   [81 Unity of Command](#Unity_of_Command)
    *   [81.1 Dependencies](#Dependencies_41)
    *   [81.2 Squares](#Squares)
    *   [81.3 No audio](#No_audio_5)
*   [82 Unity3D](#Unity3D)
    *   [82.1 Locale Settings](#Locale_Settings)
    *   [82.2 Unity 5 sound problems](#Unity_5_sound_problems)
    *   [82.3 Game launching on wrong monitor in fullscreen mode](#Game_launching_on_wrong_monitor_in_fullscreen_mode)
*   [83 Unrest](#Unrest)
    *   [83.1 Dependencies](#Dependencies_42)
*   [84 War Thunder](#War_Thunder)
    *   [84.1 Blank screen](#Blank_screen)
*   [85 Warhammer 40,000: Dawn of War II](#Warhammer_40.2C000:_Dawn_of_War_II)
    *   [85.1 Dependencies](#Dependencies_43)
    *   [85.2 Blank screen](#Blank_screen_2)
*   [86 Witcher 2: Assassin of Kings](#Witcher_2:_Assassin_of_Kings)
    *   [86.1 Dependencies](#Dependencies_44)
    *   [86.2 Game does not start](#Game_does_not_start_7)
*   [87 Wizardry 6: Bane of the Cosmic Forge](#Wizardry_6:_Bane_of_the_Cosmic_Forge)
    *   [87.1 Dependencies](#Dependencies_45)
*   [88 World of Goo](#World_of_Goo)
    *   [88.1 Changing resolution](#Changing_resolution)
*   [89 Worms Reloaded](#Worms_Reloaded)
    *   [89.1 Dependencies](#Dependencies_46)
*   [90 XCOM](#XCOM)
    *   [90.1 Dependencies](#Dependencies_47)
    *   [90.2 Hangs on startup](#Hangs_on_startup)
    *   [90.3 Graphical glitches on Intel HD](#Graphical_glitches_on_Intel_HD)

...
*   [18 Dota 2](#Dota_2)
    ...
    *   [18.3 Troubleshooting](#Troubleshooting_5)
        ...
        *   [18.3.2 Everything seems OK but the game doesn't start](#Everything_seems_OK_but_the_game_doesn.27t_start)
        *   [18.3.3 Game runs on the wrong screen](#Game_runs_on_the_wrong_screen_2)
        *   [18.3.4 Game does not start with libxcb-dri3 error message](#Game_does_not_start_with_libxcb-dri3_error_message)
        *   [18.3.5 Steam overlay](#Steam_overlay)
        *   [18.3.6 Chinese Tips and player's name display problem](#Chinese_Tips_and_player.27s_name_display_problem)
        *   [18.3.7 Chinese input method problem](#Chinese_input_method_problem)
*   [19 Dwarfs F2P](#Dwarfs_F2P)
    *   [19.1 Dependencies](#Dependencies_7)
    *   [19.2 Troubleshooting](#Troubleshooting_6)
        *   [19.2.1 Game does not start](#Game_does_not_start_2)
        *   [19.2.2 Game crashes](#Game_crashes)
*   [20 Dynamite Jack](#Dynamite_Jack)
    *   [20.1 Dependencies](#Dependencies_8)
    *   [20.2 Troubleshooting](#Troubleshooting_7)
        *   [20.2.1 Sound Issues](#Sound_Issues)
        *   [20.2.2 Game does not start](#Game_does_not_start_3)
*   [21 Football Manager 2014](#Football_Manager_2014)
*   [22 FORCED](#FORCED)
    *   [22.1 Dependencies](#Dependencies_9)
*   [23 FTL: Faster than Light](#FTL:_Faster_than_Light)
    *   [23.1 Dependencies](#Dependencies_10)
    *   [23.2 Compatibility](#Compatibility_3)
    *   [23.3 Problems with open-source video driver](#Problems_with_open-source_video_driver)
*   [24 Game Dev Tycoon](#Game_Dev_Tycoon)
    *   [24.1 Troubleshooting](#Troubleshooting_8)
        *   [24.1.1 Game does not start](#Game_does_not_start_4)
*   [25 Garry's Mod](#Garry.27s_Mod)
    *   [25.1 Troubleshooting](#Troubleshooting_9)
        *   [25.1.1 Game does not start](#Game_does_not_start_5)
        *   [25.1.2 Opening some menus causes the game to crash](#Opening_some_menus_causes_the_game_to_crash)
    *   [25.2 Game crashes after attempting to join server](#Game_crashes_after_attempting_to_join_server)
*   [26 Hack 'n' Slash](#Hack_.27n.27_Slash)
    *   [26.1 Troubleshooting](#Troubleshooting_10)
        *   [26.1.1 The game starts but craches when loading a new or saved game](#The_game_starts_but_craches_when_loading_a_new_or_saved_game)
*   [27 Hacker Evolution [Untold, Duality]](#Hacker_Evolution_.5BUntold.2C_Duality.5D)
    *   [27.1 Dependencies](#Dependencies_11)
*   [28 Half-Life 2 & episodes](#Half-Life_2_.26_episodes)
    *   [28.1 Cyrillic fonts problem](#Cyrillic_fonts_problem)
*   [29 Hammerwatch](#Hammerwatch)
    *   [29.1 Troubleshooting](#Troubleshooting_11)
        *   [29.1.1 The game not starting from Steam GUI](#The_game_not_starting_from_Steam_GUI)
        *   [29.1.2 No sound](#No_sound_3)
*   [30 Harvest: Massive Encounter](#Harvest:_Massive_Encounter)
    *   [30.1 Dependencies](#Dependencies_12)
    *   [30.2 Compatibility](#Compatibility_4)
*   [31 Hatoful Boyfriend](#Hatoful_Boyfriend)
    *   [31.1 Japanese text invisible](#Japanese_text_invisible)
*   [32 The inner world](#The_inner_world)
    *   [32.1 Bringing up the inventory or main menu](#Bringing_up_the_inventory_or_main_menu)
    *   [32.2 Dependencies](#Dependencies_13)
        *   [32.2.1 Sound support](#Sound_support)
        *   [32.2.2 Cutscenes](#Cutscenes)
*   [33 Interloper](#Interloper)
    *   [33.1 Dependencies](#Dependencies_14)
    *   [33.2 Game does not launch](#Game_does_not_launch)
*   [34 Invisible Apartment](#Invisible_Apartment)
    *   [34.1 Dependencies](#Dependencies_15)
    *   [34.2 Game does not run](#Game_does_not_run)
*   [35 Joe Danger 2: The Movie](#Joe_Danger_2:_The_Movie)
    *   [35.1 Dependencies](#Dependencies_16)
    *   [35.2 Compatibility](#Compatibility_5)
*   [36 Kerbal Space Program](#Kerbal_Space_Program)
    *   [36.1 Troubleshooting](#Troubleshooting_12)
    *   [36.2 Game never progresses past initial loading](#Game_never_progresses_past_initial_loading)
    *   [36.3 No text display](#No_text_display)
    *   [36.4 Graphics flickering when using primusrun](#Graphics_flickering_when_using_primusrun)
    *   [36.5 Game crashes when accessing settings or saves on 64 bit systems on Steam](#Game_crashes_when_accessing_settings_or_saves_on_64_bit_systems_on_Steam)
    *   [36.6 Locale settings](#Locale_settings)
    *   [36.7 No audio on 64-bit systems](#No_audio_on_64-bit_systems)
    *   [36.8 Black ingame textures](#Black_ingame_textures)
    *   [36.9 See also](#See_also)
*   [37 Killing Floor](#Killing_Floor)
    *   [37.1 Troubleshooting](#Troubleshooting_13)
        *   [37.1.1 Screen resolution](#Screen_resolution)
        *   [37.1.2 Windowed mode](#Windowed_mode)
        *   [37.1.3 Stuttering Sound](#Stuttering_Sound)
*   [38 Lethal League](#Lethal_League)
    *   [38.1 Dependencies](#Dependencies_17)
*   [39 Metro: Last Light](#Metro:_Last_Light)
    *   [39.1 Attempted fixes](#Attempted_fixes)
    *   [39.2 Hacky solution](#Hacky_solution)
    *   [39.3 Possible solutions](#Possible_solutions)

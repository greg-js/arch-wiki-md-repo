...
*   [4 Games](#Games)
    ...
    *   [4.14 Borderlands: The Pre-Sequel](#Borderlands:_The_Pre-Sequel)
        *   [4.14.1 Not starting via Steam](#Not_starting_via_Steam)
    ...
    *   [4.30 Dirt Rally](#Dirt_Rally)
    *   [4.31 Divinity: Original Sin - Enhanced Edition](#Divinity:_Original_Sin_-_Enhanced_Edition)
        *   [4.31.1 Game does not start when using Bumblebee optirun or primusrun](#Game_does_not_start_when_using_Bumblebee_optirun_or_primusrun)
        *   [4.31.2 Game does not work with amdgpu](#Game_does_not_work_with_amdgpu)
    *   [4.32 Don't Starve](#Don.27t_Starve)
        *   [4.32.1 No sound](#No_sound_3)
    *   [4.33 Dota 2](#Dota_2)
        *   [4.33.1 In-game font is unreadable](#In-game_font_is_unreadable)
        *   [4.33.2 Error with libpangoft2](#Error_with_libpangoft2)
        *   [4.33.3 The game does not start](#The_game_does_not_start)
        *   [4.33.4 Game runs on the wrong screen](#Game_runs_on_the_wrong_screen)
        *   [4.33.5 Game does not start with libxcb-dri3 error message](#Game_does_not_start_with_libxcb-dri3_error_message)
        *   [4.33.6 Steam overlay](#Steam_overlay)
        *   [4.33.7 Chinese tips and player names not shown](#Chinese_tips_and_player_names_not_shown)
        *   [4.33.8 Chinese input method problem](#Chinese_input_method_problem)
    *   [4.34 Devil Daggers](#Devil_Daggers)
    *   [4.35 Drox Operative](#Drox_Operative)
    *   [4.36 Dwarfs F2P](#Dwarfs_F2P)
        *   [4.36.1 Game does not start](#Game_does_not_start_2)
        *   [4.36.2 Game crashes](#Game_crashes)
    *   [4.37 Dynamite Jack](#Dynamite_Jack)
        *   [4.37.1 Sound Issues](#Sound_Issues)
        *   [4.37.2 Game does not start](#Game_does_not_start_3)
    *   [4.38 Euro Truck Simulator 2](#Euro_Truck_Simulator_2)
        *   [4.38.1 Shows only a black screen](#Shows_only_a_black_screen)
    *   [4.39 Football Manager 2014](#Football_Manager_2014)
    *   [4.40 FORCED](#FORCED)
    *   [4.41 FTL: Faster than Light](#FTL:_Faster_than_Light)
        *   [4.41.1 Compatibility](#Compatibility)
        *   [4.41.2 Problems with open-source video driver](#Problems_with_open-source_video_driver)
    *   [4.42 Game Dev Tycoon](#Game_Dev_Tycoon)
        *   [4.42.1 Game does not start](#Game_does_not_start_4)
    *   [4.43 Garry's Mod](#Garry.27s_Mod)
        *   [4.43.1 Game does not start](#Game_does_not_start_5)
        *   [4.43.2 Opening some menus causes the game to crash](#Opening_some_menus_causes_the_game_to_crash)
        *   [4.43.3 Game crashes after attempting to join server](#Game_crashes_after_attempting_to_join_server)
        *   [4.43.4 Black screen when trying to play](#Black_screen_when_trying_to_play)
    *   [4.44 Hack 'n' Slash](#Hack_.27n.27_Slash)
        *   [4.44.1 Crashes when trying to load a game](#Crashes_when_trying_to_load_a_game)
    *   [4.45 Hacker Evolution](#Hacker_Evolution)
    *   [4.46 Half-Life 2 and episodes](#Half-Life_2_and_episodes)
        *   [4.46.1 Cyrillic fonts problem](#Cyrillic_fonts_problem)
    *   [4.47 Hammerwatch](#Hammerwatch)
        *   [4.47.1 The game does not start via Steam](#The_game_does_not_start_via_Steam)
        *   [4.47.2 No sound](#No_sound_4)
    *   [4.48 Harvest: Massive Encounter](#Harvest:_Massive_Encounter)
        *   [4.48.1 Compatibility](#Compatibility_2)
    *   [4.49 Hatoful Boyfriend](#Hatoful_Boyfriend)
        *   [4.49.1 Japanese text invisible](#Japanese_text_invisible)
    *   [4.50 Hyper Light Drifter](#Hyper_Light_Drifter)
        *   [4.50.1 The controller does not work](#The_controller_does_not_work)
        *   [4.50.2 Missing libcurl.so.4 or version CURL_OPENSSL_3 not found](#Missing_libcurl.so.4_or_version_CURL_OPENSSL_3_not_found)
    *   [4.51 The Impossible Game](#The_Impossible_Game)
    *   [4.52 The Inner World](#The_Inner_World)
        *   [4.52.1 Bringing up the inventory or main menu](#Bringing_up_the_inventory_or_main_menu)
            *   [4.52.1.1 Cutscenes](#Cutscenes)
    *   [4.53 Interloper](#Interloper)
        *   [4.53.1 Game does not start](#Game_does_not_start_6)
    *   [4.54 Invisible Apartment](#Invisible_Apartment)
        *   [4.54.1 Game does not start](#Game_does_not_start_7)
    *   [4.55 Joe Danger 2: The Movie](#Joe_Danger_2:_The_Movie)
        *   [4.55.1 Compatibility](#Compatibility_3)
    *   [4.56 Kerbal Space Program](#Kerbal_Space_Program)
    *   [4.57 Killing Floor](#Killing_Floor)
        *   [4.57.1 Cannot change screen resolution](#Cannot_change_screen_resolution)
        *   [4.57.2 Windowed mode](#Windowed_mode)
        *   [4.57.3 Stuttering sound](#Stuttering_sound)
    *   [4.58 Left for Dead 2](#Left_for_Dead_2)
        *   [4.58.1 Missing Chinese font](#Missing_Chinese_font)
    *   [4.59 Lethal League](#Lethal_League)
    *   [4.60 Life is Strange](#Life_is_Strange)
    *   [4.61 Little Racers STREET](#Little_Racers_STREET)
    *   [4.62 The Long Dark](#The_Long_Dark)
        *   [4.62.1 Game does not start](#Game_does_not_start_8)
        *   [4.62.2 Game starts, but some overlay text is missing and cutscenes shows black screen](#Game_starts.2C_but_some_overlay_text_is_missing_and_cutscenes_shows_black_screen)
        *   [4.62.3 Cutscenes are still black](#Cutscenes_are_still_black)
        *   [4.62.4 Cursor disappears](#Cursor_disappears)
    *   [4.63 Magicka 2](#Magicka_2)
        *   [4.63.1 Indefinitely stuck at start](#Indefinitely_stuck_at_start)
    *   [4.64 Mark of the Ninja](#Mark_of_the_Ninja)
        *   [4.64.1 Bad sound](#Bad_sound)
    *   [4.65 Metro: Last Light](#Metro:_Last_Light)
    *   [4.66 Metro: 2033 Redux](#Metro:_2033_Redux)
        *   [4.66.1 No sound](#No_sound_5)
    *   [4.67 Middle-earth: Shadow of Mordor](#Middle-earth:_Shadow_of_Mordor)
        *   [4.67.1 Floating heads](#Floating_heads)
    *   [4.68 Mount & Blade: Warband](#Mount_.26_Blade:_Warband)
        *   [4.68.1 Segmentation fault (core dumped) with wayland](#Segmentation_fault_.28core_dumped.29_with_wayland)
        *   [4.68.2 DLC Chooser](#DLC_Chooser)
    *   [4.69 Multiwinia](#Multiwinia)
        *   [4.69.1 Crash on startup](#Crash_on_startup)
    *   [4.70 Natural Selection 2](#Natural_Selection_2)
    *   [4.71 Nuclear Throne](#Nuclear_Throne)
        *   [4.71.1 Missing libcurl.so.4 or version CURL_OPENSSL_3 not found](#Missing_libcurl.so.4_or_version_CURL_OPENSSL_3_not_found_2)
    *   [4.72 Penumbra: Overture](#Penumbra:_Overture)
        *   [4.72.1 Windowed mode](#Windowed_mode_2)
    *   [4.73 The Polynomial](#The_Polynomial)
        *   [4.73.1 Segfaults during program start on 64-bit systems](#Segfaults_during_program_start_on_64-bit_systems)
    *   [4.74 Portal 2](#Portal_2)
        *   [4.74.1 Game does not start](#Game_does_not_start_9)
        *   [4.74.2 Resolution too low](#Resolution_too_low)
        *   [4.74.3 Missing non Latin font](#Missing_non_Latin_font)
    *   [4.75 Prison Architect](#Prison_Architect)
        *   [4.75.1 ALSA error when using PulseAudio](#ALSA_error_when_using_PulseAudio)
    *   [4.76 Project Zomboid](#Project_Zomboid)
        *   [4.76.1 No sound](#No_sound_6)
    *   [4.77 Pyre](#Pyre)
        *   [4.77.1 Game does not start](#Game_does_not_start_10)
    *   [4.78 Redshirt](#Redshirt)
    *   [4.79 Revenge of the Titans](#Revenge_of_the_Titans)
    *   [4.80 Risk of Rain](#Risk_of_Rain)
    *   [4.81 Rock Boshers DX: Directors Cut](#Rock_Boshers_DX:_Directors_Cut)
    *   [4.82 Saints Row IV](#Saints_Row_IV)
        *   [4.82.1 Game fails to launch after update to new Nvidia drivers](#Game_fails_to_launch_after_update_to_new_Nvidia_drivers)
        *   [4.82.2 Game causes GPU lockup with mesa drivers](#Game_causes_GPU_lockup_with_mesa_drivers)
    *   [4.83 Serious Sam 3: BFE](#Serious_Sam_3:_BFE)
        *   [4.83.1 No audio](#No_audio_2)
    *   [4.84 Slay the Spire](#Slay_the_Spire)
    *   [4.85 Songbringer](#Songbringer)
        *   [4.85.1 Launch error with wanyland](#Launch_error_with_wanyland)
    *   [4.86 Space Pirates and Zombies](#Space_Pirates_and_Zombies)
        *   [4.86.1 No audio](#No_audio_3)
    *   [4.87 Spacechem](#Spacechem)
        *   [4.87.1 Game crash](#Game_crash)
    *   [4.88 Splice](#Splice)
    *   [4.89 The Stanley Parable](#The_Stanley_Parable)
        *   [4.89.1 Game won't start](#Game_won.27t_start)
    *   [4.90 Shadow Tactics: Blades of the Shogun](#Shadow_Tactics:_Blades_of_the_Shogun)
    *   [4.91 Steel Storm: Burning Retribution](#Steel_Storm:_Burning_Retribution)
        *   [4.91.1 Start with black screen](#Start_with_black_screen)
    *   [4.92 Stephen's Sausage Roll](#Stephen.27s_Sausage_Roll)
        *   [4.92.1 No sound](#No_sound_7)
    *   [4.93 Superbrothers: Sword & Sworcery EP](#Superbrothers:_Sword_.26_Sworcery_EP)
    *   [4.94 System Shock 2](#System_Shock_2)
    *   [4.95 Tabletop Simulator](#Tabletop_Simulator)
        *   [4.95.1 CJK characters not showing in game](#CJK_characters_not_showing_in_game)
    *   [4.96 Team Fortress 2](#Team_Fortress_2)
        *   [4.96.1 HRTF setup](#HRTF_setup)
        *   [4.96.2 Loading screen freeze](#Loading_screen_freeze)
        *   [4.96.3 No audio](#No_audio_4)
        *   [4.96.4 Slow loading textures](#Slow_loading_textures)
    *   [4.97 Terraria](#Terraria)
    *   [4.98 This War of Mine](#This_War_of_Mine)
        *   [4.98.1 Game does not start](#Game_does_not_start_11)
        *   [4.98.2 Sound glitches with Steam native](#Sound_glitches_with_Steam_native)
    *   [4.99 Ticket to Ride](#Ticket_to_Ride)
    *   [4.100 Tomb Raider](#Tomb_Raider)
        *   [4.100.1 Game immediately closes when running with steam-native](#Game_immediately_closes_when_running_with_steam-native)
        *   [4.100.2 Steam Controller not working in-game](#Steam_Controller_not_working_in-game)
    *   [4.101 Tower Unite](#Tower_Unite)
        *   [4.101.1 Graphical Glitches](#Graphical_Glitches)
    *   [4.102 Towns / Towns Demo](#Towns_.2F_Towns_Demo)
    *   [4.103 Transistor](#Transistor)
        *   [4.103.1 Crash on launch / FMOD binding crash / audio issues](#Crash_on_launch_.2F_FMOD_binding_crash_.2F_audio_issues)
    *   [4.104 Transmissions: Element 120](#Transmissions:_Element_120)
        *   [4.104.1 Troubleshooting](#Troubleshooting)
    *   [4.105 Trine 2](#Trine_2)
        *   [4.105.1 Colors](#Colors)
        *   [4.105.2 Sound](#Sound)
        *   [4.105.3 Resolution](#Resolution)
    *   [4.106 Tropico 5](#Tropico_5)
        *   [4.106.1 Blank screen with sound only on startup](#Blank_screen_with_sound_only_on_startup)
    *   [4.107 Unity of Command](#Unity_of_Command)
        *   [4.107.1 Squares](#Squares)
        *   [4.107.2 No audio](#No_audio_5)
    *   [4.108 Unity3D](#Unity3D)
        *   [4.108.1 Locale settings](#Locale_settings)
        *   [4.108.2 Unity 5 sound problems](#Unity_5_sound_problems)
        *   [4.108.3 Game launching on wrong monitor in fullscreen mode](#Game_launching_on_wrong_monitor_in_fullscreen_mode)
        *   [4.108.4 Chinese/Japanese/Korean display bug](#Chinese.2FJapanese.2FKorean_display_bug)
    *   [4.109 Unrest](#Unrest)
    *   [4.110 Volgarr the Viking](#Volgarr_the_Viking)
    *   [4.111 War Thunder](#War_Thunder)
        *   [4.111.1 No audio](#No_audio_6)
        *   [4.111.2 Blank screen](#Blank_screen)
    *   [4.112 Warhammer 40,000: Dawn of War II](#Warhammer_40.2C000:_Dawn_of_War_II)
    *   [4.113 Worms W.M.D](#Worms_W.M.D)
    *   [4.114 Witcher 2: Assassin of Kings](#Witcher_2:_Assassin_of_Kings)
        *   [4.114.1 Game does not start](#Game_does_not_start_12)
    *   [4.115 Wizardry 6: Bane of the Cosmic Forge](#Wizardry_6:_Bane_of_the_Cosmic_Forge)
    *   [4.116 World of Goo](#World_of_Goo)
        *   [4.116.1 Changing resolution](#Changing_resolution)
    *   [4.117 X3: Terran Conflict](#X3:_Terran_Conflict)
        *   [4.117.1 Game crashes on startup](#Game_crashes_on_startup)
    *   [4.118 XCOM](#XCOM)
        *   [4.118.1 Hangs on startup](#Hangs_on_startup)
        *   [4.118.2 Graphical glitches on Intel HD](#Graphical_glitches_on_Intel_HD)
...
*   Do not document problems without solutions.
...
Affected games: Dirt, Gods will be watching, GRID Autosport

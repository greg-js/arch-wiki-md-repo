...
*   [6 ARK: Survival Evolved](#ARK:_Survival_Evolved)
    *   [6.1 Game does not start, displays text window with unreadable text](#Game_does_not_start.2C_displays_text_window_with_unreadable_text)
*   [7 Audiosurf 2](#Audiosurf_2)
    *   [7.1 Dependencies](#Dependencies_5)
*   [8 Binding of Isaac: Rebirth](#Binding_of_Isaac:_Rebirth)
    *   [8.1 No sound](#No_sound)
*   [9 The Book of Unwritten Tales](#The_Book_of_Unwritten_Tales)
    *   [9.1 Dependencies](#Dependencies_6)
*   [10 The Book of Unwritten Tales: The Critter Chronicles](#The_Book_of_Unwritten_Tales:_The_Critter_Chronicles)
*   [11 Borderlands 2](#Borderlands_2)
    *   [11.1 Syncing save games](#Syncing_save_games)
    *   [11.2 Using Ctrl Key](#Using_Ctrl_Key)
...
*   [14 Cities Skylines](#Cities_Skylines)
    *   [14.1 Textures not rendering properly](#Textures_not_rendering_properly)
*   [15 Civilization V](#Civilization_V)
    *   [15.1 Stuttering sound with PulseAudio](#Stuttering_sound_with_PulseAudio)
    *   [15.2 Extra LD_PRELOAD variable](#Extra_LD_PRELOAD_variable)
*   [16 Civilization: Beyond earth](#Civilization:_Beyond_earth)
*   [17 The Clockwork Man](#The_Clockwork_Man)
    *   [17.1 Dependencies](#Dependencies_7)
*   [18 Company of Heroes 2](#Company_of_Heroes_2)
*   [19 Counter-Strike: Global Offensive (CS:GO)](#Counter-Strike:_Global_Offensive_.28CS:GO.29)
    *   [19.1 Game runs on the wrong screen](#Game_runs_on_the_wrong_screen)
...
*   [20 Crusader Kings II](#Crusader_Kings_II)
    *   [20.1 Dependencies (x86_64)](#Dependencies_.28x86_64.29)
    *   [20.2 Tips and tricks](#Tips_and_tricks)
    *   [20.3 No audio](#No_audio)
    *   [20.4 Odd Sized Starting Window](#Odd_Sized_Starting_Window)
*   [21 Death Road To Canada](#Death_Road_To_Canada)
    *   [21.1 No music](#No_music)
*   [22 Defender's Quest: Valley of the Forgotten](#Defender.27s_Quest:_Valley_of_the_Forgotten)
    *   [22.1 Dependencies](#Dependencies_8)
    *   [22.2 Game does not start](#Game_does_not_start)
*   [23 Divinity: Original Sin - Enhanced Edition](#Divinity:_Original_Sin_-_Enhanced_Edition)
    *   [23.1 Game doesn't start when using Bumblebee optirun or primusrun](#Game_doesn.27t_start_when_using_Bumblebee_optirun_or_primusrun)
*   [24 Don't Starve](#Don.27t_Starve)
    *   [24.1 Dependencies](#Dependencies_9)
    *   [24.2 No sound](#No_sound_2)
*   [25 Dota 2](#Dota_2)
    *   [25.1 Dependencies](#Dependencies_10)
    *   [25.2 In-game font is unreadable](#In-game_font_is_unreadable)
    *   [25.3 Everything seems OK but the game doesn't start](#Everything_seems_OK_but_the_game_doesn.27t_start)
    *   [25.4 Game runs on the wrong screen](#Game_runs_on_the_wrong_screen_2)
    *   [25.5 Game does not start with libxcb-dri3 error message](#Game_does_not_start_with_libxcb-dri3_error_message)
    *   [25.6 Steam overlay](#Steam_overlay)
    *   [25.7 Chinese Tips and player's name display problem](#Chinese_Tips_and_player.27s_name_display_problem)
    *   [25.8 Chinese input method problem](#Chinese_input_method_problem)
*   [26 Dwarfs F2P](#Dwarfs_F2P)
    *   [26.1 Dependencies](#Dependencies_11)
    *   [26.2 Game does not start](#Game_does_not_start_2)
    *   [26.3 Game crashes](#Game_crashes)
*   [27 Dynamite Jack](#Dynamite_Jack)
    *   [27.1 Dependencies](#Dependencies_12)
    *   [27.2 Sound Issues](#Sound_Issues)
    *   [27.3 Game does not start](#Game_does_not_start_3)
*   [28 Euro Truck Simulator 2](#Euro_Truck_Simulator_2)
    *   [28.1 Shows only a black screen](#Shows_only_a_black_screen)
*   [29 Football Manager 2014](#Football_Manager_2014)
*   [30 FORCED](#FORCED)
    *   [30.1 Dependencies](#Dependencies_13)
*   [31 FTL: Faster than Light](#FTL:_Faster_than_Light)
    *   [31.1 Dependencies](#Dependencies_14)
    *   [31.2 Compatibility](#Compatibility_3)
    *   [31.3 Problems with open-source video driver](#Problems_with_open-source_video_driver)
*   [32 Game Dev Tycoon](#Game_Dev_Tycoon)
    *   [32.1 Game does not start](#Game_does_not_start_4)
*   [33 Garry's Mod](#Garry.27s_Mod)
    *   [33.1 Game does not start](#Game_does_not_start_5)
    *   [33.2 Opening some menus causes the game to crash](#Opening_some_menus_causes_the_game_to_crash)
    *   [33.3 Game crashes after attempting to join server](#Game_crashes_after_attempting_to_join_server)
*   [34 GRID Autosport](#GRID_Autosport)
    *   [34.1 Game does not start (Black screen)](#Game_does_not_start_.28Black_screen.29)
*   [35 Hack 'n' Slash](#Hack_.27n.27_Slash)
    *   [35.1 The game starts but craches when loading a new or saved game](#The_game_starts_but_craches_when_loading_a_new_or_saved_game)
*   [36 Hacker Evolution [Untold, Duality]](#Hacker_Evolution_.5BUntold.2C_Duality.5D)
    *   [36.1 Dependencies](#Dependencies_15)
*   [37 Half-Life 2 and episodes](#Half-Life_2_and_episodes)
    *   [37.1 Cyrillic fonts problem](#Cyrillic_fonts_problem)
*   [38 Hammerwatch](#Hammerwatch)
    *   [38.1 The game not starting from Steam GUI](#The_game_not_starting_from_Steam_GUI)
    *   [38.2 No sound](#No_sound_3)
*   [39 Harvest: Massive Encounter](#Harvest:_Massive_Encounter)
    *   [39.1 Dependencies](#Dependencies_16)
    *   [39.2 Compatibility](#Compatibility_4)
*   [40 Hatoful Boyfriend](#Hatoful_Boyfriend)
    *   [40.1 Japanese text invisible](#Japanese_text_invisible)
*   [41 The Impossible Game](#The_Impossible_Game)
    *   [41.1 Dependencies](#Dependencies_17)
*   [42 The Inner World](#The_Inner_World)
    *   [42.1 Bringing up the inventory or main menu](#Bringing_up_the_inventory_or_main_menu)
    *   [42.2 Dependencies](#Dependencies_18)
        *   [42.2.1 Sound support](#Sound_support)
        *   [42.2.2 Cutscenes](#Cutscenes)
*   [43 Interloper](#Interloper)
    *   [43.1 Dependencies](#Dependencies_19)
    *   [43.2 Game does not launch](#Game_does_not_launch)
*   [44 Invisible Apartment](#Invisible_Apartment)
    *   [44.1 Dependencies](#Dependencies_20)
    *   [44.2 Game does not run](#Game_does_not_run)
*   [45 Joe Danger 2: The Movie](#Joe_Danger_2:_The_Movie)
    *   [45.1 Dependencies](#Dependencies_21)
    *   [45.2 Compatibility](#Compatibility_5)
*   [46 Kerbal Space Program](#Kerbal_Space_Program)
*   [47 Killing Floor](#Killing_Floor)
    *   [47.1 Screen resolution](#Screen_resolution)
    *   [47.2 Windowed mode](#Windowed_mode)
    *   [47.3 Stuttering Sound](#Stuttering_Sound)
*   [48 Lethal League](#Lethal_League)
    *   [48.1 Dependencies](#Dependencies_22)
*   [49 Life is Strange](#Life_is_Strange)
    *   [49.1 Dependencies](#Dependencies_23)
*   [50 Mark of the Ninja](#Mark_of_the_Ninja)
    *   [50.1 Bad sound](#Bad_sound)
*   [51 Metro: Last Light](#Metro:_Last_Light)
    *   [51.1 Attempted fixes](#Attempted_fixes)
    *   [51.2 Hacky solution](#Hacky_solution)
    *   [51.3 Possible solutions](#Possible_solutions)
*   [52 Middle-earth: Shadow of Mordor](#Middle-earth:_Shadow_of_Mordor)
    *   [52.1 Floating heads](#Floating_heads)
*   [53 Multiwinia](#Multiwinia)
    *   [53.1 Dependencies](#Dependencies_24)
    *   [53.2 Crash on startup](#Crash_on_startup)
*   [54 Natural Selection 2](#Natural_Selection_2)
    *   [54.1 No Sound](#No_Sound_4)
*   [55 Penumbra: Overture](#Penumbra:_Overture)
    *   [55.1 Dependencies](#Dependencies_25)
    *   [55.2 Windowed mode](#Windowed_mode_2)
*   [56 The Polynomial](#The_Polynomial)
    *   [56.1 Dependencies](#Dependencies_26)
    *   [56.2 Segfaults during program start on 64-bit systems](#Segfaults_during_program_start_on_64-bit_systems)
*   [57 Portal 2](#Portal_2)
    *   [57.1 Game does not start](#Game_does_not_start_6)
    *   [57.2 resolution too low](#resolution_too_low)
*   [58 Prison Architect](#Prison_Architect)
    *   [58.1 ALSA error when using PulseAudio](#ALSA_error_when_using_PulseAudio)
*   [59 Project Zomboid](#Project_Zomboid)
    *   [59.1 Dependencies](#Dependencies_27)
    *   [59.2 No sound](#No_sound_5)
*   [60 Redshirt](#Redshirt)
    *   [60.1 Dependencies](#Dependencies_28)
*   [61 Revenge of the Titans](#Revenge_of_the_Titans)
    *   [61.1 Dependencies](#Dependencies_29)
*   [62 Rock Boshers DX: Directors Cut](#Rock_Boshers_DX:_Directors_Cut)
    *   [62.1 Dependencies](#Dependencies_30)
*   [63 Saints Row IV](#Saints_Row_IV)
    *   [63.1 Game fails to launch after update to new Nvidia drivers](#Game_fails_to_launch_after_update_to_new_Nvidia_drivers)
    *   [63.2 Game causes GPU lockup with mesa drivers](#Game_causes_GPU_lockup_with_mesa_drivers)
*   [64 Serious Sam 3: BFE](#Serious_Sam_3:_BFE)
    *   [64.1 Dependencies](#Dependencies_31)
    *   [64.2 No audio](#No_audio_2)
*   [65 Sir, You Are Being Hunted](#Sir.2C_You_Are_Being_Hunted)
    *   [65.1 Dependencies](#Dependencies_32)
*   [66 Space Pirates and Zombies](#Space_Pirates_and_Zombies)
    *   [66.1 Dependencies](#Dependencies_33)
    *   [66.2 No audio](#No_audio_3)
*   [67 Spacechem](#Spacechem)
    *   [67.1 Dependencies](#Dependencies_34)
    *   [67.2 Game crash](#Game_crash)
*   [68 Splice](#Splice)
    *   [68.1 Dependencies](#Dependencies_35)
*   [69 Star Wars Battlefront II](#Star_Wars_Battlefront_II)
*   [70 The Stanley Parable](#The_Stanley_Parable)
    *   [70.1 Game won't start](#Game_won.27t_start)
*   [71 Steel Storm: Burning Retribution](#Steel_Storm:_Burning_Retribution)
    *   [71.1 Start with black screen](#Start_with_black_screen)
    *   [71.2 No English fonts](#No_English_fonts)
*   [72 Stephen's Sausage Roll](#Stephen.27s_Sausage_Roll)
    *   [72.1 No sound](#No_sound_6)
*   [73 Strike Suite Zero](#Strike_Suite_Zero)
    *   [73.1 Dependencies](#Dependencies_36)
*   [74 Superbrothers: Sword & Sworcery EP](#Superbrothers:_Sword_.26_Sworcery_EP)
    *   [74.1 Dependencies](#Dependencies_37)
*   [75 Tabletop Simulator](#Tabletop_Simulator)
    *   [75.1 CJK characters not showing in game](#CJK_characters_not_showing_in_game)
*   [76 Team Fortress 2](#Team_Fortress_2)
    *   [76.1 Dependencies](#Dependencies_38)
    *   [76.2 Making HRTF work](#Making_HRTF_work)
    *   [76.3 Loading screen freeze](#Loading_screen_freeze)
    *   [76.4 No audio](#No_audio_4)
    *   [76.5 Slow loading textures](#Slow_loading_textures)
*   [77 Terraria](#Terraria)
*   [78 This War of Mine](#This_War_of_Mine)
    *   [78.1 Game doesn't load](#Game_doesn.27t_load)
    *   [78.2 Sound glitches (on steam-native)](#Sound_glitches_.28on_steam-native.29)
*   [79 Tomb Raider](#Tomb_Raider)
    *   [79.1 Game immediately closes when running with steam-native](#Game_immediately_closes_when_running_with_steam-native)
    *   [79.2 Steam Controller not working ingame while being correctly recognised* by Steam outside of the game](#Steam_Controller_not_working_ingame_while_being_correctly_recognised.2A_by_Steam_outside_of_the_game)
*   [80 Towns / Towns Demo](#Towns_.2F_Towns_Demo)
    *   [80.1 Crash on launch](#Crash_on_launch)
*   [81 Transistor](#Transistor)
    *   [81.1 Crash on launch / FMOD binding crash / Audio issues](#Crash_on_launch_.2F_FMOD_binding_crash_.2F_Audio_issues)
*   [82 Transmissions: Element 120](#Transmissions:_Element_120)
    *   [82.1 Troubleshooting](#Troubleshooting)
    *   [82.2 Dependencies](#Dependencies_39)
*   [83 Trine 2](#Trine_2)
    *   [83.1 Dependencies](#Dependencies_40)
    *   [83.2 Colors](#Colors)
    *   [83.3 Sound](#Sound)
    *   [83.4 Resolution](#Resolution)
*   [84 Unity of Command](#Unity_of_Command)
    *   [84.1 Dependencies](#Dependencies_41)
    *   [84.2 Squares](#Squares)
    *   [84.3 No audio](#No_audio_5)
*   [85 Unity3D](#Unity3D)
    *   [85.1 Locale Settings](#Locale_Settings)
    *   [85.2 Unity 5 sound problems](#Unity_5_sound_problems)
    *   [85.3 Game launching on wrong monitor in fullscreen mode](#Game_launching_on_wrong_monitor_in_fullscreen_mode)
*   [86 Unrest](#Unrest)
    *   [86.1 Dependencies](#Dependencies_42)
*   [87 War Thunder](#War_Thunder)
    *   [87.1 Blank screen](#Blank_screen)
*   [88 Warhammer 40,000: Dawn of War II](#Warhammer_40.2C000:_Dawn_of_War_II)
    *   [88.1 Dependencies](#Dependencies_43)
    *   [88.2 Blank screen](#Blank_screen_2)
*   [89 Witcher 2: Assassin of Kings](#Witcher_2:_Assassin_of_Kings)
    *   [89.1 Dependencies](#Dependencies_44)
    *   [89.2 Game does not start](#Game_does_not_start_7)
*   [90 Wizardry 6: Bane of the Cosmic Forge](#Wizardry_6:_Bane_of_the_Cosmic_Forge)
    *   [90.1 Dependencies](#Dependencies_45)
*   [91 World of Goo](#World_of_Goo)
    *   [91.1 Changing resolution](#Changing_resolution)
*   [92 Worms Reloaded](#Worms_Reloaded)
    *   [92.1 Dependencies](#Dependencies_46)
*   [93 XCOM](#XCOM)
    *   [93.1 Dependencies](#Dependencies_47)
    *   [93.2 Hangs on startup](#Hangs_on_startup)
    *   [93.3 Graphical glitches on Intel HD](#Graphical_glitches_on_Intel_HD)

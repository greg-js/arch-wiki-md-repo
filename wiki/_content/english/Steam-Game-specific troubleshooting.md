...
*   [5 Games](#Games)
    ...
    *   [5.4 Anodyne](#Anodyne)
        *   [5.4.1 Play with a controller: joy2key configuration](#Play_with_a_controller:_joy2key_configuration)
    *   [5.5 Aquaria](#Aquaria)
        *   [5.5.1 Mouse pointer gets stuck in one direction](#Mouse_pointer_gets_stuck_in_one_direction)
    *   [5.6 ARK: Survival Evolved](#ARK:_Survival_Evolved)
        *   [5.6.1 Game does not start, displays text window with unreadable text](#Game_does_not_start.2C_displays_text_window_with_unreadable_text)
        *   [5.6.2 Gray water](#Gray_water)
        *   [5.6.3 Segmentation fault on startup](#Segmentation_fault_on_startup)
    *   [5.7 Audiosurf 2](#Audiosurf_2)
        *   [5.7.1 error. unable to load song <filename> ,came back with zero duration](#error._unable_to_load_song_.3Cfilename.3E_.2Ccame_back_with_zero_duration)
    *   [5.8 BADLAND: Game of the Year Edition](#BADLAND:_Game_of_the_Year_Edition)
    *   [5.9 Beat Cop](#Beat_Cop)
        *   [5.9.1 "BeatCop.x86_64" is not responding](#.22BeatCop.x86_64.22_is_not_responding)
    *   [5.10 Binding of Isaac: Rebirth](#Binding_of_Isaac:_Rebirth)
        *   [5.10.1 No sound](#No_sound)
    *   [5.11 BioShock Infinite](#BioShock_Infinite)
        *   [5.11.1 Game launching on wrong monitor in fullscreen mode](#Game_launching_on_wrong_monitor_in_fullscreen_mode)
    *   [5.12 BLACKHOLE](#BLACKHOLE)
    *   [5.13 Black Mesa](#Black_Mesa)
    *   [5.14 Block'hood](#Block.27hood)
        *   [5.14.1 White screen on startup](#White_screen_on_startup)
    *   [5.15 The Book of Unwritten Tales](#The_Book_of_Unwritten_Tales)
    *   [5.16 BRAIN/OUT](#BRAIN.2FOUT)
    *   [5.17 The Book of Unwritten Tales: The Critter Chronicles](#The_Book_of_Unwritten_Tales:_The_Critter_Chronicles)
    *   [5.18 Borderlands 2](#Borderlands_2)
        *   [5.18.1 Migrating saves from other platforms](#Migrating_saves_from_other_platforms)
        *   [5.18.2 Using Ctrl Key](#Using_Ctrl_Key)
        *   [5.18.3 Logging into SHiFT](#Logging_into_SHiFT)
        *   [5.18.4 Game crashes nearly instantly](#Game_crashes_nearly_instantly)
    *   [5.19 Borderlands: The Pre-Sequel](#Borderlands:_The_Pre-Sequel)
        *   [5.19.1 Keyboard not working](#Keyboard_not_working)
        *   [5.19.2 Not starting via Steam](#Not_starting_via_Steam)
    *   [5.20 Cities in Motion 2](#Cities_in_Motion_2)
        *   [5.20.1 Dialog boxes fail to display properly](#Dialog_boxes_fail_to_display_properly)
    *   [5.21 Cities Skylines](#Cities_Skylines)
        *   [5.21.1 Textures not rendering properly](#Textures_not_rendering_properly)
    *   [5.22 Civilization V](#Civilization_V)
        *   [5.22.1 Stuttering sound with PulseAudio](#Stuttering_sound_with_PulseAudio)
        *   [5.22.2 Game crashes seconds after loading a map](#Game_crashes_seconds_after_loading_a_map)
        *   [5.22.3 Game crashes after intro video with "Unable to load texture (LoadingBaseGame.dds)"](#Game_crashes_after_intro_video_with_.22Unable_to_load_texture_.28LoadingBaseGame.dds.29.22)
        *   [5.22.4 Game crashes on startup with an error in libpulsecommon-12.0.so"](#Game_crashes_on_startup_with_an_error_in_libpulsecommon-12.0.so.22)
    *   [5.23 Civilization: Beyond earth](#Civilization:_Beyond_earth)
        *   [5.23.1 Segfault after a few minutes](#Segfault_after_a_few_minutes)
    *   [5.24 Civilization VI](#Civilization_VI)
        *   [5.24.1 If Segfault Immediately on Start](#If_Segfault_Immediately_on_Start)
    *   [5.25 Deus Ex: Mankind divided](#Deus_Ex:_Mankind_divided)
    *   [5.26 The Clockwork Man](#The_Clockwork_Man)
    *   [5.27 Company of Heroes 2](#Company_of_Heroes_2)
        *   [5.27.1 Missing libpcre.so.3](#Missing_libpcre.so.3_2)
    *   [5.28 Cossacks 3](#Cossacks_3)
        *   [5.28.1 No sound](#No_sound_2)
        *   [5.28.2 Flashing screen with primus](#Flashing_screen_with_primus)
    *   [5.29 Counter-Strike: Source (CS:S)](#Counter-Strike:_Source_.28CS:S.29)
        *   [5.29.1 Invisible symbols, special characters and cyrillic letters](#Invisible_symbols.2C_special_characters_and_cyrillic_letters)
    *   [5.30 Counter-Strike: Global Offensive (CS:GO)](#Counter-Strike:_Global_Offensive_.28CS:GO.29)
        *   [5.30.1 Game starts on the wrong screen](#Game_starts_on_the_wrong_screen)
        *   [5.30.2 Cannot reach bottom of the screen on menus](#Cannot_reach_bottom_of_the_screen_on_menus)
        *   [5.30.3 Sound is played slightly delayed](#Sound_is_played_slightly_delayed)
        *   [5.30.4 Mouse not working in-game](#Mouse_not_working_in-game)
        *   [5.30.5 Brightness slider not working](#Brightness_slider_not_working)
        *   [5.30.6 Microphone not working](#Microphone_not_working)
        *   [5.30.7 Mouse is unrensponsive or moves slowly](#Mouse_is_unrensponsive_or_moves_slowly)
    *   [5.31 Creeper World 3: Arc Eternal](#Creeper_World_3:_Arc_Eternal)
        *   [5.31.1 Game does not start](#Game_does_not_start_2)
    *   [5.32 Crusader Kings II](#Crusader_Kings_II)
        *   [5.32.1 No audio](#No_audio)
        *   [5.32.2 Oddly sized starting window](#Oddly_sized_starting_window)
        *   [5.32.3 DLCs not detected](#DLCs_not_detected)
    *   [5.33 Crypt of the NecroDancer](#Crypt_of_the_NecroDancer)
        *   [5.33.1 Crashes after splash screen](#Crashes_after_splash_screen)
    *   [5.34 The Curious Expedition](#The_Curious_Expedition)
        *   [5.34.1 Game stuck on loading screen](#Game_stuck_on_loading_screen)
    *   [5.35 Death Road To Canada](#Death_Road_To_Canada)
        *   [5.35.1 No music](#No_music)
    *   [5.36 Defender's Quest: Valley of the Forgotten](#Defender.27s_Quest:_Valley_of_the_Forgotten)
    *   [5.37 Dirt](#Dirt)
    *   [5.38 Dirt Rally](#Dirt_Rally)
    *   [5.39 Divinity: Original Sin - Enhanced Edition](#Divinity:_Original_Sin_-_Enhanced_Edition)
        *   [5.39.1 Game does not start when using Bumblebee optirun or primusrun](#Game_does_not_start_when_using_Bumblebee_optirun_or_primusrun)
        *   [5.39.2 Game does not work with amdgpu](#Game_does_not_work_with_amdgpu)
    *   [5.40 Don't Starve](#Don.27t_Starve)
        *   [5.40.1 No sound](#No_sound_3)
    *   [5.41 Doki Doki Literature Club](#Doki_Doki_Literature_Club)
    *   [5.42 Dota 2](#Dota_2)
        *   [5.42.1 In-game font is unreadable](#In-game_font_is_unreadable)
        *   [5.42.2 Error with libpangoft2](#Error_with_libpangoft2)
        *   [5.42.3 The game does not start](#The_game_does_not_start)
        *   [5.42.4 Game runs on the wrong screen](#Game_runs_on_the_wrong_screen)
        *   [5.42.5 Game does not start with libxcb-dri3 error message](#Game_does_not_start_with_libxcb-dri3_error_message)
        *   [5.42.6 Steam overlay](#Steam_overlay)
        *   [5.42.7 Chinese tips and player names not shown](#Chinese_tips_and_player_names_not_shown)
        *   [5.42.8 Chinese input method problem](#Chinese_input_method_problem)
    *   [5.43 Devil Daggers](#Devil_Daggers)
    *   [5.44 Drox Operative](#Drox_Operative)
    *   [5.45 Dwarfs F2P](#Dwarfs_F2P)
        *   [5.45.1 Game does not start](#Game_does_not_start_3)
        *   [5.45.2 Game crashes](#Game_crashes)
    *   [5.46 Dynamite Jack](#Dynamite_Jack)
        *   [5.46.1 Sound Issues](#Sound_Issues)
        *   [5.46.2 Game does not start](#Game_does_not_start_4)
    *   [5.47 Empire Total War](#Empire_Total_War)
        *   [5.47.1 Weird unreadable fonts](#Weird_unreadable_fonts)
    *   [5.48 Euro Truck Simulator 2](#Euro_Truck_Simulator_2)
        *   [5.48.1 Shows only a black screen](#Shows_only_a_black_screen)
    *   [5.49 Firewatch](#Firewatch)
    *   [5.50 Football Manager 2014](#Football_Manager_2014)
    *   [5.51 FORCED](#FORCED)
    *   [5.52 For the King](#For_the_King)
    *   [5.53 FTL: Faster than Light](#FTL:_Faster_than_Light)
        *   [5.53.1 Compatibility](#Compatibility)
        *   [5.53.2 Problems with open-source video driver](#Problems_with_open-source_video_driver)
    *   [5.54 Game Dev Tycoon](#Game_Dev_Tycoon)
        *   [5.54.1 Game does not start](#Game_does_not_start_5)
    *   [5.55 Garry's Mod](#Garry.27s_Mod)
        *   [5.55.1 Game does not start](#Game_does_not_start_6)
        *   [5.55.2 Opening some menus causes the game to crash](#Opening_some_menus_causes_the_game_to_crash)
        *   [5.55.3 Game crashes after attempting to join server](#Game_crashes_after_attempting_to_join_server)
    *   [5.56 Gods will be watching](#Gods_will_be_watching)
    *   [5.57 GRID Autosport](#GRID_Autosport)
        *   [5.57.1 Black screen when trying to play](#Black_screen_when_trying_to_play)
    *   [5.58 Hack 'n' Slash](#Hack_.27n.27_Slash)
        *   [5.58.1 Crashes when trying to load a game](#Crashes_when_trying_to_load_a_game)
    *   [5.59 Hacker Evolution](#Hacker_Evolution)
    *   [5.60 Half-Life 2 and episodes](#Half-Life_2_and_episodes)
        *   [5.60.1 Cyrillic fonts problem](#Cyrillic_fonts_problem)
    *   [5.61 Hammerwatch](#Hammerwatch)
        *   [5.61.1 The game does not start via Steam](#The_game_does_not_start_via_Steam)
        *   [5.61.2 No sound](#No_sound_4)
    *   [5.62 Harvest: Massive Encounter](#Harvest:_Massive_Encounter)
        *   [5.62.1 Compatibility](#Compatibility_2)
    *   [5.63 Hatoful Boyfriend](#Hatoful_Boyfriend)
        *   [5.63.1 Japanese text invisible](#Japanese_text_invisible)
    *   [5.64 HuniePop](#HuniePop)
        *   [5.64.1 Game crashes upon launch](#Game_crashes_upon_launch)
    *   [5.65 Hyper Light Drifter](#Hyper_Light_Drifter)
        *   [5.65.1 The controller does not work](#The_controller_does_not_work)
        *   [5.65.2 Missing libcurl.so.4 or version CURL_OPENSSL_3 not found](#Missing_libcurl.so.4_or_version_CURL_OPENSSL_3_not_found)
    *   [5.66 The Impossible Game](#The_Impossible_Game)
    *   [5.67 The Inner World](#The_Inner_World)
        *   [5.67.1 Bringing up the inventory or main menu](#Bringing_up_the_inventory_or_main_menu)
            *   [5.67.1.1 Cutscenes](#Cutscenes)
    *   [5.68 Interloper](#Interloper)
        *   [5.68.1 Game does not start](#Game_does_not_start_7)
    *   [5.69 Invisible Apartment](#Invisible_Apartment)
        *   [5.69.1 Game does not start](#Game_does_not_start_8)
    *   [5.70 Joe Danger 2: The Movie](#Joe_Danger_2:_The_Movie)
        *   [5.70.1 Compatibility](#Compatibility_3)
    *   [5.71 Kerbal Space Program](#Kerbal_Space_Program)
    *   [5.72 Killing Floor](#Killing_Floor)
        *   [5.72.1 Cannot change screen resolution](#Cannot_change_screen_resolution)
        *   [5.72.2 Windowed mode](#Windowed_mode)
        *   [5.72.3 Stuttering sound](#Stuttering_sound)
    *   [5.73 Left for Dead 2](#Left_for_Dead_2)
        *   [5.73.1 Missing Chinese font](#Missing_Chinese_font)
    *   [5.74 Lethal League](#Lethal_League)
    *   [5.75 Life is Strange](#Life_is_Strange)
    *   [5.76 Little Racers STREET](#Little_Racers_STREET)
    *   [5.77 The Long Dark](#The_Long_Dark)
        *   [5.77.1 Game does not start](#Game_does_not_start_9)
        *   [5.77.2 Game starts, but some overlay text is missing and cutscenes shows black screen](#Game_starts.2C_but_some_overlay_text_is_missing_and_cutscenes_shows_black_screen)
        *   [5.77.3 Cutscenes are still black](#Cutscenes_are_still_black)
        *   [5.77.4 Cursor disappears](#Cursor_disappears)
    *   [5.78 Magicka 2](#Magicka_2)
        *   [5.78.1 Indefinitely stuck at start](#Indefinitely_stuck_at_start)
    *   [5.79 Mark of the Ninja](#Mark_of_the_Ninja)
        *   [5.79.1 Bad sound](#Bad_sound)
    *   [5.80 Metro: Last Light](#Metro:_Last_Light)
    *   [5.81 Metro: 2033 Redux](#Metro:_2033_Redux)
        *   [5.81.1 No sound](#No_sound_5)
    *   [5.82 No image](#No_image)
    *   [5.83 Middle-earth: Shadow of Mordor](#Middle-earth:_Shadow_of_Mordor)
        *   [5.83.1 Floating heads](#Floating_heads)
    *   [5.84 Mount & Blade: Warband](#Mount_.26_Blade:_Warband)
        *   [5.84.1 Segmentation fault (core dumped) with wayland](#Segmentation_fault_.28core_dumped.29_with_wayland)
        *   [5.84.2 DLC Chooser](#DLC_Chooser)
        *   [5.84.3 Crash on startup](#Crash_on_startup)
    *   [5.85 Multiwinia](#Multiwinia)
        *   [5.85.1 Crash on startup](#Crash_on_startup_2)
    *   [5.86 Natural Selection 2](#Natural_Selection_2)
    *   [5.87 Nuclear Throne](#Nuclear_Throne)
        *   [5.87.1 Missing libcurl.so.4 or version CURL_OPENSSL_3 not found](#Missing_libcurl.so.4_or_version_CURL_OPENSSL_3_not_found_2)
    *   [5.88 Oxygen Not Included](#Oxygen_Not_Included)
        *   [5.88.1 World generation hangs](#World_generation_hangs)
    *   [5.89 Penumbra: Overture](#Penumbra:_Overture)
        *   [5.89.1 Windowed mode](#Windowed_mode_2)
    *   [5.90 The Polynomial](#The_Polynomial)
        *   [5.90.1 Segfaults during program start on 64-bit systems](#Segfaults_during_program_start_on_64-bit_systems)
    *   [5.91 Portal 2](#Portal_2)
        *   [5.91.1 Game does not start](#Game_does_not_start_10)
        *   [5.91.2 Resolution too low](#Resolution_too_low)
        *   [5.91.3 Missing non Latin font](#Missing_non_Latin_font)
    *   [5.92 Prison Architect](#Prison_Architect)
        *   [5.92.1 ALSA error when using PulseAudio](#ALSA_error_when_using_PulseAudio)
    *   [5.93 Project Zomboid](#Project_Zomboid)
        *   [5.93.1 No sound](#No_sound_6)
    *   [5.94 Pyre](#Pyre)
        *   [5.94.1 Game does not start](#Game_does_not_start_11)
    *   [5.95 Redshirt](#Redshirt)
    *   [5.96 Revenge of the Titans](#Revenge_of_the_Titans)
    *   [5.97 Risk of Rain](#Risk_of_Rain)
    *   [5.98 Rock Boshers DX: Directors Cut](#Rock_Boshers_DX:_Directors_Cut)
    *   [5.99 Saints Row IV](#Saints_Row_IV)
        *   [5.99.1 Game fails to launch after update to new Nvidia drivers](#Game_fails_to_launch_after_update_to_new_Nvidia_drivers)
        *   [5.99.2 Game causes GPU lockup with mesa drivers](#Game_causes_GPU_lockup_with_mesa_drivers)
    *   [5.100 Serious Sam 3: BFE](#Serious_Sam_3:_BFE)
        *   [5.100.1 No audio](#No_audio_2)
    *   [5.101 Slay the Spire](#Slay_the_Spire)
    *   [5.102 Songbringer](#Songbringer)
        *   [5.102.1 Launch error with Wayland](#Launch_error_with_Wayland)
    *   [5.103 Space Pirates and Zombies](#Space_Pirates_and_Zombies)
        *   [5.103.1 No audio](#No_audio_3)
    *   [5.104 Spacechem](#Spacechem)
        *   [5.104.1 Game crash](#Game_crash)
    *   [5.105 Splice](#Splice)
    *   [5.106 The Stanley Parable](#The_Stanley_Parable)
        *   [5.106.1 Game won't start](#Game_won.27t_start)
    *   [5.107 Shadow Tactics: Blades of the Shogun](#Shadow_Tactics:_Blades_of_the_Shogun)
    *   [5.108 Steel Storm: Burning Retribution](#Steel_Storm:_Burning_Retribution)
        *   [5.108.1 Start with black screen](#Start_with_black_screen)
    *   [5.109 Stellaris](#Stellaris)
        *   [5.109.1 No window opening, only sound](#No_window_opening.2C_only_sound)
    *   [5.110 Stephen's Sausage Roll](#Stephen.27s_Sausage_Roll)
        *   [5.110.1 No sound](#No_sound_7)
    *   [5.111 Superbrothers: Sword & Sworcery EP](#Superbrothers:_Sword_.26_Sworcery_EP)
    *   [5.112 System Shock 2](#System_Shock_2)
    *   [5.113 Tabletop Simulator](#Tabletop_Simulator)
        *   [5.113.1 CJK characters not showing in game](#CJK_characters_not_showing_in_game)
    *   [5.114 Team Fortress 2](#Team_Fortress_2)
        *   [5.114.1 HRTF setup](#HRTF_setup)
        *   [5.114.2 Loading screen freeze](#Loading_screen_freeze)
        *   [5.114.3 No audio](#No_audio_4)
        *   [5.114.4 Slow loading textures](#Slow_loading_textures)
    *   [5.115 Terraria](#Terraria)
    *   [5.116 This War of Mine](#This_War_of_Mine)
        *   [5.116.1 Game does not start](#Game_does_not_start_12)
        *   [5.116.2 Sound glitches with Steam native](#Sound_glitches_with_Steam_native)
    *   [5.117 Ticket to Ride](#Ticket_to_Ride)
    *   [5.118 The Tiny Bang Story](#The_Tiny_Bang_Story)
        *   [5.118.1 Missing libGLEW.so.1.6](#Missing_libGLEW.so.1.6)
    *   [5.119 Tomb Raider](#Tomb_Raider)
        *   [5.119.1 Game immediately closes when running with steam-native](#Game_immediately_closes_when_running_with_steam-native)
        *   [5.119.2 Steam Controller not working in-game](#Steam_Controller_not_working_in-game)
    *   [5.120 Torchlight 2](#Torchlight_2)
        *   [5.120.1 Libfreetype/libfontconfig Incompatibility](#Libfreetype.2Flibfontconfig_Incompatibility)
        *   [5.120.2 Locale incompatibility](#Locale_incompatibility)
    *   [5.121 Tower Unite](#Tower_Unite)
        *   [5.121.1 Graphical Glitches](#Graphical_Glitches)
    *   [5.122 Towns / Towns Demo](#Towns_.2F_Towns_Demo)
    *   [5.123 Transistor](#Transistor)
        *   [5.123.1 Crash on launch / FMOD binding crash / audio issues](#Crash_on_launch_.2F_FMOD_binding_crash_.2F_audio_issues)
    *   [5.124 Transmissions: Element 120](#Transmissions:_Element_120)
        *   [5.124.1 Troubleshooting](#Troubleshooting)
    *   [5.125 Trine 2](#Trine_2)
        *   [5.125.1 Colors](#Colors)
        *   [5.125.2 Sound](#Sound)
        *   [5.125.3 Resolution](#Resolution)
    *   [5.126 Tropico 5](#Tropico_5)
        *   [5.126.1 Blank screen with sound only on startup](#Blank_screen_with_sound_only_on_startup)
    *   [5.127 Unity of Command](#Unity_of_Command)
        *   [5.127.1 Squares](#Squares)
        *   [5.127.2 No audio](#No_audio_5)
    *   [5.128 Unity3D](#Unity3D)
        *   [5.128.1 Locale settings](#Locale_settings)
        *   [5.128.2 Unity 5 sound problems](#Unity_5_sound_problems)
        *   [5.128.3 Game launching on wrong monitor in fullscreen mode](#Game_launching_on_wrong_monitor_in_fullscreen_mode_2)
        *   [5.128.4 Chinese/Japanese/Korean display bug](#Chinese.2FJapanese.2FKorean_display_bug)
        *   [5.128.5 Game does not respond](#Game_does_not_respond)
    *   [5.129 Unrest](#Unrest)
    *   [5.130 Volgarr the Viking](#Volgarr_the_Viking)
    *   [5.131 War Thunder](#War_Thunder)
        *   [5.131.1 No audio](#No_audio_6)
        *   [5.131.2 Blank screen](#Blank_screen)
    *   [5.132 Warhammer 40,000: Dawn of War II](#Warhammer_40.2C000:_Dawn_of_War_II)
    *   [5.133 We Were Here](#We_Were_Here)
        *   [5.133.1 Stuck on black screen or logo on launch](#Stuck_on_black_screen_or_logo_on_launch)
    *   [5.134 Worms W.M.D](#Worms_W.M.D)
    *   [5.135 Witcher 2: Assassin of Kings](#Witcher_2:_Assassin_of_Kings)
        *   [5.135.1 Game does not start](#Game_does_not_start_13)
    *   [5.136 Wizardry 6: Bane of the Cosmic Forge](#Wizardry_6:_Bane_of_the_Cosmic_Forge)
    *   [5.137 World of Goo](#World_of_Goo)
        *   [5.137.1 Changing resolution](#Changing_resolution)
    *   [5.138 X3: Terran Conflict](#X3:_Terran_Conflict)
        *   [5.138.1 Game crashes on startup](#Game_crashes_on_startup)
    *   [5.139 XCOM](#XCOM)
        *   [5.139.1 Hangs on startup](#Hangs_on_startup)
        *   [5.139.2 Graphical glitches on Intel HD](#Graphical_glitches_on_Intel_HD)

...
*   [4 Games](#Games)
    ...
    *   [4.12 Block'hood](#Block.27hood)
        *   [4.12.1 White screen on startup](#White_screen_on_startup)
    *   [4.13 The Book of Unwritten Tales](#The_Book_of_Unwritten_Tales)
    *   [4.14 The Book of Unwritten Tales: The Critter Chronicles](#The_Book_of_Unwritten_Tales:_The_Critter_Chronicles)
    *   [4.15 Borderlands 2](#Borderlands_2)
        *   [4.15.1 Migrating saves from other platforms](#Migrating_saves_from_other_platforms)
        *   [4.15.2 Using Ctrl Key](#Using_Ctrl_Key)
        *   [4.15.3 Logging into SHiFT](#Logging_into_SHiFT)
        *   [4.15.4 Game crashes nearly instantly](#Game_crashes_nearly_instantly)
    *   [4.16 Borderlands: The Pre-Sequel](#Borderlands:_The_Pre-Sequel)
        *   [4.16.1 Keyboard not working](#Keyboard_not_working)
        *   [4.16.2 Not starting via Steam](#Not_starting_via_Steam)
    *   [4.17 Cities in Motion 2](#Cities_in_Motion_2)
        *   [4.17.1 Dialog boxes fail to display properly](#Dialog_boxes_fail_to_display_properly)
    *   [4.18 Cities Skylines](#Cities_Skylines)
        *   [4.18.1 Textures not rendering properly](#Textures_not_rendering_properly)
    *   [4.19 Civilization V](#Civilization_V)
        *   [4.19.1 Stuttering sound with PulseAudio](#Stuttering_sound_with_PulseAudio)
        *   [4.19.2 Game crashes seconds after loading a map](#Game_crashes_seconds_after_loading_a_map)
        *   [4.19.3 Game crashes after intro video with "Unable to load texture (LoadingBaseGame.dds)"](#Game_crashes_after_intro_video_with_.22Unable_to_load_texture_.28LoadingBaseGame.dds.29.22)
    *   [4.20 Civilization: Beyond earth](#Civilization:_Beyond_earth)
        *   [4.20.1 Segfault after a few minutes](#Segfault_after_a_few_minutes)
    *   [4.21 Civilization VI](#Civilization_VI)
        *   [4.21.1 If Segfault Immediately on Start](#If_Segfault_Immediately_on_Start)
    *   [4.22 Deus Ex: Mankind divided](#Deus_Ex:_Mankind_divided)
    *   [4.23 The Clockwork Man](#The_Clockwork_Man)
    *   [4.24 Company of Heroes 2](#Company_of_Heroes_2)
    ...
    *   [4.26 Counter-Strike: Global Offensive (CS:GO)](#Counter-Strike:_Global_Offensive_.28CS:GO.29)
        ...
        *   [4.26.3 Sound is played slightly delayed](#Sound_is_played_slightly_delayed)
        *   [4.26.4 Mouse not working in-game](#Mouse_not_working_in-game)
        *   [4.26.5 Brightness slider not working](#Brightness_slider_not_working)
        *   [4.26.6 Microphone not working](#Microphone_not_working)
    *   [4.27 Crusader Kings II](#Crusader_Kings_II)
        *   [4.27.1 No audio](#No_audio)
        *   [4.27.2 Oddly sized starting window](#Oddly_sized_starting_window)
        *   [4.27.3 DLCs not detected](#DLCs_not_detected)
    *   [4.28 Crypt of the NecroDancer](#Crypt_of_the_NecroDancer)
        *   [4.28.1 Crashes after splash screen](#Crashes_after_splash_screen)
    *   [4.29 The Curious Expedition](#The_Curious_Expedition)
        *   [4.29.1 Game stuck on loading screen](#Game_stuck_on_loading_screen)
    *   [4.30 Death Road To Canada](#Death_Road_To_Canada)
        *   [4.30.1 No music](#No_music)
    *   [4.31 Defender's Quest: Valley of the Forgotten](#Defender.27s_Quest:_Valley_of_the_Forgotten)
    *   [4.32 Dirt](#Dirt)
    *   [4.33 Dirt Rally](#Dirt_Rally)
    *   [4.34 Divinity: Original Sin - Enhanced Edition](#Divinity:_Original_Sin_-_Enhanced_Edition)
        *   [4.34.1 Game does not start when using Bumblebee optirun or primusrun](#Game_does_not_start_when_using_Bumblebee_optirun_or_primusrun)
        *   [4.34.2 Game does not work with amdgpu](#Game_does_not_work_with_amdgpu)
    *   [4.35 Don't Starve](#Don.27t_Starve)
        *   [4.35.1 No sound](#No_sound_3)
    *   [4.36 Dota 2](#Dota_2)
        *   [4.36.1 In-game font is unreadable](#In-game_font_is_unreadable)
        *   [4.36.2 Error with libpangoft2](#Error_with_libpangoft2)
        *   [4.36.3 The game does not start](#The_game_does_not_start)
        *   [4.36.4 Game runs on the wrong screen](#Game_runs_on_the_wrong_screen)
        *   [4.36.5 Game does not start with libxcb-dri3 error message](#Game_does_not_start_with_libxcb-dri3_error_message)
        *   [4.36.6 Steam overlay](#Steam_overlay)
        *   [4.36.7 Chinese tips and player names not shown](#Chinese_tips_and_player_names_not_shown)
        *   [4.36.8 Chinese input method problem](#Chinese_input_method_problem)
    *   [4.37 Devil Daggers](#Devil_Daggers)
    *   [4.38 Drox Operative](#Drox_Operative)
    *   [4.39 Dwarfs F2P](#Dwarfs_F2P)
        *   [4.39.1 Game does not start](#Game_does_not_start_2)
        *   [4.39.2 Game crashes](#Game_crashes)
    *   [4.40 Dynamite Jack](#Dynamite_Jack)
        *   [4.40.1 Sound Issues](#Sound_Issues)
        *   [4.40.2 Game does not start](#Game_does_not_start_3)
    *   [4.41 Empire Total War](#Empire_Total_War)
        *   [4.41.1 Weird unreadable fonts](#Weird_unreadable_fonts)
    *   [4.42 Euro Truck Simulator 2](#Euro_Truck_Simulator_2)
        *   [4.42.1 Shows only a black screen](#Shows_only_a_black_screen)
    *   [4.43 Football Manager 2014](#Football_Manager_2014)
    *   [4.44 FORCED](#FORCED)
    *   [4.45 FTL: Faster than Light](#FTL:_Faster_than_Light)
        *   [4.45.1 Compatibility](#Compatibility)
        *   [4.45.2 Problems with open-source video driver](#Problems_with_open-source_video_driver)
    *   [4.46 Game Dev Tycoon](#Game_Dev_Tycoon)
        *   [4.46.1 Game does not start](#Game_does_not_start_4)
    *   [4.47 Garry's Mod](#Garry.27s_Mod)
        *   [4.47.1 Game does not start](#Game_does_not_start_5)
        *   [4.47.2 Opening some menus causes the game to crash](#Opening_some_menus_causes_the_game_to_crash)
        *   [4.47.3 Game crashes after attempting to join server](#Game_crashes_after_attempting_to_join_server)
    *   [4.48 Gods will be watching](#Gods_will_be_watching)
    *   [4.49 GRID Autosport](#GRID_Autosport)
        *   [4.49.1 Black screen when trying to play](#Black_screen_when_trying_to_play)
    *   [4.50 Hack 'n' Slash](#Hack_.27n.27_Slash)
        *   [4.50.1 Crashes when trying to load a game](#Crashes_when_trying_to_load_a_game)
    *   [4.51 Hacker Evolution](#Hacker_Evolution)
    *   [4.52 Half-Life 2 and episodes](#Half-Life_2_and_episodes)
        *   [4.52.1 Cyrillic fonts problem](#Cyrillic_fonts_problem)
    *   [4.53 Hammerwatch](#Hammerwatch)
        *   [4.53.1 The game does not start via Steam](#The_game_does_not_start_via_Steam)
        *   [4.53.2 No sound](#No_sound_4)
    *   [4.54 Harvest: Massive Encounter](#Harvest:_Massive_Encounter)
        *   [4.54.1 Compatibility](#Compatibility_2)
    *   [4.55 Hatoful Boyfriend](#Hatoful_Boyfriend)
        *   [4.55.1 Japanese text invisible](#Japanese_text_invisible)
    *   [4.56 HuniePop](#HuniePop)
        *   [4.56.1 Game crashes upon launch](#Game_crashes_upon_launch)
    *   [4.57 Hyper Light Drifter](#Hyper_Light_Drifter)
        *   [4.57.1 The controller does not work](#The_controller_does_not_work)
        *   [4.57.2 Missing libcurl.so.4 or version CURL_OPENSSL_3 not found](#Missing_libcurl.so.4_or_version_CURL_OPENSSL_3_not_found)
    *   [4.58 The Impossible Game](#The_Impossible_Game)
    *   [4.59 The Inner World](#The_Inner_World)
        *   [4.59.1 Bringing up the inventory or main menu](#Bringing_up_the_inventory_or_main_menu)
            *   [4.59.1.1 Cutscenes](#Cutscenes)
    *   [4.60 Interloper](#Interloper)
        *   [4.60.1 Game does not start](#Game_does_not_start_6)
    *   [4.61 Invisible Apartment](#Invisible_Apartment)
        *   [4.61.1 Game does not start](#Game_does_not_start_7)
    *   [4.62 Joe Danger 2: The Movie](#Joe_Danger_2:_The_Movie)
        *   [4.62.1 Compatibility](#Compatibility_3)
    *   [4.63 Kerbal Space Program](#Kerbal_Space_Program)
    *   [4.64 Killing Floor](#Killing_Floor)
        *   [4.64.1 Cannot change screen resolution](#Cannot_change_screen_resolution)
        *   [4.64.2 Windowed mode](#Windowed_mode)
        *   [4.64.3 Stuttering sound](#Stuttering_sound)
    *   [4.65 Left for Dead 2](#Left_for_Dead_2)
        *   [4.65.1 Missing Chinese font](#Missing_Chinese_font)
    *   [4.66 Lethal League](#Lethal_League)
    *   [4.67 Life is Strange](#Life_is_Strange)
    *   [4.68 Little Racers STREET](#Little_Racers_STREET)
    *   [4.69 The Long Dark](#The_Long_Dark)
        *   [4.69.1 Game does not start](#Game_does_not_start_8)
        *   [4.69.2 Game starts, but some overlay text is missing and cutscenes shows black screen](#Game_starts.2C_but_some_overlay_text_is_missing_and_cutscenes_shows_black_screen)
        *   [4.69.3 Cutscenes are still black](#Cutscenes_are_still_black)
        *   [4.69.4 Cursor disappears](#Cursor_disappears)
    *   [4.70 Magicka 2](#Magicka_2)
        *   [4.70.1 Indefinitely stuck at start](#Indefinitely_stuck_at_start)
    *   [4.71 Mark of the Ninja](#Mark_of_the_Ninja)
        *   [4.71.1 Bad sound](#Bad_sound)
    *   [4.72 Metro: Last Light](#Metro:_Last_Light)
    *   [4.73 Metro: 2033 Redux](#Metro:_2033_Redux)
        *   [4.73.1 No sound](#No_sound_5)
    *   [4.74 Middle-earth: Shadow of Mordor](#Middle-earth:_Shadow_of_Mordor)
        *   [4.74.1 Floating heads](#Floating_heads)
    *   [4.75 Mount & Blade: Warband](#Mount_.26_Blade:_Warband)
        *   [4.75.1 Segmentation fault (core dumped) with wayland](#Segmentation_fault_.28core_dumped.29_with_wayland)
        *   [4.75.2 DLC Chooser](#DLC_Chooser)
    *   [4.76 Multiwinia](#Multiwinia)
        *   [4.76.1 Crash on startup](#Crash_on_startup)
    *   [4.77 Natural Selection 2](#Natural_Selection_2)
    *   [4.78 Nuclear Throne](#Nuclear_Throne)
        *   [4.78.1 Missing libcurl.so.4 or version CURL_OPENSSL_3 not found](#Missing_libcurl.so.4_or_version_CURL_OPENSSL_3_not_found_2)
    *   [4.79 Oxygen Not Included](#Oxygen_Not_Included)
        *   [4.79.1 World generation hangs](#World_generation_hangs)
    *   [4.80 Penumbra: Overture](#Penumbra:_Overture)
        *   [4.80.1 Windowed mode](#Windowed_mode_2)
    *   [4.81 The Polynomial](#The_Polynomial)
        *   [4.81.1 Segfaults during program start on 64-bit systems](#Segfaults_during_program_start_on_64-bit_systems)
    *   [4.82 Portal 2](#Portal_2)
        *   [4.82.1 Game does not start](#Game_does_not_start_9)
        *   [4.82.2 Resolution too low](#Resolution_too_low)
        *   [4.82.3 Missing non Latin font](#Missing_non_Latin_font)
    *   [4.83 Prison Architect](#Prison_Architect)
        *   [4.83.1 ALSA error when using PulseAudio](#ALSA_error_when_using_PulseAudio)
    *   [4.84 Project Zomboid](#Project_Zomboid)
        *   [4.84.1 No sound](#No_sound_6)
    *   [4.85 Pyre](#Pyre)
        *   [4.85.1 Game does not start](#Game_does_not_start_10)
    *   [4.86 Redshirt](#Redshirt)
    *   [4.87 Revenge of the Titans](#Revenge_of_the_Titans)
    *   [4.88 Risk of Rain](#Risk_of_Rain)
    *   [4.89 Rock Boshers DX: Directors Cut](#Rock_Boshers_DX:_Directors_Cut)
    *   [4.90 Saints Row IV](#Saints_Row_IV)
        *   [4.90.1 Game fails to launch after update to new Nvidia drivers](#Game_fails_to_launch_after_update_to_new_Nvidia_drivers)
        *   [4.90.2 Game causes GPU lockup with mesa drivers](#Game_causes_GPU_lockup_with_mesa_drivers)
    *   [4.91 Serious Sam 3: BFE](#Serious_Sam_3:_BFE)
    ...
    *   [4.95 Spacechem](#Spacechem)
        *   [4.95.1 Game crash](#Game_crash)
    *   [4.96 Splice](#Splice)
    *   [4.97 The Stanley Parable](#The_Stanley_Parable)
        *   [4.97.1 Game won't start](#Game_won.27t_start)
    *   [4.98 Shadow Tactics: Blades of the Shogun](#Shadow_Tactics:_Blades_of_the_Shogun)
    *   [4.99 Steel Storm: Burning Retribution](#Steel_Storm:_Burning_Retribution)
        *   [4.99.1 Start with black screen](#Start_with_black_screen)
    *   [4.100 Stephen's Sausage Roll](#Stephen.27s_Sausage_Roll)
        *   [4.100.1 No sound](#No_sound_7)
    *   [4.101 Superbrothers: Sword & Sworcery EP](#Superbrothers:_Sword_.26_Sworcery_EP)
    *   [4.102 System Shock 2](#System_Shock_2)
    *   [4.103 Tabletop Simulator](#Tabletop_Simulator)
        *   [4.103.1 CJK characters not showing in game](#CJK_characters_not_showing_in_game)
    *   [4.104 Team Fortress 2](#Team_Fortress_2)
        *   [4.104.1 HRTF setup](#HRTF_setup)
        *   [4.104.2 Loading screen freeze](#Loading_screen_freeze)
        *   [4.104.3 No audio](#No_audio_4)
        *   [4.104.4 Slow loading textures](#Slow_loading_textures)
    *   [4.105 Terraria](#Terraria)
    *   [4.106 This War of Mine](#This_War_of_Mine)
        *   [4.106.1 Game does not start](#Game_does_not_start_11)
        *   [4.106.2 Sound glitches with Steam native](#Sound_glitches_with_Steam_native)
    *   [4.107 Ticket to Ride](#Ticket_to_Ride)
    *   [4.108 The Tiny Bang Story](#The_Tiny_Bang_Story)
        *   [4.108.1 Missing libGLEW.so.1.6](#Missing_libGLEW.so.1.6)
    *   [4.109 Tomb Raider](#Tomb_Raider)
        *   [4.109.1 Game immediately closes when running with steam-native](#Game_immediately_closes_when_running_with_steam-native)
        *   [4.109.2 Steam Controller not working in-game](#Steam_Controller_not_working_in-game)
    *   [4.110 Tower Unite](#Tower_Unite)
        *   [4.110.1 Graphical Glitches](#Graphical_Glitches)
    *   [4.111 Towns / Towns Demo](#Towns_.2F_Towns_Demo)
    *   [4.112 Transistor](#Transistor)
        *   [4.112.1 Crash on launch / FMOD binding crash / audio issues](#Crash_on_launch_.2F_FMOD_binding_crash_.2F_audio_issues)
    *   [4.113 Transmissions: Element 120](#Transmissions:_Element_120)
        *   [4.113.1 Troubleshooting](#Troubleshooting)
    *   [4.114 Trine 2](#Trine_2)
        *   [4.114.1 Colors](#Colors)
        *   [4.114.2 Sound](#Sound)
        *   [4.114.3 Resolution](#Resolution)
    *   [4.115 Tropico 5](#Tropico_5)
        *   [4.115.1 Blank screen with sound only on startup](#Blank_screen_with_sound_only_on_startup)
    *   [4.116 Unity of Command](#Unity_of_Command)
        *   [4.116.1 Squares](#Squares)
        *   [4.116.2 No audio](#No_audio_5)
    *   [4.117 Unity3D](#Unity3D)
        *   [4.117.1 Locale settings](#Locale_settings)
        *   [4.117.2 Unity 5 sound problems](#Unity_5_sound_problems)
        *   [4.117.3 Game launching on wrong monitor in fullscreen mode](#Game_launching_on_wrong_monitor_in_fullscreen_mode)
        *   [4.117.4 Chinese/Japanese/Korean display bug](#Chinese.2FJapanese.2FKorean_display_bug)
    *   [4.118 Unrest](#Unrest)
    *   [4.119 Volgarr the Viking](#Volgarr_the_Viking)
    *   [4.120 War Thunder](#War_Thunder)
        *   [4.120.1 No audio](#No_audio_6)
        *   [4.120.2 Blank screen](#Blank_screen)
    *   [4.121 Warhammer 40,000: Dawn of War II](#Warhammer_40.2C000:_Dawn_of_War_II)
    *   [4.122 We Were Here](#We_Were_Here)
        *   [4.122.1 Stuck on black screen or logo on launch](#Stuck_on_black_screen_or_logo_on_launch)
    *   [4.123 Worms W.M.D](#Worms_W.M.D)
    *   [4.124 Witcher 2: Assassin of Kings](#Witcher_2:_Assassin_of_Kings)
        *   [4.124.1 Game does not start](#Game_does_not_start_12)
    *   [4.125 Wizardry 6: Bane of the Cosmic Forge](#Wizardry_6:_Bane_of_the_Cosmic_Forge)
    *   [4.126 World of Goo](#World_of_Goo)
        *   [4.126.1 Changing resolution](#Changing_resolution)
    *   [4.127 X3: Terran Conflict](#X3:_Terran_Conflict)
        *   [4.127.1 Game crashes on startup](#Game_crashes_on_startup)
    *   [4.128 XCOM](#XCOM)
        *   [4.128.1 Hangs on startup](#Hangs_on_startup)
        *   [4.128.2 Graphical glitches on Intel HD](#Graphical_glitches_on_Intel_HD)

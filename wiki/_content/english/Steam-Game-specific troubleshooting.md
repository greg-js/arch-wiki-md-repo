...
*   [4 Games](#Games)
    ...
    *   [4.39 Euro Truck Simulator 2](#Euro_Truck_Simulator_2)
        *   [4.39.1 Shows only a black screen](#Shows_only_a_black_screen)
    *   [4.40 Football Manager 2014](#Football_Manager_2014)
    *   [4.41 FORCED](#FORCED)
    *   [4.42 FTL: Faster than Light](#FTL:_Faster_than_Light)
        *   [4.42.1 Compatibility](#Compatibility)
        *   [4.42.2 Problems with open-source video driver](#Problems_with_open-source_video_driver)
    *   [4.43 Game Dev Tycoon](#Game_Dev_Tycoon)
        *   [4.43.1 Game does not start](#Game_does_not_start_4)
    *   [4.44 Garry's Mod](#Garry.27s_Mod)
        *   [4.44.1 Game does not start](#Game_does_not_start_5)
        *   [4.44.2 Opening some menus causes the game to crash](#Opening_some_menus_causes_the_game_to_crash)
        *   [4.44.3 Game crashes after attempting to join server](#Game_crashes_after_attempting_to_join_server)
    *   [4.45 Gods will be watching](#Gods_will_be_watching)
    *   [4.46 GRID Autosport](#GRID_Autosport)
        *   [4.46.1 Black screen when trying to play](#Black_screen_when_trying_to_play)
    *   [4.47 Hack 'n' Slash](#Hack_.27n.27_Slash)
        *   [4.47.1 Crashes when trying to load a game](#Crashes_when_trying_to_load_a_game)
    *   [4.48 Hacker Evolution](#Hacker_Evolution)
    *   [4.49 Half-Life 2 and episodes](#Half-Life_2_and_episodes)
        *   [4.49.1 Cyrillic fonts problem](#Cyrillic_fonts_problem)
    *   [4.50 Hammerwatch](#Hammerwatch)
        *   [4.50.1 The game does not start via Steam](#The_game_does_not_start_via_Steam)
        *   [4.50.2 No sound](#No_sound_4)
    *   [4.51 Harvest: Massive Encounter](#Harvest:_Massive_Encounter)
        *   [4.51.1 Compatibility](#Compatibility_2)
    *   [4.52 Hatoful Boyfriend](#Hatoful_Boyfriend)
        *   [4.52.1 Japanese text invisible](#Japanese_text_invisible)
    *   [4.53 Hyper Light Drifter](#Hyper_Light_Drifter)
        *   [4.53.1 The controller does not work](#The_controller_does_not_work)
        *   [4.53.2 Missing libcurl.so.4 or version CURL_OPENSSL_3 not found](#Missing_libcurl.so.4_or_version_CURL_OPENSSL_3_not_found)
    *   [4.54 The Impossible Game](#The_Impossible_Game)
    *   [4.55 The Inner World](#The_Inner_World)
        *   [4.55.1 Bringing up the inventory or main menu](#Bringing_up_the_inventory_or_main_menu)
            *   [4.55.1.1 Cutscenes](#Cutscenes)
    *   [4.56 Interloper](#Interloper)
        *   [4.56.1 Game does not start](#Game_does_not_start_6)
    *   [4.57 Invisible Apartment](#Invisible_Apartment)
        *   [4.57.1 Game does not start](#Game_does_not_start_7)
    *   [4.58 Joe Danger 2: The Movie](#Joe_Danger_2:_The_Movie)
        *   [4.58.1 Compatibility](#Compatibility_3)
    *   [4.59 Kerbal Space Program](#Kerbal_Space_Program)
    *   [4.60 Killing Floor](#Killing_Floor)
        *   [4.60.1 Cannot change screen resolution](#Cannot_change_screen_resolution)
        *   [4.60.2 Windowed mode](#Windowed_mode)
        *   [4.60.3 Stuttering sound](#Stuttering_sound)
    *   [4.61 Left for Dead 2](#Left_for_Dead_2)
        *   [4.61.1 Missing Chinese font](#Missing_Chinese_font)
    *   [4.62 Lethal League](#Lethal_League)
    *   [4.63 Life is Strange](#Life_is_Strange)
    *   [4.64 Little Racers STREET](#Little_Racers_STREET)
    *   [4.65 The Long Dark](#The_Long_Dark)
        *   [4.65.1 Game does not start](#Game_does_not_start_8)
        *   [4.65.2 Game starts, but some overlay text is missing and cutscenes shows black screen](#Game_starts.2C_but_some_overlay_text_is_missing_and_cutscenes_shows_black_screen)
        *   [4.65.3 Cutscenes are still black](#Cutscenes_are_still_black)
        *   [4.65.4 Cursor disappears](#Cursor_disappears)
    *   [4.66 Magicka 2](#Magicka_2)
        *   [4.66.1 Indefinitely stuck at start](#Indefinitely_stuck_at_start)
    *   [4.67 Mark of the Ninja](#Mark_of_the_Ninja)
        *   [4.67.1 Bad sound](#Bad_sound)
    *   [4.68 Metro: Last Light](#Metro:_Last_Light)
    *   [4.69 Metro: 2033 Redux](#Metro:_2033_Redux)
        *   [4.69.1 No sound](#No_sound_5)
    *   [4.70 Middle-earth: Shadow of Mordor](#Middle-earth:_Shadow_of_Mordor)
        *   [4.70.1 Floating heads](#Floating_heads)
    *   [4.71 Mount & Blade: Warband](#Mount_.26_Blade:_Warband)
        *   [4.71.1 Segmentation fault (core dumped) with wayland](#Segmentation_fault_.28core_dumped.29_with_wayland)
        *   [4.71.2 DLC Chooser](#DLC_Chooser)
    *   [4.72 Multiwinia](#Multiwinia)
        *   [4.72.1 Crash on startup](#Crash_on_startup)

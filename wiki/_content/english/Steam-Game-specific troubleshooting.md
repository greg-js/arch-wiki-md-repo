...
*   [17 Counter-Strike: Global Offensive (CS:GO)](#Counter-Strike:_Global_Offensive_.28CS:GO.29)
    *   [17.1 Game runs on the wrong screen](#Game_runs_on_the_wrong_screen)
    *   [17.2 Cannot reach bottom of the screen on menues](#Cannot_reach_bottom_of_the_screen_on_menues)
    *   [17.3 Audio is not synced](#Audio_is_not_synced)
    *   [17.4 Unable to aim when in game](#Unable_to_aim_when_in_game)
    *   [17.5 Mouse Deadzone](#Mouse_Deadzone)
    *   [17.6 Low Performance on AMD card using Catalyst proprietary driver ( <= 15.7 )](#Low_Performance_on_AMD_card_using_Catalyst_proprietary_driver_.28_.3C.3D_15.7_.29)
    *   [17.7 Brightness slider not working](#Brightness_slider_not_working)
*   [18 Crusader Kings II](#Crusader_Kings_II)
    *   [18.1 Dependencies (x86_64)](#Dependencies_.28x86_64.29)
    *   [18.2 Tips and tricks](#Tips_and_tricks)
    *   [18.3 No audio](#No_audio)
    *   [18.4 Odd Sized Starting Window](#Odd_Sized_Starting_Window)
*   [19 Death Road To Canada](#Death_Road_To_Canada)
    *   [19.1 No music](#No_music)
*   [20 Defender's Quest: Valley of the Forgotten](#Defender.27s_Quest:_Valley_of_the_Forgotten)
    *   [20.1 Dependencies](#Dependencies_8)
    *   [20.2 Game does not start](#Game_does_not_start)
*   [21 Divinity: Original Sin - Enhanced Edition](#Divinity:_Original_Sin_-_Enhanced_Edition)
    *   [21.1 Game doesn't start when using Bumblebee optirun or primusrun](#Game_doesn.27t_start_when_using_Bumblebee_optirun_or_primusrun)
*   [22 Don't Starve](#Don.27t_Starve)
    *   [22.1 Dependencies](#Dependencies_9)
    *   [22.2 No sound](#No_sound_2)
*   [23 Dota 2](#Dota_2)
    *   [23.1 Dependencies](#Dependencies_10)
        *   [23.1.1 Dota 2 reborn](#Dota_2_reborn)
    *   [23.2 In-game font is unreadable](#In-game_font_is_unreadable)
    *   [23.3 Everything seems OK but the game doesn't start](#Everything_seems_OK_but_the_game_doesn.27t_start)
    *   [23.4 Game runs on the wrong screen](#Game_runs_on_the_wrong_screen_2)
    *   [23.5 Game does not start with libxcb-dri3 error message](#Game_does_not_start_with_libxcb-dri3_error_message)
    *   [23.6 Steam overlay](#Steam_overlay)
    *   [23.7 Chinese Tips and player's name display problem](#Chinese_Tips_and_player.27s_name_display_problem)
    *   [23.8 Chinese input method problem](#Chinese_input_method_problem)
*   [24 Dwarfs F2P](#Dwarfs_F2P)
    *   [24.1 Dependencies](#Dependencies_11)
    *   [24.2 Game does not start](#Game_does_not_start_2)
    *   [24.3 Game crashes](#Game_crashes)
*   [25 Dynamite Jack](#Dynamite_Jack)
    *   [25.1 Dependencies](#Dependencies_12)
    *   [25.2 Sound Issues](#Sound_Issues)
    *   [25.3 Game does not start](#Game_does_not_start_3)
*   [26 Football Manager 2014](#Football_Manager_2014)
*   [27 FORCED](#FORCED)
    *   [27.1 Dependencies](#Dependencies_13)
*   [28 FTL: Faster than Light](#FTL:_Faster_than_Light)
    *   [28.1 Dependencies](#Dependencies_14)
    *   [28.2 Compatibility](#Compatibility_3)
    *   [28.3 Problems with open-source video driver](#Problems_with_open-source_video_driver)
*   [29 Game Dev Tycoon](#Game_Dev_Tycoon)
    *   [29.1 Game does not start](#Game_does_not_start_4)
*   [30 Garry's Mod](#Garry.27s_Mod)
    *   [30.1 Game does not start](#Game_does_not_start_5)
    *   [30.2 Opening some menus causes the game to crash](#Opening_some_menus_causes_the_game_to_crash)
    *   [30.3 Game crashes after attempting to join server](#Game_crashes_after_attempting_to_join_server)
*   [31 Hack 'n' Slash](#Hack_.27n.27_Slash)
    *   [31.1 The game starts but craches when loading a new or saved game](#The_game_starts_but_craches_when_loading_a_new_or_saved_game)
*   [32 Hacker Evolution [Untold, Duality]](#Hacker_Evolution_.5BUntold.2C_Duality.5D)
    *   [32.1 Dependencies](#Dependencies_15)
*   [33 Half-Life 2 and episodes](#Half-Life_2_and_episodes)
    *   [33.1 Cyrillic fonts problem](#Cyrillic_fonts_problem)
*   [34 Hammerwatch](#Hammerwatch)
    *   [34.1 The game not starting from Steam GUI](#The_game_not_starting_from_Steam_GUI)
    *   [34.2 No sound](#No_sound_3)
*   [35 Harvest: Massive Encounter](#Harvest:_Massive_Encounter)
    *   [35.1 Dependencies](#Dependencies_16)
    *   [35.2 Compatibility](#Compatibility_4)
*   [36 Hatoful Boyfriend](#Hatoful_Boyfriend)
    *   [36.1 Japanese text invisible](#Japanese_text_invisible)
*   [37 The Impossible Game](#The_Impossible_Game)
    *   [37.1 Dependencies](#Dependencies_17)
*   [38 The Inner World](#The_Inner_World)
    *   [38.1 Bringing up the inventory or main menu](#Bringing_up_the_inventory_or_main_menu)
    *   [38.2 Dependencies](#Dependencies_18)
        *   [38.2.1 Sound support](#Sound_support)
        *   [38.2.2 Cutscenes](#Cutscenes)
*   [39 Interloper](#Interloper)
    *   [39.1 Dependencies](#Dependencies_19)
    *   [39.2 Game does not launch](#Game_does_not_launch)
*   [40 Invisible Apartment](#Invisible_Apartment)
    *   [40.1 Dependencies](#Dependencies_20)
    *   [40.2 Game does not run](#Game_does_not_run)
*   [41 Joe Danger 2: The Movie](#Joe_Danger_2:_The_Movie)
    *   [41.1 Dependencies](#Dependencies_21)
    *   [41.2 Compatibility](#Compatibility_5)
*   [42 Kerbal Space Program](#Kerbal_Space_Program)
*   [43 Killing Floor](#Killing_Floor)
    *   [43.1 Screen resolution](#Screen_resolution)
    *   [43.2 Windowed mode](#Windowed_mode)
    *   [43.3 Stuttering Sound](#Stuttering_Sound)
...
*   [47 Metro: Last Light](#Metro:_Last_Light)
    *   [47.1 Attempted fixes](#Attempted_fixes)
    *   [47.2 Hacky solution](#Hacky_solution)
    *   [47.3 Possible solutions](#Possible_solutions)
...
*   [67 Steel Storm: Burning Retribution](#Steel_Storm:_Burning_Retribution)
    *   [67.1 Start with black screen](#Start_with_black_screen)
    *   [67.2 No English fonts](#No_English_fonts)
...
*   [71 Tabletop Simulator](#Tabletop_Simulator)
    *   [71.1 CJK characters not showing in game](#CJK_characters_not_showing_in_game)
*   [72 Team Fortress 2](#Team_Fortress_2)
    *   [72.1 Dependencies](#Dependencies_38)
    *   [72.2 Making HRTF work](#Making_HRTF_work)
    *   [72.3 Loading screen freeze](#Loading_screen_freeze)
    *   [72.4 No audio](#No_audio_4)
    *   [72.5 Slow loading textures](#Slow_loading_textures)
*   [73 Terraria](#Terraria)
*   [74 This War of Mine](#This_War_of_Mine)
    *   [74.1 Game doesn't load](#Game_doesn.27t_load)
*   [75 Tomb Raider](#Tomb_Raider)
    *   [75.1 Game immediately closes when running with steam-native](#Game_immediately_closes_when_running_with_steam-native)
    *   [75.2 Steam Controller not working ingame while being correctly recognised* by Steam outside of the game](#Steam_Controller_not_working_ingame_while_being_correctly_recognised.2A_by_Steam_outside_of_the_game)
*   [76 Towns / Towns Demo](#Towns_.2F_Towns_Demo)
    *   [76.1 Crash on launch](#Crash_on_launch)
*   [77 Transistor](#Transistor)
    *   [77.1 Crash on launch / FMOD binding crash / Audio issues](#Crash_on_launch_.2F_FMOD_binding_crash_.2F_Audio_issues)
*   [78 Transmissions: Element 120](#Transmissions:_Element_120)
    *   [78.1 Troubleshooting](#Troubleshooting)
    *   [78.2 Dependencies](#Dependencies_39)
*   [79 Trine 2](#Trine_2)
    *   [79.1 Dependencies](#Dependencies_40)
    *   [79.2 Colors](#Colors)
    *   [79.3 Sound](#Sound)
    *   [79.4 Resolution](#Resolution)
*   [80 Unity of Command](#Unity_of_Command)
    *   [80.1 Dependencies](#Dependencies_41)
    *   [80.2 Squares](#Squares)
    *   [80.3 No audio](#No_audio_5)
*   [81 Unity3D](#Unity3D)
    *   [81.1 Locale Settings](#Locale_Settings)
    *   [81.2 Unity 5 sound problems](#Unity_5_sound_problems)
    *   [81.3 Game launching on wrong monitor in fullscreen mode](#Game_launching_on_wrong_monitor_in_fullscreen_mode)
*   [82 Unrest](#Unrest)
    *   [82.1 Dependencies](#Dependencies_42)
*   [83 War Thunder](#War_Thunder)
    *   [83.1 Blank screen](#Blank_screen)
*   [84 Warhammer 40,000: Dawn of War II](#Warhammer_40.2C000:_Dawn_of_War_II)
    *   [84.1 Dependencies](#Dependencies_43)
    *   [84.2 Blank screen](#Blank_screen_2)
*   [85 Witcher 2: Assassin of Kings](#Witcher_2:_Assassin_of_Kings)
    *   [85.1 Dependencies](#Dependencies_44)
    *   [85.2 Game does not start](#Game_does_not_start_7)
*   [86 Wizardry 6: Bane of the Cosmic Forge](#Wizardry_6:_Bane_of_the_Cosmic_Forge)
    *   [86.1 Dependencies](#Dependencies_45)
*   [87 World of Goo](#World_of_Goo)
    *   [87.1 Changing resolution](#Changing_resolution)
*   [88 Worms Reloaded](#Worms_Reloaded)
    *   [88.1 Dependencies](#Dependencies_46)
*   [89 XCOM](#XCOM)
    *   [89.1 Dependencies](#Dependencies_47)
    *   [89.2 Hangs on startup](#Hangs_on_startup)
    *   [89.3 Graphical glitches on Intel HD](#Graphical_glitches_on_Intel_HD)

...
*   [4 Games](#Games)
    ...
    *   [4.48 FORCED](#FORCED)
    *   [4.49 FTL: Faster than Light](#FTL:_Faster_than_Light)
        *   [4.49.1 Compatibility](#Compatibility)
        *   [4.49.2 Problems with open-source video driver](#Problems_with_open-source_video_driver)
    *   [4.50 Game Dev Tycoon](#Game_Dev_Tycoon)
        *   [4.50.1 Game does not start](#Game_does_not_start_5)
    *   [4.51 Garry's Mod](#Garry.27s_Mod)
        *   [4.51.1 Game does not start](#Game_does_not_start_6)
        *   [4.51.2 Opening some menus causes the game to crash](#Opening_some_menus_causes_the_game_to_crash)
        *   [4.51.3 Game crashes after attempting to join server](#Game_crashes_after_attempting_to_join_server)
    *   [4.52 Gods will be watching](#Gods_will_be_watching)
    *   [4.53 GRID Autosport](#GRID_Autosport)
        *   [4.53.1 Black screen when trying to play](#Black_screen_when_trying_to_play)
    *   [4.54 Hack 'n' Slash](#Hack_.27n.27_Slash)
        *   [4.54.1 Crashes when trying to load a game](#Crashes_when_trying_to_load_a_game)
    *   [4.55 Hacker Evolution](#Hacker_Evolution)
    *   [4.56 Half-Life 2 and episodes](#Half-Life_2_and_episodes)
        *   [4.56.1 Cyrillic fonts problem](#Cyrillic_fonts_problem)
    *   [4.57 Hammerwatch](#Hammerwatch)
        *   [4.57.1 The game does not start via Steam](#The_game_does_not_start_via_Steam)
        *   [4.57.2 No sound](#No_sound_4)
    *   [4.58 Harvest: Massive Encounter](#Harvest:_Massive_Encounter)
        *   [4.58.1 Compatibility](#Compatibility_2)
    *   [4.59 Hatoful Boyfriend](#Hatoful_Boyfriend)
        *   [4.59.1 Japanese text invisible](#Japanese_text_invisible)
    *   [4.60 HuniePop](#HuniePop)
        *   [4.60.1 Game crashes upon launch](#Game_crashes_upon_launch)
    *   [4.61 Hyper Light Drifter](#Hyper_Light_Drifter)
        *   [4.61.1 The controller does not work](#The_controller_does_not_work)
        *   [4.61.2 Missing libcurl.so.4 or version CURL_OPENSSL_3 not found](#Missing_libcurl.so.4_or_version_CURL_OPENSSL_3_not_found)
    *   [4.62 The Impossible Game](#The_Impossible_Game)
    *   [4.63 The Inner World](#The_Inner_World)
        *   [4.63.1 Bringing up the inventory or main menu](#Bringing_up_the_inventory_or_main_menu)
            *   [4.63.1.1 Cutscenes](#Cutscenes)
    *   [4.64 Interloper](#Interloper)
        *   [4.64.1 Game does not start](#Game_does_not_start_7)
    *   [4.65 Invisible Apartment](#Invisible_Apartment)
        *   [4.65.1 Game does not start](#Game_does_not_start_8)
    *   [4.66 Joe Danger 2: The Movie](#Joe_Danger_2:_The_Movie)
        *   [4.66.1 Compatibility](#Compatibility_3)
    *   [4.67 Kerbal Space Program](#Kerbal_Space_Program)
    *   [4.68 Killing Floor](#Killing_Floor)
        *   [4.68.1 Cannot change screen resolution](#Cannot_change_screen_resolution)
        *   [4.68.2 Windowed mode](#Windowed_mode)
        *   [4.68.3 Stuttering sound](#Stuttering_sound)
    *   [4.69 Left for Dead 2](#Left_for_Dead_2)
        *   [4.69.1 Missing Chinese font](#Missing_Chinese_font)
    *   [4.70 Lethal League](#Lethal_League)
    *   [4.71 Life is Strange](#Life_is_Strange)
    *   [4.72 Little Racers STREET](#Little_Racers_STREET)
    *   [4.73 The Long Dark](#The_Long_Dark)
        *   [4.73.1 Game does not start](#Game_does_not_start_9)
        *   [4.73.2 Game starts, but some overlay text is missing and cutscenes shows black screen](#Game_starts.2C_but_some_overlay_text_is_missing_and_cutscenes_shows_black_screen)
        *   [4.73.3 Cutscenes are still black](#Cutscenes_are_still_black)
        *   [4.73.4 Cursor disappears](#Cursor_disappears)
    *   [4.74 Magicka 2](#Magicka_2)
        *   [4.74.1 Indefinitely stuck at start](#Indefinitely_stuck_at_start)
    *   [4.75 Mark of the Ninja](#Mark_of_the_Ninja)
        *   [4.75.1 Bad sound](#Bad_sound)
    *   [4.76 Metro: Last Light](#Metro:_Last_Light)
    *   [4.77 Metro: 2033 Redux](#Metro:_2033_Redux)
        *   [4.77.1 No sound](#No_sound_5)
    *   [4.78 No image](#No_image)
    *   [4.79 Middle-earth: Shadow of Mordor](#Middle-earth:_Shadow_of_Mordor)
        *   [4.79.1 Floating heads](#Floating_heads)
    *   [4.80 Mount & Blade: Warband](#Mount_.26_Blade:_Warband)
        *   [4.80.1 Segmentation fault (core dumped) with wayland](#Segmentation_fault_.28core_dumped.29_with_wayland)
        *   [4.80.2 DLC Chooser](#DLC_Chooser)
        *   [4.80.3 Crash on startup](#Crash_on_startup)
    *   [4.81 Multiwinia](#Multiwinia)
        *   [4.81.1 Crash on startup](#Crash_on_startup_2)
    *   [4.82 Natural Selection 2](#Natural_Selection_2)
    *   [4.83 Nuclear Throne](#Nuclear_Throne)
        *   [4.83.1 Missing libcurl.so.4 or version CURL_OPENSSL_3 not found](#Missing_libcurl.so.4_or_version_CURL_OPENSSL_3_not_found_2)
    *   [4.84 Oxygen Not Included](#Oxygen_Not_Included)
        *   [4.84.1 World generation hangs](#World_generation_hangs)
    *   [4.85 Penumbra: Overture](#Penumbra:_Overture)
        *   [4.85.1 Windowed mode](#Windowed_mode_2)
    *   [4.86 The Polynomial](#The_Polynomial)
        *   [4.86.1 Segfaults during program start on 64-bit systems](#Segfaults_during_program_start_on_64-bit_systems)
    *   [4.87 Portal 2](#Portal_2)
        *   [4.87.1 Game does not start](#Game_does_not_start_10)
        *   [4.87.2 Resolution too low](#Resolution_too_low)
        *   [4.87.3 Missing non Latin font](#Missing_non_Latin_font)
    *   [4.88 Prison Architect](#Prison_Architect)
        *   [4.88.1 ALSA error when using PulseAudio](#ALSA_error_when_using_PulseAudio)
    *   [4.89 Project Zomboid](#Project_Zomboid)
        *   [4.89.1 No sound](#No_sound_6)
    *   [4.90 Pyre](#Pyre)
        *   [4.90.1 Game does not start](#Game_does_not_start_11)
    *   [4.91 Redshirt](#Redshirt)
    *   [4.92 Revenge of the Titans](#Revenge_of_the_Titans)
    *   [4.93 Risk of Rain](#Risk_of_Rain)
    *   [4.94 Rock Boshers DX: Directors Cut](#Rock_Boshers_DX:_Directors_Cut)
    *   [4.95 Saints Row IV](#Saints_Row_IV)
        *   [4.95.1 Game fails to launch after update to new Nvidia drivers](#Game_fails_to_launch_after_update_to_new_Nvidia_drivers)
        *   [4.95.2 Game causes GPU lockup with mesa drivers](#Game_causes_GPU_lockup_with_mesa_drivers)
    *   [4.96 Serious Sam 3: BFE](#Serious_Sam_3:_BFE)
        *   [4.96.1 No audio](#No_audio_2)
    *   [4.97 Slay the Spire](#Slay_the_Spire)
    *   [4.98 Songbringer](#Songbringer)
        *   [4.98.1 Launch error with Wayland](#Launch_error_with_Wayland)
    *   [4.99 Space Pirates and Zombies](#Space_Pirates_and_Zombies)
        *   [4.99.1 No audio](#No_audio_3)
    *   [4.100 Spacechem](#Spacechem)
        *   [4.100.1 Game crash](#Game_crash)
    *   [4.101 Splice](#Splice)
    *   [4.102 The Stanley Parable](#The_Stanley_Parable)
        *   [4.102.1 Game won't start](#Game_won.27t_start)
    *   [4.103 Shadow Tactics: Blades of the Shogun](#Shadow_Tactics:_Blades_of_the_Shogun)
    *   [4.104 Steel Storm: Burning Retribution](#Steel_Storm:_Burning_Retribution)
        *   [4.104.1 Start with black screen](#Start_with_black_screen)
    *   [4.105 Stellaris](#Stellaris)
        *   [4.105.1 No window opening, only sound](#No_window_opening.2C_only_sound)
    *   [4.106 Stephen's Sausage Roll](#Stephen.27s_Sausage_Roll)
        *   [4.106.1 No sound](#No_sound_7)
    *   [4.107 Superbrothers: Sword & Sworcery EP](#Superbrothers:_Sword_.26_Sworcery_EP)
    *   [4.108 System Shock 2](#System_Shock_2)
    *   [4.109 Tabletop Simulator](#Tabletop_Simulator)
        *   [4.109.1 CJK characters not showing in game](#CJK_characters_not_showing_in_game)
    *   [4.110 Team Fortress 2](#Team_Fortress_2)
        *   [4.110.1 HRTF setup](#HRTF_setup)
        *   [4.110.2 Loading screen freeze](#Loading_screen_freeze)
        *   [4.110.3 No audio](#No_audio_4)
        *   [4.110.4 Slow loading textures](#Slow_loading_textures)
    *   [4.111 Terraria](#Terraria)
    *   [4.112 This War of Mine](#This_War_of_Mine)
        *   [4.112.1 Game does not start](#Game_does_not_start_12)
        *   [4.112.2 Sound glitches with Steam native](#Sound_glitches_with_Steam_native)
    *   [4.113 Ticket to Ride](#Ticket_to_Ride)
    *   [4.114 The Tiny Bang Story](#The_Tiny_Bang_Story)
        *   [4.114.1 Missing libGLEW.so.1.6](#Missing_libGLEW.so.1.6)
    *   [4.115 Tomb Raider](#Tomb_Raider)
        *   [4.115.1 Game immediately closes when running with steam-native](#Game_immediately_closes_when_running_with_steam-native)
        *   [4.115.2 Steam Controller not working in-game](#Steam_Controller_not_working_in-game)
    *   [4.116 Torchlight 2](#Torchlight_2)
        *   [4.116.1 Libfreetype/libfontconfig Incompatibility](#Libfreetype.2Flibfontconfig_Incompatibility)
        *   [4.116.2 Locale incompatibility](#Locale_incompatibility)
    *   [4.117 Tower Unite](#Tower_Unite)
        *   [4.117.1 Graphical Glitches](#Graphical_Glitches)
    *   [4.118 Towns / Towns Demo](#Towns_.2F_Towns_Demo)
    *   [4.119 Transistor](#Transistor)
        *   [4.119.1 Crash on launch / FMOD binding crash / audio issues](#Crash_on_launch_.2F_FMOD_binding_crash_.2F_audio_issues)
    *   [4.120 Transmissions: Element 120](#Transmissions:_Element_120)
        *   [4.120.1 Troubleshooting](#Troubleshooting)
    *   [4.121 Trine 2](#Trine_2)
        *   [4.121.1 Colors](#Colors)
        *   [4.121.2 Sound](#Sound)
        *   [4.121.3 Resolution](#Resolution)
    *   [4.122 Tropico 5](#Tropico_5)
        *   [4.122.1 Blank screen with sound only on startup](#Blank_screen_with_sound_only_on_startup)
    *   [4.123 Unity of Command](#Unity_of_Command)
        *   [4.123.1 Squares](#Squares)
        *   [4.123.2 No audio](#No_audio_5)
    *   [4.124 Unity3D](#Unity3D)
        *   [4.124.1 Locale settings](#Locale_settings)
        *   [4.124.2 Unity 5 sound problems](#Unity_5_sound_problems)
        *   [4.124.3 Game launching on wrong monitor in fullscreen mode](#Game_launching_on_wrong_monitor_in_fullscreen_mode_2)
        *   [4.124.4 Chinese/Japanese/Korean display bug](#Chinese.2FJapanese.2FKorean_display_bug)
        *   [4.124.5 Game does not respond](#Game_does_not_respond)
    *   [4.125 Unrest](#Unrest)
    *   [4.126 Volgarr the Viking](#Volgarr_the_Viking)
    *   [4.127 War Thunder](#War_Thunder)
        *   [4.127.1 No audio](#No_audio_6)
        *   [4.127.2 Blank screen](#Blank_screen)
    *   [4.128 Warhammer 40,000: Dawn of War II](#Warhammer_40.2C000:_Dawn_of_War_II)
    *   [4.129 We Were Here](#We_Were_Here)
        *   [4.129.1 Stuck on black screen or logo on launch](#Stuck_on_black_screen_or_logo_on_launch)
    *   [4.130 Worms W.M.D](#Worms_W.M.D)
    *   [4.131 Witcher 2: Assassin of Kings](#Witcher_2:_Assassin_of_Kings)
        *   [4.131.1 Game does not start](#Game_does_not_start_13)
    *   [4.132 Wizardry 6: Bane of the Cosmic Forge](#Wizardry_6:_Bane_of_the_Cosmic_Forge)
    *   [4.133 World of Goo](#World_of_Goo)
        *   [4.133.1 Changing resolution](#Changing_resolution)
    *   [4.134 X3: Terran Conflict](#X3:_Terran_Conflict)
        *   [4.134.1 Game crashes on startup](#Game_crashes_on_startup)
    *   [4.135 XCOM](#XCOM)
        *   [4.135.1 Hangs on startup](#Hangs_on_startup)
        *   [4.135.2 Graphical glitches on Intel HD](#Graphical_glitches_on_Intel_HD)

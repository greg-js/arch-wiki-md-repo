...
*   [15 Defender's Quest: Valley of the Forgotten](#Defender.27s_Quest:_Valley_of_the_Forgotten)
    ...
    *   [15.2 Troubleshooting](#Troubleshooting_3)
        *   [15.2.1 Game does not start](#Game_does_not_start)
*   [16 Don't Starve](#Don.27t_Starve)
    *   [16.1 Dependencies (x86_64)](#Dependencies_.28x86_64.29)
    *   [16.2 Troubleshooting](#Troubleshooting_4)
        *   [16.2.1 No sound](#No_sound_2)
*   [17 Dota 2](#Dota_2)
    *   [17.1 Dependencies (x86_64)](#Dependencies_.28x86_64.29_2)
    *   [17.2 Dependencies (Dota 2 reborn)](#Dependencies_.28Dota_2_reborn.29)
    *   [17.3 Troubleshooting](#Troubleshooting_5)
        *   [17.3.1 In-game font is unreadable](#In-game_font_is_unreadable)
        *   [17.3.2 Everything seems OK but the game doesn't start](#Everything_seems_OK_but_the_game_doesn.27t_start)
        *   [17.3.3 Game runs on the wrong screen](#Game_runs_on_the_wrong_screen_2)
        *   [17.3.4 Game does not start with libxcb-dri3 error message](#Game_does_not_start_with_libxcb-dri3_error_message)
        *   [17.3.5 Steam overlay](#Steam_overlay)
        *   [17.3.6 Chinese Tips and player's name display problem](#Chinese_Tips_and_player.27s_name_display_problem)
        *   [17.3.7 Chinese input method problem](#Chinese_input_method_problem)
*   [18 Dwarfs F2P](#Dwarfs_F2P)
    *   [18.1 Dependencies](#Dependencies_7)
    *   [18.2 Troubleshooting](#Troubleshooting_6)
        *   [18.2.1 Game does not start](#Game_does_not_start_2)
        *   [18.2.2 Game crashes](#Game_crashes)
*   [19 Dynamite Jack](#Dynamite_Jack)
    *   [19.1 Dependencies](#Dependencies_8)
    *   [19.2 Troubleshooting](#Troubleshooting_7)
        *   [19.2.1 Sound Issues](#Sound_Issues)
        *   [19.2.2 Game does not start](#Game_does_not_start_3)
*   [20 Football Manager 2014](#Football_Manager_2014)
*   [21 FORCED](#FORCED)
    *   [21.1 Dependencies](#Dependencies_9)
*   [22 FTL: Faster than Light](#FTL:_Faster_than_Light)
    *   [22.1 Dependencies](#Dependencies_10)
    *   [22.2 Compatibility](#Compatibility_3)
    *   [22.3 Problems with open-source video driver](#Problems_with_open-source_video_driver)
*   [23 Game Dev Tycoon](#Game_Dev_Tycoon)
    *   [23.1 Troubleshooting](#Troubleshooting_8)
        *   [23.1.1 Game does not start](#Game_does_not_start_4)
*   [24 Garry's Mod](#Garry.27s_Mod)
    *   [24.1 Troubleshooting](#Troubleshooting_9)
        *   [24.1.1 Game does not start](#Game_does_not_start_5)
        *   [24.1.2 Opening some menus causes the game to crash](#Opening_some_menus_causes_the_game_to_crash)
    *   [24.2 Game crashes after attempting to join server](#Game_crashes_after_attempting_to_join_server)
*   [25 Hacker Evolution [Untold, Duality]](#Hacker_Evolution_.5BUntold.2C_Duality.5D)
    *   [25.1 Dependencies](#Dependencies_11)
*   [26 Half-Life 2 & episodes](#Half-Life_2_.26_episodes)
    *   [26.1 Cyrillic fonts problem](#Cyrillic_fonts_problem)
*   [27 Hammerwatch](#Hammerwatch)
    *   [27.1 Troubleshooting](#Troubleshooting_10)
        *   [27.1.1 The game not starting from Steam GUI](#The_game_not_starting_from_Steam_GUI)
        *   [27.1.2 No sound](#No_sound_3)
*   [28 Harvest: Massive Encounter](#Harvest:_Massive_Encounter)
    *   [28.1 Dependencies](#Dependencies_12)
    *   [28.2 Compatibility](#Compatibility_4)
*   [29 Hatoful Boyfriend](#Hatoful_Boyfriend)
    *   [29.1 Japanese text invisible](#Japanese_text_invisible)
*   [30 The inner world](#The_inner_world)
    *   [30.1 Bringing up the inventory or main menu](#Bringing_up_the_inventory_or_main_menu)
    *   [30.2 Dependencies](#Dependencies_13)
        *   [30.2.1 Sound support](#Sound_support)
        *   [30.2.2 Cutscenes](#Cutscenes)
*   [31 Interloper](#Interloper)
    *   [31.1 Dependencies](#Dependencies_14)
    *   [31.2 Game does not launch](#Game_does_not_launch)
*   [32 Invisible Apartment](#Invisible_Apartment)
    *   [32.1 Dependencies](#Dependencies_15)
    *   [32.2 Game does not run](#Game_does_not_run)
*   [33 Joe Danger 2: The Movie](#Joe_Danger_2:_The_Movie)
    *   [33.1 Dependencies](#Dependencies_16)
    *   [33.2 Compatibility](#Compatibility_5)
*   [34 Kerbal Space Program](#Kerbal_Space_Program)
    *   [34.1 Troubleshooting](#Troubleshooting_11)
    *   [34.2 Game never progresses past initial loading](#Game_never_progresses_past_initial_loading)
    *   [34.3 No text display](#No_text_display)
    *   [34.4 Graphics flickering when using primusrun](#Graphics_flickering_when_using_primusrun)
    *   [34.5 Game crashes when accessing settings or saves on 64 bit systems on Steam](#Game_crashes_when_accessing_settings_or_saves_on_64_bit_systems_on_Steam)
    *   [34.6 Locale settings](#Locale_settings)
    *   [34.7 No audio on 64-bit systems](#No_audio_on_64-bit_systems)
    *   [34.8 Black ingame textures](#Black_ingame_textures)
    *   [34.9 See also](#See_also)
*   [35 Killing Floor](#Killing_Floor)
    *   [35.1 Troubleshooting](#Troubleshooting_12)
        *   [35.1.1 Screen resolution](#Screen_resolution)
        *   [35.1.2 Windowed mode](#Windowed_mode)
        *   [35.1.3 Stuttering Sound](#Stuttering_Sound)
*   [36 Lethal League](#Lethal_League)
    *   [36.1 Dependencies](#Dependencies_17)
*   [37 Metro: Last Light](#Metro:_Last_Light)
    *   [37.1 Attempted fixes](#Attempted_fixes)
    *   [37.2 Hacky solution](#Hacky_solution)
    *   [37.3 Possible solutions](#Possible_solutions)
*   [38 Mark of the Ninja](#Mark_of_the_Ninja)
    *   [38.1 Troubleshooting](#Troubleshooting_13)
        *   [38.1.1 Bad sound](#Bad_sound)
*   [39 Multiwinia](#Multiwinia)
    *   [39.1 Dependencies](#Dependencies_18)
*   [40 Natural Selection 2](#Natural_Selection_2)
    *   [40.1 No Sound](#No_Sound_4)
*   [41 Penumbra: Overture](#Penumbra:_Overture)
    *   [41.1 Dependencies](#Dependencies_19)
    *   [41.2 Troubleshooting](#Troubleshooting_14)
        *   [41.2.1 Windowed mode](#Windowed_mode_2)
*   [42 Portal 2](#Portal_2)
    *   [42.1 Troubleshooting](#Troubleshooting_15)
        *   [42.1.1 Game does not start](#Game_does_not_start_6)
*   [43 Prison Architect](#Prison_Architect)
    *   [43.1 Troubleshooting](#Troubleshooting_16)
        *   [43.1.1 ALSA error when using PulseAudio](#ALSA_error_when_using_PulseAudio)
*   [44 Project Zomboid](#Project_Zomboid)
    *   [44.1 Dependencies](#Dependencies_20)
    *   [44.2 No sound](#No_sound_5)
*   [45 Redshirt](#Redshirt)
    *   [45.1 Dependencies (x86_64)](#Dependencies_.28x86_64.29_3)
*   [46 Revenge of the Titans](#Revenge_of_the_Titans)
    *   [46.1 Dependencies](#Dependencies_21)
*   [47 Rock Boshers DX: Directors Cut](#Rock_Boshers_DX:_Directors_Cut)
    *   [47.1 Dependencies](#Dependencies_22)
*   [48 Serious Sam 3: BFE](#Serious_Sam_3:_BFE)
    *   [48.1 Dependencies](#Dependencies_23)
    *   [48.2 Troubleshooting](#Troubleshooting_17)
        *   [48.2.1 No audio](#No_audio_2)
*   [49 Sir, you are being hunted](#Sir.2C_you_are_being_hunted)
    *   [49.1 Dependencies](#Dependencies_24)
*   [50 Spacechem](#Spacechem)
    *   [50.1 Dependencies](#Dependencies_25)
    *   [50.2 Troubleshooting](#Troubleshooting_18)
        *   [50.2.1 Game crash](#Game_crash)
*   [51 Space Pirates and Zombies](#Space_Pirates_and_Zombies)
    *   [51.1 Dependencies](#Dependencies_26)
    *   [51.2 Troubleshooting](#Troubleshooting_19)
        *   [51.2.1 No audio](#No_audio_3)
*   [52 Splice](#Splice)
    *   [52.1 Dependencies](#Dependencies_27)
*   [53 Steel Storm: Burning Retribution](#Steel_Storm:_Burning_Retribution)
    *   [53.1 Troubleshooting](#Troubleshooting_20)
        *   [53.1.1 Start with black screen](#Start_with_black_screen)
        *   [53.1.2 No English fonts](#No_English_fonts)
*   [54 Strike Suite Zero](#Strike_Suite_Zero)
    *   [54.1 Dependencies](#Dependencies_28)
*   [55 Superbrothers: Sword & Sworcery EP](#Superbrothers:_Sword_.26_Sworcery_EP)
    *   [55.1 Dependencies](#Dependencies_29)
*   [56 Team Fortress 2](#Team_Fortress_2)
    *   [56.1 Dependencies](#Dependencies_30)
    *   [56.2 Making HRTF work](#Making_HRTF_work)
    *   [56.3 Troubleshooting](#Troubleshooting_21)
        *   [56.3.1 Loading screen freeze](#Loading_screen_freeze)
        *   [56.3.2 No audio](#No_audio_4)
        *   [56.3.3 Slow loading textures](#Slow_loading_textures)
*   [57 Terraria](#Terraria)
*   [58 The Book of Unwritten Tales](#The_Book_of_Unwritten_Tales)
    *   [58.1 Dependencies](#Dependencies_31)
*   [59 The Book of Unwritten Tales: The Critter Chronicles](#The_Book_of_Unwritten_Tales:_The_Critter_Chronicles)
*   [60 The Clockwork Man](#The_Clockwork_Man)
    *   [60.1 Dependencies](#Dependencies_32)
*   [61 The Polynomial](#The_Polynomial)
    *   [61.1 Dependencies](#Dependencies_33)
    *   [61.2 Troubleshooting](#Troubleshooting_22)
        *   [61.2.1 Segfaults during program start on 64-bit systems](#Segfaults_during_program_start_on_64-bit_systems)
*   [62 This War of Mine](#This_War_of_Mine)
    *   [62.1 Troubleshooting](#Troubleshooting_23)
        *   [62.1.1 Game doesn't load](#Game_doesn.27t_load)
*   [63 Towns / Towns Demo](#Towns_.2F_Towns_Demo)
    *   [63.1 Crash on launch](#Crash_on_launch)
*   [64 Transistor](#Transistor)
    *   [64.1 Crash on launch / FMOD binding crash / Audio issues](#Crash_on_launch_.2F_FMOD_binding_crash_.2F_Audio_issues)
*   [65 Trine 2](#Trine_2)
    *   [65.1 Dependencies](#Dependencies_34)
    *   [65.2 Troubleshooting](#Troubleshooting_24)
*   [66 Unity3D](#Unity3D)
    *   [66.1 Locale Settings](#Locale_Settings_2)
    *   [66.2 Unity 5 and PulseAudio](#Unity_5_and_PulseAudio)
*   [67 Unity of Command](#Unity_of_Command)
    *   [67.1 Dependencies](#Dependencies_35)
    *   [67.2 Troubleshooting](#Troubleshooting_25)
        *   [67.2.1 No audio](#No_audio_5)
*   [68 Unrest](#Unrest)
    *   [68.1 Dependencies](#Dependencies_36)
*   [69 War Thunder](#War_Thunder)
    *   [69.1 Troubleshooting](#Troubleshooting_26)
*   [70 Witcher 2: Assassin of Kings](#Witcher_2:_Assassin_of_Kings)
    *   [70.1 Dependencies](#Dependencies_37)
    *   [70.2 Troubleshooting](#Troubleshooting_27)
*   [71 Wizardry 6: Bane of the Cosmic Forge](#Wizardry_6:_Bane_of_the_Cosmic_Forge)
    *   [71.1 Dependencies](#Dependencies_38)
*   [72 World of Goo](#World_of_Goo)
    *   [72.1 Changing resolution](#Changing_resolution)
*   [73 Worms Reloaded](#Worms_Reloaded)
    *   [73.1 Dependencies](#Dependencies_39)
*   [74 XCOM](#XCOM)
    *   [74.1 Dependencies](#Dependencies_40)
    *   [74.2 Hangs on startup](#Hangs_on_startup)
    *   [74.3 Graphical glitches on Intel HD](#Graphical_glitches_on_Intel_HD)
*   [75 Saints Row IV](#Saints_Row_IV)
    *   [75.1 Game fails to launch after update to new Nvidia drivers](#Game_fails_to_launch_after_update_to_new_Nvidia_drivers)

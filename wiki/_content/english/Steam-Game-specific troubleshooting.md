...
*   [5 Games](#Games)
    ...
    *   [5.8 ARK: Survival Evolved](#ARK:_Survival_Evolved)
        *   [5.8.1 Game does not start, displays text window with unreadable text](#Game_does_not_start.2C_displays_text_window_with_unreadable_text)
        *   [5.8.2 Gray water](#Gray_water)
        *   [5.8.3 Segmentation fault on startup](#Segmentation_fault_on_startup)
    *   [5.9 Audiosurf 2](#Audiosurf_2)
        *   [5.9.1 error. unable to load song <filename> ,came back with zero duration](#error._unable_to_load_song_.3Cfilename.3E_.2Ccame_back_with_zero_duration)
    *   [5.10 BADLAND: Game of the Year Edition](#BADLAND:_Game_of_the_Year_Edition)
    *   [5.11 Beat Cop](#Beat_Cop)
        *   [5.11.1 "BeatCop.x86_64" is not responding](#.22BeatCop.x86_64.22_is_not_responding)
    ...
    *   [5.22 Cities in Motion 2](#Cities_in_Motion_2)
        *   [5.22.1 Dialog boxes fail to display properly](#Dialog_boxes_fail_to_display_properly)
    *   [5.23 Cities Skylines](#Cities_Skylines)
        *   [5.23.1 Textures not rendering properly](#Textures_not_rendering_properly)
    *   [5.24 Civilization V](#Civilization_V)
        *   [5.24.1 Stuttering sound with PulseAudio](#Stuttering_sound_with_PulseAudio)
        *   [5.24.2 Game crashes seconds after loading a map](#Game_crashes_seconds_after_loading_a_map)
        *   [5.24.3 Game crashes after intro video with "Unable to load texture (LoadingBaseGame.dds)"](#Game_crashes_after_intro_video_with_.22Unable_to_load_texture_.28LoadingBaseGame.dds.29.22)
        *   [5.24.4 Game crashes on startup with an error in libpulsecommon-12.0.so"](#Game_crashes_on_startup_with_an_error_in_libpulsecommon-12.0.so.22)
    *   [5.25 Civilization: Beyond earth](#Civilization:_Beyond_earth)
        *   [5.25.1 Segfault after a few minutes](#Segfault_after_a_few_minutes)
    *   [5.26 Civilization VI](#Civilization_VI)
        *   [5.26.1 If Segfault Immediately on Start](#If_Segfault_Immediately_on_Start)
    *   [5.27 Deus Ex: Mankind divided](#Deus_Ex:_Mankind_divided)
    *   [5.28 The Clockwork Man](#The_Clockwork_Man)
    *   [5.29 Company of Heroes 2](#Company_of_Heroes_2)
        *   [5.29.1 Missing libpcre.so.3](#Missing_libpcre.so.3)
    *   [5.30 Cossacks 3](#Cossacks_3)
        *   [5.30.1 No sound](#No_sound_2)
        *   [5.30.2 Flashing screen with primus](#Flashing_screen_with_primus)
    *   [5.31 Counter-Strike: Source (CS:S)](#Counter-Strike:_Source_.28CS:S.29)
        *   [5.31.1 Invisible symbols, special characters and cyrillic letters](#Invisible_symbols.2C_special_characters_and_cyrillic_letters)
    *   [5.32 Counter-Strike: Global Offensive (CS:GO)](#Counter-Strike:_Global_Offensive_.28CS:GO.29)
        *   [5.32.1 Game starts on the wrong screen](#Game_starts_on_the_wrong_screen)
        *   [5.32.2 Cannot reach bottom of the screen on menus](#Cannot_reach_bottom_of_the_screen_on_menus)
        *   [5.32.3 Sound is played slightly delayed](#Sound_is_played_slightly_delayed)
        *   [5.32.4 Mouse not working in-game](#Mouse_not_working_in-game)
        *   [5.32.5 Brightness slider not working](#Brightness_slider_not_working)
        *   [5.32.6 Microphone not working](#Microphone_not_working)
        *   [5.32.7 Mouse is unrensponsive or moves slowly](#Mouse_is_unrensponsive_or_moves_slowly)
    *   [5.33 Creeper World 3: Arc Eternal](#Creeper_World_3:_Arc_Eternal)
        *   [5.33.1 Game does not start](#Game_does_not_start_2)
    *   [5.34 Crusader Kings II](#Crusader_Kings_II)
        *   [5.34.1 No audio](#No_audio)
        *   [5.34.2 Oddly sized starting window](#Oddly_sized_starting_window)
        *   [5.34.3 DLCs not detected](#DLCs_not_detected)
    *   [5.35 Crypt of the NecroDancer](#Crypt_of_the_NecroDancer)
        *   [5.35.1 Crashes after splash screen](#Crashes_after_splash_screen)
    *   [5.36 The Curious Expedition](#The_Curious_Expedition)
        *   [5.36.1 Game stuck on loading screen](#Game_stuck_on_loading_screen)
    *   [5.37 Death Road To Canada](#Death_Road_To_Canada)
        *   [5.37.1 No music](#No_music)
    *   [5.38 Defender's Quest: Valley of the Forgotten](#Defender.27s_Quest:_Valley_of_the_Forgotten)
    *   [5.39 Dirt](#Dirt)
    *   [5.40 Dirt Rally](#Dirt_Rally)
    *   [5.41 Divinity: Original Sin - Enhanced Edition](#Divinity:_Original_Sin_-_Enhanced_Edition)
        *   [5.41.1 Game does not start when using Bumblebee optirun or primusrun](#Game_does_not_start_when_using_Bumblebee_optirun_or_primusrun)
        *   [5.41.2 Game does not work with amdgpu](#Game_does_not_work_with_amdgpu)
    *   [5.42 Don't Starve](#Don.27t_Starve)
        *   [5.42.1 No sound](#No_sound_3)
    *   [5.43 Doki Doki Literature Club](#Doki_Doki_Literature_Club)
    *   [5.44 Dota 2](#Dota_2)
        *   [5.44.1 In-game font is unreadable](#In-game_font_is_unreadable)
        *   [5.44.2 Error with libpangoft2](#Error_with_libpangoft2)
        *   [5.44.3 The game does not start](#The_game_does_not_start)
        *   [5.44.4 Game runs on the wrong screen](#Game_runs_on_the_wrong_screen)
        *   [5.44.5 Game does not start with libxcb-dri3 error message](#Game_does_not_start_with_libxcb-dri3_error_message)
        *   [5.44.6 Steam overlay](#Steam_overlay)
        *   [5.44.7 Chinese tips and player names not shown](#Chinese_tips_and_player_names_not_shown)
        *   [5.44.8 Chinese input method problem](#Chinese_input_method_problem)
    *   [5.45 Devil Daggers](#Devil_Daggers)
    *   [5.46 Drox Operative](#Drox_Operative)
    *   [5.47 Dungeon Souls](#Dungeon_Souls)
    *   [5.48 Dwarfs F2P](#Dwarfs_F2P)
        *   [5.48.1 Game does not start](#Game_does_not_start_3)
        *   [5.48.2 Game crashes](#Game_crashes)
    *   [5.49 Dynamite Jack](#Dynamite_Jack)
        *   [5.49.1 Sound Issues](#Sound_Issues)
        *   [5.49.2 Game does not start](#Game_does_not_start_4)
    *   [5.50 Empire Total War](#Empire_Total_War)
        *   [5.50.1 Weird unreadable fonts](#Weird_unreadable_fonts)
    *   [5.51 Euro Truck Simulator 2](#Euro_Truck_Simulator_2)
        *   [5.51.1 Shows only a black screen](#Shows_only_a_black_screen)
    *   [5.52 Firewatch](#Firewatch)
    *   [5.53 Football Manager 2014](#Football_Manager_2014)
    *   [5.54 FORCED](#FORCED)
    *   [5.55 For the King](#For_the_King)
    *   [5.56 FTL: Faster than Light](#FTL:_Faster_than_Light)
        *   [5.56.1 Compatibility](#Compatibility)
        *   [5.56.2 Problems with open-source video driver](#Problems_with_open-source_video_driver)
    *   [5.57 Game Dev Tycoon](#Game_Dev_Tycoon)
        *   [5.57.1 Game does not start](#Game_does_not_start_5)
    *   [5.58 Garry's Mod](#Garry.27s_Mod)
        *   [5.58.1 Game does not start](#Game_does_not_start_6)
        *   [5.58.2 Opening some menus causes the game to crash](#Opening_some_menus_causes_the_game_to_crash)
        *   [5.58.3 Game crashes after attempting to join server](#Game_crashes_after_attempting_to_join_server)
    *   [5.59 Gods will be watching](#Gods_will_be_watching)
    *   [5.60 GRID Autosport](#GRID_Autosport)
        *   [5.60.1 Black screen when trying to play](#Black_screen_when_trying_to_play)
    *   [5.61 Hack 'n' Slash](#Hack_.27n.27_Slash)
        *   [5.61.1 Crashes when trying to load a game](#Crashes_when_trying_to_load_a_game)
    *   [5.62 Hacker Evolution](#Hacker_Evolution)
    *   [5.63 Half-Life 2 and episodes](#Half-Life_2_and_episodes)
        *   [5.63.1 Cyrillic fonts problem](#Cyrillic_fonts_problem)
    *   [5.64 Hammerwatch](#Hammerwatch)
        *   [5.64.1 The game does not start via Steam](#The_game_does_not_start_via_Steam)
        *   [5.64.2 No sound](#No_sound_4)
    *   [5.65 Harvest: Massive Encounter](#Harvest:_Massive_Encounter)
        *   [5.65.1 Compatibility](#Compatibility_2)
    *   [5.66 Hatoful Boyfriend](#Hatoful_Boyfriend)
        *   [5.66.1 Japanese text invisible](#Japanese_text_invisible)
    *   [5.67 HuniePop](#HuniePop)
        *   [5.67.1 Game crashes upon launch](#Game_crashes_upon_launch)
    *   [5.68 Hyper Light Drifter](#Hyper_Light_Drifter)
        *   [5.68.1 The controller does not work](#The_controller_does_not_work)
        *   [5.68.2 Missing libcurl.so.4 or version CURL_OPENSSL_3 not found](#Missing_libcurl.so.4_or_version_CURL_OPENSSL_3_not_found)
    *   [5.69 The Impossible Game](#The_Impossible_Game)
    *   [5.70 The Inner World](#The_Inner_World)
        *   [5.70.1 Bringing up the inventory or main menu](#Bringing_up_the_inventory_or_main_menu)
            *   [5.70.1.1 Cutscenes](#Cutscenes)
    *   [5.71 Interloper](#Interloper)
        *   [5.71.1 Game does not start](#Game_does_not_start_7)
    *   [5.72 Invisible Apartment](#Invisible_Apartment)
        *   [5.72.1 Game does not start](#Game_does_not_start_8)
    *   [5.73 Joe Danger 2: The Movie](#Joe_Danger_2:_The_Movie)
        *   [5.73.1 Compatibility](#Compatibility_3)
    *   [5.74 Kerbal Space Program](#Kerbal_Space_Program)
    *   [5.75 Killing Floor](#Killing_Floor)
        *   [5.75.1 Cannot change screen resolution](#Cannot_change_screen_resolution)
        *   [5.75.2 Windowed mode](#Windowed_mode)
        *   [5.75.3 Stuttering sound](#Stuttering_sound)
    *   [5.76 Left for Dead 2](#Left_for_Dead_2)
        *   [5.76.1 Missing Chinese font](#Missing_Chinese_font)
    *   [5.77 Lethal League](#Lethal_League)
    *   [5.78 Life is Strange](#Life_is_Strange)
    *   [5.79 Little Racers STREET](#Little_Racers_STREET)
    *   [5.80 The Long Dark](#The_Long_Dark)
        *   [5.80.1 Game does not start](#Game_does_not_start_9)
        *   [5.80.2 Game starts, but some overlay text is missing and cutscenes shows black screen](#Game_starts.2C_but_some_overlay_text_is_missing_and_cutscenes_shows_black_screen)
        *   [5.80.3 Cutscenes are still black](#Cutscenes_are_still_black)
        *   [5.80.4 Cursor disappears](#Cursor_disappears)
    *   [5.81 Magicka 2](#Magicka_2)
        *   [5.81.1 Indefinitely stuck at start](#Indefinitely_stuck_at_start)
    *   [5.82 Mark of the Ninja](#Mark_of_the_Ninja)
        *   [5.82.1 Bad sound](#Bad_sound)
    *   [5.83 Metro: Last Light](#Metro:_Last_Light)
    *   [5.84 Metro: 2033 Redux](#Metro:_2033_Redux)
        *   [5.84.1 No sound](#No_sound_5)
    *   [5.85 No image](#No_image)
    *   [5.86 Middle-earth: Shadow of Mordor](#Middle-earth:_Shadow_of_Mordor)
        *   [5.86.1 Floating heads](#Floating_heads)
    *   [5.87 Mount & Blade: Warband](#Mount_.26_Blade:_Warband)
        *   [5.87.1 Segmentation fault (core dumped) with wayland](#Segmentation_fault_.28core_dumped.29_with_wayland)
        *   [5.87.2 DLC Chooser](#DLC_Chooser)
        *   [5.87.3 Crash on startup](#Crash_on_startup)
    *   [5.88 Move or Die](#Move_or_Die)
        *   [5.88.1 No Sound](#No_Sound_6)
    *   [5.89 Multiwinia](#Multiwinia)
        *   [5.89.1 Crash on startup](#Crash_on_startup_2)
    *   [5.90 Natural Selection 2](#Natural_Selection_2)
    *   [5.91 Nuclear Throne](#Nuclear_Throne)
        *   [5.91.1 Missing libcurl.so.4 or version CURL_OPENSSL_3 not found](#Missing_libcurl.so.4_or_version_CURL_OPENSSL_3_not_found_2)
    *   [5.92 Oxygen Not Included](#Oxygen_Not_Included)
        *   [5.92.1 World generation hangs](#World_generation_hangs)
    *   [5.93 Penumbra: Overture](#Penumbra:_Overture)
        *   [5.93.1 Windowed mode](#Windowed_mode_2)
    *   [5.94 The Polynomial](#The_Polynomial)
        *   [5.94.1 Segfaults during program start on 64-bit systems](#Segfaults_during_program_start_on_64-bit_systems)
    *   [5.95 Portal 2](#Portal_2)
        *   [5.95.1 Game does not start](#Game_does_not_start_10)
        *   [5.95.2 Resolution too low](#Resolution_too_low)
        *   [5.95.3 Missing non Latin font](#Missing_non_Latin_font)
    *   [5.96 Prison Architect](#Prison_Architect)
        *   [5.96.1 ALSA error when using PulseAudio](#ALSA_error_when_using_PulseAudio)
    *   [5.97 Project Zomboid](#Project_Zomboid)
        *   [5.97.1 No sound](#No_sound_7)
    *   [5.98 Pyre](#Pyre)
        *   [5.98.1 Game does not start](#Game_does_not_start_11)
    *   [5.99 Redshirt](#Redshirt)
    *   [5.100 Revenge of the Titans](#Revenge_of_the_Titans)
    *   [5.101 Risk of Rain](#Risk_of_Rain)
    *   [5.102 Rock Boshers DX: Directors Cut](#Rock_Boshers_DX:_Directors_Cut)
    *   [5.103 Saints Row IV](#Saints_Row_IV)
        *   [5.103.1 Game fails to launch after update to new Nvidia drivers](#Game_fails_to_launch_after_update_to_new_Nvidia_drivers)
        *   [5.103.2 Game causes GPU lockup with mesa drivers](#Game_causes_GPU_lockup_with_mesa_drivers)
    *   [5.104 Serious Sam 3: BFE](#Serious_Sam_3:_BFE)
        *   [5.104.1 No audio](#No_audio_2)
    *   [5.105 Slay the Spire](#Slay_the_Spire)
    *   [5.106 Songbringer](#Songbringer)
        *   [5.106.1 Launch error with Wayland](#Launch_error_with_Wayland)
    *   [5.107 Space Pirates and Zombies](#Space_Pirates_and_Zombies)
        *   [5.107.1 No audio](#No_audio_3)
    *   [5.108 Spacechem](#Spacechem)
        *   [5.108.1 Game crash](#Game_crash)
    *   [5.109 Splice](#Splice)
    *   [5.110 The Stanley Parable](#The_Stanley_Parable)
        *   [5.110.1 Game won't start](#Game_won.27t_start)
    *   [5.111 Shadow Tactics: Blades of the Shogun](#Shadow_Tactics:_Blades_of_the_Shogun)
    *   [5.112 Steel Storm: Burning Retribution](#Steel_Storm:_Burning_Retribution)
        *   [5.112.1 Start with black screen](#Start_with_black_screen)
    *   [5.113 Stellaris](#Stellaris)
        *   [5.113.1 No window opening, only sound](#No_window_opening.2C_only_sound)
        *   [5.113.2 Immediate crash to desktop](#Immediate_crash_to_desktop)
    *   [5.114 Stephen's Sausage Roll](#Stephen.27s_Sausage_Roll)
        *   [5.114.1 No sound](#No_sound_8)
    *   [5.115 Superbrothers: Sword & Sworcery EP](#Superbrothers:_Sword_.26_Sworcery_EP)
    *   [5.116 System Shock 2](#System_Shock_2)
        *   [5.116.1 Game won't launch](#Game_won.27t_launch)
        *   [5.116.2 Resolution fix](#Resolution_fix)
    *   [5.117 Tabletop Simulator](#Tabletop_Simulator)
        *   [5.117.1 CJK characters not showing in game](#CJK_characters_not_showing_in_game)
    *   [5.118 Team Fortress 2](#Team_Fortress_2)
        *   [5.118.1 HRTF setup](#HRTF_setup)
        *   [5.118.2 Loading screen freeze](#Loading_screen_freeze)
        *   [5.118.3 No audio](#No_audio_4)
        *   [5.118.4 Slow loading textures](#Slow_loading_textures)
    *   [5.119 Terraria](#Terraria)
        *   [5.119.1 Input Issues](#Input_Issues)
    *   [5.120 This War of Mine](#This_War_of_Mine)
        *   [5.120.1 Game does not start](#Game_does_not_start_12)
        *   [5.120.2 Sound glitches with Steam native](#Sound_glitches_with_Steam_native)
    *   [5.121 Ticket to Ride](#Ticket_to_Ride)
    *   [5.122 The Tiny Bang Story](#The_Tiny_Bang_Story)
        *   [5.122.1 Missing libGLEW.so.1.6](#Missing_libGLEW.so.1.6)
    *   [5.123 Tomb Raider](#Tomb_Raider)
        *   [5.123.1 Game immediately closes when running with steam-native](#Game_immediately_closes_when_running_with_steam-native)
        *   [5.123.2 Steam Controller not working in-game](#Steam_Controller_not_working_in-game)
    *   [5.124 Torchlight 2](#Torchlight_2)
        *   [5.124.1 Libfreetype/libfontconfig Incompatibility](#Libfreetype.2Flibfontconfig_Incompatibility)
        *   [5.124.2 Locale incompatibility](#Locale_incompatibility)
    *   [5.125 Tower Unite](#Tower_Unite)
        *   [5.125.1 Graphical Glitches](#Graphical_Glitches)
    *   [5.126 Towns / Towns Demo](#Towns_.2F_Towns_Demo)
    *   [5.127 Transistor](#Transistor)
        *   [5.127.1 Crash on launch / FMOD binding crash / audio issues](#Crash_on_launch_.2F_FMOD_binding_crash_.2F_audio_issues)
    *   [5.128 Transmissions: Element 120](#Transmissions:_Element_120)
        *   [5.128.1 Troubleshooting](#Troubleshooting)
    *   [5.129 Trine 2](#Trine_2)
        *   [5.129.1 Colors](#Colors)
        *   [5.129.2 Sound](#Sound)
        *   [5.129.3 Resolution](#Resolution)
    *   [5.130 Tropico 5](#Tropico_5)
        *   [5.130.1 Blank screen with sound only on startup](#Blank_screen_with_sound_only_on_startup)
    *   [5.131 Unity of Command](#Unity_of_Command)
        *   [5.131.1 Squares](#Squares)
        *   [5.131.2 No audio](#No_audio_5)
    *   [5.132 Unity3D](#Unity3D)
        *   [5.132.1 Locale settings](#Locale_settings)
        *   [5.132.2 Unity 5 sound problems](#Unity_5_sound_problems)
        *   [5.132.3 Game launching on wrong monitor in fullscreen mode](#Game_launching_on_wrong_monitor_in_fullscreen_mode_2)
        *   [5.132.4 Chinese/Japanese/Korean display bug](#Chinese.2FJapanese.2FKorean_display_bug)
        *   [5.132.5 Game does not respond](#Game_does_not_respond)
    *   [5.133 Unrest](#Unrest)
    *   [5.134 Volgarr the Viking](#Volgarr_the_Viking)
    *   [5.135 War Thunder](#War_Thunder)
        *   [5.135.1 No audio](#No_audio_6)
        *   [5.135.2 Blank screen](#Blank_screen)
    *   [5.136 Warhammer 40,000: Dawn of War II](#Warhammer_40.2C000:_Dawn_of_War_II)
    *   [5.137 We Were Here](#We_Were_Here)
        *   [5.137.1 Stuck on black screen or logo on launch](#Stuck_on_black_screen_or_logo_on_launch)
    *   [5.138 Worms W.M.D](#Worms_W.M.D)
    *   [5.139 Witcher 2: Assassin of Kings](#Witcher_2:_Assassin_of_Kings)
        *   [5.139.1 Game does not start](#Game_does_not_start_13)
    *   [5.140 Wizardry 6: Bane of the Cosmic Forge](#Wizardry_6:_Bane_of_the_Cosmic_Forge)
    *   [5.141 World of Goo](#World_of_Goo)
        *   [5.141.1 Changing resolution](#Changing_resolution)
    *   [5.142 X3: Terran Conflict](#X3:_Terran_Conflict)
        *   [5.142.1 Game crashes on startup](#Game_crashes_on_startup)
    *   [5.143 XCOM](#XCOM)
        *   [5.143.1 Hangs on startup](#Hangs_on_startup)
        *   [5.143.2 Graphical glitches on Intel HD](#Graphical_glitches_on_Intel_HD)
...
If you have a CPU with more than 8 threads (such as AMD Ryzen), set `MaxSimultaneousThreads` to `16` in `config.ini` in game directory.[[5]](https://www.reddit.com/r/civ5/comments/5z77jr/game_crashes_randomly_on_linux_amd_ryzen/)
...
If your mouse works in the main menu but not in-game, run the game with `SDL_VIDEO_X11_DGAMOUSE=0`. [[6]](https://bbs.archlinux.org/viewtopic.php?id=184905)
...
Steam distributes a copy of libxcb which is incompatible with the latest xorg libxcb. See [[7]](https://github.com/ValveSoftware/steam-for-linux/issues/3199), [[8]](https://github.com/ValveSoftware/steam-for-linux/issues/3093).
...
See [[9]](https://steamcommunity.com/app/1530/discussions/0/864969481950542663/#c558746995160431396).
...
Set launch options in steam to `LANG=C %command%`.[[10]](http://steamcommunity.com/app/457140/discussions/3/1488866180617243731/#c1488866813753688864)
...
If this is indeed your problem, download the libnss-sss package from Ubuntu's repository [[11]](https://packages.ubuntu.com/bionic/i386/libnss-sss/download), extract the libnss_sss.so.2 from the downloaded package, and place it at ~/.local/share/Steam/steamapps/common/Stellaris. The game should now load properly.
...
The game bundles an outdated version of libstdc++ which prevents the game from starting. [[12]](http://steamcommunity.com/app/204060/discussions/0/364039785161291413) The following can be observed when you run Steam and S&S from the terminal:
...
Otherwise, run the game via shell and set up proper audio device for FMOD, as discussed in [[13]](https://steamcommunity.com/app/237930/discussions/2/620695877176333955/).

Also, check out this thread [[14]](https://steamcommunity.com/app/237930/discussions/2/492378265893557247/).
...
If having a green or blank screen on startup, run the game with `MESA_GL_VERSION_OVERRIDE=4.1COMPAT`. [[15]](https://forum.warthunder.com/index.php?/topic/267809-linux-potential-workaround-for-mesa-drivers-black-screen/) [[16]](http://forum.warthunder.com/index.php?search_term=0030709&app=core&module=search&do=search&fromMainBar=1&search_app=forums%3Aforum%3A920&sort_field=&sort_order=&search_in=posts)
...
Add `-screen-fullscreen 0` to launch options. [[17]](https://steamcommunity.com/app/582500/discussions/1/1470840994974091613/)
...
Now the game should run using the default "Play Worms W.M.D" option. See also Steam community discussions [[18]](https://steamcommunity.com/app/327030/discussions/2/133257959065155871/) and [[19]](https://steamcommunity.com/app/327030/discussions/1/343785380902286766/).

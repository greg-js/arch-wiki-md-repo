...
*   [5 Games](#Games)
    ...
    *   [5.47 Dwarfs F2P](#Dwarfs_F2P)
        *   [5.47.1 Game does not start](#Game_does_not_start_3)
        *   [5.47.2 Game crashes](#Game_crashes)
    *   [5.48 Dynamite Jack](#Dynamite_Jack)
        *   [5.48.1 Sound Issues](#Sound_Issues)
        *   [5.48.2 Game does not start](#Game_does_not_start_4)
    *   [5.49 Empire Total War](#Empire_Total_War)
        *   [5.49.1 Weird unreadable fonts](#Weird_unreadable_fonts)
    *   [5.50 Euro Truck Simulator 2](#Euro_Truck_Simulator_2)
        *   [5.50.1 Shows only a black screen](#Shows_only_a_black_screen)
    *   [5.51 Firewatch](#Firewatch)
    *   [5.52 Football Manager 2014](#Football_Manager_2014)
    *   [5.53 FORCED](#FORCED)
    *   [5.54 For the King](#For_the_King)
    *   [5.55 FTL: Faster than Light](#FTL:_Faster_than_Light)
        *   [5.55.1 Compatibility](#Compatibility)
        *   [5.55.2 Problems with open-source video driver](#Problems_with_open-source_video_driver)
    *   [5.56 Game Dev Tycoon](#Game_Dev_Tycoon)
        *   [5.56.1 Game does not start](#Game_does_not_start_5)
    *   [5.57 Garry's Mod](#Garry.27s_Mod)
        *   [5.57.1 Game does not start](#Game_does_not_start_6)
        *   [5.57.2 Opening some menus causes the game to crash](#Opening_some_menus_causes_the_game_to_crash)
        *   [5.57.3 Game crashes after attempting to join server](#Game_crashes_after_attempting_to_join_server)
    *   [5.58 Gods will be watching](#Gods_will_be_watching)
    *   [5.59 GRID Autosport](#GRID_Autosport)
        *   [5.59.1 Black screen when trying to play](#Black_screen_when_trying_to_play)
    *   [5.60 Hack 'n' Slash](#Hack_.27n.27_Slash)
        *   [5.60.1 Crashes when trying to load a game](#Crashes_when_trying_to_load_a_game)
    *   [5.61 Hacker Evolution](#Hacker_Evolution)
    *   [5.62 Half-Life 2 and episodes](#Half-Life_2_and_episodes)
        *   [5.62.1 Cyrillic fonts problem](#Cyrillic_fonts_problem)
    *   [5.63 Hammerwatch](#Hammerwatch)
        *   [5.63.1 The game does not start via Steam](#The_game_does_not_start_via_Steam)
        *   [5.63.2 No sound](#No_sound_4)
    *   [5.64 Harvest: Massive Encounter](#Harvest:_Massive_Encounter)
        *   [5.64.1 Compatibility](#Compatibility_2)
    *   [5.65 Hatoful Boyfriend](#Hatoful_Boyfriend)
        *   [5.65.1 Japanese text invisible](#Japanese_text_invisible)
    *   [5.66 HuniePop](#HuniePop)
        *   [5.66.1 Game crashes upon launch](#Game_crashes_upon_launch)
    *   [5.67 Hyper Light Drifter](#Hyper_Light_Drifter)
        *   [5.67.1 The controller does not work](#The_controller_does_not_work)
        *   [5.67.2 Missing libcurl.so.4 or version CURL_OPENSSL_3 not found](#Missing_libcurl.so.4_or_version_CURL_OPENSSL_3_not_found)
    *   [5.68 The Impossible Game](#The_Impossible_Game)
    *   [5.69 The Inner World](#The_Inner_World)
        *   [5.69.1 Bringing up the inventory or main menu](#Bringing_up_the_inventory_or_main_menu)
            *   [5.69.1.1 Cutscenes](#Cutscenes)
    *   [5.70 Interloper](#Interloper)
        *   [5.70.1 Game does not start](#Game_does_not_start_7)
    *   [5.71 Invisible Apartment](#Invisible_Apartment)
        *   [5.71.1 Game does not start](#Game_does_not_start_8)
    *   [5.72 Joe Danger 2: The Movie](#Joe_Danger_2:_The_Movie)
        *   [5.72.1 Compatibility](#Compatibility_3)
    *   [5.73 Kerbal Space Program](#Kerbal_Space_Program)
    *   [5.74 Killing Floor](#Killing_Floor)
        *   [5.74.1 Cannot change screen resolution](#Cannot_change_screen_resolution)
        *   [5.74.2 Windowed mode](#Windowed_mode)
        *   [5.74.3 Stuttering sound](#Stuttering_sound)
    *   [5.75 Left for Dead 2](#Left_for_Dead_2)
        *   [5.75.1 Missing Chinese font](#Missing_Chinese_font)
    *   [5.76 Lethal League](#Lethal_League)
    *   [5.77 Life is Strange](#Life_is_Strange)
    *   [5.78 Little Racers STREET](#Little_Racers_STREET)
    *   [5.79 The Long Dark](#The_Long_Dark)
        *   [5.79.1 Game does not start](#Game_does_not_start_9)
        *   [5.79.2 Game starts, but some overlay text is missing and cutscenes shows black screen](#Game_starts.2C_but_some_overlay_text_is_missing_and_cutscenes_shows_black_screen)
        *   [5.79.3 Cutscenes are still black](#Cutscenes_are_still_black)
        *   [5.79.4 Cursor disappears](#Cursor_disappears)
    *   [5.80 Magicka 2](#Magicka_2)
        *   [5.80.1 Indefinitely stuck at start](#Indefinitely_stuck_at_start)
    *   [5.81 Mark of the Ninja](#Mark_of_the_Ninja)
        *   [5.81.1 Bad sound](#Bad_sound)
    *   [5.82 Metro: Last Light](#Metro:_Last_Light)
    *   [5.83 Metro: 2033 Redux](#Metro:_2033_Redux)
        *   [5.83.1 No sound](#No_sound_5)
    *   [5.84 No image](#No_image)
    *   [5.85 Middle-earth: Shadow of Mordor](#Middle-earth:_Shadow_of_Mordor)
        *   [5.85.1 Floating heads](#Floating_heads)
    *   [5.86 Mount & Blade: Warband](#Mount_.26_Blade:_Warband)
        *   [5.86.1 Segmentation fault (core dumped) with wayland](#Segmentation_fault_.28core_dumped.29_with_wayland)
        *   [5.86.2 DLC Chooser](#DLC_Chooser)
        *   [5.86.3 Crash on startup](#Crash_on_startup)
    *   [5.87 Move or Die](#Move_or_Die)
        *   [5.87.1 No Sound](#No_Sound_6)
    *   [5.88 Multiwinia](#Multiwinia)
        *   [5.88.1 Crash on startup](#Crash_on_startup_2)
    *   [5.89 Natural Selection 2](#Natural_Selection_2)
    *   [5.90 Nuclear Throne](#Nuclear_Throne)
        *   [5.90.1 Missing libcurl.so.4 or version CURL_OPENSSL_3 not found](#Missing_libcurl.so.4_or_version_CURL_OPENSSL_3_not_found_2)
    *   [5.91 Oxygen Not Included](#Oxygen_Not_Included)
        *   [5.91.1 World generation hangs](#World_generation_hangs)
    *   [5.92 Penumbra: Overture](#Penumbra:_Overture)
        *   [5.92.1 Windowed mode](#Windowed_mode_2)
    *   [5.93 The Polynomial](#The_Polynomial)
        *   [5.93.1 Segfaults during program start on 64-bit systems](#Segfaults_during_program_start_on_64-bit_systems)
    *   [5.94 Portal 2](#Portal_2)
        *   [5.94.1 Game does not start](#Game_does_not_start_10)
        *   [5.94.2 Resolution too low](#Resolution_too_low)
        *   [5.94.3 Missing non Latin font](#Missing_non_Latin_font)
    *   [5.95 Prison Architect](#Prison_Architect)
        *   [5.95.1 ALSA error when using PulseAudio](#ALSA_error_when_using_PulseAudio)
    *   [5.96 Project Zomboid](#Project_Zomboid)
        *   [5.96.1 No sound](#No_sound_7)
    *   [5.97 Pyre](#Pyre)
        *   [5.97.1 Game does not start](#Game_does_not_start_11)
    *   [5.98 Redshirt](#Redshirt)
    *   [5.99 Revenge of the Titans](#Revenge_of_the_Titans)
    *   [5.100 Risk of Rain](#Risk_of_Rain)
    *   [5.101 Rock Boshers DX: Directors Cut](#Rock_Boshers_DX:_Directors_Cut)
    *   [5.102 Saints Row IV](#Saints_Row_IV)
        *   [5.102.1 Game fails to launch after update to new Nvidia drivers](#Game_fails_to_launch_after_update_to_new_Nvidia_drivers)
        *   [5.102.2 Game causes GPU lockup with mesa drivers](#Game_causes_GPU_lockup_with_mesa_drivers)
    *   [5.103 Serious Sam 3: BFE](#Serious_Sam_3:_BFE)
        *   [5.103.1 No audio](#No_audio_2)
    *   [5.104 Slay the Spire](#Slay_the_Spire)
    *   [5.105 Songbringer](#Songbringer)
        *   [5.105.1 Launch error with Wayland](#Launch_error_with_Wayland)
    *   [5.106 Space Pirates and Zombies](#Space_Pirates_and_Zombies)
        *   [5.106.1 No audio](#No_audio_3)
    *   [5.107 Spacechem](#Spacechem)
        *   [5.107.1 Game crash](#Game_crash)
    *   [5.108 Splice](#Splice)
    *   [5.109 The Stanley Parable](#The_Stanley_Parable)
        *   [5.109.1 Game won't start](#Game_won.27t_start)
    *   [5.110 Shadow Tactics: Blades of the Shogun](#Shadow_Tactics:_Blades_of_the_Shogun)
    *   [5.111 Steel Storm: Burning Retribution](#Steel_Storm:_Burning_Retribution)
        *   [5.111.1 Start with black screen](#Start_with_black_screen)
    *   [5.112 Stellaris](#Stellaris)
        *   [5.112.1 No window opening, only sound](#No_window_opening.2C_only_sound)
        *   [5.112.2 Immediate crash to desktop](#Immediate_crash_to_desktop)
    *   [5.113 Stephen's Sausage Roll](#Stephen.27s_Sausage_Roll)
        *   [5.113.1 No sound](#No_sound_8)
    *   [5.114 Superbrothers: Sword & Sworcery EP](#Superbrothers:_Sword_.26_Sworcery_EP)
    *   [5.115 System Shock 2](#System_Shock_2)
        *   [5.115.1 Game won't launch](#Game_won.27t_launch)
        *   [5.115.2 Resolution fix](#Resolution_fix)
    *   [5.116 Tabletop Simulator](#Tabletop_Simulator)
        *   [5.116.1 CJK characters not showing in game](#CJK_characters_not_showing_in_game)
    *   [5.117 Team Fortress 2](#Team_Fortress_2)
        *   [5.117.1 HRTF setup](#HRTF_setup)
        *   [5.117.2 Loading screen freeze](#Loading_screen_freeze)
        *   [5.117.3 No audio](#No_audio_4)
        *   [5.117.4 Slow loading textures](#Slow_loading_textures)
    *   [5.118 Terraria](#Terraria)
        *   [5.118.1 Input Issues](#Input_Issues)
    *   [5.119 This War of Mine](#This_War_of_Mine)
        *   [5.119.1 Game does not start](#Game_does_not_start_12)
        *   [5.119.2 Sound glitches with Steam native](#Sound_glitches_with_Steam_native)
    *   [5.120 Ticket to Ride](#Ticket_to_Ride)
    *   [5.121 The Tiny Bang Story](#The_Tiny_Bang_Story)
        *   [5.121.1 Missing libGLEW.so.1.6](#Missing_libGLEW.so.1.6)
    *   [5.122 Tomb Raider](#Tomb_Raider)
        *   [5.122.1 Game immediately closes when running with steam-native](#Game_immediately_closes_when_running_with_steam-native)
        *   [5.122.2 Steam Controller not working in-game](#Steam_Controller_not_working_in-game)
    *   [5.123 Torchlight 2](#Torchlight_2)
        *   [5.123.1 Libfreetype/libfontconfig Incompatibility](#Libfreetype.2Flibfontconfig_Incompatibility)
        *   [5.123.2 Locale incompatibility](#Locale_incompatibility)
    *   [5.124 Tower Unite](#Tower_Unite)
        *   [5.124.1 Graphical Glitches](#Graphical_Glitches)
    *   [5.125 Towns / Towns Demo](#Towns_.2F_Towns_Demo)
    *   [5.126 Transistor](#Transistor)
        *   [5.126.1 Crash on launch / FMOD binding crash / audio issues](#Crash_on_launch_.2F_FMOD_binding_crash_.2F_audio_issues)
    *   [5.127 Transmissions: Element 120](#Transmissions:_Element_120)
        *   [5.127.1 Troubleshooting](#Troubleshooting)
    *   [5.128 Trine 2](#Trine_2)
        *   [5.128.1 Colors](#Colors)
        *   [5.128.2 Sound](#Sound)
        *   [5.128.3 Resolution](#Resolution)
    *   [5.129 Tropico 5](#Tropico_5)
        *   [5.129.1 Blank screen with sound only on startup](#Blank_screen_with_sound_only_on_startup)
    *   [5.130 Unity of Command](#Unity_of_Command)
        *   [5.130.1 Squares](#Squares)
        *   [5.130.2 No audio](#No_audio_5)
    *   [5.131 Unity3D](#Unity3D)
        *   [5.131.1 Locale settings](#Locale_settings)
        *   [5.131.2 Unity 5 sound problems](#Unity_5_sound_problems)
        *   [5.131.3 Game launching on wrong monitor in fullscreen mode](#Game_launching_on_wrong_monitor_in_fullscreen_mode_2)
        *   [5.131.4 Chinese/Japanese/Korean display bug](#Chinese.2FJapanese.2FKorean_display_bug)
        *   [5.131.5 Game does not respond](#Game_does_not_respond)
    *   [5.132 Unrest](#Unrest)
    *   [5.133 Volgarr the Viking](#Volgarr_the_Viking)
    *   [5.134 War Thunder](#War_Thunder)
        *   [5.134.1 No audio](#No_audio_6)
        *   [5.134.2 Blank screen](#Blank_screen)
    *   [5.135 Warhammer 40,000: Dawn of War II](#Warhammer_40.2C000:_Dawn_of_War_II)
    *   [5.136 We Were Here](#We_Were_Here)
        *   [5.136.1 Stuck on black screen or logo on launch](#Stuck_on_black_screen_or_logo_on_launch)
    *   [5.137 Worms W.M.D](#Worms_W.M.D)
    *   [5.138 Witcher 2: Assassin of Kings](#Witcher_2:_Assassin_of_Kings)
        *   [5.138.1 Game does not start](#Game_does_not_start_13)
    *   [5.139 Wizardry 6: Bane of the Cosmic Forge](#Wizardry_6:_Bane_of_the_Cosmic_Forge)
    *   [5.140 World of Goo](#World_of_Goo)
        *   [5.140.1 Changing resolution](#Changing_resolution)
    *   [5.141 X3: Terran Conflict](#X3:_Terran_Conflict)
        *   [5.141.1 Game crashes on startup](#Game_crashes_on_startup)
    *   [5.142 XCOM](#XCOM)
        *   [5.142.1 Hangs on startup](#Hangs_on_startup)
        *   [5.142.2 Graphical glitches on Intel HD](#Graphical_glitches_on_Intel_HD)

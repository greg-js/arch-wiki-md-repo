...
2.  Then use `updpkgsums` (from [pacman-contrib](https://www.archlinux.org/packages/?name=pacman-contrib)) to update the `md5sums` array. Or manually add an entry to the `md5sums` array; you can generate the sum of your patch using *md5sum* tool.

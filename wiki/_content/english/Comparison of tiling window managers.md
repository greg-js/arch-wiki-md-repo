...
| [dwm](/index.php/Dwm "Dwm") | C | C (recompile) | Dynamic | Optional Patch | [Optional](/index.php/Dwm#Restart_dwm_without_logging_out_or_closing_programs "Dwm") | Built-in, reads from root window name | external | v-stack, max | via [dwmfifo](https://dwm.suckless.org/patches/dwmfifo) | Xlib | n regions, 9 workspaces fixed to each region | Active |

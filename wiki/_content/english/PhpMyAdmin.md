...
**Note:** If `open_basedir` has been set, make sure to include `/usr/share/webapps` and `/etc/webapps` to `open_basedir` in `/etc/php/php.ini`. See [PHP#Configuration](/index.php/PHP#Configuration "PHP").

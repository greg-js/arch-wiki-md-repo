...
If the PostgreSQL database cluster has not been initialized yet, please follow the [PostgreSQL#Installation](/index.php/PostgreSQL#Installation "PostgreSQL") first.

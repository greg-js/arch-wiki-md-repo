...
The official launcher usually works fine, but is known to hang sometimes. Some people report better results with the unofficial Python-based *PyLOTRO* launcher.
...
As of Wine 2.0 (December 2016), only the DirectX 9 mode works. If you have accidentally set it to DirectX 10 or 11, open `~/Documents/Dungeons\ and\ Dragons\ Online/UserPreferences.ini` and set `GraphicsCore=D3D9`.

...
*   [5 Tips and tricks](#Tips_and_tricks)
    *   [5.1 Encrypted SOCKS tunnel](#Encrypted_SOCKS_tunnel)
        ...
        *   [5.1.2 Step 2: configure your browser (or other programs)](#Step_2:_configure_your_browser_.28or_other_programs.29)
...
*   [6 Troubleshooting](#Troubleshooting)
    ...
    *   [6.2 Connection refused or timeout problem](#Connection_refused_or_timeout_problem)
        ...
        *   [6.2.2 Is SSH running and listening?](#Is_SSH_running_and_listening.3F)
        *   [6.2.3 Are there firewall rules blocking the connection?](#Are_there_firewall_rules_blocking_the_connection.3F)
        *   [6.2.4 Is the traffic even getting to your computer?](#Is_the_traffic_even_getting_to_your_computer.3F)
        *   [6.2.5 Your ISP or a third party blocking default port?](#Your_ISP_or_a_third_party_blocking_default_port.3F)
    ...
    *   [6.3 "[your shell]: No such file or directory" / ssh_exchange_identification problem](#.22.5Byour_shell.5D:_No_such_file_or_directory.22_.2F_ssh_exchange_identification_problem)
    *   [6.4 "Terminal unknown" or "Error opening terminal" error message](#.22Terminal_unknown.22_or_.22Error_opening_terminal.22_error_message)
        *   [6.4.1 TERM hack](#TERM_hack)
    *   [6.5 Connection closed by x.x.x.x [preauth]](#Connection_closed_by_x.x.x.x_.5Bpreauth.5D)
    ...
    *   [6.8 tmux/screen session killed when disconnecting from SSH](#tmux.2Fscreen_session_killed_when_disconnecting_from_SSH)

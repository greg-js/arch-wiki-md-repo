...
An equivalent of the `-J` flag in the configuration file is the `ProxyJump` option, see [ssh_config(5)](https://jlk.fjfi.cvut.cz/arch/manpages/man/ssh_config.5) for details.

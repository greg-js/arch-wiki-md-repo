...
*   [2 Signed](#Signed)
    ...
    *   [2.5 archlinuxcn](#archlinuxcn)
    *   [2.6 archstrike](#archstrike)
    *   [2.7 archzfs](#archzfs)
    *   [2.8 archzfs-kernels](#archzfs-kernels)
    *   [2.9 ashleyis](#ashleyis)
    *   [2.10 Bennix Repo](#Bennix_Repo)
    *   [2.11 blackeagle-pre-community](#blackeagle-pre-community)
    *   [2.12 chaotic-aur](#chaotic-aur)
    *   [2.13 catalyst](#catalyst)
    *   [2.14 catalyst-hd234k](#catalyst-hd234k)
    *   [2.15 city](#city)
    *   [2.16 coderkun-aur](#coderkun-aur)
    *   [2.17 coderkun-aur-audio](#coderkun-aur-audio)
    *   [2.18 devkitpro](#devkitpro)
    *   [2.19 disastrousaur](#disastrousaur)
    *   [2.20 dvzrv](#dvzrv)
    *   [2.21 ear](#ear)
    *   [2.22 eatabrick](#eatabrick)
    *   [2.23 eschwartz](#eschwartz)
    *   [2.24 ffy00](#ffy00)
    *   [2.25 fusion809](#fusion809)
    *   [2.26 grawlinson](#grawlinson)
    *   [2.27 gnome-devel](#gnome-devel)
    *   [2.28 herecura](#herecura)
    *   [2.29 holo](#holo)
    *   [2.30 ivasilev](#ivasilev)
    *   [2.31 jlk](#jlk)
    *   [2.32 llvm-svn](#llvm-svn)
    *   [2.33 markzz](#markzz)
    ...
    *   [2.51 selinux](#selinux)
    *   [2.52 sergej-repo](#sergej-repo)
    *   [2.53 siosm-aur](#siosm-aur)
    *   [2.54 sublime-text](#sublime-text)
    *   [2.55 subtitlecomposer](#subtitlecomposer)
    *   [2.56 trinity](#trinity)
...
*   **Maintainer:** [DarkFeather](http://foundation.aninix.net/DarkFeather)
*   **Description:** Self-written and AUR packages to support open-source cybersecurity research
...
*   **Maintainer:** [PedroHLC](https://github.com/pedrohlc), and [Librewish](https://github.com/librewish)
*   **Description:** Auto builds AUR packages the maintainer uses, update them hourly (a few are daily). Hosted in São Carlos, SP, Brazil. Has two mirrors (Germany and USA). x86_64 only. Has over 1600 packages.

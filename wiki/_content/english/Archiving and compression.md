...
| [zstd](https://en.wikipedia.org/wiki/zstd "wikipedia:zstd") | [zstd](https://www.archlinux.org/packages/?name=zstd) | [zstd(1)](https://jlk.fjfi.cvut.cz/arch/manpages/man/zstd.1) | .zst | Uses [Zstandard](https://en.wikipedia.org/wiki/Zstandard "wikipedia:Zstandard") algorithm. | is multithreaded |

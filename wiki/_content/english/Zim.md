...
The requirements for the Spell Checker plugin are as follows: [gtkspell3](https://www.archlinux.org/packages/?name=gtkspell3) and [aspell-en](https://www.archlinux.org/packages/?name=aspell-en).

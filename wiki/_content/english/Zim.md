...
The requirements for the Spell Checker plugin are as follows: [gtkspell](https://www.archlinux.org/packages/?name=gtkspell) and [aspell-en](https://www.archlinux.org/packages/?name=aspell-en).

...
As of July 2018 (Vagrant version 2.1.2-1) Vagrant plugin `pkg-config` needs to be installed before installing `vagrant-libvirt` plugin, otherwise plugin compilation fails.

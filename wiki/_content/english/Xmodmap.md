...
To see which *keycode* corresponds to a key, see [Keyboard configuration in Xorg#Identifying keycodes](/index.php/Keyboard_configuration_in_Xorg#Identifying_keycodes "Keyboard configuration in Xorg") for details on the *xev* utility which will output relevant keycode/keysym information about a key when you press it.

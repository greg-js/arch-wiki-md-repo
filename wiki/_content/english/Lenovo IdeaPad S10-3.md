...
An alternative may be the [802.11 Linux STA driver](http://www.broadcom.com/support/802.11/linux_sta.php), which can be installed from the [AUR](/index.php/AUR "AUR"): [broadcom-wl](https://www.archlinux.org/packages/?name=broadcom-wl)

...
*udev* is now part of [systemd](/index.php/Systemd "Systemd") and thus installed by default. See [systemd-udevd.service(8)](https://jlk.fjfi.cvut.cz/arch/manpages/man/systemd-udevd.service.8) for information.

...
[Install](/index.php/Install "Install") [barry](https://aur.archlinux.org/packages/barry/). [Barry](http://www.netdirect.ca/software/packages/barry) is an application that provides backup and sync support for BlackBerry devices. As of 0.18.4, only devices older than the BlackBerry Z10 are supported. [Synchronization support](http://www.netdirect.ca/software/packages/barry/sync.php) is provided via the [OpenSync](/index.php/OpenSync "OpenSync") library. The Barry source is available on [sourceforge](https://sourceforge.net/projects/barry/).

...
CDemu can be [installed](/index.php/Pacman "Pacman") with the package [cdemu-client](https://www.archlinux.org/packages/?name=cdemu-client), which contains also a handy [systemd](/index.php/Systemd "Systemd") service called **cdemu-daemon.service**. If you are using a custom kernel, instead of the normal `vhba` kernel module package, [vhba-module](https://www.archlinux.org/packages/?name=vhba-module), you must use the [DKMS](/index.php/DKMS "DKMS") variant of the package, [vhba-module-dkms](https://www.archlinux.org/packages/?name=vhba-module-dkms).

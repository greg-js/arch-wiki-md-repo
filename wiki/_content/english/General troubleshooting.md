...
*fuser* is provided by the [psmisc](https://www.archlinux.org/packages/?name=psmisc) package, which should be already installed as a dependency of the [base](https://www.archlinux.org/packages/?name=base) [meta package](/index.php/Meta_package "Meta package"). See [fuser(1)](https://jlk.fjfi.cvut.cz/arch/manpages/man/fuser.1) for details.

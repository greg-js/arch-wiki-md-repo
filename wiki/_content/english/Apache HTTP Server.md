...
Be aware that http2_module is not compatible with mpm_prefork_module that widely use for PHP setup. You may consider using [php-fpm](#Using_php-fpm_and_mod_proxy_fcgi) instead

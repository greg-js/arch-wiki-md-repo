...
*   [1 General](#General)
    ...
    *   [1.2 Why would I not want to use Arch?](#Why_would_I_not_want_to_use_Arch?)
    *   [1.3 What architectures does Arch support?](#What_architectures_does_Arch_support?)
    *   [1.4 Does Arch follow the Linux Foundation's Filesystem Hierarchy Standard (FHS)?](#Does_Arch_follow_the_Linux_Foundation's_Filesystem_Hierarchy_Standard_(FHS)?)
    *   [1.5 I am a complete GNU/Linux beginner. Should I use Arch?](#I_am_a_complete_GNU/Linux_beginner._Should_I_use_Arch?)
    *   [1.6 Is Arch designed to be used as a server? A desktop? A workstation?](#Is_Arch_designed_to_be_used_as_a_server?_A_desktop?_A_workstation?)
    *   [1.7 I really like Arch, except the development team needs to implement feature X](#I_really_like_Arch,_except_the_development_team_needs_to_implement_feature_X)
    *   [1.8 When will the new release be made available?](#When_will_the_new_release_be_made_available?)
    *   [1.9 Is Arch Linux a stable distribution? Will I get frequent breakage?](#Is_Arch_Linux_a_stable_distribution?_Will_I_get_frequent_breakage?)
    *   [1.10 Arch needs more press (i.e. advertisement)](#Arch_needs_more_press_(i.e._advertisement))
    *   [1.11 Arch needs more developers](#Arch_needs_more_developers)
    *   [1.12 Why is my internet so slow compared to other operating systems?](#Why_is_my_internet_so_slow_compared_to_other_operating_systems?)
    *   [1.13 Why is Arch using all my RAM?](#Why_is_Arch_using_all_my_RAM?)
    *   [1.14 Where did all my free space go?](#Where_did_all_my_free_space_go?)
...
Arch Linux releases are simply a live environment for installation or rescue, which include the [base](https://www.archlinux.org/packages/?name=base) [meta package](/index.php/Meta_package "Meta package") and a few [other packages](https://projects.archlinux.org/archiso.git/tree/configs/releng/packages.x86_64). The releases are issued usually in the first half of every month.

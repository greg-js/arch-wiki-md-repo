...
Create a systemd service and replace the default one with it to make fahclient run as this user:

 `/etc/systemd/system/foldingathome.service` 
```
[Unit]
...
```
# systemctl reenable foldingathome.service

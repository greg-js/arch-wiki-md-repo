...
Additionally, when upstream digitally sign their releases, the signature files should be added to the `source` array. This allows authentication of the files at build time.

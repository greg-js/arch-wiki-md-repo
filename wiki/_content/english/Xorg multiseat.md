...
*   [8 Setting up the loginmanager](#Setting_up_the_loginmanager)
    ...
    *   [8.4 For Auto Login multiseat (without Display Manager)](#For_Auto_Login_multiseat_(without_Display_Manager))
*   [9 Sound](#Sound)
...
*   [10 Troubleshooting](#Troubleshooting)
    *   [10.1 My Windows key doesn't work anymore](#My_Windows_key_doesn't_work_anymore)
    *   [10.2 Unreliable behaviour (black picture without cursor)](#Unreliable_behaviour_(black_picture_without_cursor))
    *   [10.3 Little black boxes/dots on the desktop](#Little_black_boxes/dots_on_the_desktop)
    *   [10.4 Multimedia keys not working](#Multimedia_keys_not_working)
    *   [10.5 The Ctrl-Alt-Fx, Alt-Fx keys mess up with virtual terminals](#The_Ctrl-Alt-Fx,_Alt-Fx_keys_mess_up_with_virtual_terminals)

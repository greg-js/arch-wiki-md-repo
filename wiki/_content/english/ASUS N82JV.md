...
*   [2 Configuration](#Configuration)
    ...
    *   [2.2 Video](#Video)
        *   [2.2.1 Intel](#Intel)
        *   [2.2.2 Nvidia](#Nvidia)
            *   [2.2.2.1 Switching / Using Nvidia card](#Switching_/_Using_Nvidia_card)
            *   [2.2.2.2 Disabling the Nvidia card](#Disabling_the_Nvidia_card)
                *   [2.2.2.2.1 acpi_call (manual)](#acpi_call_(manual))
                    *   [2.2.2.2.1.1 Run on Startup](#Run_on_Startup)
                    *   [2.2.2.2.1.2 Enable/Disable Scripts](#Enable/Disable_Scripts)
    *   [2.3 Audio](#Audio)
        *   [2.3.1 HDMI](#HDMI)

...
See [Fonts#Indic](/index.php/Fonts#Indic "Fonts").
...
[Localization](/index.php/Localization "Localization") has a good list of IMEs. The following support m17n-db input methods:

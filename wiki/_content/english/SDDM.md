...
If disk space is not the issue, it may be due to [a bug.](https://github.com/sddm/sddm/issues/1179) Switch [to another TTY](/index.php/Getty#Installation "Getty") to [restart](/index.php/Restart "Restart") SDDM.

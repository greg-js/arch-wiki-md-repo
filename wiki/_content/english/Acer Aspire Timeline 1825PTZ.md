...
*   [1 Hardware](#Hardware)
    *   [1.1 /proc/cpuinfo](#.2Fproc.2Fcpuinfo)
    *   [1.2 lspci](#lspci)
*   [2 Touchpad](#Touchpad)
*   [3 Touchscreen](#Touchscreen)
    *   [3.1 rotate](#rotate)
    *   [3.2 rotate back](#rotate_back)
*   [4 Webcam](#Webcam)
*   [5 Audio](#Audio)
...
[[1]](https://bbs.archlinux.org/viewtopic.php?pid=871201#p871201) Hi, I want to share my xorg config to solve this problem (xinput is not the best approach ;P) so, on /etc/X11/xorg.conf you will find something like this:
...
(...) Remove (or comment) line 4 and 5, also you may remove the respective Section "InputDevice"s. You do not want this because you have /etc/X11/xorg.conf.d/10-synaptics.conf so lets add some options there, this is my configuration (I've an Acer AS1410 laptop):
...
As mentioned in [Acer Aspire Timeline 1810tz#Webcam](/index.php/Acer_Aspire_Timeline_1810tz#Webcam "Acer Aspire Timeline 1810tz") you can add !uvcvideo to rc.conf modules to prevent webcam from auto loading to save power.

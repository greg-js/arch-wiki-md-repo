...
| Arch Security Tracker | CVE tracking platform and aids in publishing advisories | Python (Flask) | anthraxx | [security.archlinux.org](https://security.archlinux.org), [IRC #archlinux-security](ircs://chat.freenode.net/archlinux-security), [Advisory mailing list](https://lists.archlinux.org/listinfo/arch-security) |
...
| Infrastructure | Maintains the infrastructure to Arch Linux | Ansible, Python | Bluewind, Grazzolini and more | [cgit](https://git.archlinux.org/infrastructure.git/), [IRC #archlinux-devops](ircs://chat.freenode.net/archlinux-devops) [kanboard](https://kanboard.archlinux.org/public/board/7dd7510424e4229247e8e0b90bf43e1553fce86cdf8475b60edc956ed5a8) |

...
*   [5 Tips and tricks](#Tips_and_tricks)
    *   [5.1 Advanced window navigation](#Advanced_window_navigation)
    *   [5.2 Jump to open window](#Jump_to_open_window)
    *   [5.3 Jump to urgent window](#Jump_to_urgent_window)
    *   [5.4 Save and restore the window layout](#Save_and_restore_the_window_layout)
        *   [5.4.1 Save the current window layout of a single workspace](#Save_the_current_window_layout_of_a_single_workspace)
        *   [5.4.2 Restore the window layout of the workspace](#Restore_the_window_layout_of_the_workspace)
    *   [5.5 Scratchpad containers](#Scratchpad_containers)
    *   [5.6 Screensaver and power management](#Screensaver_and_power_management)
    *   [5.7 Shutdown, reboot, lock screen](#Shutdown.2C_reboot.2C_lock_screen)
    *   [5.8 External displays manual management](#External_displays_manual_management)
    *   [5.9 Tabbed or stacked web-browsing](#Tabbed_or_stacked_web-browsing)
    *   [5.10 Workspace variables](#Workspace_variables)
    *   [5.11 Correct handling of floating dialogs](#Correct_handling_of_floating_dialogs)
    *   [5.12 Network Download/Upload speed in statusbar](#Network_Download.2FUpload_speed_in_statusbar)
*   [6 Patches](#Patches)

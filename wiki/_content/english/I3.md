...
*   [4 Tips and tricks](#Tips_and_tricks)
    ...
    *   [4.13 Multimedia Keys](#Multimedia_Keys)
*   [5 Patches](#Patches)
...
To set up media keys for media players like [vlc](https://www.archlinux.org/packages/?name=vlc), [deadbeef](https://www.archlinux.org/packages/?name=deadbeef), [spotify](https://aur.archlinux.org/packages/spotify/) and all that, you can install package [playerctl](https://aur.archlinux.org/packages/playerctl/) then add the keybindings to `~/.config/i3/config`.
...
On some keyboards, `XF86AudioPlay` and `XF86AudioPause` are the same physical key. In this case, use `playerctl play-pause` instead of `playerctl play` and `playerctl pause` to toggle.

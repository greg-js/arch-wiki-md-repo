...
*   **i3bumblebee** — Theme-able Python status bar generator.

	[https://github.com/tobi-wan-kenobi/i3bumblebee](https://github.com/tobi-wan-kenobi/i3bumblebee) || <small>not packaged? [search in AUR](https://aur.archlinux.org/packages/)</small>

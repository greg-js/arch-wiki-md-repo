...
*   [5 Tips and tricks](#Tips_and_tricks)
    ...
    *   [5.12 Alternating layouts](#Alternating_layouts)
*   [6 Patches](#Patches)
...
The [alternating-layouts-git](https://aur.archlinux.org/packages/alternating-layouts-git/) package can be used for alternating layouts resulting in a similar behavior to the spiral tiling of bspwm. After installation add the following to your `~/.config/i3/config` and reload i3.

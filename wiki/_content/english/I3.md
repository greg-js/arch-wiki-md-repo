...
*   [5 Tips and tricks](#Tips_and_tricks)
    ...
    *   [5.12 Add automatic tiling](#Add_automatic_tiling)
*   [6 Patches](#Patches)
...
### Add automatic tiling

This [python script](https://github.com/olemartinorg/i3-alternating-layout) adds automatic tiling behavior similar to the spiral tiling of bspwm. It is available in the [AUR](https://aur.archlinux.org/packages/alternating-layouts-git). After installation add the following to your `~/.config/i3/config` and reload i3.

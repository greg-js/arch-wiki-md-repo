...
*   [3 Usage](#Usage)
    ...
    *   [3.3 Application launcher](#Application_launcher)
        *   [3.3.1 KRunner as application launcher in KDE Plasma/i3](#KRunner_as_application_launcher_in_KDE_Plasma.2Fi3)
...
An [i3](https://www.archlinux.org/groups/x86_64/i3/) [package group](/index.php/Package_group "Package group") is also available. It includes the window manager, a screen locker and two programs which write a status line to i3bar through [stdout](https://en.wikipedia.org/wiki/Standard_streams#Standard_output_.28stdout.29 "wikipedia:Standard streams").
...
To start i3 with *startx*, add `exec i3` to `~/.xinitrc`. See [xinit](/index.php/Xinit "Xinit").

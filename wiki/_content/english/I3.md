...
The default `tray_output primary` directive may require setting a primary output with _xrandr_, or specifying the output explicitly. [[15]](https://github.com/i3/i3/issues/1144) See [Xrandr](/index.php/Xrandr "Xrandr") for details.

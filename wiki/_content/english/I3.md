...
*   **bumblebee-status** — Theme-able Python status bar generator.
	...
	[https://github.com/tobi-wan-kenobi/bumblebee-status](https://github.com/tobi-wan-kenobi/bumblebee-status) || <small>not packaged? [search in AUR](https://aur.archlinux.org/packages/)</small>

...
Not all plugins are defined in the default configuration and some configuration values may be invalid for your system, so they need to be updated accordingly. See [i3status(1)](https://jlk.fjfi.cvut.cz/arch/manpages/man/i3status.1) for details.

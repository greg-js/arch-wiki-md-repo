...
*   [2 Configuration](#Configuration)
    ...
    *   [2.5 PHP](#PHP)
    *   [2.6 Webserver (Apache)](#Webserver_(Apache))
    *   [2.7 Webserver (Nginx)](#Webserver_(Nginx))
*   [3 Install Roundcube](#Install_Roundcube)
*   [4 Tips and tricks](#Tips_and_tricks)
    *   [4.1 Setting Roundcube up for use with an IMAP/SMTP server that only allows TLS authentication](#Setting_Roundcube_up_for_use_with_an_IMAP/SMTP_server_that_only_allows_TLS_authentication)
    ...
    *   [4.3 Calendar Support](#Calendar_Support)
        ...
        *   [4.3.3 Sabre\VObject\Property\Text Not Found](#Sabre\VObject\Property\Text_Not_Found)

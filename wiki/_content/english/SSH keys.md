...
An SSH key pair can be generated by running the `ssh-keygen` command, defaulting to 2048-bit RSA (and SHA256) which the [ssh-keygen(1)](http://man7.org/linux/man-pages/man1/ssh-keygen.1.html) man page says is "*generally considered sufficient*" and should be compatible with virtually all clients and servers:
...
See [ssh_config(5)](http://man7.org/linux/man-pages/man5/ssh_config.5.html) for full description of these options.

...
An SSH key pair can be generated by running the `ssh-keygen` command, defaulting to 3072-bit RSA (and SHA256) which the [ssh-keygen(1)](https://jlk.fjfi.cvut.cz/arch/manpages/man/ssh-keygen.1) man page says is "*generally considered sufficient*" and should be compatible with virtually all clients and servers:
...
Minimum key size is 1024 bits, default is 3072 (see [ssh-keygen(1)](https://jlk.fjfi.cvut.cz/arch/manpages/man/ssh-keygen.1)) and maximum is 16384.
...
*   OpenSSH key management: [Part 1](https://www.ibm.com/developerworks/linux/library/l-keyc/), [Part 2](https://www.funtoo.org/OpenSSH_Key_Management,_Part_2), [Part 3](https://www.funtoo.org/OpenSSH_Key_Management,_Part_3)

...
| [Vultr](https://www.vultr.com/) | Latest | KVM | [Multiple International locations](https://www.vultr.com/locations/) | When deploying a new server just select the Arch install ISO from Vultr ISO Library. Then just manually run through the standard [Arch installation guide](https://wiki.archlinux.org/index.php/Installation_guide). |

...
**Note:** Starting with [version 6.4.0](https://www.opensmtpd.org/announces/release-6.4.0.txt) OpenSMTPD depends on LibreSSL. Since [libressl](https://aur.archlinux.org/packages/libressl/) is not supported by Arch Linux, the [opensmtpd](https://www.archlinux.org/packages/?name=opensmtpd) package is stuck in version 6.0.3p1 indefinitely. The [opensmtpd-libressl](https://aur.archlinux.org/packages/opensmtpd-libressl/) package from the AUR is available for newer versions.

...
*   [1 Introduction](#Introduction)
    ...
    *   [1.4 USB connection modes](#USB_connection_modes)
        *   [1.4.1 What does a mode do ?](#What_does_a_mode_do_.3F)
        *   [1.4.2 Which mode is used?](#Which_mode_is_used.3F)
...
*   [6 Tips and tricks](#Tips_and_tricks)
    *   [6.1 YubiKey and LUKS encrypted partition/disk](#YubiKey_and_LUKS_encrypted_partition.2Fdisk)
    ...
    *   [6.3 Two-factor authentication with SSH](#Two-factor_authentication_with_SSH)
        ...
        *   [6.3.2 Configuration](#Configuration)
            *   [6.3.2.1 Authorization Mapping Files](#Authorization_Mapping_Files)
                ...
                *   [6.3.2.1.3 Obtaining the YubiKey token ID (a.k.a. public ID)](#Obtaining_the_YubiKey_token_ID_.28a.k.a._public_ID.29)
        ...
        *   [6.3.3 That is it!](#That_is_it.21)
        *   [6.3.4 Explanation](#Explanation)
*   [7 Maintenance / Upgrades](#Maintenance_.2F_Upgrades)
    *   [7.1 Installing the OATH Applet for a YubiKey NEO](#Installing_the_OATH_Applet_for_a_YubiKey_NEO)
        ...
        *   [7.1.3 (Optional) Install the Yubico Authenticator Desktop client](#.28Optional.29_Install_the_Yubico_Authenticator_Desktop_client)
*   [8 Troubleshooting](#Troubleshooting)
    ...
    *   [8.4 Error: [key] could not be locally signed or gpg: No default secret key: No public key](#Error:_.5Bkey.5D_could_not_be_locally_signed_or_gpg:_No_default_secret_key:_No_public_key)

...
Jami is currently packaged in [Official repositories#community](/index.php/Official_repositories#community "Official repositories"), with some third-party clients in AUR. You can choose between several versions:

*   Official Gnome client: [jami-gnome](https://www.archlinux.org/packages/?name=jami-gnome)

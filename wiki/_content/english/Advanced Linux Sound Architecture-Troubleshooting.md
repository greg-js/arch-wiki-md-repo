...
*   [2 Microphone](#Microphone)
    ...
    *   [2.2 Setting the default microphone/capture device](#Setting_the_default_microphone/capture_device)
...
*   [3 Audio Quality](#Audio_Quality)
    *   [3.1 Crackling sound through mini-jack (headphones connector)](#Crackling_sound_through_mini-jack_(headphones_connector))
...
*   [4 Hardware and Cards](#Hardware_and_Cards)
    ...
    *   [4.2 Error 'Unknown hardware' appears after kernel update](#Error_'Unknown_hardware'_appears_after_kernel_update)
    *   [4.3 Fix wrong audio pin mapping](#Fix_wrong_audio_pin_mapping)
    *   [4.4 S/PDIF output does not work](#S/PDIF_output_does_not_work)
    *   [4.5 Conflicting PC speaker](#Conflicting_PC_speaker)
    *   [4.6 HP TX2500](#HP_TX2500)
    *   [4.7 No sound when S/PDIF video card is installed](#No_sound_when_S/PDIF_video_card_is_installed)
    ...
    *   [4.10 HDMI](#HDMI)
        ...
        *   [4.10.2 PCM through HDMI does not work (Intel Gfx)](#PCM_through_HDMI_does_not_work_(Intel_Gfx))
...
*   [6 Other Issues](#Other_Issues)
    ...
    *   [6.2 Removing old ALSA state file (asound.state)](#Removing_old_ALSA_state_file_(asound.state))

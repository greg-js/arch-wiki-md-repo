...
*   [7 Troubleshooting](#Troubleshooting)
    *   [7.1 Emacs fails to start with the error message 'Undefined color: "WINDOW_FOREGROUND"'](#Emacs_fails_to_start_with_the_error_message_'Undefined_color:_"WINDOW_FOREGROUND"')
    ...
    *   [7.6 Dead-accent keys problem: '<dead-acute> is undefined'](#Dead-accent_keys_problem:_'<dead-acute>_is_undefined')
    *   [7.7 C-M-% and some other bindings do not work in emacs nox](#C-M-%_and_some_other_bindings_do_not_work_in_emacs_nox)
    *   [7.8 Emacs hangs](#Emacs_hangs)
    *   [7.9 Emacs-nox output gets messy](#Emacs-nox_output_gets_messy)
    *   [7.10 Weirds escaped numbers(utf-8) displaying in emacs terminal](#Weirds_escaped_numbers(utf-8)_displaying_in_emacs_terminal)

...
```
# cd /tmp
# curl -O [https://mirrors.kernel.org/archlinux/iso/latest/archlinux-bootstrap-2018.03.01-x86_64.tar.gz](https://mirrors.kernel.org/archlinux/iso/latest/archlinux-bootstrap-2018.03.01-x86_64.tar.gz)
...
```
# tar xzf <path-to-bootstrap-image>/archlinux-bootstrap-2018.03.01-x86_64.tar.gz

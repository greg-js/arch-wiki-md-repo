...
```
# cd /tmp
# curl -O [https://mirrors.kernel.org/archlinux/iso/latest/archlinux-bootstrap-2017.07.01-x86_64.tar.gz](https://mirrors.kernel.org/archlinux/iso/latest/archlinux-bootstrap-2017.07.01-x86_64.tar.gz)
...
```
# tar xzf <path-to-bootstrap-image>/archlinux-bootstrap-2017.07.01-x86_64.tar.gz

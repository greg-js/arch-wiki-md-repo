...
[Install](/index.php/Install "Install") the package [xpra-winswitch](https://aur.archlinux.org/packages/xpra-winswitch/) from the [AUR](/index.php/AUR "AUR"), on the server and the clients.

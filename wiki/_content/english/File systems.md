...
| [HFS](https://en.wikipedia.org/wiki/Hierarchical_File_System "w:Hierarchical File System") | [mkfs.hfsplus(8)](http://jlk.fjfi.cvut.cz/arch/manpages/man/mkfs.hfsplus.8) | [hfsprogs](https://aur.archlinux.org/packages/hfsprogs/) | Optional | [hfs.txt](https://www.kernel.org/doc/Documentation/filesystems/hfs.txt) | [macOS](https://en.wikipedia.org/wiki/macOS "w:macOS") file system |

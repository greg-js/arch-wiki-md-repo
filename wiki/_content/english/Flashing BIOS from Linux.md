...
The script Geteltorito.pl will extract the [El Torito](https://en.wikipedia.org/wiki/El_Torito_(CD-ROM_standard) boot image. It has worked with Lenovo laptops like the X1 Carbon, X220, X230, X260, W540, T450, T450s and P50\. It may work for other vendors as well.

...
**Note:** For users with Dell computers, Dell recommends Linux users flash their BIOS following information located [here](https://www.dell.com/support/article/us/en/19/sln171755/updating-the-dell-bios-in-linux-and-ubuntu-environments).

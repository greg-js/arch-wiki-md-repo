...
**Note:** Extensions from [extensions.gnome.org](https://extensions.gnome.org) can be installed right away with [gnome-software](https://www.archlinux.org/packages/?name=gnome-software). For other browsers, it is required to install [chrome-gnome-shell](https://www.archlinux.org/packages/?name=chrome-gnome-shell) and the appropriate browser extension.

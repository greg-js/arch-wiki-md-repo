...
| rtl88xxau | 5.2.20 (possibility of using 5.3.4 base) | [rtl88xxau-aircrack-dkms-git](https://aur.archlinux.org/packages/rtl88xxau-aircrack-dkms-git/) | Aircrack-ng kernel module for 8811au, 8812au, 8814au and 8821au chipsets with monitor mode and injection support. Possibility to use experimental v5.3.4 of the driver by editing PKGBUILD. |

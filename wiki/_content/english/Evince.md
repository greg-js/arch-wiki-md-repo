...
For a standalone version install [evince-no-gnome](https://aur.archlinux.org/packages/evince-no-gnome/) or the light version [evince](https://aur.archlinux.org/packages/evince/) for pdf support only.

...
**Note:** Enabling VA-API support on computers with Intel GPUs may cause issues with thumbnailing of video files. See [GNOME Files#Thumbnailing_not_working_for_video_files](/index.php/GNOME_Files#Thumbnailing_not_working_for_video_files "GNOME Files") for details.

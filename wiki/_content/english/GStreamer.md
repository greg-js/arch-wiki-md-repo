...
To make GStreamer useful, install the plugins packages you require. See [official documentation](https://gstreamer.freedesktop.org/documentation/plugins_doc.html) for list of features in each plugin.

...
*   [5 Troubleshooting](#Troubleshooting)
    ...
    *   [5.7 scrot: Cannot take a mouse selected screenshot with keyboard shortcuts](#scrot:_Cannot_take_a_mouse_selected_screenshot_with_keyboard_shortcuts)
    *   [5.8 YouTube: fullscreen appears in background](#YouTube:_fullscreen_appears_in_background)
    *   [5.9 Prevent the mouse scroll wheel from changing tags](#Prevent_the_mouse_scroll_wheel_from_changing_tags)
    *   [5.10 Starting console clients on specific tags](#Starting_console_clients_on_specific_tags)
    *   [5.11 Duplicate menu-entries generated by Xdg-menu](#Duplicate_menu-entries_generated_by_Xdg-menu)
    *   [5.12 Some Shortcuts not Working in Xfce4 overlapping Keys](#Some_Shortcuts_not_Working_in_Xfce4_overlapping_Keys)
*   [6 See also](#See_also)

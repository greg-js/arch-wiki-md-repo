...
*   [Swap](/index.php/Swap "Swap") enabled if needed: `# swapon /dev/sd*xY*` 
...
*   Some [systemd](/index.php/Systemd "Systemd") tools such as *hostnamectl*, *localectl* and *timedatectl* can not be used inside a chroot, as they require an active [dbus](/index.php/Dbus "Dbus") connection. [[1]](https://github.com/systemd/systemd/issues/798#issuecomment-126568596)

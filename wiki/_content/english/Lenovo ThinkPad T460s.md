...
*   [2 Troubleshooting](#Troubleshooting)
    ...
    *   [2.8 Audio Volume Buttons](#Audio_Volume_Buttons)
    *   [2.9 Video Issues](#Video_Issues)
*   [3 Youtube](#Youtube)
...
The ALSA audio volume can be controlled via the multimedia buttons, e.g. by using the [xbindkeys](https://www.archlinux.org/packages/?name=xbindkeys) package with the following lines in your `$HOME/.xbindkeysrc` (cf. [ALSA#Keyboard volume control](/index.php/ALSA#Keyboard_volume_control "ALSA") and [Xbindkeys](/index.php/Xbindkeys "Xbindkeys")):

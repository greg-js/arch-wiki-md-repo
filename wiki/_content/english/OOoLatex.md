...
This article explains how to install OOoLatex for Arch Linux, assuming one has a working [LaTeX](/index.php/LaTeX "LaTeX") system and the [ghostscript](https://www.archlinux.org/packages/?name=ghostscript) package installed.

...
| [notmuch](/index.php/Notmuch "Notmuch") | `~/.notmuch-config` | [[70]](http://notmuchmail.org/pipermail/notmuch/2011/007007.html) | `$ export NOTMUCH_CONFIG="$XDG_CONFIG_HOME"/notmuch/notmuchrc`
...
`~/.npmrc`
 ...
 | [[71]](https://github.com/npm/npm/issues/6675) | `$ export NPM_CONFIG_USERCONFIG=$XDG_CONFIG_HOME/npm/npmrc` `npmrc` 
```
...
| [openscad](http://www.openscad.org/) | `~/.OpenSCAD` | [7c3077b0f](https://github.com/openscad/openscad/commit/7c3077b0f) | [[72]](https://github.com/openscad/openscad/issues/125) | Does not fully honour XDG Base Directory Specification, see [[73]](https://github.com/openscad/openscad/issues/373)
...
| [rlwrap](http://utopia.knoware.nl/~hlub/uck/rlwrap/) | `~/.*_history` | [[74]](https://github.com/hanslub42/rlwrap/issues/25) | `$ export RLWRAP_HOME="$XDG_DATA_HOME"/rlwrap` |
...
| [stack](https://www.stackage.org/) | `~/.stack` | [[75]](https://github.com/commercialhaskell/stack/issues/342) | `$ export STACK_ROOT="$XDG_DATA_HOME"/stack` |
| [subversion](/index.php/Subversion "Subversion") | `~/.subversion` | [[76]](https://issues.apache.org/jira/browse/SVN-4599) [[77]](https://mail-archives.apache.org/mod_mbox/subversion-users/201204.mbox/%3c4F8FBCC6.4080205@ritsuka.org%3e)[[78]](http://mail-archives.apache.org/mod_mbox/subversion-dev/201509.mbox/%3c20150917222954.GA20331@teapot%3e) | `$ svn --config-dir "$XDG_CONFIG_HOME"/subversion` |
...
`$ tiptop -W "$XDG_CONFIG_HOME"/tiptop`
 ...
 |
| [tmux](/index.php/Tmux "Tmux") | `~/.tmux.conf` | [[79]](http://comments.gmane.org/gmane.comp.terminal-emulators.tmux.user/6013) [[80]](http://sourceforge.net/p/tmux/mailman/message/30619546/) | `$ tmux -f "$XDG_CONFIG_HOME"/tmux/tmux.conf`
...
| [WeeChat](/index.php/WeeChat "WeeChat") | `~/.weechat` | [[81]](http://savannah.nongnu.org/task/?10934) | `$ export WEECHAT_HOME="$XDG_CONFIG_HOME"/weechat`

`$ weechat -d "$XDG_CONFIG_HOME"/weechat`

 |
| [wget](/index.php/Wget "Wget") | `~/.wgetrc` | `$ export WGETRC="$XDG_CONFIG_HOME/wgetrc"` |
| [wine](/index.php/Wine "Wine") | `~/.wine` | [[82]](https://bugs.winehq.org/show_bug.cgi?id=20888) | [Winetricks](/index.php/Wine#Winetricks "Wine") uses XDG-alike location below for [WINEPREFIX](/index.php/Wine#WINEPREFIX "Wine") management:
...
| [xsel](http://www.vergenet.net/~conrad/software/xsel/) | `~/.xsel.log` | [[83]](https://github.com/kfish/xsel/issues/10) | `$ xsel --logfile "$XDG_CACHE_HOME"/xsel/xsel.log` |
...
`~/.java`
 ...
 |
| [anthy](https://osdn.net/projects/anthy/) | `~/.anthy` | [[84]](https://osdn.net/ticket/browse.php?group_id=14&tid=28397) |
...
`~/.bash_logout`
 ...
 | [[85]](http://savannah.gnu.org/support/?108134) | A specified `bashrc` can be sourced from `/etc/bashrc`
...
`~/.bzr.log`
 ...
 |
| [cabal](https://www.haskell.org/cabal/) | `~/.cabal` | [[86]](https://github.com/haskell/cabal/issues/680) | See discussion for potential workarounds. It is not very easy or straightforward but may be possible to emulate Base Directory compliance. |
| [calibre](https://calibre-ebook.com/) | `~/Calibre Library` |
| [CUPS](/index.php/CUPS "CUPS") | `~/.cups` | [[87]](http://www.cups.org/str.php?L4243) |
| [darcs](/index.php/Darcs "Darcs") | `~/.darcs` | [[88]](http://bugs.darcs.net/issue2453) |
| [dbus](/index.php/Dbus "Dbus") | `~/.dbus` | [[89]](https://bugs.freedesktop.org/show_bug.cgi?id=35887) | This should be avoidable with kdbus [citation needed]. |
| [Dia](https://wiki.gnome.org/Apps/Dia) | `~/.dia` |
| [eclipse](/index.php/Eclipse "Eclipse") | `~/.eclipse` | [[90]](https://bugs.eclipse.org/bugs/show_bug.cgi?id=200809) | Option `-Dosgi.configuration.area=@user.home/.config/..` overrides but must be added to `"$ECLIPSE_HOME"/eclipse.ini"` rather than command line which means you must have write access to `$ECLIPSE_HOME`. (Arch Linux hard-codes `$ECLIPSE_HOME` in `/usr/bin/eclipse`) |
| [emacs](https://www.gnu.org/software/emacs/) | `~/.emacs`

`~/.emacs.d`

 | [[91]](http://debbugs.gnu.org/cgi/bugreport.cgi?bug=583) | It's possible to set `HOME`, but it has unexpected side effects. So far the most promising approach is modifying another Emacs environment variable to alter the load path and author your own site file which can manually load up your init file, but it changes the load process significantly. |
| [Fetchmail](http://www.fetchmail.info/) | `~/.fetchmailrc` |
| [Firefox](/index.php/Firefox "Firefox") | `~/.mozilla` | [[92]](https://bugzil.la/259356) |
| [GHC](https://www.haskell.org/ghc/) | `~/.ghc` | [[93]](https://ghc.haskell.org/trac/ghc/ticket/6077) |
...
| [idris](http://www.idris-lang.org/) | `~/.idris` | [[94]](https://github.com/idris-lang/Idris-dev/pull/3456) |
| [julia](http://julialang.org/) | `~/.juliarc.jl`

`~/.julia_history`

 | [[95]](https://github.com/JuliaLang/julia/issues/4630) [[96]](https://github.com/JuliaLang/julia/issues/10016) |
...
| [milkytracker](http://www.milkytracker.org/) | `~/.milkytracker_config` | [[97]](https://github.com/Deltafire/MilkyTracker/issues/12) |
| [Minecraft](https://minecraft.net/) | `~/.minecraft` | [[98]](https://bugs.mojang.com/browse/MCL-2563) |
| [mongodb](https://www.mongodb.org/) | `~/.mongorc.js`

`~/.dbshell`

 | [[99]](https://jira.mongodb.org/browse/DOCS-5652?jql=text%20~%20%22.mongorc.js%22) | [This Stack Overflow thread](http://stackoverflow.com/a/22349050/4200039) suggests a partial workaround using command-line switch `--norc`. |
...
| [NSS](https://developer.mozilla.org/en-US/docs/Mozilla/Projects/NSS) | `~/.pki` | [[100]](https://bugzilla.mozilla.org/show_bug.cgi?id=818686) |
| [OpenSSH](https://www.openssh.com/) | `~/.ssh` | [[101]](https://bugzilla.mindrot.org/show_bug.cgi?id=2050) | Assumed to be present by many ssh daemons and clients such as DropBear and OpenSSH. |
| [palemoon](https://www.palemoon.org/) | `~/.moonchild productions` | [[102]](https://forum.palemoon.org/viewtopic.php?f=5&t=9639) |
...
| [SeaMonkey](http://www.seamonkey-project.org/) | `~/.mozilla` | [[103]](https://bugzil.la/726939) |
| [Skype](/index.php/Skype "Skype") < 5.0 | `~/.Skype` | [[104]](https://community.skype.com/t5/Linux-archive/Skype-violates-XDG-basedir-spec-on-linux/td-p/4175884) |
...
`~/lessonfiles`
 ...
 | [[105]](https://savannah.gnu.org/bugs/index.php?50251) |
...
`~/.sqliterc`
 ...
 | [[106]](https://unix.stackexchange.com/questions/306890/change-location-of-sqlite-history-file)[[107]](http://sqlite.1065341.n5.nabble.com/Customizing-the-location-of-the-sqlite-history-td87055.html) | `$ sqlite3 -init "$XDG_CONFIG_HOME"/sqlite3/sqliterc` |
| [Steam](/index.php/Steam "Steam") | `~/.steam` |
| [TeamSpeak](/index.php/TeamSpeak "TeamSpeak") | `~/.ts3client` |
| [TeXmacs](http://www.texmacs.org/) | `~/.TeXmacs` |
| [Thunderbird](/index.php/Thunderbird "Thunderbird") | `~/.thunderbird` | [[108]](https://bugzil.la/735285) |
...
*   [https://tlvince.com/vim-respect-xdg](https://tlvince.com/vim-respect-xdg)
 ...
 |
| [vimperator](http://www.vimperator.org/) | `~/.vimperatorrc` | [[109]](http://www.mozdev.org/pipermail/vimperator/2009-October/004848.html) | `$ export VIMPERATOR_INIT=":source $XDG_CONFIG_HOME/vimperator/vimperatorrc"`
...
| [xombrero](https://opensource.conformal.com/wiki/xombrero) | `~/.xombrero` | [[110]](https://github.com/conformal/xombrero/issues/74) |

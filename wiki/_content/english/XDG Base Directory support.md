...
`$ export TERMINFO_DIRS="$XDG_DATA_HOME"/terminfo:/usr/share/terminfo`
 ...
 |
| [npm](https://www.archlinux.org/packages/?name=npm) | `~/.npm` `~/.npmrc` | [[56]](https://github.com/npm/npm/issues/6675) | `$ export NPM_CONFIG_USERCONFIG=$XDG_CONFIG_HOME/npm/npmrc` `npmrc` 
```
...
`$ export CUDA_CACHE_PATH="$XDG_CACHE_HOME"/nv`
 ...
 |
| [openscad](http://www.openscad.org/) | `~/.OpenSCAD` | [7c3077b0f](https://github.com/openscad/openscad/commit/7c3077b0f) | [[57]](https://github.com/openscad/openscad/issues/125) | Does not fully honour XDG Base Directory Specification, see [[58]](https://github.com/openscad/openscad/issues/373)
...
| [WeeChat](/index.php/WeeChat "WeeChat") | `~/.weechat` | [[66]](http://savannah.nongnu.org/task/?10934) | `$ export WEECHAT_HOME="$XDG_CONFIG_HOME"/weechat`
...
| [xsel](http://www.vergenet.net/~conrad/software/xsel/) | `~/.xsel.log` | [[68]](https://github.com/kfish/xsel/issues/10) | `$ xsel --logfile "$XDG_CACHE_HOME"/xsel/xsel.log` |
...
| [bash](/index.php/Bash "Bash") | `~/.bashrc` `~/.bash_history` `~/.bash_profile` `~/.bash_login` `~/.bash_logout` | [[69]](http://savannah.gnu.org/support/?108134) | 

*   A specified `bashrc` can be sourced from `/etc/bashrc`
*   `export HISTFILE="$XDG_DATA_HOME"/bash/history`

 |
| [cabal](https://www.haskell.org/cabal/) | `~/.cabal` | [[70]](https://github.com/haskell/cabal/issues/680) | See discussion for potential workarounds. It is not very easy or straightforward but may be possible to emulate Base Directory compliance. |

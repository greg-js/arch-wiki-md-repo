...
| [Flatpak](/index.php/Flatpak "Flatpak") | `~/.var/` | [[97]](https://github.com/flatpak/flatpak/issues/46) [[98]](https://github.com/flatpak/flatpak.github.io/issues/191) |
| [GHC](https://www.haskell.org/ghc/) | `~/.ghc` | [[99]](https://ghc.haskell.org/trac/ghc/ticket/6077) |
...
| [idris](http://www.idris-lang.org/) | `~/.idris` | [[100]](https://github.com/idris-lang/Idris-dev/pull/3456) |
| [julia](http://julialang.org/) | `~/.juliarc.jl`

`~/.julia_history`

 | [[101]](https://github.com/JuliaLang/julia/issues/4630) [[102]](https://github.com/JuliaLang/julia/issues/10016) |
| [Linux PAM](http://www.linux-pam.org/) | `~/.pam_environment` | [[103]](https://github.com/linux-pam/linux-pam/issues/7) | Hardcoded in [modules/pam_env/pam_env.c](https://github.com/linux-pam/linux-pam/blob/master/modules/pam_env/pam_env.c) |
...
| [milkytracker](http://www.milkytracker.org/) | `~/.milkytracker_config` | [[104]](https://github.com/Deltafire/MilkyTracker/issues/12) |
| [Minecraft](https://minecraft.net/) | `~/.minecraft` | [[105]](https://bugs.mojang.com/browse/MCL-2563) |
| [mongodb](https://www.mongodb.org/) | `~/.mongorc.js`

`~/.dbshell`

 | [[106]](https://jira.mongodb.org/browse/DOCS-5652?jql=text%20~%20%22.mongorc.js%22) | [This Stack Overflow thread](http://stackoverflow.com/a/22349050/4200039) suggests a partial workaround using command-line switch `--norc`. |
...
| [nano](/index.php/Nano "Nano") | `~/.nano/` `~/.nanorc` | [[107]](https://savannah.gnu.org/patch/?8523) |
| [NSS](https://developer.mozilla.org/en-US/docs/Mozilla/Projects/NSS) | `~/.pki` | [[108]](https://bugzilla.mozilla.org/show_bug.cgi?id=818686) |
| [OpenSSH](https://www.openssh.com/) | `~/.ssh` | [[109]](https://bugzilla.mindrot.org/show_bug.cgi?id=2050) | Assumed to be present by many ssh daemons and clients such as DropBear and OpenSSH. |
| [palemoon](https://www.palemoon.org/) | `~/.moonchild productions` | [[110]](https://forum.palemoon.org/viewtopic.php?f=5&t=9639) |

...
| [docker](/index.php/Docker "Docker") | `~/.docker` | [[114]](https://github.com/docker/machine/issues/3116) [[115]](https://github.com/moby/moby/issues/20693) |
...
| [Java](/index.php/Java "Java") (OpenJDK) | `~/.java/fonts`, `~/.java/webview` | [[124]](https://bugzilla.redhat.com/show_bug.cgi?id=1154277) |
...
| [milkytracker](http://www.milkytracker.org/) | `~/.milkytracker_config` | [[128]](https://github.com/Deltafire/MilkyTracker/issues/12) |
| [Minecraft](https://minecraft.net/) | `~/.minecraft/` | [[129]](https://bugs.mojang.com/browse/MCL-2563) |
...
| [OpenSSH](https://www.openssh.com/) | `~/.ssh` | [[135]](https://bugzilla.mindrot.org/show_bug.cgi?id=2050) | Assumed to be present by many ssh daemons and clients such as DropBear and OpenSSH. |
...
| [Quod Libet](https://quodlibet.readthedocs.io/en/latest/) | `~/.quodlibet` | [[137]](https://github.com/quodlibet/quodlibet/issues/138) |
...
`~/.sqliterc`
 ...
 | [[141]](https://unix.stackexchange.com/questions/306890/change-location-of-sqlite-history-file)[[142]](http://sqlite.1065341.n5.nabble.com/Customizing-the-location-of-the-sqlite-history-td87055.html) | `$ sqlite3 -init "$XDG_CONFIG_HOME"/sqlite3/sqliterc` |
...
| [xdg-utils](https://www.archlinux.org/packages/?name=xdg-utils) | `~/.gnome` | [[147]](https://bugs.freedesktop.org/show_bug.cgi?id=90775) | For some reason the script `xdg-desktop-menu` hard-codes `gnome_user_dir="$HOME/.gnome/apps"`. This is used by [chromium](/index.php/Chromium "Chromium") amoung others. |

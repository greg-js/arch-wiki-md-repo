...
| [emacs](https://www.gnu.org/software/emacs/) | `~/.emacs` `~/.emacs.d` | [[78]](http://debbugs.gnu.org/cgi/bugreport.cgi?bug=583) | It's possible to set `HOME`, but it has unexpected side effects. So far the most promising approach is modifying another Emacs environment variable to alter the load path and author your own site file which can manually load up your init file, but it changes the load process significantly. |
...
| [julia](http://julialang.org/) | `~/.juliarc.jl` `~/.julia_history` | [[80]](https://github.com/JuliaLang/julia/issues/4630) [[81]](https://github.com/JuliaLang/julia/issues/10016) |
...
To find the default configuration paths, use this: `env -u HGRCPATH hg debugconfig --debug | grep "read config"`
 ...
 |
| [milkytracker](http://www.milkytracker.org/) | `~/.milkytracker_config` | [[82]](https://github.com/Deltafire/MilkyTracker/issues/12) |
| [mongodb](https://www.mongodb.org/) | `~/.mongorc.js` `~/.dbshell` | [[83]](https://jira.mongodb.org/browse/DOCS-5652?jql=text%20~%20%22.mongorc.js%22) | [This Stack Overflow](http://stackoverflow.com/a/22349050/4200039) thread suggests a partial workaround using command-line switch `--norc`. |
...
| [NSS](https://developer.mozilla.org/en-US/docs/Mozilla/Projects/NSS) | `~/.pki` | [[84]](https://bugzilla.mozilla.org/show_bug.cgi?id=818686) |
| [OpenSSH](https://www.openssh.com/) | `~/.ssh` | [[85]](https://bugzilla.mindrot.org/show_bug.cgi?id=2050) | Assumed to be present by many ssh daemons and clients such as DropBear and OpenSSH. |
| [palemoon](https://www.palemoon.org/) | `~/.moonchild productions` | [[86]](https://forum.palemoon.org/viewtopic.php?f=5&t=9639) |

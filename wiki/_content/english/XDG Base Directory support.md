...
| [GnuPG](/index.php/GnuPG "GnuPG") | `~/.gnupg` | [[66]](https://bugs.gnupg.org/gnupg/issue1456) [[67]](https://bugs.gnupg.org/gnupg/issue1018) | `$ export GNUPGHOME="$XDG_CONFIG_HOME"/gnupg`
...
`$ mkdir -p "$(dirname "$GQSTATE")"`
 ...
 |
| [gradle](https://gradle.org/) | `~/.gradle` | [[68]](https://discuss.gradle.org/t/be-a-nice-freedesktop-citizen-move-the-gradle-to-the-appropriate-location-in-linux/2199) | `$ export GRADLE_USER_HOME="$XDG_DATA_HOME"/gradle` |
...
| [httpie](http://httpie.org) | `~/.httpie` | [[69]](https://github.com/jakubroztocil/httpie/issues/145) | `$ export HTTPIE_CONFIG_DIR="$XDG_CONFIG_HOME"/httpie` |
| [ipython](http://ipython.org)/[jupyter](/index.php/Jupyter "Jupyter") | `~/.ipython` | `$ export IPYTHONDIR="$XDG_CONFIG_HOME"/jupyter`

`$ export JUPYTER_CONFIG_DIR="$XDG_CONFIG_HOME"/jupyter`

 |
| [irssi](/index.php/Irssi "Irssi") | `~/.irssi` | [[70]](https://github.com/irssi/irssi/pull/511) | `$ irssi --config="$XDG_CONFIG_HOME"/irssi/config \`
...
`$ export LESSKEY="$XDG_CONFIG_HOME"/less/lesskey`
 ...
 |
| [libdvdcss](http://www.videolan.org/developers/libdvdcss.html) | `~/.dvdcss` | [[71]](https://mailman.videolan.org/pipermail/libdvdcss-devel/2014-August/001022.html) | `$ export DVDCSS_CACHE="$XDG_DATA_HOME"/dvdcss` |
| [libice](https://www.x.org/releases/current/doc/libICE/ice.html) | `~/.ICEauthority` | [[72]](https://bugs.freedesktop.org/show_bug.cgi?id=49173) | `$ export ICEAUTHORITY="$XDG_RUNTIME_DIR"/ICEauthority`
...
| [Netbeans](/index.php/Netbeans "Netbeans") | `~/.netbeans` | [[73]](https://netbeans.org/bugzilla/show_bug.cgi?id=215961) | `$ netbeans --userdir "${XDG_CONFIG_HOME}"/netbeans` |
| [Node.js](/index.php/Node.js "Node.js") | `~/.node_repl_history` | `$ export NODE_REPL_HISTORY="$XDG_DATA_HOME"/node_repl_history` [[74]](https://nodejs.org/api/repl.html#repl_environment_variable_options) |
| [notmuch](/index.php/Notmuch "Notmuch") | `~/.notmuch-config` | [[75]](http://notmuchmail.org/pipermail/notmuch/2011/007007.html) | `$ export NOTMUCH_CONFIG="$XDG_CONFIG_HOME"/notmuch/notmuchrc`
...
`~/.npmrc`
 ...
 | [[76]](https://github.com/npm/npm/issues/6675) | `$ export NPM_CONFIG_USERCONFIG=$XDG_CONFIG_HOME/npm/npmrc` `npmrc` 
```
...
| [openscad](http://www.openscad.org/) | `~/.OpenSCAD` | [7c3077b0f](https://github.com/openscad/openscad/commit/7c3077b0f) | [[77]](https://github.com/openscad/openscad/issues/125) | Does not fully honour XDG Base Directory Specification, see [[78]](https://github.com/openscad/openscad/issues/373)
...
`~/.pg_service.conf`
 ...
 | 9.2 | [[79]](https://www.postgresql.org/docs/current/static/app-psql.html)

[[80]](https://www.postgresql.org/docs/current/static/libpq-envars.html)
...
| [rlwrap](http://utopia.knoware.nl/~hlub/uck/rlwrap/) | `~/.*_history` | [[81]](https://github.com/hanslub42/rlwrap/issues/25) | `$ export RLWRAP_HOME="$XDG_DATA_HOME"/rlwrap` |
...
| [stack](https://www.stackage.org/) | `~/.stack` | [[82]](https://github.com/commercialhaskell/stack/issues/342) | `$ export STACK_ROOT="$XDG_DATA_HOME"/stack` |
| [subversion](/index.php/Subversion "Subversion") | `~/.subversion` | [[83]](https://issues.apache.org/jira/browse/SVN-4599) [[84]](https://mail-archives.apache.org/mod_mbox/subversion-users/201204.mbox/%3c4F8FBCC6.4080205@ritsuka.org%3e)[[85]](http://mail-archives.apache.org/mod_mbox/subversion-dev/201509.mbox/%3c20150917222954.GA20331@teapot%3e) | `$ svn --config-dir "$XDG_CONFIG_HOME"/subversion` |
...
`$ tiptop -W "$XDG_CONFIG_HOME"/tiptop`
 ...
 |
| [tmux](/index.php/Tmux "Tmux") | `~/.tmux.conf` | [[86]](http://comments.gmane.org/gmane.comp.terminal-emulators.tmux.user/6013) [[87]](http://sourceforge.net/p/tmux/mailman/message/30619546/) | `$ tmux -f "$XDG_CONFIG_HOME"/tmux/tmux.conf`
...
| [WeeChat](/index.php/WeeChat "WeeChat") | `~/.weechat` | [[88]](http://savannah.nongnu.org/task/?10934) | `$ export WEECHAT_HOME="$XDG_CONFIG_HOME"/weechat`

`$ weechat -d "$XDG_CONFIG_HOME"/weechat`

 |
| [wget](/index.php/Wget "Wget") | `~/.wgetrc` | `$ export WGETRC="$XDG_CONFIG_HOME/wgetrc"` |
| [wine](/index.php/Wine "Wine") | `~/.wine` | [[89]](https://bugs.winehq.org/show_bug.cgi?id=20888) | [Winetricks](/index.php/Wine#Winetricks "Wine") uses XDG-alike location below for [WINEPREFIX](/index.php/Wine#WINEPREFIX "Wine") management:
...
| [adb](/index.php/Adb "Adb") | `~/.android` | [[90]](https://developer.android.com/studio/command-line/variables.html#android_sdk_root) | `$ export ANDROID_SDK_HOME="$XDG_CONFIG_HOME"/android` |
...
`~/.java`
 ...
 |
| [anthy](https://osdn.net/projects/anthy/) | `~/.anthy` | [[91]](https://osdn.net/ticket/browse.php?group_id=14&tid=28397) |
...
`~/.bzr.log`
 ...
 |
| [cabal](https://www.haskell.org/cabal/) | `~/.cabal` | [[93]](https://github.com/haskell/cabal/issues/680) | See discussion for potential workarounds. It is not very easy or straightforward but may be possible to emulate Base Directory compliance. |
| [calibre](https://calibre-ebook.com/) | `~/Calibre Library` |
| [CUPS](/index.php/CUPS "CUPS") | `~/.cups` | [[94]](http://www.cups.org/str.php?L4243) |
| [darcs](/index.php/Darcs "Darcs") | `~/.darcs` | [[95]](http://bugs.darcs.net/issue2453) |
| [dbus](/index.php/Dbus "Dbus") | `~/.dbus` | [[96]](https://bugs.freedesktop.org/show_bug.cgi?id=35887) | This should be avoidable with kdbus [citation needed]. |
| [Dia](https://wiki.gnome.org/Apps/Dia) | `~/.dia` |
| [eclipse](/index.php/Eclipse "Eclipse") | `~/.eclipse` | [[97]](https://bugs.eclipse.org/bugs/show_bug.cgi?id=200809) | Option `-Dosgi.configuration.area=@user.home/.config/..` overrides but must be added to `"$ECLIPSE_HOME"/eclipse.ini"` rather than command line which means you must have write access to `$ECLIPSE_HOME`. (Arch Linux hard-codes `$ECLIPSE_HOME` in `/usr/bin/eclipse`) |
| [emacs](https://www.gnu.org/software/emacs/) | `~/.emacs`

`~/.emacs.d`

 | [[98]](http://debbugs.gnu.org/cgi/bugreport.cgi?bug=583) | It's possible to set `HOME`, but it has unexpected side effects. So far the most promising approach is modifying another Emacs environment variable to alter the load path and author your own site file which can manually load up your init file, but it changes the load process significantly. |
| [Fetchmail](http://www.fetchmail.info/) | `~/.fetchmailrc` |
| [Firefox](/index.php/Firefox "Firefox") | `~/.mozilla` | [[99]](https://bugzil.la/259356) |
| [Flatpak](/index.php/Flatpak "Flatpak") | `~/.var/` | [[100]](https://github.com/flatpak/flatpak/issues/46) [[101]](https://github.com/flatpak/flatpak.github.io/issues/191) |
| [GHC](https://www.haskell.org/ghc/) | `~/.ghc` | [[102]](https://ghc.haskell.org/trac/ghc/ticket/6077) |
...
| [idris](http://www.idris-lang.org/) | `~/.idris` | [[103]](https://github.com/idris-lang/Idris-dev/pull/3456) |
| [julia](http://julialang.org/) | `~/.juliarc.jl`

`~/.julia_history`

 | [[104]](https://github.com/JuliaLang/julia/issues/4630) [[105]](https://github.com/JuliaLang/julia/issues/10016) |
| [Linux PAM](http://www.linux-pam.org/) | `~/.pam_environment` | [[106]](https://github.com/linux-pam/linux-pam/issues/7) | Hardcoded in [modules/pam_env/pam_env.c](https://github.com/linux-pam/linux-pam/blob/master/modules/pam_env/pam_env.c) |
...
| [milkytracker](http://www.milkytracker.org/) | `~/.milkytracker_config` | [[107]](https://github.com/Deltafire/MilkyTracker/issues/12) |
| [Minecraft](https://minecraft.net/) | `~/.minecraft` | [[108]](https://bugs.mojang.com/browse/MCL-2563) |
| [mongodb](https://www.mongodb.org/) | `~/.mongorc.js`

`~/.dbshell`

 | [[109]](https://jira.mongodb.org/browse/DOCS-5652?jql=text%20~%20%22.mongorc.js%22) | [This Stack Overflow thread](http://stackoverflow.com/a/22349050/4200039) suggests a partial workaround using command-line switch `--norc`. |
...
| [NSS](https://developer.mozilla.org/en-US/docs/Mozilla/Projects/NSS) | `~/.pki` | [[110]](https://bugzilla.mozilla.org/show_bug.cgi?id=818686) |
| [OpenSSH](https://www.openssh.com/) | `~/.ssh` | [[111]](https://bugzilla.mindrot.org/show_bug.cgi?id=2050) | Assumed to be present by many ssh daemons and clients such as DropBear and OpenSSH. |
| [palemoon](https://www.palemoon.org/) | `~/.moonchild productions` | [[112]](https://forum.palemoon.org/viewtopic.php?f=5&t=9639) |
...
| [Quod Libet](https://quodlibet.readthedocs.io/en/latest/) | `~/.quodlibet` | [[113]](https://github.com/quodlibet/quodlibet/issues/138) |
...
| [SeaMonkey](http://www.seamonkey-project.org/) | `~/.mozilla` | [[114]](https://bugzil.la/726939) |
| [Skype](/index.php/Skype "Skype") < 5.0 | `~/.Skype` | [[115]](https://community.skype.com/t5/Linux-archive/Skype-violates-XDG-basedir-spec-on-linux/td-p/4175884) |
...
`~/lessonfiles`
 ...
 | [[116]](https://savannah.gnu.org/bugs/index.php?50251) |
...
`~/.sqliterc`
 ...
 | [[117]](https://unix.stackexchange.com/questions/306890/change-location-of-sqlite-history-file)[[118]](http://sqlite.1065341.n5.nabble.com/Customizing-the-location-of-the-sqlite-history-td87055.html) | `$ sqlite3 -init "$XDG_CONFIG_HOME"/sqlite3/sqliterc` |
| [Steam](/index.php/Steam "Steam") | `~/.steam`

`~/.steampath` `~/.steampid`

 | [[119]](https://github.com/ValveSoftware/steam-for-linux/issues/1890) |
| [TeamSpeak](/index.php/TeamSpeak "TeamSpeak") | `~/.ts3client` |
| [TeXmacs](http://www.texmacs.org/) | `~/.TeXmacs` |
| [Thunderbird](/index.php/Thunderbird "Thunderbird") | `~/.thunderbird` | [[120]](https://bugzil.la/735285) |
...
*   [https://tlvince.com/vim-respect-xdg](https://tlvince.com/vim-respect-xdg)
 ...
 |
| [vimperator](http://www.vimperator.org/) | `~/.vimperatorrc` | [[121]](http://www.mozdev.org/pipermail/vimperator/2009-October/004848.html) | `$ export VIMPERATOR_INIT=":source $XDG_CONFIG_HOME/vimperator/vimperatorrc"`
...
| [xombrero](https://opensource.conformal.com/wiki/xombrero) | `~/.xombrero` | [[122]](https://github.com/conformal/xombrero/issues/74) |
...
`~/.yarn-config/`
 ...
 | [[123]](https://github.com/yarnpkg/yarn/issues/2334) |

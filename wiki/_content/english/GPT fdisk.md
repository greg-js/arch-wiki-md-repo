...
*gdisk*, *cgdisk* and *sgdisk* all have the same functionality but provide different user interfaces. *gdisk* is text-mode interactive, *sgdisk* is command-line, and *cgdisk* has a [curses](https://en.wikipedia.org/wiki/curses_(programming_library) "wikipedia:curses (programming library)")-based interface. This article covers [gdisk(8)](https://jlk.fjfi.cvut.cz/arch/manpages/man/gdisk.8) and [sgdisk(8)](https://jlk.fjfi.cvut.cz/arch/manpages/man/sgdisk.8) utilities.

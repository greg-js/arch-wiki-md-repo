...
| Lenovo ThinkPad L520 | Yes | Yes | Yes | Yes | Not tested | Not tested | Not tested | Not tested | Not tested |
...
install CD version
 | Hardware support | Remarks |
| Video | Sound | Ethernet | Wireless | Bluetooth | Power management | Modem | Other |
| [Lenovo ThinkPad P50](/index.php/Lenovo_ThinkPad_P50 "Lenovo ThinkPad P50") | 2016.04 | Yes | Yes | Yes | Yes | Yes | Suspend working, hibernate not tested | NA | SD card (Yes), Webcam (Yes), Fingerprint Reader ([libfprint-vfs0090-git](https://aur.archlinux.org/packages/libfprint-vfs0090-git/)), | Wifi requires Kernel 4.3.3+ |

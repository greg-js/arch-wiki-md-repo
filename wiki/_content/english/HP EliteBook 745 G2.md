...
Use [AMDGPU](/index.php/AMDGPU "AMDGPU").

### Audio

Speakers work flawlessly

### Wireless

Use [broadcom-wl](https://www.archlinux.org/packages/?name=broadcom-wl) and [linux-kernel-headers](https://www.archlinux.org/packages/?name=linux-kernel-headers).

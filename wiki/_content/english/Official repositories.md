...
as well as dependencies of the above (not necessarily [makedepends](/index.php/Makedepends "Makedepends")) and the [base](https://www.archlinux.org/packages/?name=base) [meta package](/index.php/Meta_package "Meta package").

...
The driver to be used must be either the reverse-engineered open-source `b43` module together with blob firmware [b43-firmware](https://aur.archlinux.org/packages/b43-firmware/), or the proprietary `wl` module via [broadcom-wl](https://www.archlinux.org/packages/?name=broadcom-wl) or [broadcom-wl-dkms](https://www.archlinux.org/packages/?name=broadcom-wl-dkms).

See [Broadcom wireless](/index.php/Broadcom_wireless "Broadcom wireless") and [Dell Wireless 1540 on WikiDevi](https://web.archive.org/web/20191003014054/https://wikidevi.com/wiki/Dell_Wireless_1540_(DW1540)) for more info.

...
**Warning:** Enabling [KMS](/index.php/KMS "KMS") causes [GNOME](/index.php/GNOME "GNOME") to default to [Wayland](/index.php/Wayland "Wayland"). Non-Wayland-native applications suffer from poor performance in Wayland sessions because of the lack of hardware accelerated XWayland. This is [expected](https://blogs.gnome.org/uraeus/2019/04/03/preparing-for-fedora-workstation-30/) to be resolved in Fall 2019\. Use the *GNOME on Xorg* session instead.

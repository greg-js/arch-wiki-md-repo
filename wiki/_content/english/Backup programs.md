...
| [rdup](http://miek.nl/projects/rdup) | [rdup](https://aur.archlinux.org/packages/rdup/) | C | tar.gz | gpg, blowfish and others | n/a | n/a | n/a | n/a | n/a | n/a | Yes | No | GPLv3 | No | Does not backup anything, only prints a list of absolute filenames to standard output. |

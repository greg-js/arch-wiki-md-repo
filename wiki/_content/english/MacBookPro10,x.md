...
*   [3 Post installation](#Post_installation)
    ...
    *   [3.2 Graphics](#Graphics)
        ...
        *   [3.2.4 Switching to/from GPUs with gpu-switch](#Switching_to/from_GPUs_with_gpu-switch)
    ...
    *   [3.6 Memory Card (SDHCI/SDX) Reader](#Memory_Card_(SDHCI/SDX)_Reader)
*   [4 What does not work (early August 2013, 3.10.3-1)](#What_does_not_work_(early_August_2013,_3.10.3-1))

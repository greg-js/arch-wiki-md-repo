...
Rime is provided by [librime](https://www.archlinux.org/packages/?name=librime) and can be used with [ibus-rime](https://www.archlinux.org/packages/?name=ibus-rime) or [fcitx-rime](https://www.archlinux.org/packages/?name=fcitx-rime).
...
*   [Official website](https://rime.github.io/)

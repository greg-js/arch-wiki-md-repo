...
*   [1 Installation](#Installation)
    *   [1.1 Booting the install media](#Booting_the_install_media)
        *   [1.1.1 BIOS and USB drives](#BIOS_and_USB_drives)
        *   [1.1.2 Screen corruption](#Screen_corruption)
    *   [1.2 Partitioning](#Partitioning)
*   [2 Post-installation](#Post-installation)
    *   [2.1 No sound from headphone out](#No_sound_from_headphone_out)
    *   [2.2 No sound from built-in speakers](#No_sound_from_built-in_speakers)
    *   [2.3 Turn off beep sound](#Turn_off_beep_sound)
*   [3 Trackpad](#Trackpad)

...
On the client and server [install](/index.php/Install "Install") [pulseaudio-zeroconf](https://www.archlinux.org/packages/?name=pulseaudio-zeroconf).

On both machines, [start](/index.php/Start "Start") and [enable](/index.php/Enable "Enable") `avahi-daemon.service`.

...
| [pikaur](https://aur.archlinux.org/packages/pikaur/) | Python | Yes | Yes | Yes | Yes | Yes | [No](https://github.com/actionless/pikaur/issues/320) | [-Sy](https://github.com/actionless/pikaur#pikaur) | bash, fish, zsh | [dynamic users](http://0pointer.net/blog/dynamic-users-with-systemd.html), batch interaction (1,2) |

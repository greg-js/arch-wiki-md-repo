...
| [snes9x](https://www.archlinux.org/packages/?name=snes9x) | `~/.snes9x` | [93b5f11](https://github.com/snes9xgit/snes9x/commit/93b5f11) | [[54]](https://github.com/snes9xgit/snes9x/issues/194) | By default configuration is blank, is intended that the user fill it at they will (throw the gui or manually) before launch a rom |
...
[3e4591d](https://gitlab.com/surfraw/Surfraw/commit/3e4591d) [bd8c427](https://gitlab.com/surfraw/Surfraw/commit/bd8c427) [f57fc71](https://gitlab.com/surfraw/Surfraw/commit/f57fc71)
 ...
 |
| [sway](/index.php/Sway "Sway") | `~/.sway/config` | [614393c](https://github.com/SirCmpwn/sway/commit/614393c) | [[55]](https://github.com/SirCmpwn/sway/issues/5) |
| [systemd](/index.php/Systemd "Systemd") |
| [termite](/index.php/Termite "Termite") |
| [tig](https://www.archlinux.org/packages/?name=tig) | `~/.tigrc`, `~/.tig_history` | [2.2](https://github.com/jonas/tig/blob/master/NEWS.adoc#tig-22) | [[56]](https://github.com/jonas/tig/issues/513) | `~/.local/share/tig` directory must exist, writes to `~/.tig_history` otherwise. |
| [tmuxinator](https://aur.archlinux.org/packages/tmuxinator/) | `~/.tmuxinator` | [2636923](https://github.com/tmuxinator/tmuxinator/pull/511/commits/2636923) | [[57]](https://github.com/tmuxinator/tmuxinator/pull/511) |
...
| [Uzbl](/index.php/Uzbl "Uzbl") | [c6fd63a](https://github.com/uzbl/uzbl/commit/c6fd63a) | [[58]](https://github.com/uzbl/uzbl/pull/150) |
| [vimb](https://aur.archlinux.org/packages/vimb/) |
| [VirtualBox](/index.php/VirtualBox "VirtualBox") | `~/.VirtualBox` | [4.3](https://www.virtualbox.org/ticket/5099?action=diff&version=7) | [[59]](https://www.virtualbox.org/ticket/5099) |
...
[68a25c7](https://github.com/martanne/vis/commit/68a25c7) [d138908](https://github.com/martanne/vis/commit/d138908)
 ...
 | [[60]](https://github.com/martanne/vis/pull/303) |
| [VLC](/index.php/VLC "VLC") | `~/.vlcrc` | [16f32e1](http://git.videolan.org/?p=vlc.git;a=commit;h=16f32e1) | [[61]](https://trac.videolan.org/vlc/ticket/1267) |
| [Visual Studio Code](/index.php/Visual_Studio_Code "Visual Studio Code") |
| [warsow](https://www.archlinux.org/packages/?name=warsow) | `~/.warsow-2.x` | [98ece3f](https://github.com/Qfusion/qfusion/commit/98ece3f) | [[62]](https://github.com/Qfusion/qfusion/issues/298) |
...
[[63]](https://github.com/xmonad/xmonad/issues/61) [[64]](https://code.google.com/p/xmonad/issues/detail?id=484)

 | Alternatively the environments `XMONAD_CONFIG_HOME`, `XMONAD_DATA_HOME`, and `XMONAD_CACHE_HOME` are also available. |
| [xsel](https://www.archlinux.org/packages/?name=xsel) | `~/.xsel.log` | [ee7b481](https://github.com/kfish/xsel/commit/ee7b481) | [[65]](https://github.com/kfish/xsel/issues/10) |
...
~/.yarn-config/`
 ...
 | [2d454b5](https://github.com/yarnpkg/yarn/commit/2d454b5) | [[66]](https://github.com/yarnpkg/yarn/pull/5336) |
...
| [ack](https://www.archlinux.org/packages/?name=ack) | `~/.ackrc` | [[67]](https://github.com/beyondgrep/ack2/issues/516) | `$ export ACKRC="$XDG_CONFIG_HOME/ack/ackrc"` |
| [Anki](/index.php/Anki "Anki") | 

`~/Anki
~/Documents/Anki`

 | [[68]](https://github.com/dae/anki/pull/49) [[69]](https://github.com/dae/anki/pull/58) | `$ anki -b "$XDG_DATA_HOME"/Anki` |
...
| [Atom](/index.php/Atom "Atom") | `~/.atom` | [[70]](https://github.com/atom/atom/issues/8281) | `$ export ATOM_HOME="$XDG_DATA_HOME"/atom` |
| [aws-cli](https://www.archlinux.org/packages/?name=aws-cli) | `~/.aws` | [1.7.45](https://github.com/aws/aws-cli/commit/fc5961ea2cc0b5976ac9f777e20e4236fd7540f5) | [[71]](https://github.com/aws/aws-cli/issues/2433) | 
...
~/.bzr.log`
 ...
 | [2.3.0](https://bugs.launchpad.net/bzr/+bug/195397/comments/15) | [[72]](https://bugs.launchpad.net/bzr/+bug/195397) | Discussion in upstream bug states that bazaar wil use `~/.config/bazaar` if it exists. The logfile `~/.bzr.log` might still be written. |
| [Ruby#Bundler](/index.php/Ruby#Bundler "Ruby") | `~/.bundle` | [[73]](https://github.com/bundler/bundler/pull/6024) [[74]](https://github.com/bundler/bundler/issues/4333) | `$ export BUNDLE_USER_CONFIG="$XDG_CONFIG_HOME"/bundle BUNDLE_USER_CACHE="$XDG_CACHE_HOME"/bundle BUNDLE_USER_PLUGIN="$XDG_DATA_HOME"/bundle` |
| [Rust#Cargo](/index.php/Rust#Cargo "Rust") | `~/.cargo` | [[75]](https://github.com/rust-lang/cargo/issues/1734) [[76]](https://github.com/rust-lang/rfcs/pull/1615) [[77]](https://github.com/rust-lang/cargo/pull/5183) [[78]](https://github.com/rust-lang/cargo/pull/148) | `$ export CARGO_HOME="$XDG_DATA_HOME"/cargo` |
...
| [conky](/index.php/Conky "Conky") | `~/.conkyrc` | [00481ee](https://github.com/brndnmtthws/conky/commit/00481ee9a97025e8e2acd7303d080af1948f7980) | [[79]](https://github.com/brndnmtthws/conky/issues/144) | `$ conky --config="$XDG_CONFIG_HOME"/conky/conkyrc` |
...
| [DOSBox](/index.php/DOSBox "DOSBox") | `~/.dosbox/dosbox-0.74-2.conf` | [[80]](https://www.vogons.org/viewtopic.php?t=29599) | `$ dosbox -conf "$XDG_CONFIG_HOME"/dosbox/dosbox.conf` |
...
~/.emscripten_cache__last_clear`
 ...
 | [[81]](https://github.com/kripken/emscripten/issues/3624) | 
...
$ emcc --em-config "$XDG_CONFIG_HOME"/emscripten/config --em-cache "$XDG_CACHE_HOME"/emscripten/cache`
 ...
 |
| [freecad](https://aur.archlinux.org/packages/freecad/) | `~/.FreeCAD` | [[82]](https://www.freecadweb.org/tracker/view.php?id=2956) | `$ freecad -u "$XDG_CONFIG_HOME"/FreeCAD/user.cfg -s "$XDG_CONFIG_HOME"/FreeCAD/system.cfg`
...
| [GnuPG](/index.php/GnuPG "GnuPG") | `~/.gnupg` | [[83]](https://bugs.gnupg.org/gnupg/issue1456) [[84]](https://bugs.gnupg.org/gnupg/issue1018) | 
...
$ mkdir -p "$(dirname "$GQSTATE")"`
 ...
 |
| [Gradle](/index.php/Gradle "Gradle") | `~/.gradle` | [[85]](https://discuss.gradle.org/t/be-a-nice-freedesktop-citizen-move-the-gradle-to-the-appropriate-location-in-linux/2199) | `$ export GRADLE_USER_HOME="$XDG_DATA_HOME"/gradle` |
...
| [httpie](https://www.archlinux.org/packages/?name=httpie) | `~/.httpie` | [[86]](https://github.com/jakubroztocil/httpie/issues/145) | `$ export HTTPIE_CONFIG_DIR="$XDG_CONFIG_HOME"/httpie` |
| [intellij-idea-ce](https://aur.archlinux.org/packages/intellij-idea-ce/) | `~/.IntelliJIdea*` | [[87]](https://youtrack.jetbrains.com/issue/IDEA-22407) | 
```
...
```
 |
| [irssi](/index.php/Irssi "Irssi") | `~/.irssi` | [[88]](https://github.com/irssi/irssi/pull/511) | `$ irssi --config="$XDG_CONFIG_HOME"/irssi/config --home="$XDG_DATA_HOME"/irssi` |
| [isync](/index.php/Isync "Isync") | `~/.mbsyncrc` | `$ mbsync -c "$XDG_CONFIG_HOME"/isync/mbsyncrc` |
| [Java#OpenJDK](/index.php/Java#OpenJDK "Java") | `~/.java/.userPrefs` | [[89]](https://bugzilla.redhat.com/show_bug.cgi?id=1154277) | `$ export _JAVA_OPTIONS=-Djava.util.prefs.userRoot="$XDG_CONFIG_HOME"/java` |
...
`$ export LESSHISTFILE=-` can be used to disable this feature.
 ...
 |
| [libdvdcss](https://www.archlinux.org/packages/?name=libdvdcss) | `~/.dvdcss` | [[90]](https://mailman.videolan.org/pipermail/libdvdcss-devel/2014-August/001022.html) | `$ export DVDCSS_CACHE="$XDG_DATA_HOME"/dvdcss` |
| [libice](https://www.archlinux.org/packages/?name=libice) | `~/.ICEauthority` | [[91]](https://gitlab.freedesktop.org/xorg/lib/libice/issues/2) | `$ export ICEAUTHORITY="$XDG_CACHE_HOME"/ICEauthority`
...
| [maven](https://www.archlinux.org/packages/?name=maven) | `~/.m2` | [[92]](https://issues.apache.org/jira/browse/MNG-6603) | `$ mvn -gs "$XDG_CONFIG_HOME"/maven/settings.xml` `[settings.xml](http://maven.apache.org/settings.html)` 
```
...
| [Netbeans](/index.php/Netbeans "Netbeans") | `~/.netbeans` | [[93]](https://netbeans.org/bugzilla/show_bug.cgi?id=215961) | `$ netbeans --userdir "${XDG_CONFIG_HOME}"/netbeans` |
| [Node.js](/index.php/Node.js "Node.js") | `~/.node_repl_history` | `$ export NODE_REPL_HISTORY="$XDG_DATA_HOME"/node_repl_history` [[94]](https://nodejs.org/api/repl.html#repl_environment_variable_options) |
| [notmuch](/index.php/Notmuch "Notmuch") | `~/.notmuch-config` | [[95]](http://notmuchmail.org/pipermail/notmuch/2011/007007.html) | 
...
~/.npmrc`
 ...
 | [[96]](https://github.com/npm/npm/issues/6675) | `$ export NPM_CONFIG_USERCONFIG=$XDG_CONFIG_HOME/npm/npmrc` `npmrc` 
```
...
`prefix` is unnecessary (and unsupported) if Node.js is installed by [nvm](https://aur.archlinux.org/packages/nvm/).
 ...
 |
| [nuget](https://www.archlinux.org/packages/?name=nuget) | `~/.nuget/packages` | [[97]](https://docs.microsoft.com/en-us/nuget/consume-packages/managing-the-global-packages-and-cache-folders) | `$ export NUGET_PACKAGES="$XDG_CACHE_HOME"/NuGetPackages` |
...
The `local_list` option must be given an absolute path.
 ...
 |
| [openscad](https://www.archlinux.org/packages/?name=openscad) | `~/.OpenSCAD` | [7c3077b0f](https://github.com/openscad/openscad/commit/7c3077b0f) | [[98]](https://github.com/openscad/openscad/issues/125) | Does not fully honour XDG Base Directory Specification, see [[99]](https://github.com/openscad/openscad/issues/373)
...
| [Pidgin](/index.php/Pidgin "Pidgin") | `~/.purple` | [[100]](https://developer.pidgin.im/ticket/4911) | `$ pidgin --config="$XDG_DATA_HOME"/purple` |
...
~/.pg_service.conf`
 ...
 | 9.2 | [[101]](https://www.postgresql.org/docs/current/static/app-psql.html) [[102]](https://www.postgresql.org/docs/current/static/libpq-envars.html) | 
...
| [rlwrap](https://www.archlinux.org/packages/?name=rlwrap) | `~/.*_history` | [[103]](https://github.com/hanslub42/rlwrap/issues/25) | `$ export RLWRAP_HOME="$XDG_DATA_HOME"/rlwrap` |
...
$ export GEM_SPEC_CACHE="$XDG_CACHE_HOME"/gem`
 ...
 |
| [Rust#Rustup](/index.php/Rust#Rustup "Rust") | `~/.rustup` | [[104]](https://github.com/rust-lang-nursery/rustup.rs/issues/247) | `$ export RUSTUP_HOME="$XDG_DATA_HOME"/rustup` |
| [sbt](https://www.archlinux.org/packages/?name=sbt) | `~/.sbt`

`~/.ivy2`

 | [[105]](https://github.com/sbt/sbt/issues/3681) | `$ sbt -ivy "$XDG_DATA_HOME"/ivy2 -sbt-dir "$XDG_DATA_HOME"/sbt` (beware [[106]](https://github.com/sbt/sbt/issues/3598)) |
| [GNU Screen](/index.php/GNU_Screen "GNU Screen") | `~/.screenrc` | `$ export SCREENRC="$XDG_CONFIG_HOME"/screen/screenrc` |
| [Haskell#Stack](/index.php/Haskell#Stack "Haskell") | `~/.stack` | [[107]](https://github.com/commercialhaskell/stack/issues/342) | `$ export STACK_ROOT="$XDG_DATA_HOME"/stack` |
| [subversion](/index.php/Subversion "Subversion") | `~/.subversion` | [[108]](https://issues.apache.org/jira/browse/SVN-4599) [[109]](https://mail-archives.apache.org/mod_mbox/subversion-users/201204.mbox/%3c4F8FBCC6.4080205@ritsuka.org%3e)[[110]](http://mail-archives.apache.org/mod_mbox/subversion-dev/201509.mbox/%3c20150917222954.GA20331@teapot%3e) | `$ svn --config-dir "$XDG_CONFIG_HOME"/subversion` |
...
`$ tiptop -W "$XDG_CONFIG_HOME"/tiptop`
 ...
 |
| [tmux](/index.php/Tmux "Tmux") | `~/.tmux.conf` | [[111]](https://github.com/tmux/tmux/issues/142) | `$ tmux -f "$XDG_CONFIG_HOME"/tmux/tmux.conf`
...
~/.vagrant.d/aliases`
 ...
 | [[112]](https://www.vagrantup.com/docs/other/environmental-variables.html) | 

`$ export VAGRANT_HOME="$XDG_DATA_HOME"/vagrant
$ export VAGRANT_ALIAS_FILE="$XDG_DATA_HOME"/vagrant/aliases`

 |
| [WeeChat](/index.php/WeeChat "WeeChat") | `~/.weechat` | [[113]](http://savannah.nongnu.org/task/?10934) | 
...
$ echo hsts-file \= "$XDG_CACHE_HOME"/wget-hsts >> "$XDG_CONFIG_HOME/wgetrc"`
 ...
 |
| [wine](/index.php/Wine "Wine") | `~/.wine` | [[114]](https://bugs.winehq.org/show_bug.cgi?id=20888) | [Winetricks](/index.php/Wine#Winetricks "Wine") uses XDG-alike location below for [WINEPREFIX](/index.php/Wine#WINEPREFIX "Wine") management:
...
~/.xserverrc`
 ...
 | [[115]](https://gitlab.freedesktop.org/xorg/app/xinit/issues/14) | 
...
`~/.z`
 ...
 | [[116]](https://github.com/rupa/z/issues/267) | `$ export _Z_DATA="$XDG_DATA_HOME/z"` |

### Hardcoded

| Application | Legacy Path | Discussion | Notes |
| [adb](/index.php/Adb "Adb") | `~/.android/` | [[117]](https://developer.android.com/studio/command-line/variables.html#android_sdk_root) | `$ export ANDROID_SDK_HOME="$XDG_CONFIG_HOME"/android` |
...
~/.java/`
 ...
 |
| [anthy](https://osdn.net/projects/anthy/) | `~/.anthy` | [[118]](https://osdn.net/ticket/browse.php?group_id=14&tid=28397) |
...
Specify `--init-file <file>` as an alternative to `~/.bashrc` for interactive shells.
 ...
 |
| [cabal](https://www.haskell.org/cabal/) | `~/.cabal/` | [[119]](https://github.com/haskell/cabal/issues/680) | See discussion for potential workarounds. It is not very easy or straightforward but may be possible to emulate Base Directory compliance. |
| [chatty](https://aur.archlinux.org/packages/chatty/) | `~/.chatty/` | [[120]](https://github.com/chatty/chatty/issues/273) |
...
| [Cinnamon](/index.php/Cinnamon "Cinnamon") | `~/.cinnamon/` | [[121]](https://github.com/linuxmint/Cinnamon/issues/7807) |
| [cryptomator](https://aur.archlinux.org/packages/cryptomator/) | `~/.Cryptomator` | [[122]](https://github.com/cryptomator/cryptomator/issues/710) |
| [CUPS](/index.php/CUPS "CUPS") | `~/.cups/` | [won't fix](https://github.com/apple/cups/issues/4243) |
| [darcs](/index.php/Darcs "Darcs") | `~/.darcs/` | [[123]](http://bugs.darcs.net/issue2453) |
| [dbus](/index.php/Dbus "Dbus") | `~/.dbus/` | [[124]](https://gitlab.freedesktop.org/dbus/dbus/issues/46) | This should be avoidable with kdbus [citation needed]. |
...
| [dotnet-sdk](https://www.archlinux.org/packages/?name=dotnet-sdk) | `~/.dotnet/` | [[125]](https://github.com/dotnet/cli/issues/7569) |
| [Eclipse](/index.php/Eclipse "Eclipse") | `~/.eclipse/` | [[126]](https://bugs.eclipse.org/bugs/show_bug.cgi?id=200809) | Option `-Dosgi.configuration.area=@user.home/.config/..` overrides but must be added to `"$ECLIPSE_HOME"/eclipse.ini"` rather than command line which means you must have write access to `$ECLIPSE_HOME`. (Arch Linux hard-codes `$ECLIPSE_HOME` in `/usr/bin/eclipse`) |
| [Emacs](/index.php/Emacs "Emacs") | 

`~/.emacs
~/.emacs.d/`

 | [[127]](http://debbugs.gnu.org/cgi/bugreport.cgi?bug=583) | It's possible to set `HOME`, but it has unexpected side effects. So far the most promising approach is modifying another Emacs environment variable to alter the load path and author your own site file which can manually load up your init file, but it changes the load process significantly. |
| [Fetchmail](http://www.fetchmail.info/) | `~/.fetchmailrc` |
| [Firefox](/index.php/Firefox "Firefox") | `~/.mozilla/` | [[128]](https://bugzil.la/259356) |
| [Flatpak](/index.php/Flatpak "Flatpak") | `~/.var/` | [[129]](https://github.com/flatpak/flatpak/issues/46) [[130]](https://github.com/flatpak/flatpak.github.io/issues/191) [won't fix](https://github.com/flatpak/flatpak/issues/1651) |
| [GHC](https://www.haskell.org/ghc/) | `~/.ghc` | [[131]](https://ghc.haskell.org/trac/ghc/ticket/6077) |
| [Goldendict](/index.php/Goldendict "Goldendict") | `~/.goldendict/` | [[132]](https://github.com/goldendict/goldendict/issues/151) |
| [gramps](https://www.archlinux.org/packages/?name=gramps) | `~/.gramps/` | [[133]](https://gramps-project.org/bugs/view.php?id=8025) |
| [grsync](https://www.archlinux.org/packages/?name=grsync) | `~/.grsync/` | [[134]](https://sourceforge.net/p/grsync/feature-requests/15/) |
| [gtk-recordMyDesktop](http://recordmydesktop.sourceforge.net/about.php) | `~/.gtk-recordmydesktop` |
| [hplip](https://www.archlinux.org/packages/?name=hplip) | `~/.hplip/` | [[135]](https://bugs.launchpad.net/hplip/+bug/307152) |
| [idris](http://www.idris-lang.org/) | `~/.idris` | [[136]](https://github.com/idris-lang/Idris-dev/pull/3456) |
| [Java](/index.php/Java "Java") OpenJDK | `~/.java/fonts` | [[137]](https://bugzilla.redhat.com/show_bug.cgi?id=1154277) |
...
~/.julia_history`
 ...
 | [[138]](https://github.com/JuliaLang/julia/issues/4630) [[139]](https://github.com/JuliaLang/julia/issues/10016) |
| [Linux PAM](http://www.linux-pam.org/) | `~/.pam_environment` | [[140]](https://github.com/linux-pam/linux-pam/issues/7) | Hardcoded in [modules/pam_env/pam_env.c](https://github.com/linux-pam/linux-pam/blob/master/modules/pam_env/pam_env.c) |
...
| [Minecraft](/index.php/Minecraft "Minecraft") | `~/.minecraft/` | [[141]](https://bugs.mojang.com/browse/MCL-2563) |
| [Minetest](/index.php/Minetest "Minetest") | `~/.minetest/` | [won't fix](https://github.com/minetest/minetest/issues/864) [[142]](https://github.com/minetest/minetest/issues/8151) |
| [mongodb](https://www.mongodb.org/) | 

`~/.mongorc.js
~/.dbshell`

 | [[143]](https://jira.mongodb.org/browse/DOCS-5652?jql=text%20~%20%22.mongorc.js%22) | [This Stack Overflow thread](https://stackoverflow.com/questions/22348604/the-mongorc-js-is-not-found-but-there-is-one/22349050#22349050) suggests a partial workaround using command-line switch `--norc`. |
...
| [NSS](https://developer.mozilla.org/en-US/docs/Mozilla/Projects/NSS) | `~/.pki` | [[144]](https://bugzilla.mozilla.org/show_bug.cgi?id=818686) |
...
| [palemoon](https://www.palemoon.org/) | `~/.moonchild productions` | [[145]](https://forum.palemoon.org/viewtopic.php?f=5&t=9639) |
...
| [Ren'Py](https://www.renpy.org/) | `~/.renpy` | [[146]](https://github.com/renpy/renpy/issues/1377) |
...
| [SeaMonkey](http://www.seamonkey-project.org/) | `~/.mozilla/` | [[147]](https://bugzil.la/726939) |
| [simplescreenrecorder](https://www.archlinux.org/packages/?name=simplescreenrecorder) | `~/.ssr/` | [[148]](https://github.com/MaartenBaert/ssr/issues/407) | Author seems against this feature. |
...
~/lessonfiles`
 ...
 | [[149]](https://savannah.gnu.org/bugs/index.php?50251) |
...
~/.sqliterc`
 ...
 | [[150]](https://www.sqlite.org/src/info/696e82f7c82d1720) | `$ export SQLITE_HISTORY=$XDG_DATA_HOME/sqlite_history
`
...
~/.steampid`
 ...
 | [[151]](https://github.com/ValveSoftware/steam-for-linux/issues/1890) | Many game engines (Unity 3D, Unreal) follow the specification, but then individual game publishers hardcode the paths in [Steam Auto-Cloud](https://www.ctrl.blog/entry/flatpak-steamcloud-xdg) causing game-saves to sync to the wrong directory. |
...
| [Thunderbird](/index.php/Thunderbird "Thunderbird") | `~/.thunderbird/` | [[152]](https://bugzil.la/735285) |
...
*   [https://tlvince.com/vim-respect-xdg](https://tlvince.com/vim-respect-xdg)
 ...
 |
| [vimperator](http://www.vimperator.org/) | `~/.vimperatorrc` | [[153]](http://www.mozdev.org/pipermail/vimperator/2009-October/004848.html) | `$ export VIMPERATOR_INIT=":source $XDG_CONFIG_HOME/vimperator/vimperatorrc"`

`$ export VIMPERATOR_RUNTIME="$XDG_CONFIG_HOME"/vimperator`

 |
| [w3m](https://www.archlinux.org/packages/?name=w3m) | `~/.w3m` | [[154]](https://sourceforge.net/p/w3m/feature-requests/31/) |
| [wpa_cli](https://w1.fi/) | `~/.wpa_cli_history` |
| [xdg-utils](https://www.archlinux.org/packages/?name=xdg-utils) | `~/.gnome` | [[155]](https://bugs.freedesktop.org/show_bug.cgi?id=90775) | For some reason the script `xdg-desktop-menu` hard-codes `gnome_user_dir="$HOME/.gnome/apps"`. This is used by [chromium](/index.php/Chromium "Chromium") among others. |
| [xombrero](https://opensource.conformal.com/wiki/xombrero) | `~/.xombrero` | [[156]](https://github.com/conformal/xombrero/issues/74) |
| [zenmap](https://nmap.org/zenmap/) [nmap](https://www.archlinux.org/packages/?name=nmap) | `~/.zenmap` | [[157]](http://seclists.org/nmap-dev/2012/q2/163) [[158]](https://github.com/nmap/nmap/issues/590) |

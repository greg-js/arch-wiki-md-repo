...
| [Quod Libet](https://quodlibet.readthedocs.io/en/latest/) | `~/.quodlibet` | 3.10.0 | [[46]](https://github.com/quodlibet/quodlibet/issues/138) |
...
[fd8686e](https://github.com/qtile/qtile/commit/fd8686e) [66d704b](https://github.com/qtile/qtile/commit/66d704b) [51cff01](https://github.com/qtile/qtile/commit/51cff01)
 ...
 | [[47]](https://github.com/qtile/qtile/pull/835) | Some optional bar widgets can create files and directories in non-compliant paths, but most often these are still configurable. |
| [rclone](https://www.archlinux.org/packages/?name=rclone) | `~/.rclone.conf` | [9d36258](https://github.com/ncw/rclone/commit/9d36258) | [[48]](https://github.com/ncw/rclone/issues/868) |
| [retroarch](https://www.archlinux.org/packages/?name=retroarch) |
| [rr](https://aur.archlinux.org/packages/rr/) | `~/.rr` | [02e7d41](https://github.com/mozilla/rr/commit/02e7d41) | [[49]](https://github.com/mozilla/rr/issues/1455) |
...
| [snes9x](https://www.archlinux.org/packages/?name=snes9x) | `~/.snes9x` | [93b5f11](https://github.com/snes9xgit/snes9x/commit/93b5f11) | [[50]](https://github.com/snes9xgit/snes9x/issues/194) | By default configuration is blank, is intended that the user fill it at they will (throw the gui or manually) before launch a rom |
...
[3e4591d](https://gitlab.com/surfraw/Surfraw/commit/3e4591d) [bd8c427](https://gitlab.com/surfraw/Surfraw/commit/bd8c427) [f57fc71](https://gitlab.com/surfraw/Surfraw/commit/f57fc71)
 ...
 |
| [sway](/index.php/Sway "Sway") | `~/.sway/config` | [614393c](https://github.com/SirCmpwn/sway/commit/614393c) | [[51]](https://github.com/SirCmpwn/sway/issues/5) |
| [systemd](/index.php/Systemd "Systemd") |
| [termite](/index.php/Termite "Termite") |
| [tmuxinator](https://aur.archlinux.org/packages/tmuxinator/) | `~/.tmuxinator` | [2636923](https://github.com/tmuxinator/tmuxinator/pull/511/commits/2636923) | [[52]](https://github.com/tmuxinator/tmuxinator/pull/511) |
...
[68a25c7](https://github.com/martanne/vis/commit/68a25c7) [d138908](https://github.com/martanne/vis/commit/d138908)
 ...
 | [[55]](https://github.com/martanne/vis/pull/303) |
| [VLC](/index.php/VLC "VLC") | `~/.vlcrc` | [16f32e1](http://git.videolan.org/?p=vlc.git;a=commit;h=16f32e1) | [[56]](https://trac.videolan.org/vlc/ticket/1267) |
...
[[58]](https://github.com/xmonad/xmonad/issues/61) [[59]](https://code.google.com/p/xmonad/issues/detail?id=484)

 | Alternatively the environments `XMONAD_CONFIG_HOME`, `XMONAD_DATA_HOME`, and `XMONAD_CACHE_HOME` are also available. |
| [xsel](https://www.archlinux.org/packages/?name=xsel) | `~/.xsel.log` | [ee7b481](https://github.com/kfish/xsel/commit/ee7b481) | [[60]](https://github.com/kfish/xsel/issues/10) |
...
~/.yarn-config/`
 ...
 | [2d454b5](https://github.com/yarnpkg/yarn/commit/2d454b5) | [[61]](https://github.com/yarnpkg/yarn/pull/5336) |
...
| [DOSBox](/index.php/DOSBox "DOSBox") | `~/.dosbox/dosbox-0.74-2.conf` | [[74]](https://www.vogons.org/viewtopic.php?t=29599) | `$ dosbox -conf "$XDG_CONFIG_HOME"/dosbox/dosbox.conf` |
...
~/.emscripten_cache__last_clear`
 ...
 | [[75]](https://github.com/kripken/emscripten/issues/3624) | 
...
$ emcc --em-config "$XDG_CONFIG_HOME"/emscripten/config --em-cache "$XDG_CACHE_HOME"/emscripten/cache`
 ...
 |
| [freecad](https://www.freecadweb.org/) | `~/.FreeCAD` | [[76]](https://www.freecadweb.org/tracker/view.php?id=2956) | `$ freecad -u "$XDG_CONFIG_HOME"/FreeCAD/user.cfg -s "$XDG_CONFIG_HOME"/FreeCAD/system.cfg` |
...
| [GnuPG](/index.php/GnuPG "GnuPG") | `~/.gnupg` | [[77]](https://bugs.gnupg.org/gnupg/issue1456) [[78]](https://bugs.gnupg.org/gnupg/issue1018) | 
...
$ mkdir -p "$(dirname "$GQSTATE")"`
 ...
 |
| [gradle](https://gradle.org/) | `~/.gradle` | [[79]](https://discuss.gradle.org/t/be-a-nice-freedesktop-citizen-move-the-gradle-to-the-appropriate-location-in-linux/2199) | `$ export GRADLE_USER_HOME="$XDG_DATA_HOME"/gradle` |
...
| [httpie](http://httpie.org) | `~/.httpie` | [[80]](https://github.com/jakubroztocil/httpie/issues/145) | `$ export HTTPIE_CONFIG_DIR="$XDG_CONFIG_HOME"/httpie` |
...
```
 |
| [irssi](/index.php/Irssi "Irssi") | `~/.irssi` | [[81]](https://github.com/irssi/irssi/pull/511) | `$ irssi --config="$XDG_CONFIG_HOME"/irssi/config --home="$XDG_DATA_HOME"/irssi` |
| [isync](/index.php/Isync "Isync") | `~/.mbsyncrc` | `$ mbsync -c "$XDG_CONFIG_HOME"/isync/mbsyncrc` |
| [Java](/index.php/Java "Java") OpenJDK | `~/.java/.userPrefs` | [[82]](https://bugzilla.redhat.com/show_bug.cgi?id=1154277) | `$ export _JAVA_OPTIONS=-Djava.util.prefs.userRoot="$XDG_CONFIG_HOME"/java` |
...
`$ export LESSHISTFILE=-` can be used to disable this feature.
 ...
 |
| [libdvdcss](http://www.videolan.org/developers/libdvdcss.html) | `~/.dvdcss` | [[83]](https://mailman.videolan.org/pipermail/libdvdcss-devel/2014-August/001022.html) | `$ export DVDCSS_CACHE="$XDG_DATA_HOME"/dvdcss` |
| [libice](https://www.x.org/releases/current/doc/libICE/ice.html) | `~/.ICEauthority` | [[84]](https://bugs.freedesktop.org/show_bug.cgi?id=49173) | `$ export ICEAUTHORITY="$XDG_CACHE_HOME"/ICEauthority`
...
| [Netbeans](/index.php/Netbeans "Netbeans") | `~/.netbeans` | [[85]](https://netbeans.org/bugzilla/show_bug.cgi?id=215961) | `$ netbeans --userdir "${XDG_CONFIG_HOME}"/netbeans` |
| [Node.js](/index.php/Node.js "Node.js") | `~/.node_repl_history` | `$ export NODE_REPL_HISTORY="$XDG_DATA_HOME"/node_repl_history` [[86]](https://nodejs.org/api/repl.html#repl_environment_variable_options) |
| [notmuch](/index.php/Notmuch "Notmuch") | `~/.notmuch-config` | [[87]](http://notmuchmail.org/pipermail/notmuch/2011/007007.html) | 
...
~/.npmrc`
 ...
 | [[88]](https://github.com/npm/npm/issues/6675) | `$ export NPM_CONFIG_USERCONFIG=$XDG_CONFIG_HOME/npm/npmrc` `npmrc` 
```
...
The `local_list` option must be given an absolute path.
 ...
 |
| [openscad](http://www.openscad.org/) | `~/.OpenSCAD` | [7c3077b0f](https://github.com/openscad/openscad/commit/7c3077b0f) | [[89]](https://github.com/openscad/openscad/issues/125) | Does not fully honour XDG Base Directory Specification, see [[90]](https://github.com/openscad/openscad/issues/373)
...
| [Pidgin](/index.php/Pidgin "Pidgin") | `~/.purple` | [[91]](https://developer.pidgin.im/ticket/4911) | `$ pidgin --config="$XDG_DATA_HOME"/purple` |
...
~/.pg_service.conf`
 ...
 | 9.2 | [[92]](https://www.postgresql.org/docs/current/static/app-psql.html) [[93]](https://www.postgresql.org/docs/current/static/libpq-envars.html) | 
...
| [Flatpak](/index.php/Flatpak "Flatpak") | `~/.var/` | [[116]](https://github.com/flatpak/flatpak/issues/46) [[117]](https://github.com/flatpak/flatpak.github.io/issues/191) [won't fix](https://github.com/flatpak/flatpak/issues/1651) |
| [GHC](https://www.haskell.org/ghc/) | `~/.ghc` | [[118]](https://ghc.haskell.org/trac/ghc/ticket/6077) |
| [Goldendict](/index.php/Goldendict "Goldendict") | `~/.goldendict/` | [[119]](https://github.com/goldendict/goldendict/issues/151) |
| [gramps](https://www.archlinux.org/packages/?name=gramps) | `~/.gramps/` | [[120]](https://gramps-project.org/bugs/view.php?id=8025) |
| [grsync](https://www.archlinux.org/packages/?name=grsync) | `~/.grsync/` | [[121]](https://sourceforge.net/p/grsync/feature-requests/15/) |
| [gtk-recordMyDesktop](http://recordmydesktop.sourceforge.net/about.php) | `~/.gtk-recordmydesktop` |
| [hplip](https://www.archlinux.org/packages/?name=hplip) | `~/.hplip/` | [[122]](https://bugs.launchpad.net/hplip/+bug/307152) |
| [idris](http://www.idris-lang.org/) | `~/.idris` | [[123]](https://github.com/idris-lang/Idris-dev/pull/3456) |
| [Java](/index.php/Java "Java") OpenJDK | `~/.java/fonts` | [[124]](https://bugzilla.redhat.com/show_bug.cgi?id=1154277) |
...
~/.julia_history`
 ...
 | [[125]](https://github.com/JuliaLang/julia/issues/4630) [[126]](https://github.com/JuliaLang/julia/issues/10016) |
| [Linux PAM](http://www.linux-pam.org/) | `~/.pam_environment` | [[127]](https://github.com/linux-pam/linux-pam/issues/7) | Hardcoded in [modules/pam_env/pam_env.c](https://github.com/linux-pam/linux-pam/blob/master/modules/pam_env/pam_env.c) |
...
| [Minecraft](/index.php/Minecraft "Minecraft") | `~/.minecraft/` | [[128]](https://bugs.mojang.com/browse/MCL-2563) |

...
Install from AUR: [broadcom-wl](https://www.archlinux.org/packages/?name=broadcom-wl) or (better) [broadcom-wl-dkms](https://www.archlinux.org/packages/?name=broadcom-wl-dkms)

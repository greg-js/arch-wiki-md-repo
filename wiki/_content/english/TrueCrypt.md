**Warning:** As of May 2014, development on TrueCrypt is discontinued and [will no longer receive updates and fixes](http://truecrypt.sourceforge.net/). Consider alternatives such as [dm-crypt](/index.php/Dm-crypt "Dm-crypt"), [tcplay](/index.php/Tcplay "Tcplay") or use a TrueCrypt fork. For example, [VeraCrypt](http://veracrypt.codeplex.com/) is in active development and available as [veracrypt](https://www.archlinux.org/packages/?name=veracrypt); VeraCrypt storage format is compatible with TrueCrypt storage format since version 1.0f.

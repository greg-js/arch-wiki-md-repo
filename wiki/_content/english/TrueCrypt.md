...
*   [2 Accessing a TrueCrypt or VeraCrypt container using cryptsetup](#Accessing_a_TrueCrypt_or_VeraCrypt_container_using_cryptsetup)
    *   [2.1 Automounting using /etc/crypttab](#Automounting_using_/etc/crypttab)
...
*   [9 Safely unmount and unmap volumes (on shutdown)](#Safely_unmount_and_unmap_volumes_(on_shutdown))
*   [10 Errors](#Errors)
    *   [10.1 TrueCrypt is already running](#TrueCrypt_is_already_running)
    *   [10.2 Deleted stale lockfile](#Deleted_stale_lockfile)
    *   [10.3 Issues with Unicode file/folder names](#Issues_with_Unicode_file/folder_names)
        *   [10.3.1 NTFS](#NTFS)
        *   [10.3.2 FAT](#FAT)
    *   [10.4 Unmount error (device mapper)](#Unmount_error_(device_mapper))
    *   [10.5 Mount error (device mapper, truecrypt partition)](#Mount_error_(device_mapper,_truecrypt_partition))

...
**Tip:** If you use something other than `/var/lib/mysql` for datadir, you need to [edit](/index.php/Systemd#Editing_provided_units "Systemd") `mysqld.service` and append the same parameter to the `ExecStart` line.

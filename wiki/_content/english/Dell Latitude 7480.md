...
Another test configuration: Core i7-7600u, 1080p display with an IR camera and fingerprint reader Output of `lspci -nn` is as below
...
Bus 002 Device 001: ID 1d6b:0003 Linux Foundation 3.0 root hub
Bus 001 Device 003: ID 8087:0a2b Intel Corp. 
Bus 001 Device 002: ID 0bda:58c7 Realtek Semiconductor Corp. 
Bus 001 Device 004: ID 0a5c:5834 Broadcom Corp. 
Bus 001 Device 001: ID 1d6b:0002 Linux Foundation 2.0 root hub
...
The IR camera can be used to take a picture but not for log in at the moment.
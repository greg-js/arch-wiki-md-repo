...
**Tip:** PlayOnLinux supports Bumblebee. Open POL console, type this command `POL_Config_Write BEFORE_WINE **optirun**` and hit enter. **optirun** command will used and each application will be run using **optirun**. You can even use **primusrun** instead!

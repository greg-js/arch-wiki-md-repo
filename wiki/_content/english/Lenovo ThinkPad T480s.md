...
Install it using the [throttled](https://www.archlinux.org/packages/?name=throttled) or [lenovo-throttling-fix-git](https://aur.archlinux.org/packages/lenovo-throttling-fix-git/) package.

Tomcat is an open source Java [Servlet container](https://en.wikipedia.org/wiki/Web_container "wikipedia:Web container") developed by the Apache Software Foundation. For more information about basic configuration, see:[Tomcat and Apache](/index.php/Tomcat_and_Apache "Tomcat and Apache")

...
Supports both UEFI and MBR style bios. There are no issues with installing Arch Linux with the latest that is known [Archiso](https://www.archlinux.org/download/). The [Installation guide](/index.php/Installation_guide "Installation guide") works except, the sound.

Check out the T450s wiki, almost everything from there works on the T450: [Lenovo ThinkPad T450s](/index.php/Lenovo_ThinkPad_T450s "Lenovo ThinkPad T450s")

...
2.  broadcom-wl: [broadcom-wl](https://www.archlinux.org/packages/?name=broadcom-wl) needs to be re-compiled after each kernel upgrade. LED works but reconnecting problem after suspending.

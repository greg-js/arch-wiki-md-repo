...
| [Knot Resolver](/index.php/Knot_Resolver "Knot Resolver") | [knot-resolver](https://aur.archlinux.org/packages/knot-resolver/) | Yes | Yes | Yes | No | Yes | No | Yes | [Server](https://knot-resolver.readthedocs.io/en/stable/modules.html#dns-over-http-doh) |

...
*   [3 Application overview](#Application_overview)
    ...
    *   [3.3 Patchbay / Router](#Patchbay_/_Router)
...
*   [4 Usage examples](#Usage_examples)
    *   [4.1 Recording a single track in Ardour (Ardour does monitoring)](#Recording_a_single_track_in_Ardour_(Ardour_does_monitoring))
    ...
    *   [4.2 Recording a single track in Ardour (Audio Hardware does monitoring)](#Recording_a_single_track_in_Ardour_(Audio_Hardware_does_monitoring))

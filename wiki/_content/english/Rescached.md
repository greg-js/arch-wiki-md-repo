...
Other programs may overwrite this setting; see [Domain_name_resolution#Overwriting_of_resolv.conf](/index.php/Domain_name_resolution#Overwriting_of_resolv.conf "Domain name resolution") for details.

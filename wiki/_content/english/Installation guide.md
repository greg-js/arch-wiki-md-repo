...
*   Ensure your [network interface](/index.php/Network_interface "Network interface") is listed and enabled, for example with [ip-link(8)](https://jlk.fjfi.cvut.cz/arch/manpages/man/ip-link.8): `# ip link` 
*   Connect to the network. Plug in the Ethernet cable or [connect to the wireless LAN](/index.php/Wireless_network_configuration "Wireless network configuration").
...
*   The connection may be verified with [ping](https://en.wikipedia.org/wiki/ping "wikipedia:ping"): `# ping archlinux.org` 
...
Choose and install a Linux-capable [boot loader](/index.php/Boot_loader "Boot loader"). If you have an Intel or AMD CPU, enable [microcode](/index.php/Microcode "Microcode") updates in addition.

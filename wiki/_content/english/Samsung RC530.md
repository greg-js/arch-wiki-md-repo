...
```
 * do not use acpi_call ([https://aur.archlinux.org/packages.php?ID=39470](https://aur.archlinux.org/packages.php?ID=39470)) since it breaks hibernation/suspend with pm-utils
...
*   [1 Samsung Tools - fan-control and power-management](#Samsung_Tools_-_fan-control_and_power-management)
    *   [1.1 Description](#Description)
*   [2 Laptop Mode Tools](#Laptop_Mode_Tools)
*   [3 Optimus](#Optimus)
...
URL: [https://launchpad.net/samsung-tools](https://launchpad.net/samsung-tools)

It's a kernel extension, which can be installed via AUR: [https://aur.archlinux.org/packages.php?ID=37713](https://aur.archlinux.org/packages.php?ID=37713)

## Laptop Mode Tools

Another useful step is to install laptop-tools. Ensure that you carefully read the hdparm section.

URL: [Laptop Mode Tools](/index.php/Laptop_Mode_Tools "Laptop Mode Tools")

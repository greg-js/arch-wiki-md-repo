...
This document covers the creation of [PKGBUILDs](/index.php/PKGBUILD "PKGBUILD") for perl modules distributed over CPAN, the Comprehensive Perl Authors Network. The target audience of this document is intended to be packagers of perl modules. For Perl policies see [Perl Policy](/index.php/Perl_Policy "Perl Policy").

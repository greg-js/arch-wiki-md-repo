...
*   [4 Tips and tricks](#Tips_and_tricks)
    ...
    *   [4.3 Disable Ctrl+z in terminal](#Disable_Ctrl+z_in_terminal)
    *   [4.4 Clear the screen after logging out](#Clear_the_screen_after_logging_out)
    *   [4.5 Auto "cd" when entering just a path](#Auto_"cd"_when_entering_just_a_path)

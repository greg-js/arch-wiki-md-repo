...
One often used backend is [InfluxDB](/index.php/InfluxDB "InfluxDB"). [Enable](/index.php/Enable "Enable") and [start](/index.php/Start "Start") `influxdb.service`. The web interface is available at [http://localhost:8086/](http://localhost:8086/)

...
*   [James Barnett's Tutorials](http://statthermo.blogspot.com/p/tutorials.html) — a few basic tutorials on simulations with an organic solute. Includes how to use *gmx pdb2gmx* with a user-created molecule.
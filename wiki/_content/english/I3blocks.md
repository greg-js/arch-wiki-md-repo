[i3blocks](http://vivien.github.io/i3blocks) is an alternative status bar for the tiling wm [i3](/index.php/I3 "I3"). It's designed to replace the standard i3 status bar, i3status.

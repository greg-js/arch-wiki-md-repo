...
*   Blacklist the [nvidia](https://www.archlinux.org/packages/?name=nvidia) & [nouveau](https://www.archlinux.org/packages/?name=nouveau) modules [Kernel Modules#Blacklisting](/index.php/Kernel_Modules#Blacklisting "Kernel Modules")

**Note:** This is not meant to be installed through [pip](https://www.archlinux.org/packages/?name=pip) directly. See [Package not installable by pip #30](https://github.com/flamusdiu/python-pia/issues/30) for more information.

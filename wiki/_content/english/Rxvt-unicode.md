...
*   [4 Perl extensions](#Perl_extensions)
    ...
    *   [4.2 Yankable URLs (no mouse)](#Yankable_URLs_(no_mouse))
...
*   [5 Troubleshooting](#Troubleshooting)
    ...
    *   [5.4 My numerical keypad acts weird and generates differing output? (e.g. in vim)](#My_numerical_keypad_acts_weird_and_generates_differing_output?_(e.g._in_vim))

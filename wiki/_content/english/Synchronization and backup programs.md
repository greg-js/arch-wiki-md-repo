...
| [osync.sh](http://www.netpower.fr/osync) | [osync](https://aur.archlinux.org/packages/osync/) | Shell | rsync | rsync |  ? | Yes |  ? | Yes |  ? | No | optional [[11]](https://github.com/deajan/osync#daemon-mode) | Yes | No | BSD | Yes |

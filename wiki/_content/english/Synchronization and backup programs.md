...
| [git-annex](https://git-annex.branchable.com/) | [git-annex](https://www.archlinux.org/packages/?name=git-annex) | Haskell, git | rsync [[4]](http://git-annex.branchable.com/transferring_data/) | rsync, others [[5]](http://git-annex.branchable.com/transferring_data/) | No, but has custom non-FS metadata [[6]](https://git-annex.branchable.com/metadata/) | Yes [[7]](https://git-annex.branchable.com/transferring_data/) | Yes, content-addressable storage | Yes | **multi**directional; with git remotes [[8]](http://git-annex.branchable.com/sync/) | renames conflicting files [[9]](http://git-annex.branchable.com/automatic_conflict_resolution/) | optional, git-annex assistant | Yes | [git-annex assistant](http://git-annex.branchable.com/assistant/) | GPLv3 | macOS, Android (beta), Windows (beta) | Yes | Manage files with git |
| [osync.sh](http://www.netpower.fr/osync) | [osync](https://aur.archlinux.org/packages/osync/) | Bash, based on rsync | rsync | rsync | ? | Yes | No | Yes | **bi**directional | keeps multiple versions of a file [[10]](http://www.netpower.fr/sites/default/files/soft/html-doc/osync_v1.2.html#toc-Subsubsection-1.3.1) | optional [[11]](https://github.com/deajan/osync#daemon-mode) | Yes | No | BSD | Yes |
| [rclone](https://rclone.org/) | [rclone](https://www.archlinux.org/packages/?name=rclone) | Go | No [[12]](https://rclone.org/faq/#why-doesn-t-rclone-support-partial-transfers-binary-diffs-like-rsync) | ? | ? | ? | ? | ? | **uni**directional [[13]](https://rclone.org/faq/#can-rclone-do-bi-directional-sync) | ? | ? | Yes | [RcloneBrowser](https://github.com/mmozeiko/RcloneBrowser) | MIT | *BSD, Plan9, Solaris, Windows, macOS | Yes | Optimized for synchronization with cloud storage, behavior varies with the features supported by the remote location. |
...
| [SparkleShare](https://sparkleshare.org/) | [sparkleshare](https://www.archlinux.org/packages/?name=sparkleshare) | C#, git | Yes | AES-256 [[15]](https://github.com/hbons/SparkleShare/wiki/Client-Side-Encryption) | ? | ? | Yes | Yes | ? | ? | ? | No | Yes | GPLv3 | Windows, macOS | Yes | It can sync with any Git server over SSH. |
| [Syncany](https://www.syncany.org/) | [syncany](https://aur.archlinux.org/packages/syncany/) | Java | ? | ? | ? | ? | ? | ? | ? | ? | ? | Yes | Yes | GPLv3 | No [[16]](https://github.com/syncany/syncany/graphs/contributors) |
| [Syncthing](/index.php/Syncthing "Syncthing") | [syncthing](https://www.archlinux.org/packages/?name=syncthing) | Go | Yes [[17]](http://docs.syncthing.net/users/faq.html#is-synchronization-fast) | Yes [[18]](http://docs.syncthing.net/users/security.html) | partial [[19]](http://docs.syncthing.net/users/faq.html#what-things-are-synced) | Yes | ? | Yes [[20]](http://docs.syncthing.net/users/versioning.html), previous versions moved to archive folder | **multi**directional | renames one file [[21]](https://docs.syncthing.net/users/faq.html#what-if-there-is-a-conflict) | Yes | Yes | Web, GTK | MPL v2 | BSD, Windows, macOS, Android, Kindle Paperwhite | Yes | P2P sync |
...
| [taskd](/index.php/Taskd "Taskd") | [taskd](https://www.archlinux.org/packages/?name=taskd) | C++, Python | Yes | Yes | ? | Yes | ? | ? | **multi**directional | ? | No | Yes | No | MIT | Android | Yes |
| [Unison](/index.php/Unison "Unison") | [unison](https://www.archlinux.org/packages/?name=unison) | OCaml | Yes | Yes | partial [[22]](http://www.cis.upenn.edu/~bcpierce/unison/download/releases/stable/unison-manual.html#perms) | optional [[23]](http://www.cis.upenn.edu/~bcpierce/unison/download/releases/stable/unison-manual.html#speeding) | No | Yes [[24]](http://www.cis.upenn.edu/~bcpierce/unison/download/releases/stable/unison-manual.html#backups) | **bi**directional | interactive | No | Yes | GTK2 | GPL | FreeBSD, Windows, macOS, Android | Yes [[25]](http://www.cis.upenn.edu/~bcpierce/unison/status.html) |
| [Zaloha.sh](/index.php/Zaloha.sh "Zaloha.sh") | bash | No | No | optional | No | No | No | **bi**directional | interactive | No | Yes | No | MIT | Windows under Cygwin | Yes [[26]](https://github.com/Fitus/Zaloha.sh/) | Small and simple |
...
| [BorgBackup](http://borgbackup.readthedocs.org/en/stable/) | [borg](https://www.archlinux.org/packages/?name=borg) [borg-bin](https://aur.archlinux.org/packages/borg-bin/) | Python, C (Cython) | lz4, zlib, lzma, zstd | AES256 | Yes | SSH | Yes [[27]](http://borgbackup.readthedocs.org/en/stable/faq.html#which-file-types-attributes-etc-are-preserved) | Yes [[28]](http://borgbackup.readthedocs.org/en/stable/usage.html#borg-mount) | Yes [[29]](http://borgbackup.readthedocs.org/en/stable/faq.html#if-a-backup-stops-mid-way-does-the-already-backed-up-data-stay-there) | Yes | Yes | third party | BSD | *BSD, macOS, Windows (Cygwin / WSL)[[30]](https://borgbackup.readthedocs.io/en/stable/#main-features) | Yes | Deduplication based on variable length chunks; support both local and SSH-based remote backup destination. |
...
| [bup](https://bup.github.io/) | [bup](https://www.archlinux.org/packages/?name=bup) [bup-git](https://aur.archlinux.org/packages/bup-git/) | C, Python, git | Yes | No | Yes | Yes | Immature | Yes [[31]](https://bup.github.io/man/bup-fuse.html) | pick up where you left off [[32]](https://github.com/bup/bup/blob/master/README.md#reasons-bup-is-awesome) | Yes | Yes | [bups](https://aur.archlinux.org/packages/bups/) | GPLv2 | NetBSD, Windows, macOS | Yes | Same storage format as git. |
| [Duplicati](http://www.duplicati.com/) | [duplicati-latest](https://aur.archlinux.org/packages/duplicati-latest/) | C# | Yes | Yes | Yes | Yes | Yes | No | Pausing only | No | Yes | Yes | LGPL | Windows, macOS | Yes |
...
| [restic](https://restic.net/) | [restic](https://www.archlinux.org/packages/?name=restic) [restic-git](https://aur.archlinux.org/packages/restic-git/) | Go | No [[33]](https://github.com/restic/restic/issues/21) | AES-256 [[34]](https://github.com/restic/restic/blob/master/doc/Design.md) | Yes | Yes | Yes [[35]](https://restic.readthedocs.io/en/latest/manual_rest.html#metadata-handling) | Yes [[36]](https://restic.readthedocs.io/en/stable/050_restore.html#restore-using-mount) | Yes [[37]](https://github.com/restic/restic/pull/310) | Yes | Yes | No [[38]](https://github.com/restic/restic/issues/60) | BSD | OpenBSD, Windows, macOS | Yes | Supports storage on various cloud services natively and through [rclone](https://www.archlinux.org/packages/?name=rclone). |
| [ZBackup](http://zbackup.org/) | [zbackup](https://aur.archlinux.org/packages/zbackup/) | C++ | LZMA, LZO | AES | Yes | Yes | ? | planned [[39]](https://github.com/zbackup/zbackup#improvements) | No | Kinda through tar | Yes | No | GPLv2 | Yes | Repository consists of immutable files. |
...
| [Back In Time](/index.php/Back_In_Time "Back In Time") | [backintime](https://aur.archlinux.org/packages/backintime/) | Python, rsync, diff | No | No | rsync | rsync | rsync | Yes | No | No | Yes [[40]](http://backintime.le-web.org/documentation/) | Yes | Qt | GPLv2 | Yes |
| [DAR](http://dar.linux.free.fr/) (Disk ARchive) | [dar](https://aur.archlinux.org/packages/dar/) | C++ | special archive format | Yes | Yes | Yes | ? | ? | ? | ? | No [[41]](http://dar.linux.free.fr/doc/Features.html) | Yes | [dargui](https://aur.archlinux.org/packages/dargui/) | GPL | FreeBSD, NetBSD, Windows, macOS | Yes |
| [Link-Backup](http://www.scottlu.com/Content/Link-Backup.html) | [link-backup](https://aur.archlinux.org/packages/link-backup/) | Python 2 | No | No | ? | SSH | ? | ? | Yes | Yes | No [[42]](http://www.scottlu.com/Content/Link-Backup.html) | Yes | No | MIT | No | It copies itself to the server. |
...
| [rsnapshot](/index.php/Rsnapshot "Rsnapshot") | [rsnapshot](https://www.archlinux.org/packages/?name=rsnapshot) | rsync | No | No | Yes | Yes | ? | ? | ? | ? | Yes [[43]](http://rsnapshot.org/rsnapshot/docs/docbook/rest.html) | Yes | No | GPLv2 | Win32 | No [[44]](https://github.com/rsnapshot/rsnapshot/issues/191) |
...
| [BackupPC](/index.php/BackupPC "BackupPC") | [backuppc](https://www.archlinux.org/packages/?name=backuppc) | Perl | Pull | Yes | No | Yes | Yes | Yes | No | Yes | ? | file-based, hard links [[45]](http://backuppc.sourceforge.net/faq/BackupPC.html#Backup-basics) | No | Web | GPLv2 | Any (no client needed) | Yes | Identical files across backups of the same or different clients are stored only once. |
| [Bacula](http://www.bacula.org) | [bacula*](https://aur.archlinux.org/packages/?K=bacula) in [AUR](/index.php/AUR "AUR") | C++ | Pull | Yes | Yes | ? | Yes | ? | ? | Yes | ? | file-based [[46]](http://burp.grke.org/why.html) | Yes | GUI, Web | AGPLv3 | Windows, macOS | Yes |
| [Bareos](/index.php/Bareos "Bareos") | [bareos*](https://aur.archlinux.org/packages/?K=bareos) in [AUR](/index.php/AUR "AUR") | C++ (Bacula fork) | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | ? | AGPLv3 | Yes |
| [burp](http://burp.grke.org) | [burp-backup](https://aur.archlinux.org/packages/burp-backup/) | librsync | Push | Yes | Yes | Yes | Yes | Yes | ? | Yes | ? | chunk-based [[47]](http://burp.grke.org/why.html) | Yes | [burp-ui](https://git.ziirish.me/ziirish/burp-ui) | AGPLv3 | Windows, macOS | Yes |
| [SafeKeep](http://safekeep.sourceforge.net/) | [safekeep](https://aur.archlinux.org/packages/safekeep/) | rdiff-backup | Pull | No | No | ? | Yes | ? | ? | ? | ? | chunk-based [[48]](http://safekeep.sourceforge.net/safekeep.html) | Yes | Yes | GPL | No | Integrates with [LVM](/index.php/LVM "LVM") and databases to create consistent backups. Bandwidth throttling. |
| [Snebu](http://www.snebu.com) | [snebu](https://aur.archlinux.org/packages/snebu/) | C | Push or Pull | Yes | No | ? | Yes | ? | ? | ? | ? | file-based [[49]](http://www.snebu.com/#_concepts) | Yes | No | GPLv3 | ? | Supports arbitrary retention schedules. |

...
| [Jotasync](http://jotasync.trixon.se/) | <small>not packaged? [search in AUR](https://aur.archlinux.org/packages/?K=jotasync)</small> | Java gui for rsync | rsync | rsync |  ? |  ? |  ? |  ? |  ? | No |  ? | limited | Swing | Apache v2 | OS X, Windows | Yes | Integrated scheduler. |
...
| [bup](https://bup.github.io/) | [bup](https://www.archlinux.org/packages/?name=bup) [bup-git](https://aur.archlinux.org/packages/bup-git/) | C, Python, git | Yes | No | Yes | Yes | Immature | Yes[[25]](https://bup.github.io/man/bup-fuse.html) | No | Yes | Yes | third party | GPLv2 | Windows, OS X, NetBSD, Solaris | Yes | Same storage format as git |
| [bups](https://github.com/emersion/bups) | [bups](https://aur.archlinux.org/packages/bups/) | bup frontend | Yes | No | Yes | Yes | Immature | Yes | No | Yes | Yes | GTK 3 | MIT | Yes |
...
| [ZBackup](http://zbackup.org/) | [zbackup](https://aur.archlinux.org/packages/zbackup/) | C++ | LZMA, LZO | AES | Yes | Yes |  ? | planned [[26]](https://github.com/zbackup/zbackup#improvements) | No | Kinda through tar | Yes | No | GPLv2 | Yes | Repository consists of immutable files. |
| Name | Installation | Implementation | Compressed storage | Encrypted storage | Delta transfer | Encrypted transfer | FS metadata | Easy access | Resumable | Handles renames | CLI | Other interfaces | Licence | Other platforms | Active | Specificity |
...
| [Back In Time](https://github.com/bit-team/backintime) | [Back In Time](/index.php/Back_In_Time "Back In Time") | Python, rsync, diff | No | No | rsync | rsync | rsync | Yes | No | No | Yes [[27]](http://backintime.le-web.org/documentation/) | No | Qt | GPL | Yes |
| [DAR](http://dar.linux.free.fr/) (Disk ARchive) | [dar](https://aur.archlinux.org/packages/dar/) | C++ | special archive format | Yes |  ? | Yes |  ? |  ? |  ? |  ? | No [[28]](http://dar.linux.free.fr/doc/Features.html) | Yes | DarGUI | GPL | Windows, Solaris, FreeBSD, NetBSD, MacOS X | Yes | Automatic backup using [cron](/index.php/Cron "Cron") is possible with [sarab](https://aur.archlinux.org/packages/sarab/). |
| [DarGUI](http://dargui.sourceforge.net/) | [dargui](https://aur.archlinux.org/packages/dargui/) | DAR front-end | Yes | Yes |  ? | Yes |  ? |  ? |  ? |  ? | No [[29]](http://dar.linux.free.fr/doc/Features.html) | No | GTK | GPL | Windows |  ? |
...
| [Link-Backup](http://www.scottlu.com/Content/Link-Backup.html) | [link-backup](https://aur.archlinux.org/packages/link-backup/) | Python | No | No |  ? | SSH |  ? |  ? | Yes | Yes | No [[30]](http://www.scottlu.com/Content/Link-Backup.html) | Yes | No | MIT | No | It copies itself to the server. |
...
| [rsnapshot](http://www.rsnapshot.org/) | [rsnapshot](/index.php/Rsnapshot "Rsnapshot") | rsync | No | No | Yes | Yes |  ? |  ? |  ? |  ? | Yes [[31]](http://rsnapshot.org/rsnapshot/docs/docbook/rest.html) | Yes | No | GPLv2 | Win32 | Yes |
...
| [BackupPC](http://backuppc.sourceforge.net/index.html) | [BackupPC](/index.php/BackupPC "BackupPC") | Perl | Yes | No | Yes | Yes | Yes | No | Yes |  ? | file-based, hard links [[32]](http://backuppc.sourceforge.net/faq/BackupPC.html#Backup-basics) | No | Web | GPLv2 | Any (no client needed) | Yes | Identical files across backups of the same or different clients are stored only once. |
| [Bacula](http://www.bacula.org) | [bacula-*](https://aur.archlinux.org/packages/?K=bacula-) in [AUR](/index.php/AUR "AUR") | C++ | Yes | Yes |  ? | Yes |  ? |  ? | Yes |  ? | file-based [[33]](http://burp.grke.org/why.html) | Yes | GUI, Web | AGPLv3 | Windows, OS X | Yes |
| [burp](http://burp.grke.org) | [burp-backup](https://aur.archlinux.org/packages/burp-backup/) | librsync | Yes | Yes | Yes | Yes |  ? |  ? |  ? |  ? | chunk-based [[34]](http://burp.grke.org/why.html) | Yes | [burp-ui](https://git.ziirish.me/ziirish/burp-ui) | AGPLv3 | Windows | Yes |
| [SafeKeep](http://safekeep.sourceforge.net/) | [safekeep](https://aur.archlinux.org/packages/safekeep/) | rdiff-backup | No | No |  ? | Yes |  ? |  ? |  ? |  ? | chunk-based [[35]](http://safekeep.sourceforge.net/safekeep.html) | Yes | No | GPL | No | Integrates with [LVM](/index.php/LVM "LVM") and databases to create consistent backups. Bandwidth throttling. |
...
*   **[Symform](http://www.symform.com)** — A peer-to-peer cloud backup service.
    ...
    *   Data is encrypted before leaving the computer, though keys are also stored on the Symform's servers.[[36]](http://virtualserverguy.com/blog/2012/12/19/symform-security-analysis)

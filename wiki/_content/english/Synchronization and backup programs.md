...
*   **Conflict prompt**: the application asks what to do in case of file conflicts (push, pull, merge).
...
| Name | Installation | Implementation | Delta transfer | Encrypted transfer | FS metadata | Resumable | Handles renames | Version control | Conflict prompt | Multidirectional | FS monitoring | CLI | Other interfaces | Licence | Other platforms | Active | Specificity |
| [BitTorrent Sync](https://www.getsync.com/) | [BitTorrent Sync](/index.php/BitTorrent_Sync "BitTorrent Sync") | Closed source | Yes |  ? |  ? |  ? |  ? |  ? |  ? |  ? |  ? | No | Web | Proprietary freemium | OS X, Windows, Android, iOS, Windows Phone, Amazon Kindle Fire, FreeBSD | Yes |
...
| [osync.sh](http://www.netpower.fr/osync) | <small>not packaged? [search in AUR](https://aur.archlinux.org/packages/?K=osync)</small> | Shell | rsync | rsync |  ? | Yes |  ? | Yes |  ? | No | optional [[11]](https://github.com/deajan/osync#daemon-mode) | Yes | No | BSD | Yes |
...
| [Syncthing](https://syncthing.net/) | [Syncthing](/index.php/Syncthing "Syncthing") | Go | Yes [[13]](http://docs.syncthing.net/users/faq.html#is-synchronization-fast) | Yes [[14]](http://docs.syncthing.net/users/security.html) | partial [[15]](http://docs.syncthing.net/users/faq.html#what-things-are-synced) |  ? |  ? | Yes [[16]](http://docs.syncthing.net/users/versioning.html) | renames one file [[17]](https://docs.syncthing.net/users/faq.html#what-if-there-is-a-conflict) | Yes |  ? | No | Web, GTK | MPL v2 | Windows, OS X, Android, BSD, Solaris | Yes |
| [Synkron](http://synkron.sourceforge.net/) | [synkron](https://aur.archlinux.org/packages/synkron/) | C++ |  ? |  ? |  ? |  ? |  ? |  ? |  ? | Yes |  ? | No | Qt | GPLv2 | Windows, OS X |  ? |
| [Unison](http://www.cis.upenn.edu/~bcpierce/unison/) | [Unison](/index.php/Unison "Unison") | OCaml | Yes | Yes | Yes [[18]](http://www.cis.upenn.edu/~bcpierce/unison/download/releases/stable/unison-manual.html#perms) | optional [[19]](http://www.cis.upenn.edu/~bcpierce/unison/download/releases/stable/unison-manual.html#speeding) | No | Yes [[20]](http://www.cis.upenn.edu/~bcpierce/unison/download/releases/stable/unison-manual.html#backups) | Yes | No | No | Yes | No | GPL | Windows, OS X, FreeBSD, Android | Yes [[21]](http://www.cis.upenn.edu/~bcpierce/unison/status.html) |
| Name | Installation | Implementation | Delta transfer | Encrypted transfer | FS metadata | Resumable | Handles renames | Version control | Conflict prompt | Multidirectional | FS monitoring | CLI | Other interfaces | Licence | Other platforms | Active | Specificity |
...
| [Attic](https://github.com/jborg/attic/) | [attic](https://aur.archlinux.org/packages/attic/) | Python | Yes | AES256 | Yes | SSH | Yes | Yes | Yes | Yes | Yes | No | BSD | Yes |
| [BorgBackup](http://borgbackup.readthedocs.org/en/stable/) | [borg](https://www.archlinux.org/packages/?name=borg) | Python (Attic fork) | lz4, zlib, lzma | AES256 | Yes | SSH | Yes[[22]](http://borgbackup.readthedocs.org/en/stable/faq.html#which-file-types-attributes-etc-are-preserved) | Yes | Yes[[23]](http://borgbackup.readthedocs.org/en/stable/faq.html#if-a-backup-stops-mid-way-does-the-already-backed-up-data-stay-there) | Yes | Yes | No | BSD | *BSD, OS X | Yes |
...
| [bup](https://bup.github.io/) | [bup](https://www.archlinux.org/packages/?name=bup) [bup-git](https://aur.archlinux.org/packages/bup-git/) | C, Python, git | No | No | Yes | Yes |  ? | [bup-fuse](https://bup.github.io/man/bup-fuse.html) |  ? |  ? | Yes | third party | GPLv2 | Windows, OS X, NetBSD, Solaris | Yes |
| [Déjà Dup](https://launchpad.net/deja-dup) | [Déjà Dup](/index.php/D%C3%A9j%C3%A0_Dup "Déjà Dup") | duplicity front-end | Yes | Yes | Yes | Yes |  ? | No |  ? |  ? | No | GTK+ | GPLv3 | Yes | Integrated into [GNOME Files](/index.php/GNOME_Files "GNOME Files"). |
...
| [Duplicity](http://www.nongnu.org/duplicity/) | [Duplicity](/index.php/Duplicity "Duplicity") | librsync | gzip | gpg | Yes | Yes |  ? | No |  ? |  ? | Yes | Déjà Dup, Duply | GPL | Yes |
| [Duply](http://www.duply.net/) | [Duply](/index.php/Duply "Duply") | duplicity front-end | Yes | Yes | Yes | Yes |  ? | No |  ? |  ? | Yes | No | GPLv2 | Yes |
| [Kup Backup System](http://kde-apps.org/content/show.php/Kup+Backup+System?content=147465) | [kup](https://www.archlinux.org/packages/?name=kup) | rsync, bup front-end | No | No | Yes | Yes |  ? | [bup-fuse](https://bup.github.io/man/bup-fuse.html) |  ? |  ? | No | Qt | GPLv2 | Yes |
| [obnam](http://liw.fi/obnam/) | [obnam](https://aur.archlinux.org/packages/obnam/) | Python | Yes | GnuPG | Yes | Yes |  ? | Yes |  ? |  ? | Yes | No | GPLv3 | Yes |
| [ZBackup](http://zbackup.org/) | [zbackup](https://aur.archlinux.org/packages/zbackup/) | C++ | LZMA, LZO | AES | Yes | Yes |  ? | planned [[24]](https://github.com/zbackup/zbackup#improvements) |  ? |  ? | Yes | No | GPLv2 | Yes | Repository consists of immutable files. |
| Name | Installation | Implementation | Compressed storage | Encrypted storage | Delta transfer | Encrypted transfer | FS metadata | Easy access | Resumable | Handles renames | CLI | Other interfaces | Licence | Other platforms | Active | Specificity |
...
| [Back In Time](https://github.com/bit-team/backintime) | [Back In Time](/index.php/Back_In_Time "Back In Time") | Python, rsync, diff | No | No | rsync | rsync | rsync | Yes | No | No | Yes [[25]](http://backintime.le-web.org/documentation/) | No | Qt | GPL | Yes |
| [DAR](http://dar.linux.free.fr/) (Disk ARchive) | [dar](https://aur.archlinux.org/packages/dar/) | C++ | special archive format | Yes |  ? | Yes |  ? |  ? |  ? |  ? | No [[26]](http://dar.linux.free.fr/doc/Features.html) | Yes | DarGUI | GPL | Windows, Solaris, FreeBSD, NetBSD, MacOS X | Yes | Automatic backup using [cron](/index.php/Cron "Cron") is possible with [sarab](https://aur.archlinux.org/packages/sarab/). |
| [DarGUI](http://dargui.sourceforge.net/) | [dargui](https://aur.archlinux.org/packages/dargui/) | DAR front-end | Yes | Yes |  ? | Yes |  ? |  ? |  ? |  ? | No [[27]](http://dar.linux.free.fr/doc/Features.html) | No | GTK | GPL | Windows |  ? |
| [hdup](http://miek.nl/projects/hdup2/) | [hdup](/index.php/Hdup "Hdup") | C | bzip, gzip, lzop | gpg |  ? | SSH |  ? | No | No | No | No | Yes | No | GPLv2 | No | Multiple backup targets. |
| [Link-Backup](http://www.scottlu.com/Content/Link-Backup.html) | [link-backup](https://aur.archlinux.org/packages/link-backup/) | Python | No | No |  ? | SSH |  ? |  ? | Yes | Yes | No [[28]](http://www.scottlu.com/Content/Link-Backup.html) | Yes | No | MIT | No | It copies itself to the server. |
...
| [rsnapshot](http://www.rsnapshot.org/) | [rsnapshot](/index.php/Rsnapshot "Rsnapshot") | rsync | No | No | Yes | Yes |  ? |  ? |  ? |  ? | Yes [[29]](http://rsnapshot.org/rsnapshot/docs/docbook/rest.html) | Yes | No | GPLv2 | Win32 | Yes |
...
| [BackupPC](http://backuppc.sourceforge.net/index.html) | [BackupPC](/index.php/BackupPC "BackupPC") | Perl | Yes | No | Yes | Yes | Yes | No | Yes |  ? | file-based, hard links [[30]](http://backuppc.sourceforge.net/faq/BackupPC.html#Backup-basics) | No | Web | GPLv2 | Any (no client needed) | Yes | Identical files across backups of the same or different clients are stored only once. |
| [Bacula](http://www.bacula.org) | [bacula-*](https://aur.archlinux.org/packages/?K=bacula-) in [AUR](/index.php/AUR "AUR") | C++ | Yes | Yes |  ? | Yes |  ? |  ? | Yes |  ? | file-based [[31]](http://burp.grke.org/why.html) | Yes | GUI, Web | AGPLv3 | Windows, OS X | Yes |
| [burp](http://burp.grke.org) | [burp-backup](https://aur.archlinux.org/packages/burp-backup/) | librsync | Yes | Yes | Yes | Yes |  ? |  ? |  ? |  ? | chunk-based [[32]](http://burp.grke.org/why.html) | Yes | [burp-ui](https://git.ziirish.me/ziirish/burp-ui) | AGPLv3 | Windows | Yes |
| [SafeKeep](http://safekeep.sourceforge.net/) | [safekeep](https://aur.archlinux.org/packages/safekeep/) | rdiff-backup | No | No |  ? | Yes |  ? |  ? |  ? |  ? | chunk-based [[33]](http://safekeep.sourceforge.net/safekeep.html) | Yes | No | GPL | No | Integrates with [LVM](/index.php/LVM "LVM") and databases to create consistent backups. Bandwidth throttling. |
...
*   **[Symform](http://www.symform.com)** — A peer-to-peer cloud backup service.
    ...
    *   Data is encrypted before leaving the computer, though keys are also stored on the Symform's servers.[[34]](http://virtualserverguy.com/blog/2012/12/19/symform-security-analysis)

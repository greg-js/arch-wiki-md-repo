...
**Warning:** The `ffodivxvdpau` codec is only supported by the most recent series of NVIDIA hardware. Consider omitting it based on your specific hardware. See [NVIDIA#NVDEC and VDPAU](/index.php/NVIDIA#NVDEC_and_VDPAU "NVIDIA") for more information.

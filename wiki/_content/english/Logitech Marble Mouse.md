...
*   [2 Sample Configurations](#Sample_Configurations)
    *   [2.1 libinput](#libinput)
*   [3 Basic function](#Basic_function)
*   [4 Configuration](#Configuration)
    *   [4.1 Buttons and trackball](#Buttons_and_trackball)
        *   [4.1.1 Assigning buttons](#Assigning_buttons)
        *   [4.1.2 "Both-large-buttons" combination-click](#"Both-large-buttons"_combination-click)
        *   [4.1.3 Scroll modifier](#Scroll_modifier)
    *   [4.2 Right-side or left-side](#Right-side_or_left-side)
    *   [4.3 System-wide or per-user](#System-wide_or_per-user)
    *   [4.4 Xorg input hotplugging](#Xorg_input_hotplugging)
    *   [4.5 Without Xorg hotplugging](#Without_Xorg_hotplugging)
    *   [4.6 Gnome 3 and Wayland](#Gnome_3_and_Wayland)
        *   [4.6.1 Mouse wheel emulation](#Mouse_wheel_emulation)
        *   [4.6.2 Acceleration profile](#Acceleration_profile)
*   [5 Sample configuration](#Sample_configuration)
    *   [5.1 Configuration file](#Configuration_file)
    *   [5.2 Restarting X](#Restarting_X)
*   [6 Minimal configuration](#Minimal_configuration)
    *   [6.1 Using evdev](#Using_evdev)
*   [7 Additional tweaks](#Additional_tweaks)
    *   [7.1 Console (gpm)](#Console_(gpm))
    *   [7.2 Chromium browser](#Chromium_browser)
    *   [7.3 Firefox browser](#Firefox_browser)
*   [8 See also](#See_also)

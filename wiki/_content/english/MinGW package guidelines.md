...
*   consider using compilation flags `-D_FORTIFY_SOURCE=2 -O2 -pipe -fstack-protector-strong -fno-plt -fexceptions --param=ssp-buffer-size=4` (usually named CFLAGS, CXXFLAGS) when no proper build system is provided

...
[Pam fprint - fprint project](http://reactivated.net/fprint/wiki/Pam_fprint) пише:
	...
	_pam_fprint е модула за PAM, която използва обработката на пръстови отпечатъци на libfprint и го използва за вписване в системата. С други думи, вмешсто да вкарвате парола, трябва да си сканирате пръста._

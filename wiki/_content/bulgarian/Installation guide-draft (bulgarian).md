...
Следните [дялове](/index.php/Partition "Partition") са **необходими** за избраното устройство:
...
Щом дяловете са създадени, всеки трябва да бъде форматиран в съответната [файлова система](/index.php/File_system "File system"). Например, за да форматирате дяла root на `/dev/sd*x*2` с `*ext4*`, използвайте:
...
Ако сте променили подредбата на [конзолната клавиатура](#.D0.98.D0.B7.D0.B1.D0.B5.D1.80.D0.B5.D1.82.D0.B5_.D0.BA.D0.BB.D0.B0.D0.B2.D0.B8.D0.B0.D1.82.D1.83.D1.80.D0.BD.D0.B0_.D0.BF.D0.BE.D0.B4.D1.80.D0.B5.D0.B4.D0.B1.D0.B0), може да направите промените постоянни във [vconsole.conf(5)](https://jlk.fjfi.cvut.cz/arch/manpages/man/vconsole.conf.5):
...
За [LVM](/index.php/LVM#Configure_mkinitcpio "LVM"), [full-disk encryption](/index.php/Dm-crypt/Encrypting_an_entire_system "Dm-crypt/Encrypting an entire system") или [RAID](/index.php/RAID#Configure_mkinitcpio "RAID"), променете [mkinitcpio.conf(5)](https://jlk.fjfi.cvut.cz/arch/manpages/man/mkinitcpio.conf.5) и създайте отново initramfs образа:
...
Вижте [Arch boot process#Boot loader](/index.php/Arch_boot_process#Boot_loader "Arch boot process") за списък със Linux съвместими „буут лоудъри“.

**Note:** Ако разполагате с Intel или AMD процесор, включете [microcode](/index.php/Microcode "Microcode") обновления.

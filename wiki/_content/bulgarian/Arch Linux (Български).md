...
Простата система init на Arch е дълбоко вдъхновена от начина на *BSD да инкорпорира заявки чрез _един файл_ ([rc.conf](/index.php/Rc.conf "Rc.conf")) вместо от сложна директорна структура с мнозина символични връзки за всеки runlevel.

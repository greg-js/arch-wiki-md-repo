...
*   [1 Преди инсталацията](#Преди_инсталацията)
    *   [1.1 Изберете клавиатурна подредба](#Изберете_клавиатурна_подредба)
    *   [1.2 Проверете boot режима](#Проверете_boot_режима)
    *   [1.3 Свързване с интернет](#Свързване_с_интернет)
    *   [1.4 Обновяване на системния часовник](#Обновяване_на_системния_часовник)
    *   [1.5 Разделяне на дялове](#Разделяне_на_дялове)
    *   [1.6 Форматиране на дяловете](#Форматиране_на_дяловете)
    *   [1.7 Включване на файловите системи](#Включване_на_файловите_системи)

...
*   تثبيت حزمة لغة واحدة مطلوب. اللغة الافتراضية هي الأفريكانية (لأنّها (أبجديًّا المُوفِّر الأولّ لِـ libreoffice-langpack). إن أردتَ حزمة الأمريكية الإنجليزية (en-US)، ثبّت [libreoffice-en-GB](https://www.archlinux.org/packages/?name=libreoffice-en-GB)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): package not found]</sup>، وليس [libreoffice-uk](https://www.archlinux.org/packages/?name=libreoffice-uk)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): package not found]</sup> (الأوكرانية) أو [libreoffice-br](https://www.archlinux.org/packages/?name=libreoffice-br)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): package not found]</sup> (البريتونية)!
*   حزمتي [libreoffice-still-kde4](https://www.archlinux.org/packages/?name=libreoffice-still-kde4)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): package not found]</sup> و [libreoffice-still-gnome](https://www.archlinux.org/packages/?name=libreoffice-still-gnome)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): package not found]</sup> مطلوبتان للتكامل البصري مع كيوت وجتك+ بالترتيب. طالع قسم [السمة](#Theme).
...
Check the optional dependencies pacman displays. A Java Runtime Environment is not required unless you want to use Libreoffice Base: see [Java](/index.php/Java "Java"). You may need [hsqldb2-java](https://aur.archlinux.org/packages/hsqldb2-java/)<sup><small>AUR</small></sup> to use [some modules](https://wiki.documentfoundation.org/Base#Java_and_HSQLDB) in LibreOffice Base.

## السمة

لتكامل [Qt](/index.php/Qt "Qt")، ثبّت الحزمة [libreoffice-still-kde4](https://www.archlinux.org/packages/?name=libreoffice-still-kde4)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): package not found]</sup>. لتكامل [GTK+](/index.php/GTK%2B "GTK+")، ثبّت الحزمة [libreoffice-still-gnome](https://www.archlinux.org/packages/?name=libreoffice-still-gnome)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): package not found]</sup>.
...
للتدقيق النحوي، ستحتاج إلى تثبيت امتداد مثل LanguageTool، حيث تجدها في [AUR](/index.php/AUR "AUR"): [libreoffice-extension-languagetool](https://aur.archlinux.org/packages/libreoffice-extension-languagetool/)<sup><small>AUR</small></sup> أو [موقع وِب LanguageTool](http://www.languagetool.org/).
...
للمستخدمين الفنلديين، هناك أربع حزم لتثبيتها. ثبّتها بهذا الترتيب: [malaga](https://aur.archlinux.org/packages/malaga/)<sup><small>AUR</small></sup>، و[suomi-malaga-voikko](https://aur.archlinux.org/packages/suomi-malaga-voikko/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/suomi-malaga-voikko)]</sup>، و[libvoikko](https://www.archlinux.org/packages/?name=libvoikko) و [voikko-libreoffice](https://aur.archlinux.org/packages/voikko-libreoffice/)<sup><small>AUR</small></sup>.

### مساعدة الإنجليزية الأمريكية (en-US) دون الإنترنت

حزم الإنجليزية الأمريكية في المستودعات الرسمية لا تحوي ملفات المساعدة التي تعمل دون الإنترنت. للمستخديم الراغبين بهذه المساعدة عليه تثبيت حزمة [libreoffice-still-en-us-help](https://aur.archlinux.org/packages/libreoffice-still-en-us-help/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/libreoffice-still-en-us-help)]</sup> أو [libreoffice-fresh-en-us-help](https://aur.archlinux.org/packages/libreoffice-fresh-en-us-help/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/libreoffice-fresh-en-us-help)]</sup> من [مستودع مستخدم آرتش](/index.php?title=AUR_(%D8%A7%D9%84%D8%B9%D8%B1%D8%A8%D9%8A%D8%A9)&action=edit&redlink=1 "AUR (العربية) (page does not exist)").
...
**ملاحظة:** يجب أن تكون الحزمة [libreoffice-still-gnome](https://www.archlinux.org/packages/?name=libreoffice-still-gnome)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): package not found]</sup> مثبّتة ليتوفّر خيار التشغيل السريع.
...
ثبّت [libreoffice-base](https://www.archlinux.org/packages/?name=libreoffice-base)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): package not found]</sup> للالتفاف حول علّة معروفة، يظهر أنها [أُصلِحت](http://cgit.freedesktop.org/libreoffice/core/commit/?id=1889c1af41650576a29c587a0b2cdeaf0d297587).
...
إن لم يتغيّر حجم محتوى نافذة ليبر أوفيس معه تحت Xfce (أو باستخدام Xfwm4 فقط)، مثل هذا المنشور: [[1]](https://bbs.archlinux.org/viewtopic.php?id=133137). ثبّت [libreoffice-still-gnome](https://www.archlinux.org/packages/?name=libreoffice-still-gnome)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): package not found]</sup> لحلّ هذه المشكلة.

### gvfs mounts

إن احتجت إلى فتح/حفظ المستندات على gvfs mounts، سيكون عليك تثبيت الحزمة [libreoffice-still-gnome](https://www.archlinux.org/packages/?name=libreoffice-still-gnome)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): package not found]</sup>.

Retrieved from "[https://wiki.archlinux.org/index.php?title=LibreOffice_(العربية)&oldid=412818](https://wiki.archlinux.org/index.php?title=LibreOffice_(العربية)&oldid=412818)"

[Categories](/index.php/Special:Categories "Special:Categories"):

*   [About Arch (العربية)](/index.php/Category:About_Arch_(%D8%A7%D9%84%D8%B9%D8%B1%D8%A8%D9%8A%D8%A9) "Category:About Arch (العربية)")

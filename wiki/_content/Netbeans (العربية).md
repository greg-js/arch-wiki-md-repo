...
*   أو قم بتنصيب الحزمة الناقصة ([libungif](https://www.archlinux.org/packages/?name=libungif)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): package not found]</sup>), ومن ثم سيعمل NetBeans كالمعتاد.

Retrieved from "[https://wiki.archlinux.org/index.php?title=Netbeans_(العربية)&oldid=413926](https://wiki.archlinux.org/index.php?title=Netbeans_(العربية)&oldid=413926)"

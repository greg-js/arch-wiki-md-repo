...
*   Если вы желаете просмотреть весь текущий трафик исходящие из специфичного адреса, то используйте следующий фильтр: `ip.dst == _1.2.3.4_`.
*   Для просмотра входящего трафика, используя специфичный адрес: `ip.src == _1.2.3.4_`.
*   Для просмотра исходящего трафика: `ip.addr == _1.2.3.4_`.

Вместо `_1.2.3.4_` подставьте нужный вам ip-адрес.

Retrieved from "[https://wiki.archlinux.org/index.php?title=Wireshark_(Русский)&oldid=416242](https://wiki.archlinux.org/index.php?title=Wireshark_(Русский)&oldid=416242)"

...
*   [2 Konfigurace](#Konfigurace)
    *   [2.1 Touchpad/Synaptics](#Touchpad/Synaptics)
    *   [2.2 Grafická karta a ovladače](#Grafická_karta_a_ovladače)
        *   [2.2.1 Uživatelé karet Nvidia](#Uživatelé_karet_Nvidia)
    *   [2.3 Nastavení monitoru](#Nastavení_monitoru)
        *   [2.3.1 Karty Nvidia](#Karty_Nvidia)
        *   [2.3.2 Na začátek](#Na_začátek)
        *   [2.3.3 Více monitorů/Dual screen](#Více_monitorů/Dual_screen)
        *   [2.3.4 TwinView](#TwinView)
            *   [2.3.4.1 Více než jedna grafická karta](#Více_než_jedna_grafická_karta)
    *   [2.4 Vypnutí automatického přidávání zařízení (hot plugging)](#Vypnutí_automatického_přidávání_zařízení_(hot_plugging))
    *   [2.5 InputClass](#InputClass)
        *   [2.5.1 Ukázkové konfigurace](#Ukázkové_konfigurace)
            *   [2.5.1.1 Příklad: Emulace kolečka (pro Trackpoint)](#Příklad:_Emulace_kolečka_(pro_Trackpoint))
            *   [2.5.1.2 Příklad: Kliknutí po ťuknutí (tap to click)](#Příklad:_Kliknutí_po_ťuknutí_(tap_to_click))
            *   [2.5.1.3 Příklad: Rozložení a model klávesnice na laptopu Acer 5920G](#Příklad:_Rozložení_a_model_klávesnice_na_laptopu_Acer_5920G)
    *   [2.6 Velikost displeje a DPI](#Velikost_displeje_a_DPI)
    *   [2.7 Nastavení klávesnice](#Nastavení_klávesnice)
        *   [2.7.1 Nastavení rozložení klávesnice s hot pluggingem](#Nastavení_rozložení_klávesnice_s_hot_pluggingem)
        *   [2.7.2 Nastavení rozložení klávesnice bez hot pluggingu (zavrhováno)](#Nastavení_rozložení_klávesnice_bez_hot_pluggingu_(zavrhováno))
        *   [2.7.3 Přepínání mezi rozloženími klávesnice](#Přepínání_mezi_rozloženími_klávesnice)
        *   [2.7.4 Trvalé vypnutí mousekeys (myš na klávesnici)](#Trvalé_vypnutí_mousekeys_(myš_na_klávesnici))
    *   [2.8 DPMS](#DPMS)
    *   [2.9 Proprietární ovladače](#Proprietární_ovladače)
*   [3 Spouštění Xorg](#Spouštění_Xorg)
*   [4 Tipy a triky](#Tipy_a_triky)
    *   [4.1 X startup (/usr/bin/startx) tweaking](#X_startup_(/usr/bin/startx)_tweaking)
    *   [4.2 Virtual X session](#Virtual_X_session)
    *   [4.3 Nested X session](#Nested_X_session)
*   [5 Troubleshooting](#Troubleshooting)
    *   [5.1 Common problems](#Common_problems)
    *   [5.2 Ctrl-Alt-Backspace doesn't work](#Ctrl-Alt-Backspace_doesn't_work)
    ...
    *   [5.6 X clients started with "su" fail](#X_clients_started_with_"su"_fail)
    *   [5.7 Missing libraries](#Missing_libraries)
    *   [5.8 Packages fail to build; missing X11 includes](#Packages_fail_to_build;_missing_X11_includes)
    *   [5.9 Program requests "font '(null)'"](#Program_requests_"font_'(null)'")

...
Ако је потребно, замените `~/.ssh/id_dsa` са `~/.ssh/id_rsa`. За оне који не користе non-Bash компатибилну љуску, погледати `keychain --help` или [keychain(1)](http://jlk.fjfi.cvut.cz/arch/manpages/man/keychain.1) за детаље о другим љускама.

...
Конфигурациони фајл за sudo је `/etc/sudoers`. **Овај фајл се не треба директно едитовати!** Корисници морају да покрену команду `visudo` као root, која отвара привремену копију конфигурационог фајла у _$EDITOR_ и проверава синтаксу привремене копије пре чувања праве.
...
Подразумевани едитор је _vi_. Ако је коршћење _vi_ тешко, покрените ову команду прво:
...
и/или да дозволите члану [group](/index.php/Groups "Groups") wheel sudo приступ који не захтева шифру:
...
**Warning:** Уверите се да је корисник правилно конфигурисан као sudoer _пре_ онемогућавања root налога!

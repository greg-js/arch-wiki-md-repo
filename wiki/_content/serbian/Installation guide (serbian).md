...
*   [1 О овом водичу](#О_овом_водичу)
*   [2 Кратак преглед](#Кратак_преглед)
*   [3 Увод](#Увод)
    *   [3.1 Шта је Arch Linux?](#Шта_је_Arch_Linux?)
    *   [3.2 Лиценца](#Лиценца)
    *   [3.3 Аутори и коментари](#Аутори_и_коментари)
*   [4 Инсталација Arch Linux-а](#Инсталација_Arch_Linux-а)
    *   [4.1 Пре инсталације](#Пре_инсталације)
        *   [4.1.1 Шта вам све треба](#Шта_вам_све_треба)
        *   [4.1.2 Набавка Arch Linux-а](#Набавка_Arch_Linux-а)
        *   [4.1.3 Припрема инсталационог медијума](#Припрема_инсталационог_медијума)
            *   [4.1.3.1 Инсталација са дискете](#Инсталација_са_дискете)
            *   [4.1.3.2 Инсталација са CD-а](#Инсталација_са_CD-а)
    *   [4.2 Употреба CD-ROM-а](#Употреба_CD-ROM-а)
    *   [4.3 Употреба дискета](#Употреба_дискета)
    *   [4.4 Заједнички део инсталације](#Заједнички_део_инсталације)
        *   [4.4.1 Учитавање алтернативних тастатурних мапа](#Учитавање_алтернативних_тастатурних_мапа)
        *   [4.4.2 Покретање инсталације](#Покретање_инсталације)
        *   [4.4.3 Конфигурација мреже: Configure Network (само за FTP инсталацију)](#Конфигурација_мреже:_Configure_Network_(само_за_FTP_инсталацију))
        *   [4.4.4 Припрема хард диска: Prepare Hard Drive](#Припрема_хард_диска:_Prepare_Hard_Drive)
        *   [4.4.5 Партиционисање хард дискова: Partition Hard Drives](#Партиционисање_хард_дискова:_Partition_Hard_Drives)
        *   [4.4.6 Постављање прикључака фајлсистема: Set Filesystem Mountpoints](#Постављање_прикључака_фајлсистема:_Set_Filesystem_Mountpoints)
        *   [4.4.7 Одабир пакета: Select packages](#Одабир_пакета:_Select_packages)
        *   [4.4.8 Инсталација пакета: Install Packages](#Инсталација_пакета:_Install_Packages)
...
*   [5 System Configuration](#System_Configuration)
    *   [5.1 Configuration Files](#Configuration_Files)
        *   [5.1.1 Листа конфигурационих фајлова](#Листа_конфигурационих_фајлова)
        *   [5.1.2 /etc/rc.conf](#/etc/rc.conf)
        ...
        *   [5.1.3 /boot/grub/menu.lst](#/boot/grub/menu.lst)
        *   [5.1.4 /etc/lilo.conf](#/etc/lilo.conf)
        *   [5.1.5 /etc/mkinitrd.conf](#/etc/mkinitrd.conf)
        *   [5.1.6 /etc/hosts](#/etc/hosts)
        *   [5.1.7 /etc/fstab](#/etc/fstab)
        *   [5.1.8 /etc/modprobe.d/modprobe.conf](#/etc/modprobe.d/modprobe.conf)
        *   [5.1.9 /etc/modules.conf](#/etc/modules.conf)
        *   [5.1.10 /etc/resolv.conf](#/etc/resolv.conf)
        *   [5.1.11 /etc/conf.d/*](#/etc/conf.d/*)
        *   [5.1.12 /etc/profile](#/etc/profile)
...
Ако не дижете систем са инсталационог CD-а, прекочите овај одељак и сместа пређите на [упутства за инсталацију са дискета](#Употреба_дискета). Ако познајете поступак подизања система, такође можете прескочити ово разглабање и прећи на [Уобичајен поступак за инсталацију](#Уобичајен_поступак_за_инсталацију) у којем се обрађује сама инсталација Arch Linux система.

...
*   [1 Образложење](#Образложење)
*   [2 Инсталација](#Инсталација)
*   [3 Коришћење](#Коришћење)
*   [4 Конфигурација](#Конфигурација)
    *   [4.1 sudoers подразумеване дозволе над фајловима](#sudoers_подразумеване_дозволе_над_фајловима)
    *   [4.2 Коришћење visudo](#Коришћење_visudo)
    *   [4.3 Тајмаут кеш лозинке](#Тајмаут_кеш_лозинке)
*   [5 Савети и трикови](#Савети_и_трикови)
    *   [5.1 Омогућити завршетак табом у bash-u](#Омогућити_завршетак_табом_у_bash-u)
    *   [5.2 Онемогући per-terminal sudo](#Онемогући_per-terminal_sudo)
    *   [5.3 Променљиве околине (Застарело?)](#Променљиве_околине_(Застарело?))
    *   [5.4 Додајте /sbin и /usr/sbin у root путању](#Додајте_/sbin_и_/usr/sbin_у_root_путању)
    *   [5.5 Пренос псеудонима](#Пренос_псеудонима)
    *   [5.6 Увреде](#Увреде)
    *   [5.7 Root шифра](#Root_шифра)
    *   [5.8 Онемогући root логин](#Онемогући_root_логин)
        *   [5.8.1 kdesu](#kdesu)
*   [6 Sudo отклањање грешака](#Sudo_отклањање_грешака)
    *   [6.1 SSH TTY проблеми](#SSH_TTY_проблеми)
    *   [6.2 Приказивање корисничких привилегија](#Приказивање_корисничких_привилегија)
*   [7 Sudoers пример](#Sudoers_пример)
...
Кориснику неће бити дозвољено да покреће sudo уколико није експлицитно дозвољено у /etc/sudoers фајлу. Погледај [#Конфигурација](#Конфигурација) за упутства.

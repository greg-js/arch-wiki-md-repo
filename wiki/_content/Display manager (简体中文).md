...
*   [KDM](/index.php/KDM "KDM"): [KDE](/index.php/KDE_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87) "KDE (简体中文)")4 显示管理器 ([kdebase-workspace](https://aur.archlinux.org/packages/kdebase-workspace/)<sup><small>AUR</small></sup>)(已经停止开发).
...
安装 [xinit-xsession](https://aur.archlinux.org/packages/xinit-xsession/)<sup><small>AUR</small></sup> 后会在显示管理器中提供一个运行 .xinitrc 会话的选项。

### 没有窗口管理启动应用程序

您也可以启动没有窗口修饰、桌面或窗口管理器的会话。例如要启动 [google-chrome](https://aur.archlinux.org/packages/google-chrome/)<sup><small>AUR</small></sup>，在`/usr/share/xsessions/`中创建`web-browser.desktop`：
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Display_manager_(简体中文)&oldid=413645](https://wiki.archlinux.org/index.php?title=Display_manager_(简体中文)&oldid=413645)"

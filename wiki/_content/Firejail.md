...
For most applications launched from the console, or from .desktop files, you can place your own launcher proxies for each in /usr/local/bin. For example, to create one for firefox, create /usr/share/bin/firefox:
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Firejail&oldid=410964](https://wiki.archlinux.org/index.php?title=Firejail&oldid=410964)"

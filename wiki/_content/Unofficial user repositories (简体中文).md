# Unofficial user repositories (简体中文)
...
**Reason:** Please fill in the missing information about repository maintainers. (Discuss in [Talk:Unofficial user repositories (简体中文)#](https://wiki.archlinux.org/index.php/Talk:Unofficial_user_repositories_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87)))
...
*   **描述：** AUR packages that would take long to build, such as [firefox-kde-opensuse](https://aur.archlinux.org/packages/firefox-kde-opensuse/)<sup><small>AUR</small></sup>.
*   **Key-ID:** 3E37398D
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Unofficial_user_repositories_(简体中文)&oldid=413064](https://wiki.archlinux.org/index.php?title=Unofficial_user_repositories_(简体中文)&oldid=413064)"

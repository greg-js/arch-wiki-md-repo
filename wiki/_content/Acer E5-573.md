...
*   [3 Unsupported Hardware](#Unsupported_Hardware)
...
As of December, 2015, kernel 4.2.5-1-ARCH, the built in Bluetooth seems not to be supported. All the rest works fine.
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Acer_E5-573&oldid=411271](https://wiki.archlinux.org/index.php?title=Acer_E5-573&oldid=411271)"

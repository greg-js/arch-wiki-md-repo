...
This page assumes that you will be using it for additional reference to [Beginners' guide](/index.php/Beginners%27_guide "Beginners' guide") and [Acer Aspire One](/index.php/Acer_Aspire_One "Acer Aspire One"). Note that this netbook does **not** come with Recovery CDs.

## Contents

*   [1 Hardware Information for Potential Buyers](#Hardware_Information_for_Potential_Buyers)
    *   [1.1 lspci](#lspci)
    *   [1.2 lsusb](#lsusb)
    *   [1.3 lsmod](#lsmod)
    *   [1.4 Wired and Wireless Networking](#Wired_and_Wireless_Networking)
    *   [1.5 Bluetooth](#Bluetooth)
*   [2 Not Losing Android](#Not_Losing_Android)
    *   [2.1 Quick Review](#Quick_Review)
    *   [2.2 Details](#Details)
*   [3 CPUFREQ and Wrong CPU Freq Reporting](#CPUFREQ_and_Wrong_CPU_Freq_Reporting)
*   [4 Mounting Android from Linux as a Loop Device](#Mounting_Android_from_Linux_as_a_Loop_Device)
...
Works out of the box (don't forget to turn it on using the bluetooth button). See [Bluetooth](/index.php/Bluetooth "Bluetooth").
...
6\. Have Arch be the default OS to boot for NTLDR: use **msconfig** to set the default entry (find the BOOT.INI tab, click on the line that says, for example, _c:\arch.mbr="Arch Linux"_, and click on "Set as Default". You may also want to change the time out value for NTLDR, see [http://vlaurie.com/computers2/Articles/bootini.htm](http://vlaurie.com/computers2/Articles/bootini.htm) which has nice screenshots on various things to do with the bootloader.

## CPUFREQ and Wrong CPU Freq Reporting

When you load acpi-cpufreq to do cpu frequency scaling, the maximum CPU speed becomes 1.33GHz instead of 1.66Ghz. There is no workaround for this at time of writing except not using said module, which is not helpful in terms of saving power (battery life for the session). See [https://bugs.launchpad.net/ubuntu/+source/cpufreqd/+bug/422858](https://bugs.launchpad.net/ubuntu/+source/cpufreqd/+bug/422858)
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Acer_AOD250-1613&oldid=298162](https://wiki.archlinux.org/index.php?title=Acer_AOD250-1613&oldid=298162)"
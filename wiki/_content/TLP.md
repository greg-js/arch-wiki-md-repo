...
[Install](/index.php/Pacman "Pacman") [tlp](https://www.archlinux.org/packages/?name=tlp) from the [official repositories](/index.php/Official_repositories "Official repositories") - pay attention to its optional dependencies that may help provide additional power saving.
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=TLP&oldid=405760](https://wiki.archlinux.org/index.php?title=TLP&oldid=405760)"

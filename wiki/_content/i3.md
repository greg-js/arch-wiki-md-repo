...
In many cases, bugs are fixed in the development versions [i3-git](https://aur.archlinux.org/packages/i3-git/)<sup><small>AUR</small></sup> and [i3status-git](https://aur.archlinux.org/packages/i3status-git/)<sup><small>AUR</small></sup>, and upstream will ask to reproduce any errors with this version. [[11]](http://i3wm.org/docs/debugging.html) See also [Debug - Getting Traces#General](/index.php/Debug_-_Getting_Traces#General "Debug - Getting Traces").
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=I3&oldid=415702](https://wiki.archlinux.org/index.php?title=I3&oldid=415702)"

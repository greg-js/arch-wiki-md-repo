...
**Reason:** More methods must be listed, but the actual content should be put in application-specific articles and only linked from here. (Discuss in [Talk:Screencast#](https://wiki.archlinux.org/index.php/Talk:Screencast))

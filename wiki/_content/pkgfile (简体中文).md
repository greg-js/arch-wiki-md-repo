...
*   [Bash#The_"command_not_found"_hook](/index.php/Bash#The_.22command_not_found.22_hook "Bash") - A section comparing [pkgfile](https://www.archlinux.org/packages/?name=pkgfile) and [command-not-found](https://aur.archlinux.org/packages/command-not-found/)<sup><small>AUR</small></sup>

Retrieved from "[https://wiki.archlinux.org/index.php?title=Pkgfile_(简体中文)&oldid=411600](https://wiki.archlinux.org/index.php?title=Pkgfile_(简体中文)&oldid=411600)"

...
可以从 AUR 上下载[enlightenment17-git](https://aur.archlinux.org/packages/enlightenment17-git/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/enlightenment17-git)]</sup>得到最新的 SVN 版源码及其依赖的包构建文件（PKGBUILDs）。
...
Enlightenment 现在提供了新的显示管理器 Entrance，可以通过 [entrance-git](https://aur.archlinux.org/packages/entrance-git/)<sup><small>AUR</small></sup> 软件包从 [AUR](/index.php/AUR "AUR") 安装。通过 `/etc/entrance.conf` 配置。要使用entrance：
...
更高级一点的显示管理器，比如 [GDM](/index.php/GDM "GDM") 和 [KDM](/index.php/KDM "KDM") 会自动检测到 E17。这多亏了 [enlightenment17](https://www.archlinux.org/packages/?name=enlightenment17)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): package not found]</sup> 软件包里的 `/usr/share/xsessions/enlightenment.desktop` 文件。

## 配置网络

### connman

E17 推荐的网络管理器是 [Connman](/index.php/Connman "Connman")，可以通过 [community] 软件仓库中的[connman](https://www.archlinux.org/packages/?name=connman)软件包进行安装。}} 。为了与 Enlightenment 的默认网络模块交互工作，需要安装[AUR](/index.php/AUR "AUR") 中的 [econnman](https://aur.archlinux.org/packages/econnman/)<sup><small>AUR</small></sup> 或 [econnman-git](https://aur.archlinux.org/packages/econnman-git/)<sup><small>AUR</small></sup>。
...
*   [exchange.enlightenment.org](http://exchange.enlightenment.org) ，你可以使用 AUR 的 [e17-themes](https://aur.archlinux.org/packages/e17-themes/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/e17-themes)]</sup> 来安装上面的内容。
...
**Note:** 在[extra]中这个模块已非必要。如果需要，应当安装 AUR 中的[comp-scale-svn](https://aur.archlinux.org/packages/comp-scale-svn/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/comp-scale-svn)]</sup>
...
Available from [engage-svn](https://aur.archlinux.org/packages/engage-svn/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/engage-svn)]</sup>
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Enlightenment_(简体中文)&oldid=412802](https://wiki.archlinux.org/index.php?title=Enlightenment_(简体中文)&oldid=412802)"

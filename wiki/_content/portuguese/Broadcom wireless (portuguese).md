...
Desde o kernel 3.3.1, o módulo **bcma** foi introduzido. Se estiver usando um driver **brcm80211**, certifique-se de que ele não esteja em [lista negra](/index.php/Kernel_module_(Portugu%C3%AAs)#Adicionar_um_módulo_em_uma_lista_negra_(Blacklisting) "Kernel module (Português)"). Deve ser negado se usar um driver **b43**.

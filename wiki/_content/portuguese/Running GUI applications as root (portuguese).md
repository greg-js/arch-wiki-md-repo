**Status de tradução:** Esse artigo é uma tradução de [Running GUI applications as root](/index.php/Running_GUI_applications_as_root "Running GUI applications as root"). Data da última tradução: 2019-03-21\. Você pode ajudar a sincronizar a tradução, se houver [alterações](https://wiki.archlinux.org/index.php?title=Running_GUI_applications_as_root&diff=0&oldid=569367) na versão em inglês.

...
Este documento cobre a criação de [PKGBUILDs](/index.php/PKGBUILD_(Portugu%C3%AAs) "PKGBUILD (Português)") para módulos perl distribuídos pelo CPAN, a Comprehensive Perl Authors Network. Este documento tem como público-alvo aqueles que deseja empacotar módulos perl. Para as políticas do Perl, veja [Políticas do Perl](/index.php/Perl_Policy "Perl Policy").

## Contents

*   [1 Convenções de empacotamento do Arch Linux](#Convenções_de_empacotamento_do_Arch_Linux)
    *   [1.1 Nomes de pacotes](#Nomes_de_pacotes)
    *   [1.2 Colocação de arquivos no pacote](#Colocação_de_arquivos_no_pacote)
    *   [1.3 Arquitetura](#Arquitetura)
    *   [1.4 Automação](#Automação)
*   [2 Exemplos de PKGBUILD](#Exemplos_de_PKGBUILD)
*   [3 Mecanismos de módulo CPAN](#Mecanismos_de_módulo_CPAN)
    *   [3.1 Módulos](#Módulos)
    *   [3.2 Distribuições](#Distribuições)
    *   [3.3 CPAN](#CPAN)
    *   [3.4 Dependências de módulos](#Dependências_de_módulos)
    *   [3.5 Definição de dependências](#Definição_de_dependências)
    *   [3.6 Informações meta](#Informações_meta)
*   [4 Módulos instaláveis](#Módulos_instaláveis)
    ...
    *   [4.5 Variáveis de ambiente](#Variáveis_de_ambiente)
...
*   [5 Problemas com perl instalado pelo usuário](#Problemas_com_perl_instalado_pelo_usuário)

## Convenções de empacotamento do Arch Linux

As seguintes convenções devem ser usadas para manter os pacotes de módulos perl consistentes. Esta seção serve como uma introdução ao conceito de empacotamento de perl, do ponto de vista do Arch Linux; isto é, gerenciamento de pacotes e administração do sistema. Em um esforço para agradar o leitor [TL;DR](https://en.wikipedia.org/wiki/TL;DR "wikipedia:TL;DR"), o material mais fácil e/ou mais popular está no topo.

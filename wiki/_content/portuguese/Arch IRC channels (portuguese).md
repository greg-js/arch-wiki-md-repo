**Status de tradução:** Esse artigo é uma tradução de [Arch IRC channels](/index.php/Arch_IRC_channels "Arch IRC channels"). Data da última tradução: 2018-11-23\. Você pode ajudar a sincronizar a tradução, se houver [alterações](https://wiki.archlinux.org/index.php?title=Arch_IRC_channels&diff=0&oldid=554936) na versão em inglês.

**Status de tradução:** Esse artigo é uma tradução de [Xprofile](/index.php/Xprofile "Xprofile"). Data da última tradução: 2019-10-10\. Você pode ajudar a sincronizar a tradução, se houver [alterações](https://wiki.archlinux.org/index.php?title=Xprofile&diff=0&oldid=540305) na versão em inglês.

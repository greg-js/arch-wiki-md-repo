**Status de tradução:** Esse artigo é uma tradução de [Xprofile](/index.php/Xprofile "Xprofile"). Data da última tradução: 2018-08-14\. Você pode ajudar a sincronizar a tradução, se houver [alterações](https://wiki.archlinux.org/index.php?title=Xprofile&diff=0&oldid=526059) na versão em inglês.

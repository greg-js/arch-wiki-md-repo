**Status de tradução:** Esse artigo é uma tradução de [Wine package guidelines](/index.php/Wine_package_guidelines "Wine package guidelines"). Data da última tradução: 2019-04-14\. Você pode ajudar a sincronizar a tradução, se houver [alterações](https://wiki.archlinux.org/index.php?title=Wine_package_guidelines&diff=0&oldid=553089) na versão em inglês.
...
É muito mais fácil trabalhar com arquivos compactados como `.zip` do que com instaladores do Windows. Se você não tiver escolha, pois o autor insiste em distribuir seu programa com um instalador, pesquise na Internet se é possível instalar silenciosamente o software. [MSFN](http://unattended.msfn.org/unattended.xp/page/list/switch/) geralmente é um bom lugar para pesquisar. Se não conseguir encontrar uma maneira, tente abrir o instalador com diferentes [utilitários de desempacotamento](/index.php/Diretrizes_de_pacotes_de_aplicativos_n%C3%A3o_livres#Desempacotamento "Diretrizes de pacotes de aplicativos não livres"); pode funcionar.

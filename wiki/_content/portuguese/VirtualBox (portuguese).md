...
*   [2 Configuração](#Configuração)
    *   [2.1 Adicionar usuário ao grupo vboxusers](#Adicionar_usuário_ao_grupo_vboxusers)
    ...
    *   [2.4 Iniciando máquinas virtuais como serviço](#Iniciando_máquinas_virtuais_como_serviço)
*   [3 Máquinas Virtuais](#Máquinas_Virtuais)
    *   [3.1 Instalando o Arch Linux em uma máquina virtual](#Instalando_o_Arch_Linux_em_uma_máquina_virtual)
        *   [3.1.1 Adicionais para Convidado](#Adicionais_para_Convidado_2)
        *   [3.1.2 Iniciando serviços compartilhados](#Iniciando_serviços_compartilhados)
        *   [3.1.3 Usando Microfone/WebCam USB](#Usando_Microfone/WebCam_USB)
        *   [3.1.4 Sincronizando a data da máquina virtual com a máquina real](#Sincronizando_a_data_da_máquina_virtual_com_a_máquina_real)
...
*   [5 Solução de Problemas](#Solução_de_Problemas)
    ...
    *   [5.2 VBOX_E_INVALID_OBJECT_STATE (0x80BB0007)](#VBOX_E_INVALID_OBJECT_STATE_(0x80BB0007))

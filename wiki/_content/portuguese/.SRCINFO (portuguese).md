**Status de tradução:** Esse artigo é uma tradução de [.SRCINFO](/index.php/.SRCINFO ".SRCINFO"). Data da última tradução: 2018-06-23\. Você pode ajudar a sincronizar a tradução, se houver [alterações](https://wiki.archlinux.org/index.php?title=.SRCINFO&diff=0&oldid=512104) na versão em inglês.

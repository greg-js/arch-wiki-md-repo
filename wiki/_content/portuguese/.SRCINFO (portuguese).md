**Status de tradução:** Esse artigo é uma tradução de [.SRCINFO](/index.php/.SRCINFO ".SRCINFO"). Data da última tradução: 2018-08-17\. Você pode ajudar a sincronizar a tradução, se houver [alterações](https://wiki.archlinux.org/index.php?title=.SRCINFO&diff=0&oldid=579486) na versão em inglês.

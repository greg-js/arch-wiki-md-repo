...
*   **aura** — Um gerenciador de pacotes para o Arch Linux escrito em Haskell. ([Página no fórum](https://bbs.archlinux.org/viewtopic.php?id=155778))
	...
	[https://github.com/aurapm/aura](https://github.com/aurapm/aura) || [aura-bin](https://aur.archlinux.org/packages/aura-bin/) (binário)
...
*   **aurman** — Auxiliar do AUR escrito em python
...
*   **naaman** — Um auxiliar do AUR escrito em Python 3.
...
*   *Pacotes divididos*: habilidade de compilar e instalar corretamente pacotes divididos (*split packages*) de forma independente, tal como [python-pyalsaaudio](https://aur.archlinux.org/packages/python-pyalsaaudio/) e [python2-pyalsaaudio](https://aur.archlinux.org/packages/python2-pyalsaaudio/).
*   *Git clone*: usa git-clones (em vez de baixar tarballs, o que está obsoleto).
...
| aurman | Python | Sim | Sim | Sim | Sim | Sim | Sim | bash | P | Interação em lite, obtenção de chaves pgp necessárias, ordena por popularidade |
...
| naaman | Python | Não | Sim | Não | Não | Não | Sim | bash | P/E | - |
| pacaur | Bash/C | Sim | Sim | Sim | Sim | Sim | Sim | bash,zsh | P/E | Multilíngue, ordena por votos/popularidade, interação por lote |
| packer | Bash | Não | Sim | Não | Não | Não | Não | Nenhum | P | - |
| pbget | Python | Sim | N/D | Sim | N/D | N/D | Sim | Nenhum | E | Sem compilações automáticas |
| pikaur | Python | Sim | Sim | Sim | Sim | Sim | Sim | bash,fish,zsh | P+E | [isolação de usuários dinâmicos com systemd](http://0pointer.net/blog/dynamic-users-with-systemd.html), ordena por votos/popularidade, interação em lote |
...
| yay | Go | Sim | Sim | Sim | Sim | Sim | Não | bash,zsh,fish | P | Ordena por votos, interação por lote |

**Status de tradução:** Esse artigo é uma tradução de [AUR helpers](/index.php/AUR_helpers "AUR helpers"). Data da última tradução: 2018-08-24\. Você pode ajudar a sincronizar a tradução, se houver [alterações](https://wiki.archlinux.org/index.php?title=AUR_helpers&diff=0&oldid=536647) na versão em inglês.
...
*   [1 Compilação e pesquisa](#Compila.C3.A7.C3.A3o_e_pesquisa)
    *   [1.1 Ativos](#Ativos)
    *   [1.2 Apenas pesquisa](#Apenas_pesquisa)
...
| [yay](https://aur.archlinux.org/packages/yay/) | Go | compatível | Sim | Sim | Sim | Sim | Sim | [Sim](https://github.com/Jguer/yay/pull/297) | [Sim](https://github.com/Jguer/yay/pull/447) | 1, [2*](https://github.com/Jguer/yay/commit/3bdb5343218d99d40f8a449b887348611f6bdbfc), [3*](https://github.com/Jguer/yay/commit/ea5a94e0f8bb5f76879099e6d319c0c0102231c2) | bash, fish, zsh | obtém chaves PGP, ordena por votos/popularidade, [arquitetura de prompt](https://github.com/Jguer/yay/commit/4bcd3a6297052714e91e3f886602ce5c12d15786) |
...
| [wrapaur](https://aur.archlinux.org/packages/wrapaur/) | Bash | compatível | Sim | Sim | Não | Não | Não | Sim | Não | – | – | Atualizações de espelhos, emite notícias e comentários do AUR |
...
| [packer-aur-git](https://aur.archlinux.org/packages/packer-aur-git/) | Bash | compatível | Não | Sim | Não | Não | Não | Não | Não | – | – | – |

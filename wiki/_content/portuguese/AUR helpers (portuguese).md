...
| aura | Haskell | Sim | Sim | Sim | Não | Não [[1]](https://github.com/aurapm/aura/issues/353) | Não | bash/zsh | P | Suporte a downgrade, [ABS](/index.php/ABS_(Portugu%C3%AAs) "ABS (Português)") e [powerpill](/index.php/Powerpill "Powerpill"), multilíngue, exibe [ArchHaskell](/index.php/ArchHaskell "ArchHaskell") |

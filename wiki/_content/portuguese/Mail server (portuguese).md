**Status de tradução:** Esse artigo é uma tradução de [Mail server](/index.php/Mail_server "Mail server"). Data da última tradução: 2019-11-10\. Você pode ajudar a sincronizar a tradução, se houver [alterações](https://wiki.archlinux.org/index.php?title=Mail_server&diff=0&oldid=586648) na versão em inglês.
...
*   **[dma](/index.php/Dma "Dma")** — Agente de transporte de correio minúsculo.
...
*   [https://www.mail-tester.com/](https://www.mail-tester.com/) (3 tentativas de graça apenas!)

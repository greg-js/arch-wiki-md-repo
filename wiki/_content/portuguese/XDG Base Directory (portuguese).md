**Status de tradução:** Esse artigo é uma tradução de [XDG Base Directory](/index.php/XDG_Base_Directory "XDG Base Directory"). Data da última tradução: 2019-11-24\. Você pode ajudar a sincronizar a tradução, se houver [alterações](https://wiki.archlinux.org/index.php?title=XDG_Base_Directory&diff=0&oldid=589882) na versão em inglês.
...
| [calcurse](https://www.archlinux.org/packages/?name=calcurse) | `~/.calcurse` | [[82]](https://github.com/lfos/calcurse/issues/252) | `$ calcurse -C "$XDG_CONFIG_HOME"/calcurse -D "$XDG_DATA_HOME"/calcurse` |
...
| [Java (Português)#OpenJDK](/index.php/Java_(Portugu%C3%AAs)#OpenJDK "Java (Português)") | `~/.java/.userPrefs` | [[98]](https://bugzilla.redhat.com/show_bug.cgi?id=1154277) | `$ export _JAVA_OPTIONS=-Djava.util.prefs.userRoot="$XDG_CONFIG_HOME"/java` |
...
~/.npmrc`
 ...
 | [[106]](https://github.com/npm/npm/issues/6675) | `$ export NPM_CONFIG_USERCONFIG=$XDG_CONFIG_HOME/npm/npmrc` `npmrc` 
```
...
Deve-se fornecer à opção `local_list` um caminho absoluto.
 ...
 |
| [openscad](https://www.archlinux.org/packages/?name=openscad) | `~/.OpenSCAD` | [7c3077b0f](https://github.com/openscad/openscad/commit/7c3077b0f) | [[108]](https://github.com/openscad/openscad/issues/125) | Não honra totalmente a XDG Base Directory Specification, veja [[109]](https://github.com/openscad/openscad/issues/373)
...
`~/.ivy2`
 ...
 | [[116]](https://github.com/sbt/sbt/issues/3681) | `$ sbt -ivy "$XDG_DATA_HOME"/ivy2 -sbt-dir "$XDG_DATA_HOME"/sbt` (cuidado com [[117]](https://github.com/sbt/sbt/issues/3598)) |
...
$ export VAGRANT_ALIAS_FILE="$XDG_DATA_HOME"/vagrant/aliases`
 ...
 |
| [WeeChat](/index.php/WeeChat "WeeChat") | `~/.weechat` | [[124]](http://savannah.nongnu.org/task/?10934) [[125]](https://github.com/ipython/ipython/pull/4457) | 
...
`$ echo hsts-file \= "$XDG_CACHE_HOME"/wget-hsts >> "$XDG_CONFIG_HOME/wgetrc"`
 ...
 |
| [wine](/index.php/Wine "Wine") | `~/.wine` | [[126]](https://bugs.winehq.org/show_bug.cgi?id=20888) | [Winetricks](/index.php/Wine#Winetricks "Wine") usa local tipo XDG abaixo para gerenciamento de [WINEPREFIX](/index.php/Wine#WINEPREFIX "Wine"):
...
~/.xserverrc`
 ...
 | [[127]](https://gitlab.freedesktop.org/xorg/app/xinit/issues/14) | 
...
`~/.z`
 ...
 | [[128]](https://github.com/rupa/z/issues/267) | `$ export _Z_DATA="$XDG_DATA_HOME/z"` |

### Codificado

| Aplicativo | Caminho legal | Discussão | Observações |
| [adb](/index.php/Adb_(Portugu%C3%AAs) "Adb (Português)") | `~/.android/` | [[129]](https://developer.android.com/studio/command-line/variables.html#android_sdk_root) | `$ export ANDROID_SDK_HOME="$XDG_CONFIG_HOME"/android` |
...
~/.java/`
 ...
 |
| [anthy](https://osdn.net/projects/anthy/) | `~/.anthy` | [[130]](https://osdn.net/ticket/browse.php?group_id=14&tid=28397) |
...
Especifique `--init-file <arquivo>` como uma alternativa a `~/.bashrc` para shells interativos.
 ...
 |
| [cabal](https://www.haskell.org/cabal/) | `~/.cabal/` | [[131]](https://github.com/haskell/cabal/issues/680) | Veja a discussão para soluções alternativas em potencial. Não é muito fácil ou direta, mas pode ser possível emular a conformidade com Base Directory. |
| [chatty](https://aur.archlinux.org/packages/chatty/) | `~/.chatty/` | [[132]](https://github.com/chatty/chatty/issues/273) |
...
| [Cinnamon](/index.php/Cinnamon "Cinnamon") | `~/.cinnamon/` | [[133]](https://github.com/linuxmint/Cinnamon/issues/7807) |
| [cryptomator](https://aur.archlinux.org/packages/cryptomator/) | `~/.Cryptomator` | [[134]](https://github.com/cryptomator/cryptomator/issues/710) |
| [CUPS](/index.php/CUPS "CUPS") | `~/.cups/` | [não vai corrigir](https://github.com/apple/cups/issues/4243) |
| [darcs](/index.php/Darcs "Darcs") | `~/.darcs/` | [[135]](http://bugs.darcs.net/issue2453) |
| [dbus](/index.php/Dbus "Dbus") | `~/.dbus/` | [[136]](https://gitlab.freedesktop.org/dbus/dbus/issues/46) | Isso deve ser evitável com kdbus [citação necessária]. |
...
| [hplip](https://www.archlinux.org/packages/?name=hplip) | `~/.hplip/` | [[148]](https://bugs.launchpad.net/hplip/+bug/307152) |
| [idris](http://www.idris-lang.org/) | `~/.idris` | [[149]](https://github.com/idris-lang/Idris-dev/pull/3456) |
| [iwd](https://iwd.wiki.kernel.org/) / iwctl | `~/.iwctl_history` |
| [Java](/index.php/Java_(Portugu%C3%AAs) "Java (Português)") OpenJDK | `~/.java/fonts` | [[150]](https://bugzilla.redhat.com/show_bug.cgi?id=1154277) |
...
~/.julia_history`
 ...
 | [[151]](https://github.com/JuliaLang/julia/issues/4630) [[152]](https://github.com/JuliaLang/julia/issues/10016) |
| [Linux PAM](http://www.linux-pam.org/) | `~/.pam_environment` | [[153]](https://github.com/linux-pam/linux-pam/issues/7) | Codificado em [modules/pam_env/pam_env.c](https://github.com/linux-pam/linux-pam/blob/master/modules/pam_env/pam_env.c) |
...
| [Minecraft](/index.php/Minecraft "Minecraft") | `~/.minecraft/` | [[154]](https://bugs.mojang.com/browse/MCL-2563) |
| [Minetest](/index.php/Minetest "Minetest") | `~/.minetest/` | [não vai corrigir](https://github.com/minetest/minetest/issues/864) [[155]](https://github.com/minetest/minetest/issues/8151) |
| [mongodb](https://www.mongodb.org/) | 

`~/.mongorc.js
~/.dbshell`

 | [[156]](https://jira.mongodb.org/browse/DOCS-5652?jql=text%20~%20%22.mongorc.js%22) | [Esse tópico do Stack Overflow](https://stackoverflow.com/questions/22348604/the-mongorc-js-is-not-found-but-there-is-one/22349050#22349050) sugere uma solução alternativa parcial usando a opção de linha de comando `--norc`. |
...
| [Networkmanager-openvpn](/index.php/Networkmanager-openvpn "Networkmanager-openvpn") | `~/.cert/nm-openvpn` | [[157]](https://gitlab.gnome.org/GNOME/NetworkManager-openvpn/issues/35) |
| [NSS](https://developer.mozilla.org/en-US/docs/Mozilla/Projects/NSS) | `~/.pki` | [[158]](https://bugzilla.mozilla.org/show_bug.cgi?id=818686) |
...
| [palemoon](https://www.palemoon.org/) | `~/.moonchild productions` | [[159]](https://forum.palemoon.org/viewtopic.php?f=5&t=9639) |
...
| [Ren'Py](https://www.renpy.org/) | `~/.renpy` | [[160]](https://github.com/renpy/renpy/issues/1377) |
...
| [sdcv](https://www.archlinux.org/packages/?name=sdcv) | `~/.stardict/` | [[161]](https://github.com/Dushistov/sdcv/issues/51) | A única solução alternativa é modificar `HOME` |
| [SeaMonkey](http://www.seamonkey-project.org/) | `~/.mozilla/` | [[162]](https://bugzil.la/726939) |
| [simplescreenrecorder](https://www.archlinux.org/packages/?name=simplescreenrecorder) | `~/.ssr/` | [[163]](https://github.com/MaartenBaert/ssr/issues/407) | O autor parece não concordar com esse recurso. |
...
~/lessonfiles`
 ...
 | [[164]](https://savannah.gnu.org/bugs/index.php?50251) |
| [spacemacs](https://spacemacs.org/) | 

`~/.spacemacs
~/.spacemacs.d`

 | [[165]](https://github.com/syl20bnr/spacemacs/issues/3589) |
...
~/.sqliterc`
 ...
 | [[166]](https://www.sqlite.org/src/info/696e82f7c82d1720) | `$ export SQLITE_HISTORY=$XDG_DATA_HOME/sqlite_history
`
...
| [Thunderbird](/index.php/Thunderbird "Thunderbird") | `~/.thunderbird/` | [[168]](https://bugzil.la/735285) |
...
~/.viminfo`
 ...
 | [[169]](https://github.com/vim/vim/issues/2034) | A partir de [7.3.1178](https://github.com/vim/vim/commit/6a459902592e2a4ba68), vem com suporte a `~/.vim/vimrc` se `~/.vimrc` não for encontrado.
...
*   [https://tlvince.com/vim-respect-xdg](https://tlvince.com/vim-respect-xdg)
 ...
 |
| [vimperator](http://www.vimperator.org/) | `~/.vimperatorrc` | [[170]](http://www.mozdev.org/pipermail/vimperator/2009-October/004848.html) | `$ export VIMPERATOR_INIT=":source $XDG_CONFIG_HOME/vimperator/vimperatorrc"`

`$ export VIMPERATOR_RUNTIME="$XDG_CONFIG_HOME"/vimperator`

 |
| [w3m](https://www.archlinux.org/packages/?name=w3m) | `~/.w3m` | [[171]](https://sourceforge.net/p/w3m/feature-requests/31/) |
| [wpa_cli](https://w1.fi/) | `~/.wpa_cli_history` |
| [xdg-utils](https://www.archlinux.org/packages/?name=xdg-utils) | `~/.gnome` | [[172]](https://bugs.freedesktop.org/show_bug.cgi?id=90775) | Por algum motivo o script `xdg-desktop-menu` codifica `gnome_user_dir="$HOME/.gnome/apps"`. Isso é usado por [chromium](/index.php/Chromium "Chromium") entre outros. |
| [xombrero](https://opensource.conformal.com/wiki/xombrero) | `~/.xombrero` | [[173]](https://github.com/conformal/xombrero/issues/74) |
| [xournalpp](https://www.archlinux.org/packages/?name=xournalpp) | `~/.xournalpp` | [[174]](https://github.com/xournalpp/xournalpp/issues/1101) |
| [YARD](https://yardoc.org) | `~/.yard` | [[175]](https://github.com/lsegal/yard/issues/1230) | Aceitaria uma Pull Request se alguém quisesse implementá-la. |
| [zenmap](https://nmap.org/zenmap/) [nmap](https://www.archlinux.org/packages/?name=nmap) | `~/.zenmap` | [[176]](http://seclists.org/nmap-dev/2012/q2/163) [[177]](https://github.com/nmap/nmap/issues/590) |

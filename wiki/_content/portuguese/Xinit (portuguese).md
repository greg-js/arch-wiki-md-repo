**Status de tradução:** Esse artigo é uma versão localizada de [Xinit](/index.php/Xinit "Xinit"). Data da última tradução: 2018-08-14\. Você pode ajudar a sincronizar a tradução, se houver [alterações](https://wiki.archlinux.org/index.php?title=Xinit&diff=0&oldid=528270) na versão em inglês.

...
*   [3 Configuração dos Backends](#Configuração_dos_Backends)
    *   [3.1 ALSA](#ALSA)
    *   [3.2 OSS](#OSS)
        *   [3.2.1 osspd](#osspd)
...
*   [5 Aplicativos](#Aplicativos)
    ...
    *   [5.2 mpd](#mpd)
    *   [5.3 MPlayer](#MPlayer)
*   [6 Configurações alternativas](#Configurações_alternativas)
    ...
    *   [6.3 Suporte TCP (som via rede)](#Suporte_TCP_(som_via_rede))
        *   [6.3.1 Publicação Zeroconf (Avahi)](#Publicação_Zeroconf_(Avahi))
...
*   [7 Soluções de problemas](#Soluções_de_problemas)
    *   [7.1 Sem som depois da instalação](#Sem_som_depois_da_instalação)
    ...
    *   [7.4 Problemas e uso intenso da CPU a partir da versão 0.9.14](#Problemas_e_uso_intenso_da_CPU_a_partir_da_versão_0.9.14)
    *   [7.5 Som intermitente](#Som_intermitente)
    *   [7.6 Ajuste de volume não funciona corretamente](#Ajuste_de_volume_não_funciona_corretamente)

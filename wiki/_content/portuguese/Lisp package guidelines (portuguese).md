**Status de tradução:** Esse artigo é uma tradução de [Lisp package guidelines](/index.php/Lisp_package_guidelines "Lisp package guidelines"). Data da última tradução: 2019-06-27\. Você pode ajudar a sincronizar a tradução, se houver [alterações](https://wiki.archlinux.org/index.php?title=Lisp_package_guidelines&diff=0&oldid=569831) na versão em inglês.

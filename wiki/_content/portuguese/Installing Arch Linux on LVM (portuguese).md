**Status de tradução:** Esse artigo é uma tradução de [Installing_Arch_Linux_on_LVM](/index.php/Installing_Arch_Linux_on_LVM "Installing Arch Linux on LVM"). Data da última tradução: 2020-01-18\. Você pode ajudar a sincronizar a tradução, se houver [alterações](https://wiki.archlinux.org/index.php?title=Installing_Arch_Linux_on_LVM&diff=0&oldid=595453) na versão em inglês.
...
*   [2 Instalação](#Instalação)
    *   [2.1 Criar partições](#Criar_partições)
    *   [2.2 Criar volumes físicos](#Criar_volumes_físicos)
    *   [2.3 Criar um grupo de volumes](#Criar_um_grupo_de_volumes)
        *   [2.3.1 Criação combinada de volumes físicos e grupos de volumes](#Criação_combinada_de_volumes_físicos_e_grupos_de_volumes)
    *   [2.4 Criar volumes lógicos](#Criar_volumes_lógicos)
    *   [2.5 Criar sistemas de arquivos e montar volumes lógicos](#Criar_sistemas_de_arquivos_e_montar_volumes_lógicos)
*   [3 Configuração do sistema](#Configuração_do_sistema)
    *   [3.1 Adicionando hooks do mkinitcpio](#Adicionando_hooks_do_mkinitcpio)
    *   [3.2 Opções de carregamento do kernel](#Opções_de_carregamento_do_kernel)

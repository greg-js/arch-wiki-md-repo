...
*   Arquivos de configuração globais de seu [shell](/index.php/Command-line_shell_(Portugu%C3%AAs) "Command-line shell (Português)"), inicializa variáveis e executa scripts. Por exemplo, [Bash#Configuration files](/index.php/Bash#Configuration_files "Bash") ou [Zsh#Startup/Shutdown files](/index.php/Zsh#Startup.2FShutdown_files "Zsh").

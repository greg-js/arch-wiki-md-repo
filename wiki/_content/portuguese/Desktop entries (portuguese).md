A [especificação XDG Desktop Entry](https://specifications.freedesktop.org/desktop-entry-spec/desktop-entry-spec-latest.html) define um padrão para aplicativos se integrarem em menus de aplicativos de [ambientes de desktop](/index.php/Ambientes_de_desktop "Ambientes de desktop") que implementam a especificação [XDG Desktop Menu](https://specifications.freedesktop.org/menu-spec/menu-spec-latest.html).
...
*   [1 Básico](#Básico)
*   [2 Entrada de aplicativos](#Entrada_de_aplicativos)
    *   [2.1 Exemplo de arquivo](#Exemplo_de_arquivo)
    *   [2.2 Definição das chaves](#Definição_das_chaves)
    *   [2.3 Validação](#Validação)
    *   [2.4 Instalação](#Instalação)
    *   [2.5 Atualizar banco de dados de entradas destkop](#Atualizar_banco_de_dados_de_entradas_destkop)
*   [3 Ícones](#Ícones)
    *   [3.1 Formatos de imagens comuns](#Formatos_de_imagens_comuns)
    *   [3.2 Convertendo ícones](#Convertendo_ícones)
    *   [3.3 Obtendo ícones](#Obtendo_ícones)
    *   [3.4 Caminho de ícones](#Caminho_de_ícones)
*   [4 Ferramentas](#Ferramentas)
    *   [4.1 gendesk](#gendesk)
        *   [4.1.1 Como usar](#Como_usar)
    *   [4.2 lsdesktopf](#lsdesktopf)
    *   [4.3 fbrokendesktop](#fbrokendesktop)
*   [5 Dicas e truques](#Dicas_e_truques)
    *   [5.1 Executar um arquivo desktop do terminal](#Executar_um_arquivo_desktop_do_terminal)
    *   [5.2 Ocultar entradas de desktop](#Ocultar_entradas_de_desktop)
    *   [5.3 Modificar variáveis de ambiente](#Modificar_variáveis_de_ambiente)
...
### Atualizar banco de dados de entradas destkop

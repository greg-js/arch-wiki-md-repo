**Status de tradução:** Esse artigo é uma tradução de [.NET Core](/index.php/.NET_Core ".NET Core"). Data da última tradução: 2019-08-17\. Você pode ajudar a sincronizar a tradução, se houver [alterações](https://wiki.archlinux.org/index.php?title=.NET_Core&diff=0&oldid=580135) na versão em inglês.

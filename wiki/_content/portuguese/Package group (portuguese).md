**Status de tradução:** Esse artigo é uma tradução de [Package group](/index.php/Package_group "Package group"). Data da última tradução: 2019-04-14\. Você pode ajudar a sincronizar a tradução, se houver [alterações](https://wiki.archlinux.org/index.php?title=Package_group&diff=0&oldid=566038) na versão em inglês.

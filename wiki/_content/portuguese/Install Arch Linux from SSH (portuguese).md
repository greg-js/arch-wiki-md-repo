**Status de tradução:** Esse artigo é uma tradução de [Install Arch Linux from SSH](/index.php/Install_Arch_Linux_from_SSH "Install Arch Linux from SSH"). Data da última tradução: 2019-12-15\. Você pode ajudar a sincronizar a tradução, se houver [alterações](https://wiki.archlinux.org/index.php?title=Install_Arch_Linux_from_SSH&diff=0&oldid=591867) na versão em inglês.

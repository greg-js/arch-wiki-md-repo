...
Pacotes que contêm [módulos do kernel](/index.php/Kernel_module_(Portugu%C3%AAs) "Kernel module (Português)") devem ser tratados especialmente, para suportar usuários que desejam ter mais de um kernel instalado em um sistema.

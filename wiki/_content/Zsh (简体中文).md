...
<td>和前面介绍的 $fg 是一样的，但是更简洁。还可以在 F 前面添加数字。</td>
...
<td>重置文本颜色（改为默认颜色）。不会重置粗体设定。使用 `%b` 来重置粗体设定。可以使用 `%f` 来简化配置。</td>
...
*   [Prezto - Instantly Awesome Zsh](https://github.com/sorin-ionescu/prezto)（可以通过 [prezto-git](https://aur.archlinux.org/packages/prezto-git/)<sup><small>AUR</small></sup> 获取） 它是一个模块化的 Zsh 配置框架，里面有很多顺手的默认配置、别名、函数、自动补全和命令提示符主题。
*   [Antigen](https://github.com/zsh-users/antigen) (可以通过 [antigen-git](https://aur.archlinux.org/packages/antigen-git/)<sup><small>AUR</small></sup> 获取) 这个一个 zsh 插件管理器，受到 oh-my-zsh 和 vundle 的启发
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Zsh_(简体中文)&oldid=415841](https://wiki.archlinux.org/index.php?title=Zsh_(简体中文)&oldid=415841)"

[Category](/index.php/Special:Categories "Special:Categories"):

*   [Command shells (简体中文)](/index.php/Category:Command_shells_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87) "Category:Command shells (简体中文)")
...
[ddclient](https://www.archlinux.org/packages/?name=ddclient), available in the [community](/index.php/Community "Community") repository, is compatible with many DDNS services and is the recommended tool for updating DDNS if your [router](#Router) is not an option. It includes [systemd](/index.php/Systemd "Systemd") support.

...
*   [2 Configuration](#Configuration)
    *   [2.1 UFW](#UFW)
    *   [2.2 Straight up iptables](#Straight_up_iptables)
*   [3 Usage](#Usage)
    *   [3.1 With systemd](#With_systemd)
    *   [3.2 With syslog-ng](#With_syslog-ng)
*   [4 General Information](#General_Information)
    *   [4.1 Aggressive banning](#Aggressive_banning)
*   [5 How to Unban](#How_to_Unban)
*   [6 See also](#See_also)

## Installation

[Install](/index.php/Install "Install") [sshguard](https://www.archlinux.org/packages/?name=sshguard).

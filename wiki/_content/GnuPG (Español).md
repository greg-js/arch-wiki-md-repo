...
**Reason:** [#GPG_AGENT_INFO](#GPG_AGENT_INFO) es obsoleto desde [gnupg](https://www.archlinux.org/packages/?name=gnupg)-2.1\. Ver [#Frase de acceso desatendida](#Frase_de_acceso_desatendida) para un método nuevo. (Discuss in [Talk:GnuPG (Español)#](https://wiki.archlinux.org/index.php/Talk:GnuPG_(Espa%C3%B1ol)))
...
**Reason:** Ver [#GPG_AGENT_INFO](#GPG_AGENT_INFO) (Discuss in [Talk:GnuPG (Español)#](https://wiki.archlinux.org/index.php/Talk:GnuPG_(Espa%C3%B1ol)))
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=GnuPG_(Español)&oldid=411644](https://wiki.archlinux.org/index.php?title=GnuPG_(Español)&oldid=411644)"

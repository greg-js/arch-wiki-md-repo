...
**Reason:** Possible "failed to bind errors" indicate towards a race condition, requires/after and similar should be updated accordingly (Discuss in [Talk:Aria2#](https://wiki.archlinux.org/index.php/Talk:Aria2))

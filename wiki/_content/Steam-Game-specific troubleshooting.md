...
*   [30 Interloper](#Interloper)
    *   [30.1 Dependencies](#Dependencies_13)
    *   [30.2 Game does not launch](#Game_does_not_launch)
*   [31 Invisible Apartment](#Invisible_Apartment)
    *   [31.1 Dependencies](#Dependencies_14)
    *   [31.2 Game does not run](#Game_does_not_run)
*   [32 Joe Danger 2: The Movie](#Joe_Danger_2:_The_Movie)
    *   [32.1 Dependencies](#Dependencies_15)
    *   [32.2 Compatibility](#Compatibility_5)
*   [33 Kerbal Space Program](#Kerbal_Space_Program)
    *   [33.1 Troubleshooting](#Troubleshooting_11)
    *   [33.2 Game never progresses past initial loading](#Game_never_progresses_past_initial_loading)
    *   [33.3 No text display](#No_text_display)
    *   [33.4 Graphics flickering when using primusrun](#Graphics_flickering_when_using_primusrun)
    *   [33.5 Game crashes when accessing settings or saves on 64 bit systems on Steam](#Game_crashes_when_accessing_settings_or_saves_on_64_bit_systems_on_Steam)
    *   [33.6 Locale settings](#Locale_settings)
    *   [33.7 No audio on 64-bit systems](#No_audio_on_64-bit_systems)
    *   [33.8 Black ingame textures](#Black_ingame_textures)
    *   [33.9 See also](#See_also)
*   [34 Killing Floor](#Killing_Floor)
    *   [34.1 Troubleshooting](#Troubleshooting_12)
        *   [34.1.1 Screen resolution](#Screen_resolution)
        *   [34.1.2 Windowed mode](#Windowed_mode)
        *   [34.1.3 Stuttering Sound](#Stuttering_Sound)
*   [35 Lethal League](#Lethal_League)
    *   [35.1 Dependencies](#Dependencies_16)
*   [36 Metro: Last Light](#Metro:_Last_Light)
    *   [36.1 Attempted fixes](#Attempted_fixes)
    *   [36.2 Hacky solution](#Hacky_solution)
    *   [36.3 Possible solutions](#Possible_solutions)
*   [37 Mark of the Ninja](#Mark_of_the_Ninja)
    *   [37.1 Troubleshooting](#Troubleshooting_13)
        *   [37.1.1 Bad sound](#Bad_sound)
*   [38 Multiwinia](#Multiwinia)
    *   [38.1 Dependencies](#Dependencies_17)
*   [39 Natural Selection 2](#Natural_Selection_2)
    *   [39.1 No Sound](#No_Sound_4)
*   [40 Penumbra: Overture](#Penumbra:_Overture)
    *   [40.1 Dependencies](#Dependencies_18)
    *   [40.2 Troubleshooting](#Troubleshooting_14)
        *   [40.2.1 Windowed mode](#Windowed_mode_2)
*   [41 Portal 2](#Portal_2)
    *   [41.1 Troubleshooting](#Troubleshooting_15)
        *   [41.1.1 Game does not start](#Game_does_not_start_6)
*   [42 Prison Architect](#Prison_Architect)
    *   [42.1 Troubleshooting](#Troubleshooting_16)
        *   [42.1.1 ALSA error when using PulseAudio](#ALSA_error_when_using_PulseAudio)
*   [43 Project Zomboid](#Project_Zomboid)
    *   [43.1 Dependencies](#Dependencies_19)
    *   [43.2 No sound](#No_sound_5)
*   [44 Redshirt](#Redshirt)
    *   [44.1 Dependencies (x86_64)](#Dependencies_.28x86_64.29_3)
*   [45 Revenge of the Titans](#Revenge_of_the_Titans)
    *   [45.1 Dependencies](#Dependencies_20)
*   [46 Rock Boshers DX: Directors Cut](#Rock_Boshers_DX:_Directors_Cut)
    *   [46.1 Dependencies](#Dependencies_21)
*   [47 Serious Sam 3: BFE](#Serious_Sam_3:_BFE)
    *   [47.1 Dependencies](#Dependencies_22)
    *   [47.2 Troubleshooting](#Troubleshooting_17)
        *   [47.2.1 No audio](#No_audio_2)
*   [48 Sir, you are being hunted](#Sir.2C_you_are_being_hunted)
    *   [48.1 Dependencies](#Dependencies_23)
*   [49 Spacechem](#Spacechem)
    *   [49.1 Dependencies](#Dependencies_24)
    *   [49.2 Troubleshooting](#Troubleshooting_18)
        *   [49.2.1 Game crash](#Game_crash)
*   [50 Space Pirates and Zombies](#Space_Pirates_and_Zombies)
    *   [50.1 Dependencies](#Dependencies_25)
    *   [50.2 Troubleshooting](#Troubleshooting_19)
        *   [50.2.1 No audio](#No_audio_3)
*   [51 Splice](#Splice)
    *   [51.1 Dependencies](#Dependencies_26)
*   [52 Steel Storm: Burning Retribution](#Steel_Storm:_Burning_Retribution)
    *   [52.1 Troubleshooting](#Troubleshooting_20)
        *   [52.1.1 Start with black screen](#Start_with_black_screen)
        *   [52.1.2 No English fonts](#No_English_fonts)
*   [53 Strike Suite Zero](#Strike_Suite_Zero)
    *   [53.1 Dependencies](#Dependencies_27)
*   [54 Superbrothers: Sword & Sworcery EP](#Superbrothers:_Sword_.26_Sworcery_EP)
    *   [54.1 Dependencies](#Dependencies_28)
*   [55 Team Fortress 2](#Team_Fortress_2)
    *   [55.1 Dependencies](#Dependencies_29)
    *   [55.2 Making HRTF work](#Making_HRTF_work)
    *   [55.3 Troubleshooting](#Troubleshooting_21)
        *   [55.3.1 Loading screen freeze](#Loading_screen_freeze)
        *   [55.3.2 No audio](#No_audio_4)
        *   [55.3.3 Slow loading textures](#Slow_loading_textures)
*   [56 Terraria](#Terraria)
    *   [56.1 Troubleshooting](#Troubleshooting_22)
        *   [56.1.1 Failed to start game (missing executable)](#Failed_to_start_game_.28missing_executable.29)
*   [57 The Book of Unwritten Tales](#The_Book_of_Unwritten_Tales)
    *   [57.1 Dependencies](#Dependencies_30)
*   [58 The Book of Unwritten Tales: The Critter Chronicles](#The_Book_of_Unwritten_Tales:_The_Critter_Chronicles)
*   [59 The Clockwork Man](#The_Clockwork_Man)
    *   [59.1 Dependencies](#Dependencies_31)
*   [60 The Polynomial](#The_Polynomial)
    *   [60.1 Dependencies](#Dependencies_32)
    *   [60.2 Troubleshooting](#Troubleshooting_23)
        *   [60.2.1 Segfaults during program start on 64-bit systems](#Segfaults_during_program_start_on_64-bit_systems)
*   [61 This War of Mine](#This_War_of_Mine)
    *   [61.1 Troubleshooting](#Troubleshooting_24)
        *   [61.1.1 Game doesn't load](#Game_doesn.27t_load)
*   [62 Towns / Towns Demo](#Towns_.2F_Towns_Demo)
    *   [62.1 Crash on launch](#Crash_on_launch)
*   [63 Transistor](#Transistor)
    *   [63.1 Crash on launch / FMOD binding crash / Audio issues](#Crash_on_launch_.2F_FMOD_binding_crash_.2F_Audio_issues)
*   [64 Trine 2](#Trine_2)
    *   [64.1 Dependencies](#Dependencies_33)
    *   [64.2 Troubleshooting](#Troubleshooting_25)
*   [65 Unity3D](#Unity3D)
    *   [65.1 Locale Settings](#Locale_Settings_2)
    *   [65.2 Unity 5 and PulseAudio](#Unity_5_and_PulseAudio)
*   [66 Unity of Command](#Unity_of_Command)
    *   [66.1 Dependencies](#Dependencies_34)
    *   [66.2 Troubleshooting](#Troubleshooting_26)
        *   [66.2.1 No audio](#No_audio_5)
*   [67 Unrest](#Unrest)
    *   [67.1 Dependencies](#Dependencies_35)
*   [68 War Thunder](#War_Thunder)
    *   [68.1 Troubleshooting](#Troubleshooting_27)
*   [69 Witcher 2: Assassin of Kings](#Witcher_2:_Assassin_of_Kings)
    *   [69.1 Dependencies](#Dependencies_36)
    *   [69.2 Troubleshooting](#Troubleshooting_28)
*   [70 Wizardry 6: Bane of the Cosmic Forge](#Wizardry_6:_Bane_of_the_Cosmic_Forge)
    *   [70.1 Dependencies](#Dependencies_37)
*   [71 World of Goo](#World_of_Goo)
    *   [71.1 Changing resolution](#Changing_resolution)
*   [72 Worms Reloaded](#Worms_Reloaded)
    *   [72.1 Dependencies](#Dependencies_38)
*   [73 XCOM](#XCOM)
    *   [73.1 Dependencies](#Dependencies_39)
    *   [73.2 Hangs on startup](#Hangs_on_startup)
    *   [73.3 Graphical glitches on Intel HD](#Graphical_glitches_on_Intel_HD)

...
Considerare l'utilizzo di applicazioni come [spamassassin](https://www.archlinux.org/packages/?name=spamassassin) o [imapfilter](https://aur.archlinux.org/packages/imapfilter/)<sup><small>AUR</small></sup> per smistare la posta.
...
È possibile installare [muttprint](https://aur.archlinux.org/packages/muttprint/)<sup><small>AUR</small></sup> da [AUR](/index.php/AUR "AUR") per una migliore qualità di stampa. Nel file muttrc, inserire:
...
Ora installare [urlview](https://aur.archlinux.org/packages/urlview/)<sup><small>AUR</small></sup> da [AUR](/index.php/AUR_(Italiano) "AUR (Italiano)").
...
Il pacchetto [mutt-sidebar](https://aur.archlinux.org/packages/mutt-sidebar/)<sup><small>AUR</small></sup> disponibile su [AUR](/index.php/AUR_(Italiano) "AUR (Italiano)") contiene una patch per avere la lista delle cartelle in una colonna a sinistra della finestra di mutt.
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Mutt_(Italiano)&oldid=412728](https://wiki.archlinux.org/index.php?title=Mutt_(Italiano)&oldid=412728)"

[Category](/index.php/Special:Categories "Special:Categories"):

*   [Email clients (Italiano)](/index.php/Category:Email_clients_(Italiano) "Category:Email clients (Italiano)")
# List of applications/Other (正體中文)
...
**Notes:** please use the first argument of the template to provide more detailed indications. (Discuss in [Talk:List of applications/Other (正體中文)#](https://wiki.archlinux.org/index.php/Talk:List_of_applications/Other_(%E6%AD%A3%E9%AB%94%E4%B8%AD%E6%96%87)))
...
**This article or section is a candidate for merging with [Bootsplash](/index.php/Bootsplash "Bootsplash").**

**Notes:** That article does not add any particular general information about bootsplash applications. (Discuss in [Talk:Bootsplash#Merge or backlink?](https://wiki.archlinux.org/index.php/Talk:Bootsplash#Merge_or_backlink.3F))
...
*   [xsplash-bzr](https://aur.archlinux.org/packages/xsplash-bzr/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/xsplash-bzr)]</sup> – new splash program used by Ubuntu starting from 9.10
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Pager (GUI)](https://en.wikipedia.org/wiki/Pager_(GUI) "wikipedia:Pager (GUI)")**
...
[http://code.google.com/p/mupen64plus/](http://code.google.com/p/mupen64plus/) || [mupen64plus](https://www.archlinux.org/packages/?name=mupen64plus) and [m64py](https://aur.archlinux.org/packages/m64py/)<sup><small>AUR</small></sup> (graphical frontend)

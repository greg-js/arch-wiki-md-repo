...
<td style="text-align: left; padding: 3px">تصف هذه المقالة كيف يمكن لمستخدموا آرتش الجُدد أو المتقدّمين المساهمة في المجتمع. اعلم أنّ هذه القائمة ليست شاملة.</td>
...
<td style="text-align: left; padding: 3px">[Arch_User_Repository_(العربية)](/index.php/Arch_User_Repository_(%D8%A7%D9%84%D8%B9%D8%B1%D8%A8%D9%8A%D8%A9) "Arch User Repository (العربية)")</td>
...
مستودع غير رسمي لحزم [linux-ck](https://aur.archlinux.org/packages/linux-ck/)<sup><small>AUR</small></sup> المُثلى لمستخدمي آرتش.
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Getting_involved_(العربية)&oldid=411901](https://wiki.archlinux.org/index.php?title=Getting_involved_(العربية)&oldid=411901)"

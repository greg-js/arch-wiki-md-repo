...
[Internet](/index.php/List_of_applications/Internet_(Espa%C3%B1ol) "List of applications/Internet (Español)") – [Multimedia](/index.php/List_of_applications/Multimedia_(Espa%C3%B1ol) "List of applications/Multimedia (Español)") – **Utilidades** – [Documentos](/index.php/List_of_applications/Documents_(Espa%C3%B1ol) "List of applications/Documents (Español)") – [Seguridad](/index.php/List_of_applications/Security_(Espa%C3%B1ol) "List of applications/Security (Español)") – [Ciencia](/index.php/List_of_applications/Science_(Espa%C3%B1ol) "List of applications/Science (Español)") – [Otras](/index.php/List_of_applications/Other_(Espa%C3%B1ol) "List of applications/Other (Español)")

## Contents

*   [1 Utilidades](#Utilidades)
    *   [1.1 Órdenes básicas de la shell](#.C3.93rdenes_b.C3.A1sicas_de_la_shell)
    *   [1.2 Gestores de paquetes](#Gestores_de_paquetes)
    *   [1.3 Programas de visualización sobre la utilización del disco](#Programas_de_visualizaci.C3.B3n_sobre_la_utilizaci.C3.B3n_del_disco)
    *   [1.4 Herramientas de grabación de CD/DVD](#Herramientas_de_grabaci.C3.B3n_de_CD.2FDVD)
    *   [1.5 Gestores de portapapeles](#Gestores_de_portapapeles)
    *   [1.6 Herramientas de compresión](#Herramientas_de_compresi.C3.B3n)
        *   [1.6.1 Consola](#Consola)
        *   [1.6.2 Interfaz gráfica](#Interfaz_gr.C3.A1fica)
    *   [1.7 Gestores de archivos](#Gestores_de_archivos)
        *   [1.7.1 Consola](#Consola_2)
        *   [1.7.2 Interfaz gráfica](#Interfaz_gr.C3.A1fica_2)
    *   [1.8 Herramientas de integración y comparación de archivos](#Herramientas_de_integraci.C3.B3n_y_comparaci.C3.B3n_de_archivos)
    *   [1.9 Barras de tareas](#Barras_de_tareas)
    *   [1.10 Aplicaciones para renombrar masivamente archivos](#Aplicaciones_para_renombrar_masivamente_archivos)
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=List_of_applications/Utilities_(Español)&oldid=412821](https://wiki.archlinux.org/index.php?title=List_of_applications/Utilities_(Español)&oldid=412821)"

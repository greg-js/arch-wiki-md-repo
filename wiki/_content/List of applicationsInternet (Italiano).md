...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Comparison of BitTorrent clients](https://en.wikipedia.org/wiki/Comparison_of_BitTorrent_clients "wikipedia:Comparison of BitTorrent clients")**
...
[http://transmissionbt.com/](http://transmissionbt.com/) || [transmission-cli](https://www.archlinux.org/packages/?name=transmission-cli) [transmission-remote-cli](https://www.archlinux.org/packages/?name=transmission-remote-cli) [transmission-remote-gtk](https://aur.archlinux.org/packages/transmission-remote-gtk/)<sup><small>AUR</small></sup> (Client remoti che lavorano con il demone del pacchetto -cli)
...
**Notes:** please use the first argument of the template to provide more detailed indications. (Discuss in [Talk:List of applications/Internet (Italiano)#](https://wiki.archlinux.org/index.php/Talk:List_of_applications/Internet_(Italiano)))
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Comparison of instant messaging protocols](https://en.wikipedia.org/wiki/Comparison_of_instant_messaging_protocols "wikipedia:Comparison of instant messaging protocols")**
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Comparison of instant messaging clients](https://en.wikipedia.org/wiki/Comparison_of_instant_messaging_clients "wikipedia:Comparison of instant messaging clients")**

Tutti i programmi di messagistica che supportano le diverse reti per mezzo di collegamenti diretti con loro, appartengono a questa sezione
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[XMPP](https://en.wikipedia.org/wiki/XMPP "wikipedia:XMPP")**

##### Client da console

See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Comparison of instant messaging clients#XMPP-related features](https://en.wikipedia.org/wiki/Comparison_of_instant_messaging_clients#XMPP-related_features "wikipedia:Comparison of instant messaging clients")**
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Comparison of XMPP server software](https://en.wikipedia.org/wiki/Comparison_of_XMPP_server_software "wikipedia:Comparison of XMPP server software")**
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Comparison of Internet Relay Chat clients](https://en.wikipedia.org/wiki/Comparison_of_Internet_Relay_Chat_clients "wikipedia:Comparison of Internet Relay Chat clients")**
...
[http://www.bitchx.org/](http://www.bitchx.org/) || [bitchx-svn](https://aur.archlinux.org/packages/bitchx-svn/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/bitchx-svn)]</sup>
...
[http://scrollz.com](http://scrollz.com) || [scrollz](https://aur.archlinux.org/packages/scrollz/)<sup><small>AUR</small></sup>
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Comparison of VoIP software](https://en.wikipedia.org/wiki/Comparison_of_VoIP_software "wikipedia:Comparison of VoIP software")**

See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[List of SIP software](https://en.wikipedia.org/wiki/List_of_SIP_software "wikipedia:List of SIP software")**
...
[http://www.teamspeak.com/](http://www.teamspeak.com/) || [teamspeak](https://www.archlinux.org/packages/?name=teamspeak)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/teamspeak)]</sup>
...
[https://github.com/Kiwi/curlpaste/](https://github.com/Kiwi/curlpaste/) || [curlpaste](https://www.archlinux.org/packages/?name=curlpaste)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): package not found]</sup>
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Comparison of e-mail clients](https://en.wikipedia.org/wiki/Comparison_of_e-mail_clients "wikipedia:Comparison of e-mail clients")**
...
[http://heirloom.sourceforge.net/mailx.html](http://heirloom.sourceforge.net/mailx.html) || [heirloom-mailx](https://www.archlinux.org/packages/?name=heirloom-mailx)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): replaced by [s-nail](https://www.archlinux.org/packages/?name=s-nail)]</sup>
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Comparison of feed aggregators](https://en.wikipedia.org/wiki/Comparison_of_feed_aggregators "wikipedia:Comparison of feed aggregators")**
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Comparison of web browsers](https://en.wikipedia.org/wiki/Comparison_of_web_browsers "wikipedia:Comparison of web browsers")**
...
[http://lab-fgb.com/abaco/](http://lab-fgb.com/abaco/)<sup>[[dead link](https://en.wikipedia.org/wiki/Wikipedia:Link_rot "wikipedia:Wikipedia:Link rot") 2013-05-19]</sup> || [abaco](https://aur.archlinux.org/packages/abaco/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/abaco)]</sup>
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Blog software](https://en.wikipedia.org/wiki/Blog_software "wikipedia:Blog software")**

See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[List of content management systems](https://en.wikipedia.org/wiki/List_of_content_management_systems "wikipedia:List of content management systems")**
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[List of Twitter services and applications](https://en.wikipedia.org/wiki/List_of_Twitter_services_and_applications "wikipedia:List of Twitter services and applications")**
...
*   **turses** — Client Twitter per console basato su [tyrs](https://aur.archlinux.org/packages/tyrs/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/tyrs)]</sup> con molti miglioramenti.
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Comparison of FTP client software](https://en.wikipedia.org/wiki/Comparison_of_FTP_client_software "wikipedia:Comparison of FTP client software")**
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=List_of_applications/Internet_(Italiano)&oldid=413332](https://wiki.archlinux.org/index.php?title=List_of_applications/Internet_(Italiano)&oldid=413332)"

[Category](/index.php/Special:Categories "Special:Categories"):

*   [Internet applications (Italiano)](/index.php/Category:Internet_applications_(Italiano) "Category:Internet applications (Italiano)")
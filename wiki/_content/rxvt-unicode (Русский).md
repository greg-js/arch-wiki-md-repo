...
[rxvt-unicode-patched](https://aur.archlinux.org/packages/rxvt-unicode-patched/)<sup><small>AUR</small></sup> доступен в [AUR](/index.php/AUR "AUR") и включает в себя исправление ошибки ширины шрифта.
...
**Причина:** Bias towards url-select while matcher and url-select are mostly equivalent, as well as man page duplication (обсуждение: [Talk:Rxvt-unicode (Русский)#](https://wiki.archlinux.org/index.php/Talk:Rxvt-unicode_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)))
...
<td>Вход в режим выбора. Будет выбран последний URL на вашем экране. Вы можете повторить `Alt+u` для выбора следующего upward URL.</td>
...
<td>Открыть выбранный URL в браузере и выйти из режима выбора</td>
...
<td>Открыть выбранный URL в браузере без выхода из режима выбора</td>
...
<td>Скопировать (yank) выбранные URL выйти из режима выбора</td>
...
<td>Отменить режим выбора URL</td>
...
<td>Перейти к правой вкладке</td>
...
<td>Переместить вкладку влево</td>
...
<td>Переместить вкладку вправо</td>
...
Установите пакет [urxvt-tabbedex](https://aur.archlinux.org/packages/urxvt-tabbedex/)<sup><small>AUR</small></sup> из [AUR](/index.php/AUR "AUR"), затем добавьте `tabbedex` значение в `URxvt.perl-ext-common` X resource в вашем `~/.Xresources`:
...
**Обратите внимание:** Переназначенные горячие клавиши, используемые для пользовательских команд, не будет отключать сопоставление по умолчанию, для этого вы должны установить X resource `no-tabbedex-keys`. Однако это значение, в настоящее время не входит в пакет [urxvt-tabbedex](https://aur.archlinux.org/packages/urxvt-tabbedex/)<sup><small>AUR</small></sup>. Вместо него, рассмотрите возможность использования пакета [urxvt-tabbedex-git](https://aur.archlinux.org/packages/urxvt-tabbedex-git/)<sup><small>AUR</small></sup>:
...
Вы можете установить [AUR](/index.php/AUR "AUR") пакет [urxvt-fullscreen](https://aur.archlinux.org/packages/urxvt-fullscreen/)<sup><small>AUR</small></sup>, а затем назначить клавишу (или сочетание клавиш), чтобы привести urxvt в полноэкранный режим.
...
Установите [urxvt-vtwheel](https://aur.archlinux.org/packages/urxvt-vtwheel/)<sup><small>AUR</small></sup> из [AUR](/index.php/AUR "AUR") и добавьте его в ваше расширение Perl внутри `~/.Xresources`:
...
Установите [urxvt-resize-font-git](https://aur.archlinux.org/packages/urxvt-resize-font-git/)<sup><small>AUR</small></sup> из [AUR](/index.php/AUR "AUR"), и добавьте его в ваше расширение Perl внутри `~/.Xresources`
...
*   Соберите rxvt-unicode с отключением ненужных функций, `--disable-xft` и в частности `--disable-unicode3`.<sup>[[3]](http://pod.tst.eu/http://cvs.schmorp.de/rxvt-unicode/doc/rxvt.7.pod#Rxvt_unicode_uses_gobs_of_memory_how)</sup>
...
Участник Xyne также создал свой собственный вариант сценария Skottish по имени [urxvt-clipboard](https://aur.archlinux.org/packages/urxvt-clipboard/)<sup><small>AUR</small></sup> который доступен в [AUR](/index.php/AUR_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "AUR (Русский)"), позволяющий пользователю вставлять выделение вместо `Ctrl+V` по щелчку средней кнопки мыши:
...
[AUR](/index.php/AUR_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "AUR (Русский)") пакет [urxvt-perls-git](https://aur.archlinux.org/packages/urxvt-perls-git/)<sup><small>AUR</small></sup> это еще один вариант которым можно воспользоватся. [urxvt-perls-git](https://aur.archlinux.org/packages/urxvt-perls-git/)<sup><small>AUR</small></sup> включает в себя такую же функциональность как [urxvt-clipboard](https://aur.archlinux.org/packages/urxvt-clipboard/)<sup><small>AUR</small></sup>, в дополнение к расширениям Perl keyboard-select и url-select.
...
<td>Переход на вкладку слева от текущей</td>
...
<td>Переход на вкладку справа от текущей</td>
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Rxvt-unicode_(Русский)&oldid=415173](https://wiki.archlinux.org/index.php?title=Rxvt-unicode_(Русский)&oldid=415173)"

[Categories](/index.php/Special:Categories "Special:Categories"):

*   [Terminal emulators (Русский)](/index.php/Category:Terminal_emulators_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Category:Terminal emulators (Русский)")

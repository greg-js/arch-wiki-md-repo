...
*   pakiety dostępu do dokumentacji ([man](https://www.archlinux.org/packages/?name=man) i [man-pages](https://www.archlinux.org/packages/?name=man-pages));
*   [program rozruchowy](/index.php/Arch_boot_process#Boot_loader "Arch boot process") taki jak [grub](https://www.archlinux.org/packages/?name=grub) czy [refind](https://www.archlinux.org/packages/?name=refind);

...
**Tip:** Przed systemd w wersji 216 _systemd-timesyncd_ do uruchomienia wymagał [systemd-networkd](/index.php/Systemd-networkd "Systemd-networkd"), obecnie potrafi również współpracować z [dhcpcd](/index.php/Dhcpcd "Dhcpcd") i [NetworkManager](/index.php/NetworkManager "NetworkManager"), lecz dalej polega na zewnętrznych narzędziach.

## Konfiguracja

Przy uruchamianiu _systemd-timesyncd_ wczyta plik `/etc/systemd/timesyncd.conf`. Począwszy od [systemd](/index.php/Systemd "Systemd") 217 wygląda on tak:

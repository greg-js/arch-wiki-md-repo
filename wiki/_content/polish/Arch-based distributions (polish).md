...
Gwiazdką zaznaczono rok pierwszego wydania opartego na Arch Linuksie.
...
Poniższe dystrybucje nie są już rozwijane, ale stanowią część historii związanej z Arch Linuksem. Tytuł podrozdziału wskazuje na rok ostatniego wydania.
...
*   [Aegis Project](https://web.archive.org/web/20110728041813/http://arch-egis.berlios.de/news.php)
...
*   [Lista dystrybucji bazujących na Arch Linuksie w polskiej Wikipedii](https://en.wikipedia.org/wiki/pl:Arch_Linux#Dystrybucje_bazuj.C4.85ce_na_Arch_Linux "wikipedia:pl:Arch Linux")
*   [Lista dystrybucji bazujących na Arch Linuksie w serwisie DistroWatch](https://distrowatch.com/search.php?&basedon=Arch&status=All#simple) (w języku angielskim)
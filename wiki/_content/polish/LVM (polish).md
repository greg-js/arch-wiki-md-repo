...
*   [4 Instalowanie Arch Linux na LVM](#Instalowanie_Arch_Linux_na_LVM)
    *   [4.1 Utwórz partycje](#Utw.C3.B3rz_partycje)
    *   [4.2 Utwórz woluminy fizyczne](#Utw.C3.B3rz_woluminy_fizyczne)
    *   [4.3 Utwórz grupę woluminów](#Utw.C3.B3rz_grup.C4.99_wolumin.C3.B3w)
    *   [4.4 Utwórz w jednym kroku](#Utw.C3.B3rz_w_jednym_kroku)
    *   [4.5 Utwórz woluminy logiczne](#Utw.C3.B3rz_woluminy_logiczne)
    *   [4.6 Twórz systemy plików i montowanie woliminów logicznych](#Tw.C3.B3rz_systemy_plik.C3.B3w_i_montowanie_wolimin.C3.B3w_logicznych)
    *   [4.7 Skonfiguruj mkinitcpio](#Skonfiguruj_mkinitcpio)
    *   [4.8 Opcje jądra](#Opcje_j.C4.85dra)
*   [5 Volume operations](#Volume_operations)
    *   [5.1 Zaawansowane opcje](#Zaawansowane_opcje)
    *   [5.2 Zmienianie wielkości woluminów](#Zmienianie_wielko.C5.9Bci_wolumin.C3.B3w)
        *   [5.2.1 woluminów fizycznych](#wolumin.C3.B3w_fizycznych)
            *   [5.2.1.1 Growing](#Growing)
            *   [5.2.1.2 Shrinking](#Shrinking)
                *   [5.2.1.2.1 Move physical extents](#Move_physical_extents)
                *   [5.2.1.2.2 Zmień rozmiar woluminu fizycznego](#Zmie.C5.84_rozmiar_woluminu_fizycznego)
                *   [5.2.1.2.3 Zmień rozmiar partycji](#Zmie.C5.84_rozmiar_partycji)
        *   [5.2.2 Logical volumes](#Logical_volumes)
            *   [5.2.2.1 Growing or shrinking with lvresize](#Growing_or_shrinking_with_lvresize)
            *   [5.2.2.2 Rozszerzanie woluminu logicznego i systemu plików za jednym razem](#Rozszerzanie_woluminu_logicznego_i_systemu_plik.C3.B3w_za_jednym_razem)
            *   [5.2.2.3 Zmiana rozmiaru systemu plików oddzielnie](#Zmiana_rozmiaru_systemu_plik.C3.B3w_oddzielnie)
    *   [5.3 Remove logical volume](#Remove_logical_volume)
    *   [5.4 Dodaj wolumin fizyczny do grupy woluminów](#Dodaj_wolumin_fizyczny_do_grupy_wolumin.C3.B3w)
    *   [5.5 Usuń partycję z grupy woluminów](#Usu.C5.84_partycj.C4.99_z_grupy_wolumin.C3.B3w)
    *   [5.6 Dezaktywuj grupę woluminów](#Dezaktywuj_grup.C4.99_wolumin.C3.B3w)
*   [6 Typy woluminów logicznych](#Typy_wolumin.C3.B3w_logicznych)
    *   [6.1 Migawki](#Migawki)
        *   [6.1.1 Konfiguracja](#Konfiguracja)
    *   [6.2 LVM cache](#LVM_cache)
        *   [6.2.1 Create cache](#Create_cache)
        *   [6.2.2 Usuń pamięć podręczną](#Usu.C5.84_pami.C4.99.C4.87_podr.C4.99czn.C4.85)
    *   [6.3 RAID](#RAID)
...
*   [8 Rozwiązywanie problemów](#Rozwi.C4.85zywanie_problem.C3.B3w)
    *   [8.1 Zmiany, które mogą być wymagane ze względu na zmiany w domyślnych ustawieniach Arch-Linux](#Zmiany.2C_kt.C3.B3re_mog.C4.85_by.C4.87_wymagane_ze_wzgl.C4.99du_na_zmiany_w_domy.C5.9Blnych_ustawieniach_Arch-Linux)
    *   [8.2 Komendy LVM nie działają](#Komendy_LVM_nie_dzia.C5.82aj.C4.85)
    *   [8.3 Woluminy logiczne się nie wyświetlają](#Woluminy_logiczne_si.C4.99_nie_wy.C5.9Bwietlaj.C4.85)
    *   [8.4 LVM na nośnikach wymiennych](#LVM_na_no.C5.9Bnikach_wymiennych)
    *   [8.5 Zmiana rozmiaru sąsiedniego woluminu logicznego kończy się niepowodzeniem](#Zmiana_rozmiaru_s.C4.85siedniego_woluminu_logicznego_ko.C5.84czy_si.C4.99_niepowodzeniem)
    *   [8.6 Polecenie "grub-mkconfig" zgłasza błędy "unknown filesystem" errors](#Polecenie_.22grub-mkconfig.22_zg.C5.82asza_b.C5.82.C4.99dy_.22unknown_filesystem.22_errors)
    *   [8.7 Thinly-provisioned root volume device times out](#Thinly-provisioned_root_volume_device_times_out)
    *   [8.8 Opóźnienie przy wyłączaniu](#Op.C3.B3.C5.BAnienie_przy_wy.C5.82.C4.85czaniu)
*   [9 Zobacz też](#Zobacz_te.C5.BC)

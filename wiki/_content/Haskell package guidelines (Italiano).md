...
**Reason:** please use the first argument of the template to provide a brief explanation. (Discuss in [Talk:Haskell package guidelines (Italiano)#](https://wiki.archlinux.org/index.php/Talk:Haskell_package_guidelines_(Italiano)))
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Haskell_package_guidelines_(Italiano)&oldid=413919](https://wiki.archlinux.org/index.php?title=Haskell_package_guidelines_(Italiano)&oldid=413919)"

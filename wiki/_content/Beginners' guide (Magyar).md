...
**Reason:** please use the first argument of the template to provide a brief explanation. (Discuss in [Talk:Beginners' guide (Magyar)#](https://wiki.archlinux.org/index.php/Talk:Beginners%27_guide_(Magyar)))
...
**Notes:** please use the first argument of the template to provide more detailed indications. (Discuss in [Talk:Beginners' guide (Magyar)#](https://wiki.archlinux.org/index.php/Talk:Beginners%27_guide_(Magyar)))
...
**Notes:** Az útmutató ezen része befejezetlen és fordításra vár!! (Discuss in [Talk:Beginners' guide (Magyar)#](https://wiki.archlinux.org/index.php/Talk:Beginners%27_guide_(Magyar)))
...
<td>WEP ASCII jelszóval (passphrase)</td>
...
A telepítés során minden elérhető szoftvercsomag a [[core]](/index.php/Official_repositories#core "Official repositories") csomagtárolóból származik. Továbbá ez a csomagtároló ketté van osztva **base** <sup>([i686](https://www.archlinux.org/groups/i686/base/)|[x86_64](https://www.archlinux.org/groups/x86_64/base/))</sup>, és **base-devel** <sup>([i686](https://www.archlinux.org/groups/i686/base-devel/)|[x86_64](https://www.archlinux.org/groups/x86_64/base-devel/))</sup> csoportokra. Csomaginformációk és rövid leírások a [core]-ról elérhetőek [itt](https://www.archlinux.org/packages/?repo=Core&arch=any&arch=i686&arch=x86_64&limit=all&sort=pkgname).
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Beginners%27_guide_(Magyar)&oldid=411527](https://wiki.archlinux.org/index.php?title=Beginners%27_guide_(Magyar)&oldid=411527)"

[Category](/index.php/Special:Categories "Special:Categories"):

*   [Magyar](/index.php/Category:Magyar "Category:Magyar")
...
Surface Pro 3有三种启动模式 [explained 这里](http://www.microsoft.com/surface/en-us/support/storage-files-and-folders/boot-surface-pro-from-usb-recovery-device):
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Microsoft_Surface_Pro_3_(简体中文)&oldid=417598](https://wiki.archlinux.org/index.php?title=Microsoft_Surface_Pro_3_(简体中文)&oldid=417598)"
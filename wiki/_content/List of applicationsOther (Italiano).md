...
*   [1 Varie](#Varie)
    ...
    *   [1.2 Gestione del tempo](#Gestione_del_tempo)
        *   [1.2.1 Console](#Console_2)
        *   [1.2.2 Grafiche](#Grafiche_2)
    ...
    *   [1.4 Ambienti di lavoro](#Ambienti_di_lavoro)
        ...
        *   [1.4.4 Applicazioni supportate](#Applicazioni_supportate)
            *   [1.4.4.1 Login managers](#Login_managers)
            *   [1.4.4.2 Terminal multiplexers etc](#Terminal_multiplexers_etc)
    *   [1.5 Sistema di monitoraggio](#Sistema_di_monitoraggio)
    *   [1.6 Emulatori di terminale](#Emulatori_di_terminale)
        *   [1.6.1 Basati su VTE](#Basati_su_VTE)
    *   [1.7 Editor di Testi](#Editor_di_Testi)
        *   [1.7.1 Console](#Console_4)
        *   [1.7.2 Grafici](#Grafici_2)
    *   [1.8 Ambienti integrati di sviluppo](#Ambienti_integrati_di_sviluppo)
    *   [1.9 Pager](#Pager)
    *   [1.10 Lanciatori di applicazioni](#Lanciatori_di_applicazioni)
    *   [1.11 Radio amatoriali](#Radio_amatoriali)
    *   [1.12 Finanza](#Finanza)
    *   [1.13 Emulatori](#Emulatori)
        *   [1.13.1 Console](#Console_5)
        *   [1.13.2 Altri](#Altri)
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Comparison of notetaking software](https://en.wikipedia.org/wiki/Comparison_of_notetaking_software "wikipedia:Comparison of notetaking software")**
...
[http://prematureoptimization.org/glista/](http://prematureoptimization.org/glista/) || [glista](https://aur.archlinux.org/packages/glista/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/glista)]</sup>
...
[http://gtg.fritalk.com](http://gtg.fritalk.com) || [gtg](https://aur.archlinux.org/packages/gtg/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/gtg)]</sup>
...
[http://userbase.kde.org/Lokalize](http://userbase.kde.org/Lokalize) || [kdesdk-lokalize](https://www.archlinux.org/packages/?name=kdesdk-lokalize)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): replaced by [lokalize](https://www.archlinux.org/packages/?name=lokalize)]</sup>
...
[http://statmt.org/moses](http://statmt.org/moses) || [moses-release](https://aur.archlinux.org/packages/moses-release/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/moses-release)]</sup>
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Comparison of command shells](https://en.wikipedia.org/wiki/Comparison_of_command_shells "wikipedia:Comparison of command shells")**

See the main article: [Command shell](/index.php/Command_shell "Command shell")

#### Ambienti Desktop (De)

See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Comparison of X Window System desktop environments](https://en.wikipedia.org/wiki/Comparison_of_X_Window_System_desktop_environments "wikipedia:Comparison of X Window System desktop environments")**
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Comparison of X window managers](https://en.wikipedia.org/wiki/Comparison_of_X_window_managers "wikipedia:Comparison of X window managers")**
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[List of terminal emulators](https://en.wikipedia.org/wiki/List_of_terminal_emulators "wikipedia:List of terminal emulators")**
...
[http://kde.org/applications/system/konsole/](http://kde.org/applications/system/konsole/) || [kdebase-konsole](https://www.archlinux.org/packages/?name=kdebase-konsole)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): replaced by [konsole](https://www.archlinux.org/packages/?name=konsole)]</sup>
...
[http://materm.sourceforge.net/index.html](http://materm.sourceforge.net/index.html) || [mrxvt](https://aur.archlinux.org/packages/mrxvt/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/mrxvt)]</sup>
...
*   **Terminology** — Emulatore di terminale del progetto Enlightenment dalle caratteristiche innovative: usa anteprime dei file e gestisce i file multimediali come un media player. Appartiene a [e17-extra](https://www.archlinux.org/groups/x86_64/e17-extra/)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): package not found]</sup>.
...
[https://github.com/mutantturkey/mt/](https://github.com/mutantturkey/mt/) || [mt-git](https://aur.archlinux.org/packages/mt-git/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/mt-git)]</sup>
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Comparison of text editors](https://en.wikipedia.org/wiki/Comparison_of_text_editors "wikipedia:Comparison of text editors")**
...
[http://kate-editor.org/](http://kate-editor.org/) || [kdesdk-kate](https://www.archlinux.org/packages/?name=kdesdk-kate)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): replaced by [kate](https://www.archlinux.org/packages/?name=kate)]</sup>
...
[http://code.google.com/p/qxmledit/](http://code.google.com/p/qxmledit/) || [qxmledit](https://aur.archlinux.org/packages/qxmledit/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/qxmledit)]</sup>
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Comparison of integrated development environments](https://en.wikipedia.org/wiki/Comparison_of_integrated_development_environments "wikipedia:Comparison of integrated development environments")**
...
[http://eclipse.org/](http://eclipse.org/) || [eclipse](https://www.archlinux.org/packages/?name=eclipse)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): replaced by [eclipse-java](https://www.archlinux.org/packages/?name=eclipse-java)]</sup>
...
[http://www.editra.org](http://www.editra.org) || [editra](https://aur.archlinux.org/packages/editra/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/editra)]</sup>
...
[http://www.jetbrains.com/pycharm/](http://www.jetbrains.com/pycharm/) || [pycharm](https://aur.archlinux.org/packages/pycharm/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/pycharm)]</sup>
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Terminal pager](https://en.wikipedia.org/wiki/Terminal_pager "wikipedia:Terminal pager")**
...
*   **less-mouse** — less con il supporto scrolling via mouse. Presente su AUR come [less-mouse](https://aur.archlinux.org/packages/less-mouse/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/less-mouse)]</sup>.
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Comparison of desktop application launchers](https://en.wikipedia.org/wiki/Comparison_of_desktop_application_launchers "wikipedia:Comparison of desktop application launchers")**
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[List of software-defined radios](https://en.wikipedia.org/wiki/List_of_software-defined_radios "wikipedia:List of software-defined radios")**

Si veda l'articolo principale: [Amateur Radio#Software list](/index.php/Amateur_Radio#Software_list "Amateur Radio")

### Finanza

See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[Comparison of accounting software](https://en.wikipedia.org/wiki/Comparison_of_accounting_software "wikipedia:Comparison of accounting software")**
...
See the [Wikipedia](https://en.wikipedia.org/wiki/Main_Page "wikipedia:Main Page") article on this subject for more information: **[List of video game console emulators](https://en.wikipedia.org/wiki/List_of_video_game_console_emulators "wikipedia:List of video game console emulators")**
...
[http://byuu.org/higan/](http://byuu.org/higan/) || [higan-gtk](https://www.archlinux.org/packages/?name=higan-gtk)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): replaced by [higan](https://www.archlinux.org/packages/?name=higan)]</sup> [higan-qt](https://www.archlinux.org/packages/?name=higan-qt)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): replaced by [higan](https://www.archlinux.org/packages/?name=higan)]</sup>
...
[http://vba.ngemu.com/](http://vba.ngemu.com/) || [visualboyadvance](https://aur.archlinux.org/packages/visualboyadvance/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/visualboyadvance)]</sup> e [vbaexpress](https://aur.archlinux.org/packages/vbaexpress/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/vbaexpress)]</sup> (frontend grafico)
...
[http://code.google.com/p/mupen64plus/](http://code.google.com/p/mupen64plus/) || [mupen64plus](https://www.archlinux.org/packages/?name=mupen64plus) e [m64py](https://aur.archlinux.org/packages/m64py/)<sup><small>AUR</small></sup> (frontend grafico)
...
[http://kaede.strangesoft.net/kadence/](http://kaede.strangesoft.net/kadence/) || [fakenes](https://aur.archlinux.org/packages/fakenes/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/fakenes)]</sup>
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=List_of_applications/Other_(Italiano)&oldid=413338](https://wiki.archlinux.org/index.php?title=List_of_applications/Other_(Italiano)&oldid=413338)"

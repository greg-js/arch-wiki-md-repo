...
**Reason:** Does not describe the difference between `virtualenv` and `python -m venv`. See also [this report](https://wiki.archlinux.org/index.php?title=ArchWiki:Reports&diff=343331&oldid=343147). (Discuss in [Talk:Python VirtualEnv#](https://wiki.archlinux.org/index.php/Talk:Python_VirtualEnv))
...
**Reason:** stretched writing (Discuss in [Talk:Python VirtualEnv#](https://wiki.archlinux.org/index.php/Talk:Python_VirtualEnv))

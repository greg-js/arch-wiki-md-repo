...
**翻译状态：** 本文是英文页面 [Ceph](/index.php/Ceph "Ceph") 的[翻译](/index.php/ArchWiki_Translation_Team_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87) "ArchWiki Translation Team (简体中文)")，最后翻译时间：2016-01-15，点击[这里](https://wiki.archlinux.org/index.php?title=Ceph&diff=0&oldid=401404)可以查看翻译后英文页面的改动。
...
可以从 [官方源](/index.php/Official_repositories "Official repositories") 安装[ceph](https://www.archlinux.org/packages/?name=ceph)。如果愿意冒险，也可以安装开发版的 [ceph-git](https://aur.archlinux.org/packages/ceph-git/)<sup><small>AUR</small></sup>。

[ceph-deploy](https://aur.archlinux.org/packages/ceph-deploy/)<sup><small>AUR</small></sup>提供了 Ceph 的官方部署工具。
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Ceph_(简体中文)&oldid=415485](https://wiki.archlinux.org/index.php?title=Ceph_(简体中文)&oldid=415485)"

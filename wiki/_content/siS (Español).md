...
Necesitará instalar el paquete [xf86-video-sis](https://www.archlinux.org/packages/?name=xf86-video-sis), también es buena idea instalar [sisctrl](https://www.archlinux.org/packages/?name=sisctrl) (herramienta gráfica para editar los modos de vídeo). Algunas tarjetas que no son soportadas por el controlador **sis** pueden funcionar instalando los paquetes [xf86-video-sisusb](https://www.archlinux.org/packages/?name=xf86-video-sisusb) y [xf86-video-sisimedia](https://aur.archlinux.org/packages/xf86-video-sisimedia/)<sup><small>AUR</small></sup>. También puede probar con [xf86-video-sis671](https://aur.archlinux.org/packages/xf86-video-sis671/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/xf86-video-sis671)]</sup> desde [AUR](/index.php/AUR "AUR").
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=SiS_(Español)&oldid=415685](https://wiki.archlinux.org/index.php?title=SiS_(Español)&oldid=415685)"

[Category](/index.php/Special:Categories "Special:Categories"):

*   [X server (Español)](/index.php/Category:X_server_(Espa%C3%B1ol) "Category:X server (Español)")

...
**This article or section is a candidate for merging with [VirtualBox#Accessing a guest server](/index.php/VirtualBox#Accessing_a_guest_server "VirtualBox").**

**Notes:** This section does not really belong here, merging into [VirtualBox](/index.php/VirtualBox "VirtualBox") will give the reader more context. (Discuss in [Talk:Secure Shell (Español)#](https://wiki.archlinux.org/index.php/Talk:Secure_Shell_(Espa%C3%B1ol)))
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Secure_Shell_(Español)&oldid=411712](https://wiki.archlinux.org/index.php?title=Secure_Shell_(Español)&oldid=411712)"

[Category](/index.php/Special:Categories "Special:Categories"):

*   [Secure Shell (Español)](/index.php/Category:Secure_Shell_(Espa%C3%B1ol) "Category:Secure Shell (Español)")
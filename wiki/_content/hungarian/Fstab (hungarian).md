...
*   **<options>** - (opciók) az adott fájlrendszer csatolási opciói. Jegyezzük meg, hogy egyes [[csatolási opciók](http://linux.die.net/man/8/mount) csak egy-egy fájlrendszerre jellemzők. A leggyakoribbak a következők:

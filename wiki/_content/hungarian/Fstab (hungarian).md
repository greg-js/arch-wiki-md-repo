...
*   [1 Példa az fstab állományra](#Példa_az_fstab_állományra)
*   [2 A mezők definíciói](#A_mezők_definíciói)
*   [3 A fájlrendszerek azonosítása](#A_fájlrendszerek_azonosítása)
    *   [3.1 Rendszermag szerinti leíró](#Rendszermag_szerinti_leíró)
    *   [3.2 Címke](#Címke)
    *   [3.3 UUID](#UUID)
*   [4 Tippek és trükkök](#Tippek_és_trükkök)
    *   [4.1 Automatikus csatolás systemd-vel](#Automatikus_csatolás_systemd-vel)
    *   [4.2 Szóköz az elérési utakban](#Szóköz_az_elérési_utakban)
    *   [4.3 Külső meghajtók](#Külső_meghajtók)
    *   [4.4 atime opciók](#atime_opciók)
    *   [4.5 tmpfs](#tmpfs)
        *   [4.5.1 Használata](#Használata)
            *   [4.5.1.1 Fordítási idők javítása](#Fordítási_idők_javítása)
                *   [4.5.1.1.1 Egy munkamenetre](#Egy_munkamenetre)
                *   [4.5.1.1.2 Véglegesítve](#Véglegesítve)
    *   [4.6 A FAT32 írása egyszerű felhasználóként](#A_FAT32_írása_egyszerű_felhasználóként)
    *   [4.7 A root partíció újracsatolása](#A_root_partíció_újracsatolása)
*   [5 Lásd még](#Lásd_még)
...
*   [Adjunk Samba megosztásokat az /etc/fstab-hoz](/index.php/Samba#Add_Share_to_/etc/fstab "Samba")
...
*   [1 Általános](#Általános)
    *   [1.1 Mi az az Arch Linux?](#Mi_az_az_Arch_Linux?)
    *   [1.2 Miért nem szeretném az Archot használni?](#Miért_nem_szeretném_az_Archot_használni?)
    *   [1.3 Milyen architektúrákat támogat az Arch?](#Milyen_architektúrákat_támogat_az_Arch?)
    *   [1.4 Támogat az Arch ARM processzorokat?](#Támogat_az_Arch_ARM_processzorokat?)
    *   [1.5 Az Arch követi a Linux Alapítvány(Linux Foundation) Fájlrendszer Hierarchia Szabványát (FHS)?](#Az_Arch_követi_a_Linux_Alapítvány(Linux_Foundation)_Fájlrendszer_Hierarchia_Szabványát_(FHS)?)
    *   [1.6 I am a complete GNU/Linux beginner. Should I use Arch?](#I_am_a_complete_GNU/Linux_beginner._Should_I_use_Arch?)
    *   [1.7 Is Arch designed to be used as a server? A desktop? A workstation?](#Is_Arch_designed_to_be_used_as_a_server?_A_desktop?_A_workstation?)
    *   [1.8 I really like Arch, except the development team needs to implement feature X](#I_really_like_Arch,_except_the_development_team_needs_to_implement_feature_X)
    *   [1.9 When will the new release be made available?](#When_will_the_new_release_be_made_available?)
    *   [1.10 Is Arch Linux a stable distribution? Will I get frequent breakage?](#Is_Arch_Linux_a_stable_distribution?_Will_I_get_frequent_breakage?)
    *   [1.11 Arch needs more press (i.e. advertisement)](#Arch_needs_more_press_(i.e._advertisement))
    *   [1.12 Arch needs more developers](#Arch_needs_more_developers)
    *   [1.13 Why is my internet so slow compared to other operating systems?](#Why_is_my_internet_so_slow_compared_to_other_operating_systems?)
    *   [1.14 Why is Arch using all my RAM?](#Why_is_Arch_using_all_my_RAM?)
    *   [1.15 Where did all my free space go?](#Where_did_all_my_free_space_go?)
*   [2 Package management](#Package_management)
    *   [2.1 I have found an error with Package X. What should I do?](#I_have_found_an_error_with_Package_X._What_should_I_do?)
    *   [2.2 Arch packages need to use a unique naming convention. ".pkg.tar.gz" and ".pkg.tar.xz" are too long and/or confusing](#Arch_packages_need_to_use_a_unique_naming_convention._".pkg.tar.gz"_and_".pkg.tar.xz"_are_too_long_and/or_confusing)
    ...
    *   [2.4 Pacman needs feature X!](#Pacman_needs_feature_X!)
    *   [2.5 I just installed Package X. How do I start it?](#I_just_installed_Package_X._How_do_I_start_it?)
    *   [2.6 Why is there only a single version of each shared library in the official repositories?](#Why_is_there_only_a_single_version_of_each_shared_library_in_the_official_repositories?)
    ...
    *   [2.8 Is it possible that there is a major kernel update in the repository, and that some of the driver packages have not been updated?](#Is_it_possible_that_there_is_a_major_kernel_update_in_the_repository,_and_that_some_of_the_driver_packages_have_not_been_updated?)
    *   [2.9 What to do before upgrading?](#What_to_do_before_upgrading?)
...
*   [3 Installation](#Installation)
    ...
    *   [3.3 Which desktop environment or window manager should I use?](#Which_desktop_environment_or_window_manager_should_I_use?)
    *   [3.4 What makes Arch unique amongst other "minimal" distributions?](#What_makes_Arch_unique_amongst_other_"minimal"_distributions?)
*   [4 64-bit](#64-bit)
    *   [4.1 How do I determine if my processor is x86_64 compatible?](#How_do_I_determine_if_my_processor_is_x86_64_compatible?)
    *   [4.2 Why 64-bit?](#Why_64-bit?)
    *   [4.3 Válthatok i686-ról x86_64-re újratelepítés nélkül?](#Válthatok_i686-ról_x86_64-re_újratelepítés_nélkül?)

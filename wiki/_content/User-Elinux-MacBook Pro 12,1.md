...
**Note:** On 13" MacBook Pro with Retina 12,1 both wl and brcmfmac modules are needed for Wi-Fi to activate.
...
Gnome works out of box. See [HiDPI](/index.php/HiDPI "HiDPI") for information on how to tweak the system for a Retina screen.
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=User:Elinux/MacBook_Pro_12,1&oldid=415741](https://wiki.archlinux.org/index.php?title=User:Elinux/MacBook_Pro_12,1&oldid=415741)"
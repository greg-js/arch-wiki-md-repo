...
*   可以考虑把默认的端口从22改成更高的端口(参考 [security through obscurity](http://en.wikipedia.org/wiki/Security_through_obscurity)).尽管ssh的运行端口可以被像nmap这样的端口扫描器侦测到，但改变它可以减少由于自动验证的尝试造成的登录日志条目。
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Secure_Shell_(简体中文)&oldid=416198](https://wiki.archlinux.org/index.php?title=Secure_Shell_(简体中文)&oldid=416198)"

[Category](/index.php/Special:Categories "Special:Categories"):

*   [Secure Shell (简体中文)](/index.php/Category:Secure_Shell_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87) "Category:Secure Shell (简体中文)")
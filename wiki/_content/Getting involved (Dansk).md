...
**Reason:** please use the first argument of the template to provide a brief explanation. (Discuss in [Talk:Getting involved (Dansk)#](https://wiki.archlinux.org/index.php/Talk:Getting_involved_(Dansk)))
...
<td style="text-align: left; padding: 3px">Denne artikel beskriver forskellige måder, hvorpå Arch-brugere (både nye og gamle) kan bidrage til Arch-fællesskabet. Bemærk at denne liste ikke er udtømmende.</td>

</tr>

<tr style="text-align: center; height: 1.5em; border-bottom: 5px #08c solid;">

<th style="background: #333; color: white; padding: 2px;">**Beslægtet**</th>
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Getting_involved_(Dansk)&oldid=411878](https://wiki.archlinux.org/index.php?title=Getting_involved_(Dansk)&oldid=411878)"

[Category](/index.php/Special:Categories "Special:Categories"):

*   [About Arch (Dansk)](/index.php/Category:About_Arch_(Dansk) "Category:About Arch (Dansk)")
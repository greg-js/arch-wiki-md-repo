...
*   [1 前言](#前言)
    *   [1.1 CUPS 是什麼?](#CUPS_是什麼?)
    *   [1.2 疑難排解和CUPS的組成](#疑難排解和CUPS的組成)
*   [2 安裝 CUPS](#安裝_CUPS)
    *   [2.1 軟體套件](#軟體套件)
    *   [2.2 為核心加載印表機模組](#為核心加載印表機模組)
        *   [2.2.1 USB 埠印表機](#USB_埠印表機)
        *   [2.2.2 並列埠印表機](#並列埠印表機)
    *   [2.3 啟動 CUPS](#啟動_CUPS)
    *   [2.4 列印驅動： Foomatic](#列印驅動：_Foomatic)
    *   [2.5 列印驅動：hplip](#列印驅動：hplip)
    *   [2.6 列印驅動：Gutenprint](#列印驅動：Gutenprint)
    *   [2.7 在 X 下設定 CUPS](#在_X_下設定_CUPS)
*   [3 印表機的共享](#印表機的共享)
    *   [3.1 Linux 對 Linux](#Linux_對_Linux)
    ...
    *   [3.5 Others to Linux, Linux to others](#Others_to_Linux,_Linux_to_others)
*   [4 Appendix](#Appendix)
    ...
    *   [4.4 Specialized Cases](#Specialized_Cases)
        *   [4.4.1 Printing does not work/aborts with the HP Deskjet 700 Series Printers.](#Printing_does_not_work/aborts_with_the_HP_Deskjet_700_Series_Printers.)
...
*   [5 Troubleshooting](#Troubleshooting)
    *   [5.1 As a result of upgrade](#As_a_result_of_upgrade)
        ...
        *   [5.1.2 All jobs are "stopped"](#All_jobs_are_"stopped")

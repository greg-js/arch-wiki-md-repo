...
*   [6 軟體包分享與維護](#軟體包分享與維護)
    ...
    *   [6.2 維護軟體包](#維護軟體包)
    *   [6.3 其他要求](#其他要求)
*   [7 community 軟體庫](#community_軟體庫)
*   [8 Git 軟體庫](#Git_軟體庫)
*   [9 FAQ](#FAQ)
    *   [9.1 什麼是 AUR？](#什麼是_AUR？)
    *   [9.2 AUR 許可什麼類型的軟體包？](#AUR_許可什麼類型的軟體包？)
    *   [9.3 我要如何投票給 AUR 軟體包？](#我要如何投票給_AUR_軟體包？)
    *   [9.4 什麼是 TU？](#什麼是_TU？)
    *   [9.5 Arch 使用者倉庫和 *community* 的不同？](#Arch_使用者倉庫和_community_的不同？)
    *   [9.6 要多少個投票推薦才會讓 PKGBUILD 進入 *community*？](#要多少個投票推薦才會讓_PKGBUILD_進入_community？)
    *   [9.7 如何建立一份 PKGBUILD？](#如何建立一份_PKGBUILD？)
    *   [9.8 我確定 "foo" 在 *community* 庫，可是執行 "pacman -S foo" 卻失敗了。](#我確定_"foo"_在_community_庫，可是執行_"pacman_-S_foo"_卻失敗了。)
    *   [9.9 AUR 的某個軟體已經過期，我該怎麼做？](#AUR_的某個軟體已經過期，我該怎麼做？)
    *   [9.10 我打算提交一份 PKGBUILD，有沒有好心人可以幫忙檢查有沒有錯誤？](#我打算提交一份_PKGBUILD，有沒有好心人可以幫忙檢查有沒有錯誤？)
    *   [9.11 我從 AUR 下載某個軟體，執行 makepkg 卻無法編譯；我該怎麼做？](#我從_AUR_下載某個軟體，執行_makepkg_卻無法編譯；我該怎麼做？)
    *   [9.12 重復性的組建過程有什麼方法可以加速？](#重復性的組建過程有什麼方法可以加速？)
    *   [9.13 我該如何存取未支援的軟體包？](#我該如何存取未支援的軟體包？)
    *   [9.14 如何在不使用網頁介面的情況下上傳資料至 AUR？](#如何在不使用網頁介面的情況下上傳資料至_AUR？)
*   [10 另請參閱](#另請參閱)

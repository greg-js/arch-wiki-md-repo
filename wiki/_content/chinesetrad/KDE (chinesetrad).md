...
*   [1 KDE SC 4.5 Arch Linux 註記](#KDE_SC_4.5_Arch_Linux_註記)
    *   [1.1 KDE 4.5 Archlinux 套件的特殊資訊](#KDE_4.5_Archlinux_套件的特殊資訊)
*   [2 安裝 KDE 4.5 Software Compilation](#安裝_KDE_4.5_Software_Compilation)
    *   [2.1 安裝全套的 KDE SC](#安裝全套的_KDE_SC)
    *   [2.2 最小安裝](#最小安裝)
*   [3 啟動 KDE](#啟動_KDE)
    *   [3.1 使用 KDM (KDE Display Manager)](#使用_KDM_(KDE_Display_Manager))
        *   [3.1.1 作為一個守護進程啟動 KDM](#作為一個守護進程啟動_KDM)
        *   [3.1.2 透過 /etc/inittab 啟動 KDM [*最佳*]](#透過_/etc/inittab_啟動_KDM_[最佳])
    *   [3.2 使用 xinitrc](#使用_xinitrc)
*   [4 配置](#配置)
    *   [4.1 個人化](#個人化)
        *   [4.1.1 Plasma 桌面](#Plasma_桌面)
            *   [4.1.1.1 主題](#主題)
            *   [4.1.1.2 元件](#元件)
        *   [4.1.2 視窗外框](#視窗外框)
        ...
        *   [4.1.6 字型](#字型)
        *   [4.1.7 空間效率](#空間效率)
            *   [4.1.7.1 All sorts of *bars](#All_sorts_of_*bars)
            *   [4.1.7.2 Plasma](#Plasma)
            *   [4.1.7.3 KWin](#KWin)
    *   [4.2 網絡/列印](#網絡/列印)
    *   [4.3 Samba/Windows 支援](#Samba/Windows_支援)
    *   [4.4 KDE 桌面活動](#KDE_桌面活動)
    *   [4.5 省電](#省電)
        *   [4.5.1 如何啟用一般的省電](#如何啟用一般的省電)
        *   [4.5.2 How to enable Cpufreq based powersaving](#How_to_enable_Cpufreq_based_powersaving)
*   [5 系統管理](#系統管理)
    *   [5.1 設定鍵盤排版，以便切換輸入語言](#設定鍵盤排版，以便切換輸入語言)
    *   [5.2 Terminate Xorg-server through KDE system settings](#Terminate_Xorg-server_through_KDE_system_settings)
*   [6 桌面搜尋和語義學桌面](#桌面搜尋和語義學桌面)
    *   [6.1 Soprano](#Soprano)
    *   [6.2 Nepomuk](#Nepomuk)
    *   [6.3 Akonadi](#Akonadi)
    *   [6.4 Strigi 搜尋](#Strigi_搜尋)
*   [7 KDM (KDE Desktop Manager)](#KDM_(KDE_Desktop_Manager))
    *   [7.1 KDM Xserver 檔案](#KDM_Xserver_檔案)
    *   [7.2 配置 KDM](#配置_KDM)
        *   [7.2.1 使用者配置 KDM 的問題](#使用者配置_KDM_的問題)
*   [8 Phonon](#Phonon)
    *   [8.1 什麼是 Phonon？](#什麼是_Phonon？)
    *   [8.2 Which backend should I choose ?](#Which_backend_should_I_choose_?)
*   [9 使用 WebKit 在 Konqueror](#使用_WebKit_在_Konqueror)
    *   [9.1 什麼是 WebKit？](#什麼是_WebKit？)
    *   [9.2 如何用於 konqueror](#如何用於_konqueror)
*   [10 疑難解答](#疑難解答)
    *   [10.1 KHotkeys 問題](#KHotkeys_問題)
    ...
    *   [10.3 I encounter problems with automounting (or) KDE behaves strangely for no apparent reason](#I_encounter_problems_with_automounting_(or)_KDE_behaves_strangely_for_no_apparent_reason)
    *   [10.4 圖形的相關問題](#圖形的相關問題)
        *   [10.4.1 2D桌面效能低落（或）2D 出現假影](#2D桌面效能低落（或）2D_出現假影)
        *   [10.4.2 Konsole is slow in applications like vim](#Konsole_is_slow_in_applications_like_vim)
        *   [10.4.3 低落的 3D 桌面效能](#低落的_3D_桌面效能)
            *   [10.4.3.1 KDE 4.5 specific graphics' issues](#KDE_4.5_specific_graphics'_issues)
    *   [10.5 KDE 下的聲音問題](#KDE_下的聲音問題)
        *   [10.5.1 ALSA 相關問題](#ALSA_相關問題)
            *   [10.5.1.1 "Falling back to default" messages when trying to listen to any sound in KDE](#"Falling_back_to_default"_messages_when_trying_to_listen_to_any_sound_in_KDE)
            ...
            *   [10.5.1.3 Amarok "waits" before playing any track](#Amarok_"waits"_before_playing_any_track)
        *   [10.5.2 OSS4 相關問題](#OSS4_相關問題)
    *   [10.6 Arch linux 特定的打包問題](#Arch_linux_特定的打包問題)
    *   [10.7 我想要一個最小化安裝的 KDE。當我安裝套件後並登入 KDE，但沒有面板出現](#我想要一個最小化安裝的_KDE。當我安裝套件後並登入_KDE，但沒有面板出現)
    *   [10.8 我想要在我的系統安裝一個全新的 KDE。我應該怎麼做？](#我想要在我的系統安裝一個全新的_KDE。我應該怎麼做？)
    *   [10.9 Plasma 桌面行為奇怪，但我不知道該怎麼辦](#Plasma_桌面行為奇怪，但我不知道該怎麼辦)
*   [11 其他 KDE 專案](#其他_KDE_專案)
    *   [11.1 Chakra 專案](#Chakra_專案)
        *   [11.1.1 Split KDE packages](#Split_KDE_packages)
        *   [11.1.2 Chakra 專案 Arch Live CD](#Chakra_專案_Arch_Live_CD)
        *   [11.1.3 Passing from KDEmod to [extra]'s KDE](#Passing_from_KDEmod_to_[extra]'s_KDE)
    *   [11.2 KDE unstable](#KDE_unstable)
        *   [11.2.1 KDEmod testing/unstable](#KDEmod_testing/unstable)
        *   [11.2.2 KDE unstable (快照)](#KDE_unstable_(快照))
            *   [11.2.2.1 非官方的 kde-unstable](#非官方的_kde-unstable)
            *   [11.2.2.2 半官方的 kde-unstable](#半官方的_kde-unstable)

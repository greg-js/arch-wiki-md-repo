...
*   [4 啟動GNOME](#啟動GNOME)
    *   [4.1 圖形化的（Graphically）](#圖形化的（Graphically）)
    *   [4.2 手動開啟](#手動開啟)
    *   [4.3 在Wayland啟動GNOME應用程式](#在Wayland啟動GNOME應用程式)
*   [5 導覽解說](#導覽解說)
    *   [5.1 常用的應用程式名](#常用的應用程式名)
*   [6 設定](#設定)
    *   [6.1 系統設定](#系統設定)
        *   [6.1.1 顏色](#顏色)
        *   [6.1.2 日期 & 時間](#日期_&_時間)
    ...
    *   [6.2 Advanced settings](#Advanced_settings)
        *   [6.2.1 Appearance](#Appearance)
            *   [6.2.1.1 GTK+ themes and icon themes](#GTK+_themes_and_icon_themes)
        ...
        *   [6.2.8 Sort applications into application (app) folders](#Sort_applications_into_application_(app)_folders)
*   [7 Tips and tricks](#Tips_and_tricks)
    ...
    *   [7.8 Retina (HiDPI) display support](#Retina_(HiDPI)_display_support)
    *   [7.9 Passwords and keys (PGP Keys)](#Passwords_and_keys_(PGP_Keys))
...
*   [8 Troubleshooting](#Troubleshooting)
    ...
    *   [8.3 Tracker & Documents do not list any local files](#Tracker_&_Documents_do_not_list_any_local_files)
    ...
    *   [8.11 Windows cannot be modified with Alt-Key + mouse-button](#Windows_cannot_be_modified_with_Alt-Key_+_mouse-button)
    *   [8.12 Slow loading of system icons/slow GDM login](#Slow_loading_of_system_icons/slow_GDM_login)

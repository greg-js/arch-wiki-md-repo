...
*   [1 網路](#網路)
    ...
    *   [1.2 網頁瀏覽器](#網頁瀏覽器)
        ...
        *   [1.2.2 圖形](#圖形)
            *   [1.2.2.1 主流](#主流)
            *   [1.2.2.2 基於 Webkit](#基於_Webkit)
            *   [1.2.2.3 替代品](#替代品)
    *   [1.3 下載器](#下載器)
        *   [1.3.1 FTP](#FTP)
            *   [1.3.1.1 FTP 客戶端](#FTP_客戶端)
            *   [1.3.1.2 FTP 伺服器](#FTP_伺服器)
        *   [1.3.2 BitTorrent 客戶端](#BitTorrent_客戶端)
            *   [1.3.2.1 終端機](#終端機_2)
                *   [1.3.2.1.1 命令列 / 後端](#命令列_/_後端)
                *   [1.3.2.1.2 終端機介面](#終端機介面)
            *   [1.3.2.2 圖形介面](#圖形介面)
                *   [1.3.2.2.1 libtorrent-rasterbar 後端](#libtorrent-rasterbar_後端)
                *   [1.3.2.2.2 libktorrent 後端](#libktorrent_後端)
                *   [1.3.2.2.3 其他](#其他)
        *   [1.3.3 eDonkey 客戶端](#eDonkey_客戶端)
        *   [1.3.4 Gnutella](#Gnutella)
    *   [1.4 通訊](#通訊)
        *   [1.4.1 Email 客戶端](#Email_客戶端)
            *   [1.4.1.1 終端機](#終端機_3)
            *   [1.4.1.2 圖形](#圖形_2)
        *   [1.4.2 即時通訊](#即時通訊)
            *   [1.4.2.1 多埠客戶端](#多埠客戶端)
            ...
            *   [1.4.2.2 XMPP (Jabber)](#XMPP_(Jabber))
                *   [1.4.2.2.1 終端機客戶端](#終端機客戶端)
                *   [1.4.2.2.2 圖形客戶端](#圖形客戶端)
                *   [1.4.2.2.3 伺服器](#伺服器)
            *   [1.4.2.3 IRC 客戶端](#IRC_客戶端)
                *   [1.4.2.3.1 終端機](#終端機_5)
                *   [1.4.2.3.2 圖形](#圖形_4)
        *   [1.4.3 軟體電話](#軟體電話)
            *   [1.4.3.1 客戶端](#客戶端)
            *   [1.4.3.2 工具](#工具)
    *   [1.5 新聞、RSS 和部落格](#新聞、RSS_和部落格)
        *   [1.5.1 新聞收集器](#新聞收集器)
            *   [1.5.1.1 終端](#終端)
            *   [1.5.1.2 圖形](#圖形_5)
        *   [1.5.2 部落格軟體](#部落格軟體)
        *   [1.5.3 微網誌客戶端](#微網誌客戶端)
    *   [1.6 Pastebin 客戶端](#Pastebin_客戶端)
    *   [1.7 Bitcoin](#Bitcoin)
*   [2 多媒體](#多媒體)
    *   [2.1 編解碼器](#編解碼器)
    *   [2.2 圖像](#圖像)
        *   [2.2.1 圖像檢視器](#圖像檢視器)
            ...
            *   [2.2.1.2 圖形](#圖形_6)
        *   [2.2.2 圖形操作](#圖形操作)
            *   [2.2.2.1 點陣圖編輯器](#點陣圖編輯器)
            *   [2.2.2.2 向量圖形 - 繪畫](#向量圖形_-_繪畫)
            *   [2.2.2.3 向量圖形 - CAD](#向量圖形_-_CAD)
            *   [2.2.2.4 3D 模型/算繪](#3D_模型/算繪)
        *   [2.2.3 螢幕截取](#螢幕截取)
    *   [2.3 音訊](#音訊)
        *   [2.3.1 音訊系統](#音訊系統)
        *   [2.3.2 音訊播放器](#音訊播放器)
            *   [2.3.2.1 音樂播放器：守護程序與客戶端](#音樂播放器：守護程序與客戶端)
            *   [2.3.2.2 命令列播放器](#命令列播放器)
            *   [2.3.2.3 GUI 播放器](#GUI_播放器)
        *   [2.3.3 音量管理員](#音量管理員)
        *   [2.3.4 CD 抓軌](#CD_抓軌)
        *   [2.3.5 視覺化](#視覺化)
        *   [2.3.6 音訊標籤編輯器](#音訊標籤編輯器)
        *   [2.3.7 音訊編輯](#音訊編輯)
    *   [2.4 電話](#電話)
    *   [2.5 視訊](#視訊)
        *   [2.5.1 視訊播放器](#視訊播放器)
...
*   [3 工具](#工具_2)
    ...
    *   [3.4 檔案](#檔案)
        ...
        *   [3.4.3 壓縮工具](#壓縮工具)
            *   [3.4.3.1 終端機](#終端機_10)
            *   [3.4.3.2 圖形](#圖形_10)
        *   [3.4.4 比較、差異、合併](#比較、差異、合併)
        *   [3.4.5 批次重命名器](#批次重命名器)
    *   [3.5 硬碟使用量顯示程式](#硬碟使用量顯示程式)
    *   [3.6 系統監控](#系統監控)
    *   [3.7 系統資訊檢視器](#系統資訊檢視器)
        *   [3.7.1 終端機](#終端機_11)
        *   [3.7.2 圖形](#圖形_11)
...
*   [4 文件和文字](#文件和文字)
    ...
    *   [4.6 文字編輯器](#文字編輯器)
        *   [4.6.1 終端機](#終端機_12)
            *   [4.6.1.1 Vi 文字編輯器](#Vi_文字編輯器)
        *   [4.6.2 圖形](#圖形_12)
            *   [4.6.2.1 共筆文字編輯器](#共筆文字編輯器)
    *   [4.7 閱讀器和檢視器](#閱讀器和檢視器)
        *   [4.7.1 E-book 應用程式](#E-book_應用程式)
            *   [4.7.1.1 書本管理員](#書本管理員)
        *   [4.7.2 掃描/圖像](#掃描/圖像)
            *   [4.7.2.1 PDF](#PDF)
                *   [4.7.2.1.1 終端機](#終端機_13)
                *   [4.7.2.1.2 圖形](#圖形_13)
            *   [4.7.2.2 DjVu](#DjVu)
            *   [4.7.2.3 OCR 軟體](#OCR_軟體)
        *   [4.7.3 終端機分頁器](#終端機分頁器)
        *   [4.7.4 CHM](#CHM)
    *   [4.8 筆記組織](#筆記組織)
        *   [4.8.1 終端機](#終端機_14)
...
*   [6 科學](#科學)
    ...
    *   [6.2 數學](#數學)
        *   [6.2.1 計算機](#計算機)
        *   [6.2.2 電腦代數系統](#電腦代數系統)
        *   [6.2.3 科學或技術性計算](#科學或技術性計算)
        *   [6.2.4 統計](#統計)
        *   [6.2.5 資料評估](#資料評估)
    *   [6.3 化學和生物學](#化學和生物學)
        *   [6.3.1 計算生物學和生物資訊學](#計算生物學和生物資訊學)
        *   [6.3.2 分子檢視](#分子檢視)
        *   [6.3.3 分子繪圖](#分子繪圖)
        *   [6.3.4 週期表](#週期表)
        *   [6.3.5 生物化學](#生物化學)
...
*   [7 其他](#其他_2)
    *   [7.1 工作環境](#工作環境)
        ...
        *   [7.1.2 指令 shell](#指令_shell)
        *   [7.1.3 終端機多工器](#終端機多工器)
        *   [7.1.4 桌面環境](#桌面環境)
        *   [7.1.5 視窗管理員](#視窗管理員)
            *   [7.1.5.1 終端機](#終端機_15)
            *   [7.1.5.2 圖形](#圖形_15)
        *   [7.1.6 虛擬桌面分頁器](#虛擬桌面分頁器)
        *   [7.1.7 支援應用程式](#支援應用程式)
            *   [7.1.7.1 登入管理員](#登入管理員)
            *   [7.1.7.2 任務欄 / 面板 / Dock](#任務欄_/_面板_/_Dock)
            *   [7.1.7.3 應用程式啟動器](#應用程式啟動器)
            *   [7.1.7.4 登出對話框](#登出對話框)
    *   [7.2 整合開發環境](#整合開發環境)
    *   [7.3 財務](#財務)
    *   [7.4 時間管理](#時間管理)
...
see [Multimedia#Multimedia#CD_Ripping](/index.php/Multimedia#Multimedia#CD_Ripping "Multimedia")
...
參閱主文：[List of applications/Documents (正體中文)#科學文件](/index.php/List_of_applications/Documents_(%E6%AD%A3%E9%AB%94%E4%B8%AD%E6%96%87)#科學文件 "List of applications/Documents (正體中文)").

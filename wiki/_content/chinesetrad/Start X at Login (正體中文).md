...
這篇文章將解釋如何使 [X 伺服器](/index.php/X_server "X server")在登入虛擬終端機後自動啟動。利用 _startx_ 指令可以達到目的，並使用 [xinitrc](/index.php/Xinitrc "Xinitrc") 調整該指令的行為，例如選擇要啟動什麼[視窗管理員](/index.php/Window_manager "Window manager")。一種替代方案是使用[顯示管理員](/index.php/Display_Manager_(%E6%AD%A3%E9%AB%94%E4%B8%AD%E6%96%87) "Display Manager (正體中文)")，它會自動啟動 X 並提供圖形登入畫面。

...
*   [1 Pertanyaan Umum](#Pertanyaan_Umum)
    ...
    *   [1.2 Q) Apa alasan Saya untuk memakai Archlinux?](#Q)_Apa_alasan_Saya_untuk_memakai_Archlinux?)
    *   [1.3 Q) Apa alasan Saya untuk TIDAK memakai Archlinux?](#Q)_Apa_alasan_Saya_untuk_TIDAK_memakai_Archlinux?)
    *   [1.4 Q) Archlinux berbasis distro apa?](#Q)_Archlinux_berbasis_distro_apa?)
    *   [1.5 Q) Cocok kah pengguna pemula GNU/Linux menggunakan Archlinux?](#Q)_Cocok_kah_pengguna_pemula_GNU/Linux_menggunakan_Archlinux?)
    *   [1.6 Q) Apakah Arch didesain sebagai sebuah server? Desktop? *Workstation*?](#Q)_Apakah_Arch_didesain_sebagai_sebuah_server?_Desktop?_Workstation?)
    *   [1.7 Q) Alangkah lebih baiknya jika tim Archlinux menerapkan "fitur ini" ?](#Q)_Alangkah_lebih_baiknya_jika_tim_Archlinux_menerapkan_"fitur_ini"_?)
    *   [1.8 Q) Kapan rilis baru Archlinux dibuat?](#Q)_Kapan_rilis_baru_Archlinux_dibuat?)
    *   [1.9 Q) Is Arch Linux a stable distro? Will I get frequent breakage?](#Q)_Is_Arch_Linux_a_stable_distro?_Will_I_get_frequent_breakage?)
    *   [1.10 Q) What exactly *is* this 'BSD-style' init framework I keep hearing about?](#Q)_What_exactly_is_this_'BSD-style'_init_framework_I_keep_hearing_about?)
    *   [1.11 Q) Arch linux butuh lebih banyak sorotan publik (seperti sosialiasi)?](#Q)_Arch_linux_butuh_lebih_banyak_sorotan_publik_(seperti_sosialiasi)?)
    *   [1.12 Q) Apakah Archlinux membutuhkan lebih banyak developer?](#Q)_Apakah_Archlinux_membutuhkan_lebih_banyak_developer?)
    *   [1.13 Q) Kenapa Archlinux Saya lambat saat membuka aplikasi tertentu?](#Q)_Kenapa_Archlinux_Saya_lambat_saat_membuka_aplikasi_tertentu?)
    *   [1.14 Q) Kenapa koneksi internet Saya lebih lambat dari sistem operasi lainnya?](#Q)_Kenapa_koneksi_internet_Saya_lebih_lambat_dari_sistem_operasi_lainnya?)
    *   [1.15 Q) Kenapa Archlinux banyak menggunakan kapasitas RAM saat masuk desktop hingga 2Gb?](#Q)_Kenapa_Archlinux_banyak_menggunakan_kapasitas_RAM_saat_masuk_desktop_hingga_2Gb?)
*   [2 Manajemen Paket/aplikasi](#Manajemen_Paket/aplikasi)
    *   [2.1 Q) Saya menemukan error pada sebuah paket/aplikasi.Apa yang harus Saya lakukan?](#Q)_Saya_menemukan_error_pada_sebuah_paket/aplikasi.Apa_yang_harus_Saya_lakukan?)
    *   [2.2 Q) Apakah Archlinux mempunyai database untuk Pacman?](#Q)_Apakah_Archlinux_mempunyai_database_untuk_Pacman?)
    *   [2.3 Q) Archlinux harus mempunyai nama ekstensi file paket dengan format tersendiri karena .pkg.tar.gz dan .pkg.tar.xz terlalu panjang dan membingungkan](#Q)_Archlinux_harus_mempunyai_nama_ekstensi_file_paket_dengan_format_tersendiri_karena_.pkg.tar.gz_dan_.pkg.tar.xz_terlalu_panjang_dan_membingungkan)
    *   [2.4 Q) Pacman membutuhkan sebuah pustaka yang berisi tentang informasi paket/aplikasi](#Q)_Pacman_membutuhkan_sebuah_pustaka_yang_berisi_tentang_informasi_paket/aplikasi)
    *   [2.5 Q) Kenapa Pacman tidak mempunyai versi khusus dengan GUI?](#Q)_Kenapa_Pacman_tidak_mempunyai_versi_khusus_dengan_GUI?)
    *   [2.6 Q) Pacman membutuhkan *"Fitur X"*](#Q)_Pacman_membutuhkan_"Fitur_X")
    *   [2.7 Q) Archlinux membutuhkan repositori khusus berisi paket/aplikasi paling stabil](#Q)_Archlinux_membutuhkan_repositori_khusus_berisi_paket/aplikasi_paling_stabil)
    *   [2.8 Q) Apa perbedaan antara semua repositori tersebut?](#Q)_Apa_perbedaan_antara_semua_repositori_tersebut?)
    *   [2.9 Q) Saya baru saja menginstall paket/aplikasi "nama_paket/aplikasi".Bagaimana cara membukanya?](#Q)_Saya_baru_saja_menginstall_paket/aplikasi_"nama_paket/aplikasi".Bagaimana_cara_membukanya?)
*   [3 Proses Instalasi](#Proses_Instalasi)
    *   [3.1 Q) Archlinux membutuhkan proses installasi yang lebih baik.Mungkin installasi dengan GUI ketimbang mode teks?](#Q)_Archlinux_membutuhkan_proses_installasi_yang_lebih_baik.Mungkin_installasi_dengan_GUI_ketimbang_mode_teks?)
    *   [3.2 Q) Desktop Environment/Window Manager manakah yang seharusnya Saya gunakan?](#Q)_Desktop_Environment/Window_Manager_manakah_yang_seharusnya_Saya_gunakan?)
    *   [3.3 Q) Apa yang membedakan Archlinux dengan distro "minimalis" lainnya?](#Q)_Apa_yang_membedakan_Archlinux_dengan_distro_"minimalis"_lainnya?)
*   [4 Pertanyaan Lainnya](#Pertanyaan_Lainnya)
    *   [4.1 Q) Pesan error 'warning: current locale is invalid; using default "C" locale' saat menggunakan Pacman.Apa yang harus Saya lakukan?](#Q)_Pesan_error_'warning:_current_locale_is_invalid;_using_default_"C"_locale'_saat_menggunakan_Pacman.Apa_yang_harus_Saya_lakukan?)
    *   [4.2 Q) Bagaimana cara terhubung ke koneksi nirkabel seperti wifi?](#Q)_Bagaimana_cara_terhubung_ke_koneksi_nirkabel_seperti_wifi?)
    *   [4.3 Q) Bagaimana cara terhubung ke jaringan kabel?](#Q)_Bagaimana_cara_terhubung_ke_jaringan_kabel?)
    *   [4.4 Q) Dari tadi Saya sering menemui perihal AUR.Apakah itu AUR?](#Q)_Dari_tadi_Saya_sering_menemui_perihal_AUR.Apakah_itu_AUR?)
    *   [4.5 Q) Kenapa layar saya menjadi hijau saat menonton video?](#Q)_Kenapa_layar_saya_menjadi_hijau_saat_menonton_video?)
    *   [4.6 Q) Pengecek ejaan kata menganggap semua teks 'salah'.Kenapa?](#Q)_Pengecek_ejaan_kata_menganggap_semua_teks_'salah'.Kenapa?)

...
**Причина:** Переменная [#GPG_AGENT_INFO](#GPG_AGENT_INFO) устарела начиная с [gnupg](https://www.archlinux.org/packages/?name=gnupg)-2.1\. Обратитесь к [#Unattended passphrase](#Unattended_passphrase) за новым методом. ([Обсудить](https://wiki.archlinux.org/index.php/Talk:GnuPG_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)))
...
Для упрощения процедуры подписи ключей и отправку этих подписей владельцам ключей вы можете воспользоваться утилитой _caff_. Установить ее можно из [AUR](/index.php/AUR_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "AUR (Русский)") с пакетом [caff-svn](https://aur.archlinux.org/packages/caff-svn/)<sup><small>AUR</small></sup>. Там же доступен [signing-party-svn](https://aur.archlinux.org/packages/signing-party-svn/)<sup><small>AUR</small></sup> — набор удобных инструментов, включающий также _caff_. Так или иначе, потребуется установить много зависимостей из AUR. Как вариант, вы можете загрузить и установить эти зависимости из CPAN:
...
**Причина:** Смотрите [#GPG AGENT INFO](#GPG_AGENT_INFO). (обсуждение: [Talk:GnuPG (Русский)#](https://wiki.archlinux.org/index.php/Talk:GnuPG_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)))
...
**Причина:** Is `MODE="664"` necessary? Assigning a group, `MODE="660"` may be enough? (обсуждение: [Talk:GnuPG (Русский)#](https://wiki.archlinux.org/index.php/Talk:GnuPG_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)))
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=GnuPG_(Русский)&oldid=411769](https://wiki.archlinux.org/index.php?title=GnuPG_(Русский)&oldid=411769)"

[Categories](/index.php/Special:Categories "Special:Categories"):

*   [Encryption (Русский)](/index.php/Category:Encryption_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Category:Encryption (Русский)")

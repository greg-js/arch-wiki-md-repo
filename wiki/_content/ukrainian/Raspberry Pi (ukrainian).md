...
Продуктивність і швидкість реагування системи в цілому можна поліпшити шляхом внесення змін в конфігурацію системи. Більше про це дивіться [Maximizing performance](/index.php/Maximizing_performance "Maximizing performance").

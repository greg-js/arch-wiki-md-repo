...
Ще не працює? Спробуйте цей пакет з AUR [gstreamer0.10-good-plugins-ossv4](https://aur.archlinux.org/packages/gstreamer0.10-good-plugins-ossv4/), змініть pkgver на найновіше в PKGBUILD, і воно має запрацювати.

...
Щоб gdm став вашим способом авторизації за замовчуванням, змініть файл `/etc/inittab`, або ж пропишіть демона "gdm" в секцію DAEMONS файлу `/etc/rc.conf`. Обидва способи описані в [цієї статті](/index.php/Display_manager_(%D0%A3%D0%BA%D1%80%D0%B0%D1%97%D0%BD%D1%81%D1%8C%D0%BA%D0%B0) "Display manager (Українська)")

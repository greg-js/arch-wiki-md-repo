...
Деякі теми GTK+ 2 рекомендовані до встановлення. Поширена тема _Clearlooks_ входить до пакунку [gtk-engines](https://www.archlinux.org/packages/?name=gtk-engines):
...
Налаштування клавіш швидкого доступу в GTK додатках (котрі називаються ще _прискорювачі_ в GTK термінології) можна зробити за допомогою миші, навівши її над пунктом меню і натиснувши бажану комбінацію клавіш. Однак, ця функція вимкнена за замовчуванням. Щоб її увімкнути, встановіть

...
Although Adobe RGB is a common profile, sRGB profiles (especially the new v4 version also [available in the AUR](https://aur.archlinux.org/packages.php?ID=32999)) is also used often.

...
**Notes:** Condense into a Note in that article (Discuss in [Talk:PDF forms#](https://wiki.archlinux.org/index.php/Talk:PDF_forms))
...
**Reason:** please use the first argument of the template to provide a brief explanation. (Discuss in [Talk:PDF forms#](https://wiki.archlinux.org/index.php/Talk:PDF_forms))

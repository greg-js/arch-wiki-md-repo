...
_Python — высокоуровневый язык программирования общего назначения, ориентированный на повышение производительности разработчика и читаемости кода. Синтаксис ядра Python минималистичен. В то же время стандартная библиотека включает большой объём полезных функций._

_Python поддерживает несколько парадигм программирования, в том числе структурное, объектно-ориентированное, функциональное, императивное и аспектно-ориентированное. Основные архитектурные черты — динамическая типизация, автоматическое управление памятью, полная интроспекция, механизм обработки исключений, поддержка многопоточных вычислений и удобные высокоуровневые структуры данных. Код в Python организовывается в функции и классы, которые могут объединяться в модули (они, в свою очередь, могут быть объединены в пакеты)._
...
**Эта статья или раздел является кандидатом на объединение с [Python VirtualEnv](/index.php/Python_VirtualEnv "Python VirtualEnv").**

**Причина:** пожалуйста, используйте второй аргумент шаблона для указания причины. (обсуждение: [Talk:Python (Русский)#](https://wiki.archlinux.org/index.php/Talk:Python_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)))
...
Затем создайте символьную ссылку `python`, указывающую на _python2_, и еще одну для конфигурационных скриптов:
...
Наконец, добавьте ваш вновь созданный каталог _в начало_ значения вашей переменной `PATH`:
...
**Обратите внимание:** Изменение [переменных окружения](/index.php/Environment_variables_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Environment variables (Русский)") подобным образом не является долговременным и действует только в текущем сеансе терминала
...
**Причина:** Описанные действия ведут лишь к "обману" переменной PATH, смотрите [[1]](https://gist.github.com/IngCr3at1on/3f5260581901e3035d9e)<sup>[[устаревшая ссылка](https://en.wikipedia.org/wiki/Wikipedia:Link_rot "wikipedia:Wikipedia:Link rot") 2015-08-08]</sup> (обсуждение: [Talk:Python (Русский)#](https://wiki.archlinux.org/index.php/Talk:Python_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)))
...
**Обратите внимание:** Этот совет относится только к Python 2, начиная с версии 3.4 [автодополнение по клавише Tab](https://docs.python.org/3/tutorial/interactive.html) по умолчанию включено
...
*   [python24](https://aur.archlinux.org/packages/python24/)<sup><small>AUR</small></sup><sup>[[ссылка недействительна](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): сохранено в [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/python24)]</sup>: Python 2.4.6
...
*   [python31](https://aur.archlinux.org/packages/python31/)<sup><small>AUR</small></sup><sup>[[ссылка недействительна](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): сохранено в [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/python31)]</sup>: Python 3.1.5
...
*   [Crash into Python](http://stephensugden.com/crash_into_python/) - также известное под названием _Python for Programmers with 3 Hours_, это руководство предоставляет опытным разработчикам на других языках интенсивный курс по освоению Python
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Python_(Русский)&oldid=414757](https://wiki.archlinux.org/index.php?title=Python_(Русский)&oldid=414757)"

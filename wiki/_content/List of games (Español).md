...
**Reason:** add newly ported games (such as Steam games and HIB). (Discuss in [Talk:List of games (Español)#](https://wiki.archlinux.org/index.php/Talk:List_of_games_(Espa%C3%B1ol)))
...
[http://www.koshutin.com/](http://www.koshutin.com/) || [hammerfight](https://aur.archlinux.org/packages/hammerfight/)<sup><small>AUR</small></sup>
...
*   **[Frogatto](https://en.wikipedia.org/wiki/Frogatto "wikipedia:Frogatto")** — Plataforma de juego divertido, que consiste en ayudar a un pequeño hombre verde llamado Frogatto a caminar y saltar entre puntos de apoyo sólidos sin hacerse daño; eche un vistazo a [this review](http://www.slidetoplay.com/story/frogatto-review).
...
*   **Pinball** — Simulador pinball de código abierto para Linux y otros sistemas Unix.
...
[http://www.parallelrealities.co.uk/projects/virusKiller.php](http://www.parallelrealities.co.uk/projects/virusKiller.php)<sup>[[dead link](https://en.wikipedia.org/wiki/Wikipedia:Link_rot "wikipedia:Wikipedia:Link rot") 2013-05-19]</sup> || [viruskiller](https://aur.archlinux.org/packages/viruskiller/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/viruskiller)]</sup>
...
*   **BSD Games** — Colección de juegos de texto clásicos distribuidos con estido BSD.
...
*   **Dofus** — Juego multijugador masivo en línea (siglas en inglés MMORPG), gratuito, inspirado en manga, que utiliza Adobe AIR.
...
[https://sourceforge.net/projects/netris/](https://sourceforge.net/projects/netris/) || [netris](https://aur.archlinux.org/packages/netris/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/netris)]</sup>
...
*   **Simon Tatham's Portable Puzzle Collection.** — Mas de treinta juegos de puzzle «rápidos» con una simple y pulida interfaz basada en GTK.
...
*   **Speed Dreams** — Fork de Torcs, con el objetivo de implementar nuevas e interesantes características, así como mejorar el realismo.
...
*   **Counter-Strike Source** — Juego FPS semirrealista, basado en equipos que usa Source Engine.
...
*   Datos de Doom 1 Demo – [doom1-wad](https://aur.archlinux.org/packages/doom1-wad/)<sup><small>AUR</small></sup>
...
*   **Remood** — Motor avanzado del juego Doom basado en Doom Legacy.
...
*   **Half-Life 2** — Juego FPS de ciencia ficción. También hay expansiones disponibles Lost Coat, Episode One y Epise Two. En fase beta desde julio de 2013.
...
*   Datos del juego Heretic Demo – [heretic1-wad](https://aur.archlinux.org/packages/heretic1-wad/)<sup><small>AUR</small></sup>
...
*   Datos del juego Hexen 1 Demo – [hexen1-wad](https://aur.archlinux.org/packages/hexen1-wad/)<sup><small>AUR</small></sup>
...
*   Motor de juego avanzado Quake 1 – [darkplaces](https://aur.archlinux.org/packages/darkplaces/)<sup><small>AUR</small></sup>
*   Otro puerto moderno para el motor de Quake1 – [fitzquake](https://aur.archlinux.org/packages/fitzquake/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/fitzquake)]</sup>
*   Proyecto gratuito que reemplaza el contenido de Quake 1 – [oqplus-svn](https://aur.archlinux.org/packages/oqplus-svn/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/oqplus-svn)]</sup>
*   Texturas de alta calidad para Quake del proyecto Quake Revitalization Project – [quake-qrp-textures](https://aur.archlinux.org/packages/quake-qrp-textures/)<sup><small>AUR</small></sup>

*   **Quake 2** — Compilado por Icculus
...
*   Motor avanzado de Quake 2 – [qudos-svn](https://aur.archlinux.org/packages/qudos-svn/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/qudos-svn)]</sup>
*   Motor mejorado de Quake 2 con soporte para mod Lazarus – [kmquake2](https://aur.archlinux.org/packages/kmquake2/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/kmquake2)]</sup>
*   Un paquete que proporcina retexturación de color auténtico para Quetoo y otros motores para Quake2 con soporte de texturas tga 32bpp – [quake2-retexture](https://aur.archlinux.org/packages/quake2-retexture/)<sup><small>AUR</small></sup>
*   Motor de Quake 2 enfocado a un solo jugador y 64bits. [yamagi-quake2](https://aur.archlinux.org/packages/yamagi-quake2/)<sup><small>AUR</small></sup>

*   Quake III Arena

*   Binarios de Quake III Arena – [quake3](https://aur.archlinux.org/packages/quake3/)<sup><small>AUR</small></sup>
...
*   Vesión Demo – [quake4-demo](https://aur.archlinux.org/packages/quake4-demo/)<sup><small>AUR</small></sup>
*   Motor Quake 4 – [quake4](https://aur.archlinux.org/packages/quake4/)<sup><small>AUR</small></sup>
...
[Instaladores de Linux para juegos de Linux](http://liflg.org/?catid=6&gameid=83) || <small>not packaged? [search in AUR](https://aur.archlinux.org/packages/?K=serioussam2)</small>
...
[http://www.unrealtournament2004.com](http://www.unrealtournament2004.com) || [ut2004](https://aur.archlinux.org/packages/ut2004/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/ut2004)]</sup> para la versión comercial, [ut2004-anthology](https://aur.archlinux.org/packages/ut2004-anthology/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/ut2004-anthology)]</sup> para la versión antológica.
...
*   FPS totalmente gratis, independiente, basado en equipos, multijugador – [enemy-territory](https://aur.archlinux.org/packages/enemy-territory/)<sup><small>AUR</small></sup>
*   Fork avanzado de código abierto del motor ET, con cliente y servidor completamente compatibles – [etlegacy](https://aur.archlinux.org/packages/etlegacy/)<sup><small>AUR</small></sup>
*   Fork avanzado de código abierto del motor ET – [iowolfet-hg](https://aur.archlinux.org/packages/iowolfet-hg/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/iowolfet-hg)]</sup>, [bin32-iowolfet-hg](https://aur.archlinux.org/packages/bin32-iowolfet-hg/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/bin32-iowolfet-hg)]</sup>
...
**Reason:** Some random trash I can not even test. TODO: apply [Template:App](/index.php/Template:App "Template:App"). (Discuss in [Talk:List of games (Español)#](https://wiki.archlinux.org/index.php/Talk:List_of_games_(Espa%C3%B1ol)))
...
*   **Dark Oberon** — Juego de estrategia en tiempo real de código abierto, similar a Warcraft II.
...
*   **[Netpanzer](https://en.wikipedia.org/wiki/Netpanzer "wikipedia:Netpanzer")** — Juego de estrategia en tiempo real como Command y Conquer, pero sin compilar las bases.

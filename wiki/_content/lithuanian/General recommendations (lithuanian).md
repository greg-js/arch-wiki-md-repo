...
*   [1 Sistemos administravimas](#Sistemos_administravimas)
    ...
    *   [1.2 Privilegijos pakėlimas](#Privilegijos_pakėlimas)
    *   [1.3 Servisų valdymas](#Servisų_valdymas)
    *   [1.4 Sistemos priežiūra](#Sistemos_priežiūra)
*   [2 Paketų valdymas](#Paketų_valdymas)
    *   [2.1 pacman](#pacman)
    *   [2.2 Saugyklos](#Saugyklos)
    *   [2.3 Veidrodžiai](#Veidrodžiai)
    *   [2.4 Arch Build sistema](#Arch_Build_sistema)
    *   [2.5 Arch User Repository](#Arch_User_Repository)
*   [3 Paleidimas](#Paleidimas)
    *   [3.1 Techninės įrangos auto-pažinimas](#Techninės_įrangos_auto-pažinimas)
    *   [3.2 Mikrokodas](#Mikrokodas)
    *   [3.3 Paleidimo pranešimų išsaugojimas](#Paleidimo_pranešimų_išsaugojimas)
    *   [3.4 Num Lock aktyvacija](#Num_Lock_aktyvacija)
*   [4 Grafinė naudotojo sąsaja](#Grafinė_naudotojo_sąsaja)
    *   [4.1 Ekrano serveris](#Ekrano_serveris)
    *   [4.2 Ekrano tvarkyklės](#Ekrano_tvarkyklės)
    *   [4.3 Darbastalio aplinkos](#Darbastalio_aplinkos)
    *   [4.4 Langų tvarkyklės](#Langų_tvarkyklės)
    *   [4.5 Ekrano valdyklės](#Ekrano_valdyklės)
*   [5 Energijos valdymas](#Energijos_valdymas)
    *   [5.1 ACPI įvykiai](#ACPI_įvykiai)
    *   [5.2 CPU dažnio kėlimas](#CPU_dažnio_kėlimas)
    *   [5.3 Nešiojamieji kompiuteriai](#Nešiojamieji_kompiuteriai)
    *   [5.4 Sustabdymas ir užmigdymas](#Sustabdymas_ir_užmigdymas)
*   [6 Multimedija](#Multimedija)
    *   [6.1 Garsas](#Garsas)
    *   [6.2 Naršyklės įskiepiai](#Naršyklės_įskiepiai)
    *   [6.3 Kodekai](#Kodekai)
*   [7 Tinklas](#Tinklas)
    *   [7.1 Laikrodžio sinchronizacija](#Laikrodžio_sinchronizacija)
    *   [7.2 DNS saugumas](#DNS_saugumas)
    *   [7.3 Užkardos nustatymas](#Užkardos_nustatymas)
    *   [7.4 Dalinimasis resursais](#Dalinimasis_resursais)
*   [8 Įvesties įrenginiai](#Įvesties_įrenginiai)
    *   [8.1 Klaviatūros išdėstymai](#Klaviatūros_išdėstymai)
    *   [8.2 Pelės mygtukai](#Pelės_mygtukai)
    *   [8.3 Nešiojamojo kompiuterio padelis](#Nešiojamojo_kompiuterio_padelis)
    *   [8.4 TrackPoints](#TrackPoints)
*   [9 Optimizavimas](#Optimizavimas)
    *   [9.1 Lyginamoji analizė](#Lyginamoji_analizė)
    *   [9.2 Našumo gerinimas](#Našumo_gerinimas)
    *   [9.3 Solid state diskai](#Solid_state_diskai)
*   [10 Sistemos servisai](#Sistemos_servisai)
    *   [10.1 Failų indeksavimas ir paieška](#Failų_indeksavimas_ir_paieška)
    *   [10.2 Vietinio pašto pristatymas](#Vietinio_pašto_pristatymas)
    *   [10.3 Spausdinimas](#Spausdinimas)
*   [11 Išvaizda](#Išvaizda)
    *   [11.1 Šriftai](#Šriftai)
    *   [11.2 GTK+ ir Qt temos](#GTK+_ir_Qt_temos)
*   [12 Konsolės patobulinimai](#Konsolės_patobulinimai)
    *   [12.1 Tab-užbaigimo patobulinimai](#Tab-užbaigimo_patobulinimai)
    *   [12.2 Trumpiniai](#Trumpiniai)
    *   [12.3 Alternatyvūs apvalkalai](#Alternatyvūs_apvalkalai)
    *   [12.4 Bash papildymai](#Bash_papildymai)
    *   [12.5 Spalvota išvestis](#Spalvota_išvestis)
    *   [12.6 Suspausti failai](#Suspausti_failai)
    *   [12.7 Konsolės eilutė](#Konsolės_eilutė)
    *   [12.8 Emacs apvalkalas](#Emacs_apvalkalas)
    *   [12.9 Pelės palaikymas](#Pelės_palaikymas)
    *   [12.10 Atgalinės slinkties buferis](#Atgalinės_slinkties_buferis)

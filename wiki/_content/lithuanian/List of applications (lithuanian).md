...
Šis straipsnis tai bendras programų sąrašas suskirstytas kateogrijomis, kaip nuoroda ieškantiems paketų. Daugima skyrių padalinti į konsolines ir grafines programas.

**Tip:**

*   Šis puslapis egzistuoja, pirmiausiai, lengvesnei alternatyvių programų paieškai, kai nežinoma kuriam skyriui programa priklauso. Naudokite nuorodas šablono viršuje kad matytumėte pagrindinius skyrius atskiruose puslapiuose.
*   Pagalvokite apie [pkgstats](/index.php/Pkgstats "Pkgstats") paketo [įdiegimą](/index.php/Install "Install"), kuris Arch Linux programuotojams siunčia jūsų instaliuotų paketų sąrašą, kartu su architektūra bei naudojamais veidrodžiais, taip leidžiant prioritetizuoti pastangas ir padaryti distribuciją dar geresne. Informacija siunčiama anonimiškai ir jūsų identifikuoti negali. Surinktus duomenis galite pamatyti [statistikos puslapyje](https://www.archlinux.de/?page=Statistics). Daugiau informacijos rasite [šioje forumo gijoje](https://bbs.archlinux.org/viewtopic.php?id=105431).
*   Daemon paketai dažnai turi atitinkamą systemd unit'o failą reikalingą [startui](/index.php/Start "Start"); kai kurie paketai įtraukia kelis skirtingus. Po įdiegimo, `pacman -Qql *package* | grep -Fe .service -e .socket` gali būti panaudota rasti tinkamam failui.

**Note:** Porgramos "Konsolė" skyriuje, gali turėti grafines sąsajas. Oficialios šiuo metu nėra įtrauktos.
...
*   [3 Utilities](#Utilities)
    ...
    *   [3.2 Files](#Files)
        ...
        *   [3.2.5 Comparison, diff, merge](#Comparison.2C_diff.2C_merge)
...
*   [4 Documents and texts](#Documents_and_texts)
    ...
    *   [4.6 Readers and viewers](#Readers_and_viewers)
        ...
        *   [4.6.2 PDF and DjVu](#PDF_and_DjVu)
            *   [4.6.2.1 Console](#Console_20)
            *   [4.6.2.2 Graphical](#Graphical_20)
                *   [4.6.2.2.1 Annotation](#Annotation)
                *   [4.6.2.2.2 Manipulation](#Manipulation)
        *   [4.6.3 CHM](#CHM)
        *   [4.6.4 Comic book](#Comic_book)
    *   [4.7 Scanning software](#Scanning_software)
    *   [4.8 OCR software](#OCR_software)
        *   [4.8.1 OCR engines](#OCR_engines)
        *   [4.8.2 Layout analyzers](#Layout_analyzers)
    *   [4.9 Notes](#Notes)
        *   [4.9.1 Note-taking software](#Note-taking_software)
            *   [4.9.1.1 Console](#Console_21)
            *   [4.9.1.2 Graphical](#Graphical_21)
        *   [4.9.2 Diary](#Diary)
        *   [4.9.3 Mind-mapping](#Mind-mapping)
        *   [4.9.4 Sticky notes](#Sticky_notes)
    *   [4.10 Special writing environments](#Special_writing_environments)
        *   [4.10.1 Distraction-free writing](#Distraction-free_writing)
        *   [4.10.2 Story writing](#Story_writing)
        *   [4.10.3 Screenwriting](#Screenwriting)
    *   [4.11 Language](#Language)
        *   [4.11.1 Dictionary and thesaurus](#Dictionary_and_thesaurus)
        *   [4.11.2 Spell checkers](#Spell_checkers)
        *   [4.11.3 Translation and localization](#Translation_and_localization)
    *   [4.12 Barcode generators and readers](#Barcode_generators_and_readers)
        *   [4.12.1 Console](#Console_22)
        *   [4.12.2 Graphical](#Graphical_22)
*   [5 Security](#Security)
    ...
    *   [5.9 Cryptography](#Cryptography)
        ...
        *   [5.9.2 Encryption, signing, steganography](#Encryption.2C_signing.2C_steganography)
...
*   [8 Taip pat žiūrėti](#Taip_pat_.C5.BEi.C5.ABr.C4.97ti)
...
**Bendros programinės įrangos sąrašai**
...
*   [alternativeto.net](https://alternativeto.net/platform/linux/) - Linux alternatyvos populiarioms programoms.
*   [Linux App Finder](https://linuxappfinder.com/all) - Linux programų direktorija.
*   [Debian paketai](https://packages.debian.org) ir [kopijos](https://screenshots.debian.net)
*   [Linux Alternative Project](http://www.linuxalt.com/) - Linux ekvivalentai Windows programoms.
*   [Open Source Alternative](https://www.osalt.com/) - Alternatyvos komercinėms programoms.
*   [Linux Links](http://www.linuxlinks.com/) - Programų ir straipsnių direktorija.

**Programinės įrangos [kalvės](https://en.wikipedia.org/wiki/Forge_(software) "wikipedia:Forge (software)")**

*   [Sourceforge.net](https://sourceforge.net/) - Atvirojo kodo programinės įrangos kalvė
*   [Launchpad.net](https://launchpad.net/projects/+all) - Atvirojo kodo programinės įrangos kalvė
*   [Gitlab.com](https://gitlab.com/explore) - Atvirojo kodo programinės įrangos kalvė
*   [GitHub.com](https://github.com/explore**) - Atvirojo kodo programinės įrangos kalvė

**Specializuotos programinės įrangos sąrašai**

*   [K.Mandla's blog](https://kmandla.wordpress.com/software/) - Terminalo programų kopijos ir apžvalgos.
*   [Inconsolation](https://inconsolation.wordpress.com/index/) - Lengva ir minimalistinė programinė įranga.
*   [awesome-shell](https://github.com/alebcay/awesome-shell) - Komandinės eilutės sistemos, įrankių rinkiniai ir gidai.
*   [awesome-selfhosted](https://github.com/Kickball/awesome-selfhosted) - Tinklo servisai ir žiniatinklio programos.
*   [Libre Projects](http://libreprojects.net/) - Atvirjojo kodo žiniatinklio servisai.
*   [awesome-sysadmin](https://github.com/n1trux/awesome-sysadmin) - Programinė įranga sistemų administratoriams.
*   [awesome-linuxaudio](https://github.com/nodiscc/awesome-linuxaudio) - programinė įranga garso/vaizdo/transliacijos produkcijai.
*   [PRISM Break](https://prism-break.org/en/all/) - Programinė įranga prieš masinį sekimą.
*   [Privacy Tools](https://www.privacytools.io/) - Žinios ir įrankiai asmeninio privatumo apsaugai nuo masinio stebėjimo.
*   [lin-app.com](http://lin-app.com/) - Komercinės programos ir žaidimai Linux'ams.

**Arch Linux forumo gijos**

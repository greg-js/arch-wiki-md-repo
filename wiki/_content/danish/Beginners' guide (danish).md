...
| WEP med Hex Key | `iwconfig wlan0 essid "linksys" key "0241baf34c"` |
| WEP med ASCII kodeord | `iwconfig wlan0 essid "linksys" key "s:pass1"` |
...
Quicktime-kodeks er med i pakken [codecs](https://aur.archlinux.org/packages/codecs/). Skriv blot
...
Kodeks til Realplayer 9 s er med i pakken [codecs](https://aur.archlinux.org/packages/codecs/). Skriv blot
...
for at installere dem. Realplayer 10 er tilgængelig som binær pakke til Linux. Du kan få den fra AUR: [realplayer](https://aur.archlinux.org/packages/realplayer/).

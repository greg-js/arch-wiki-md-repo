...
*   [4 Redigere xorg.conf](#Redigere_xorg.conf)
    *   [4.1 Skærmindstillinger](#Sk.C3.A6rmindstillinger)
        *   [4.1.1 Horizontal Sync (Horisontal synkronisering)](#Horizontal_Sync_.28Horisontal_synkronisering.29)
        *   [4.1.2 Refresh Rate (Genopfriskningsrate)](#Refresh_Rate_.28Genopfriskningsrate.29)
        *   [4.1.3 Colour Depth (Farvedybe)](#Colour_Depth_.28Farvedybe.29)
        *   [4.1.4 Resolution (Opløsning)](#Resolution_.28Opl.C3.B8sning.29)
    *   [4.2 Tastaturindstillinger](#Tastaturindstillinger)
        *   [4.2.1 Tastatur-layout](#Tastatur-layout)
        *   [4.2.2 Tastatur-model](#Tastatur-model)
    *   [4.3 Skærmstørrelse/DPI](#Sk.C3.A6rmst.C3.B8rrelse.2FDPI)
    *   [4.4 Proprietære drivere](#Propriet.C3.A6re_drivere)
    *   [4.5 Fonte](#Fonte)
    *   [4.6 Eksempler på Xorg.conf-file](#Eksempler_p.C3.A5_Xorg.conf-file)
*   [5 Køre Xorg](#K.C3.B8re_Xorg)
*   [6 Finpudse opstarten af X (/usr/bin/startx)](#Finpudse_opstarten_af_X_.28.2Fusr.2Fbin.2Fstartx.29)
*   [7 Ændringer med modulær Xorg](#.C3.86ndringer_med_modul.C3.A6r_Xorg)
    ...
    *   [7.4 Ændrede søgestier (og konfiguration)](#.C3.86ndrede_s.C3.B8gestier_.28og_konfiguration.29)
*   [8 Fejlfinding](#Fejlfinding)
    ...
    *   [8.3 Et hurtigt fiks af filkonflikter i /usr/include](#Et_hurtigt_fiks_af_filkonflikter_i_.2Fusr.2Finclude)
    ...
    *   [8.6 Tastaturproblemer](#Tastaturproblemer_2)
        ...
        *   [8.6.2 Kan ikke sætte 'qwerty'-layout op med kommandoen 'setxkbmap'](#Kan_ikke_s.C3.A6tte_.27qwerty.27-layout_op_med_kommandoen_.27setxkbmap.27)
        *   [8.6.3 Opsætning af fransk-canadisk layout (gammel 'ca_enhanced)](#Ops.C3.A6tning_af_fransk-canadisk_layout_.28gammel_.27ca_enhanced.29)
    *   [8.7 Manglende biblioteker](#Manglende_biblioteker)
    *   [8.8 Bygning af nogle pakker fejler, og der klages over manglende X11-inkluderinger](#Bygning_af_nogle_pakker_fejler.2C_og_der_klages_over_manglende_X11-inkluderinger)
    *   [8.9 Ikke i stamd til at indlæse fonten '(null)'](#Ikke_i_stamd_til_at_indl.C3.A6se_fonten_.27.28null.29.27)
    *   [8.10 KDE opgavelinje/skrivebordsikoner ødelagt](#KDE_opgavelinje.2Fskrivebordsikoner_.C3.B8delagt)
    *   [8.11 Opdatering fra 'testing'-version til 'extra'- (manglende filer)](#Opdatering_fra_.27testing.27-version_til_.27extra.27-_.28manglende_filer.29)
    *   [8.12 Problemer med MIME-typer i forskellige skrivebordsmiljøer](#Problemer_med_MIME-typer_i_forskellige_skrivebordsmilj.C3.B8er)
    *   [8.13 DRI virker ikke længere med Matrox-kort](#DRI_virker_ikke_l.C3.A6ngere_med_Matrox-kort)
    *   [8.14 Kan ikke starte nogen klient under 'Xephyr'](#Kan_ikke_starte_nogen_klient_under_.27Xephyr.27)
*   [9 Links](#Links)

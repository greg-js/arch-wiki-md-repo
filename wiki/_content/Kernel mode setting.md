...
See [Fonts#Changing the default font](/index.php/Fonts#Changing_the_default_font "Fonts") for how to change your console font to a large font. The Terminus font ([terminus-font](https://www.archlinux.org/packages/?name=terminus-font)) is available in many sizes, including larger sizes.

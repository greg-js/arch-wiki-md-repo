...
**Αυτό το άρθρο χρειάζεται [μετάφραση.](/index.php/ArchWiki_Translation_Team_(%CE%95%CE%BB%CE%BB%CE%B7%CE%BD%CE%B9%CE%BA%CE%AC) "ArchWiki Translation Team (Ελληνικά)")**

**Σημειώσεις:** Η σελίδα βρίσκεται σε διαδικασία μετάφρασης ([Discuss](https://wiki.archlinux.org/index.php/Talk:Iptables_(%CE%95%CE%BB%CE%BB%CE%B7%CE%BD%CE%B9%CE%BA%CE%AC)))

...
*   <s>Verify kernel and udev version, because this also depends on the resolution of [ArchWiki_talk:Reports#Minimum_supported_kernel_version](/index.php/ArchWiki_talk:Reports#Minimum_supported_kernel_version "ArchWiki talk:Reports").</s>
...
-- [Kynikos](/index.php/User:Kynikos "User:Kynikos") ([talk](/index.php/User_talk:Kynikos "User talk:Kynikos")) 06:41, 2 August 2014 (UTC)
...
Why not just visit [Special:Log/delete](/index.php/Special:Log/delete "Special:Log/delete"). Any difference here?--[Fengchao](/index.php/User:Fengchao "User:Fengchao") ([talk](/index.php/User_talk:Fengchao "User talk:Fengchao")) 13:32, 9 August 2014 (UTC)
...
<th><s>Delete, don't look back</s>  
(current method, not a solution)</th>

<th><s>Separate namespace</s>  
(discarded)</th>

<th>Redirect to a page like  
"ArchWiki:Deleted"</th>

<th>Publicize [Special:Undelete](/index.php/Special:Undelete "Special:Undelete")</th>

</tr>

<tr>

<td>Type of archive operation</td>
...
<td>redirect  
<small>(i.e. modify content, then protect<sup>questioned</sup>)</small></td>
...
<td>Permission to perform archiving</td>

<td> ???</td>

<td>admins</td>

<td>depends on [config](https://www.mediawiki.org/wiki/Manual:$wgNamespaceProtection "mw:Manual:$wgNamespaceProtection")</td>
...
<td>Permission to undo archiving</td>

<td> ???</td>

<td>admins</td>

<td>depends on [config](https://www.mediawiki.org/wiki/Manual:$wgNamespaceProtection "mw:Manual:$wgNamespaceProtection") (?)  
<small>(can be forced w/ copy/paste)</small></td>
...
<td>Page titles show in wiki search results</td>
...
<td>yes  
<small>(if redirects are included)</small></td>
...
<td>Page content shows in wiki search results</td>
...
<td>Page titles/content show in external search results</td>
...
with [1](https://www.mediawiki.org/wiki/Manual:$wgExemptFromUserRobotsControl "mw:Manual:$wgExemptFromUserRobotsControl") or [2](https://www.mediawiki.org/wiki/Manual:$wgNamespaceRobotPolicies "mw:Manual:$wgNamespaceRobotPolicies"))</small></td>
...
<td> ???  
<small>(ask upstream)</small></td>

</tr>

<tr>

<td>Pollutes other pages' backlinks and special pages</td>
...
<td>Can link to archived revisions</td>
...
We'll also need a news entry to make this official, <s>I'll probably get there by the upcoming weekend in absence of substantial objections</s>. Please help improve the procedure in case I missed something: it will have to be moved to [Help:Procedures](/index.php/Help:Procedures "Help:Procedures") once enforced.
...
Redirection diffs look like [this](https://wiki.archlinux.org/index.php?title=Mount_encrypted_volumes_in_parallel&diff=next&oldid=373289), pretty hard to miss, and they're also usually accompanied by a bold-red negative byte count in RecentChanges, something that always immediately attracts my attention.
...
-- [Lahwaacz](/index.php/User:Lahwaacz "User:Lahwaacz") ([talk](/index.php/User_talk:Lahwaacz "User talk:Lahwaacz")) 14:58, 19 August 2015 (UTC)
...
-- [Kynikos](/index.php/User:Kynikos "User:Kynikos") ([talk](/index.php/User_talk:Kynikos "User talk:Kynikos")) 03:38, 11 October 2014 (UTC)
...
--[Indigo](/index.php/User:Indigo "User:Indigo") ([talk](/index.php/User_talk:Indigo "User talk:Indigo")) 12:59, 14 December 2014 (UTC)
...
-- [Kynikos](/index.php/User:Kynikos "User:Kynikos") ([talk](/index.php/User_talk:Kynikos "User talk:Kynikos")) 13:36, 7 November 2014 (UTC)
...
*   <s>[Bug Day/2010](/index.php/Bug_Day/2010 "Bug Day/2010") - No changeable instances</s>
...
I checked backlinks to [Kodi](/index.php/Kodi "Kodi") of the now moved article. I think we got it covered. Can this be closed? --[Indigo](/index.php/User:Indigo "User:Indigo") ([talk](/index.php/User_talk:Indigo "User talk:Indigo")) 09:22, 4 January 2015 (UTC)

Thank you Indigo, unfortunately there's [more](https://wiki.archlinux.org/index.php?title=Special%3ASearch&search=xbmc&fulltext=Search), including an entry in [List of applications/Multimedia](/index.php/List_of_applications/Multimedia "List of applications/Multimedia") and an entire section in [XScreenSaver](/index.php/XScreenSaver "XScreenSaver") :) — [Kynikos](/index.php/User:Kynikos "User:Kynikos") ([talk](/index.php/User_talk:Kynikos "User talk:Kynikos")) 09:21, 5 January 2015 (UTC)

Ah, thanks for search fu. I amended the last two for starters of this lot [[8]](https://wiki.archlinux.org/index.php?title=List_of_applications%2FMultimedia&diff=355510&oldid=353008) [[9]](https://wiki.archlinux.org/index.php?title=XScreenSaver&diff=355511&oldid=345221). Simple thing to watch for the [rest](https://wiki.archlinux.org/index.php?title=Special%3ASearch&search=xbmc&fulltext=Search) is that the config directory stays `~/.xmbc/`. --[Indigo](/index.php/User:Indigo "User:Indigo") ([talk](/index.php/User_talk:Indigo "User talk:Indigo")) 14:50, 5 January 2015 (UTC)
...
As of today, there are exactly 714 invalid uses (413 unique) of [Template:AUR](/index.php/Template:AUR "Template:AUR") or [Template:Pkg](/index.php/Template:Pkg "Template:Pkg"), spread across 398 pages. The complete list is on <s>[User:Lahwaacz.bot/Report 2014-04-05](/index.php?title=User:Lahwaacz.bot/Report_2014-04-05&action=edit&redlink=1 "User:Lahwaacz.bot/Report 2014-04-05 (page does not exist)")</s>. I will try to go through it and update the links, but this is not a one-man job, so I would really appreciate some help. Please remember to strike/remove the items from the list to save others' time. -- [Lahwaacz](/index.php/User:Lahwaacz "User:Lahwaacz") ([talk](/index.php/User_talk:Lahwaacz "User talk:Lahwaacz")) 16:42, 5 April 2014 (UTC)

The previous report is closed for further updates, please contribute to <s>[User:Lahwaacz.bot/Report 2014-05-11](/index.php/User:Lahwaacz.bot/Report_2014-05-11 "User:Lahwaacz.bot/Report 2014-05-11")</s>. -- [Lahwaacz](/index.php/User:Lahwaacz "User:Lahwaacz") ([talk](/index.php/User_talk:Lahwaacz "User talk:Lahwaacz")) 09:15, 12 May 2014 (UTC)

The previous reports are closed for further updates, please contribute to <s>[User:Lahwaacz.bot/Report 2014-12-24](/index.php/User:Lahwaacz.bot/Report_2014-12-24 "User:Lahwaacz.bot/Report 2014-12-24")</s>. -- [Lahwaacz](/index.php/User:Lahwaacz "User:Lahwaacz") ([talk](/index.php/User_talk:Lahwaacz "User talk:Lahwaacz")) 13:14, 25 December 2014 (UTC)

The previous reports are closed for further updates, please contribute to [User:Lahwaacz.bot/Report 2015-02-06](/index.php/User:Lahwaacz.bot/Report_2015-02-06 "User:Lahwaacz.bot/Report 2015-02-06"). -- [Lahwaacz](/index.php/User:Lahwaacz "User:Lahwaacz") ([talk](/index.php/User_talk:Lahwaacz "User talk:Lahwaacz")) 23:08, 6 February 2015 (UTC)

After introducing "package not found" link, should the bot pages above be removed now? --[Fengchao](/index.php/User:Fengchao "User:Fengchao") ([talk](/index.php/User_talk:Fengchao "User talk:Fengchao")) 13:05, 10 March 2015 (UTC)

I'll delete them eventually, for now I think they could be useful for searching through the user notes when fixing localized pages (not that many user do this...) First I will need to implement the automatic report page as suggested in [#Strategy for updating package templates](#Strategy_for_updating_package_templates). -- [Lahwaacz](/index.php/User:Lahwaacz "User:Lahwaacz") ([talk](/index.php/User_talk:Lahwaacz "User talk:Lahwaacz")) 13:00, 13 March 2015 (UTC)

#### Surrounding link text

While performing [#Cleanup: links to non-existent packages](#Cleanup:_links_to_non-existent_packages), the bot updated a lot of package links, but of course it couldn't update the text around them accordingly, for example [[10]](https://wiki.archlinux.org/index.php?title=Smokeping&diff=prev&oldid=308608), so that's something else that could be done. Here's the list of the changes: <s>[[11]](https://wiki.archlinux.org/index.php?limit=250&tagfilter=&title=Special%3AContributions&contribs=user&target=Lahwaacz.bot&namespace=&year=2014&month=4)</s>. -- [Kynikos](/index.php/User:Kynikos "User:Kynikos") ([talk](/index.php/User_talk:Kynikos "User talk:Kynikos")) 03:24, 7 April 2014 (UTC)

Technical detail: the last link is now slightly inaccurate, it shows all edits of the bot made in April 2014\. Is there a way to set a specific day? (in this case 5th April) -- [Lahwaacz](/index.php/User:Lahwaacz "User:Lahwaacz") ([talk](/index.php/User_talk:Lahwaacz "User talk:Lahwaacz")) 21:46, 9 April 2014 (UTC)

Cool, there's really a way, I've just noticed it :D [https://wiki.archlinux.org/index.php?title=Special:Contributions&target=Lahwaacz.bot&offset=20140406000000](https://wiki.archlinux.org/index.php?title=Special:Contributions&target=Lahwaacz.bot&offset=20140406000000) (the magic is in the `offset` parameter!) -- [Kynikos](/index.php/User:Kynikos "User:Kynikos") ([talk](/index.php/User_talk:Kynikos "User talk:Kynikos")) 13:51, 11 April 2014 (UTC)

Update: the edit list for the 2014-05-11 cleanup is [[12]](https://wiki.archlinux.org/index.php?title=Special:Contributions&target=Lahwaacz.bot&offset=20140512000000). -- [Kynikos](/index.php/User:Kynikos "User:Kynikos") ([talk](/index.php/User_talk:Kynikos "User talk:Kynikos")) 09:42, 12 May 2014 (UTC)

Update: the edit list for the 2014-12-24 cleanup is [[13]](https://wiki.archlinux.org/index.php?title=Special:Contributions&target=Lahwaacz.bot&offset=20141225000000). -- [Lahwaacz](/index.php/User:Lahwaacz "User:Lahwaacz") ([talk](/index.php/User_talk:Lahwaacz "User talk:Lahwaacz")) 13:14, 25 December 2014 (UTC)

Update: the edit list for the 2015-02-06 cleanup is [[14]](https://wiki.archlinux.org/index.php?title=Special:Contributions&target=Lahwaacz.bot&offset=20150207000000). -- [Lahwaacz](/index.php/User:Lahwaacz "User:Lahwaacz") ([talk](/index.php/User_talk:Lahwaacz "User talk:Lahwaacz")) 23:08, 6 February 2015 (UTC)
...
*   It's consistent with [Template:Dead link](/index.php/Template:Dead_link "Template:Dead link").

Why would method 2\. "be more favourable to the bot"?

— [Kynikos](/index.php/User:Kynikos "User:Kynikos") ([talk](/index.php/User_talk:Kynikos "User talk:Kynikos")) 00:51, 11 February 2015 (UTC)

The second method would only add checking additional templates. The first method would need checking for an adjacent template, which could be tricky to implement. I haven't tried it yet though, in the end it may be equally easy to the second method. -- [Lahwaacz](/index.php/User:Lahwaacz "User:Lahwaacz") ([talk](/index.php/User_talk:Lahwaacz "User talk:Lahwaacz")) 07:59, 11 February 2015 (UTC)

Other thing is that one of the mistakes when using AUR/Pkg/Grp templates is invalid number of parameters, e.g. [[15]](https://wiki.archlinux.org/index.php?title=Internationalization/Korean&diff=359911&oldid=353001). If the additional parameters are to be preserved and not automatically removed by the bot, this would be impossible to mark using the second way. Well, almost impossible, we could still set the hint using a named parameter, but it would be really unclear how the link marked this way should be "fixed". So we should definitely use the first method. -- [Lahwaacz](/index.php/User:Lahwaacz "User:Lahwaacz") ([talk](/index.php/User_talk:Lahwaacz "User talk:Lahwaacz")) 19:32, 11 February 2015 (UTC)
...
Either method would be great. One suggestion regarding the current report pages: How about still producing them additionally, but onto a static page (overwritten on next run, noting a schedule, e.g. quarterly, on top)? Reason: Particularly if an editor wants to fix articles of a language, [Special:WhatLinksHere](/index.php/Special:WhatLinksHere "Special:WhatLinksHere") is unwieldy to swim through for articles in the language. --[Indigo](/index.php/User:Indigo "User:Indigo") ([talk](/index.php/User_talk:Indigo "User talk:Indigo")) 10:20, 12 February 2015 (UTC)

I could certainly still produce the reports. Also being it a static page, the updating could be done automatically similarly to [ArchWiki:Statistics](/index.php/ArchWiki:Statistics "ArchWiki:Statistics") (so far I have created the report pages manually).

I have implemented the first method in the [bot script](https://github.com/lahwaacz/wiki-scripts/commit/3e7e1103ee7a0560ce7d8f298055e4dec8ea6fc8) today. Since it has taken me almost half a day, it was probably not "equally easy" to the second method, but I think it works quite well and safely now. [Template:Broken package link](/index.php/Template:Broken_package_link "Template:Broken package link") is now created and its "broken link" link points to [#Broken package links](#Broken_package_links), feel free to improve both.

I was also thinking about how to integrate [#Surrounding link text](#Surrounding_link_text) into [#Broken package links](#Broken_package_links), maybe the link to the bot's "contributions" with fixed date should be automatically put somewhere on each run? This task also depends too much on context, so the links like [[16]](https://wiki.archlinux.org/index.php?title=Special:Contributions&target=Lahwaacz.bot&offset=20150207000000) are not very useful. In a way, it is already marked on the pages, because the link points e.g. to AUR and the context says otherwise. Also, we probably don't have the workforce to do systematic checking on this task, so is it even worth to include these instructions/links?

-- [Lahwaacz](/index.php/User:Lahwaacz "User:Lahwaacz") ([talk](/index.php/User_talk:Lahwaacz "User talk:Lahwaacz")) 20:59, 12 February 2015 (UTC)
...
Regarding the template: I would leave out "the hint" because the sup-text gets too long and breaks text badly on small resolutions. "Broken link" should be enough, not? Also I would let "Broken link" link itself to [Template:Broken_package_link](/index.php/Template:Broken_package_link "Template:Broken package link"). This way we can change the link to the instructions ([#Broken_package_links](#Broken_package_links)) noted there in case they move (e.g. to [ArchWiki:Contributing](/index.php/ArchWiki:Contributing "ArchWiki:Contributing")) at a later point, or we decide to expand the instructions in the template itself a little, without needing a bot run over existing broken links again. --[Indigo](/index.php/User:Indigo "User:Indigo") ([talk](/index.php/User_talk:Indigo "User talk:Indigo")) 22:45, 12 February 2015 (UTC)
...
Having the instructions on this page has the advantage that it is linked from the navigation bar on the left, whereas [Template:Broken package link](/index.php/Template:Broken_package_link "Template:Broken package link") would not be as easily discovered "by accident". The template page should serve mainly as a description of the template itself and just link to the instructions, so I'd leave it this way. Of course if the instructions are moved, the link in the template can be updated accordingly.

-- [Lahwaacz](/index.php/User:Lahwaacz "User:Lahwaacz") ([talk](/index.php/User_talk:Lahwaacz "User talk:Lahwaacz")) 15:32, 13 February 2015 (UTC)
...
The problem of grouping broken links by language would IMO be more naturally solved with localized [Template:Broken package link](/index.php/Template:Broken_package_link "Template:Broken package link") templates, instead of using a report: it would be easy to add this feature to the bot.

The problem of the context wording is clearly unsolvable automatically, but for completeness I would mention it briefly in [#Broken package links](#Broken_package_links). I don't think adding any links is going to be of any usefulness; in theory a list of the changes could indeed be maintained in a report, and the entries stricken whenever each link's surrounding text is manually checked to be mentioning the correct location of the package; I'm not sure how popular such a list would be though, and the text would also be fixed anyway by casual users whenever they notice the inconsistency while reading the article. An alternative is using the bot to only always add the broken link template, even when the package template could be updated automatically, letting instead the users do all the actual updates manually; this method could be integrated with Wiki Monkey's editor assistant, which would complete the template updates in the editor, but still allow checking the changes before saving (already implemented there).

About leaving out "the hint", maybe we could instead remove "broken link: " and move the link to "the hint". Would adding a light-red background to "the hint" help having it recognized as a link status template, even if "broken link: " isn't there anymore? But still, this method would make the template inconsistent with [Template:Dead link](/index.php/Template:Dead_link "Template:Dead link"), unless we want to update that one too.

If we want the link to [ArchWiki:Requests#Broken package links](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests") to be flexible in case we want to move the instructions somewhere else, I'd say the most natural way would be to use a redirect like [Broken package link](/index.php?title=Broken_package_link&action=edit&redlink=1 "Broken package link (page does not exist)") that we can point to wherever we want.

— [Kynikos](/index.php/User:Kynikos "User:Kynikos") ([talk](/index.php/User_talk:Kynikos "User talk:Kynikos")) 15:50, 13 February 2015 (UTC)
...
Administrators can't configure the entry-point urls, that's something that should be done in LocalSettings.php, which however is currently unpatchable because of [FS#35545](https://bugs.archlinux.org/task/35545).

Nonetheless I agree with you, urls could be prettified by removing "index.php/", I think [wiki.archlinux.fr](https://wiki.archlinux.fr/Sp%C3%A9cial:Version#URL%20des%20points%20d%27entr%C3%A9e) has the best configuration in this respect. Documentation is in [mw:Manual:Short URL/LocalSettings.php](https://www.mediawiki.org/wiki/Manual:Short_URL/LocalSettings.php "mw:Manual:Short URL/LocalSettings.php"). Backward compatibility wouldn't be a problem since urls can be easily rewritten by the http server.

— [Kynikos](/index.php/User:Kynikos "User:Kynikos") ([talk](/index.php/User_talk:Kynikos "User talk:Kynikos")) 01:49, 7 March 2015 (UTC)

I have noticed, that article's path became _[https://wiki.archlinux.org/index.php/Page_title](https://wiki.archlinux.org/index.php/Page_title)_. Better, but still with ugly index.php. I agree with you, french arch linux wiki did varian which I wanted: just clearly _[https://wiki.example.com/Page_title](https://wiki.example.com/Page_title)_. But according to [[17]](https://www.mediawiki.org/wiki/Manual:Wiki_in_site_root_directory) it is not recommended in some cases. As I understand, it just do not allow you (Pierre) to use some titles as articles, for example [https://wiki.example.com/favicon.ico](https://wiki.example.com/favicon.ico), but really, what reason to have such articles =D. And another problem may be that it may require root access to hosting server. Does wiki.archlinux.org is running on virtual server or it is hosted on a normal server? — [Agent0](/index.php/User:Agent0 "User:Agent0") ([talk](/index.php/User_talk:Agent0 "User talk:Agent0")|[contribs](/index.php/Special:Contributions/Agent0 "Special:Contributions/Agent0")) 09:59, 17 August 2015 (UTC)
...
(2) I like your idea of using a "/dev/disks/by-uuid/[<s>YOUR</s>UUID] /mnt" format (we call other instances of such 'pseudo-variables'). Still, if you used it in an article context, e.g. an encrypted LVM, you would still have to more verbosely describe **which** dev/blockdevice/vg/lv UUID is meant to be mounted on /mnt. I still can't really picture for myself how writing and reading it is easier in general.

As I wrote above, I agree we might need to pinpoint the advantages of persistent naming more, but we do some already (e.g. right from the start: [Beginners' guide#Generate an fstab](/index.php/Beginners%27_guide#Generate_an_fstab "Beginners' guide")). In short I believe we are better off with the way we have it (no rule on it, as long as the contribution fits the article contributed to all editors may choose what's best in context). That's it from me. Looking forward to read feedback & other opinions. --[Indigo](/index.php/User:Indigo "User:Indigo") ([talk](/index.php/User_talk:Indigo "User talk:Indigo")) 20:46, 31 March 2015 (UTC)

IMO man page examples are sometimes a bit behind "new standards". That's natural and this shouldn't prevent us from moving a bit more forward. With Arch we have [UUIDs](https://en.wikipedia.org/wiki/Universally_Unique_Identifier) - lets use them :)
...
*   Just enter **lsblk -f** and it's obvious which UUID points to which drive in any context (raid, luks, lvm, ...). As this [Get UUID example](http://dpaste.com/3RYFAPY) shows, just copy the corresponding UUID and use it with all UUID Wiki examples. IMHO it's quite easy.
...
[T.ask](/index.php?title=User:T.ask&action=edit&redlink=1 "User:T.ask (page does not exist)") ([talk](/index.php/User_talk:T.ask "User talk:T.ask")) 12:45, 1 April 2015 (UTC)

Hi, T.ask, thank you for discussing this, however I'm not sure if this is all only theoretical or you have a precise idea of how to put it into practice, because after reading all the discussion I haven't understood very well how this idea would change our articles. At this stage you must choose one of our _important_ articles, e.g. [LVM](/index.php/LVM "LVM"), and explain us how the article would change in details, so we can discuss on something more tangible. — [Kynikos](/index.php/User:Kynikos "User:Kynikos") ([talk](/index.php/User_talk:Kynikos "User talk:Kynikos")) 14:37, 2 April 2015 (UTC)

Hi, Kynikos. Yes, it's always better to have a good practical example if things seem to be complicated. I'm quite busy right now. When I find the time, I will start changing the Wiki (slowly) as I mentioned before. [LVM](/index.php/LVM "LVM") is a nice example, while I would like to start with those sections which are easier to adapt and more commonly used. Especially if I need to add a new subsection (How do you work with UUIDs) beforehand. --[T.ask](/index.php?title=User:T.ask&action=edit&redlink=1 "User:T.ask (page does not exist)") ([talk](/index.php/User_talk:T.ask "User talk:T.ask")) 10:44, 21 April 2015 (UTC)

As I said, it would be better if you showed us an example here or in your User page _before_ starting to actually "chang[e] the Wiki". Take your time of course :) — [Kynikos](/index.php/User:Kynikos "User:Kynikos") ([talk](/index.php/User_talk:Kynikos "User talk:Kynikos")) 02:30, 22 April 2015 (UTC)
...
Well, the user and group database files are handled also from [filesystem.install](https://projects.archlinux.org/svntogit/packages.git/tree/trunk/filesystem.install?h=packages/filesystem#n15) so the only difference I ever got from a .pacnew file was different ordering or (compatible) database format changes. Anyway, I'm wondering as well what is the best way to handle the .pacnew for these 4 files. -- [Lahwaacz](/index.php/User:Lahwaacz "User:Lahwaacz") ([talk](/index.php/User_talk:Lahwaacz "User talk:Lahwaacz")) 21:46, 18 April 2015 (UTC)

Thanks. Searching the BBS yields a few threads, e.g. [[18]](https://bbs.archlinux.org/viewtopic.php?id=194095). All I saw seem to suggest the files can be deleted. I remember an update where bash path changed; the .pacnew used `/usr/bin` while the original still had `/bin` path. I guess that would count as an example under "compatible" changes. A manual sorting with _pwck_ and _grpck_ could be part of the explanation how to diff the files before deletion. Also _grpconv_ and _pwconv_ should be mentioned briefly in my opinion. I added [[19]](https://wiki.archlinux.org/index.php?title=Users_and_groups&diff=370749&oldid=368309) and [[20]](https://wiki.archlinux.org/index.php?title=Pacnew_and_Pacsave_files&diff=370753&oldid=363010) for now.

Anyone has input for (2.) or (3.) above? --[Indigo](/index.php/User:Indigo "User:Indigo") ([talk](/index.php/User_talk:Indigo "User talk:Indigo")) 09:33, 23 April 2015 (UTC)
...
+1, but I'd place it into [General troubleshooting](/index.php/General_troubleshooting "General troubleshooting"). -- [Lahwaacz](/index.php/User:Lahwaacz "User:Lahwaacz") ([talk](/index.php/User_talk:Lahwaacz "User talk:Lahwaacz")) 07:52, 19 September 2015 (UTC)

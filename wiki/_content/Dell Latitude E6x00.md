...
The [Installation guide](/index.php/Installation_guide "Installation guide") should get you running without a problem.

Further help can be found in the Forum:

*   [Linux on the Dell Latitude E6400](https://bbs.archlinux.org/viewtopic.php?id=65440)
*   [Dell Latitude E6400 internal mic not working](https://bbs.archlinux.org/viewtopic.php?id=65249)

## Throttling

This series is known to severely throttle the CPU even on moderately high temperatures.
...
Kernel 2.6.28.x - follow instruction in [Dell Latitude E6400 internal mic not working](https://bbs.archlinux.org/viewtopic.php?id=65249)

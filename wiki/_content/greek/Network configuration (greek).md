...
*   [3 Οδηγός Συσκευής (Device driver)](#Οδηγός_Συσκευής_(Device_driver))
    *   [3.1 Έλεγχος κατάστασης συσκευής](#Έλεγχος_κατάστασης_συσκευής)
    *   [3.2 Φόρτωση λειτουργικής μονάδας (module)](#Φόρτωση_λειτουργικής_μονάδας_(module))
*   [4 Διασυνδέσεις δικτύου](#Διασυνδέσεις_δικτύου)
    *   [4.1 Ονομασία συσκευών](#Ονομασία_συσκευών)
        *   [4.1.1 Αλλαγή ονόματος συσκευής](#Αλλαγή_ονόματος_συσκευής)
    *   [4.2 Ορισμός της μονάδας μέγιστης μετάδοσης (MTU) και μεγέθους ουράς (queue Length)](#Ορισμός_της_μονάδας_μέγιστης_μετάδοσης_(MTU)_και_μεγέθους_ουράς_(queue_Length))
    *   [4.3 Βρείτε τα τρέχοντα ονόματα των συσκευών](#Βρείτε_τα_τρέχοντα_ονόματα_των_συσκευών)
    *   [4.4 Ενεργοποίηση και απενεργοποίηση συσκευών δικτύου](#Ενεργοποίηση_και_απενεργοποίηση_συσκευών_δικτύου)
*   [5 Ρύθμιση της διεύθυνσης ip](#Ρύθμιση_της_διεύθυνσης_ip)
    *   [5.1 Δυναμική διεύθυνση ip](#Δυναμική_διεύθυνση_ip)
        *   [5.1.1 Χειροκίνητη εκκίνηση DHCP Client Daemon](#Χειροκίνητη_εκκίνηση_DHCP_Client_Daemon)
        *   [5.1.2 Ενεργοποίηση DHCP κατά την εκκίνηση](#Ενεργοποίηση_DHCP_κατά_την_εκκίνηση)
    *   [5.2 Στατική διεύθυνση ip](#Στατική_διεύθυνση_ip)
        *   [5.2.1 Χειροκίνητη απόδοση στατικής ip](#Χειροκίνητη_απόδοση_στατικής_ip)
        *   [5.2.2 Χειροκίνητη σύνδεση κατά την εκκίνηση με χρήση του systemd](#Χειροκίνητη_σύνδεση_κατά_την_εκκίνηση_με_χρήση_του_systemd)
        *   [5.2.3 Υπολογισμός διευθύνσεων](#Υπολογισμός_διευθύνσεων)
*   [6 Φόρτωση ρυθμίσεων](#Φόρτωση_ρυθμίσεων)
*   [7 Συμπληρωματικές ρυθμίσεις](#Συμπληρωματικές_ρυθμίσεις)
    *   [7.1 ifplugd για laptops](#ifplugd_για_laptops)
    *   [7.2 Ενσωμάτωση ή Συσσώρευση συνδέσεων (Bonding or LAG)](#Ενσωμάτωση_ή_Συσσώρευση_συνδέσεων_(Bonding_or_LAG))
    *   [7.3 IP address aliasing](#IP_address_aliasing)
        *   [7.3.1 Παράδειγμα](#Παράδειγμα)
    *   [7.4 Αλλαγή διεύθυνσης MAC/hardware](#Αλλαγή_διεύθυνσης_MAC/hardware)
    *   [7.5 Κοινή χρήση δικτύου (Sharing Internet)](#Κοινή_χρήση_δικτύου_(Sharing_Internet))
    *   [7.6 Διαμόρφωση δρομολογητή (Router)](#Διαμόρφωση_δρομολογητή_(Router))
    *   [7.7 Ανάλυση ονομασίας κεντρικού υπολογιστή δικτύου (Host name resolution)](#Ανάλυση_ονομασίας_κεντρικού_υπολογιστή_δικτύου_(Host_name_resolution))
*   [8 Αντιμετώπιση προβλημάτων](#Αντιμετώπιση_προβλημάτων)
    *   [8.1 Εναλλαγή υπολογιστών σε καλωδιακό μόντεμ (cable modem)](#Εναλλαγή_υπολογιστών_σε_καλωδιακό_μόντεμ_(cable_modem))
    *   [8.2 Το πρόβλημα του εύρους τιμής του TCP](#Το_πρόβλημα_του_εύρους_τιμής_του_TCP)
        *   [8.2.1 Αναγνώριση του προβλήματος](#Αναγνώριση_του_προβλήματος)
        *   [8.2.2 Επίλυση του προβλήματος (Η λάθος μέθοδος)](#Επίλυση_του_προβλήματος_(Η_λάθος_μέθοδος))
        *   [8.2.3 Επίλυση του προβλήματος (Η σωστή μέθοδος)](#Επίλυση_του_προβλήματος_(Η_σωστή_μέθοδος))
        *   [8.2.4 Επίλυση του προβλήματος (Η βέλτιστη μέθοδος)](#Επίλυση_του_προβλήματος_(Η_βέλτιστη_μέθοδος))
        *   [8.2.5 Περισσότερα](#Περισσότερα)
    *   [8.3 Πρόβλημα με Realtek (no link / WOL)](#Πρόβλημα_με_Realtek_(no_link_/_WOL))
        *   [8.3.1 Μέθοδος 1 - Υποβάθμιση/αλλαγή οδηγού Windows](#Μέθοδος_1_-_Υποβάθμιση/αλλαγή_οδηγού_Windows)
        *   [8.3.2 Μέθοδος 2 - Ενεργοποίηση του WOL στον οδηγό των Windows](#Μέθοδος_2_-_Ενεργοποίηση_του_WOL_στον_οδηγό_των_Windows)
        *   [8.3.3 Μέθοδος 3 - Νεώτερος οδηγός Realtek Linux](#Μέθοδος_3_-_Νεώτερος_οδηγός_Realtek_Linux)
        *   [8.3.4 Μέθοδος 4 - Ενεργοποίηση *LAN Boot ROM* στο BIOS/CMOS](#Μέθοδος_4_-_Ενεργοποίηση_LAN_Boot_ROM_στο_BIOS/CMOS)
    *   [8.4 Πρόβλημα με DNS στο DLink G604T/DLink G502T](#Πρόβλημα_με_DNS_στο_DLink_G604T/DLink_G502T)
        *   [8.4.1 Πως θα αναγνωρίσετε το πρόβλημα](#Πως_θα_αναγνωρίσετε_το_πρόβλημα)
        *   [8.4.2 Περισσότερα για αυτό το πρόβλημα](#Περισσότερα_για_αυτό_το_πρόβλημα)
    *   [8.5 Έλεγχος προβλήματος DHCP με αποδέσμευση ΙΡ](#Έλεγχος_προβλήματος_DHCP_με_αποδέσμευση_ΙΡ)
    *   [8.6 Απουσία ενσύρματης σύνδεσης eth0 με Atheros AR8161](#Απουσία_ενσύρματης_σύνδεσης_eth0_με_Atheros_AR8161)
    *   [8.7 Απουσία ενσύρματης σύνδεσης eth0 με Atheros AR9485](#Απουσία_ενσύρματης_σύνδεσης_eth0_με_Atheros_AR9485)
    *   [8.8 Ανυπαρξία φορέα / σύνδεσης μετά από αναστολή λειτουργίας (Suspend)](#Ανυπαρξία_φορέα_/_σύνδεσης_μετά_από_αναστολή_λειτουργίας_(Suspend))
...
Αν αυτή η μέθοδος αποτύχει, θα πρέπει να δημιουργήσετε έναν κλώνο της διεύθυνσης MAC του αρχικού υπολογιστή. Δείτε επίσης [Change MAC/hardware address](/index.php/Configuring_Network#Change_MAC/hardware_address "Configuring Network").

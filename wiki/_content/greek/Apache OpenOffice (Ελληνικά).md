...
*   Κάντε εγκατάσταση ένα ή περισσότερα γλωσσικά πακέτα.Το βήμα αυτό είναι προαιρετικό μια και τα Αγγλικά _περιλαμβάνονται_ στο πακέτο base:
...
Η ίδια διαδικασία ισχύει εάν το OOo τερματίζεται με μια εξαίρεση σαν _terminate called after throwing an instance of com::sun::star::uno::RuntimeException_.Αυτό μπορεί να γίνει σε μια αναβάθμιση,π.χ. από OOo 2.2 σε 2.3.

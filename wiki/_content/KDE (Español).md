...
**Notes:** please use the first argument of the template to provide more detailed indications. (Discuss in [Talk:KDE (Español)#](https://wiki.archlinux.org/index.php/Talk:KDE_(Espa%C3%B1ol)))
...
**Reason:** It's May 31st 2015 and this article hasn't been updated in 3 years. (Discuss in [Talk:KDE (Español)#](https://wiki.archlinux.org/index.php/Talk:KDE_(Espa%C3%B1ol)))
...
*   Plasma 5 no es co-instalable con KDE 4 Workspace, proporcionado por [kdebase-workspace](https://aur.archlinux.org/packages/kdebase-workspace/)<sup><small>AUR</small></sup>.
...
Para instalar el conjunto completo de aplicaciones de KDE, instale el grupo de aplicaciones [kde-aplicactions](https://www.archlinux.org/groups/x86_64/kde-aplicactions/)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): package not found]</sup> o el meta-paquetes de KDE [kde-applications-meta](https://www.archlinux.org/packages/?name=kde-applications-meta) meta paquete para instalar módulos específicos. **Tenga en cuenta que esto sólo va a instalar aplicaciones, no va a instalar cualquier versión del escritorio Plasma.**
...
KDE utiliza **inotify** directamente desde el núcleo utilizando **kdirwatch** (incluido en kdelibs), por lo tanto no son necesarios Gamin o FAM. Puede que desee instalar este paquete ([kdirwatch](https://aur.archlinux.org/packages/kdirwatch/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/kdirwatch)]</sup>de AUR) que es un entorno GUI para kdirwatch.
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=KDE_(Español)&oldid=412811](https://wiki.archlinux.org/index.php?title=KDE_(Español)&oldid=412811)"

[Category](/index.php/Special:Categories "Special:Categories"):

*   [KDE (Español)](/index.php/Category:KDE_(Espa%C3%B1ol) "Category:KDE (Español)")
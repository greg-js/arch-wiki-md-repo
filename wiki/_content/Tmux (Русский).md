...
Чтобы перейти по URL, который появляется в tmux, должен быть установлен и настроен [urlview](https://aur.archlinux.org/packages/urlview/)<sup><small>AUR</small></sup>.
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Tmux_(Русский)&oldid=417102](https://wiki.archlinux.org/index.php?title=Tmux_(Русский)&oldid=417102)"

...
After the configuration is done, [enable](/index.php/Enable "Enable") the **ip6tables** service, it is meant to run in parallel to _iptables_.
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Simple_stateful_firewall_(简体中文)&oldid=414046](https://wiki.archlinux.org/index.php?title=Simple_stateful_firewall_(简体中文)&oldid=414046)"

...
Puppet's main configuration file is `puppet.conf` which is located at `/etc/puppet/puppet.conf`.
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Puppet&oldid=408997](https://wiki.archlinux.org/index.php?title=Puppet&oldid=408997)"

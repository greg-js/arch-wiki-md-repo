...
Después de reiniciar Xfce se agrega un enlace de "Red" a la barra lateral de Thunar y las ubicaciones remotas se pueden abrir con los siguientes esquemas de URI en el campo de diálogo (abierto con `Ctrl+L`): smb://, ftp://, [ssh://](ssh://), sftp://
...
<th>Patrones de archivos</th>

<th>Aparecerá si está en la selección</th>

</tr>

<tr>

<th>Analizar en busca de virus</th>
...
<th>Enlace a Dropbox</th>

<td>`ln -s %f /ruta/a/Carpeta_Dropbox`</td>

<td>*</td>

<td>Directorios, otros archivos</td>
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Thunar_(Español)&oldid=411651](https://wiki.archlinux.org/index.php?title=Thunar_(Español)&oldid=411651)"

[Category](/index.php/Special:Categories "Special:Categories"):

*   [File managers (Español)](/index.php/Category:File_managers_(Espa%C3%B1ol) "Category:File managers (Español)")
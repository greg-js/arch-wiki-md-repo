...
*   [2 General Information](#General_Information)
    *   [2.1 Important information](#Important_information)
    *   [2.2 Technical Specifications](#Technical_Specifications)
    *   [2.3 lspci (on model PTA83E)](#lspci_.28on_model_PTA83E.29)
*   [3 Installation](#Installation)
*   [4 State of the drivers](#State_of_the_drivers)
    *   [4.1 What works](#What_works)
    *   [4.2 What needs special hacks for getting to work](#What_needs_special_hacks_for_getting_to_work)
        *   [4.2.1 Audio system](#Audio_system)
        *   [4.2.2 Synaptics Touchpad](#Synaptics_Touchpad)

## Reference Information

For this wiki, I also used information from the Gentoo wiki (page no longer exists).
...
A BIOS update is mandatory so that Arch Linux can boot. Otherwise, the supplied BIOS gives a lot of APIC errors. The BIOS updating procedure can be done by using the software supplied by Toshiba at [bios update](http://eu.computers.toshiba-europe.com/cgi-bin/ToshibaCSG/download_bios.jsp). Note that this requires that you run the program on windows.
...
The integrated sound card works out of the box, but the integrated speakers don't. To enable the integrated speakers do:

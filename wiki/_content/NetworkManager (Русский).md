...
**Примечания:** пожалуйста, используйте первый аргумент шаблона для указания дополнительной информации. (обсуждение: [Talk:NetworkManager (Русский)#](https://wiki.archlinux.org/index.php/Talk:NetworkManager_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)))
...
The Plasma-nm front-end is a Plasma widget available in the official repositories as package [kdeplasma-applets-plasma-nm](https://www.archlinux.org/packages/?name=kdeplasma-applets-plasma-nm)<sup>[[ссылка недействительна](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): сохранено в [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/kdeplasma-applets-plasma-nm)]</sup>. The older KNetworkManager front-end Plasma widget is also available as package [kdeplasma-applets-networkmanagement](https://aur.archlinux.org/packages/kdeplasma-applets-networkmanagement/)<sup><small>AUR</small></sup> from the aur.
...
To solve the problem it should be sufficient to install [ppp-mppe](https://aur.archlinux.org/packages/ppp-mppe/)<sup><small>AUR</small></sup><sup>[[ссылка недействительна](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): сохранено в [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/ppp-mppe)]</sup>.
...
**Обратите внимание:** See [http://live.gnome.org/GnomeKeyring/Pam](http://live.gnome.org/GnomeKeyring/Pam) for reference, and if you are using [KDE](/index.php/KDE_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "KDE (Русский)") with [KDM](/index.php/KDM_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "KDM (Русский)"), you can use [pam-keyring-tool](https://aur.archlinux.org/packages/pam-keyring-tool/)<sup><small>AUR</small></sup><sup>[[ссылка недействительна](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): сохранено в [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/pam-keyring-tool)]</sup>
...
[kdeplasma-applets-plasma-nm](https://www.archlinux.org/packages/?name=kdeplasma-applets-plasma-nm)<sup>[[ссылка недействительна](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): сохранено в [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/kdeplasma-applets-plasma-nm)]</sup> does not support to configure username and password for OpenConnect VPN connections in its GUI. You have to type both values everytime you connect. [kdeplasma-applets-plasma-nm](https://www.archlinux.org/packages/?name=kdeplasma-applets-plasma-nm)<sup>[[ссылка недействительна](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): сохранено в [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/kdeplasma-applets-plasma-nm)]</sup> 0.9.3.2-1 and above is however capable of retrieving OpenConnect username and password directly from KWallet.
...
**Эта статья или раздел является кандидатом на объединение с [Настройка сети#Дополнительные настройки](/index.php/%D0%9D%D0%B0%D1%81%D1%82%D1%80%D0%BE%D0%B9%D0%BA%D0%B0_%D1%81%D0%B5%D1%82%D0%B8#.D0.94.D0.BE.D0.BF.D0.BE.D0.BB.D0.BD.D0.B8.D1.82.D0.B5.D0.BB.D1.8C.D0.BD.D1.8B.D0.B5_.D0.BD.D0.B0.D1.81.D1.82.D1.80.D0.BE.D0.B9.D0.BA.D0.B8 "Настройка сети").**

**Причина:** В этом разделе содержатся советы, применимые не только к данной программе (обсуждение: [Talk:NetworkManager (Русский)#](https://wiki.archlinux.org/index.php/Talk:NetworkManager_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)))
...
**Notes:** Very hacky solution, what's wrong with [#Customizing_resolv.conf](#Customizing_resolv.conf)? (Discuss in [Talk:NetworkManager (Русский)#](https://wiki.archlinux.org/index.php/Talk:NetworkManager_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)))
...
**Notes:** should be covered only in one place (Discuss in [Talk:NetworkManager (Русский)#](https://wiki.archlinux.org/index.php/Talk:NetworkManager_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)))
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=NetworkManager_(Русский)&oldid=412826](https://wiki.archlinux.org/index.php?title=NetworkManager_(Русский)&oldid=412826)"

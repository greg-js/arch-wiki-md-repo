...
*   **<options>** - indica le opzioni utilizzate dal comando mount sul file system. Alcune opzioni di mount fanno riferimento a specifici file system, altre invece sono generiche ([mount(8)](https://jlk.fjfi.cvut.cz/arch/manpages/man/mount.8)):

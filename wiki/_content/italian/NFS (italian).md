...
*   [2 Configurazione del server](#Configurazione_del_server)
    *   [2.1 File](#File)
        *   [2.1.1 /etc/exports](#/etc/exports)
        *   [2.1.2 /etc/conf.d/nfs-common.conf](#/etc/conf.d/nfs-common.conf)
    *   [2.2 Demoni](#Demoni)
*   [3 Configurazione del client](#Configurazione_del_client)
    *   [3.1 File](#File_2)
        *   [3.1.1 /etc/conf.d/nfs-common.conf](#/etc/conf.d/nfs-common.conf_2)
    *   [3.2 Demoni](#Demoni_2)
    *   [3.3 Montaggio](#Montaggio)
    *   [3.4 Montaggio tramite cifs](#Montaggio_tramite_cifs)
    *   [3.5 Auto-mount all'avvio](#Auto-mount_all'avvio)
*   [4 Risoluzione dei problemi](#Risoluzione_dei_problemi)
    *   [4.1 Performance scarse, bassa velocità di trasferimento e/o alto carico del sistema utilizzando NFS con collegamenti gigabit](#Performance_scarse,_bassa_velocità_di_trasferimento_e/o_alto_carico_del_sistema_utilizzando_NFS_con_collegamenti_gigabit)
        *   [4.1.1 Async](#Async)
    ...
    *   [4.3 Nfsd non si avvia, restituendo "nfssvc: No such device"](#Nfsd_non_si_avvia,_restituendo_"nfssvc:_No_such_device")
    *   [4.4 rpcbind non si avvia e non mostra errori nell'avvio da terminale](#rpcbind_non_si_avvia_e_non_mostra_errori_nell'avvio_da_terminale)
    *   [4.5 Nfsd sembra funzionare, ma non ci si connette da clients MacOS X](#Nfsd_sembra_funzionare,_ma_non_ci_si_connette_da_clients_MacOS_X)
    *   [4.6 mount.nfs: Operation not permitted](#mount.nfs:_Operation_not_permitted)
    *   [4.7 L'ownership delle condivisioni montate è 4294967294:4294967294](#L'ownership_delle_condivisioni_montate_è_4294967294:4294967294)

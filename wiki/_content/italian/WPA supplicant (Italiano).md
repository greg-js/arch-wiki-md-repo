...
Per utilizzare _wpa_cli_, sarà necessario specificare un'interfaccia di controllo per _wpa_supplicant_ e dotarla dei permessi per modificare il relativo file di configurazione.

...
*   [2 Installazione](#Installazione)
    ...
    *   [2.4 Costruire l'array](#Costruire_l'array)
    ...
    *   [2.7 Assemblare l'array al boot](#Assemblare_l'array_al_boot)
    *   [2.8 Aggiungere all'immagine del kernel](#Aggiungere_all'immagine_del_kernel)
*   [3 Montaggio da un Live CD](#Montaggio_da_un_Live_CD)
*   [4 Rimozione di un dispositivo, smettere di usare l'array](#Rimozione_di_un_dispositivo,_smettere_di_usare_l'array)
*   [5 Aggiunta di un dispositivo all'array](#Aggiunta_di_un_dispositivo_all'array)
...
*   [7 Risoluzione dei problemi](#Risoluzione_dei_problemi)
    *   [7.1 Avviare l'array in sola lettura](#Avviare_l'array_in_sola_lettura)

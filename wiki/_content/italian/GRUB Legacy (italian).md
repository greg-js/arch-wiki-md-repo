...
*   [2 Aggiornamento a GRUB(2)](#Aggiornamento_a_GRUB(2))
    *   [2.1 È necessario aggiornare?](#È_necessario_aggiornare?)
    *   [2.2 Come effettuare l'aggiornamento](#Come_effettuare_l'aggiornamento)
*   [3 Configurazione](#Configurazione)
    *   [3.1 Trovare la root di GRUB](#Trovare_la_root_di_GRUB)
    *   [3.2 Dual booting con Windows](#Dual_booting_con_Windows)
    *   [3.3 Dual booting con GNU/Linux](#Dual_booting_con_GNU/Linux)
    *   [3.4 chainloader e configfile](#chainloader_e_configfile)
    *   [3.5 Dual boot con GNU/Linux (Grub2)](#Dual_boot_con_GNU/Linux_(Grub2))
*   [4 Installazione del bootloader](#Installazione_del_bootloader)
    ...
    *   [4.5 Metodo alternativo (installazione di grub)](#Metodo_alternativo_(installazione_di_grub))
*   [5 Suggerimenti](#Suggerimenti)
    ...
    *   [5.4 Eseguire il boot come root (single-user mode)](#Eseguire_il_boot_come_root_(single-user_mode))
...
*   [6 Modalità debug avanzata](#Modalità_debug_avanzata)
*   [7 Risoluzione dei problemi](#Risoluzione_dei_problemi)
    ...
    *   [7.7 GRUB non riesce a trovare o installare qualsiasi virtio /dev/vd* o altri dispositivi non-BIOS](#GRUB_non_riesce_a_trovare_o_installare_qualsiasi_virtio_/dev/vd*_o_altri_dispositivi_non-BIOS)

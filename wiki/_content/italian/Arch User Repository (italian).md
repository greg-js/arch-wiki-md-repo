...
*   [8 Git Repo](#Git_Repo)
*   [9 FAQ](#FAQ)
    *   [9.1 Cos'è AUR?](#Cos'è_AUR?)
    *   [9.2 Che tipo di pacchetti sono permessi su AUR?](#Che_tipo_di_pacchetti_sono_permessi_su_AUR?)
    *   [9.3 Come si votano i pacchetti in AUR?](#Come_si_votano_i_pacchetti_in_AUR?)
    *   [9.4 Cos'è un TU?](#Cos'è_un_TU?)
    *   [9.5 Che differenza c'è tra Arch User Repository e community?](#Che_differenza_c'è_tra_Arch_User_Repository_e_community?)
    *   [9.6 Quanti voti servono per far spostare un PKGBUILD in community?](#Quanti_voti_servono_per_far_spostare_un_PKGBUILD_in_community?)
    *   [9.7 Come si fa un PKGBUILD?](#Come_si_fa_un_PKGBUILD?)
    *   [9.8 Ho dato il comando "pacman -S foo"; non funziona, ma sono sicuro che si trova in community](#Ho_dato_il_comando_"pacman_-S_foo";_non_funziona,_ma_sono_sicuro_che_si_trova_in_community)
    *   [9.9 In AUR, un pacchetto non è aggiornato; cosa devo fare?](#In_AUR,_un_pacchetto_non_è_aggiornato;_cosa_devo_fare?)
    *   [9.10 Ho un PKGBUILD che vorrei inviare; qualcuno può controllarlo per vedere se ci sono errori?](#Ho_un_PKGBUILD_che_vorrei_inviare;_qualcuno_può_controllarlo_per_vedere_se_ci_sono_errori?)
    *   [9.11 Il pacchetto Foo in AUR non compila quando lancio makepkg; cosa dovrei fare?](#Il_pacchetto_Foo_in_AUR_non_compila_quando_lancio_makepkg;_cosa_dovrei_fare?)
    *   [9.12 Come posso accelerare i ripetuti processi di compilazione?](#Come_posso_accelerare_i_ripetuti_processi_di_compilazione?)
    *   [9.13 Come faccio ad accedere ai pacchetti di unsupported](#Come_faccio_ad_accedere_ai_pacchetti_di_unsupported)
    *   [9.14 Come faccio a mandare un PKGBUILD ad AUR senza usare l'interfaccia web?](#Come_faccio_a_mandare_un_PKGBUILD_ad_AUR_senza_usare_l'interfaccia_web?)
*   [10 AUR 4](#AUR_4)

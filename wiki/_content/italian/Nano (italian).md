...
**Attenzione:** Dal [visudo(8)](https://jlk.fjfi.cvut.cz/arch/manpages/man/visudo.8): *Si noti che questo metodo potrebbe compromettere la sicurezza in quanto permette all'utente di eseguire qualsiasi programma che desiderano semplicemente impostando le variabili VISUAL o EDITOR.*

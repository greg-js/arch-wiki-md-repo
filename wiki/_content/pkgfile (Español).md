...
[Instale](/index.php/Pacman_(Espa%C3%B1ol) "Pacman (Español)") [pkgfile](https://www.archlinux.org/packages/?name=pkgfile) desde los repositorios oficiales, o [pkgfile-git](https://aur.archlinux.org/packages/pkgfile-git/)<sup><small>AUR</small></sup> desde [AUR](/index.php/AUR "AUR").
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Pkgfile_(Español)&oldid=411598](https://wiki.archlinux.org/index.php?title=Pkgfile_(Español)&oldid=411598)"

[Categories](/index.php/Special:Categories "Special:Categories"):

*   [Package development (Español)](/index.php/Category:Package_development_(Espa%C3%B1ol) "Category:Package development (Español)")
*   [Package management (Español)](/index.php/Category:Package_management_(Espa%C3%B1ol) "Category:Package management (Español)")
...
*   [2 Версии из AUR](#Версии_из_AUR)
*   [3 Советы и рекомендации](#Советы_и_рекомендации)
    *   [3.1 Включить реальную прозрачность в KDE4 и Xfce4](#Включить_реальную_прозрачность_в_KDE4_и_Xfce4)
    *   [3.2 Автозапуск в Xfce4](#Автозапуск_в_Xfce4)
    *   [3.3 Как предотвратить мерцание](#Как_предотвратить_мерцание)
    *   [3.4 Настройка цвета](#Настройка_цвета)
    *   [3.5 С двумя экранами](#С_двумя_экранами)
    *   [3.6 Не сворачивать при сворачивании всех окон](#Не_сворачивать_при_сворачивании_всех_окон)
    *   [3.7 Интеграция с Gnome 3](#Интеграция_с_Gnome_3)
    *   [3.8 Интеграция с KDE](#Интеграция_с_KDE)
    *   [3.9 Интеграция с Razor-qt](#Интеграция_с_Razor-qt)
    *   [3.10 Показывать информацию об обновлениях пакетов](#Показывать_информацию_об_обновлениях_пакетов)
    *   [3.11 Показывать прогноз погоды](#Показывать_прогноз_погоды)
    *   [3.12 Показывать RSS ленты](#Показывать_RSS_ленты)
    *   [3.13 Показывать состояние rTorrent](#Показывать_состояние_rTorrent)
    *   [3.14 Показывать состояние вашего WordPress блога](#Показывать_состояние_вашего_WordPress_блога)
    *   [3.15 Показывать количество новых писем из Gmail](#Показывать_количество_новых_писем_из_Gmail)
        *   [3.15.1 Аналогичные способы](#Аналогичные_способы)
    *   [3.16 Показывать новые письма (IMAP + SSL)](#Показывать_новые_письма_(IMAP_+_SSL))
    *   [3.17 Исправление прокручивания для кодировки UTF-8](#Исправление_прокручивания_для_кодировки_UTF-8)
*   [4 Примеры конфигурации от пользователей](#Примеры_конфигурации_от_пользователей)
    *   [4.1 Graysky](#Graysky)
    *   [4.2 Пример скрипта с поддержкой nvidia](#Пример_скрипта_с_поддержкой_nvidia)
*   [5 Замечание о шрифтах](#Замечание_о_шрифтах)
*   [6 Универсальный способ включения настоящей прозрачности](#Универсальный_способ_включения_настоящей_прозрачности)
...
Также вы можете использовать stunnel, как описано выше: [#Показывать количество новых писем из Gmail](#Показывать_количество_новых_писем_из_Gmail)

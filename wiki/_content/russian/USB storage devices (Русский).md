...
_Здесь можно видеть целый список дисков, видимых системой, и длинные строчки с символами. Так вот эти строчки и есть те самые uuidы._

*   Теперь нужно подключить USB устройство и подождать несколько секунд . . .

*   Заново выполнить `blkid -o list -c /dev/null`

_Появилось новое устройство и UUID? Это и есть USB накопитель_
...
**Обратите внимание:** Если же вообще ничего не помогло, то, возможно, нужно чинить флэшку, см. [Format a device](/index.php/Format_a_device "Format a device"). Но перед этим имеет смысл попробовать на другом компьютере или операционной системе.
...
**Обратите внимание:** Здесь `/dev/sda1` должно быть заменено на имя флэшки (если оно не /dev/sda1, конечно). Если непонятно, см. [Монтирование USB флэш-памяти](/index.php/USB_storage_devices_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#.D0.9C.D0.BE.D0.BD.D1.82.D0.B8.D1.80.D0.BE.D0.B2.D0.B0.D0.BD.D0.B8.D0.B5_USB_.D1.84.D0.BB.D1.8D.D1.88-.D0.BF.D0.B0.D0.BC.D1.8F.D1.82.D0.B8 "USB storage devices (Русский)").
...
**Обратите внимание:** Извлекать флэшку, не выполнив размонтирование, опасно.
...
*   [3 Исправление звука](#Исправление_звука)
*   [4 Ошибка веб браузера](#Ошибка_веб_браузера)
*   [5 Ошибка кодировки QIP](#Ошибка_кодировки_QIP)
*   [6 ICQ](#ICQ)
*   [7 IRC](#IRC)
*   [8 Xfire](#Xfire)
*   [9 Web QQ](#Web_QQ)
*   [10 Facebook XMPP](#Facebook_XMPP)
*   [11 Конфиденциальность](#Конфиденциальность)
    *   [11.1 Pidgin-OTR](#Pidgin-OTR)
    *   [11.2 Pidgin-Encryption](#Pidgin-Encryption)
    *   [11.3 Pidgin-GPG](#Pidgin-GPG)
*   [12 Sametime протокол](#Sametime_протокол)
...
*   [14 Другие пакеты](#Другие_пакеты)
*   [15 Плагин Skype](#Плагин_Skype)
*   [16 Автоматический выход перед гибернацией](#Автоматический_выход_перед_гибернацией)
*   [17 Решение проблем](#Решение_проблем)
    *   [17.1 Установка Pidgin после установки Carrier](#Установка_Pidgin_после_установки_Carrier)
*   [18 Импорт истории Kopete в Pidgin](#Импорт_истории_Kopete_в_Pidgin)
*   [19 Смотрите также](#Смотрите_также)
...
Для того чтобы звук заработал, необходимо установить пакет [gstreamer0.10-good](https://aur.archlinux.org/packages/gstreamer0.10-good/). Альтарнативно, на вкладке настроек "Звуки" можно задать метод 'команда' и использовать одну из следующих команд.
...
Теперь перейдите в *Собеседники > Новое мгновенное сообщение* (или нажмите `Ctrl+m`), введите 'freenode.net' в текстовое поле и *имяпользователя*@irc.freenode.net, затем нажмите 'Ok'. Введите:
...
1.  Для включения OTR, запустите Pidgin, и перейдите в *Средства* > *Модули* или нажмите `Ctrl+u`. Прокрутите вниз до записи "Off-The-Record Messaging". Если относящийся к ней чекбокс не отмечен, отметьте его.
...
Для автоматизации этого, создайте новый systemd юнит `pidgin-suspend` в `/etc/systemd/system` Возьмите следующую заготовку и замените *myuser* на вашего пользователя.
...
Если вы перед этим устанавливали [carrier](https://aur.archlinux.org/packages/carrier/) (также известный как [FunPidgin](http://funpidgin.sourceforge.net/)), следуйте следующим инструкциям *до* установки Pidgin:

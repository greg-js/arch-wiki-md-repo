...
*   [1 Реализация](#Реализация)
    ...
    *   [1.2 Текстовый режим](#Текстовый_режим)
    *   [1.3 Фреймбуфер консоли](#Фреймбуфер_консоли)
*   [2 Сочетание клавиш](#Сочетание_клавиш)
*   [3 Шрифты](#Шрифты)
    *   [3.1 Предосмотр и временные изменения](#Предосмотр_и_временные_изменения)
    *   [3.2 Постоянные настройки](#Постоянные_настройки)

...
*   [2 Переключение между средами](#Переключение_между_средами)
    ...
    *   [2.3 Сброс среды Java по умолчанию](#Сброс_среды_Java_по_умолчанию)
    *   [2.4 Исправление конфигурации используемой среды Java](#Исправление_конфигурации_используемой_среды_Java)
    *   [2.5 Запуск приложений с не установленным по умолчанию окружением](#Запуск_приложений_с_не_установленным_по_умолчанию_окружением)
...
Обратите внимание, что `archlinux-java` не позволит задать некорректную среду Java. В предыдущем примере была использована установленная среда [jre8-openjdk](https://www.archlinux.org/packages/?name=jre8-openjdk), а, к примеру, указание неустановленной среды [jdk8-openjdk](https://www.archlinux.org/packages/?name=jdk8-openjdk) завершилось бы следующей ошибкой:

...
**Обратите внимание:** Вы можете держать libao стандартно на вывод драйвера *alsa* и его устройств по умолчанию, если Вы устанавливаете [pulseaudio-alsa](https://www.archlinux.org/packages/?name=pulseaudio-alsa), так как устройством вывода по умолчанию ALSA **является** PulseAudio.

...
**Обратите внимание:** Делайте это с правами _пользователя_.
...
**Обратите внимание:** Для поддержки автозапуска приложений из `~/.config/openbox/autostart` Вам потребуется использовать Openbox в качестве отдельного оконного менеджера.

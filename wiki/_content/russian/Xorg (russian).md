**Состояние перевода:** На этой странице представлен перевод статьи [Xorg](/index.php/Xorg "Xorg"). Дата последней синхронизации: 27 июня 2019\. Вы можете [помочь](/index.php/ArchWiki_Translation_Team_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "ArchWiki Translation Team (Русский)") синхронизировать перевод, если в английской версии произошли [изменения](https://wiki.archlinux.org/index.php?title=Xorg&diff=0&oldid=577927).
...
| Проприетарный | [xf86-video-amdgpu](https://www.archlinux.org/packages/?name=xf86-video-amdgpu) | [amdgpu-pro-libgl](https://aur.archlinux.org/packages/amdgpu-pro-libgl/) | [lib32-amdgpu-pro-libgl](https://aur.archlinux.org/packages/lib32-amdgpu-pro-libgl/) | [AMDGPU PRO](/index.php/AMDGPU_PRO "AMDGPU PRO") |

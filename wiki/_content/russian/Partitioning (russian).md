...
*   [1 Таблица разделов](#Таблица_разделов)
    *   [1.1 Главная загрузочная запись (MBR)](#Главная_загрузочная_запись_(MBR))
        *   [1.1.1 Главная загрузочная запись (таблица разделов)](#Главная_загрузочная_запись_(таблица_разделов))
        *   [1.1.2 Главная загрузочная запись (загрузочный код)](#Главная_загрузочная_запись_(загрузочный_код))
...
*   [2 Схема разметки](#Схема_разметки)
    *   [2.1 Однокорневой раздел](#Однокорневой_раздел)
    *   [2.2 Дискретные разделы](#Дискретные_разделы)
        *   [2.2.1 /](#/)
        *   [2.2.2 /boot](#/boot)
        *   [2.2.3 /home](#/home)
        *   [2.2.4 /var](#/var)
    ...
    *   [2.3 Примеры схем](#Примеры_схем)
        ...
        *   [2.3.2 Примеры схем MBR/BIOS](#Примеры_схем_MBR/BIOS)
        *   [2.3.3 UEFI пример схемы отдельного /home](#UEFI_пример_схемы_отдельного_/home)
...
*   [5 Советы и хитрости](#Советы_и_хитрости)
    ...
    *   [5.2 Поддержка ядра GPT](#Поддержка_ядра_GPT)
...
[Таблица разделов GUID](https://en.wikipedia.org/wiki/ru:%D0%A2%D0%B0%D0%B1%D0%BB%D0%B8%D1%86%D0%B0_%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB%D0%BE%D0%B2_GUID "w:ru:Таблица разделов GUID") (GPT) представляет собой схему разметки, которая является частью спецификации [UEFI](/index.php/Unified_Extensible_Firmware_Interface_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Unified Extensible Firmware Interface (Русский)"); она использует [глобально уникальные идентификаторы](https://en.wikipedia.org/wiki/ru:UUID "w:ru:UUID") (GUIDs) или UUID в мире Linux для определения разделов и [их типов](https://en.wikipedia.org/wiki/ru:%D0%A2%D0%B0%D0%B1%D0%BB%D0%B8%D1%86%D0%B0_%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB%D0%BE%D0%B2_GUID#.D0.98.D0.B4.D0.B5.D0.BD.D1.82.D0.B8.D1.84.D0.B8.D0.BA.D0.B0.D1.82.D0.BE.D1.80.D1.8B_.28GUID.29_.D1.80.D0.B0.D0.B7.D0.BB.D0.B8.D1.87.D0.BD.D1.8B.D1.85_.D1.82.D0.B8.D0.BF.D0.BE.D0.B2_.D1.80.D0.B0.D0.B7.D0.B4.D0.B5.D0.BB.D0.BE.D0.B2 "w:ru:Таблица разделов GUID"). Она разработана, чтобы преуспеть в методе схемы разделов [главной загрузочной записи](#Главная_загрузочная_запись_(MBR)).
...
*   Хранит резервный заголовок и таблицу разделов в конце диска, что помогает [восстановить](/index.php/Fdisk_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Восстановление_заголовка_GPT "Fdisk (Русский)") их, если первичные повреждены.
...
[Btrfs](/index.php/Btrfs_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Btrfs (Русский)") может занимать все устройство хранения данных и заменять схемы разметки [MBR](#Главная_загрузочная_запись_(MBR)) или [GPT](#Таблица_разделов_GUID). Для получения допольнительной информации смотрите статью [Btrfs#Безраздельный диск Btrfs](/index.php/Btrfs_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Безраздельный_диск_Btrfs "Btrfs (Русский)").

### Резервное копирование

Смотрите [fdisk#Резервное копирование и восстановление таблицы разделов](/index.php/Fdisk_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Резервное_копирование_и_восстановление_таблицы_разделов "Fdisk (Русский)").
...
*   Для систем BIOS, размеченных с [GPT](#Таблица_разделов_GUID), требуется [раздел загрузки BIOS](/index.php/%D0%A0%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB_%D0%B7%D0%B0%D0%B3%D1%80%D1%83%D0%B7%D0%BA%D0%B8_BIOS "Раздел загрузки BIOS"), если в качестве загрузчика используется [GRUB](/index.php/GRUB_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "GRUB (Русский)").
*   При использовании [Btrfs](/index.php/Btrfs_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Btrfs (Русский)") подтома можно рассматривать как разделы. Для получения допольнительной информации смотрите раздел [Btrfs#Монтирование подтомов](/index.php/Btrfs_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Монтирование_подтомов "Btrfs (Русский)").
...
*   **[gdisk](/index.php/Fdisk_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Fdisk (Русский)")** — [GPT](#Таблица_разделов_GUID) - альтернатива fdisk.
...
[fdisk/gdisk](/index.php/Fdisk_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Fdisk (Русский)") и [parted](/index.php/GNU_Parted_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Выравнивание "GNU Parted (Русский)") автоматически обрабатывают выравнивание размера разделов. Смотрите раздел [GNU Parted (Русский)#Проверка выравнивания](/index.php/GNU_Parted_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Проверка_выравнивания "GNU Parted (Русский)"), если вы хотите проверить выравнивание после разметки.
...
Смотрите [fdisk#Преобразование между MBR и GPT](/index.php/Fdisk_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Преобразование_между_MBR_и_GPT "Fdisk (Русский)").

**Состояние перевода:** На этой странице представлен перевод статьи [Installation guide](/index.php/Installation_guide "Installation guide"). Дата последней синхронизации: 14 сентября 2019\. Вы можете [помочь](/index.php/ArchWiki_Translation_Team_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "ArchWiki Translation Team (Русский)") синхронизировать перевод, если в английской версии произошли [изменения](https://wiki.archlinux.org/index.php?title=Installation_guide&diff=0&oldid=582205).
...
Arch Linux способен работать на любой [x86_64](https://en.wikipedia.org/wiki/ru:X86-64 "w:ru:X86-64")-совместимой машине, имеющей хотя бы 512 MiB ОЗУ. Базовая установка со всеми пакетами группы [base](https://www.archlinux.org/groups/x86_64/base/) занимает меньше 800 MiB дискового пространства. Поскольку для процесса установки требуется получать пакеты из удаленного репозитория, необходимо работающее интернет-соединение.
...
*   Убедитесь, что ваш [сетевой интерфейс](/index.php/%D0%9D%D0%B0%D1%81%D1%82%D1%80%D0%BE%D0%B9%D0%BA%D0%B0_%D1%81%D0%B5%D1%82%D0%B8#Сетевые_интерфейсы "Настройка сети") в списке и включен, например, с помощью [ip-link(8)](https://jlk.fjfi.cvut.cz/arch/manpages/man/ip-link.8): `# ip link` 
...
Выберите и установите [загрузчик](/index.php/%D0%97%D0%B0%D0%B3%D1%80%D1%83%D0%B7%D1%87%D0%B8%D0%BA "Загрузчик") с поддержкой Linux. Если вы используете процессор Intel или AMD, включите также обновление [микрокода](/index.php?title=%D0%9C%D0%B8%D0%BA%D1%80%D0%BE%D0%BA%D0%BE%D0%B4%D0%B0&action=edit&redlink=1 "Микрокода (page does not exist)").

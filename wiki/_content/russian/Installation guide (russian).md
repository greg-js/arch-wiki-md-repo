**Состояние перевода:** На этой странице представлен перевод статьи [Installation guide](/index.php/Installation_guide "Installation guide"). Дата последней синхронизации: 2 февраля 2020\. Вы можете [помочь](/index.php/ArchWiki_Translation_Team_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "ArchWiki Translation Team (Русский)") синхронизировать перевод, если в английской версии произошли [изменения](https://wiki.archlinux.org/index.php?title=Installation_guide&diff=0&oldid=596197).
...
Установочный образ и его подпись [GnuPG](/index.php/GnuPG "GnuPG") можно получить со страницы [Загрузки](https://archlinux.org/download/).

### Проверка подписи

Рекомендуется проверять подпись образа перед его использованием, особенно когда он был загружен с *зеркала HTTP*, где загрузки обычно подвержены перехвату для [подмены образа на вредоносный](https://www2.cs.arizona.edu/stork/packagemanagersecurity/attacks-on-package-managers.html).
...
На выбранном накопителе **должны присутствовать** следующие [разделы](/index.php/Partitioning_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Partitioning (Русский)"):
...
Чтобы [установить](/index.php/%D0%A3%D1%81%D1%82%D0%B0%D0%BD%D0%BE%D0%B2%D0%B8%D1%82%D1%8C "Установить") другие пакеты или группы, добавьте их названия к команде *pacstrap* (разделяя их пробелом) или используйте [pacman](/index.php/Pacman_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Pacman (Русский)") во время этапа [#Chroot](#Chroot). Список пакетов на установочном носителе доступен на странице [packages.x86_64](https://projects.archlinux.org/archiso.git/tree/configs/releng/packages.x86_64).
...
Завершите [настройку сети](/index.php/Network_configuration_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Network configuration (Русский)") для вновь установленной среды, что включает в себя установку предпочитаемого ПО для [управления сетевым подключением](/index.php/Network_configuration_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Управление_сетевым_подключением "Network configuration (Русский)").

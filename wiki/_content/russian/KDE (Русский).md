...
Настройка принтеров в KDE осуществляется на панели _System Settings > Printer Configuration_. Для этого необходимо сначала установить [kdeutils-print-manager](https://www.archlinux.org/packages/?name=kdeutils-print-manager) и [cups](https://www.archlinux.org/packages/?name=cups).
...
Вы также можете просто установить [kcm-qt-graphicssystem](https://aur.archlinux.org/packages/kcm-qt-graphicssystem/) из AUR и выбрать рендер на панели _System Settings > Qt Graphics System_.

...
*   Воспользоваться менеджером плагинов Eclipse, который скачает и установит плагины прямо из их собственных репозиториев. В этом случае вам понадобится найти необходимый репозиторий на сайте разработчиков плагина, затем перейти в меню _Help -> Install New Software..._, ввести адрес репозитория в поле _Work with_, выбрать нужный плагин из списка и следовать дальнейшим укаазаниям установщика.
...
а добавленные автоматически могут быть активированы в меню _Available Software Sites_.

...
Если часто приходиться монтировать файловые системы sshfs, то вас может заинтересовать помощник для sshfs, например, [sftpman](/index.php/Sftpman "Sftpman").
...
Для начала, прочитайте следующую страницу вики [Secure Shell (Русский)#Проверка](/index.php/Secure_Shell_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#.D0.9F.D1.80.D0.BE.D0.B2.D0.B5.D1.80.D0.BA.D0.B0 "Secure Shell (Русский)"). Проблемы, которые следует проверить:

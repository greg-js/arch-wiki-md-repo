...
**Обратите внимание:** Файлы должны существовать (пути, указанные при настройке) с правильными правами, иначе MPD не запустится.

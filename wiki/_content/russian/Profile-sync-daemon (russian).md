...
*   [2 Установка и настройка](#Установка_и_настройка)
    *   [2.1 Редактируем файл с конфигурацией](#Редактируем_файл_с_конфигурацией)
*   [3 Поддерживаемые браузеры](#Поддерживаемые_браузеры)
*   [4 Использование psd](#Использование_psd)
    *   [4.1 Проверка конфигурации](#Проверка_конфигурации)
    *   [4.2 Режим чистки](#Режим_чистки)
    *   [4.3 Запуск и завершение psd](#Запуск_и_завершение_psd)
*   [5 Поддерживаемые дистрибутивы](#Поддерживаемые_дистрибутивы)
    *   [5.1 Установка частоты синхронизации (опционально)](#Установка_частоты_синхронизации_(опционально))
*   [6 FAQ](#FAQ)
    *   [6.1 Что такое overlayfs и зачем его использовать?](#Что_такое_overlayfs_и_зачем_его_использовать?)
    *   [6.2 Overlayfs требует больше памяти для размещения моего профиля/профилей в /run/user/xxxx. Как мне выделить больше?](#Overlayfs_требует_больше_памяти_для_размещения_моего_профиля/профилей_в_/run/user/xxxx._Как_мне_выделить_больше?)
    *   [6.3 Моя система аварийно завершила работу и не была синхронизирована. Что мне делать?](#Моя_система_аварийно_завершила_работу_и_не_была_синхронизирована._Что_мне_делать?)
    *   [6.4 Где я могу найти снимок?](#Где_я_могу_найти_снимок?)
    *   [6.5 Как восстановить снимок?](#Как_восстановить_снимок?)
    *   [6.6 Может ли psd удалить снимки автоматически?](#Может_ли_psd_удалить_снимки_автоматически?)
...
[Установите](/index.php/%D0%A3%D1%81%D1%82%D0%B0%D0%BD%D0%BE%D0%B2%D0%B8%D1%82%D0%B5 "Установите") пакет [profile-sync-daemon](https://www.archlinux.org/packages/?name=profile-sync-daemon).
...
См. [systemd.timer(5)](https://jlk.fjfi.cvut.cz/arch/manpages/man/systemd.timer.5) для получения дополнительной информации о настройке таймеров.

...
Если ярлык приложения связан с типом MIME, его просто нельзя установить как значение по умолчанию. Измените [#mimeapps.list](#Стандарт_XDG), чтобы установить связь по умолчанию.

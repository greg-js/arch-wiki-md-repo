...
**Состояние перевода:** На этой странице представлен перевод статьи [SDDM](/index.php/SDDM "SDDM"). Дата последней синхронизации: 2 февраля 2020\. Вы можете [помочь](/index.php/ArchWiki_Translation_Team_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "ArchWiki Translation Team (Русский)") синхронизировать перевод, если в английской версии произошли [изменения](https://wiki.archlinux.org/index.php?title=SDDM&diff=0&oldid=596068).
...
*   [2 Настройка](#Настройка)
    ...
    *   [2.8 Включение виртуальной клавиатуры](#Включение_виртуальной_клавиатуры)
    *   [2.9 Использование сканера отпечатка пальцев](#Использование_сканера_отпечатка_пальцев)
*   [3 Решение проблем](#Решение_проблем)
    ...
    *   [3.6 Аватары пользователей не отображаются на экране приветствия](#Аватары_пользователей_не_отображаются_на_экране_приветствия)
    *   [3.7 SDDM загружает только английскую (US) раскладку клавиатуры](#SDDM_загружает_только_английскую_(US)_раскладку_клавиатуры)
    *   [3.8 Слишком низкое разрешение экрана](#Слишком_низкое_разрешение_экрана)
    *   [3.9 Долгая загрузка с домашней директорией на autofs](#Долгая_загрузка_с_домашней_директорией_на_autofs)
...
Установите пакет [qt5-virtualkeyboard](https://www.archlinux.org/packages/?name=qt5-virtualkeyboard).
...
Если же проблема не в отсутствии свободного места, она может быть связана с [данной ошибкой](https://github.com/sddm/sddm/issues/1179). Переключитесь [в другой TTY](/index.php/Getty#Installation "Getty") и [перезапустите](/index.php/%D0%9F%D0%B5%D1%80%D0%B5%D0%B7%D0%B0%D0%BF%D1%83%D1%81%D1%82%D0%B8%D1%82%D0%B5 "Перезапустите") SDDM.

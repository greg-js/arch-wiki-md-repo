...
**Состояние перевода:** На этой странице представлен перевод статьи [SDDM](/index.php/SDDM "SDDM"). Дата последней синхронизации: 23 декабря 2018\. Вы можете [помочь](/index.php/ArchWiki_Translation_Team_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "ArchWiki Translation Team (Русский)") синхронизировать перевод, если в английской версии произошли [изменения](https://wiki.archlinux.org/index.php?title=SDDM&diff=0&oldid=559681).
...
*   [3 Решение проблем](#Решение_проблем)
    *   [3.1 Долгая загрузка перед отображением экрана приветствия SDDM](#Долгая_загрузка_перед_отображением_экрана_приветствия_SDDM)
    *   [3.2 Зависания после входа](#Зависания_после_входа)
    *   [3.3 SDDM запускается на tty1 вместо tty7](#SDDM_запускается_на_tty1_вместо_tty7)
    *   [3.4 Один или более пользователей не отображаются на экране приветствия](#Один_или_более_пользователей_не_отображаются_на_экране_приветствия)
    *   [3.5 SDDM загружает только английскую (US) раскладку клавиатуры](#SDDM_загружает_только_английскую_(US)_раскладку_клавиатуры)
    *   [3.6 Слишком низкое разрешение экрана](#Слишком_низкое_разрешение_экрана)
    *   [3.7 Долгая загрузка с домашней директорией на autofs](#Долгая_загрузка_с_домашней_директорией_на_autofs)

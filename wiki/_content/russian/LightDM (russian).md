...
*   [2 Включение LightDM](#Включение_LightDM)
*   [3 Инструмент командной строки](#Инструмент_командной_строки)
*   [4 Тестирование](#Тестирование)
*   [5 Дополнительные настройки и твики](#Дополнительные_настройки_и_твики)
    *   [5.1 Изменение фонового изображения/цветов](#Изменение_фонового_изображения/цветов)
        *   [5.1.1 Экран приветствия GTK+](#Экран_приветствия_GTK+)
        *   [5.1.2 Экран приветствия Unity](#Экран_приветствия_Unity)
        *   [5.1.3 Экран приветствия KDE](#Экран_приветствия_KDE)
    *   [5.2 Изменение вашего аватара](#Изменение_вашего_аватара)
    *   [5.3 Внедрение Arch-ориентированных 64x64 иконок](#Внедрение_Arch-ориентированных_64x64_иконок)
    *   [5.4 Включение автовхода](#Включение_автовхода)
    *   [5.5 Включение интерактивного без парольного входа в систему](#Включение_интерактивного_без_парольного_входа_в_систему)
    *   [5.6 Скрытие пользователей системы и служб](#Скрытие_пользователей_системы_и_служб)
    *   [5.7 Миграция с SLiM](#Миграция_с_SLiM)
    *   [5.8 NumLock включен по умолчанию](#NumLock_включен_по_умолчанию)
    *   [5.9 Переключение пользователя при Xfce4](#Переключение_пользователя_при_Xfce4)
    *   [5.10 Сессия по умолчанию](#Сессия_по_умолчанию)
    *   [5.11 Регулировка положения входа окна](#Регулировка_положения_входа_окна)
        *   [5.11.1 Экран приветствия GTK+](#Экран_приветствия_GTK+_2)
*   [6 Решение проблем](#Решение_проблем)
    *   [6.1 Локаль неправильно отображается](#Локаль_неправильно_отображается)
    *   [6.2 Ресурсы X не корректно распознаны](#Ресурсы_X_не_корректно_распознаны)
    *   [6.3 Отсутствуют иконки в Экране приветствия GTK](#Отсутствуют_иконки_в_Экране_приветствия_GTK)
    *   [6.4 LightDM зависает при попытке входа в систему](#LightDM_зависает_при_попытке_входа_в_систему)
    *   [6.5 LightDM отображается в неправильном мониторе](#LightDM_отображается_в_неправильном_мониторе)
    *   [6.6 LightDM не отображается](#LightDM_не_отображается)
    *   [6.7 Pulseaudio не запускается автоматически](#Pulseaudio_не_запускается_автоматически)
...
Убедитесь в том что вы [включили](/index.php/Systemd_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Использование_юнитов "Systemd (Русский)") `lightdm.service` чтобы LightDM запускался при загрузке. Смотрите также [Экранный менеджер#Запуск экранного менеджера](/index.php/%D0%AD%D0%BA%D1%80%D0%B0%D0%BD%D0%BD%D1%8B%D0%B9_%D0%BC%D0%B5%D0%BD%D0%B5%D0%B4%D0%B6%D0%B5%D1%80#Запуск_экранного_менеджера "Экранный менеджер").
...
Lightdm, как и другие Экранные менеджеры, хранит последнюю выбранную xsession в `~/.dmrc`. Для подробностей смотрите [Экранный менеджер#Список сеансов](/index.php/%D0%AD%D0%BA%D1%80%D0%B0%D0%BD%D0%BD%D1%8B%D0%B9_%D0%BC%D0%B5%D0%BD%D0%B5%D0%B4%D0%B6%D0%B5%D1%80#Список_сеансов "Экранный менеджер").
...
Смотрите [PulseAudio (Русский)#Выполнение](/index.php/PulseAudio_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Выполнение "PulseAudio (Русский)").

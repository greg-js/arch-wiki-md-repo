...
*   [1 Форматы шрифтов](#Форматы_шрифтов)
    *   [1.1 Распространённые расширения](#Распространённые_расширения)
    *   [1.2 Другие форматы](#Другие_форматы)
*   [2 Установка](#Установка)
    *   [2.1 Pacman](#Pacman)
    *   [2.2 Создание пакета](#Создание_пакета)
    *   [2.3 Установка вручную](#Установка_вручную)
*   [3 Рекомендации по выбору шрифтов](#Рекомендации_по_выбору_шрифтов)
    *   [3.1 Установка Droid Fonts](#Установка_Droid_Fonts)
    *   [3.2 Установка Bitstream Vera Fonts](#Установка_Bitstream_Vera_Fonts)
    *   [3.3 Установка Red Hats Liberation Fonts](#Установка_Red_Hats_Liberation_Fonts)
    *   [3.4 Установка шрифтов Microsoft](#Установка_шрифтов_Microsoft®)
*   [4 Шрифты с включенным LCD фильтром](#Шрифты_с_включенным_LCD_фильтром)
    *   [4.1 "LCD" пакеты](#"LCD"_пакеты)
    *   [4.2 "LCD" пакеты c патчами Ubuntu](#"LCD"_пакеты_c_патчами_Ubuntu)
*   [5 Конфигурация](#Конфигурация)
    *   [5.1 Общие понятия](#Общие_понятия)
    *   [5.2 Рекомендации по настройке (для патчей *-ubuntu)](#Рекомендации_по_настройке_(для_патчей_*-ubuntu))
        *   [5.2.1 cat ~/.fonts.conf (альтернатива настройкам в /etc/fonts/...)](#cat_~/.fonts.conf_(альтернатива_настройкам_в_/etc/fonts/...))
*   [6 Шрифт в консоли](#Шрифт_в_консоли)
    *   [6.1 Теория](#Теория)
    *   [6.2 Практика](#Практика)
*   [7 Внешние ссылки](#Внешние_ссылки)
...
Рекомендованный метод добавления шрифтов, недоступных в репозиториях, в систему описан в разделе [#Создание пакета](#Создание_пакета). Это даёт возможность пакетному менеджеру pacman удалять или обновлять их позднее. Шрифты также могут быть установлены вручную.
...
**Примечание:** Если у Вас в системе всего один пользовательский аккаунт - настраивать шрифты рекомендуется посредством правки файла `~/.fonts.conf` ([#cat ~/.fonts.conf (альтернатива настройкам в /etc/fonts/...)](#cat_~/.fonts.conf_(альтернатива_настройкам_в_/etc/fonts/...))), т.к. это:

...
Сперва убедитесь, что это не проблема вашей звуковой подсистемы ([ALSA](/index.php/ALSA "ALSA"), [OSS](/index.php/OSS "OSS"), etc.) и ваш _playback sink_ в Exaile имеет корректное значение. Попробуйте установить его в automatic.

...
1) Добавьте "nouveau" в массив _MODULES_ в файле `/etc/mkinitcpio.conf`:
...
```
# mkinitcpio -p <_ваш профиль ядра (kernel26, etc.)_>

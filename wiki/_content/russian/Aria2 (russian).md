...
*   [2 Настройка](#Настройка)
    ...
    *   [2.2 Пример aria2.conf](#Пример_aria2.conf)
        *   [2.2.1 Детали опций](#Детали_опций)
            *   [2.2.1.1 Пример входного файла #1](#Пример_входного_файла_#1)
            *   [2.2.1.2 Пример входного файла #2](#Пример_входного_файла_#2)
        *   [2.2.2 Дополнительные замечания](#Дополнительные_замечания)
    *   [2.3 Пример aria2.rapidshare](#Пример_aria2.rapidshare)
        *   [2.3.1 Описание опций](#Описание_опций)
        *   [2.3.2 Дополнительные замечания](#Дополнительные_замечания_2)
    *   [2.4 Пример aria2.bittorrent](#Пример_aria2.bittorrent)
        *   [2.4.1 Описание опций](#Описание_опций_2)
    *   [2.5 Пример aria2.daemon](#Пример_aria2.daemon)
*   [3 Интерфейс](#Интерфейс)
    *   [3.1 Веб-интерфейсы](#Веб-интерфейсы)
    *   [3.2 Другие интерфейсы](#Другие_интерфейсы)
*   [4 Советы и хитрости](#Советы_и_хитрости)
    *   [4.1 Скачать пакеты без установки](#Скачать_пакеты_без_установки)
    *   [4.2 pacman XferCommand](#pacman_XferCommand)
    *   [4.3 Изменение User Agent](#Изменение_User_Agent)
    *   [4.4 Использование Aria2 с makepkg](#Использование_Aria2_с_makepkg)

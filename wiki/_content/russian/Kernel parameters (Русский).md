...
**Обратите внимание:** You can check the parameters your system was booted up with by running `$ cat /proc/cmdline` and see if it includes your changes.
...
**Обратите внимание:** If you have not set a value for menu timeout, you will need to hold `Space` while booting for the Gummiboot menu to appear.
...
**Обратите внимание:** Not all of the listed options are always available. Most are associated with subsystems and work only if the kernel is configured with those subsystems built in. They also depend on the presence of the hardware they are associated with.

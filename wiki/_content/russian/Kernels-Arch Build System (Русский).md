...
**Обратите внимание:** Ядру нужно время чтобы скомпилироваться. Компиляция в течение 1 часа это вполне нормально. На современных системах с SSD обычно это занимает менее десяти минут.
...
**Обратите внимание:** Желательно так же установить kernel headers. Он может понадобится, если, к примеру, понадобится установить драйвера NVIDIA с [nvidia-hook](/index.php/NVIDIA#Alternate_install:_custom_kernel "NVIDIA")

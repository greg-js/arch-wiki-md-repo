...
*   [2 Установка](#Установка)
    *   [2.1 Поздний запуск KMS](#Поздний_запуск_KMS)
    *   [2.2 Ранний запуск KMS](#Ранний_запуск_KMS)
*   [3 Устранение неполадок](#Устранение_неполадок)
    *   [3.1 Мои шрифты слишком маленькие](#Мои_шрифты_слишком_маленькие)
    *   [3.2 Проблемы во время загрузки и dmesg](#Проблемы_во_время_загрузки_и_dmesg)
*   [4 Принудительный режим и EDID](#Принудительный_режим_и_EDID)
*   [5 Отключение modesetting](#Отключение_modesetting)
...
Если осуществлён ранний запуск KMS, необходимо включить кастомизированный файл EDID в [initramfs](#Ранний_запуск_KMS) иначе возможны проблемы.

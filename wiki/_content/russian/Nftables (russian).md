...
**Состояние перевода:** На этой странице представлен перевод статьи [nftables](/index.php/Nftables "Nftables"). Дата последней синхронизации: 2 февраля 2020\. Вы можете [помочь](/index.php/ArchWiki_Translation_Team_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "ArchWiki Translation Team (Русский)") синхронизировать перевод, если в английской версии произошли [изменения](https://wiki.archlinux.org/index.php?title=Nftables&diff=0&oldid=595769).
...
*   [2 Использование](#Использование)
    *   [2.1 Базовая конфигурация](#Базовая_конфигурация)
...
*   [5 Советы и рекомендации](#Советы_и_рекомендации)
    *   [5.1 Сохранение текущего набора правил](#Сохранение_текущего_набора_правил)
    *   [5.2 Настройка простого сетевого экрана](#Настройка_простого_сетевого_экрана)
        *   [5.2.1 Одиночная машина](#Одиночная_машина)
    *   [5.3 Предотвращение атак перебором](#Предотвращение_атак_перебором)
...
Для создания и загрузки правил используется утилита `nft`. Подробнее смотрите раздел [#Настройка](#Настройка).
...
В пакет [nftables](https://www.archlinux.org/packages/?name=nftables) входит простая и безопасная конфигурация экрана, сохранённая в файле `/etc/nftablse.conf`.

Служба `nftables.conf` загрузит эти правила при [запуске](/index.php/%D0%97%D0%B0%D0%BF%D1%83%D1%81%D1%82%D0%B8%D1%82%D0%B5 "Запустите") или [включении](/index.php/%D0%92%D0%BA%D0%BB%D1%8E%D1%87%D0%B8%D1%82%D0%B5 "Включите").
...
Смотрите [Simple stateful firewall](/index.php/Simple_stateful_firewall_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Simple stateful firewall (Русский)").

...
*   [1 Ярлык приложения](#Ярлык_приложения)
    ...
    *   [1.2 Определение ключа](#Определение_ключа)
        *   [1.2.1 Осуждение](#Осуждение)
*   [2 Значки](#Значки)
    *   [2.1 Распространенные форматы изображений](#Распространенные_форматы_изображений)
    *   [2.2 Преобразование значков](#Преобразование_значков)
    *   [2.3 Получение значков](#Получение_значков)
*   [3 Инструменты](#Инструменты)
    *   [3.1 gendesk](#gendesk)
        *   [3.1.1 Как использовать](#Как_использовать)
    *   [3.2 Список или поиск в файлах .desktop](#Список_или_поиск_в_файлах_.desktop)
    *   [3.3 fbrokendesktop](#fbrokendesktop)
*   [4 Советы и хитрости](#Советы_и_хитрости)
    *   [4.1 Скрытие ярлыков приложений](#Скрытие_ярлыков_приложений)
    *   [4.2 Автозапуск](#Автозапуск)
    *   [4.3 Изменение переменных среды](#Изменение_переменных_среды)

...
*   [Список приложений/Утилиты#Управление пакетами](/index.php/%D0%A1%D0%BF%D0%B8%D1%81%D0%BE%D0%BA_%D0%BF%D1%80%D0%B8%D0%BB%D0%BE%D0%B6%D0%B5%D0%BD%D0%B8%D0%B9/%D0%A3%D1%82%D0%B8%D0%BB%D0%B8%D1%82%D1%8B#Управление_пакетами "Список приложений/Утилиты")
...
*   [1 Настройка](#Настройка)
    *   [1.1 Основные параметры](#Основные_параметры)
        *   [1.1.1 Пропуск обновления пакетов](#Пропуск_обновления_пакетов)
        *   [1.1.2 Пропуск обновления группы пакетов](#Пропуск_обновления_группы_пакетов)
        *   [1.1.3 Игнорирование установки файлов в систему](#Игнорирование_установки_файлов_в_систему)
    *   [1.2 Репозитории](#Репозитории)
    *   [1.3 Безопасность пакетов](#Безопасность_пакетов)
*   [2 Использование](#Использование)
    *   [2.1 Установка пакетов](#Установка_пакетов)
        *   [2.1.1 Установка определенных пакетов](#Установка_определенных_пакетов)
        *   [2.1.2 Установка группы пакетов](#Установка_группы_пакетов)
    *   [2.2 Удаление пакетов](#Удаление_пакетов)
    *   [2.3 Обновление пакетов](#Обновление_пакетов)
    *   [2.4 Запросы к базам данных пакетов](#Запросы_к_базам_данных_пакетов)
    *   [2.5 Очистка кэша пакетов](#Очистка_кэша_пакетов)
    *   [2.6 Дополнительные команды](#Дополнительные_команды)
    *   [2.7 Частичные обновления не поддерживаются](#Частичные_обновления_не_поддерживаются)
    *   [2.8 Общие рекомендации](#Общие_рекомендации)
...
**Важно:** Перед установкой пакетов **не** обновляйте список пакетов без последующего [обновления](#Обновление_пакетов) системы (например, `pacman -Sy *имя_пакета*`), иначе могут возникнуть проблемы с зависимостями. Смотрите раздел [#Частичные обновления не поддерживаются](#Частичные_обновления_не_поддерживаются) и ветку форума [https://bbs.archlinux.org/viewtopic.php?id=89328](https://bbs.archlinux.org/viewtopic.php?id=89328).

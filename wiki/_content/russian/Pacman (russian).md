...
*   [2 Использование](#Использование)
    ...
    *   [2.5 Поиск пакета по названию файла](#Поиск_пакета_по_названию_файла)
    *   [2.6 Очистка кэша пакетов](#Очистка_кэша_пакетов)
    *   [2.7 Дополнительные команды](#Дополнительные_команды)
    *   [2.8 Частичные обновления не поддерживаются](#Частичные_обновления_не_поддерживаются)
    *   [2.9 Общие рекомендации](#Общие_рекомендации)

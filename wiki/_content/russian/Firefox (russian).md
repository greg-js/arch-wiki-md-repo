...
*   [6 Решение проблем](#Решение_проблем)
    ...
    *   [6.17 Разрыв изображения во время скроллинга](#Разрыв_изображения_во_время_скроллинга)
    *   [6.18 WebRTC-модуль Firefox не обнаруживает микрофон](#WebRTC-модуль_Firefox_не_обнаруживает_микрофон)
    *   [6.19 Не получается авторизоваться с китайским аккаунтом](#Не_получается_авторизоваться_с_китайским_аккаунтом)
...
Также может помочь уменьшение [Swappiness](/index.php/Swappiness_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Swappiness (Русский)").

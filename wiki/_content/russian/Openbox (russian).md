...
*   [2 Обновление до Openbox 3.5](#Обновление_до_Openbox_3.5)
    *   [2.1 Проблемы 3.5](#Проблемы_3.5)
*   [3 Openbox в качестве отдельного менеджера окон](#Openbox_в_качестве_отдельного_менеджера_окон)
*   [4 Openbox в качестве оконного менеджера для других окружений рабочих столов](#Openbox_в_качестве_оконного_менеджера_для_других_окружений_рабочих_столов)
    *   [4.1 GNOME 2.24 и 2.26](#GNOME_2.24_и_2.26)
    *   [4.2 GNOME 2.26 Redux](#GNOME_2.26_Redux)
    *   [4.3 GNOME 2.22 и ниже](#GNOME_2.22_и_ниже)
    *   [4.4 KDE](#KDE)
    *   [4.5 Xfce4](#Xfce4)
*   [5 Openbox для пользователей с несколькими мониторами](#Openbox_для_пользователей_с_несколькими_мониторами)
*   [6 Настройка](#Настройка)
    *   [6.1 Ручная настройка](#Ручная_настройка)
    *   [6.2 ObConf](#ObConf)
    *   [6.3 Настройка приложений](#Настройка_приложений)
*   [7 Меню](#Меню)
    *   [7.1 Ручная настройка меню](#Ручная_настройка_меню)
    *   [7.2 Иконки в меню](#Иконки_в_меню)
    *   [7.3 MenuMaker](#MenuMaker)
    *   [7.4 Obmenu](#Obmenu)
    *   [7.5 openbox-menu](#openbox-menu)
        *   [7.5.1 Obm-xdg](#Obm-xdg)
    *   [7.6 Основанный на Python скрипт меню xdg](#Основанный_на_Python_скрипт_меню_xdg)
    *   [7.7 Генератор меню для Openbox](#Генератор_меню_для_Openbox)
    *   [7.8 Pipe меню](#Pipe_меню)
    *   [7.9 Вызов и работа меню](#Вызов_и_работа_меню)
    *   [7.10 Дополнительные функции](#Дополнительные_функции)
*   [8 Управление окнами](#Управление_окнами)
*   [9 Автозапуск приложений](#Автозапуск_приложений)
*   [10 Темы и оформление](#Темы_и_оформление)
    *   [10.1 Темы Openbox](#Темы_Openbox)
    *   [10.2 Курсоры, иконки, обои рабочего стола](#Курсоры,_иконки,_обои_рабочего_стола)
*   [11 Советы и хитрости](#Советы_и_хитрости)
    *   [11.1 Поведение подобное Aero Snap](#Поведение_подобное_Aero_Snap)
    *   [11.2 Ассоциации файлов](#Ассоциации_файлов)
    *   [11.3 Копирование и вставка](#Копирование_и_вставка)
    *   [11.4 Прозрачность окон](#Прозрачность_окон)
    *   [11.5 Значения Xprop для приложений](#Значения_Xprop_для_приложений)
        *   [11.5.1 Xprop для Firefox](#Xprop_для_Firefox)
    *   [11.6 Привязка меню к кнопке](#Привязка_меню_к_кнопке)
    *   [11.7 Urxvt в качестве фона рабочего стола](#Urxvt_в_качестве_фона_рабочего_стола)
        *   [11.7.1 Переключение между рабочими столами](#Переключение_между_рабочими_столами)
    *   [11.8 Клавиши регулирования громкости на клавиатуре](#Клавиши_регулирования_громкости_на_клавиатуре)
        *   [11.8.1 ALSA](#ALSA)
        *   [11.8.2 Pulseaudio](#Pulseaudio)
    *   [11.9 Выключение/перезагрузка OpenBox](#Выключение/перезагрузка_OpenBox)
*   [12 Устранение неисправностей Openbox 3.5](#Устранение_неисправностей_Openbox_3.5)
    *   [12.1 X server *падает*](#X_server_падает)
    *   [12.2 Автозапуск лишних приложений в 3.5](#Автозапуск_лишних_приложений_в_3.5)
    *   [12.3 SSH агент больше не запускается](#SSH_агент_больше_не_запускается)
    *   [12.4 Новые окна загружаются под старыми](#Новые_окна_загружаются_под_старыми)
*   [13 Полезные ссылки](#Полезные_ссылки)
...
*   `menu.xml` описывает содержимое меню, выпадающего по правому клику мыши. В нем описаны ярлыки запуска приложений и другие ярлыки. Смотрите секцию [#Меню](#Меню).
...
Смотри секцию ниже [Устранение неисправностей Openbox 3.5](#Устранение_неисправностей_Openbox_3.5).

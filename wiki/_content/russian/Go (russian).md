...
Компилятор go по умолчанию компилирует пакет с отладочной информацией и сгенерированной таблицей символов что в свою очередь увеличивает размер исполняемого файла, чтобы этого избежать необходимо добавить флаги *-w* и *-s* соотвецтвенно:
...
все эти параметры влияют только на отладку и анализ полученного бинарного файла.

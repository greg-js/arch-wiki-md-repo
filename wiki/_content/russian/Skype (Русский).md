...
**Обратите внимание:** Большое спасибо за это Lorenzo Colitti!
...
**Обратите внимание:** Данный пример подразумевает что Skype настроен сохранять полученные файлы в `~/Public`. Вы можете свободно менять её под ваши параметры.
...
Заметьте, что данный раздел описывает использование TOMOYO 2.5\. Смотрите установку [TOMOYO_Linux#TOMOYO_Linux_2.x](/index.php/TOMOYO_Linux#TOMOYO_Linux_2.x "TOMOYO Linux").

**Обратите внимание:** Не забудьте заполнить сначала папку `/etc/tomoyo` запустив: `/usr/lib/tomoyo/init_policy`
...
**Обратите внимание:** Этот пример подразумевает, что ваши скачанные файлы skype кладёт в `/home/skype/downloads`

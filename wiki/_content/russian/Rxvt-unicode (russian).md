...
*   [2 Настройка](#Настройка)
    *   [2.1 Создание ~/.Xresources](#Создание_~/.Xresources)
    *   [2.2 Полоса прокрутки](#Полоса_прокрутки)
    *   [2.3 Позиция полосы прокрутки](#Позиция_полосы_прокрутки)
    *   [2.4 Прокрутка буфера в дополнительном экране](#Прокрутка_буфера_в_дополнительном_экране)
    *   [2.5 Методы декларации шрифта](#Методы_декларации_шрифта)
    *   [2.6 Расстояние шрифта](#Расстояние_шрифта)
    *   [2.7 Цвета](#Цвета)
*   [3 Вырезать и вставить](#Вырезать_и_вставить)
*   [4 Perl расширения](#Perl_расширения)
    *   [4.1 Кликабельные ссылки (URL-адреса)](#Кликабельные_ссылки_(URL-адреса))
    *   [4.2 Yankable URL'ы (без мыши)](#Yankable_URL'ы_(без_мыши))
    *   [4.3 Простые вкладки](#Простые_вкладки)
    *   [4.4 Полноэкранный](#Полноэкранный)
    *   [4.5 Поддержка колеса прокрутки](#Поддержка_колеса_прокрутки)
    *   [4.6 Изменение размера шрифта на лету](#Изменение_размера_шрифта_на_лету)
    *   [4.7 Отключение расширений Perl](#Отключение_расширений_Perl)
    *   [4.8 Цвета как в Xterm](#Цвета_как_в_Xterm)
*   [5 Решение проблем](#Решение_проблем)
    *   [5.1 Настройки ~/.Xresources не применяются](#Настройки_~/.Xresources_не_применяются)
    *   [5.2 Прозрачность не работает после обновления, начиная с версии 9.09](#Прозрачность_не_работает_после_обновления,_начиная_с_версии_9.09)
    *   [5.3 Удаленные хосты](#Удаленные_хосты)
    *   [5.4 Использование rxvt-Unicode в качестве терминала gmrun (Gnome Completion-Run)](#Использование_rxvt-Unicode_в_качестве_терминала_gmrun_(Gnome_Completion-Run))
    *   [5.5 Моя цифровая клавиатура действует странно и производит странный вывод (например, в VIM)](#Моя_цифровая_клавиатура_действует_странно_и_производит_странный_вывод_(например,_в_VIM))
    *   [5.6 pseudo-tty](#pseudo-tty)
    *   [5.7 Горячие клавиши не работают](#Горячие_клавиши_не_работают)
    *   [5.8 Низкая производительность при рисовании глифов](#Низкая_производительность_при_рисовании_глифов)
...
**Примечание:** Пожалуйста, не используйте эту опцию с расширением Perl [vtwheel](#Поддержка_колеса_прокрутки): это приведёт к беспорядку
...
Соответствующие ссылки могут быть окрашены с помощью [#Цвета](#Цвета) переднего плана (foreground) или фона (background), например, в синий:

...
*   [2 Настройка](#Настройка)
    *   [2.1 Создание файла настроек](#Создание_файла_настроек)
        *   [2.1.1 Примеры](#Примеры)
    *   [2.2 Расширения](#Расширения)
    *   [2.3 Автозапуск программ](#Автозапуск_программ)
    *   [2.4 Выбор раскладки клавиатуры](#Выбор_раскладки_клавиатуры)
    *   [2.5 Темы оформления](#Темы_оформления)
        *   [2.5.1 Обои рабочего стола](#Обои_рабочего_стола)
*   [3 Советы и рекомендации](#Советы_и_рекомендации)
    *   [3.1 Скрыть / показать wibox](#Скрыть_/_показать_wibox)
    *   [3.2 Скриншот (снимок экрана)](#Скриншот_(снимок_экрана))
    *   [3.3 Удаление пробелов окна](#Удаление_пробелов_окна)
    *   [3.4 Прозрачность](#Прозрачность)
        *   [3.4.1 Conky](#Conky)
        *   [3.4.2 wibox'ы](#wibox'ы)
        *   [3.4.3 ImageMagick](#ImageMagick)
    *   [3.5 Передача информации виджетам при помощи awesome-client](#Передача_информации_виджетам_при_помощи_awesome-client)
    *   [3.6 Использование другой панели с awesome](#Использование_другой_панели_с_awesome)
    *   [3.7 Каталоги приложений в строке меню](#Каталоги_приложений_в_строке_меню)
    *   [3.8 Всплывающие меню](#Всплывающие_меню)
    *   [3.9 Меню приложений](#Меню_приложений)
    *   [3.10 Заголовки окон (titlebars )](#Заголовки_окон_(titlebars_))
    *   [3.11 Уведомление состояния батареи](#Уведомление_состояния_батареи)
*   [4 Решение проблем](#Решение_проблем)
    *   [4.1 Нахождение и устранение ошибок rc.lua](#Нахождение_и_устранение_ошибок_rc.lua)
        *   [4.1.1 awmtt](#awmtt)
    *   [4.2 Файл журналов](#Файл_журналов)
    *   [4.3 Клавиша Mod4](#Клавиша_Mod4)
        *   [4.3.1 Клавиша Mod4 против пользователей IBM ThinkPad](#Клавиша_Mod4_против_пользователей_IBM_ThinkPad)
    *   [4.4 Исправление для Java приложений (серый интерфейс)](#Исправление_для_Java_приложений_(серый_интерфейс))
    *   [4.5 Eclipse: невозможно изменить размер/переместить главное окно](#Eclipse:_невозможно_изменить_размер/переместить_главное_окно)
    *   [4.6 YouTube: полноэкранный режим показывает как в фоновом режиме](#YouTube:_полноэкранный_режим_показывает_как_в_фоновом_режиме)
    *   [4.7 Запретить колесу прокрутки мыши менять теги](#Запретить_колесу_прокрутки_мыши_менять_теги)
    *   [4.8 Запуск консольных клиентов на определённом теге](#Запуск_консольных_клиентов_на_определённом_теге)
    *   [4.9 Не работает мышка в не латинской раскладке клавиатуры](#Не_работает_мышка_в_не_латинской_раскладке_клавиатуры)
...
Для запуска awesome из [Xinitrc](/index.php/Xinitrc_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Xinitrc (Русский)"), добавьте `exec awesome` в `~/.xinitrc`. Для того, чтобы использовать входящий в комплект файл [xsession](/index.php/%D0%AD%D0%BA%D1%80%D0%B0%D0%BD%D0%BD%D1%8B%D0%B9_%D0%BC%D0%B5%D0%BD%D0%B5%D0%B4%D0%B6%D0%B5%D1%80#Список_сеансов "Экранный менеджер"), смотрите [Экранный менеджер](/index.php/%D0%AD%D0%BA%D1%80%D0%B0%D0%BD%D0%BD%D1%8B%D0%B9_%D0%BC%D0%B5%D0%BD%D0%B5%D0%B4%D0%B6%D0%B5%D1%80 "Экранный менеджер").

...
*   [1 Обзор](#Обзор)
    *   [1.1 Типы](#Типы)
*   [2 Список оконных менеджеров](#Список_оконных_менеджеров)
    *   [2.1 Стековые оконные менеджеры](#Стековые_оконные_менеджеры)
    *   [2.2 Фреймовые оконные менеджеры](#Фреймовые_оконные_менеджеры)
    *   [2.3 Динамические оконные менеджеры](#Динамические_оконные_менеджеры)
...
Спецификация [Extended Window Manager Hints от X Desktop Group](https://specifications.freedesktop.org/wm-spec/wm-spec-latest.html) создана и используется для того, чтобы позволить разным оконным менеджерам единообразно взаимодействовать с сервером X и другими клиентами.

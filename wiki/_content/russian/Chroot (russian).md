...
*   [3 Монтирование разделов](#Монтирование_разделов)
*   [4 Изменение корневого раздела](#Изменение_корневого_раздела)
    *   [4.1 Используя arch-chroot](#Используя_arch-chroot)
    *   [4.2 Используя chroot](#Используя_chroot)
    *   [4.3 Используя systemd-nspawn](#Используя_systemd-nspawn)
*   [5 Запуск графических приложений в среде chroot](#Запуск_графических_приложений_в_среде_chroot)
*   [6 Выход из среды chroot](#Выход_из_среды_chroot)
*   [7 Без прав суперпользователя](#Без_прав_суперпользователя)
    *   [7.1 PRoot](#PRoot)
...
*   Переустановка [загрузчика](/index.php/Boot_loader "Boot loader").
...
Чтобы вернуться в основную систему, просто разлогиньтесь или запустите команду *poweroff*. После этого вы можете размонтировать разделы, как показано в [#Выход из среды chroot](#Выход_из_среды_chroot).

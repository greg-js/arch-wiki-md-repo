...
**Примечание:** Сами пакеты находятся в [svn](https://www.archlinux.org/svn/) и [git](https://projects.archlinux.org/svntogit/packages.git/) репозиториях, а скрипт `abs` скачивает их с помощью [rsync](/index.php/Rsync "Rsync").
...
**Примечание:** Прежде чем жаловаться на недостающие зависимости (во время make), не забудьте проверить, что группа [base-devel](https://www.archlinux.org/groups/x86_64/base-devel/) установлена, поскольку это подразумевается при сборке пакетов с помощью *makepkg*. Смотрите [#Установка инструментов](#.D0.A3.D1.81.D1.82.D0.B0.D0.BD.D0.BE.D0.B2.D0.BA.D0.B0_.D0.B8.D0.BD.D1.81.D1.82.D1.80.D1.83.D0.BC.D0.B5.D0.BD.D1.82.D0.BE.D0.B2).

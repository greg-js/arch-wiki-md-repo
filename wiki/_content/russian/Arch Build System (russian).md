...
**Состояние перевода:** На этой странице представлен перевод статьи [Arch Build System](/index.php/Arch_Build_System "Arch Build System"). Дата последней синхронизации: 2 февраля 2020\. Вы можете [помочь](/index.php/ArchWiki_Translation_Team_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "ArchWiki Translation Team (Русский)") синхронизировать перевод, если в английской версии произошли [изменения](https://wiki.archlinux.org/index.php?title=Arch_Build_System&diff=0&oldid=596073).
...
*   [2 Способы применения](#Способы_применения)
*   [3 Использование](#Использование)
    *   [3.1 Получение PKGBUILD](#Получение_PKGBUILD)
        *   [3.1.1 Получение PKGBUILD посредством SVN](#Получение_PKGBUILD_посредством_SVN)
        *   [3.1.2 Получение PKGBUILD посредством Git](#Получение_PKGBUILD_посредством_Git)
    *   [3.2 Сборка пакета](#Сборка_пакета)
    *   [3.3 Установка пакета](#Установка_пакета)
*   [4 Советы и рекомендации](#Советы_и_рекомендации)
    *   [4.1 Оставлять модифицированные пакеты](#Оставлять_модифицированные_пакеты)
    *   [4.2 Синхронизация устаревшей версии пакета](#Синхронизация_устаревшей_версии_пакета)
*   [5 Другие инструменты](#Другие_инструменты)
...
*   Сборка и установка новых пакетов из исходных кодов программ, для которых ещё нет пакетов (см. [Создание пакетов](/index.php/%D0%A1%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D0%B5_%D0%BF%D0%B0%D0%BA%D0%B5%D1%82%D0%BE%D0%B2 "Создание пакетов"));
...
*   Чистая сборка и установка собственного ядра (см. [Компиляция ядра](/index.php/Kernels_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Компиляция_ядра "Kernels (Русский)"));
...
Есть два способа получить файл [PKGBUILD](/index.php/PKGBUILD_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "PKGBUILD (Русский)") пакета в официальном репозитории: через SVN и посредством Git. Ниже описаны оба подхода.

#### Получение PKGBUILD посредством SVN

Предварительно [установите](/index.php/%D0%A3%D1%81%D1%82%D0%B0%D0%BD%D0%BE%D0%B2%D0%B8%D1%82%D0%B5 "Установите") пакет [subversion](https://www.archlinux.org/packages/?name=subversion).
...
[Установите](/index.php/%D0%A3%D1%81%D1%82%D0%B0%D0%BD%D0%BE%D0%B2%D0%B8%D1%82%D0%B5 "Установите") пакет [asp](https://www.archlinux.org/packages/?name=asp). [asp](https://github.com/falconindy/asp) — инструмент для сборки пакетов Arch Linux из исходных кодов. Работает через git-интерфейс, что открывает доступ к более свежим исходным кодам. Подробнее смотрите [обсуждение](https://bbs.archlinux.org/viewtopic.php?id=185075) на форуме.
...
**Совет:** Для получения информации о других возможных настройках `makepkg` обратитесь к разделам [makepkg#Использование](/index.php/Makepkg_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Использование "Makepkg (Русский)") и [makepkg#Настройка](/index.php/Makepkg_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Настройка "Makepkg (Русский)").

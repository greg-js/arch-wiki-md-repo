...
Большинство keysyms интуитивно понятны. Наример, чтобы настроить клавишу 112 для вывода символа 'e', директива примет следующий вид:

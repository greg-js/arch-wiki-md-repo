...
`-o [options]`
	...
	Смотрите страницу руководства [mount.cifs(8)](http://jlk.fjfi.cvut.cz/arch/manpages/man/mount.cifs.8) для получения информации.

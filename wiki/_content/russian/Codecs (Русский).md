Цитата из [Википедии](https://en.wikipedia.org/wiki/ru:%D0%9A%D0%BE%D0%B4%D0%B5%D0%BA "wikipedia:ru:Кодек"):
	...
	_Ко́дек (англ. codec, от coder/decoder — кодировщик/декодировщик или compressor/decompressor) — устройство или программа, способная выполнять преобразование данных или сигнала._

**Состояние перевода:** На этой странице представлен перевод статьи [Wine](/index.php/Wine "Wine"). Дата последней синхронизации: 30 января 2015\. Вы можете [помочь](/index.php/ArchWiki_Translation_Team_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "ArchWiki Translation Team (Русский)") синхронизировать перевод, если в английской версии произошли [изменения](https://wiki.archlinux.org/index.php?title=Wine&diff=0&oldid=358855).
...
*   [2 Настройка](#Настройка)
    ...
    *   [2.3 Графические драйверы](#Графические_драйверы)
    *   [2.4 Звук](#Звук)
        *   [2.4.1 Поддержка MIDI](#Поддержка_MIDI)
    *   [2.5 Другие библиотеки](#Другие_библиотеки)
    *   [2.6 Шрифты](#Шрифты)
    *   [2.7 Значки запуска программ](#Значки_запуска_программ)
        *   [2.7.1 Создание пунктов меню для утилит Wine](#Создание_пунктов_меню_для_утилит_Wine)
        *   [2.7.2 Удаление пунктов меню](#Удаление_пунктов_меню)
        *   [2.7.3 Неверный раздел в меню KDE 4](#Неверный_раздел_в_меню_KDE_4)
*   [3 Запуск приложений Windows](#Запуск_приложений_Windows)
*   [4 Советы и рекомендации](#Советы_и_рекомендации)
    *   [4.1 Сброс ассоциаций файлов Wine](#Сброс_ассоциаций_файлов_Wine)
    *   [4.2 Два монитора с разными разрешениями](#Два_монитора_с_разными_разрешениями)
    *   [4.3 exe-thumbnailer](#exe-thumbnailer)
    *   [4.4 Патч CSMT](#Патч_CSMT)
        *   [4.4.1 Дополнительная информация о CSMT](#Дополнительная_информация_о_CSMT)
    *   [4.5 Изменение языка](#Изменение_языка)
    *   [4.6 Установка Microsoft Office 2010](#Установка_Microsoft_Office_2010)
    *   [4.7 Правильное монтирование образов компакт-дисков](#Правильное_монтирование_образов_компакт-дисков)
    *   [4.8 Запись на компакт-диски](#Запись_на_компакт-диски)
    *   [4.9 OpenGL](#OpenGL)
    *   [4.10 Использование Wine как интерпретатор для исполняемых файлов Win16/Win32](#Использование_Wine_как_интерпретатор_для_исполняемых_файлов_Win16/Win32)
    *   [4.11 Wineconsole](#Wineconsole)
    *   [4.12 Winetricks](#Winetricks)
    *   [4.13 Установка .NET framework 4.0](#Установка_.NET_framework_4.0)
    *   [4.14 Треск из колонок при использовании PulseAudio](#Треск_из_колонок_при_использовании_PulseAudio)
    *   [4.15 16-битные программы](#16-битные_программы)
*   [5 Сторонние оболочки](#Сторонние_оболочки)
...
Смотрите также раздел [Настройка шрифтов#Приложения без поддержки fontconfig](/index.php/%D0%9D%D0%B0%D1%81%D1%82%D1%80%D0%BE%D0%B9%D0%BA%D0%B0_%D1%88%D1%80%D0%B8%D1%84%D1%82%D0%BE%D0%B2#Приложения_без_поддержки_fontconfig "Настройка шрифтов").

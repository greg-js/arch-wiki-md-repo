...
**Обратите внимание:** Если вы получаете сообщение вида `ping: icmp open socket: Operation not permitted` (операция не позволена) при вызове *ping*, попробуйте переустановить пакет [iputils](https://www.archlinux.org/packages/?name=iputils)

...
*   [GNU Parted](/index.php/GNU_Parted "GNU Parted"): Создайте раздел FAT32 и в Parted установите/активируйте флаг `boot` (**не** флаг `legacy_boot`) на этом разделе. Перейдите к разделу [#Монтирование раздела](#Монтирование_раздела) ниже.

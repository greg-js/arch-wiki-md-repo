...
Основным способ получения исходных кодов **dwm** является использование [ABS](/index.php/Arch_Build_System_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Arch Build System (Русский)")([asp](https://www.archlinux.org/packages/?name=asp)). Однако для ознакомления(или в случаи отсутствия необходимости конфигурации) можно установить пакет [dwm](https://aur.archlinux.org/packages/dwm/) из официального репозитория.

...
**Обратите внимание:** **Настоятельно рекомендуется использовать VMWare Server 2 на ядре 2.6.27, так как это актуальные сборки. Также они не требуют наложения патча.**
...
**Обратите внимание:** ethtool is on extra packages

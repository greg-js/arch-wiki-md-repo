...
[autojump](https://aur.archlinux.org/packages/autojump/) позволяет перемещаться по файловой системе при помощи поиска строк в базе данных наиболее часто посещаемых пользователем путей.

...
*   [1 Низкоуровневые интерфейсы](#Низкоуровневые_интерфейсы)
    *   [1.1 kernel (swsusp)](#kernel_(swsusp))
    *   [1.2 uswsusp](#uswsusp)
*   [2 Интерфейсы высокого уровня](#Интерфейсы_высокого_уровня)
    *   [2.1 systemd](#systemd)
*   [3 Гибернация](#Гибернация)
    *   [3.1 Про размер раздела/файла подкачки](#Про_размер_раздела/файла_подкачки)
    *   [3.2 Необходимые параметры ядра](#Необходимые_параметры_ядра)
        *   [3.2.1 Гибернация в файл подкачки](#Гибернация_в_файл_подкачки)
    *   [3.3 Настройка initramfs](#Настройка_initramfs)
*   [4 Исправление проблем](#Исправление_проблем)
    *   [4.1 ACPI_OS_NAME](#ACPI_OS_NAME)
    *   [4.2 Пользователям VAIO](#Пользователям_VAIO)
    *   [4.3 Ждущий/Спящий режим не работает или сбоит](#Ждущий/Спящий_режим_не_работает_или_сбоит)

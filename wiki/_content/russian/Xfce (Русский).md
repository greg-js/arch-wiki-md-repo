...
Если вы хотите **загрузить** профиль icc (который вы создали или получили из сети) для калибровки монитора в момент запуска системы, вы можете установить пакет [xcalib](https://aur.archlinux.org/packages/xcalib/) из [AUR](/index.php/AUR_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "AUR (Русский)"), затем открыть _Settings Manager_, зайти в _Session and Startup_ и на вкладке _Autostart_ добавить такую команду в список автозапуска:

...
*   [2 Настройка после установки](#Настройка_после_установки)
...
Теперь [соберите и установите](/index.php/Arch_User_Repository_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Установка_пакетов "Arch User Repository (Русский)") пакет, как обычно.
...
Пакет [nessus](https://aur.archlinux.org/packages/nessus/) предоставляет файл юнита `nessusd.service`, для получения дополнительной информации смотрите раздел [systemd (Русский)#Использование юнитов](/index.php/Systemd_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Использование_юнитов "Systemd (Русский)").
...
Пакет может быть удален при помощи [pacman](/index.php/Pacman_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Удаление_пакетов "Pacman (Русский)"), но файлы, созданные Nessus — например, база данных установленных плагинов, должны быть удалены вручную:
...
**Примечание:** Эта команда удалит ваши настройки Nessus.

...
**Состояние перевода:** На этой странице представлен перевод статьи [makepkg](/index.php/Makepkg "Makepkg"). Дата последней синхронизации: 16 января 2020\. Вы можете [помочь](/index.php/ArchWiki_Translation_Team_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "ArchWiki Translation Team (Русский)") синхронизировать перевод, если в английской версии произошли [изменения](https://wiki.archlinux.org/index.php?title=Makepkg&diff=0&oldid=594210).
...
*   Устанавливаемые пакеты-зависимости должны находиться в подключённых репозиториях; в статье [Pacman#Репозитории и зеркала](/index.php/Pacman_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Репозитории_и_зеркала "Pacman (Русский)") описана настройка репозиториев. Кроме того, зависимости можно установить вручную командой `pacman -S --asdeps *зависимость1* *зависимость2*`.

...
Посмотрите [gcc(1)](http://jlk.fjfi.cvut.cz/arch/manpages/man/gcc.1) для полного списка доступных опций. Дополнительную информацию можно найти в вики проекта Gentoo: [Compilation Optimization Guide](http://www.gentoo.org/doc/en/gcc-optimization.xml) и [Safe Cflags](http://wiki.gentoo.org/wiki/Safe_CFLAGS).
...
Смотрите [make(1)](http://jlk.fjfi.cvut.cz/arch/manpages/man/make.1) для полного списка доступных опций.

**Состояние перевода:** На этой странице представлен перевод статьи [Command-line shell](/index.php/Command-line_shell "Command-line shell"). Дата последней синхронизации: 18 января 2016\. Вы можете [помочь](/index.php/ArchWiki_Translation_Team_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "ArchWiki Translation Team (Русский)") синхронизировать перевод, если в английской версии произошли [изменения](https://wiki.archlinux.org/index.php?title=Command-line_shell&diff=0&oldid=416001).
...
*   [>_ .bashrc генератор PS1](http://bashrcgenerator.com/) создайте свою строку вывода bash .bashrc/PS1 с помощью простого интерфейса.
*   [terminal.sexy](https://terminal.sexy/) — Конструктор цветовых схем терминала

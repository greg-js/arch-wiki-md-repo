...
**Примечание:** *Xinit* имеет собственное поведение по умолчанию, вместо выполнения файла. Для подробностей,смотрите [xinit(1)](http://jlk.fjfi.cvut.cz/arch/manpages/man/xinit.1).
...
Смотрите также [startx(1)](http://jlk.fjfi.cvut.cz/arch/manpages/man/startx.1).

...
*   [3 Запуск](#Запуск)
*   [4 Автозапуск X при входе в систему](#Автозапуск_X_при_входе_в_систему)
    *   [4.1 Автоматический вход в виртуальной консоли](#Автоматический_вход_в_виртуальной_консоли)
*   [5 Советы и рекомендации](#Советы_и_рекомендации)
    *   [5.1 Переопределение xinitrc из командной строки](#Переопределение_xinitrc_из_командной_строки)
    *   [5.2 Создание выбора DE/WM (Окружения рабочего стола/Оконного менеджера)](#Создание_выбора_DE/WM_(Окружения_рабочего_стола/Оконного_менеджера))
    *   [5.3 Запуск приложений без оконного менеджера](#Запуск_приложений_без_оконного_менеджера)
...
Смотрите также [Fish#Запуск X при входе в систему](/index.php/Fish_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Запуск_X_при_входе_в_систему "Fish (Русский)") и [Systemd/User#Automatic login into Xorg without display manager](/index.php/Systemd/User#Automatic_login_into_Xorg_without_display_manager "Systemd/User").
...
**Совет:** Это может быть использовано даже для запуска программ с графическим интерфейсом, но без каких-либо особенностей оконного менеджера. Смотрите также [#Запуск приложений без оконного менеджера](#Запуск_приложений_без_оконного_менеджера) и [Запуск программ в отдельном экране X](/index.php/Running_program_in_separate_X_display_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Running program in separate X display (Русский)").
...
Смотрите также [Display manager (Русский)#Запуск приложений без оконного менеджера](/index.php/Display_manager_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Запуск_приложений_без_оконного_менеджера "Display manager (Русский)").
...
*   [1 Обзор](#Обзор)
*   [2 Получение информации](#Получение_информации)
*   [3 Автоматическое управление модулями](#Автоматическое_управление_модулями)
*   [4 Управление модулями вручную](#Управление_модулями_вручную)
*   [5 Настройка параметров модуля](#Настройка_параметров_модуля)
    *   [5.1 С помощью файлов в /etc/modprobe.d/](#С_помощью_файлов_в_/etc/modprobe.d/)
    *   [5.2 С помощью командной строки ядра](#С_помощью_командной_строки_ядра)
*   [6 Создание псевдонимов](#Создание_псевдонимов)
*   [7 Запрет загрузки](#Запрет_загрузки)
    *   [7.1 С помощью файлов в /etc/modprobe.d/](#С_помощью_файлов_в_/etc/modprobe.d/_2)
    *   [7.2 С помощью командной строки ядра](#С_помощью_командной_строки_ядра_2)
*   [8 Решение проблем](#Решение_проблем)
    *   [8.1 Модули не загружаются](#Модули_не_загружаются)

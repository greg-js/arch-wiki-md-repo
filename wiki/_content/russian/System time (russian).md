...
*   [3 Часовой пояс](#Часовой_пояс)
*   [4 Установка времени](#Установка_времени)
*   [5 Если нет файла rc.conf](#Если_нет_файла_rc.conf)
*   [6 Погрешность часов](#Погрешность_часов)
*   [7 Синхронизация времени](#Синхронизация_времени)
*   [8 Возможные проблемы](#Возможные_проблемы)
*   [9 См. также](#См._также)
...
После этих операций скорее всего придется обновить ваши аппаратные и системные часы. См. ниже [#Установка времени](#Установка_времени).

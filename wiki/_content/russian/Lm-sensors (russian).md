...
*   [1 Использование](#Использование)
    ...
    *   [1.3 Просмотр датчиков](#Просмотр_датчиков)
    *   [1.4 Считывание SPD-значений из памяти модулей (опционально)](#Считывание_SPD-значений_из_памяти_модулей_(опционально))
*   [2 Использование данных датчиков](#Использование_данных_датчиков)
    *   [2.1 Графические фронтэнды](#Графические_фронтэнды)
    *   [2.2 sensord](#sensord)
*   [3 Советы и рекомендации](#Советы_и_рекомендации)
    *   [3.1 Регулировка значений](#Регулировка_значений)
        *   [3.1.1 Пример 1\. Регулировка температурных смещений](#Пример_1._Регулировка_температурных_смещений)
        *   [3.1.2 Пример 2\. Переименование параметров](#Пример_2._Переименование_параметров)
        *   [3.1.3 Пример 3\. Изменение нумерации ядер для многопроцессорных систем](#Пример_3._Изменение_нумерации_ядер_для_многопроцессорных_систем)
    *   [3.2 Автоматизация развертывания lm_sensors](#Автоматизация_развертывания_lm_sensors)
*   [4 Решение проблем](#Решение_проблем)
    *   [4.1 Модуль K10Temp](#Модуль_K10Temp)
    *   [4.2 Датчики не работают с Linux 2.6.31](#Датчики_не_работают_с_Linux_2.6.31)
...
**Примечание:** Служба systemd добавится автоматически после того, как будет послан ответ **YES** на предложение создать `/etc/conf.d/lm_sensors`. Так же отвечая положительно эта служба будет незамедлительно запущена.
...
**Примечание:** Уже готовые файлы настройки можно посмотреть на сайте [lm-sensor](http://www.lm-sensors.org/wiki/Configurations).

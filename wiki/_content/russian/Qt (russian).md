...
*   [2 Выбор набора Qt по умолчанию](#Выбор_набора_Qt_по_умолчанию)
    *   [2.1 Используя переменные окружения](#Используя_переменные_окружения)
    *   [2.2 Используя файл конфигурации](#Используя_файл_конфигурации)
*   [3 Внешний вид](#Внешний_вид)
    *   [3.1 Настройка](#Настройка)
        *   [3.1.1 Темы](#Темы)
        *   [3.1.2 Шрифты](#Шрифты)
        *   [3.1.3 Значки](#Значки)
    *   [3.2 Ручная настройка](#Ручная_настройка)
    *   [3.3 Таблицы стилей Qt](#Таблицы_стилей_Qt)
    *   [3.4 GTK+ и Qt](#GTK+_и_Qt)
*   [4 Разработка](#Разработка)
    *   [4.1 Поддержка платформ](#Поддержка_платформ)
    *   [4.2 Инструменты](#Инструменты)
    *   [4.3 Другие языки программирования](#Другие_языки_программирования)
        *   [4.3.1 C++](#C++)
        *   [4.3.2 QML](#QML)
...
Установив [qtchooser](https://aur.archlinux.org/packages/qtchooser/), вы сможете выбрать, для какого набора Qt из установленных необходимо перенести исполняемые файлы (например, *qmake*) в `/usr/bin`. По умолчанию используется Qt5.

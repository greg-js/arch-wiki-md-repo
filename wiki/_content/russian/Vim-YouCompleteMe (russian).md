...
*   [2 Настройка](#Настройка)
    ...
    *   [2.2 Java](#Java)
    *   [2.3 Java (альтернативный вариант)](#Java_(альтернативный_вариант))
    *   [2.4 C#](#C#)
...
У YCM есть встроенная поддержка сервера [jdt.ls](https://github.com/eclipse/eclipse.jdt.ls), который можно установить с помощью опции `--java-completer` при запуске `install.py`.
...
Перед началом работы с проектом на C# убедитесь, что в системе установлен пакет [msbuild-stable](https://aur.archlinux.org/packages/msbuild-stable/), так как он является обязательной зависимостью Omnisharp Roslyn — движка автодополнения для C#, используемого YouCompleteMe. Более подробная информация доступна в [README](https://github.com/OmniSharp/omnisharp-roslyn/) репозитория Omnisharp Roslyn и в [данном issue](https://github.com/OmniSharp/omnisharp-roslyn/issues/1168) на GitHub.

...
Если вы хотите использовать _tty_ отличный от _tty1_, смотрите [systemd FAQ](/index.php/Systemd_FAQ#How_do_I_change_the_default_number_of_gettys.3F "Systemd FAQ").

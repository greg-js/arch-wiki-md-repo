...
*   [1 Основы использования](#Основы_использования)
    ...
    *   [1.2 Примеры настроек](#Примеры_настроек)
        *   [1.2.1 Проводной адаптер с DHCP](#Проводной_адаптер_с_DHCP)
        *   [1.2.2 Проводной адаптер использующий статический IP](#Проводной_адаптер_использующий_статический_IP)
        *   [1.2.3 Беспроводной адаптер](#Беспроводной_адаптер)
        *   [1.2.4 Проводные и беспроводные адаптеры на одной машине](#Проводные_и_беспроводные_адаптеры_на_одной_машине)
        *   [1.2.5 IPv6 расширения конфиденциальности](#IPv6_расширения_конфиденциальности)
...
Все настройки этого раздела хранятся в `foo.network` в `/etc/systemd/network`. Для получения полного списка опций и порядка обработки, см. [#Файлы настроек](#Файлы_настроек) и страницу man `systemd.network`.
...
Если беспроводной адаптер имеет статический IP-адрес, настройка является такой же (кроме имени интерфейса) как в [проводном адаптере](#Проводной_адаптер_использующий_статический_IP).

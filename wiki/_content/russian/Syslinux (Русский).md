...
**Обратите внимание:** Если вы используете pxelinux, измените имя с *memtest.bin* на *memtest*, поскольку pxelinux интерпретирует файлы с расширением .bin как загрузочные секторы и загружает только 2KB из них

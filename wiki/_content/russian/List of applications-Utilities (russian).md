...
*   [1 Утилиты](#Утилиты)
    *   [1.1 Разделы дисков](#Разделы_дисков)
    *   [1.2 Монтирование](#Монтирование)
        *   [1.2.1 Udisks](#Udisks)
    *   [1.3 Базовые команды оболочки](#Базовые_команды_оболочки)
    *   [1.4 Интегрированные среды разработки (IDE)](#Интегрированные_среды_разработки_(IDE))
    *   [1.5 Эмуляторы терминала](#Эмуляторы_терминала)
        *   [1.5.1 На основе VTE](#На_основе_VTE)
    *   [1.6 Файлы](#Файлы)
        *   [1.6.1 Файловые менеджеры](#Файловые_менеджеры)
            *   [1.6.1.1 Консольные](#Консольные)
            *   [1.6.1.2 Графические](#Графические)
        *   [1.6.2 Поисковые движки](#Поисковые_движки)
        *   [1.6.3 Инструменты архивации и сжатия](#Инструменты_архивации_и_сжатия)
            *   [1.6.3.1 Консольные](#Консольные_2)
            *   [1.6.3.2 Графические](#Графические_2)
        *   [1.6.4 Сравнение, поиск различий, объединение](#Сравнение,_поиск_различий,_объединение)
        *   [1.6.5 Групповые переименования](#Групповые_переименования)
    *   [1.7 Очистка диска](#Очистка_диска)
    *   [1.8 Информация об использовании дискового пространства](#Информация_об_использовании_дискового_пространства)
    *   [1.9 Синхронизация времени](#Синхронизация_времени)
    *   [1.10 Состояние системы](#Состояние_системы)
    *   [1.11 Просмотр информации о системе](#Просмотр_информации_о_системе)
        *   [1.11.1 Консольные](#Консольные_3)
        *   [1.11.2 Графические](#Графические_3)
        *   [1.11.3 Другие](#Другие)
    *   [1.12 Переключение раскладки клавиатуры](#Переключение_раскладки_клавиатуры)
    *   [1.13 Управление питанием](#Управление_питанием)
    *   [1.14 Менеджеры буфера обмена](#Менеджеры_буфера_обмена)
    *   [1.15 Обои рабочего стола](#Обои_рабочего_стола)
    *   [1.16 Управление пакетами](#Управление_пакетами)

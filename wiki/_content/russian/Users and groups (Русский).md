...
| video | `/dev/fb/0`, `/dev/misc/agpgart` | Access to video capture devices, DRI/3D hardware acceleration ([X](/index.php/Xorg "Xorg") can be used _without_ belonging to this group). |

...
*   [Шрифты#Шрифт в консоли](/index.php/%D0%A8%D1%80%D0%B8%D1%84%D1%82%D1%8B#Шрифт_в_консоли "Шрифты")
...
*   [2 Раскладки клавиатуры](#Раскладки_клавиатуры)
    *   [2.1 Список раскладок](#Список_раскладок)
    *   [2.2 Временная конфигурация (Loadkeys)](#Временная_конфигурация_(Loadkeys))
    *   [2.3 Постоянная конфигурация](#Постоянная_конфигурация)
    *   [2.4 Создание своей раскладки](#Создание_своей_раскладки)
        *   [2.4.1 Добавление директив](#Добавление_директив)
        *   [2.4.2 Другие примеры](#Другие_примеры)
        *   [2.4.3 Сохранение изменений](#Сохранение_изменений)
*   [3 Регулировка задержки и скорости автоповтора](#Регулировка_задержки_и_скорости_автоповтора)
    *   [3.1 Служба systemd](#Служба_systemd)

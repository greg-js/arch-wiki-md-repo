...
в наш файл `.ssh/config`, который говорит *ssh* использовать эту опцию, как альтернативу: можно использовать 'ssh -o' (смотрите страницу справочного руководства `man ssh`).

...
в наш файл `.ssh/config`, который говорит *ssh* использовать эту опцию, как альтернативу: можно использовать 'ssh -o' (смотрите страницу справочного руководства [ssh(1)](http://jlk.fjfi.cvut.cz/arch/manpages/man/ssh.1)).

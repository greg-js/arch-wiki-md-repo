...
**Обратите внимание:** Чтобы использовать urxvt, его нужно поставить: pacman -S rxvt-unicode
...
**Обратите внимание:** Если вы не переназначили Mod-клавишу. то (как говорилось выше) по умолчанию это Alt
...
**Обратите внимание:** Существует также [dzen2](https://www.archlinux.org/packages/?name=dzen2) который можно заменить на [xmobar](https://www.archlinux.org/packages/?name=xmobar).
...
Теперь выберите "Xmonad GNOME (Composite)" в списке сеансов, во время входа в систему. Посмотрите `man xcompmgr` для дополнительных настроек "радующих глаз".
...
**Обратите внимание:** Вы можете получить сообщение об ошибке, что xmonad-x86_64-linux не найден потому что [xmonad-contrib](https://www.archlinux.org/packages/?name=xmonad-contrib) не установлен.

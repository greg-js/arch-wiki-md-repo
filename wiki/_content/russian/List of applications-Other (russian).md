...
*   [1 Другие](#Другие)
    *   [1.1 Рабочие окружения](#Рабочие_окружения)
        *   [1.1.1 Графические заставки при загрузке системы (bootsplash)](#Графические_заставки_при_загрузке_системы_(bootsplash))
        *   [1.1.2 Командные оболочки](#Командные_оболочки)
        *   [1.1.3 Терминальные мультиплексоры](#Терминальные_мультиплексоры)
        *   [1.1.4 Окружения рабочего стола](#Окружения_рабочего_стола)
        *   [1.1.5 Оконные менеджеры](#Оконные_менеджеры)
            *   [1.1.5.1 Консольные](#Консольные)
            *   [1.1.5.2 Графические](#Графические)
        *   [1.1.6 Переключатели виртуальных рабочих столов](#Переключатели_виртуальных_рабочих_столов)
        *   [1.1.7 Приложения-помощники](#Приложения-помощники)
            *   [1.1.7.1 Менеджеры входа в систему](#Менеджеры_входа_в_систему)
            *   [1.1.7.2 Композитные менеджеры](#Композитные_менеджеры)
            *   [1.1.7.3 Панели задач / доки](#Панели_задач_/_доки)
            *   [1.1.7.4 Утилиты запуска приложений](#Утилиты_запуска_приложений)
            *   [1.1.7.5 Диалоги завершения работы](#Диалоги_завершения_работы)
    *   [1.2 Финансы](#Финансы)
    *   [1.3 Время](#Время)
        *   [1.3.1 Консольные](#Консольные_2)
        *   [1.3.2 Графические](#Графические_2)
    *   [1.4 Эмуляторы](#Эмуляторы)
        *   [1.4.1 Консоли](#Консоли)
        *   [1.4.2 Другое](#Другое)
    *   [1.5 Любительское радио](#Любительское_радио)

...
*   [2 Настройка](#Настройка)
    *   [2.1 Пример файла input.conf](#Пример_файла_input.conf)
    *   [2.2 mpv и управление PulseAudio/ALSA mixer'ом с версии 0.18.1](#mpv_и_управление_PulseAudio/ALSA_mixer'ом_с_версии_0.18.1)
*   [3 Скрипты](#Скрипты)
...
*   [4 Советы и рекомендации](#Советы_и_рекомендации)
    *   [4.1 Аппаратное декодирование](#Аппаратное_декодирование)
    *   [4.2 Высокое качество воспроизведения](#Высокое_качество_воспроизведения)
    *   [4.3 Воспроизведение с предыдущего места](#Воспроизведение_с_предыдущего_места)
    *   [4.4 Звук слишком тихий](#Звук_слишком_тихий)
    *   [4.5 Быстрое переключение между соотношениями сторон](#Быстрое_переключение_между_соотношениями_сторон)
    *   [4.6 Отрисовка на корневом окне](#Отрисовка_на_корневом_окне)
    *   [4.7 Использование как плагин браузера](#Использование_как_плагин_браузера)
    *   [4.8 Использование mpv для проигрывания музыки](#Использование_mpv_для_проигрывания_музыки)
    *   [4.9 Просмотр стримов](#Просмотр_стримов)
*   [5 Устранение проблем](#Устранение_проблем)
    *   [5.1 Начальная отладка](#Начальная_отладка)
    *   [5.2 Исправление отрывистого воспроизведения и разрыва кадров](#Исправление_отрывистого_воспроизведения_и_разрыва_кадров)
    *   [5.3 Проблемы с композитными менеджерами](#Проблемы_с_композитными_менеджерами)
    *   [5.4 Невозможно изменить громкость](#Невозможно_изменить_громкость)
...
Следующие [параметры](#Настройка) можно попробовать, чтобы улучшить производительность воспроизведения:

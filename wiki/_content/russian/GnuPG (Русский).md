...
**Обратите внимание:** В этом разделе для любой команды, принимающей идентификатор ключа (обозн. `*<идентификатор>*`), можно вписать как сам идентификатор, так и его отпечаток, часть имени или адрес электронной почты. GnuPG в этом плане предоставляет большую гибкость.

...
**Обратите внимание:** Если сценарий, описанный выше, не работает как следует, обратитесь к [официальной документации](http://i3wm.org/docs/layout-saving.html#_editing_layout_files). Секции *swallows* в `~/.i3/workspace_N.json` нужно редактировать вручную.

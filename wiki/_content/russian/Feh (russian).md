...
Измените каталог `~/.wallpaper` в соответствии с вашими настройками, также можно указать задержку `15m`, по вашему желанию (смотрите [sleep(1)](http://jlk.fjfi.cvut.cz/arch/manpages/man/sleep.1) для опций).

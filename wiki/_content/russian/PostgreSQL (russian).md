...
*   [8 Решение проблем](#.D0.A0.D0.B5.D1.88.D0.B5.D0.BD.D0.B8.D0.B5_.D0.BF.D1.80.D0.BE.D0.B1.D0.BB.D0.B5.D0.BC)
    ...
    *   [8.3 Направлять лог в syslog](#.D0.9D.D0.B0.D0.BF.D1.80.D0.B0.D0.B2.D0.BB.D1.8F.D1.82.D1.8C_.D0.BB.D0.BE.D0.B3_.D0.B2_syslog)
...
и внимательно просмотрите другие строки. <brДалее добавляем следующую строку в основной файл настройки проверки подлинности `/var/lib/postgres/data/pg_hba.conf`. (если вы планируете подключатся только со своего компьютера, то пропустите данный шаг) Этот файл определяет, каким хостам разрешено подключаться, **так что будьте осторожны**.

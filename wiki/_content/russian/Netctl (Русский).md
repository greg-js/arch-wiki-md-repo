...
**Обратите внимание:** Здесь *имя_профиля* — это имя файла профиля. Указание полного пути к файлу является ошибкой.
...
**Обратите внимание:** По умолчанию для двайвера бондинга используется политика цикличности (*the round-robin policy*). Что это значит, можно узнать в [документации](https://www.kernel.org/doc/Documentation/networking/bonding.txt).

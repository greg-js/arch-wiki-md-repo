...
*   _systemadm_ - официальная графическая оболочка для _systemctl_. Она доступна в пакетах [systemd-ui](https://www.archlinux.org/packages/?name=systemd-ui) и [systemd-ui-git](https://aur.archlinux.org/packages/systemd-ui-git/)

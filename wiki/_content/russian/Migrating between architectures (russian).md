...
На этой странице описаны два возможных способа миграции установленных систем с архитектур i686 (32 бита) на x86_64 (64 бита). Методы избегают *полной* переустановки (т. е. очистки жёсткого диска). Один метод использует liveCD, другой изменяет систему изнутри.

...
*   [5 Устранение проблем](#Устранение_проблем)
    ...
    *   [5.4 Проблемы Mutt при включённом кеше](#Проблемы_Mutt_при_включённом_кеше)
...
Если процесс миграция прервётся на полпути, существуют пакеты, которые могут помочь разобраться в ситуации, но они должны быть установлены до переноса основных пакетов. Подробнее об их использовании рассказано в разделе [#Устранение проблем](#Устранение_проблем).

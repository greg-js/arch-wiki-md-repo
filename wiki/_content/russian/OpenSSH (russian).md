...
*   [3 Сервер](#Сервер)
    *   [3.1 Демон](#Демон)
    *   [3.2 Управление демоном sshd](#Управление_демоном_sshd)
    *   [3.3 Подключение к серверу](#Подключение_к_серверу)
    *   [3.4 Защита SSH](#Защита_SSH)
        *   [3.4.1 Защита от атак полного перебора (brute force)](#Защита_от_атак_полного_перебора_(brute_force))
        *   [3.4.2 Ограничение входа от имени суперпользователя](#Ограничение_входа_от_имени_суперпользователя)
            *   [3.4.2.1 Отключение](#Отключение)
            *   [3.4.2.2 Ограничение](#Ограничение)
*   [4 Советы и рекомендации](#Советы_и_рекомендации)
    *   [4.1 Шифрованный туннель SOCKS](#Шифрованный_туннель_SOCKS)
        *   [4.1.1 Шаг 1: установка соединения](#Шаг_1:_установка_соединения)
        *   [4.1.2 Шаг 2: настройка браузера (или других программ)](#Шаг_2:_настройка_браузера_(или_других_программ))
    *   [4.2 Проброс X11](#Проброс_X11)
        *   [4.2.1 Настройка](#Настройка_2)
        *   [4.2.2 Использование](#Использование)
    *   [4.3 Проброс других портов](#Проброс_других_портов)
    *   [4.4 Увеличение скорости SSH](#Увеличение_скорости_SSH)
    *   [4.5 Монтирование удаленных файловых систем при помощи SSHFS](#Монтирование_удаленных_файловых_систем_при_помощи_SSHFS)
    *   [4.6 Поддержание подключения](#Поддержание_подключения)
    *   [4.7 Сохранение данных о подключении в конфигурационном файле ssh](#Сохранение_данных_о_подключении_в_конфигурационном_файле_ssh)
    *   [4.8 Autossh - автоматический перезапуск сессий и туннелей SSH](#Autossh_-_автоматический_перезапуск_сессий_и_туннелей_SSH)
        *   [4.8.1 Автозапуск Autossh при загрузке системы при помощи systemd](#Автозапуск_Autossh_при_загрузке_системы_при_помощи_systemd)

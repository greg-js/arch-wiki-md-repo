...
В дополнение, [pacman](/index.php/Pacman_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Pacman (Русский)") использует различные настройки конфигурационных файлов для проверки подписи пакетов. Обратитесь к [Pacman/Package signing](/index.php/Pacman/Package_signing "Pacman/Package signing") для подробностей.

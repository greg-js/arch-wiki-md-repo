...
*   [1 Получение исходников](#Получение_исходников)
*   [2 Конфигурирование](#Конфигурирование)
    *   [2.1 Как насчет /usr/src/ ?](#Как_насчет_/usr/src/_?)
*   [3 Компиляция и установка](#Компиляция_и_установка)
*   [4 Выберите один из вариантов:](#Выберите_один_из_вариантов:)
    *   [4.1 1\. Традиционный метод](#1._Традиционный_метод)
    *   [4.2 2\. Использование makepkg и pacman (рекомендуется)](#2._Использование_makepkg_и_pacman_(рекомендуется))
*   [5 Конфигурация загрузчика](#Конфигурация_загрузчика)
*   [6 Использование драйвера NVIDIA в ядре](#Использование_драйвера_NVIDIA_в_ядре)

...
**Обратите внимание:** Если у вас более новое Android устройство, которое не поддерживает UMS (USB-накопитель) и вы считаете что [mtpfs](https://www.archlinux.org/packages/?name=mtpfs) очень медленный или работает некорректно, то вы можете установить [jmtpfs](https://aur.archlinux.org/packages/jmtpfs/) из AUR.

## Использование

**Обратите внимание:** Не забудьте разблокировать ваш телефон (лок-скрин) перед подключением, потому что иначе вы увидите сообщения об ошибке.

...
*   [2 Конфигурация](#Конфигурация)
    *   [2.1 Сервер](#Сервер)
        *   [2.1.1 Запуск сервера](#Запуск_сервера)
        *   [2.1.2 Разное](#Разное)
            *   [2.1.2.1 Дополнительная конфигурация](#Дополнительная_конфигурация)
            *   [2.1.2.2 Ограничение NFS для интерфейсов/IP](#Ограничение_NFS_для_интерфейсов/IP)
            *   [2.1.2.3 Убедиться что NFSv4 idmapping полностью включена](#Убедиться_что_NFSv4_idmapping_полностью_включена)
            *   [2.1.2.4 Статические порты для NFSv3](#Статические_порты_для_NFSv3)
            *   [2.1.2.5 Совместимость NFSv2](#Совместимость_NFSv2)
            *   [2.1.2.6 Конфигурация брандмауэра](#Конфигурация_брандмауэра)
    *   [2.2 Клиент](#Клиент)
        *   [2.2.1 Ручная установка](#Ручная_установка)
        *   [2.2.2 Монтирование с использованием /etc/fstab](#Монтирование_с_использованием_/etc/fstab)
        *   [2.2.3 Монтирование с использованием /etc/fstab и systemd](#Монтирование_с_использованием_/etc/fstab_и_systemd)
        *   [2.2.4 Монтирование с использованием autofs](#Монтирование_с_использованием_autofs)
*   [3 Подсказки и трюки](#Подсказки_и_трюки)
    *   [3.1 Настройка производительности](#Настройка_производительности)
    *   [3.2 Автоматизация общих ресурсов с помощью systemd-networkd](#Автоматизация_общих_ресурсов_с_помощью_systemd-networkd)
    *   [3.3 Автоматическое управление монтированием](#Автоматическое_управление_монтированием)
        *   [3.3.1 Cron](#Cron)
        *   [3.3.2 systemd/Timers](#systemd/Timers)
        *   [3.3.3 Монтирование при запуске через systemd](#Монтирование_при_запуске_через_systemd)
        *   [3.3.4 Диспетчер NetworkManager](#Диспетчер_NetworkManager)
        *   [3.3.5 Монтирование NFS и networkmanager](#Монтирование_NFS_и_networkmanager)
*   [4 Устранение неполадок](#Устранение_неполадок)
    *   [4.1 Из старого wiki (нужно проверить)](#Из_старого_wiki_(нужно_проверить))
    *   [4.2 soft или hard монтирование](#soft_или_hard_монтирование)

## Установка

Для установки сервера и клиента достаточно установить пакет [nfs-utils](https://www.archlinux.org/packages/?name=nfs-utils).

Настоятельно рекомендуется на всех узлах (клиентских и серверных) использовать системы синхронизации времени [time synchronization](/index.php/Time_synchronization "Time synchronization") daemon. Без точной синхронизации системного времени, в процессе функционирования NFS возможно возникновение дополнительных нежелательных задержек.

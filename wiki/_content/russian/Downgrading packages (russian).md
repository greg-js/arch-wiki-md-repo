...
*   [3 Инструкция по откату пакетов](#Инструкция_по_откату_пакетов)
*   [4 Поиск старых версий](#Поиск_старых_версий)
    *   [4.1 Зеркала Out-Of-Sync](#Зеркала_Out-Of-Sync)
    *   [4.2 ARM](#ARM)
    *   [4.3 Re-компиляция пакетов](#Re-компиляция_пакетов)
*   [5 Дополнительная информация](#Дополнительная_информация)
    *   [5.1 Я не могу откатить пакет из-за зависимостей.](#Я_не_могу_откатить_пакет_из-за_зависимостей.)
    *   [5.2 Как я могу запретить pacman обновлять некоторые пакеты?](#Как_я_могу_запретить_pacman_обновлять_некоторые_пакеты?)
    *   [5.3 Я хочу вернуться ко вчерашнему состоянию своей системы.](#Я_хочу_вернуться_ко_вчерашнему_состоянию_своей_системы.)

...
```
$ transset-df _прозрачность_

```

где _прозрачность_ это число от 0 до 1, где 0 - абсолютная прозрачность, а 1 - непрозрачный.
...
Эта ошибка исправляется путем установки [hsetroot](https://aur.archlinux.org/packages/hsetroot/) и настройкой цвета фона, выполнив `hsetroot -solid "#000000"` (введите код нужного цвета, вместо _#000000_) до `xcompmgr`.
...
(можно заменить _#000066_ на любой другой цвет).
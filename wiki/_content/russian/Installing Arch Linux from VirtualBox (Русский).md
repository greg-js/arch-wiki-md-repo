...
_**Примечание:** Чтобы изменения вступили в силу, вам необходимо разлогиниться и залогиниться снова._
...
_Для получение большей информации об использовании реального диска, смотрите [VirtualBox user manual](http://www.virtualbox.org/wiki/Downloads#Usermanual)._
...
Запустите VirtualBox и кликните на _Создать новую виртуальную машину_:
...
Это, скорее всего, вызвано записью `autodetect` в файле _[/etc/mkinitcpio.conf](/index.php/Mkinitcpio "Mkinitcpio")_ в строке HOOK, из-за которой из образа initramfs удаляются все ненужные модули. Если у Вас имеется эта запись, удалите ее и выполните:

...
Это разрешает всем членам группы пользователя who are members of the group users to run the commands */sbin/mount.cifs* and */sbin/umount.cifs* from any machine(ALL). Если вы не умеете или не любите использовать редактор Vi, воспользуйтесь:

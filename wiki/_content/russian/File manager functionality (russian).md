...
**Совет:** Для некоторых файловых менеджеров возможно будет полезно иметь установленный пакет [gamin](https://aur.archlinux.org/packages/gamin/). [Gamin](/index.php/Gamin_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Gamin (Русский)") - система постоянного отслеживания изменений файлов и каталогов.

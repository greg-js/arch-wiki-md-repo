...
*   [1 Уловки конфигурации](#Уловки_конфигурации)
    ...
    *   [1.2 Внешний вид GDM](#Внешний_вид_GDM)
    *   [1.3 Доводка](#Доводка)
    *   [1.4 Низкая производительность](#Низкая_производительность)
    *   [1.5 Приложения по умолчанию](#Приложения_по_умолчанию)
    *   [1.6 Улучшение производительности видео](#Улучшение_производительности_видео)
    *   [1.7 Шрифты кажутся перекошенным](#Шрифты_кажутся_перекошенным)
    *   [1.8 Изменение фона рабочего стола по умолчанию](#Изменение_фона_рабочего_стола_по_умолчанию)
    *   [1.9 Увеличении размера окна терминала](#Увеличении_размера_окна_терминала)
*   [2 Различные уловки](#Различные_уловки)
    *   [2.1 Блокировка экрана](#Блокировка_экрана)
    *   [2.2 Разблокировка GNOME-keyring при входе в систему](#Разблокировка_GNOME-keyring_при_входе_в_систему)
    *   [2.3 Nautilus уловки](#Nautilus_уловки)
        *   [2.3.1 Изменение режима файлового менеджера (Вид обозревателя)](#Изменение_режима_файлового_менеджера_(Вид_обозревателя))
        *   [2.3.2 Музыкальные информационные колонки в окне файлового менеджера (битрейт и т.д.)](#Музыкальные_информационные_колонки_в_окне_файлового_менеджера_(битрейт_и_т.д.))
    *   [2.4 Увеличение скорости авто-скрытия панели](#Увеличение_скорости_авто-скрытия_панели)
    *   [2.5 Уловки меню GNOME](#Уловки_меню_GNOME)
        *   [2.5.1 Доводка скорости](#Доводка_скорости)
        *   [2.5.2 Редактирование меню](#Редактирование_меню)
            *   [2.5.2.1 Пользовательское меню](#Пользовательское_меню)
            *   [2.5.2.2 Группы меню, системное меню](#Группы_меню,_системное_меню)
        *   [2.5.3 Изменение логотипа Gnome на Arch](#Изменение_логотипа_Gnome_на_Arch)
        *   [2.5.4 Другой способ изменить логотип](#Другой_способ_изменить_логотип)
        *   [2.5.5 Удаление стандартных иконок с рабочего стола](#Удаление_стандартных_иконок_с_рабочего_стола)
        *   [2.5.6 Автоматическая смена обоев рабочего стола](#Автоматическая_смена_обоев_рабочего_стола)
    *   [2.6 Отключение прокрутки в панели задач](#Отключение_прокрутки_в_панели_задач)
*   [3 Полезные дополнения](#Полезные_дополнения)
    *   [3.1 FAM](#FAM)
    *   [3.2 Системный монитор Gnome](#Системный_монитор_Gnome)
    *   [3.3 Запись дисков CDs из файлового менеджера](#Запись_дисков_CDs_из_файлового_менеджера)
    *   [3.4 Сервисные приложения GNOME](#Сервисные_приложения_GNOME)
    *   [3.5 Gdesklets: плюшки на рабочем столе](#Gdesklets:_плюшки_на_рабочем_столе)
*   [4 Другие приложения](#Другие_приложения)
    *   [4.1 gnome-terminal](#gnome-terminal)
        *   [4.1.1 Выпадающие консоли](#Выпадающие_консоли)
            *   [4.1.1.1 Guake](#Guake)
            *   [4.1.1.2 Tilda](#Tilda)
    *   [4.2 gedit](#gedit)
    *   [4.3 eog](#eog)
    ...
    *   [4.13 Возможность оставлять сообщения в хранителе экрана](#Возможность_оставлять_сообщения_в_хранителе_экрана)
...
На моей x86_64 системе по некоторой причине, по умолчанию установлено 89 точек на дюм. Я увеличил их до 96 и все стало выглядеть опять "нормально".
...
Возможно, эта ошибка никогда не была бы исправлена, но используя систему ABS, мы можем собрать соответствующие нашим запросам программу. Установите [ABS](/index.php/Arch_Build_System_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Arch Build System (Русский)") (+70Mb), затем

...
**Обратите внимание:** [здесь](http://www.openldap.org/pub/ksoper/OpenLDAP_TLS.html#4.0) находится более полезная и полная информация, чем то что вы увидите ниже
...
**Обратите внимание:** To see which ciphers are supported by your local OpenSSL installation, type the following: `openssl ciphers -v ALL`

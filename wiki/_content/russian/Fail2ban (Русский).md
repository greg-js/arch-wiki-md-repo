...
Also considering limiting file system read and write access, by using _ReadOnlyDirectories_ and _ReadWriteDirectories_, again under the `[Service]` section. For example:

...
*   [6 Решение проблем](#.D0.A0.D0.B5.D1.88.D0.B5.D0.BD.D0.B8.D0.B5_.D0.BF.D1.80.D0.BE.D0.B1.D0.BB.D0.B5.D0.BC)
    ...
    *   [6.6 Клавиша _Backspace_ не выполняет функцию 'Назад'](#.D0.9A.D0.BB.D0.B0.D0.B2.D0.B8.D1.88.D0.B0_Backspace_.D0.BD.D0.B5_.D0.B2.D1.8B.D0.BF.D0.BE.D0.BB.D0.BD.D1.8F.D0.B5.D1.82_.D1.84.D1.83.D0.BD.D0.BA.D1.86.D0.B8.D1.8E_.27.D0.9D.D0.B0.D0.B7.D0.B0.D0.B4.27)
...
Список установленных плагинов можно узнать на странице `about:plugins`, перейдя на страницу _Дополнения_ через меню _Инструменты_ и выбрав вкладку _Плагины_.
...
Firefox по умолчанию открывает `mailto` ссылки веб-приложением, таким как Gmail или Yahoo Mail. Чтобы выбрать свой клиент электронной почты для открытия ссылок `mailto`, перейдите в _Настройки > Приложения_ и измените значение в столбике _Действие_ для `mailto`. Значение должно быть абсолютным путём к исполняемому файлу вашего e-mail клиента (напр. `/usr/bin/kmail` для Kmail).
...
Где _/home/user/dir_ — существующий путь к директории.
...
### Клавиша _Backspace_ не выполняет функцию 'Назад'
...
**Обратите внимание:** _xxxxxxxx_ — случайно сгенерированная строка из 8 символов.
...
This will force the colors ("Allow pages to choose their own colors..." checkbox in the _Preferences > Content > Color_ dialog):

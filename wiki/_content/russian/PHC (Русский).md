...
**Обратите внимание:** Существует пакет [cpupowerd](https://aur.archlinux.org/packages/cpupowerd/), который может автоматически управлять частотой и питанием процессоров AMD-K8

...
*   [1 Генерация профиля](#Генерация_профиля)
    *   [1.1 Колориметр или спектрофотометр](#Колориметр_или_спектрофотометр)
    *   [1.2 Argyll CMS](#Argyll_CMS)
    *   [1.3 Калибровка и профилирование монитора с помощью дополнительного калибровочного оборудования](#Калибровка_и_профилирование_монитора_с_помощью_дополнительного_калибровочного_оборудования)
    *   [1.4 Калибровка сканера](#Калибровка_сканера)
    *   [1.5 Калибровка принтера](#Калибровка_принтера)
    *   [1.6 Передача файла](#Передача_файла)
    *   [1.7 Gnome Color Manager](#Gnome_Color_Manager)
        *   [1.7.1 Инструкция](#Инструкция)
    *   [1.8 LPROF ICC Profiler](#LPROF_ICC_Profiler)
        *   [1.8.1 Калибровка монитора](#Калибровка_монитора)
            *   [1.8.1.1 Контраст/Яркость](#Контраст/Яркость)
            *   [1.8.1.2 Цветовая температура](#Цветовая_температура)
        *   [1.8.2 Профилирование монитора без дополнительного устройства калибровки](#Профилирование_монитора_без_дополнительного_устройства_калибровки)
    *   [1.9 ThinkPads](#ThinkPads)
*   [2 Загрузка ICC профилей](#Загрузка_ICC_профилей)
    *   [2.1 xcalib](#xcalib)
        *   [2.1.1 Пример Xinitrc](#Пример_Xinitrc)
        *   [2.1.2 Пример JWM <StartupCommand>](#Пример_JWM_<StartupCommand>)
    *   [2.2 dispwin](#dispwin)
        *   [2.2.1 Пример Xinitrc](#Пример_Xinitrc_2)
        *   [2.2.2 Пример JWM <StartupCommand>](#Пример_JWM_<StartupCommand>_2)
*   [3 Приложения, поддерживающие профили ICC](#Приложения,_поддерживающие_профили_ICC)

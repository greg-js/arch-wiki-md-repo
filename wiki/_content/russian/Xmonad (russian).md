...
*   [2 Запуск xmonad](#Запуск_xmonad)
    *   [2.1 С установленным Экранным менеджером](#С_установленным_Экранным_менеджером)
    *   [2.2 Без установленного экранного менеджера](#Без_установленного_экранного_менеджера)
*   [3 Настройка](#Настройка)
    *   [3.1 Базовая настройка Рабочего Стола](#Базовая_настройка_Рабочего_Стола)
*   [4 Выход xmonad](#Выход_xmonad)
*   [5 Советы и приемы](#Советы_и_приемы)
    *   [5.1 X-Selection-Paste](#X-Selection-Paste)
    *   [5.2 Горячие клавиши](#Горячие_клавиши)
        *   [5.2.1 Основные комбинации клавиш](#Основные_комбинации_клавиш)
    *   [5.3 Дополнительные приложения](#Дополнительные_приложения)
    *   [5.4 Увеличение числа рабочих столов](#Увеличение_числа_рабочих_столов)
    *   [5.5 Создание комнаты для Conky или приложений из трея](#Создание_комнаты_для_Conky_или_приложений_из_трея)
    *   [5.6 Использование xmobar с xmonad](#Использование_xmobar_с_xmonad)
        *   [5.6.1 Быстрый, менее гибкий](#Быстрый,_менее_гибкий)
        *   [5.6.2 Подробные настройки](#Подробные_настройки)
        *   [5.6.3 Проверка настройки XMobar](#Проверка_настройки_XMobar)
    *   [5.7 Управление xmonad внешними скриптами](#Управление_xmonad_внешними_скриптами)
    *   [5.8 Запуск другого оконного менеджера с xmonad](#Запуск_другого_оконного_менеджера_с_xmonad)
    *   [5.9 KDE и xmonad](#KDE_и_xmonad)
    *   [5.10 IM слой для Skype](#IM_слой_для_Skype)
    *   [5.11 Примеры настроек](#Примеры_настроек)
*   [6 Решение проблем](#Решение_проблем)
    *   [6.1 GNOME 3 и xmonad](#GNOME_3_и_xmonad)
        *   [6.1.1 Композитный Xmonad и Gnome](#Композитный_Xmonad_и_Gnome)
    *   [6.2 Xfce 4 и xmonad](#Xfce_4_и_xmonad)
    *   [6.3 Отсутствует xmonad-i386-linux или xmonad-x86_64-linux](#Отсутствует_xmonad-i386-linux_или_xmonad-x86_64-linux)
    *   [6.4 Проблемы с приложениями Java](#Проблемы_с_приложениями_Java)
    *   [6.5 Пустое пространство в нижней части окон gVim или терминалов](#Пустое_пространство_в_нижней_части_окон_gVim_или_терминалов)
    *   [6.6 Chromium/Chrome не работает полноэкранно](#Chromium/Chrome_не_работает_полноэкранно)
    *   [6.7 Multitouch / touchegg](#Multitouch_/_touchegg)
    *   [6.8 Назначение клавиш с раскладкой клавиатуры azerty](#Назначение_клавиш_с_раскладкой_клавиатуры_azerty)
    *   [6.9 GNOME 3 mod4+p изменение настройки отображения вместо запуска dmenu](#GNOME_3_mod4+p_изменение_настройки_отображения_вместо_запуска_dmenu)
    *   [6.10 Проблемы с фокусировкой границы окна в VirtualBox](#Проблемы_с_фокусировкой_границы_окна_в_VirtualBox)
    *   [6.11 Игры из Steam (Half-Life, Left 4 Dead, …) и xmonad](#Игры_из_Steam_(Half-Life,_Left_4_Dead,_…)_и_xmonad)
    *   [6.12 LibreOffice - фокус перескакивает между главным окном и диалогом](#LibreOffice_-_фокус_перескакивает_между_главным_окном_и_диалогом)
...
Xmobar запускает xmobar c изменёнными настройками, которые включает все варианты, описанные в [#Подробные настройки](#Подробные_настройки).
...
Решение, меняющее цвет пространства на цвет фона, можно найти в разделе [Vim (Русский)#Пустое пространство в нижней части окон gVim](/index.php/Vim_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Пустое_пространство_в_нижней_части_окон_gVim "Vim (Русский)").

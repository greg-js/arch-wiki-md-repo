...
*   [GNU Screen (Русский)](/index.php/GNU_Screen_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "GNU Screen (Русский)")
...
*   [2 Настройка](#Настройка)
    *   [2.1 Клавиши управления](#Клавиши_управления)
        *   [2.1.1 Copy Mode](#Copy_Mode)
    *   [2.2 Переход по URL](#Переход_по_URL)
    *   [2.3 Правильное определение терминала](#Правильное_определение_терминала)
    *   [2.4 Другие настройки](#Другие_настройки)
    *   [2.5 Автозапуск посредством systemd](#Автозапуск_посредством_systemd)
*   [3 Инициализация сеансов](#Инициализация_сеансов)
*   [4 Решение проблем](#Решение_проблем)
    *   [4.1 Проблемы с прокруткой](#Проблемы_с_прокруткой)
    *   [4.2 Mouse scrolling](#Mouse_scrolling)
    *   [4.3 Fix reverse-video/italic mode in urxvt](#Fix_reverse-video/italic_mode_in_urxvt)
    *   [4.4 Shift+F6 не работает в Midnight Commander](#Shift+F6_не_работает_в_Midnight_Commander)
...
*   [6 Tips and tricks](#Tips_and_tricks)
    ...
    *   [6.8 Изменить конфигурацию при запущенном tmux](#Изменить_конфигурацию_при_запущенном_tmux)

...
*   [3 Конфигурирование](#Конфигурирование)
    *   [3.1 Съёмные носители](#Съёмные_носители)
    *   [3.2 Монтирование NFS](#Монтирование_NFS)
    *   [3.3 Samba](#Samba)
    *   [3.4 FTP и SSH (через Fuse)](#FTP_и_SSH_(через_Fuse))
        *   [3.4.1 Удалённые FTP](#Удалённые_FTP)
        *   [3.4.2 Удалённые SSH](#Удалённые_SSH)
*   [4 Запуск AutoFS](#Запуск_AutoFS)
*   [5 Решение проблем и советы](#Решение_проблем_и_советы)
    *   [5.1 Опциональные параметры](#Опциональные_параметры)
    *   [5.2 Распознавание нескольких устройств](#Распознавание_нескольких_устройств)
    *   [5.3 Права доступа AutoFS](#Права_доступа_AutoFS)
*   [6 Ссылки на внешние источники](#Ссылки_на_внешние_источники)
*   [7 Альтернативы для AutoFS](#Альтернативы_для_AutoFS)

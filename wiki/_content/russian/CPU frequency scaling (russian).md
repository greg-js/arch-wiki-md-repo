...
При использовании совместно с [Laptop Mode Tools](/index.php/Laptop_Mode_Tools "Laptop Mode Tools"), владельцы обеспечены полным набором утилит для управления энергопотреблением.
...
*   [1 Установка cpufrequtils](#Установка_cpufrequtils)
*   [2 Настройка](#Настройка)
    *   [2.1 Драйвер управления частотой процессора](#Драйвер_управления_частотой_процессора)
        *   [2.1.1 Intel](#Intel)
        *   [2.1.2 AMD](#AMD)
    *   [2.2 Загрузка при старте системы](#Загрузка_при_старте_системы)
    *   [2.3 Преимущества использования в GNOME](#Преимущества_использования_в_GNOME)
    *   [2.4 Laptop Mode Tools](#Laptop_Mode_Tools)
    *   [2.5 Регуляторы масштабирования (схемы энергопотребления)](#Регуляторы_масштабирования_(схемы_энергопотребления))
        *   [2.5.1 Изменение параметров работы регулятора ondemand](#Изменение_параметров_работы_регулятора_ondemand)
        *   [2.5.2 Взаимодействие с событиями ACPI](#Взаимодействие_с_событиями_ACPI)
    *   [2.6 Демон](#Демон)
*   [3 Устранение неисправностей](#Устранение_неисправностей)

## Установка cpufrequtils

[cpufrequtils](https://aur.archlinux.org/packages/cpufrequtils/) - это набор утилит для *масштабирования частоты процессора*. Установка этого пакета необязательна, но крайне рекомендуется, так как предоставляет полезные наборы команд для консоли и демона для запуска масштабирования при старте системы.
...
Пакет [cpufrequtils](https://aur.archlinux.org/packages/cpufrequtils/) доступен в репозитории [extra]:
...
3.  настройка метода управления регуляторами: ручной (через /sys или cpufreq-set), через cpufrequtils [daemon](#.D0.94.D0.B5.D0.BC.D0.BE.D0.BD), laptop-mode-tools, acpid или при помощи апплета окружения рабочего стола.

...
1.  Запустите _odccm_: `# odccm` 
2.  Запустите _sync-engine_. Вы можете использовать опцию `-d` для запуска в фоновом режиме в качестве [демона](/index.php/Daemons_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Daemons (Русский)")
3.  Запустите _synce-kpm_
...
Если ваше устройство не обнаруживается в _synce-kpm_, убедитесь, что в настройках синхронизации включена опция "ActiveSync", а не "Mass Storage Device" или подобная (Настройки - Подключения - USB подключения).

...
*   [Openbox (Русский)](/index.php/Openbox_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Openbox (Русский)")
...
*   [3 Советы и рекомендации](#Советы_и_рекомендации)
    *   [3.1 Автомонтирование](#Автомонтирование)
    *   [3.2 Автозапуск программ](#Автозапуск_программ)
    *   [3.3 Горячие клавиши](#Горячие_клавиши)
    *   [3.4 Курсоры](#Курсоры)
    *   [3.5 Шрифты настройка](#Шрифты_настройка)
    *   [3.6 Раскладка клавиатуры](#Раскладка_клавиатуры)
        *   [3.6.1 udev](#udev)
        *   [3.6.2 Другие способы](#Другие_способы)
        *   [3.6.3 Посредством LXDE](#Посредством_LXDE)
    *   [3.7 LXDM](#LXDM)
        *   [3.7.1 Установка LXDM](#Установка_LXDM)
        *   [3.7.2 Настройка](#Настройка)
            *   [3.7.2.1 Ожидаемое поведение после Logout](#Ожидаемое_поведение_после_Logout)
            *   [3.7.2.2 Автоматический вход](#Автоматический_вход)
    *   [3.8 PCManFM](#PCManFM)
    *   [3.9 Замена оконного менеджера](#Замена_оконного_менеджера)
    *   [3.10 Выключение, Перезагрузка (LXSession-logout)](#Выключение,_Перезагрузка_(LXSession-logout))
    *   [3.11 Редактирование меню приложений](#Редактирование_меню_приложений)
...
Если Вы хотите выполнять **startx** автоматически при загрузке, прочитайте статью [Запуск X при загрузке](/index.php/Start_X_at_Boot_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Запуск_X_выбранным_пользователем_без_логина "Start X at Boot (Русский)").
...
[PCManFM (Русский)#Работа с томами](/index.php/PCManFM_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Работа_с_томами "PCManFM (Русский)")
...
Последний [lxappearance2-git](https://aur.archlinux.org/packages/lxappearance2-git/) предоставляет функциональные возможности для изменения тем курсора. Если Вы не хотите устанавливать экспериментальный *lxappearance2*, можете указать свою тему курсора в файле `~/.Xdefaults`. Смотрите раздел [Темы курсора#Настройка](/index.php/%D0%A2%D0%B5%D0%BC%D1%8B_%D0%BA%D1%83%D1%80%D1%81%D0%BE%D1%80%D0%B0#Настройка "Темы курсора").
...
6 способ: [Xorg (Русский)#Переключение раскладок средствами X.org](/index.php/Xorg_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Переключение_раскладок_средствами_X.org "Xorg (Русский)")

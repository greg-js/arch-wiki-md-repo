...
*   [1 Идентификация кодов клавиш](#Идентификация_кодов_клавиш)
    *   [1.1 Скан коды](#Скан_коды)
        *   [1.1.1 С помощью showkey](#С_помощью_showkey)
        *   [1.1.2 С помощью evtest](#С_помощью_evtest)
        *   [1.1.3 С помощью dmesg](#С_помощью_dmesg)
    *   [1.2 Коды клавиш](#Коды_клавиш)
        *   [1.2.1 Режим консоли](#Режим_консоли)
        *   [1.2.2 Режим графики](#Режим_графики)
*   [2 Назначение скан кодов кодам клавиш](#Назначение_скан_кодов_кодам_клавиш)
*   [3 Назначение кодов клавиш символам клавиш](#Назначение_кодов_клавиш_символам_клавиш)
    *   [3.1 В консольном режиме](#В_консольном_режиме)
    *   [3.2 В графическом режиме](#В_графическом_режиме)
*   [4 Ноутбуки](#Ноутбуки)
    *   [4.1 Asus M series](#Asus_M_series)
    *   [4.2 Asus N56VJ (возможно подойдёт и для других)](#Asus_N56VJ_(возможно_подойдёт_и_для_других))
...
Чтобы она выполнялась всегда при запуске, создайте [Systemd tmpfile](/index.php/Systemd_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Временные_файлы "Systemd (Русский)"):

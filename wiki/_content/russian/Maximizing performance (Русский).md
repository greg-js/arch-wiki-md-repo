...
Выбор лучшей файловой системы под особенности системы является очень важным, так как каждая файловая система имеет свои сильные стороны. В [Beginner's Guide](/index.php/Beginners%27_guide#Filesystem_Types "Beginners' guide") кратко рассматриваются наиболее популярные файловые системы. Вы можете также найти полезные статьи [здесь](/index.php/Category:File_systems "Category:File systems").

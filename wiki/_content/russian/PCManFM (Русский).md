...
**Обратите внимание:** На данное время PolicyKit по умолчанию сконфигурирован так, чтобы разрешать монтировать/размонтировать всем пользователям входящим в группу *storage*. Таким образом этот шаг можно пропустить.

...
*   [1 Основы](#Основы)
    *   [1.1 Узнай свою систему](#Узнай_свою_систему)
*   [2 Первое, что необходимо сделать](#Первое,_что_необходимо_сделать)
*   [3 Жёсткие диски](#Жёсткие_диски)
    *   [3.1 Выбор и настройка файловых систем](#Выбор_и_настройка_файловых_систем)
    *   [3.2 Резюме](#Резюме)
    *   [3.3 Параметры монтирования](#Параметры_монтирования)
    *   [3.4 Ext3](#Ext3)
    *   [3.5 JFS](#JFS)
    *   [3.6 XFS](#XFS)
    *   [3.7 Reiserfs](#Reiserfs)
    *   [3.8 Btrfs](#Btrfs)
        *   [3.8.1 mkinitcpio.conf для btrfs](#mkinitcpio.conf_для_btrfs)
    *   [3.9 Сжатие /usr](#Сжатие_/usr)
    *   [3.10 Кэширование файлов](#Кэширование_файлов)

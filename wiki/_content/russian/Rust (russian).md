...
*   [Rust на примерах (англ.)](http://rustbyexample.com/)
...
*   [This Week in Rust (англ.)](https://this-week-in-rust.org/)
...
*   [Статья в Википедии](https://ru.wikipedia.org/wiki/Rust_(язык_программирования))

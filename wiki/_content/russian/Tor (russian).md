...
**Состояние перевода:** На этой странице представлен перевод статьи [Tor](/index.php/Tor "Tor"). Дата последней синхронизации: 2 февраля 2020\. Вы можете [помочь](/index.php/ArchWiki_Translation_Team_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "ArchWiki Translation Team (Русский)") синхронизировать перевод, если в английской версии произошли [изменения](https://wiki.archlinux.org/index.php?title=Tor&diff=0&oldid=595266).
...
Строка `LimitNOFILE=32768` позволит открывать [больше файловых дескрипторов](#Количество_соединений) одновременно.
...
**Важно:** Стороннему наблюдателю будет несложно вас опознать по редкой строке `user-agent` в заголовке HTTP-запроса; также могут возникнуть проблемы с воспроизведением Flash, работой JavaScript и т.д.
...
При работе через [прозрачный прокси-сервер](https://en.wikipedia.org/wiki/ru:%D0%9F%D1%80%D0%BE%D0%BA%D1%81%D0%B8-%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80#.D0.92.D0.B8.D0.B4.D1.8B_.D0.BF.D1.80.D0.BE.D0.BA.D1.81.D0.B8-.D1.81.D0.B5.D1.80.D0.B2.D0.B5.D1.80.D0.BE.D0.B2 "wikipedia:ru:Прокси-сервер") можно запустить сеанс Tor дважды, на клиенте и на прокси, в режиме "Tor поверх Tor". Такая схема работы обладает непредсказуемым поведением и потенциально небезопасна. В теории, трафик пользователя будет выполнять шесть прыжков вместо обычных трёх, но нет никакой гарантии, что дополнительные прыжки не совпадут с тремя изначальными — например, в другом порядке. Разработчики Tor Project считают, что это небезопасно [[9]](https://2019.www.torproject.org/docs/faq.html.en#ChoosePathLength), [[10]](https://trac.torproject.org/projects/tor/wiki/doc/TorifyHOWTO#ToroverTor).
...
**Примечание:** После обновления пакета Tor эти разрешения сбросятся. Создайте [хук](/index.php/Pacman_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)#Хуки "Pacman (Русский)") для автоматической выдачи разрешений после обновлений.

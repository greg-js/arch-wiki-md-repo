...
**Обратите внимание:** GNOME on Wayland нельзя запустить при помощи *startx* и `~/.xinitrc`
...
**Обратите внимание:** Установка Wayland в качестве общесистемного окружения при помощи `env GDK_BACKEND=wayland gnome-session --session=gnome-wayland` на данный момент не работает - *gnome-session* немедленно завершит свою работу

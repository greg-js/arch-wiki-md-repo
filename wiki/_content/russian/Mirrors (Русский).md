...
**Обратите внимание:** На ftp.archlinux.org установлено ограничение пропускной способности в 50 КБайт/с [[1]](https://www.archlinux.org/news/throttling-ftparchlinuxorg-rsyncarchlinuxorg/).
...
**Обратите внимание:** Здесь же вы можете использовать значения `auto` и `i686`.

...
*   [1 Введение](#Введение)
*   [2 Присваивание кодов клавиш символам](#Присваивание_кодов_клавиш_символам)
    *   [2.1 Введение](#Введение_2)
    *   [2.2 Шаг 1: создание файла для Xmodmap](#Шаг_1:_создание_файла_для_Xmodmap)
    *   [2.3 Шаг 2: Тестирование](#Шаг_2:_Тестирование)
    *   [2.4 Шаг 3: Постоянное использование](#Шаг_3:_Постоянное_использование)
*   [3 Присваивание кодов клавиш действиям](#Присваивание_кодов_клавиш_действиям)
    *   [3.1 Использование xbindkeys](#Использование_xbindkeys)
    *   [3.2 Использование actkbd](#Использование_actkbd)
    *   [3.3 Использование инструментов окружения рабочего стола](#Использование_инструментов_окружения_рабочего_стола)
        *   [3.3.1 Gnome](#Gnome)
        *   [3.3.2 KDE](#KDE)
        *   [3.3.3 Xfce4](#Xfce4)
...
**Примечание:** Предполагается, что уже известны коды клавиш для требуемых комбинаций. Если коды не известны, то следует прочитать статью [Extra keyboard keys](/index.php/Extra_keyboard_keys_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "Extra keyboard keys (Русский)"), где обьясняется, как их получить.

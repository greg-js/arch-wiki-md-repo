...
Рекомендуемая тема для приложений на GTK – [breeze-gtk](https://www.archlinux.org/packages/?name=breeze-gtk) или [gnome-breeze-git](https://aur.archlinux.org/packages/gnome-breeze-git/). Данные темы имитируют дизайн Breeze, использующийся в KDE Plasma. Установите [kde-gtk-config](https://www.archlinux.org/packages/?name=kde-gtk-config) (часть группы пакетов [plasma](https://www.archlinux.org/groups/x86_64/plasma/)) и выберите установленную GTK-тему для GTK2/GTK3 в приложении *Параметры системы > Оформление приложений > Стиль программ GNOME/GTK+*.

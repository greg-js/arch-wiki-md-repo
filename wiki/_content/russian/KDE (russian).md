...
Эту проблему можно решить установкой плагина libav (пакет [gst-libav](https://www.archlinux.org/packages/?name=gst-libav)) для GStreamer. Если вы все еще испытываете проблемы, вы можете попробовать другой бекенд для Phonon, например, [phonon-qt4-vlc](https://www.archlinux.org/packages/?name=phonon-qt4-vlc) или [phonon-qt5-vlc](https://www.archlinux.org/packages/?name=phonon-qt5-vlc).

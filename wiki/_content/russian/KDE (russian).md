...
**Состояние перевода:** На этой странице представлен перевод статьи [KDE](/index.php/KDE "KDE"). Дата последней синхронизации: 3 января 2019\. Вы можете [помочь](/index.php/ArchWiki_Translation_Team_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "ArchWiki Translation Team (Русский)") синхронизировать перевод, если в английской версии произошли [изменения](https://wiki.archlinux.org/index.php?title=KDE&diff=0&oldid=561416).
...
*   [5 Советы и рекомендации](#Советы_и_рекомендации)
    ...
    *   [5.4 Отключение отображения закладок браузера в меню приложений](#Отключение_отображения_закладок_браузера_в_меню_приложений)
...
**Примечание:** Проприетарный драйвер [NVIDIA (Русский)](/index.php/NVIDIA_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "NVIDIA (Русский)") требует поддержки EGLStreams в Wayland, что [не было реализовано](https://blog.martin-graesslin.com/blog/2016/09/to-eglstream-or-not) в KDE Plasma. Данная проблема решается следующими способами:

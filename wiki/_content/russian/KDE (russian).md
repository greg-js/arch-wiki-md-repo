...
Установите [apper](https://aur.archlinux.org/packages/apper/) для получения уведомлений об обновлениях пакетов. Также он предоставляет простой графический интерфейс для управления пакетами. Подробнее смотрите на [веб-сайте PackageKit](http://www.packagekit.org/).

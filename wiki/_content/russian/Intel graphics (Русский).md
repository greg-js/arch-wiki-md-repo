...
**Обратите внимание:** Основанные на PowerVR видеокарты ([GMA 500](/index.php/Poulsbo "Poulsbo") и [GMA 3600](/index.php/Intel_GMA3600 "Intel GMA3600") серии) не поддерживаются свободными драйверами.
...
**Обратите внимание:** Эта проблема связана с изменениями в ядре 3.9\. Эта проблема до сих пор остается в ядре 3.10
...
**Обратите внимание:** Некоторые телевизоры могут отображать только цвета из диапазона 16-255, поэтому установка на Full вызовет ограничение цвета в диапазоне 0-15, так что лучше оставить его в автоматическом режиме, который будет автоматически определять необходимость сокращать цветовое пространство для телевизора.

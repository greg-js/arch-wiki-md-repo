...
*   [3 Советы и рекомендации](#Советы_и_рекомендации)
    ...
    *   [3.4 Исправление отображения русских букв](#Исправление_отображения_русских_букв)
    *   [3.5 Решение проблемы с медленным первым запуском](#Решение_проблемы_с_медленным_первым_запуском)
    *   [3.6 Скрытие закладок в боковой панели](#Скрытие_закладок_в_боковой_панели)
    *   [3.7 Создание горячих клавиш в Thunar](#Создание_горячих_клавиш_в_Thunar)
    *   [3.8 Отображение разделов, определенных в fstab](#Отображение_разделов,_определенных_в_fstab)

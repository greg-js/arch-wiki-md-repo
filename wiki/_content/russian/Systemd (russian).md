...
**Примечание:** При запуске *systemd* в [пользовательском режиме](/index.php/Systemd/User#How_it_works "Systemd/User") используются совершенно другие пути загрузки
...
**Примечание:** Таймеры способны в значительной степени заменить функциональность *cron*. Смотрите раздел [Замена cron](/index.php/Systemd/Timers#As_a_cron_replacement "Systemd/Timers")

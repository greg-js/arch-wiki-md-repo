Из [домашней страницы](http://www.webmin.com/) проекта:
	...
	_Webmin - это веб-интерфейс для системного администрирования Unix. Используя современный веб-браузер, вы можете настроить учётные записи пользователей, Apache, DNS, файл-сервер и многое другое. Webmin избавляет от необходимости вручную редактировать конфигурационные файлы Unix, такие как `/etc/passwd`, а также позволяет управлять системой из консоли или удалённо. Смотрите страницу [стандартных модулей](http://www.webmin.com/standard.html) Webmin или [скриншоты](http://www.webmin.com/demo.html)._

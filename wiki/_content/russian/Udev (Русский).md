...
Использование нескольких веб-камер может быть полезно, например, совместно с [motion](https://www.archlinux.org/packages/?name=motion) (программный детектор движения, который получает изображения с устройств *video4linux* и/или веб-камер). При загрузке веб-камер им случайно присваиваются имена вида `/dev/video[0..n]`. Рекомендуемое решение состоит в создании символических ссылок с использованием правила *udev* (как в примере [#Написание своих правил](#.D0.9D.D0.B0.D0.BF.D0.B8.D1.81.D0.B0.D0.BD.D0.B8.D0.B5_.D1.81.D0.B2.D0.BE.D0.B8.D1.85_.D0.BF.D1.80.D0.B0.D0.B2.D0.B8.D0.BB)):
...
**Обратите внимание:** Начиная с версии *udev* 171, модули эмуляции OSS (`snd_seq_oss`, `snd_pcm_oss` и `snd_mixer_oss`) больше не загружаются автоматически.

...
*   [1 일반](#일반)
    ...
    *   [1.2 Q) 어떤 사람들이 아치를 좋아할까요?](#Q)_어떤_사람들이_아치를_좋아할까요?)
    *   [1.3 Q) 어떤 사람들이 아치를 싫어할까요?](#Q)_어떤_사람들이_아치를_싫어할까요?)
    *   [1.4 Q) 아치는 어떤 배포판을 기반으로 하나요?](#Q)_아치는_어떤_배포판을_기반으로_하나요?)
    *   [1.5 Q) 저는 완전 GNU/리눅스 초보자입니다. 아치를 사용해도 좋을까요?](#Q)_저는_완전_GNU/리눅스_초보자입니다._아치를_사용해도_좋을까요?)
    *   [1.6 Q) 저는 개발 팀이 *X*라는 기능을 구현했으면 좋겠는데요.](#Q)_저는_개발_팀이_X라는_기능을_구현했으면_좋겠는데요.)
    *   [1.7 Q) 아치는 설치하고 사용하는데 너무 시간과 노력을 많이 잡아먹어요. 또 사람들이 커뮤니티에서 RTFM을 너무 많이 남발하는것 같아요](#Q)_아치는_설치하고_사용하는데_너무_시간과_노력을_많이_잡아먹어요._또_사람들이_커뮤니티에서_RTFM을_너무_많이_남발하는것_같아요)
    *   [1.8 Q) 아치는 서버/데스크탑/워크스테이션용으로 제작되었나요?](#Q)_아치는_서버/데스크탑/워크스테이션용으로_제작되었나요?)
    *   [1.9 Q) 새로운 릴리즈는 언제 만들어지나요?](#Q)_새로운_릴리즈는_언제_만들어지나요?)
    *   [1.10 Q) 아치 리눅스는 안정적인 배포본입니까? 자주 깨질수도 있나요?](#Q)_아치_리눅스는_안정적인_배포본입니까?_자주_깨질수도_있나요?)
    *   [1.11 Q) 아치는 언론(예를 들면 광고)에 더 많이 노출될 필요가 있어요.](#Q)_아치는_언론(예를_들면_광고)에_더_많이_노출될_필요가_있어요.)
    *   [1.12 Q) 아치는 더 많은 개발자가 필요합니다](#Q)_아치는_더_많은_개발자가_필요합니다)
    *   [1.13 Q) 어째서 다른 운영체제에 비해 인터넷이 굉장히 느리죠?](#Q)_어째서_다른_운영체제에_비해_인터넷이_굉장히_느리죠?)
    *   [1.14 Q) 아치가 왜 램을 다 사용하나요?](#Q)_아치가_왜_램을_다_사용하나요?)
    *   [1.15 Q) 시스템 여유공간이 다 어디로 갔죠?](#Q)_시스템_여유공간이_다_어디로_갔죠?)
*   [2 패키지 관리](#패키지_관리)
    *   [2.1 Q) X는 어느 패키지에 들어있나요?](#Q)_X는_어느_패키지에_들어있나요?)
    *   [2.2 Q) 패키지 X에서 오류를 발견했어요. 어떻게 해야하죠?](#Q)_패키지_X에서_오류를_발견했어요._어떻게_해야하죠?)
    *   [2.3 Q) 아치 패키지는 자체 명명 규칙이 있어야 할 것 같아요. pkg.tar.gz은 너무 길고 헷갈려요.](#Q)_아치_패키지는_자체_명명_규칙이_있어야_할_것_같아요._pkg.tar.gz은_너무_길고_헷갈려요.)
    *   [2.4 Q) pacman은 다른 응용프로그램이 패키지 정보를 쉽게 접근할 수 있는 라이브러리가 있으면 좋겠어요](#Q)_pacman은_다른_응용프로그램이_패키지_정보를_쉽게_접근할_수_있는_라이브러리가_있으면_좋겠어요)
    *   [2.5 Q) 어째서 pacman은 공식 GUI 프론트엔드가 없나요?](#Q)_어째서_pacman은_공식_GUI_프론트엔드가_없나요?)
    *   [2.6 Q) pacman은 기능 X가 있어야 될 것 같아요!](#Q)_pacman은_기능_X가_있어야_될_것_같아요!)
    *   [2.7 Q) 아치는 안정적인 패키지 브랜치가 있어야 될 것 같아요.](#Q)_아치는_안정적인_패키지_브랜치가_있어야_될_것_같아요.)
    *   [2.8 Q) 여러 가지 저장소 간의 차이점은 무엇인가요?](#Q)_여러_가지_저장소_간의_차이점은_무엇인가요?)
    *   [2.9 Q) 패키지 X를 방금 설치했습니다. 어떻게 시작하나요?](#Q)_패키지_X를_방금_설치했습니다._어떻게_시작하나요?)
    *   [2.10 Q) 공식 저장소에 왜 공유 라이브러리마다 한 가지 버전씩밖에 없나요?](#Q)_공식_저장소에_왜_공유_라이브러리마다_한_가지_버전씩밖에_없나요?)
    *   [2.11 Q) pacman -Syu를 했는데 공유 라이브러리만 업데이트되고 거기에 의존하는 프로그램은 업데이트되지 않는다면 어떻게 되죠?](#Q)_pacman_-Syu를_했는데_공유_라이브러리만_업데이트되고_거기에_의존하는_프로그램은_업데이트되지_않는다면_어떻게_되죠?)
    *   [2.12 Q) 저장소에 메이저 커널 업데이트가 있는데 몇몇 드라이버 패키지는 최신 커널에 대해 업데이트 되지 않는 경우도 있을 수 있나요?](#Q)_저장소에_메이저_커널_업데이트가_있는데_몇몇_드라이버_패키지는_최신_커널에_대해_업데이트_되지_않는_경우도_있을_수_있나요?)
    *   [2.13 Q) 아치는 패키지 서명을 지원하나요?](#Q)_아치는_패키지_서명을_지원하나요?)
*   [3 설치](#설치)
    *   [3.1 Q) 아치는 (GUI) 설치 프로그램이 필요합니다.](#Q)_아치는_(GUI)_설치_프로그램이_필요합니다.)
    *   [3.2 Q) 아치를 설치했는데 쉘 로그인만 뜨네요. 이제 어떻게 해야하죠?](#Q)_아치를_설치했는데_쉘_로그인만_뜨네요._이제_어떻게_해야하죠?)
    *   [3.3 Q) 어떤 데스크탑 환경이나 창 관리자를 사용하는 게 좋을까요?](#Q)_어떤_데스크탑_환경이나_창_관리자를_사용하는_게_좋을까요?)
    *   [3.4 Q) 아치는 다른 "최소" 배포판과 어떤 점에서 특이합니까?](#Q)_아치는_다른_"최소"_배포판과_어떤_점에서_특이합니까?)
*   [4 기타](#기타)
    *   [4.1 Q) 자주 듣는 AUR이란 무엇입니까?](#Q)_자주_듣는_AUR이란_무엇입니까?)
    *   [4.2 Q) 동영상을 볼 때마다 녹색 화면이 나와요.](#Q)_동영상을_볼_때마다_녹색_화면이_나와요.)
    *   [4.3 Q) 맞춤법 검사기가 글이란 글은 죄다 틀렸다고 표시해요!](#Q)_맞춤법_검사기가_글이란_글은_죄다_틀렸다고_표시해요!)
...
**A)** 네트워크 설정이 올바르게 되어 있습니까? [인터넷 연결 설정하기](/index.php/Beginners%27_guide_(%ED%95%9C%EA%B5%AD%EC%96%B4)#인터넷_연결_설정하기 "Beginners' guide (한국어)")를 살펴봅니다.

...
**Reason:** Incomplete translation (Discuss in [Talk:Systemd-networkd (Español)#](https://wiki.archlinux.org/index.php/Talk:Systemd-networkd_(Espa%C3%B1ol)))
...
**Reason:** Too many points for a tip, some of them are very similar so they could be merged. (Discuss in [Talk:Systemd-networkd (Español)#](https://wiki.archlinux.org/index.php/Talk:Systemd-networkd_(Espa%C3%B1ol)))
...
**Reason:** In the listing of configuration files, /etc/systemd/network/MyBridge.netdev has the .netdev extension. But, the MyBridge.network example file has the .network extension. (Discuss in [Talk:Systemd-networkd (Español)#](https://wiki.archlinux.org/index.php/Talk:Systemd-networkd_(Espa%C3%B1ol)))
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Systemd-networkd_(Español)&oldid=413177](https://wiki.archlinux.org/index.php?title=Systemd-networkd_(Español)&oldid=413177)"

...
**翻译状态：** 本文是英文页面 [Vim](/index.php/Vim "Vim") 的[翻译](/index.php/ArchWiki_Translation_Team_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87) "ArchWiki Translation Team (简体中文)")，最后翻译时间：2015-02-18，点击[这里](https://wiki.archlinux.org/index.php?title=Vim&diff=0&oldid=358438)可以查看翻译后英文页面的改动。
...
Vim专注于全键盘操作，它并不是像nano或pico一样的简单编辑器。Vim需要花时间来学习，并值得花上更多的时间来掌握。
...
*   [3 配置](#.E9.85.8D.E7.BD.AE)
    ...
    *   [3.2 环绕搜索](#.E7.8E.AF.E7.BB.95.E6.90.9C.E7.B4.A2)
    *   [3.3 代码高亮](#.E4.BB.A3.E7.A0.81.E9.AB.98.E4.BA.AE)
    *   [3.4 使用鼠标](#.E4.BD.BF.E7.94.A8.E9.BC.A0.E6.A0.87)
    *   [3.5 跨行移动光标](#.E8.B7.A8.E8.A1.8C.E7.A7.BB.E5.8A.A8.E5.85.89.E6.A0.87)
    *   [3.6 vimrc范例](#vimrc.E8.8C.83.E4.BE.8B)
*   [4 文件合并（Vimdiff）](#.E6.96.87.E4.BB.B6.E5.90.88.E5.B9.B6.EF.BC.88Vimdiff.EF.BC.89)
*   [5 Vim 建议](#Vim_.E5.BB.BA.E8.AE.AE)
    *   [5.1 显示行号](#.E6.98.BE.E7.A4.BA.E8.A1.8C.E5.8F.B7)
    *   [5.2 拼写检查](#.E6.8B.BC.E5.86.99.E6.A3.80.E6.9F.A5)
    *   [5.3 跨行替换](#.E8.B7.A8.E8.A1.8C.E6.9B.BF.E6.8D.A2)
    *   [5.4 记录光标位置](#.E8.AE.B0.E5.BD.95.E5.85.89.E6.A0.87.E4.BD.8D.E7.BD.AE)
    *   [5.5 GVim窗口底部的空格](#GVim.E7.AA.97.E5.8F.A3.E5.BA.95.E9.83.A8.E7.9A.84.E7.A9.BA.E6.A0.BC)
    *   [5.6 用 vim 替代 vi](#.E7.94.A8_vim_.E6.9B.BF.E4.BB.A3_vi)
    *   [5.7 DOS/Windows回车问题](#DOS.2FWindows.E5.9B.9E.E8.BD.A6.E9.97.AE.E9.A2.98)
*   [6 插件](#.E6.8F.92.E4.BB.B6)
    *   [6.1 插件管理](#.E6.8F.92.E4.BB.B6.E7.AE.A1.E7.90.86)
    *   [6.2 pacman](#pacman)
        *   [6.2.1 cscope](#cscope)
        *   [6.2.2 Taglist](#Taglist)
        *   [6.2.3 AfterColors](#AfterColors)
...
[安装](/index.php/%E5%AE%89%E8%A3%85 "安装") 下面列出的软件包。

命令行版本：

*   [vim-minimal](https://www.archlinux.org/packages/?name=vim-minimal)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): replaced by [vim](https://www.archlinux.org/packages/?name=vim)]</sup> — 轻量级版本
*   [vim](https://www.archlinux.org/packages/?name=vim) — 提供Python 2, Lua和Ruby解释器支持，但没有GTK/X 支持
*   [vim-python3](https://www.archlinux.org/packages/?name=vim-python3)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): replaced by [vim](https://www.archlinux.org/packages/?name=vim)]</sup> — 比上面的`vim`包多了Python 3的解释器支持

图形界面版本：

*   [gvim](https://www.archlinux.org/packages/?name=gvim) — 提供和`vim`一样的功能
*   [gvim-python3](https://www.archlinux.org/packages/?name=gvim-python3)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): replaced by [gvim](https://www.archlinux.org/packages/?name=gvim)]</sup> - 比上面`gvim`包的多了Python 3的解释支持

**注意:**

*   _vim*_ 包 **不包含** 图形界面支持。因此缺失了 `+clipboard` 特性，Vim也就不能够同X11的 _primary_ 和 _clipboard_ 剪切板交互。_gvim*_ 包在全面支持图形界面的同时提供了命令行版本的Vim。
...
[vim-plugin-aftercolors](https://aur.archlinux.org/packages/vim-plugin-aftercolors/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/vim-plugin-aftercolors)]</sup>包使能目录`vim/after/colors`允许设置优先使用的彩色方案。

本地默认使用的目录`~/.vim/after/colors`，若不存在可自行创建。

重写的色彩方案与其本身类似(在改变设置之前，最好先看一下原来的设置。有时作者会留下提示，可以对照检查自己的设置)。重写设置时，将创建的文件取一个相关的名字 (e.g. `~/.vim/after/colors/desert.vim`)并设置一个备用方案。例如：
...
知道要使用什么颜色，将需要获得终端下的色号。可以参考以下链接: [link1](http://blog.yjl.im/2013/02/terminal-256-colors-scripts.html), [link2](http://www.calmar.ws/vim/256-xterm-24bit-rgb-color-chart.html), [link3](https://github.com/Gen2ly/genscripts/blob/master/termcolors).
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Vim_(简体中文)&oldid=415691](https://wiki.archlinux.org/index.php?title=Vim_(简体中文)&oldid=415691)"

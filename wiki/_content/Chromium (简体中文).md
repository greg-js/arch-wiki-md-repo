...
*   [chromium-dev](https://aur.archlinux.org/packages/chromium-dev/)<sup><small>AUR</small></sup> - 开发版本
*   [chromium-browser-bin](https://aur.archlinux.org/packages/chromium-browser-bin/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/chromium-browser-bin)]</sup> - 二进制版本

**注意:** 完整的编译 [Chromium-dev](https://aur.archlinux.org/packages/Chromium-dev/)<sup><small>AUR</small></sup> 至少要花费编译Linux内核一样长的时间。

[AUR](/index.php/AUR "AUR")中还有包含 Flash Player 的二进制版的[google-chrome](https://aur.archlinux.org/packages/google-chrome/)<sup><small>AUR</small></sup> 和
...
*   [chromium-pepper-flash](https://aur.archlinux.org/packages/chromium-pepper-flash/)<sup><small>AUR</small></sup> - 稳定版本
*   [chromium-pepper-flash-dev](https://aur.archlinux.org/packages/chromium-pepper-flash-dev/)<sup><small>AUR</small></sup> - 开发版本
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Chromium_(简体中文)&oldid=412625](https://wiki.archlinux.org/index.php?title=Chromium_(简体中文)&oldid=412625)"

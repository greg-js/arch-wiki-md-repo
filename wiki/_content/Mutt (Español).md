...
**Reason:** Este artículo está desactualizado. (Discuss in [Talk:Mutt (Español)#](https://wiki.archlinux.org/index.php/Talk:Mutt_(Espa%C3%B1ol)))
...
*   Si quiere (o necesita) usar CRAM-MD5, GSSAPI o DIGEST-MD5, instale también el paquete [cyrus-sasl-plugins](https://www.archlinux.org/packages/?name=cyrus-sasl-plugins)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): replaced by [cyrus-sasl-gssapi](https://www.archlinux.org/packages/?name=cyrus-sasl-gssapi)]</sup> y listo.
...
Considere el uso de aplicaciones como [spamassassin](https://www.archlinux.org/packages/?name=spamassassin) o [imapfilter](https://aur.archlinux.org/packages/imapfilter/)<sup><small>AUR</small></sup> para ordenar el correo.
...
Puede instalar [muttprint](https://aur.archlinux.org/packages/muttprint/)<sup><small>AUR</small></sup> del [AUR](/index.php/AUR "AUR") para una calidad de impresión superior. Inserte en su archivo muttrc:
...
Instale [urlview](https://aur.archlinux.org/packages/urlview/)<sup><small>AUR</small></sup> desde el [AUR](/index.php/AUR "AUR").
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Mutt_(Español)&oldid=412727](https://wiki.archlinux.org/index.php?title=Mutt_(Español)&oldid=412727)"

[Category](/index.php/Special:Categories "Special:Categories"):

*   [Email clients (Español)](/index.php/Category:Email_clients_(Espa%C3%B1ol) "Category:Email clients (Español)")
...
[udev](/index.php/Udev "Udev") will automatically detect your hardware and selects needed drivers at boot time. Therefore, your sound should be already working. Though, your sound may be initially muted, then see [Unmuting the channels](#Unmuting_the_channels).

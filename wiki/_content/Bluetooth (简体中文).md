...
bluedevil 是 [KDE](/index.php/KDE_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87) "KDE (简体中文)") 的蓝牙管理工具，可以用 [bluedevil](https://www.archlinux.org/packages/?name=bluedevil)（KDE Plasma 5）或 [bluedevil4](https://www.archlinux.org/packages/?name=bluedevil4)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): package not found]</sup>（KDE 4）[安装](/index.php/%E5%AE%89%E8%A3%85 "安装")。
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Bluetooth_(简体中文)&oldid=412788](https://wiki.archlinux.org/index.php?title=Bluetooth_(简体中文)&oldid=412788)"

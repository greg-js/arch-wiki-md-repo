...
**Notes:** Same topic. Also note that most of this can be done also natively in `/etc/resolvconf.conf` using the `name_servers` and `name_servers_append` options. (Discuss in [Talk:Dnsmasq (Русский)#](https://wiki.archlinux.org/index.php/Talk:Dnsmasq_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)))
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Dnsmasq_(Русский)&oldid=414150](https://wiki.archlinux.org/index.php?title=Dnsmasq_(Русский)&oldid=414150)"

...
[https://wiki.tox.chat/UTox](https://wiki.tox.chat/UTox) || [utox-git](https://aur.archlinux.org/packages/utox-git/)<sup><small>AUR</small></sup>
...
[https://wiki.tox.chat/Ratox](https://wiki.tox.chat/Ratox) || [ratox-git](https://aur.archlinux.org/packages/ratox-git/)<sup><small>AUR</small></sup>
...
[https://wiki.tox.chat/Tox_Pidgin_Protocol_Plugin](https://wiki.tox.chat/Tox_Pidgin_Protocol_Plugin) || [tox-prpl-git](https://aur.archlinux.org/packages/tox-prpl-git/)<sup><small>AUR</small></sup>
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Tox_(Русский)&oldid=414273](https://wiki.archlinux.org/index.php?title=Tox_(Русский)&oldid=414273)"

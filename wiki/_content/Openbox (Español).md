...
ObConf no sirve para configurar ni atajos de teclado, ni otras características avanzadas. Para hacer este tipo de modificaciones, debes editar `rc.xml`, alternativamente, puedes utilizar [obkey](https://aur.archlinux.org/packages/obkey/)<sup><small>AUR</small></sup> desde [AUR](/index.php/AUR "AUR").
...
Puede ser instalado con el paquete [openbox-menu](https://aur.archlinux.org/packages/openbox-menu/)<sup><small>AUR</small></sup> vía [AUR](/index.php/AUR "AUR").
...
[http://xyne.archlinux.ca/projects/obfilebrowser/](http://xyne.archlinux.ca/projects/obfilebrowser/) || [obfilebrowser](https://aur.archlinux.org/packages/obfilebrowser/)<sup><small>AUR</small></sup>

*   **obdevicemenu** — Un menú capaz de gestionar dispositivos extraíbles utilizando udisks.

[https://bbs.archlinux.org/viewtopic.php?id=114702](https://bbs.archlinux.org/viewtopic.php?id=114702) || [obdevicemenu](https://aur.archlinux.org/packages/obdevicemenu/)<sup><small>AUR</small></sup>
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Openbox_(Español)&oldid=414506](https://wiki.archlinux.org/index.php?title=Openbox_(Español)&oldid=414506)"

[Category](/index.php/Special:Categories "Special:Categories"):

*   [Stacking WMs (Español)](/index.php/Category:Stacking_WMs_(Espa%C3%B1ol) "Category:Stacking WMs (Español)")
...
**xxxxxxxx** - Вы должны задать _сложный_ пароль для аккаунта администратора. Минимальным требованием являются: одна буква в верхнем регистре, одна цифра, и не менее восьми символов. Если вы попытаетесь использовать пароль, который не отвечает требованиям сложности, инициализации не удастся.
...
**Причина:** В Вики нет места, чтобы положить гигантские сценарии, которые должны быть скопированы и вставлены. Они должны быть помещены в пакете AUR или что-то вроде этого. (обсуждение: [Talk:Samba 4 Active Directory domain controller (Русский)#](https://wiki.archlinux.org/index.php/Talk:Samba_4_Active_Directory_domain_controller_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9)))

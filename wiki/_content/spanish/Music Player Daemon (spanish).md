...
*   [4 Más Opciones](#Más_Opciones)
    ...
    *   [4.6 Control de MPD por medio del teléfono con Bluetooth](#Control_de_MPD_por_medio_del_teléfono_con_Bluetooth)
    *   [4.7 Archivos Cue](#Archivos_Cue)
    *   [4.8 HTTP Streaming](#HTTP_Streaming)
*   [5 Troubleshooting](#Troubleshooting)
    *   [5.1 Falla en Auto-detección](#Falla_en_Auto-detección)

...
Este artículo es una traducción de [Localization/Chinese](/index.php/Localization/Chinese "Localization/Chinese"), revisada por última vez el **2018-12-21**. Si advierte que la versión inglesa [ha cambiado](https://wiki.archlinux.org/index.php?title=Localization/Chinese&diff=0&oldid=559678) puede ayudar a actualizar la traducción, bien por [usted mismo](/index.php/ArchWiki:Translation_Team/Contributing_(Espa%C3%B1ol) "ArchWiki:Translation Team/Contributing (Español)") o bien avisando al [equipo de traducción](/index.php/ArchWiki:Translation_Team_(Espa%C3%B1ol) "ArchWiki:Translation Team (Español)").

Este artículo describe cómo configurar un entorno de idioma Chino.

## Fuentes

Véase [Fuentes#Chino](/index.php/Fonts#Chinese "Fonts").

## Métodos de entrada

Los siguientes motores de [métodos de entrada](/index.php/Input_method "Input method") (ME) están disponibles para el idioma Chino:

| Motor | [Fcitx](/index.php/Fcitx "Fcitx") | [IBus](/index.php/IBus "IBus") | [SCIM](/index.php/SCIM "SCIM") | [uim](/index.php/Uim "Uim") | [gcin](/index.php/Gcin "Gcin") | [hime-git](https://aur.archlinux.org/packages/hime-git/) |
| [Wubi](https://en.wikipedia.org/wiki/es:M%C3%A9todo_Wubi "wikipedia:es:Método Wubi") | built-in | [ibus-table](https://www.archlinux.org/packages/?name=ibus-table) | [scim-tables](https://aur.archlinux.org/packages/scim-tables/) | built-in | ? | ? |

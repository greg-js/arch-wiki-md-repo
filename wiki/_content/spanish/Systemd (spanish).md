...
*   [7 Journal](#Journal)
    *   [7.1 Nivel de prioridad](#Nivel_de_prioridad)
    *   [7.2 Nivel del recurso](#Nivel_del_recurso)
    *   [7.3 Filtrar la salida](#Filtrar_la_salida)
    *   [7.4 Límite del tamaño de journal](#Límite_del_tamaño_de_journal)
    *   [7.5 Limpiar manualmente archivos journal](#Limpiar_manualmente_archivos_journal)
    *   [7.6 Journald coexistiendo con syslog](#Journald_coexistiendo_con_syslog)
    *   [7.7 Reenviar journald a /dev/tty12](#Reenviar_journald_a_/dev/tty12)
    *   [7.8 Especificar un journal diferente para visulizar](#Especificar_un_journal_diferente_para_visulizar)
*   [8 Consejos y trucos](#Consejos_y_trucos)
    *   [8.1 Ejecutar servicios después de que la conexión de red esté activa](#Ejecutar_servicios_después_de_que_la_conexión_de_red_esté_activa)
    *   [8.2 Activar las unidades instaladas por defecto](#Activar_las_unidades_instaladas_por_defecto)
    *   [8.3 Entornos seguros para probar aplicaciones](#Entornos_seguros_para_probar_aplicaciones)
*   [9 Solución de problemas](#Solución_de_problemas)
    *   [9.1 Investigar errores de systemd](#Investigar_errores_de_systemd)
    *   [9.2 Diagnosticar problemas de arranque](#Diagnosticar_problemas_de_arranque)
    *   [9.3 Diagnosticar un servicio](#Diagnosticar_un_servicio)
    *   [9.4 Apagar/reiniciar se hace terriblemente largo](#Apagar/reiniciar_se_hace_terriblemente_largo)
    *   [9.5 Los procesos de corta duración parecen no registrar ninguna salida](#Los_procesos_de_corta_duración_parecen_no_registrar_ninguna_salida)
    *   [9.6 El tiempo de arranque aumenta con el tiempo](#El_tiempo_de_arranque_aumenta_con_el_tiempo)
    *   [9.7 systemd-tmpfiles-setup.service no se inicia en el arranque](#systemd-tmpfiles-setup.service_no_se_inicia_en_el_arranque)
    *   [9.8 La versión de systemd impresa en el arranque no es la misma que la versión del paquete instalado](#La_versión_de_systemd_impresa_en_el_arranque_no_es_la_misma_que_la_versión_del_paquete_instalado)
    *   [9.9 Desactivar el modo de emergencia en la máquina remota](#Desactivar_el_modo_de_emergencia_en_la_máquina_remota)

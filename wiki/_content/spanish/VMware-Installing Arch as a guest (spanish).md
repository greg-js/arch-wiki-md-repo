...
*   [3 Open-VM-Tools](#Open-VM-Tools)
    ...
    *   [3.3 Instalación](#Instalación)
*   [4 Herramientas oficiales de VMware](#Herramientas_oficiales_de_VMware)
    *   [4.1 Módulos](#Módulos_2)
    *   [4.2 Instalación (desde el huésped)](#Instalación_(desde_el_huésped))
*   [5 Configuración de Xorg](#Configuración_de_Xorg)
*   [6 Consejos y trucos](#Consejos_y_trucos)
    ...
    *   [6.2 Aceleración 3D](#Aceleración_3D)
    *   [6.3 Sincronizar la hora](#Sincronizar_la_hora)
        *   [6.3.1 Máquina anfitriona como fuente de la hora](#Máquina_anfitriona_como_fuente_de_la_hora)
...
*   [7 Solución de problemas](#Solución_de_problemas)
    *   [7.1 Problemas con el ratón](#Problemas_con_el_ratón)
    ...
    *   [7.2 Problemas en el arranque](#Problemas_en_el_arranque)
        ...
        *   [7.2.2 Cuelgues al apagar/reiniciar](#Cuelgues_al_apagar/reiniciar)
    *   [7.3 Problemas de reajuste automático](#Problemas_de_reajuste_automático)

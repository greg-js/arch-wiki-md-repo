...
Además, debe instalar el software reproductor. Los reproductores más populares de DVD son [MPlayer](/index.php/MPlayer "MPlayer"), [xine](https://en.wikipedia.org/wiki/Xine "wikipedia:Xine") y [VLC](/index.php/VLC_(Espa%C3%B1ol) "VLC (Español)"). Véase el listado de [reproductores de vídeo](/index.php/List_of_applications/Multimedia#Video_players "List of applications/Multimedia") y las instrucciones específicas para [MPlayer](/index.php/MPlayer#DVD_playing "MPlayer").

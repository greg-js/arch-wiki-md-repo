...
Este artículo es una traducción de [OpenSSH](/index.php/OpenSSH "OpenSSH"), revisada por última vez el **2018-01-05**. Si advierte que la versión inglesa [ha cambiado](https://wiki.archlinux.org/index.php?title=OpenSSH&diff=0&oldid=352767) puede ayudar a actualizar la traducción, bien por [usted mismo](/index.php/ArchWiki:Translation_Team/Contributing_(Espa%C3%B1ol) "ArchWiki:Translation Team/Contributing (Español)") o bien avisando al [equipo de traducción](/index.php/ArchWiki:Translation_Team_(Espa%C3%B1ol) "ArchWiki:Translation Team (Español)").
...
Se puede [activar](/index.php/Systemd_(Espa%C3%B1ol)#Utilizar_las_unidades "Systemd (Español)") y [activar inicio automático](/index.php/Systemd_(Espa%C3%B1ol)#Utilizar_las_unidades "Systemd (Español)") de `sshd.service` **o de** `sshd.socket` para empezar a usar el demonio.
...
*   a continuación, [reinicie](/index.php/Systemd_(Espa%C3%B1ol)#Utilizar_las_unidades "Systemd (Español)") el [demonio *sshd*](#Gestión_del_Demonio).

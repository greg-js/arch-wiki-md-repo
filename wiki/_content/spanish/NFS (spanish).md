...
*   [2 Configuración](#Configuraci.C3.B3n)
    *   [2.1 Servidor](#Servidor)
        *   [2.1.1 Mapeo de ID](#Mapeo_de_ID)
        *   [2.1.2 Sistema de archivos](#Sistema_de_archivos)
        *   [2.1.3 Exportación](#Exportaci.C3.B3n)
        *   [2.1.4 Arrancando el servidor](#Arrancando_el_servidor)
        *   [2.1.5 Configuración del cortafuegos](#Configuraci.C3.B3n_del_cortafuegos)
    *   [2.2 Cliente](#Cliente)
        *   [2.2.1 Montaje en Linux](#Montaje_en_Linux)
            *   [2.2.1.1 Ajustes en /etc/fstab](#Ajustes_en_.2Fetc.2Ffstab)
            *   [2.2.1.2 Uso de autofs](#Uso_de_autofs)
        *   [2.2.2 Montaje en Windows](#Montaje_en_Windows)
        *   [2.2.3 Montaje en OS X](#Montaje_en_OS_X)

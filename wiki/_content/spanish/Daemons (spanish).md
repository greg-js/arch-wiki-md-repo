**Estado de la traducción:** este artículo es una versión traducida de [Daemons](/index.php/Daemons "Daemons"). Fecha de la última traducción/revisión: **2018-09-29**. Puede ayudar a actualizar la traducción, si advierte que la versión inglesa ha cambiado: [ver cambios](https://wiki.archlinux.org/index.php?title=Daemons&diff=0&oldid=544604).

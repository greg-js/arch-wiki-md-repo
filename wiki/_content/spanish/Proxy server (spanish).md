...
*   [2 Variables de entorno](#Variables_de_entorno)
    *   [2.1 Mantener el proxy a través de sudo](#Mantener_el_proxy_a_través_de_sudo)
    *   [2.2 Automatización con los administradores de red](#Automatización_con_los_administradores_de_red)
...
*   [6 Configuración de proxy en GNOME3](#Configuración_de_proxy_en_GNOME3)
*   [7 Proxy NTLM de Microsoft](#Proxy_NTLM_de_Microsoft)
    *   [7.1 Configuración](#Configuración)
    *   [7.2 Utilización](#Utilización)
...
Edite `/etc/cntlm.conf` de nuevo e incluya los tres valores hash generados y, a continuación, [active](/index.php/Systemd_(Espa%C3%B1ol)#Utilizar_las_unidades "Systemd (Español)") `cntlm.service`.

...
| [compress](https://en.wikipedia.org/wiki/es:compress "wikipedia:es:compress") | [ncompress](https://www.archlinux.org/packages/?name=ncompress) | .Z | La utilidad clásica de compresión de Unix que puede manejar el antiguo archivo .Z. |

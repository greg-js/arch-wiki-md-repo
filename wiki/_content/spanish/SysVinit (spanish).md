...
*   [1 Migración a systemd](#Migración_a_systemd)
    ...
    *   [1.2 Proceder a la instalación](#Proceder_a_la_instalación)
    *   [1.3 Información complementaria](#Información_complementaria)
*   [2 Descripción de init e inittab](#Descripción_de_init_e_inittab)
*   [3 Instalación](#Instalación)
*   [4 Cambiar runlevel (nivel de ejecución)](#Cambiar_runlevel_(nivel_de_ejecución))
    *   [4.1 A través del gestor de arranque](#A_través_del_gestor_de_arranque)
    *   [4.2 Después de arrancar](#Después_de_arrancar)
*   [5 inittab](#inittab)
    *   [5.1 Runlevel por defecto](#Runlevel_por_defecto)
    *   [5.2 Scripts principales de arranque](#Scripts_principales_de_arranque)
    *   [5.3 Arranque en modalidad de usuario único](#Arranque_en_modalidad_de_usuario_único)
    *   [5.4 Gettys e inicio de sesión](#Gettys_e_inicio_de_sesión)
    *   [5.5 Ctrl+Alt+Supr](#Ctrl+Alt+Supr)

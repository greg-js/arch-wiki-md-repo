...
[Internet](/index.php/List_of_applications_(Espa%C3%B1ol)/Internet_(Espa%C3%B1ol) "List of applications (Español)/Internet (Español)") – [Multimedia](/index.php/List_of_applications_(Espa%C3%B1ol)/Multimedia_(Espa%C3%B1ol) "List of applications (Español)/Multimedia (Español)") – [Utilidades](/index.php/List_of_applications_(Espa%C3%B1ol)/Utilities_(Espa%C3%B1ol) "List of applications (Español)/Utilities (Español)") – [Documentos](/index.php/List_of_applications_(Espa%C3%B1ol)/Documents_(Espa%C3%B1ol) "List of applications (Español)/Documents (Español)") – [Seguridad](/index.php/List_of_applications_(Espa%C3%B1ol)/Security_(Espa%C3%B1ol) "List of applications (Español)/Security (Español)") – [Ciencia](/index.php/List_of_applications_(Espa%C3%B1ol)/Science_(Espa%C3%B1ol) "List of applications (Español)/Science (Español)") – <a class="mw-selflink selflink">Otras</a>
...
*   [1 Otros](#Otros)
    *   [1.1 Entorno de trabajo](#Entorno_de_trabajo)
        ...
        *   [1.1.2 Intérpretes de comandos](#Intérpretes_de_comandos)
        ...
        *   [1.1.5 Gestores de ventanas](#Gestores_de_ventanas)
            ...
            *   [1.1.5.2 Gráficos](#Gráficos)
        *   [1.1.6 Basado en tiles (baldosas)](#Basado_en_tiles_(baldosas))
        ...
        *   [1.1.8 Aplicaciones de soporte](#Aplicaciones_de_soporte)
            *   [1.1.8.1 Gestores de inicio de sesión](#Gestores_de_inicio_de_sesión)
            *   [1.1.8.2 Gestores de composición de ventanas](#Gestores_de_composición_de_ventanas)
            *   [1.1.8.3 Barras de tareas / paneles / docks](#Barras_de_tareas_/_paneles_/_docks)
            *   [1.1.8.4 Lanzadores de aplicaciones](#Lanzadores_de_aplicaciones)
            *   [1.1.8.5 Diálogos de cierre de sesión](#Diálogos_de_cierre_de_sesión)
    *   [1.2 Finanzas](#Finanzas)
    *   [1.3 Gestión del tiempo](#Gestión_del_tiempo)
        *   [1.3.1 Consola](#Consola)
        *   [1.3.2 Entorno gráfico](#Entorno_gráfico)

...
*   **secret-tool** — Acceso al llavero de GNOME (y cualquier otro servicio que implemente la [API del servicio DBus Secret](https://specifications.freedesktop.org/secret-service/)) desde la línea de órdenes.

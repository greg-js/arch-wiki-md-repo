...
*   [2 Iniciar Plasma](#Iniciar_Plasma)
    *   [2.1 Gráficamente](#Gráficamente)
    *   [2.2 Manual](#Manual)
*   [3 Configuración](#Configuración)
    *   [3.1 Personalización](#Personalización)
        *   [3.1.1 Escritorio Plasma](#Escritorio_Plasma)
            *   [3.1.1.1 Temas](#Temas)
                *   [3.1.1.1.1 Apariencia de aplicaciones Qt y GTK +](#Apariencia_de_aplicaciones_Qt_y_GTK_+)
        ...
        *   [3.1.4 Fuentes](#Fuentes)
            *   [3.1.4.1 Las fuentes en una sesión de Plasma lucen pobres](#Las_fuentes_en_una_sesión_de_Plasma_lucen_pobres)
            ...
            *   [3.1.4.4 Generación de miniaturas](#Generación_de_miniaturas)
    *   [3.2 Impresión](#Impresión)
    *   [3.3 Soporte de Samba/Windows](#Soporte_de_Samba/Windows)
    *   [3.4 Actividades de KDE Desktop](#Actividades_de_KDE_Desktop)
    *   [3.5 Ahorro de energía](#Ahorro_de_energía)
...
*   [5 Administración del sistema](#Administración_del_sistema)
    *   [5.1 Establecer distribución del teclado](#Establecer_distribución_del_teclado)
...
*   [9 Bajando de versión a kdemod3 o kde3-legacy desde KDE 4.3](#Bajando_de_versión_a_kdemod3_o_kde3-legacy_desde_KDE_4.3)

...
[LightDM](http://www.freedesktop.org/wiki/Software/LightDM) es un gestor de sesión inter-escritorio que aspira a ser el estándar para el sistema de ventanas X11 y para [Wayland](/index.php/Wayland "Wayland").

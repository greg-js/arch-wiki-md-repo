...
5.  Utilice [google-chrome](https://aur.archlinux.org/packages/google-chrome/) que incorpora la nueva API Pepper [pepper-flash](https://www.archlinux.org/packages/?name=pepper-flash).

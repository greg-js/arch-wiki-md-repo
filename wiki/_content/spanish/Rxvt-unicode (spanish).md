...
*   [2 Configuración](#Configuración)
    *   [2.1 Creando ~/.Xresources](#Creando_~/.Xresources)
        *   [2.1.1 Ejemplo ~/.Xresources #1](#Ejemplo_~/.Xresources_#1)
        *   [2.1.2 Ejemplo ~/.Xresources #2](#Ejemplo_~/.Xresources_#2)
*   [3 Consejos & Trucos](#Consejos_&_Trucos)
    *   [3.1 URIs cliqueables](#URIs_cliqueables)
    *   [3.2 Yankable URIs (Sin Mouse)](#Yankable_URIs_(Sin_Mouse))
    *   [3.3 Copiar y pegar](#Copiar_y_pegar)
        *   [3.3.1 Clipboard Management](#Clipboard_Management)
        *   [3.3.2 Script de gestión automática](#Script_de_gestión_automática)

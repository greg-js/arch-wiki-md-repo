...
*   [2 Comenzando con Fluxbox](#Comenzando_con_Fluxbox)
    *   [2.1 Método 1: KDM/GDM Login/Session Managers](#Método_1:_KDM/GDM_Login/Session_Managers)
    *   [2.2 Metodo 2: ~/.xinitrc](#Metodo_2:_~/.xinitrc)
*   [3 Configuración](#Configuración)
    *   [3.1 Mantenimiento del menú](#Mantenimiento_del_menú)
        *   [3.1.1 fluxbox-generate_menu](#fluxbox-generate_menu)
        *   [3.1.2 MenuMaker](#MenuMaker)
        *   [3.1.3 Arch Linux Xdg menu](#Arch_Linux_Xdg_menu)
        *   [3.1.4 Crear/editar manualmente el menú](#Crear/editar_manualmente_el_menú)
    *   [3.2 Teclas de acceso rápido](#Teclas_de_acceso_rápido)
    *   [3.3 Espacios de trabajo](#Espacios_de_trabajo)
    *   [3.4 Tabulación y agrupación](#Tabulación_y_agrupación)
    *   [3.5 Fondos de pantalla](#Fondos_de_pantalla)
        *   [3.5.1 Cambiar fondos de pantalla fácilmente](#Cambiar_fondos_de_pantalla_fácilmente)
    ...
    *   [3.10 La vida después de xorg.conf](#La_vida_después_de_xorg.conf)

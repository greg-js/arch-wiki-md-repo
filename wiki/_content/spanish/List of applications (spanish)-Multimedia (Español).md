...
[Internet](/index.php/List_of_applications_(Espa%C3%B1ol)/Internet_(Espa%C3%B1ol) "List of applications (Español)/Internet (Español)") – <a class="mw-selflink selflink">Multimedia</a> – [Utilidades](/index.php/List_of_applications_(Espa%C3%B1ol)/Utilities_(Espa%C3%B1ol) "List of applications (Español)/Utilities (Español)") – [Documentos](/index.php/List_of_applications_(Espa%C3%B1ol)/Documents_(Espa%C3%B1ol) "List of applications (Español)/Documents (Español)") – [Seguridad](/index.php/List_of_applications_(Espa%C3%B1ol)/Security_(Espa%C3%B1ol) "List of applications (Español)/Security (Español)") – [Ciencia](/index.php/List_of_applications_(Espa%C3%B1ol)/Science_(Espa%C3%B1ol) "List of applications (Español)/Science (Español)") – [Otras](/index.php/List_of_applications_(Espa%C3%B1ol)/Other_(Espa%C3%B1ol) "List of applications (Español)/Other (Español)")
...
*   [1 Multimedia](#Multimedia)
    *   [1.1 Visores de imágenes](#Visores_de_imágenes)
        *   [1.1.1 Consola](#Consola)
        *   [1.1.2 Interfaz gráfica](#Interfaz_gráfica)
    *   [1.2 Manipulación de gráficos e imágenes](#Manipulación_de_gráficos_e_imágenes)
        *   [1.2.1 Editores de imágenes matriciales o ráster](#Editores_de_imágenes_matriciales_o_ráster)
        *   [1.2.2 Gráficos vectoriales - Ilustración](#Gráficos_vectoriales_-_Ilustración)
        *   [1.2.3 Gráficos vectoriales - CAD](#Gráficos_vectoriales_-_CAD)
        *   [1.2.4 Modelado/renderizado 3D](#Modelado/renderizado_3D)
    *   [1.3 Utilizades gráficas (aplicaciones de ayuda)](#Utilizades_gráficas_(aplicaciones_de_ayuda))
        *   [1.3.1 Captura de pantalla](#Captura_de_pantalla)
        *   [1.3.2 Screencast](#Screencast)
    *   [1.4 Sistemas de audio](#Sistemas_de_audio)
    *   [1.5 Reproductores de audio](#Reproductores_de_audio)
        *   [1.5.1 Demonio y cliente de *«music player»*](#Demonio_y_cliente_de_«music_player»)
        *   [1.5.2 Consola](#Consola_2)
        *   [1.5.3 Interfez gráfica](#Interfez_gráfica)
    *   [1.6 Ripear CD](#Ripear_CD)
    *   [1.7 Visualización](#Visualización)
    *   [1.8 Editores de etiquetas de audio](#Editores_de_etiquetas_de_audio)
    *   [1.9 Editores de audio](#Editores_de_audio)
    *   [1.10 Aplicaciones de e-book](#Aplicaciones_de_e-book)
    *   [1.11 Telefonía](#Telefonía)
    *   [1.12 Reproductores de vídeo](#Reproductores_de_vídeo)
        *   [1.12.1 Consola](#Consola_3)
        *   [1.12.2 Interfaz gráfica](#Interfaz_gráfica_2)
    *   [1.13 Editores de vídeo](#Editores_de_vídeo)
        *   [1.13.1 Consola](#Consola_4)
        *   [1.13.2 Interfaz gráfica](#Interfaz_gráfica_3)
    *   [1.14 Gestores de colecciones](#Gestores_de_colecciones)

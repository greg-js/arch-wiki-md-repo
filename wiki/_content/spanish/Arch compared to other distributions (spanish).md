...
*   [The Arch Way (Español)](/index.php/The_Arch_Way_(Espa%C3%B1ol) "The Arch Way (Español)")
...
Las distribuciones basadas en las fuentes son altamente portables, proporcionando la ventaja de controlar y compilar el sistema operativo completo y las aplicaciones para la particular arquitectura de la máquina y el propósito de su uso, con la desventaja de que consumen mucho tiempo en la compilación del código fuente. La base de Arch y todos los paquetes están compilados para arquitecturas x86-64 (i686 [hasta](https://www.archlinux.org/news/phasing-out-i686-support/) noviembre de 2017), ofreciendo un significativo incremento de prestaciones respecto a distribuciones basadas en paquetes i386/i486/i586 binarios, con la ventaja añadida de instalarse rápidamente.
...
*   Tanto Arch como CRUX soportan de manera oficial la arquitectura x86_64.

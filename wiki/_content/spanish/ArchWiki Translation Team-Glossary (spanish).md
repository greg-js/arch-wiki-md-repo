...
| `**job:**` | trabajo |
| `**journaling file system:**` | sistema de archivos transaccional (-JFS- es un sistema de archivos de 55-bit con respaldo de transacciones creado por IBM. Está disponible bajo la licencia GNU GPL) |

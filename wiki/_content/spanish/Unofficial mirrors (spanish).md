...
*   [http://mirror.bit.edu.cn/archlinux/](http://mirror.bit.edu.cn/archlinux/) - *Instituto de Tecnología de Beijing*
...
*   [http://mirror.hust.edu.cn/archlinux/](http://mirror.hust.edu.cn/archlinux/) - *Mirror de la Universidad de Ciencia y Tecnología de Huazhong (HUSTMirror)*
...
*   [http://delta.archlinux.fr/](http://delta.archlinux.fr/) - *Con soporte para paquetes Delta. Necesita [xdelta3](https://www.archlinux.org/packages/?name=xdelta3) para ejecutarse.*
...
*   [http://ftp.nara.wide.ad.jp/pub/Linux/archlinux/](http://ftp.nara.wide.ad.jp/pub/Linux/archlinux/) - *Instituto de Ciencia y Tecnología de Nara*
...
*   [http://archlinux.za.mirror.allworldit.com/archlinux-deltarepo/](http://archlinux.za.mirror.allworldit.com/archlinux-deltarepo/) - *Generación automática de deltas para los últimos 3 meses hasta la versión actual. Soporta http, https, rsync e IPv6\. Véase [aquí](https://bbs.archlinux.org/viewtopic.php?id=243247) para obtener más información.*
...
*   [http://mirror.katie.host/archlinux/](http://mirror.katie.host/archlinux/) - *Contiene deltas generados automáticamente para los últimos 3 meses hasta la versión actual. Los deltas se obtienen de [aquí](http://archlinux.uk.mirror.allworldit.com/archlinux-deltarepo/). Véase [aquí](https://bbs.archlinux.org/viewtopic.php?id=243247) para obtener más información*

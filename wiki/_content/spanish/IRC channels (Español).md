El tamaño de nuestra comunidad condujo a la creación de múltiples canales de IRC. Para mostrar todos los canales que empiezan con «archlinux», escriba `/query alis list #archlinux*`.

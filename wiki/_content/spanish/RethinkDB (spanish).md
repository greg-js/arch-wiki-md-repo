**Estado de la traducción:** este artículo es una versión traducida de [RethinkDB](/index.php/RethinkDB "RethinkDB"). Fecha de la última traducción/revisión: **2018-08-13**. Puedes ayudar a actualizar la traducción, si adviertes que la versión inglesa ha cambiado: [ver cambios](https://wiki.archlinux.org/index.php?title=RethinkDB&diff=0&oldid=533304).

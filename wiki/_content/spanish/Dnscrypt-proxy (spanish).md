**Estado de la traducción:** este artículo es una versión traducida de [dnscrypt-proxy](/index.php/Dnscrypt-proxy "Dnscrypt-proxy"). Fecha de la última traducción/revisión: **2018-09-14**. Puedes ayudar a actualizar la traducción, si adviertes que la versión inglesa ha cambiado: [ver cambios](https://wiki.archlinux.org/index.php?title=Dnscrypt-proxy&diff=0&oldid=537991).

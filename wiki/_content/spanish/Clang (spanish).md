...
**Sugerencia:** Si su proyecto ya está compilado, `scan-build` no se reconstruirá y tampoco lo analizará. Para forzar la recompilación y el análisis, use el interruptor `-B`: `$ scan-build make -B` 

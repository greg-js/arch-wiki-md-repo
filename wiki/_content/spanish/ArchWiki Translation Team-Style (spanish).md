...
*   [1 Guía de estilo](#Gu.C3.ADa_de_estilo)
    *   [1.1 Reglas ortotipográficas](#Reglas_ortotipogr.C3.A1ficas)
    *   [1.2 Reglas básicas de redacción](#Reglas_b.C3.A1sicas_de_redacci.C3.B3n)
    *   [1.3 Reglas de edición](#Reglas_de_edici.C3.B3n)
    *   [1.4 Reglas técnicas](#Reglas_t.C3.A9cnicas)
*   [2 Enlaces externos](#Enlaces_externos)
*   [3 Referencias](#Referencias)

## Guía de estilo

Una [guía de estilo](https://en.wikipedia.org/wiki/es:Manual_de_estilo "wikipedia:es:Manual de estilo") es un conjunto de indicaciones, especificaciones y glosarios propios sobre cómo redactar y —en nuestro caso— traducir documentos.
...
*   [Diccionario panhispánico de dudas (2005)](http://lema.rae.es/dpd/).
...
Las reglas contenidas en esta sección siguen las normas y recomendaciones académicas de la lengua (RAE) que reconocemos como la máxima autoridad en esta materia. Se recogen algunas de las reglas ortográficas que se usan con más frecuencia y aquellas que han supuesto alguna novedad respecto a lo indicado en la última edición (2010) de la Ortografía de la Lengua Española (en adelante [OLE](http://rae.es/obras-academicas/ortografia/ortografia-2010)), así como arrojar luz sobre aquellas grafías que planteen dudas, siguiendo a tal efecto las recomendaciones del Diccionario Panhispánico de Dudas (2005) (en adelante DPD).

	[Signos de puntuación simples](https://en.wikipedia.org/wiki/es:Signo_de_puntuaci%C3%B3n "wikipedia:es:Signo de puntuación")

*   Los signos simples son aquellos que no tienen apertura y cierre, sino solamente cierre, esto es, el [punto](http://www.wikilengua.org/index.php/Punto) (`**.**`), [coma](http://www.wikilengua.org/index.php/Coma) (`**,**`), [dos puntos](http://www.wikilengua.org/index.php/Dos_puntos) (`**:**`), [punto y coma](http://www.wikilengua.org/index.php/Punto_y_coma) (`**;**`) y [puntos suspensivos](http://www.wikilengua.org/index.php/Puntos_suspensivos) (`**...**`), se escriben siempre pegados a la palabra que les precede y con un espacio que los separa de la palabra o signo que los sigue.
*   Respecto al punto (`**.**`):
...
*   Utilice el guión ordinario de su teclado (`**-**`) para separar palabras compuestas, en los casos que lo lleven, o para separar un rango de fechas, números, etc. (por ejemplo: «Desde los años 1998-2000»)
	...
	[Guión largo o raya](http://www.wikilengua.org/index.php/Raya)
...
*   Utilice [«etc.»](http://www.wikilengua.org/index.php/etc) o «...» (puntos suspensivos), pero no ambos en la misma enumeración, pues es redundancia innecesaria (OLE, 1999, p. 68 y OLE, 2010, p. 397). Los puntos suspensivos (`**...**`) nunca van seguidos de un punto, en cambio `etc.` siempre va seguida de un punto al ser una abreviatura.

	[Tildes](https://en.wikipedia.org/wiki/es:Acento_ortogr%C3%A1fico "wikipedia:es:Acento ortográfico")

*   Se ha eliminado la tilde en el adverbio «solo» y en los pronombres demostrativos («este, ese, aquel...»), incluso en casos de posible ambigüedad, salvo cuando existe riesgo de [anfibología](https://en.wikipedia.org/wiki/es:anfibolog%C3%ADa "wikipedia:es:anfibología").
...
*   La abreviatura de una palabra acentuada conserva la tilde (las abreviaturas terminan, casi sin excepción, con punto).
	...
	[Mayúsculas](https://en.wikipedia.org/wiki/es:May%C3%BAscula "wikipedia:es:Mayúscula")

*   Se escribe con mayúscula inicial únicamente la primera palabra de la cabecera de cualquier sección (excepto los nombres propios —nombres de personas o nombres geográficos—, y el nombre de las publicaciones periódicas y de las colecciones) (OLE, 2010, p. 488). Cuando se trate de la traducción al español de un título en inglés, «para el uso de las mayúsculas, se seguirá el uso ortográfico de la lengua en la que se da la información» (norma [UNE](https://en.wikipedia.org/wiki/es:Una_Norma_Espa%C3%B1ola "wikipedia:es:Una Norma Española") 50104: 1994). Por tanto, el uso de la mayúscula en todos los sustantivos y adjetivos que forman parte del encabezado de las secciones es un anglicismo ortográfico que debe evitarse.
...
*   Otros son términos creados en el ambiente informático o que en él tienen un significado especial (script, hook, shell...).
    **Nota:** Siempre que se decida dejar el término inglés original se pueden usar comillas o letra cursiva, si el contexto lo aconseja. A veces también puede ser conveniente dejar la expresión original inglesa traducida al lado de la española, entre paréntesis y en cursiva.
...
*   El traductor debe permanecer lo más fiel posible al espíritu y al sentido del mensaje a traducir, es decir, se preferirán las [traducciones literales](https://en.wikipedia.org/wiki/es:Metafr%C3%A1stica "wikipedia:es:Metafrástica") «solo» cuando reproduzcan lo expresado por el autor en un cotexto comprensible para el destinatario.
...
6.  Si nos hemos equivocado al grabar la página seguiremos los pasos descritos en el apartado sobre [cómo revertir las ediciones](/index.php/Help:Editing_(Espa%C3%B1ol)#Revertir_ediciones "Help:Editing (Español)") para subsanar el error.
...
En todo artículo que traduzca o actualice deberá prestar atención a los siguientes elementos técnicos y modificarlos adecuadamente :
	...
	**Enlaces interlenguas**
	...
	Se debe incluir al principio del texto. Cada artículo traducido debe contener, al menos, un enlace interlengua a la página en versión inglesa (el formato es: `[[en:nombre del artículo]]`, así como los enlaces a las páginas similares de otros idiomas. Además, si la traducción es nueva, tiene que ser muy cuidadoso y editar todas las páginas del mismo tema ya traducidas a otros idiomas para incluir en ellas el enlace a la página en español recién traducida. Para saber más detalles consulte [esta sección](/index.php/Help:Style_(Espa%C3%B1ol)#Enlaces_interlenguas "Help:Style (Español)").
...
*   Se pueden incluir en cualquier parte del texto. Se utilizan para indicar el estado del artículo cuando le afecte alguna anomalía de la que debe advertirse al lector:
	...
	`{{Deletion|Indicar el motivo}}` — se utiliza para indicar contenido irrelevante o inútil, propuesto para su eliminación.
	...
	`{{Moveto|Nombre del artículo propuesto|motivo}}` — se utiliza para sugerir el cambio de nombre de un artículo.

	`{{Out of date|Indicar el motivo}}` — se utiliza para indicar contenido desactualizado.

	`{{Poor writing|Indicar el motivo}}` — se utiliza para indicar artículos mal escritos.
...
*   En «Indicar el motivo» de la plantilla, podemos poner alguna breve anotación explicativa, como por ejemplo: `{{Translateme|en proceso de actualización}}`. Para conocer todas las plantillas vea [Help:Template (Español)](/index.php/Help:Template_(Espa%C3%B1ol) "Help:Template (Español)").
...
*   [Asociación de academias de la lengua española](http://asale.org/), con enlaces a las distintas academias de cada país.
*   [Diccionario multilenguaje de WordReference](http://www.wordreference.com/es/)
*   [Fundación del español urgente — Fundéu BBVA](http://www.fundeu.es/categorias/)
*   [Lenguaje wikitexto](https://en.wikipedia.org/wiki/es:Wikitexto "wikipedia:es:Wikitexto")
*   [Glosario de KDE](http://es.l10n.kde.org/glosario.php)
*   [Glosario de informática inglés-español](http://es.tldp.org/ORCA/glosario.html) del proyecto [ORCA](http://projects.gnome.org/orca/).
*   [Glosario básico inglés-español](http://www.ati.es/novatica/glosario/glosario_internet.html) (de Rafael Fernández Calvo).
*   [Errores habituales de Spanglish](http://maja.dit.upm.es/~aalvarez/pitfalls/) contiene una lista de errores de traducción comunes, «falsos amigos» o traducciones al «spanglish» (de Ángel Álvarez).

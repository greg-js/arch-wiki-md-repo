...
*   Del mismo modo, si no está formalmente interesado en las tareas de mantenimiento de la wiki, y, no obstante ello, realiza una traducción, actualización o revisión, por favor, incluya el nombre del artículo y su fecha en la [Tabla](/index.php/ArchWiki_Translation_Team/Board_(Espa%C3%B1ol)#Tabla_de_Traducciones "ArchWiki Translation Team/Board (Español)") correspondiente, a fin de que podamos tener una reflejo lo más aproximado posible de la situación actual de la wiki en español.

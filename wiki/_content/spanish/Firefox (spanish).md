...
*   [2 Add-ons](#Add-ons)
*   [3 Plugins](#Plugins)
    *   [3.1 Integración con Gnome](#Integraci.C3.B3n_con_Gnome)
    *   [3.2 Diccionarios para corrección ortográfica](#Diccionarios_para_correcci.C3.B3n_ortogr.C3.A1fica)
    *   [3.3 Añadiendo motores de búsqueda a Firefox](#A.C3.B1adiendo_motores_de_b.C3.BAsqueda_a_Firefox)
        *   [3.3.1 arch-firefox-search](#arch-firefox-search)
    *   [3.4 Firefox en español](#Firefox_en_espa.C3.B1ol)
*   [4 Proyectos relacionados con Firefox](#Proyectos_relacionados_con_Firefox)
    *   [4.1 Derivados de Firefox](#Derivados_de_Firefox)
    *   [4.2 Mejorar la integración de Firefox con KDE](#Mejorar_la_integraci.C3.B3n_de_Firefox_con_KDE)
*   [5 Resolución de problemas](#Resoluci.C3.B3n_de_problemas)
    *   [5.1 Nueva barra de menús de Firefox 4/ botón de Firefox](#Nueva_barra_de_men.C3.BAs_de_Firefox_4.2F_bot.C3.B3n_de_Firefox)
    *   [5.2 Problema abriendo carpetas contenedoras (KDE)](#Problema_abriendo_carpetas_contenedoras_.28KDE.29)
    *   [5.3 Firefox continua creando ~/Desktop incluso cuando no quiero!](#Firefox_continua_creando_.7E.2FDesktop_incluso_cuando_no_quiero.21)
    *   [5.4 Cómo prevenir que los plugins abran popups ?](#C.C3.B3mo_prevenir_que_los_plugins_abran_popups_.3F)
    *   [5.5 Errores haciendo click con el botón central](#Errores_haciendo_click_con_el_bot.C3.B3n_central)
    *   [5.6 La tecla de borrar no funciona como botón "Atrás"](#La_tecla_de_borrar_no_funciona_como_bot.C3.B3n_.22Atr.C3.A1s.22)
    *   [5.7 Firefox no recuerda la información de login](#Firefox_no_recuerda_la_informaci.C3.B3n_de_login)
    *   [5.8 Sitios web rotos / campos de entrada con temas Gtk oscuros](#Sitios_web_rotos_.2F_campos_de_entrada_con_temas_Gtk_oscuros)
    *   [5.9 Problemas de asociación de ficheros](#Problemas_de_asociaci.C3.B3n_de_ficheros)
    *   [5.10 Modo "Voy a tener suerte"](#Modo_.22Voy_a_tener_suerte.22)
    *   [5.11 Modo "Voy a tener suerte" (para DuckDuckGo)](#Modo_.22Voy_a_tener_suerte.22_.28para_DuckDuckGo.29)
    *   [5.12 El diálogo "Desea que Firefox guarde sus pestañas para la próxima vez?" no aparece](#El_di.C3.A1logo_.22Desea_que_Firefox_guarde_sus_pesta.C3.B1as_para_la_pr.C3.B3xima_vez.3F.22_no_aparece)
*   [6 Recursos](#Recursos)

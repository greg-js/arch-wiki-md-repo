...
*   [2 Configuración](#Configuración)
    ...
    *   [2.5 Vídeo](#Vídeo)
    *   [2.6 Composición acelerada por hardware](#Composición_acelerada_por_hardware)
...
Véase [GStreamer](/index.php/GStreamer_(Espa%C3%B1ol) "GStreamer (Español)") para la instalación del plugin necesario. Para la decodificación de vídeo acelerada por hardware, active también [#Composición acelerada por hardware](#Composición_acelerada_por_hardware).

### Composición acelerada por hardware

Active la composición acelerada por hardware con la siguiente orden:

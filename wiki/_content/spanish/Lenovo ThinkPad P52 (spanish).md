...
Este artículo es una traducción de [Lenovo ThinkPad P52](/index.php/Lenovo_ThinkPad_P52 "Lenovo ThinkPad P52"), revisada por última vez el **2018-12-20**. Si advierte que la versión inglesa [ha cambiado](https://wiki.archlinux.org/index.php?title=Lenovo_ThinkPad_P52&diff=0&oldid=559564) puede ayudar a actualizar la traducción, bien por [usted mismo](/index.php/ArchWiki:Translation_Team/Contributing_(Espa%C3%B1ol) "ArchWiki:Translation Team/Contributing (Español)") o bien avisando al [equipo de traducción](/index.php/ArchWiki:Translation_Team_(Espa%C3%B1ol) "ArchWiki:Translation Team (Español)").

El Lenovo P52 es un portátil Intel de octava generación de cuatro o seis núcleos.

## Instalación

Siga la [Guía para principiantes](/index.php/Installation_guide_(Espa%C3%B1ol) "Installation guide (Español)") para instalar Arch.

## lspci

`lspci` devuelve esto en el P52:
...
`lsusb` devuelve algo así en el P52:

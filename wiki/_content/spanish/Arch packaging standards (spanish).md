...
Los paquetes enviados a AUR deben además cumplir con [Arch User Repository (Español)#Reglas de envío](/index.php/Arch_User_Repository_(Espa%C3%B1ol)#Reglas_de_env.C3.ADo "Arch User Repository (Español)").
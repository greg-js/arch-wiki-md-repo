...
*   [3 Configuración del motor](#Configuración_del_motor)
    *   [3.1 ALSA](#ALSA)
    *   [3.2 OSS](#OSS)
        *   [3.2.1 osspd](#osspd)
...
*   [5 Aplicaciones](#Aplicaciones)
    ...
    *   [5.2 mpd](#mpd)
    *   [5.3 MPlayer](#MPlayer)
    *   [5.4 Flashplugin (solo x86_64)](#Flashplugin_(solo_x86_64))
    *   [5.5 Skype (x86_64 only)](#Skype_(x86_64_only))
...
*   [6 Configuraciones alternativas](#Configuraciones_alternativas)
    ...
    *   [6.3 PulseAudio over network](#PulseAudio_over_network)
        *   [6.3.1 TCP support (networked sound)](#TCP_support_(networked_sound))
        *   [6.3.2 Zeroconf (Avahi) publishing](#Zeroconf_(Avahi)_publishing)
    ...
    *   [6.4 Pulseaudio through JACK](#Pulseaudio_through_JACK)
        *   [6.4.1 QjackCtl with Startup/Shutdown Scripts](#QjackCtl_with_Startup/Shutdown_Scripts)
    *   [6.5 Pulseaudio a través OSS](#Pulseaudio_a_través_OSS)
    *   [6.6 Pulseaudio from within a chroot (ex. 32-bit chroot in 64-bit install)](#Pulseaudio_from_within_a_chroot_(ex._32-bit_chroot_in_64-bit_install))
    *   [6.7 Simultaneous Digital and Analog Output](#Simultaneous_Digital_and_Analog_Output)
*   [7 Troubleshooting](#Troubleshooting)
    *   [7.1 No hay sonido después de instalar](#No_hay_sonido_después_de_instalar)
    ...
    *   [7.5 Problemas técnicos y uso intensivo de la CPU desde 0.9.14](#Problemas_técnicos_y_uso_intensivo_de_la_CPU_desde_0.9.14)
    *   [7.6 Sonido entrecortado](#Sonido_entrecortado)
    *   [7.7 Volume adjustment doesn't work properly](#Volume_adjustment_doesn't_work_properly)

...
*   [3 Guía rápida de VIM](#Guía_rápida_de_VIM)
    *   [3.1 Cómo iniciar vim](#Cómo_iniciar_vim)
    *   [3.2 Cómo introducir texto](#Cómo_introducir_texto)
    *   [3.3 Cómo mover el cursor](#Cómo_mover_el_cursor)
    *   [3.4 Cómo borrar texto](#Cómo_borrar_texto)
    *   [3.5 Cómo insertar texto](#Cómo_insertar_texto)
    *   [3.6 Cómo Cortar, Copiar y Pegar](#Cómo_Cortar,_Copiar_y_Pegar)
    *   [3.7 Cortar, Copiar y Pegar en modo visual](#Cortar,_Copiar_y_Pegar_en_modo_visual)
    *   [3.8 Deshacer ("Undo")](#Deshacer_("Undo"))
    *   [3.9 Cómo buscar una palabra](#Cómo_buscar_una_palabra)
    *   [3.10 Cómo sustituir texto](#Cómo_sustituir_texto)
    *   [3.11 Cómo salir de vim](#Cómo_salir_de_vim)

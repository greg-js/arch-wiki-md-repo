...
*   [3 Mapas](#Mapas)
    ...
    *   [3.3 Mapas generados por el usuario](#Mapas_generados_por_el_usuario)
*   [4 Alístate](#Al.C3.ADstate)
...
**Nota:** ArchMap está actualmente en desarrollo en [GitHub](https://github.com/guyfawcus/ArchMap). Si tiene alguna sugerencia, por favor [publíquelas](https://bbs.archlinux.org/viewtopic.php?id=22518&p=2) en los foros o [cree un problema](https://github.com/guyfawcus/ArchMap/issues) en el repositorio.
...
Puedes agregar las coordenadas a Google Earth de forma permanente:
...
[Este mapa](https://data.dopsi.ch/archmap) se actualiza diariamente (alrededor de las 10:00 am UTC) utilizando el script [ArchMap](http://github.com/guyfawcus/ArchMap). Los datos KML utilizados para representar el mapa están disponibles [aquí](https://data.dopsi.ch/archmap/archmap.kml), la lista de usuarios sin procesar [aquí](https://data.dopsi.ch/archmap/users.txt).
...
Ve a la página [Lista ArchMap](/index.php/ArchMap/List "ArchMap/List"), sigue las instrucciones y luego usa el botón [**editar**] para agregarte al mapa.
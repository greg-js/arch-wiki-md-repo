...
*   si no tiene ningún [entorno de escritorio](/index.php/Desktop_environment_(Espa%C3%B1ol) "Desktop environment (Español)"), agregue la línea siguiente en la parte superior de [~/.xinitrc](/index.php/Xinitrc_(Espa%C3%B1ol) "Xinitrc (Español)") por encima de cualquier opción `exec`:

...
Si recibe un error acerca de que wicd falla al no encontrar un programa gráfico con sudo, instale uno como [gksu](https://www.archlinux.org/packages/?name=gksu), [ktsuss](https://aur.archlinux.org/packages/ktsuss/), o [kdebase-runtime](https://www.archlinux.org/packages/?name=kdebase-runtime), ejecutando la orden oportuna:

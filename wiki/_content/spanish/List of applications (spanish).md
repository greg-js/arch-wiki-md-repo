...
*   [1 Internet](#Internet)
    *   [1.1 Clientes BitTorrent](#Clientes_BitTorrent)
        ...
        *   [1.1.2 Interfez gráfica](#Interfez_gráfica)
    *   [1.2 Clientes eDonkey](#Clientes_eDonkey)
    *   [1.3 Mensajería instantánea](#Mensajería_instantánea)
        *   [1.3.1 Clientes multiprotocolo](#Clientes_multiprotocolo)
            *   [1.3.1.1 Consola](#Consola_2)
            *   [1.3.1.2 Interfaz gráfica](#Interfaz_gráfica)
        *   [1.3.2 Jabber/XMPP](#Jabber/XMPP)
            *   [1.3.2.1 Consola](#Consola_3)
            *   [1.3.2.2 Interfaz gráfica](#Interfaz_gráfica_2)
            *   [1.3.2.3 Servidores](#Servidores)
        *   [1.3.3 Clientes IRC](#Clientes_IRC)
            *   [1.3.3.1 Consola](#Consola_4)
            *   [1.3.3.2 Interfaz gráfica](#Interfaz_gráfica_3)
    *   [1.4 Software telefónico](#Software_telefónico)
    ...
    *   [1.6 Clientes de e-mail](#Clientes_de_e-mail)
        ...
        *   [1.6.2 Interfaz gráfica](#Interfaz_gráfica_4)
    ...
    *   [1.8 Agregadores de noticias](#Agregadores_de_noticias)
        ...
        *   [1.8.2 Interfaz gráfica](#Interfaz_gráfica_5)
    *   [1.9 Navegadores web](#Navegadores_web)
        *   [1.9.1 Consola](#Consola_7)
        *   [1.9.2 Interfaz gráfica](#Interfaz_gráfica_6)
...
*   [2 Multimedia](#Multimedia)
    *   [2.1 Visores de imágenes](#Visores_de_imágenes)
        *   [2.1.1 Consola](#Consola_8)
        *   [2.1.2 Interfaz gráfica](#Interfaz_gráfica_7)
    *   [2.2 Manipulación de gráficos e imágenes](#Manipulación_de_gráficos_e_imágenes)
        *   [2.2.1 Editores de imágenes matriciales o ráster](#Editores_de_imágenes_matriciales_o_ráster)
        *   [2.2.2 Gráficos vectoriales - Ilustración](#Gráficos_vectoriales_-_Ilustración)
        *   [2.2.3 Gráficos vectoriales - CAD](#Gráficos_vectoriales_-_CAD)
        *   [2.2.4 Modelado/renderizado 3D](#Modelado/renderizado_3D)
    *   [2.3 Utilizades gráficas (aplicaciones de ayuda)](#Utilizades_gráficas_(aplicaciones_de_ayuda))
    ...
    *   [2.5 Reproductores de audio](#Reproductores_de_audio)
        *   [2.5.1 Demonio y cliente de *«music player»*](#Demonio_y_cliente_de_«music_player»)
        *   [2.5.2 Consola](#Consola_9)
        *   [2.5.3 Interfez gráfica](#Interfez_gráfica_2)
    *   [2.6 Ripear CD](#Ripear_CD)
    *   [2.7 Visualización](#Visualización)
    ...
    *   [2.11 Telefonía](#Telefonía)
    *   [2.12 Reproductores de vídeo](#Reproductores_de_vídeo)
        *   [2.12.1 Consola](#Consola_10)
        *   [2.12.2 Interfaz gráfica](#Interfaz_gráfica_8)
    *   [2.13 Editores de vídeo](#Editores_de_vídeo)
        *   [2.13.1 Consola](#Consola_11)
        *   [2.13.2 Interfaz gráfica](#Interfaz_gráfica_9)
    *   [2.14 Gestores de colecciones](#Gestores_de_colecciones)
*   [3 Utilidades](#Utilidades_2)
    *   [3.1 Órdenes básicas de la shell](#Órdenes_básicas_de_la_shell)
    *   [3.2 Gestores de paquetes](#Gestores_de_paquetes)
    *   [3.3 Programas de visualización sobre la utilización del disco](#Programas_de_visualización_sobre_la_utilización_del_disco)
    *   [3.4 Herramientas de grabación de CD/DVD](#Herramientas_de_grabación_de_CD/DVD)
    *   [3.5 Gestores de portapapeles](#Gestores_de_portapapeles)
    *   [3.6 Herramientas de compresión](#Herramientas_de_compresión)
        *   [3.6.1 Consola](#Consola_12)
        *   [3.6.2 Interfaz gráfica](#Interfaz_gráfica_10)
    *   [3.7 Gestores de archivos](#Gestores_de_archivos)
        *   [3.7.1 Consola](#Consola_13)
        *   [3.7.2 Interfaz gráfica](#Interfaz_gráfica_11)
    *   [3.8 Herramientas de integración y comparación de archivos](#Herramientas_de_integración_y_comparación_de_archivos)
...
*   [4 Documentos](#Documentos)
    *   [4.1 Lectores de documentos](#Lectores_de_documentos)
        ...
        *   [4.1.2 Interfaz gráfica](#Interfaz_gráfica_12)
            *   [4.1.2.1 Visores de archivos con extensión CHM](#Visores_de_archivos_con_extensión_CHM)
    *   [4.2 Suites de ofimática](#Suites_de_ofimática)
    *   [4.3 Indexadores](#Indexadores)
    *   [4.4 Procesadores de texto](#Procesadores_de_texto)
    *   [4.5 Hojas de cálculo](#Hojas_de_cálculo)
    *   [4.6 Documentos científicos](#Documentos_científicos)
    *   [4.7 Software de reconocimiento óptico de caracteres (siglas en inglés OCR)](#Software_de_reconocimiento_óptico_de_caracteres_(siglas_en_inglés_OCR))
*   [5 Seguridad](#Seguridad)
    *   [5.1 Cortafuegos](#Cortafuegos)
    *   [5.2 Seguridad de la red](#Seguridad_de_la_red)
    *   [5.3 Detección de amenazas y vulnerabilidades](#Detección_de_amenazas_y_vulnerabilidades)
    *   [5.4 Seguridad de los archivos](#Seguridad_de_los_archivos)
    *   [5.5 Aplicaciones para realizar copias de respaldo (backup)](#Aplicaciones_para_realizar_copias_de_respaldo_(backup))
    *   [5.6 Aplicaciones para bloquear la pantalla](#Aplicaciones_para_bloquear_la_pantalla)
*   [6 Ciencia](#Ciencia)
    *   [6.1 Documentos científicos](#Documentos_científicos_2)
    *   [6.2 Matemáticas](#Matemáticas)
        *   [6.2.1 Calculadoras](#Calculadoras)
        *   [6.2.2 Sistema de álgebra computacional](#Sistema_de_álgebra_computacional)
        *   [6.2.3 Ciencia o técnica computacional](#Ciencia_o_técnica_computacional)
        *   [6.2.4 Estadística](#Estadística)
        *   [6.2.5 Evaluación de datos](#Evaluación_de_datos)
    *   [6.3 Química y biología](#Química_y_biología)
        *   [6.3.1 Biología computacional y bioinformática](#Biología_computacional_y_bioinformática)
        *   [6.3.2 Visores moleculares](#Visores_moleculares)
        *   [6.3.3 Gráficos moleculares](#Gráficos_moleculares)
        *   [6.3.4 Tabla periódica](#Tabla_periódica)
        *   [6.3.5 Bioquímica](#Bioquímica)
        *   [6.3.6 Modelado molecular](#Modelado_molecular)
        *   [6.3.7 Manipulación de imágenes](#Manipulación_de_imágenes)
    *   [6.4 Astronomía](#Astronomía)
    *   [6.5 Física](#Física)
        *   [6.5.1 Electrónica](#Electrónica)
        *   [6.5.2 Simulación física](#Simulación_física)
        *   [6.5.3 Conversión de unidades](#Conversión_de_unidades)
*   [7 Otros](#Otros_2)
    *   [7.1 Entorno de trabajo](#Entorno_de_trabajo)
        *   [7.1.1 Bootsplash](#Bootsplash)
        *   [7.1.2 Intérpretes de comandos](#Intérpretes_de_comandos)
        ...
        *   [7.1.5 Gestores de ventanas](#Gestores_de_ventanas)
            ...
            *   [7.1.5.2 Gráficos](#Gráficos)
        *   [7.1.6 Basado en tiles (baldosas)](#Basado_en_tiles_(baldosas))
        ...
        *   [7.1.8 Aplicaciones de soporte](#Aplicaciones_de_soporte)
            *   [7.1.8.1 Gestores de inicio de sesión](#Gestores_de_inicio_de_sesión)
            *   [7.1.8.2 Gestores de composición de ventanas](#Gestores_de_composición_de_ventanas)
            *   [7.1.8.3 Barras de tareas / paneles / docks](#Barras_de_tareas_/_paneles_/_docks)
            *   [7.1.8.4 Lanzadores de aplicaciones](#Lanzadores_de_aplicaciones)
            *   [7.1.8.5 Diálogos de cierre de sesión](#Diálogos_de_cierre_de_sesión)
    *   [7.2 Finanzas](#Finanzas)
    *   [7.3 Gestión del tiempo](#Gestión_del_tiempo)
        *   [7.3.1 Consola](#Consola_15)
        *   [7.3.2 Entorno gráfico](#Entorno_gráfico)
...
*   **turses** — Cliente de Twitter para consola basado sobre [tyrs](https://aur.archlinux.org/packages/tyrs/) con muchas mejoras.
...
*   **[LibreOffice](/index.php/LibreOffice "LibreOffice")** — Fork de OpenOffice desarrollado muy activamente.
	...
	[https://www.libreoffice.org/](https://www.libreoffice.org/) || [libreoffice](https://www.archlinux.org/groups/x86_64/libreoffice/)

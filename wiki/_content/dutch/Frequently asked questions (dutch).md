...
*   [1 Algemeen](#Algemeen)
    ...
    *   [1.2 V) Waarom zou ik Arch Linux willen gebruiken?](#V)_Waarom_zou_ik_Arch_Linux_willen_gebruiken?)
    *   [1.3 V) Waarom zou ik Arch niet willen gebruiken?](#V)_Waarom_zou_ik_Arch_niet_willen_gebruiken?)
    *   [1.4 V) Op welke distributie is Arch gebaseerd?](#V)_Op_welke_distributie_is_Arch_gebaseerd?)
    *   [1.5 V) I ben helemaal nieuw op het gebied van GNU/Linux, is Arch dan iets voor mij?](#V)_I_ben_helemaal_nieuw_op_het_gebied_van_GNU/Linux,_is_Arch_dan_iets_voor_mij?)
    *   [1.6 V) Ik ken enkel Nederlands. Waarom is er zo weinig in het Nederlands te vinden?](#V)_Ik_ken_enkel_Nederlands._Waarom_is_er_zo_weinig_in_het_Nederlands_te_vinden?)
    *   [1.7 V) Arch heeft meer documentatie nodig](#V)_Arch_heeft_meer_documentatie_nodig)
    *   [1.8 V) Is Arch ontworpen om gebruikt te worden als server, desktop of workstation?](#V)_Is_Arch_ontworpen_om_gebruikt_te_worden_als_server,_desktop_of_workstation?)
    *   [1.9 V) Ik vind Arch echt leuk, maar de ontwikkelaars moet echt *"functie X"* implementeren](#V)_Ik_vind_Arch_echt_leuk,_maar_de_ontwikkelaars_moet_echt_"functie_X"_implementeren)
    *   [1.10 V) Wanneer wordt er een nieuwe uitgave van Arch uitgebracht?](#V)_Wanneer_wordt_er_een_nieuwe_uitgave_van_Arch_uitgebracht?)
    *   [1.11 V) Is Arch Linux een stabiele distributie? Gaan er vaak dingen kapot?](#V)_Is_Arch_Linux_een_stabiele_distributie?_Gaan_er_vaak_dingen_kapot?)
    *   [1.12 V) Arch heeft meer persaandacht nodig, zoals advertenties.](#V)_Arch_heeft_meer_persaandacht_nodig,_zoals_advertenties.)
    *   [1.13 V) Arch heeft minder aandacht nodig.](#V)_Arch_heeft_minder_aandacht_nodig.)
    *   [1.14 V) Arch heeft een bedrijfsachtergrond nodig.](#V)_Arch_heeft_een_bedrijfsachtergrond_nodig.)
    *   [1.15 V) Arch heeft meer ontwikkelaars nodig.](#V)_Arch_heeft_meer_ontwikkelaars_nodig.)
    *   [1.16 V) Waarom is Arch Linux zo traag? Programma's openen langzaam of zelfs helemaal niet!](#V)_Waarom_is_Arch_Linux_zo_traag?_Programma's_openen_langzaam_of_zelfs_helemaal_niet!)
    *   [1.17 V) Waarom gebruikt Arch al mijn RAM?](#V)_Waarom_gebruikt_Arch_al_mijn_RAM?)
*   [2 Pakket Beheer](#Pakket_Beheer)
    *   [2.1 Q) In welk pakket zit X?](#Q)_In_welk_pakket_zit_X?)
    *   [2.2 V) Ik heb een fout gevonden in pakket X. Wat moet ik nu doen?](#V)_Ik_heb_een_fout_gevonden_in_pakket_X._Wat_moet_ik_nu_doen?)
    *   [2.3 V) Archpakketten zouden een unieke naam moeten krijgen. .pkg.tar.gz is te lang en/of verwarrend.](#V)_Archpakketten_zouden_een_unieke_naam_moeten_krijgen._.pkg.tar.gz_is_te_lang_en/of_verwarrend.)
    *   [2.4 V) Pacman heeft een bibliotheek nodig, zodat andere toepassingen gemakkelijk pakketinformatie kunnen opvragen.](#V)_Pacman_heeft_een_bibliotheek_nodig,_zodat_andere_toepassingen_gemakkelijk_pakketinformatie_kunnen_opvragen.)
    *   [2.5 V) Waarom heeft pacman geen officiele grafische user interface?](#V)_Waarom_heeft_pacman_geen_officiele_grafische_user_interface?)
    *   [2.6 V) Arch heeft een stabiele tak nodig.](#V)_Arch_heeft_een_stabiele_tak_nodig.)
*   [3 Installatie](#Installatie)
    *   [3.1 V) Arch heeft een betere installer nodig. Misschien iets met een GUI?](#V)_Arch_heeft_een_betere_installer_nodig._Misschien_iets_met_een_GUI?)
    *   [3.2 V) Ik heb Arch geïnstalleerd en zit nu in een bash login! Wat nu?](#V)_Ik_heb_Arch_geïnstalleerd_en_zit_nu_in_een_bash_login!_Wat_nu?)
...
**A)** Kan best. Je tijd is welkom! Bezoek het forum, de chat, de mailinglijsten, en kijk wat er nog te doen is. Er is trouwens altijd vraag naar documentatie. Kijk naar [DocumentRequests](/index.php/DocumentRequests "DocumentRequests") voor de huidige vraag.

...
*   [3 Updating database](#Updating_database)
*   [4 Testing the software](#Testing_the_software)
*   [5 Scan for viruses](#Scan_for_viruses)
*   [6 Using the milter](#Using_the_milter)
*   [7 Troubleshooting](#Troubleshooting)
    *   [7.1 Error: Clamd was NOT notified](#Error:_Clamd_was_NOT_notified)
    *   [7.2 Error: No supported database files found](#Error:_No_supported_database_files_found)
    *   [7.3 Error: Can't create temporary directory](#Error:_Can.27t_create_temporary_directory)

...
**La [traducción](/index.php/ArchWiki:Contributing_(Espa%C3%B1ol)#Traducir_contenido "ArchWiki:Contributing (Español)") de este artículo o sección no refleja el texto original.**

**Motivos:** desactualizada ([Discusión](https://wiki.archlinux.org/index.php/Talk:Creating_packages_(Espa%C3%B1ol)))
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Creating_packages_(Español)&oldid=411561](https://wiki.archlinux.org/index.php?title=Creating_packages_(Español)&oldid=411561)"

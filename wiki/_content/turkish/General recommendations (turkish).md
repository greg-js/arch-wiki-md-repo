...
*   [Installation guide (Türkçe)](/index.php/Installation_guide_(T%C3%BCrk%C3%A7e) "Installation guide (Türkçe)")
...
*   [1 Sistem yönetimi](#Sistem_y.C3.B6netimi)
    *   [1.1 Kullanıcılar ve gruplar](#Kullan.C4.B1c.C4.B1lar_ve_gruplar)
    *   [1.2 Ayrıcalık yükseltme](#Ayr.C4.B1cal.C4.B1k_y.C3.BCkseltme)
    *   [1.3 Servis yönetimi](#Servis_y.C3.B6netimi)
    *   [1.4 Sistem bakımı](#Sistem_bak.C4.B1m.C4.B1)
*   [2 Paket yönetimi](#Paket_y.C3.B6netimi)
    *   [2.1 pacman](#pacman)
    *   [2.2 Depolar](#Depolar)
    *   [2.3 Yansımalar](#Yans.C4.B1malar)
...
Bu kısım sistem yönetimi ve idari görevlerin yönetimi hakkında ipuçları sunacaktır. Daha fazlası için, şunlara göz atın: [Çekirdek yardımcı programları](/index.php/Core_utilities "Core utilities") ve [Kategori:Sistem Yönetimi](/index.php/Category:System_administration "Category:System administration").

### Kullanıcılar ve gruplar

Yeni bir kurulum ile sadece ayrıca "root" olarak da bilinen [superuser](https://en.wikipedia.org/wiki/Superuser "wikipedia:Superuser") hesabına sahip olursunuz. Uzun süreler root olarak giriş yapmak, ya da [SSH](/index.php/SSH "SSH") aracılığıyla açığa vurmak, [güvensizdir](https://apple.stackexchange.com/questions/192365/is-it-ok-to-use-the-root-user-as-a-normal-user/192422#192422). Bunun yerine çoğu görev için yetkileri sınırlandırılmış kullanıcı hesabı oluşturmalısınız, root hesabını ise sadece sistem yönetimi için kullanmalsınız. Detaylar için: [Kullanıcılar ve gruplar#Kullanıcı yönetimi](/index.php/Users_and_groups#User_management "Users and groups").

Kullanıcılar ve gruplar *erişim kontrolü* için bir mekanizmadır; Yöneticiler kullanıcı ve servislerin sistem kaynaklarına erişimi kısıtlamak veya onaylamak için grup üyeliği ve sahipliğine ince ayar çekebilirler. Detaylar ve potansiyel güvenlik riskleri için [Users and groups](/index.php/Users_and_groups "Users and groups") makalesini okuyun.

### Ayrıcalık yükseltme

[su](/index.php/Su "Su") ve [sudo](/index.php/Sudo "Sudo") komutlarının amacı komutları başka bir kullanıcı olarak çalıştırmayı sağlar. Varsayılan olarak *su* sizi giriş kabuğuna root kullanıcısı olarak atar. *sudo* ise tek bir komut için geçici bir root ayrıcalığı sağlar. Aradaki farklılıklar için alakalı makaleleri okuyabilirsiniz.

### Servis yönetimi

Arch Linux [açılış](/index.php/Init "Init") işlemleri için [systemd](/index.php/Systemd "Systemd") kullanır. Bu Linux için bir sistem ve servis yöneticisidir. Arch Linux kurulumunuzu denetlemek için bunu öğrenmek iyi bir fikirdir. *systemd* ile etkileşimi *systemctl* komutu üzerinden yapmaktayız. Daha fazla bilgi için [systemd#Temel systemctl kullanımı](/index.php/Systemd#Basic_systemctl_usage "Systemd") kısmını okuyabilirsiniz.

### Sistem bakımı

Arch yuvarlanan sürümlü bir sistemdir ve seri bir paket devri vardır. Bu yüzden kullanıcıların [sistem bakımı](/index.php/System_maintenance "System maintenance") için zaman harcaması gerekmektedir. [Güvenlik](/index.php/Security "Security") kısmında sistemi kararlı tutmak adına en iyi pratikler ve önerilere ulaşabilirsiniz.

## Paket yönetimi

Bu kısım paket yönetimi ile alakalı yardımcı olabilecek bilgiler içerir. Daha fazlası için, [SSS#Paket Yönetimi](/index.php/FAQ#Package_management "FAQ") ve [Kategori:Paket yönetimi](/index.php/Category:Package_management "Category:Package management") sayfalarına göz atabilirsiniz.

**Note:** Arch Linux'da sistemi güncellemeden önce elle müdahale gerektiren değişiklikleri yapmak zorundasınız. Her güncelleme yapmadan önce [arch-announce mailing sistemi](https://mailman.archlinux.org/mailman/listinfo/arch-announce/)ne abone olun veya [Arch Linux ana sayfası](https://www.archlinux.org/)nı kontrol edin. Ayrıca, [RSS beslemesi](https://www.archlinux.org/feeds/news/)ne abone olmayı daha kullanışlı da bulabilirsiniz.

### pacman

[pacman](/index.php/Pacman "Pacman"), Arch Linux paket yöneticisidir: tüm kullanıcıların diğer makaleleri okumadan önce bunu tanıması gerekmektedir.

*pacman* ile etkileşimi artırmak için ve genel paket yönetimi için [pacman/İpuçları ve püf noktaları](/index.php/Pacman/Tips_and_tricks "Pacman/Tips and tricks") sayfasına göz atın.

### Depolar

Resmi olarak desteklenen depolar hakkında detaylı bilgi almak için [Resmi depolar](/index.php/Official_repositories "Official repositories") makalesine göz atabilirsiniz.

32-bit uygulamaları kullanmayı düşünüyorsanız, [multilib](/index.php/Multilib "Multilib") deposunu açmak isteyebilirsiniz.

[Gayriresmi kullanıcı depoları](/index.php/Unofficial_user_repositories "Unofficial user repositories") makalesi diğer desteklenmeyen depoları da içerir.

[pkgstats](/index.php/Pkgstats "Pkgstats") servisini yüklemeyi düşünebilirsiniz.

### Yansımalar

[Yansımalar](/index.php/Mirrors "Mirrors") makalesi üzerinden resmi depolar için en hızlı ve kullanışlı yansıma bağlantılarına ulaşabilirsiniz. Makalede belirtildiği üzere, rutin olarak [Yansıma Durumu](https://www.archlinux.org/mirrors/status/) sayfası üzerinden en son senkronize edilen yansımaların listesini kontrol etmenizi tavsiye ediyoruz.

...
*   [1 工具](#.E5.B7.A5.E5.85.B7)
    *   [1.1 分区工具](#.E5.88.86.E5.8C.BA.E5.B7.A5.E5.85.B7)
    *   [1.2 挂载](#.E6.8C.82.E8.BD.BD)
        *   [1.2.1 Udisks](#Udisks)
    *   [1.3 基本 Shell 命令](#.E5.9F.BA.E6.9C.AC_Shell_.E5.91.BD.E4.BB.A4)
    *   [1.4 集成式开发环境](#.E9.9B.86.E6.88.90.E5.BC.8F.E5.BC.80.E5.8F.91.E7.8E.AF.E5.A2.83)
    *   [1.5 虚拟终端](#.E8.99.9A.E6.8B.9F.E7.BB.88.E7.AB.AF)
        *   [1.5.1 基于 VTE](#.E5.9F.BA.E4.BA.8E_VTE)
        *   [1.5.2 KMS-based](#KMS-based)
        *   [1.5.3 framebuffer-based](#framebuffer-based)
    *   [1.6 文件](#.E6.96.87.E4.BB.B6)
        *   [1.6.1 文件管理器](#.E6.96.87.E4.BB.B6.E7.AE.A1.E7.90.86.E5.99.A8)
            *   [1.6.1.1 命令行](#.E5.91.BD.E4.BB.A4.E8.A1.8C)
            *   [1.6.1.2 图形环境](#.E5.9B.BE.E5.BD.A2.E7.8E.AF.E5.A2.83)
        *   [1.6.2 桌面搜索引擎](#.E6.A1.8C.E9.9D.A2.E6.90.9C.E7.B4.A2.E5.BC.95.E6.93.8E)
        *   [1.6.3 压缩与解压](#.E5.8E.8B.E7.BC.A9.E4.B8.8E.E8.A7.A3.E5.8E.8B)
            *   [1.6.3.1 命令行](#.E5.91.BD.E4.BB.A4.E8.A1.8C_2)
            *   [1.6.3.2 图形环境](#.E5.9B.BE.E5.BD.A2.E7.8E.AF.E5.A2.83_2)
        *   [1.6.4 文件合并及比较](#.E6.96.87.E4.BB.B6.E5.90.88.E5.B9.B6.E5.8F.8A.E6.AF.94.E8.BE.83)
        *   [1.6.5 批量命名](#.E6.89.B9.E9.87.8F.E5.91.BD.E5.90.8D)
    *   [1.7 磁盘清理](#.E7.A3.81.E7.9B.98.E6.B8.85.E7.90.86)
    *   [1.8 磁盘使用情况分析](#.E7.A3.81.E7.9B.98.E4.BD.BF.E7.94.A8.E6.83.85.E5.86.B5.E5.88.86.E6.9E.90)
    *   [1.9 时钟同步](#.E6.97.B6.E9.92.9F.E5.90.8C.E6.AD.A5)
    *   [1.10 系统监视器](#.E7.B3.BB.E7.BB.9F.E7.9B.91.E8.A7.86.E5.99.A8)
    *   [1.11 系统信息检测](#.E7.B3.BB.E7.BB.9F.E4.BF.A1.E6.81.AF.E6.A3.80.E6.B5.8B)
        *   [1.11.1 命令行](#.E5.91.BD.E4.BB.A4.E8.A1.8C_3)
        *   [1.11.2 图形环境](#.E5.9B.BE.E5.BD.A2.E7.8E.AF.E5.A2.83_3)
    *   [1.12 键盘布局切换](#.E9.94.AE.E7.9B.98.E5.B8.83.E5.B1.80.E5.88.87.E6.8D.A2)
    *   [1.13 电源管理](#.E7.94.B5.E6.BA.90.E7.AE.A1.E7.90.86)
    *   [1.14 剪贴板管理](#.E5.89.AA.E8.B4.B4.E6.9D.BF.E7.AE.A1.E7.90.86)
    *   [1.15 壁纸设置](#.E5.A3.81.E7.BA.B8.E8.AE.BE.E7.BD.AE)
    *   [1.16 软件包管理](#.E8.BD.AF.E4.BB.B6.E5.8C.85.E7.AE.A1.E7.90.86)
    *   [1.17 输入法](#.E8.BE.93.E5.85.A5.E6.B3.95)
...
[http://www.washington.edu/alpine](http://www.washington.edu/alpine) || [alpine](https://aur.archlinux.org/packages/alpine/)<sup><small>AUR</small></sup>
...
*   **Gnome Search Tool No Nautilus** — 去除了 [GNOME Files](/index.php/GNOME_Files "GNOME Files") 和 _gnome-desktop_ 的 _gnome-search-tool_
...
[http://www.peazip.org/peazip-linux.html](http://www.peazip.org/peazip-linux.html) || [peazip](https://aur.archlinux.org/packages/peazip/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): package not found]</sup>

*   **Squeeze** — 终端工具的次轻量级的前端.

[http://squeeze.xfce.org/](http://squeeze.xfce.org/) || [squeeze](https://aur.archlinux.org/packages/squeeze/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): package not found]</sup>
...
[http://kde.org/applications/development/kompare](http://kde.org/applications/development/kompare) || [kdesdk-kompare](https://www.archlinux.org/packages/?name=kdesdk-kompare)<sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): replaced by [kompare](https://www.archlinux.org/packages/?name=kompare)]</sup>
...
*   **[KSysGuard](https://en.wikipedia.org/wiki/KDE_System_Guard "wikipedia:KDE System Guard")** — 又名 KSysguard，是 [KDE (简体中文)](/index.php/KDE_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87) "KDE (简体中文)") 专用的任务管理器、性能监视器。

[http://userbase.kde.org/KSysGuard/](http://userbase.kde.org/KSysGuard/) || [kdebase-workspace](https://aur.archlinux.org/packages/kdebase-workspace/)<sup><small>AUR</small></sup>
...
[http://trayfreq.sourceforge.net](http://trayfreq.sourceforge.net) || [trayfreq](https://aur.archlinux.org/packages/trayfreq/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/trayfreq)]</sup>
...
[http://i-nex.linux.pl/](http://i-nex.linux.pl/) || [i-nex](https://aur.archlinux.org/packages/i-nex/)<sup><small>AUR</small></sup>
...
[http://adesklets.sourceforge.net/desklets.html](http://adesklets.sourceforge.net/desklets.html) || [aurnotify](https://aur.archlinux.org/packages/aurnotify/)<sup><small>AUR</small></sup><sup>[[broken link](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): archived in [aur-mirror](http://pkgbuild.com/git/aur-mirror.git/tree/aurnotify)]</sup>
...
[http://www.archlinux.fr/yaourt-en/](http://www.archlinux.fr/yaourt-en/) || [yaourt](https://aur.archlinux.org/packages/yaourt/)<sup><small>AUR</small></sup>
...
**Reason:** See also [find](/index.php/Find "Find") and [locate](/index.php/Locate "Locate"). (Discuss in [Talk:List of applications/Utilities (简体中文)#](https://wiki.archlinux.org/index.php/Talk:List_of_applications/Utilities_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87)))

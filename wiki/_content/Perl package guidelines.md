...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Perl_package_guidelines&oldid=400988](https://wiki.archlinux.org/index.php?title=Perl_package_guidelines&oldid=400988)"
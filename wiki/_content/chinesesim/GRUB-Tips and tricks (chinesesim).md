...
*   [1 GUI 配置工具](#GUI_.E9.85.8D.E7.BD.AE.E5.B7.A5.E5.85.B7)
*   [2 视觉配置](#.E8.A7.86.E8.A7.89.E9.85.8D.E7.BD.AE)
    *   [2.1 设置帧缓冲分辨率](#.E8.AE.BE.E7.BD.AE.E5.B8.A7.E7.BC.93.E5.86.B2.E5.88.86.E8.BE.A8.E7.8E.87)
...
GRUB 能够为它自己和内核设置帧缓存。老方法`vga=`已经过时。现在的方法是像下面的例子一样编辑`/etc/default/grub`：

...
*   [1 Configuration Tips](#Configuration_Tips)
    *   [1.1 更好的视频性能](#更好的视频性能)
    *   [1.2 添加或编辑 GDM 会话](#添加或编辑_GDM_会话)
    *   [1.3 调整/etc/hosts](#调整/etc/hosts)
*   [2 Misc Tips](#Misc_Tips)
    *   [2.1 锁定屏幕](#锁定屏幕)
    *   [2.2 在登录时解锁gnome密匙环](#在登录时解锁gnome密匙环)
    *   [2.3 GNOME Files Tips](#GNOME_Files_Tips)
        *   [2.3.1 改变浏览模式 (Spatial View)](#改变浏览模式_(Spatial_View))
    *   [2.4 加速面板的自动隐藏](#加速面板的自动隐藏)
    *   [2.5 GNOME Menu Tips](#GNOME_Menu_Tips)
        *   [2.5.1 加速菜单出现速度](#加速菜单出现速度)
        *   [2.5.2 编辑菜单](#编辑菜单)
            *   [2.5.2.1 用户菜单](#用户菜单)
            *   [2.5.2.2 用户组菜单, 系统菜单](#用户组菜单,_系统菜单)
        *   [2.5.3 Custom Icon](#Custom_Icon)
*   [3 有用的附加功能](#有用的附加功能)
    *   [3.1 FAM](#FAM)
    *   [3.2 GNOME系统监视器](#GNOME系统监视器)
    *   [3.3 在GNOME Files中烧录CD](#在GNOME_Files中烧录CD)
    *   [3.4 GNOME系统工具](#GNOME系统工具)
    *   [3.5 Gdesklets:桌面小部件](#Gdesklets:桌面小部件)
*   [4 其他应用程序](#其他应用程序)

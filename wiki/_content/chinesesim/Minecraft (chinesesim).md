...
*   [1 客户端](#客户端)
    *   [1.1 安装](#安装)
    *   [1.2 局域网防火墙配置](#局域网防火墙配置)
*   [2 服务器](#服务器)
    *   [2.1 安装](#安装_2)
    *   [2.2 设置](#设置)
        *   [2.2.1 介绍](#介绍)
        *   [2.2.2 启动服务器](#启动服务器)
        *   [2.2.3 服务器管理脚本](#服务器管理脚本)
        *   [2.2.4 调整](#调整)
    *   [2.3 可替代服务器](#可替代服务器)
        *   [2.3.1 Spigot ( 区别于 Craftbukkit)](#Spigot_(_区别于_Craftbukkit))
        *   [2.3.2 Cuberite](#Cuberite)
    *   [2.4 额外说明](#额外说明)
*   [3 Minecraft mod 启动器](#Minecraft_mod_启动器)
*   [4 其它程序和编辑器](#其它程序和编辑器)
*   [5 故障排除](#故障排除)
    *   [5.1 Minecraft 服务器运行在 ARM 设备](#Minecraft_服务器运行在_ARM_设备)
    *   [5.2 Minecraft 客户端和 Wayland 支持](#Minecraft_客户端和_Wayland_支持)
    *   [5.3 Minecraft 客户端或服务器无法启动](#Minecraft_客户端或服务器无法启动)
*   [6 参见](#参见)
...
另请参阅 [#可替代服务器](#可替代服务器) 以了解其他可替代服务器。
...
确保你阅读了 [#设置](#设置) 部分，并且将 `minecraftd` 替换为 `spigot` 无论你在哪使用时。
...
确保你阅读了 [#设置](#设置) 部分，并且将 `minecraftd` 替换为 `cuberite` 无论你在哪使用时。
...
*   务必定期备份，比如，使用提供地管理脚本 (参见 [#介绍](#介绍)) 或者 [rsync](/index.php/Rsync "Rsync")。

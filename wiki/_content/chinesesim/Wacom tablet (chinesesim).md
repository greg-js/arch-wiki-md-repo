...
*   [2 配置](#配置)
    *   [2.1 常用概念](#常用概念)
        ...
        *   [2.1.3 更改方向](#更改方向)
        *   [2.1.4 重映射按钮](#重映射按钮)
            *   [2.1.4.1 获取按钮ID](#获取按钮ID)
            *   [2.1.4.2 语法](#语法)
            *   [2.1.4.3 示例](#示例)
            *   [2.1.4.4 执行自定义命令](#执行自定义命令)
        *   [2.1.5 LEDs](#LEDs)
        *   [2.1.6 TwinView设置](#TwinView设置)
            *   [2.1.6.1 临时TwinView设置](#临时TwinView设置)
        *   [2.1.7 Xrandr设置](#Xrandr设置)
    *   [2.2 压力曲线](#压力曲线)
    *   [2.3 力量比例](#力量比例)
    *   [2.4 使用kcm-wacomtablet](#使用kcm-wacomtablet)
*   [3 针对特定应用程序的配置](#针对特定应用程序的配置)
    *   [3.1 Blender](#Blender)
    *   [3.2 GIMP](#GIMP)
...
你也可以通过打开 [gimp](https://www.archlinux.org/packages/?name=gimp) 或者 [xournal](https://aur.archlinux.org/packages/xournal/) 测试设备，并且检查扩展输入设备部分（extended input devices section），或者任何数位板相关的配置是否被你选择的软件支持。

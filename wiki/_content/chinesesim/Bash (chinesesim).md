...
*   [1 调用](#调用)
    *   [1.1 登录外壳](#登录外壳)
    *   [1.2 交互式外壳](#交互式外壳)
    *   [1.3 符合 POSIX](#符合_POSIX)
    *   [1.4 传统模式](#传统模式)
*   [2 配置](#配置)
    *   [2.1 配置文件在启动时的引用顺序](#配置文件在启动时的引用顺序)
    *   [2.2 外壳和环境变量](#外壳和环境变量)
*   [3 命令行](#命令行)
*   [4 别名](#别名)
*   [5 函数](#函数)
*   [6 提示与技巧](#提示与技巧)
    *   [6.1 自定义提示符](#自定义提示符)
    *   [6.2 自动命令补全](#自动命令补全)
        *   [6.2.1 高级的补全方法](#高级的补全方法)
        *   [6.2.2 更快的补全操作](#更快的补全操作)
    *   [6.3 命令未找到时的钩子拓展(HOOKS)](#命令未找到时的钩子拓展(HOOKS))
    *   [6.4 终端中禁用 Ctrl+z](#终端中禁用_Ctrl+z)
    *   [6.5 登出后清空屏幕](#登出后清空屏幕)
    *   [6.6 ASCII的艺术, fortunes和cowsay](#ASCII的艺术,_fortunes和cowsay)
    *   [6.7 ASCII历史日历](#ASCII历史日历)
    *   [6.8 修正窗口大小调整时的换行](#修正窗口大小调整时的换行)
    *   [6.9 Bash历史补全](#Bash历史补全)
*   [7 资源](#资源)

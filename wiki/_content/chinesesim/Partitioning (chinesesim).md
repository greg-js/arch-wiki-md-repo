...
*   [1 分区表](#分区表)
    *   [1.1 Master Boot Record](#Master_Boot_Record)
        *   [1.1.1 分区表](#分区表_2)
        *   [1.1.2 引导记录](#引导记录)
    *   [1.2 GUID 分区表](#GUID_分区表)
    *   [1.3 选择 GPT 还是 MBR](#选择_GPT_还是_MBR)
    *   [1.4 Btrfs 分区](#Btrfs_分区)
    *   [1.5 备份](#备份)
    *   [1.6 恢复](#恢复)
*   [2 分区方案](#分区方案)
    *   [2.1 单root分区](#单root分区)
    ...
    *   [2.3 挂载点](#挂载点)
        ...
        *   [2.3.6 /data](#/data)
    *   [2.4 布局示例](#布局示例)
        *   [2.4.1 UEFI/GPT 示例](#UEFI/GPT_示例)
        *   [2.4.2 MBR/BIOS 示例](#MBR/BIOS_示例)
        *   [2.4.3 UEFI 带单独的 /home](#UEFI_带单独的_/home)
*   [3 分区工具](#分区工具)
    *   [3.1 fdisk/gdisk](#fdisk/gdisk)

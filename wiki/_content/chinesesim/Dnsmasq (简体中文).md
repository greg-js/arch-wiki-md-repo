**翻译状态：** 本文是英文页面 [Dnsmasq](/index.php/Dnsmasq "Dnsmasq") 的[翻译](/index.php/ArchWiki_Translation_Team_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87) "ArchWiki Translation Team (简体中文)")，最后翻译时间：2015-10-25，点击[这里](https://wiki.archlinux.org/index.php?title=Dnsmasq&diff=0&oldid=406967)可以查看翻译后英文页面的改动。

Dnsmasq 提供 DNS 缓存和 DHCP 服务功能。作为域名解析服务器(DNS)，dnsmasq可以通过缓存 DNS 请求来提高对访问过的网址的连接速度。作为DHCP 服务器，[dnsmasq](https://www.archlinux.org/packages/?name=dnsmasq) 可以用于为局域网电脑分配内网ip地址和提供路由。DNS和DHCP两个功能可以同时或分别单独实现。dnsmasq轻量且易配置，适用于个人用户或少于50台主机的网络。此外它还自带了一个 [PXE](/index.php/PXE "PXE") 服务器。

## Contents

*   [1 安装](#.E5.AE.89.E8.A3.85)
*   [2 DNS 缓存设置](#DNS_.E7.BC.93.E5.AD.98.E8.AE.BE.E7.BD.AE)
    *   [2.1 DNS 地址文件](#DNS_.E5.9C.B0.E5.9D.80.E6.96.87.E4.BB.B6)
        *   [2.1.1 resolv.conf](#resolv.conf)
            *   [2.1.1.1 三个以上域名服务器](#.E4.B8.89.E4.B8.AA.E4.BB.A5.E4.B8.8A.E5.9F.9F.E5.90.8D.E6.9C.8D.E5.8A.A1.E5.99.A8)
        *   [2.1.2 使用dhcpcd](#.E4.BD.BF.E7.94.A8dhcpcd)
        *   [2.1.3 使用dhclient](#.E4.BD.BF.E7.94.A8dhclient)
    *   [2.2 使用NetworkManager](#.E4.BD.BF.E7.94.A8NetworkManager)
        *   [2.2.1 IPv6](#IPv6)
        *   [2.2.2 其他方式](#.E5.85.B6.E4.BB.96.E6.96.B9.E5.BC.8F)
*   [3 DHCP 服务器设置](#DHCP_.E6.9C.8D.E5.8A.A1.E5.99.A8.E8.AE.BE.E7.BD.AE)
*   [4 启动守护进程](#.E5.90.AF.E5.8A.A8.E5.AE.88.E6.8A.A4.E8.BF.9B.E7.A8.8B)
*   [5 测试](#.E6.B5.8B.E8.AF.95)
    *   [5.1 DNS 缓存](#DNS_.E7.BC.93.E5.AD.98)
    *   [5.2 DHCP 服务器](#DHCP_.E6.9C.8D.E5.8A.A1.E5.99.A8)
*   [6 小技巧](#.E5.B0.8F.E6.8A.80.E5.B7.A7)
    *   [6.1 避免 OpenDNS 重定向 Google 请求](#.E9.81.BF.E5.85.8D_OpenDNS_.E9.87.8D.E5.AE.9A.E5.90.91_Google_.E8.AF.B7.E6.B1.82)
    *   [6.2 查看租约](#.E6.9F.A5.E7.9C.8B.E7.A7.9F.E7.BA.A6)
    *   [6.3 添加自定义域](#.E6.B7.BB.E5.8A.A0.E8.87.AA.E5.AE.9A.E4.B9.89.E5.9F.9F)

...
*   [1 安装](#安装)
    *   [1.1 Greeter](#Greeter)
*   [2 启用 LightDM](#启用_LightDM)
*   [3 命令行工具](#命令行工具)
*   [4 测试](#测试)
*   [5 配置和调整](#配置和调整)
    *   [5.1 更改背景图片/颜色](#更改背景图片/颜色)
        *   [5.1.1 GTK+ greeter](#GTK+_greeter)
        *   [5.1.2 Webkit2 greeter](#Webkit2_greeter)
        *   [5.1.3 Unity greeter](#Unity_greeter)
        *   [5.1.4 KDE greeter](#KDE_greeter)
    *   [5.2 改变你的头像](#改变你的头像)
    *   [5.3 Arch 为中心的 64x64 图标来源](#Arch_为中心的_64x64_图标来源)
    *   [5.4 启用自动登录](#启用自动登录)
    *   [5.5 启用无密码交互登录](#启用无密码交互登录)
    *   [5.6 隐藏系统和服务用户](#隐藏系统和服务用户)
    *   [5.7 从 SLiM 迁移](#从_SLiM_迁移)
    *   [5.8 默认打开小键盘](#默认打开小键盘)
    *   [5.9 Xfce4 下多用户切换](#Xfce4_下多用户切换)
    *   [5.10 默认会话](#默认会话)
    *   [5.11 修改登录窗口的位置](#修改登录窗口的位置)
        *   [5.11.1 GTK+ greeter](#GTK+_greeter_2)
*   [6 疑难问题](#疑难问题)
    *   [6.1 显示错误语言环境](#显示错误语言环境)
    *   [6.2 Xresources 未被正常解析](#Xresources_未被正常解析)
    *   [6.3 使用 GTK greeter 丢失图标](#使用_GTK_greeter_丢失图标)
    *   [6.4 LightDM 在登录提示符处冻结](#LightDM_在登录提示符处冻结)
    *   [6.5 LigthDM 显示在错误的显示器上](#LigthDM_显示在错误的显示器上)
    *   [6.6 LightDM 不出现](#LightDM_不出现)
    *   [6.7 Pulseaudio 不自动启动](#Pulseaudio_不自动启动)
*   [7 另见](#另见)

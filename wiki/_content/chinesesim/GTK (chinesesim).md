...
{{注意|使用上述配置，需要安装软件包[ttf-dejavu](https://www.archlinux.org/packages/?name=ttf-dejavu)、[tangerine-icon-theme](https://aur.archlinux.org/packages/tangerine-icon-theme/)、[gtk-engine-murrine](https://www.archlinux.org/packages/?name=gtk-engine-murrine)以及[AUR](/index.php/AUR_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87) "AUR (简体中文)")中的[gtk-theme-murrine-collection](https://aur.archlinux.org/packages/gtk-theme-murrine-collection/).

**翻译状态：** 本文是英文页面 [Kodi](/index.php/Kodi "Kodi") 的[翻译](/index.php/ArchWiki_Translation_Team_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87) "ArchWiki Translation Team (简体中文)")，最后翻译时间：2015-08-19，点击[这里](https://wiki.archlinux.org/index.php?title=Kodi&diff=0&oldid=390745)可以查看翻译后英文页面的改动。

**Note:** XBMC rebranded to Kodi starting with the version 14 release.

Kodi is a free, [open source (GPL)](http://www.gnu.org/copyleft/gpl.html) multimedia player that originally ran on the first-generation [XBox](https://en.wikipedia.org/wiki/Microsoft_Xbox "wikipedia:Microsoft Xbox"), (not the newer Xbox 360), and now runs on devices running Linux, Mac OS X, Windows, Android and iOS. Kodi can be used to play/view the most popular video, audio, and picture formats, and many more lesser-known formats, including:
...
*   [3 提示和技巧](#.E6.8F.90.E7.A4.BA.E5.92.8C.E6.8A.80.E5.B7.A7)
    ...
    *   [3.6 使用 ALSA](#.E4.BD.BF.E7.94.A8_ALSA)
...
To use LightDM with automatic login, see [LightDM#Enabling autologin](/index.php/LightDM#Enabling_autologin "LightDM"). *Kodi* includes `kodi.desktop` as [xsession](/index.php/Xsession "Xsession").
...
**Tip:** This example sets-up read-only exports. See [exports(5)](https://jlk.fjfi.cvut.cz/arch/manpages/man/exports.5) for additional options and configurations.
...
*   [Install](/index.php/Pacman "Pacman") the *kodi-rbp* package instead of *kodi* from the [Arch Linux ARM repository](http://archlinuxarm.org/packages).
...
*   [http://superrepo.org/](http://superrepo.org/) - xbmc插件库
*   [http://www.hdpfans.com/thread-329076-1-1.html](http://www.hdpfans.com/thread-329076-1-1.html) - Kodi/xbmc中文插件库安装方法

...
*   [5 疑难解答](#.E7.96.91.E9.9A.BE.E8.A7.A3.E7.AD.94)
    *   [5.1 在 F2FS 分区上使用GRUB](#.E5.9C.A8_F2FS_.E5.88.86.E5.8C.BA.E4.B8.8A.E4.BD.BF.E7.94.A8GRUB)

## 创建 F2FS 分区

创建 F2FS 分区，首先 [安装](/index.php/Install "Install") 软件包 [f2fs-tools](https://www.archlinux.org/packages/?name=f2fs-tools).

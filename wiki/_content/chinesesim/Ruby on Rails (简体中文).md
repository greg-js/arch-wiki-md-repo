...
**Note:** It is possible that your Nginx installation has not come with an init script; check your /etc/rc.d/ directory for a file called _nginx_, if that is your case manually create it.

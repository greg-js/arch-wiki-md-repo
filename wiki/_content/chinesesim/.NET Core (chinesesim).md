**翻译状态：** 本文是英文页面 [.NET Core](/index.php/.NET_Core ".NET Core") 的[翻译](/index.php/ArchWiki_Translation_Team_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87) "ArchWiki Translation Team (简体中文)")，最后翻译时间：2018-05-05，点击[这里](https://wiki.archlinux.org/index.php?title=.NET+Core&diff=0&oldid=506776)可以查看翻译后英文页面的改动。

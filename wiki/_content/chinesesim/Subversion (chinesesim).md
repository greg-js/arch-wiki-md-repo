...
*   [1 用于Subversion安装的Apache服务器](#用于Subversion安装的Apache服务器)
    *   [1.1 目标](#目标)
    *   [1.2 安装Apache](#安装Apache)
    *   [1.3 安装Subversion](#安装Subversion)
    *   [1.4 配置 Subversion](#配置_Subversion)
        *   [1.4.1 创建一个目录](#创建一个目录)
        *   [1.4.2 编辑 httpd.conf](#编辑_httpd.conf)
        *   [1.4.3 用不用SSL？](#用不用SSL？)
        *   [1.4.4 创建/home/svn/.svn-policy-file](#创建/home/svn/.svn-policy-file)
        *   [1.4.5 创建/home/svn/.svn-auth-file](#创建/home/svn/.svn-auth-file)
        *   [1.4.6 创建源码库](#创建源码库)
        *   [1.4.7 设置权限](#设置权限)
    *   [1.5 创建项目](#创建项目)
        *   [1.5.1 项目的目录结构](#项目的目录结构)
        *   [1.5.2 将源码添加到目录](#将源码添加到目录)
        *   [1.5.3 导入项目](#导入项目)
        *   [1.5.4 测试SVN检出](#测试SVN检出)
*   [2 安装Svnserve](#安装Svnserve)
    *   [2.1 安装软件包](#安装软件包)
    *   [2.2 创建源码库](#创建源码库_2)
    *   [2.3 设置访问策略](#设置访问策略)
    *   [2.4 启动服务器守护进程](#启动服务器守护进程)
*   [3 Subversion备份](#Subversion备份)
*   [4 Subversion 客户端](#Subversion_客户端)

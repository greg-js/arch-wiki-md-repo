...
Openbox 是一个轻量级、可高度定制以及支持大量标准的窗口管理器。它的特性在 [官方网站](http://openbox.org/wiki/Main_Page) 有详细的文档说明。这篇文章是关于在 Arch Linux 下 运行 Openbox。

## Contents

*   [1 安装](#安装)
*   [2 升级到 Openbox 3.5](#升级到_Openbox_3.5)
*   [3 Openbox 作为一个单独的窗口管理器](#Openbox_作为一个单独的窗口管理器)
*   [4 Openbox 作为在桌面环境使用的窗口管理器](#Openbox_作为在桌面环境使用的窗口管理器)
    *   [4.1 GNOME 2.24 和 2.26](#GNOME_2.24_和_2.26)
...
*   [7 菜单](#菜单)
    ...
    *   [7.6 基于 Python 的 xdg 菜单脚本](#基于_Python_的_xdg_菜单脚本)
    *   [7.7 Openbox 菜单生成器](#Openbox_菜单生成器)
...
*   [8 启动程序](#启动程序)
    ...
    *   [8.3 自启动目录](#自启动目录)
*   [9 主题和外观](#主题和外观)
    *   [9.1 Openbox 主题](#Openbox_主题)
    *   [9.2 鼠标指针,图标,壁纸](#鼠标指针,图标,壁纸)
*   [10 提示与技巧](#提示与技巧)
    *   [10.1 Aero snap 特效](#Aero_snap_特效)
    *   [10.2 文件关联](#文件关联)
    *   [10.3 复制粘贴](#复制粘贴)
    *   [10.4 窗口透明](#窗口透明)
    *   [10.5 程序的 Xprop 值](#程序的_Xprop_值)
        *   [10.5.1 Xprop for Firefox](#Xprop_for_Firefox)
    *   [10.6 链接菜单到按键](#链接菜单到按键)
    *   [10.7 在背景的 Urxvt](#在背景的_Urxvt)
        *   [10.7.1 ToggleShowDesktop 例外](#ToggleShowDesktop_例外)
    *   [10.8 键盘音量控制](#键盘音量控制)
*   [11 其他资源](#其他资源)
...
这四个文件组成了 Openbox 配置的基础。每一个文件是配置的独立的部分，它们的功能是：
	...
	本文件定义了在桌面用鼠标击键时显示的菜单。它定义了程序启动器和快捷方式。请看 [#菜单](#菜单) 段。

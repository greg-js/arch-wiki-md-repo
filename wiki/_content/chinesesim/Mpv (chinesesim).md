...
*   [1 安装](#安装)
    *   [1.1 前端](#前端)
*   [2 配置](#配置)
    *   [2.1 一个示例 input.conf 文件](#一个示例_input.conf_文件)
*   [3 提示和技巧](#提示和技巧)
    *   [3.1 硬件编码](#硬件编码)
    *   [3.2 高品质视频输出](#高品质视频输出)
    *   [3.3 自动恢复上次停止的地方](#自动恢复上次停止的地方)
    *   [3.4 音量太小](#音量太小)
    *   [3.5 快速循环多重纵横比](#快速循环多重纵横比)
    *   [3.6 从根窗口绘制](#从根窗口绘制)
    *   [3.7 总是显示图形界面](#总是显示图形界面)
    *   [3.8 作为浏览器插件使用](#作为浏览器插件使用)
    *   [3.9 使用Lua脚本让mpv作为音乐播放器](#使用Lua脚本让mpv作为音乐播放器)
    *   [3.10 Twitch.tv streaming over mpv](#Twitch.tv_streaming_over_mpv)
    *   [3.11 使用youtube-dl 并选择格式](#使用youtube-dl_并选择格式)
    *   [3.12 youtube-dl audio with search](#youtube-dl_audio_with_search)
    *   [3.13 使用mpv与合成器](#使用mpv与合成器)
*   [4 Vapoursynth](#Vapoursynth)
    *   [4.1 Debanding (flash3kyuu)](#Debanding_(flash3kyuu))

...
*   [2 运行](#运行)
    ...
    *   [2.2 手动](#手动)
*   [3 配置](#配置)
    *   [3.1 使用 .conf 文件](#使用_.conf_文件)
    *   [3.2 使用 xorg.conf](#使用_xorg.conf)
*   [4 输入设备](#输入设备)
*   [5 显示器设置](#显示器设置)
    *   [5.1 开始](#开始)
    *   [5.2 多个显示器](#多个显示器)
        *   [5.2.1 多于一个显卡](#多于一个显卡)
    *   [5.3 显示大小和 DPI](#显示大小和_DPI)
        *   [5.3.1 手动设置DPI](#手动设置DPI)
            *   [5.3.1.1 专有的NVIDIA驱动程序](#专有的NVIDIA驱动程序)
    *   [5.4 DPMS](#DPMS)
...
| AMD / ATI | 开源 | [xf86-video-amdgpu](https://www.archlinux.org/packages/?name=xf86-video-amdgpu) | [mesa](https://www.archlinux.org/packages/?name=mesa) | [lib32-mesa](https://www.archlinux.org/packages/?name=lib32-mesa) | [AMDGPU](/index.php/AMDGPU "AMDGPU") |
...
| [nvidia-340xx](https://aur.archlinux.org/packages/nvidia-340xx/) | [nvidia-340xx-utils](https://aur.archlinux.org/packages/nvidia-340xx-utils/) | [lib32-nvidia-340xx-utils](https://aur.archlinux.org/packages/lib32-nvidia-340xx-utils/) |

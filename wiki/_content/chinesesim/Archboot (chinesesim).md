...
*   [3 Archboot的发布](#Archboot的发布)
    ...
    *   [3.5 历史](#历史)
    *   [3.6 与正式发布的区别](#与正式发布的区别)
    *   [3.7 设置特性](#设置特性)
    *   [3.8 启动参数](#启动参数)
        *   [3.8.1 通用启动参数](#通用启动参数)
        *   [3.8.2 视频和framebuffer 选项](#视频和framebuffer_选项)
    *   [3.9 问题, Known Issues and limitations](#问题,_Known_Issues_and_limitations)
    *   [3.10 UEFI 参考](#UEFI_参考)
    *   [3.11 Bugs](#Bugs)
*   [4 链接](#链接)
*   [5 Usbstick 恢复](#Usbstick_恢复)
*   [6 建立镜像文件](#建立镜像文件)
    *   [6.1 如何建立Archboot Allinone ISO](#如何建立Archboot_Allinone_ISO)
        *   [6.1.1 前提条件](#前提条件)
        *   [6.1.2 建立archboot chroots](#建立archboot_chroots)
        *   [6.1.3 安装和更新archboot](#安装和更新archboot)
        *   [6.1.4 生成镜像](#生成镜像)

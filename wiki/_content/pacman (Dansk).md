...
<td style="text-align: left; padding: 3px">Pacman er Arch Linux' pakkehåndtering. Pakkehåndtering benyttes til at installere, opdatere og fjerne software. Denne artikel dækker grundlæggende brug og fejlsøgning.</td>

</tr>

<tr style="text-align: center; height: 1.5em; border-bottom: 5px #08c solid;">

<th style="background: #333; color: white; padding: 2px;">**Den danske forside her på wiki**</th>

</tr>

<tr>

<td style="text-align: left; padding: 3px">[Main Page (Dansk)](/index.php/Main_Page_(Dansk) "Main Page (Dansk)")</td>
...
**Reason:** please use the first argument of the template to provide a brief explanation. (Discuss in [Talk:Pacman (Dansk)#](https://wiki.archlinux.org/index.php/Talk:Pacman_(Dansk)))
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Pacman_(Dansk)&oldid=413287](https://wiki.archlinux.org/index.php?title=Pacman_(Dansk)&oldid=413287)"

[Categories](/index.php/Special:Categories "Special:Categories"):

*   [Dansk](/index.php/Category:Dansk "Category:Dansk")
*   [Package management (Dansk)](/index.php/Category:Package_management_(Dansk) "Category:Package management (Dansk)")
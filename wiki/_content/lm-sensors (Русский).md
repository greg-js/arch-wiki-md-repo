...
*   [kdeutils-superkaramba](https://www.archlinux.org/packages/?name=kdeutils-superkaramba)<sup>[[ссылка недействительна](/index.php/ArchWiki:Requests#Broken_package_links "ArchWiki:Requests"): package not found]</sup> - Superkaramba позволяет создавать различные виджеты для [KDE](/index.php/KDE_(%D0%A0%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9) "KDE (Русский)"). См. примеры на [karamba section on kde-look.org](http://www.kde-look.org/index.php?xcontentmode=38)
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Lm-sensors_(Русский)&oldid=413344](https://wiki.archlinux.org/index.php?title=Lm-sensors_(Русский)&oldid=413344)"

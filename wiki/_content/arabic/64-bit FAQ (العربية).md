...
مستودعات التطبيقات للمعماريتين متصلة ببعضها وكل الأمور وإلى حد كبير ستسير على ما يرام كما هو متوقع لها. في حالات نادرة تكون الحزم القديمة في مستودعات [AUR](/index.php/Arch_User_Repository "Arch User Repository") تدعم فقط أنظمة `'i686'` أي 32 بت، ولكن عادة ما تعمل هذه الحزم على 64 بت أيضاً، فقط قم بإضافة `'x86_64'`
...
هذه التطبيقات كانت تسبب إشكالية سابقاً ولكنها الآن أصبحت متوفرة في مستودعات [AUR](/index.php/Arch_User_Repository "Arch User Repository") وتعمل بشكل جيد.

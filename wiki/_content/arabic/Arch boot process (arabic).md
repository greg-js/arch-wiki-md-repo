...
*   [1 محمل الإقلاع Bootloader](#محمل_الإقلاع_Bootloader)
*   [2 النواة](#النواة)
*   [3 نظام ملفات الذاكرة الابتدائي initramfs](#نظام_ملفات_الذاكرة_الابتدائي_initramfs)
*   [4 Init process العملية الأم](#Init_process_العملية_الأم)
*   [5 انظر أيضًا](#انظر_أيضًا)
...
بعد أن يتم تحميل النواة الى الذاكرة , تقوم النواة بفك ضغط [initramfs](/index.php/Initramfs "Initramfs") (اختصار للعبارة Initial RAM filesystem) الذي يُصبح نظام تشغيل الملفات الإبتدائي للمجلد الجذر , وبعد ذلك تقوم النواة بتنفيذ`/init` كأول عملية . بعد ذلك تبدأ مرحلة فضاءالمستخدم *early userspace* .

...
*   [1 التثبيت](#التثبيت)
    ...
    *   [1.2 التثبيت الأدنى](#التثبيت_الأدنى)
    *   [1.3 حزمة اللغة](#حزمة_اللغة)
*   [2 الترقية](#الترقية)
*   [3 بدء كدي](#بدء_كدي)
    *   [3.1 استخدام مدير عرض](#استخدام_مدير_عرض)
        *   [3.1.1 KDM (مدير عرض كدي)](#KDM_(مدير_عرض_كدي))
    *   [3.2 استخدام xinitrc](#استخدام_xinitrc)
*   [4 الضبط](#الضبط)
    *   [4.1 التخصيص](#التخصيص)
        *   [4.1.1 سطح مكتب بلازما](#سطح_مكتب_بلازما)
            *   [4.1.1.1 السمات](#السمات)
            *   [4.1.1.2 الودجات](#الودجات)
            *   [4.1.1.3 بريمج الصوت في صينية النظام](#بريمج_الصوت_في_صينية_النظام)
            *   [4.1.1.4 إضافة قائمة Global إلى سطح المكتب](#إضافة_قائمة_Global_إلى_سطح_المكتب)
        *   [4.1.2 زخارف النوافذ](#زخارف_النوافذ)
        *   [4.1.3 سمات الأيقونات](#سمات_الأيقونات)
        *   [4.1.4 الخطوط](#الخطوط)
            *   [4.1.4.1 الخطوط في كدي تبدو رديئة](#الخطوط_في_كدي_تبدو_رديئة)
            *   [4.1.4.2 الخطوط ضخمة أو تبدو غير متناسبة](#الخطوط_ضخمة_أو_تبدو_غير_متناسبة)
        *   [4.1.5 كفاءة المساحة](#كفاءة_المساحة)
    *   [4.2 الشبكة](#الشبكة)
    *   [4.3 الطباعة](#الطباعة)
    *   [4.4 دعم سامبا/ويندوز](#دعم_سامبا/ويندوز)
    *   [4.5 أنشطة سطح مكتب كدي](#أنشطة_سطح_مكتب_كدي)
    *   [4.6 حفظ الطاقة](#حفظ_الطاقة)
    *   [4.7 مراقبة التغييرات على الملفات والمجلدات المحلية](#مراقبة_التغييرات_على_الملفات_والمجلدات_المحلية)
*   [5 إدارة النظام](#إدارة_النظام)
    *   [5.1 ضبط لوحة المفاتيح](#ضبط_لوحة_المفاتيح)
    *   [5.2 إنهاء خدمة Xorg عبر إعدادات نظام كدي](#إنهاء_خدمة_Xorg_عبر_إعدادات_نظام_كدي)
    *   [5.3 وحدة الضبط لِكدي](#وحدة_الضبط_لِكدي)
*   [6 بحث سطح المكتب وسطح المكتب الدلالي (Semantic desktop)](#بحث_سطح_المكتب_وسطح_المكتب_الدلالي_(Semantic_desktop))
    *   [6.1 Virtuoso و Soprano](#Virtuoso_و_Soprano)
    *   [6.2 نبومك](#نبومك)
        *   [6.2.1 استخدام نبومك وضبطه](#استخدام_نبومك_وضبطه)
        *   [6.2.2 كدي دون نبومك](#كدي_دون_نبومك)
    *   [6.3 أكوندا](#أكوندا)
        *   [6.3.1 تعطيل أكوندا](#تعطيل_أكوندا)
        *   [6.3.2 ضبط قاعدة البيانات](#ضبط_قاعدة_البيانات)
        *   [6.3.3 تشغيل كدي دون أكوندا](#تشغيل_كدي_دون_أكوندا)
*   [7 فونون](#فونون)
    *   [7.1 ما فونون؟](#ما_فونون؟)
    *   [7.2 أيَّ سند ( backend) عليَّ استخدامه؟](#أيَّ_سند_(_backend)_عليَّ_استخدامه؟)
*   [8 تطبيقات مفيدة](#تطبيقات_مفيدة)
    *   [8.1 Yakuake](#Yakuake)
    *   [8.2 كدي تيليباثي](#كدي_تيليباثي)
*   [9 تلميحات وخُدَع](#تلميحات_وخُدَع)
    *   [9.1 استخدام أوبن بوكس في كدي](#استخدام_أوبن_بوكس_في_كدي)
        *   [9.1.1 عند استخدام KDM](#عند_استخدام_KDM)
        *   [9.1.2 إعادة تمكين تأثيرات التركيب](#إعادة_تمكين_تأثيرات_التركيب)
    *   [9.2 تكامل أندرويد مع سطح المكتب كدي](#تكامل_أندرويد_مع_سطح_المكتب_كدي)
    *   [9.3 الحصول على الإخطارات لتحديثات البرمجيات](#الحصول_على_الإخطارات_لتحديثات_البرمجيات)
    *   [9.4 ضبط KWin لاستخدام OpenGL ES](#ضبط_KWin_لاستخدام_OpenGL_ES)
    *   [9.5 تمكن مصغّرات الصوت مع مديريّ الملفات كنكر/دولفين](#تمكن_مصغّرات_الصوت_مع_مديريّ_الملفات_كنكر/دولفين)
    *   [9.6 تمكن مصغّرات الفيديو مع مديريّ الملفات كنكر/دولفين](#تمكن_مصغّرات_الفيديو_مع_مديريّ_الملفات_كنكر/دولفين)
    *   [9.7 تسريع بدء تشغيل التطبيق](#تسريع_بدء_تشغيل_التطبيق)
    *   [9.8 إخفاء الأقسام](#إخفاء_الأقسام)
    *   [9.9 نصائح كنكر](#نصائح_كنكر)
        *   [9.9.1 تعطيل تلميحات المفتاح الذكي (المتصفّح)](#تعطيل_تلميحات_المفتاح_الذكي_(المتصفّح))
        *   [9.9.2 استخدام عُدَّة الوِب](#استخدام_عُدَّة_الوِب)
    *   [9.10 التكامل مع فَيَرفُكس](#التكامل_مع_فَيَرفُكس)
    *   [9.11 تعيين خلفية حافظة الشاشة إلى نفس الحالية](#تعيين_خلفية_حافظة_الشاشة_إلى_نفس_الحالية)
    *   [9.12 تعيين خلفية شاشة القفل إلى صورة arbitrary](#تعيين_خلفية_شاشة_القفل_إلى_صورة_arbitrary)
...
[مكّن/ابدأ](/index.php/Systemd_(%D8%A7%D9%84%D8%B9%D8%B1%D8%A8%D9%8A%D8%A9)#استخدام_الوحدات "Systemd (العربية)") `kdm.service` لبدء مدير العرض.
...
طالع [فَيَرفُكس](/index.php/Firefox_(%D8%A7%D9%84%D8%B9%D8%B1%D8%A8%D9%8A%D8%A9)#التكامل_مع_KDE "Firefox (العربية)").

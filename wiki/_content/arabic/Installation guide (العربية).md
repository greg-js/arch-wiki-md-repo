...
[ويكي آرتش](/index.php/Main_Page_(%D8%A7%D9%84%D8%B9%D8%B1%D8%A8%D9%8A%D8%A9) "Main Page (العربية)") الذي يشرف عليه المجتمع هو مورد ممتاز ويجب مراجعته للمشاكل أولًا. قناة [آي‌آر‌سي](https://en.wikipedia.org/wiki/IRC "wikipedia:IRC") ([irc://irc.freenode.net/#archlinux](irc://irc.freenode.net/#archlinux) )، و[المنتديات](https://bbs.archlinux.org/) متوفّران أيضًا للإجابة إن لم تحصل عليها من أي مكان آخر. أيضًا، تأكّد من مراجعة صفحات `man` لأي أمر تجده غريب، يمكن تنفيذ ذلك بسهولة عبر `man _الأمر_`.
...
*   الصور موقّع عليها، لذا ينصح بشِدّة التحقق من التوقيع قبل استخدامها: يمكن فعل ذلك بتنزيل ملف ".sig" من صفحة التنزيل (أو واحد من المرايا المُسردة هناك) إلى نفس الدليل كملف ".iso" واستخدام `pacman-key -v _iso-file_.sig`.
...
| [xf86-video-nv](https://www.archlinux.org/packages/?name=xf86-video-nv) | – | (تعريف أثري (قديم)) |

| **ملخص**  |
| نظرة عامة على الأدوات المنتشرة بين المستخدمين لتعديل النظام الفرعي لـ [CPUfreq](http://www.kernel.org/pub/linux/utils/kernel/cpufreq/cpufreq-info.html) الخاص بالنواة kernel. |
| **مواضيع متصلة** |

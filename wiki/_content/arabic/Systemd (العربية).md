...
تمثّل الأداة `systemctl` الأمر الرّئيسي للتّبحّر و التّحكم بـ systemd . بعض من استخداماته فحص حالة النظام وإدارته بالإضافة لإدارة الخدمات. انظر `man 1 systemctl` لمزيد من التّفاصيل.
...
See `man journalctl`, `systemd.journal-fields` or Lennert's [blog post](http://0pointer.de/blog/projects/journalctl.html) for details.

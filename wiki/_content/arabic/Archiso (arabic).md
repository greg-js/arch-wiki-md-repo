...
*   [1 الإعداد](#الإعداد)
*   [2 إعداد القرص الحي](#إعداد_القرص_الحي)
    *   [2.1 تنصيب الحزم](#تنصيب_الحزم)
    *   [2.2 إضافة مستخدم](#إضافة_مستخدم)
    *   [2.3 إضافة ملفات إلى صورة القرص الحي](#إضافة_ملفات_إلى_صورة_القرص_الحي)
    *   [2.4 aitab](#aitab)
    *   [2.5 محمل الإقلاع](#محمل_الإقلاع)
    *   [2.6 مدير تسجيل الدخول](#مدير_تسجيل_الدخول)
*   [3 بناء ملف ISO](#بناء_ملف_ISO)
*   [4 استخدام ملف ISO](#استخدام_ملف_ISO)
    *   [4.1 CD](#CD)
    *   [4.2 USB](#USB)
...
إذا كنت تستخدم نمط *releng* لإنشاء قرص كامل التخصيص يجب عليك الانتقال الى الخطوة [#إعداد القرص الحي](#إعداد_القرص_الحي). أما إذا كنت تستخدم نمط *baseline* لإنشاء قرص حي بسيط , لذا فإنك لا تحتاج الى أي تعديلات او تخصيصات و يمكنك مباشرة الإنتقال الى الخطوة [#بناء ملف ISO](#بناء_ملف_ISO).
...
يُفضل تنصيب "rsync" إذا أردت تنصيب النظام الذي تُريد إنشاؤه في وقت لاحق دون الحاجة الى وجود اتصال بالإنترنت أو لتجاوز خطوة إعادة تحميل الحزم مرة اخرى .([#التنصيب](#التنصيب))

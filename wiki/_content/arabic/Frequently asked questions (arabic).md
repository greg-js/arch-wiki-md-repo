...
بما أن عملية التثبيت لا تحدث كثيراً (إقرأ ما تبقى من هذه المقالة لمعرفة المزيد عن مفهوم الإصدار المتدحرج) فهي لا تشكل أولوية كبيرة لدى المطورين أو المستخدمين، تم تحديث دليل التثبيت [Installation guide](/index.php/Installation_guide "Installation guide")

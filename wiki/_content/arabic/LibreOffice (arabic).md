...
*   [1 ليبر أوفيس في آرتش لينكس](#ليبر_أوفيس_في_آرتش_لينكس)
*   [2 التثبيت](#التثبيت)
*   [3 السمة](#السمة)
    *   [3.1 سمات فَيَرفُكس](#سمات_فَيَرفُكس)
    *   [3.2 تعطيل شعار البدء](#تعطيل_شعار_البدء)
*   [4 إدارة الامتدادات](#إدارة_الامتدادات)
*   [5 مساعدات اللغة](#مساعدات_اللغة)
    *   [5.1 المدقّق الإملائي](#المدقّق_الإملائي)
    *   [5.2 قواعد الواصلة](#قواعد_الواصلة)
    *   [5.3 المترادفات](#المترادفات)
    *   [5.4 المدقّق النحوي](#المدقّق_النحوي)
    *   [5.5 مساعدة الإنجليزية الأمريكية (en-US) دون الإنترنت](#مساعدة_الإنجليزية_الأمريكية_(en-US)_دون_الإنترنت)
*   [6 تثبيت وحدات الماكرو](#تثبيت_وحدات_الماكرو)
*   [7 تسريع ليبر أوفيس](#تسريع_ليبر_أوفيس)
*   [8 إصلاح المشاكل](#إصلاح_المشاكل)
    *   [8.1 إنابة (استبدال) الخطوط](#إنابة_(استبدال)_الخطوط)
    *   [8.2 إزالة التسنّن (التنعيم)](#إزالة_التسنّن_(التنعيم))
    *   [8.3 التجمّد عند استخدام مشاركات NFSv3](#التجمّد_عند_استخدام_مشاركات_NFSv3)
    *   [8.4 إصلاح خطأ هيكل جاڤا](#إصلاح_خطأ_هيكل_جاڤا)
    *   [8.5 لا يكتشف ليبر أوفيس الشهادات](#لا_يكتشف_ليبر_أوفيس_الشهادات)
    *   [8.6 تشغيل ملفات .pps في وضع التحرير (دون العرض التقديمي)](#تشغيل_ملفات_.pps_في_وضع_التحرير_(دون_العرض_التقديمي))
    *   [8.7 مشاكل المَصَادر](#مشاكل_المَصَادر)
    *   [8.8 دعم الوسائط](#دعم_الوسائط)
    *   [8.9 لا يتغيّر حجم المحتوى في النوافذ مع Xfwm4](#لا_يتغيّر_حجم_المحتوى_في_النوافذ_مع_Xfwm4)
...
إن اعتزمت استخدام وحدات الماكرو، يجب أن تكون لديك بيئة تشغيل جاڤا ممكّنة. هناك بيئة تشغيل جاڤا ممكّنة افتراضيًّا، لكن تعطيلها [يسرّع البرنامج](#تسريع_ليبر_أوفيس).

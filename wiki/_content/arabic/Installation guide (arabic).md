...
*   [1 التنزيل](#التنزيل)
*   [2 التثبيت](#التثبيت)
    *   [2.1 تخطيط لوحة المفاتيح](#تخطيط_لوحة_المفاتيح)
    *   [2.2 تقسيم الأقراص](#تقسيم_الأقراص)
    *   [2.3 تهيئة الأقسام](#تهيئة_الأقسام)
    *   [2.4 ضمّ الأقراص](#ضمّ_الأقراص)
    *   [2.5 الاتصال بالإنترنت](#الاتصال_بالإنترنت)
        *   [2.5.1 الشبكة اللاسلكية](#الشبكة_اللاسلكية)
    *   [2.6 تثبيت أساس النظام](#تثبيت_أساس_النظام)
    *   [2.7 ضبط النظام](#ضبط_النظام)
    *   [2.8 تثبيت وضبط محمّل الإقلاع](#تثبيت_وضبط_محمّل_الإقلاع)
    *   [2.9 إزالة الضمّ وإعادة التشغيل](#إزالة_الضمّ_وإعادة_التشغيل)
*   [3 ما بعدَ التثبيت](#ما_بعدَ_التثبيت)
    *   [3.1 إدارة المستخدمين](#إدارة_المستخدمين)
    *   [3.2 إدارة الحزم](#إدارة_الحزم)
    *   [3.3 إدارة الخدمات](#إدارة_الخدمات)
    *   [3.4 الصوت](#الصوت)
    *   [3.5 تعريف الفيديو](#تعريف_الفيديو)
    *   [3.6 خادم العرض](#خادم_العرض)
    *   [3.7 الخطوط](#الخطوط)
*   [4 ملحق](#ملحق)
...
طالع [pacman](/index.php/Pacman_(%D8%A7%D9%84%D8%B9%D8%B1%D8%A8%D9%8A%D8%A9) "Pacman (العربية)") و [إدارة الحزم](/index.php/FAQ_(%D8%A7%D9%84%D8%B9%D8%B1%D8%A8%D9%8A%D8%A9)#إدارة_الحزم "FAQ (العربية)") للإجابات حول تثبيت، تحديث وإدارة الحزم.

### إدارة الخدمات

تستخدم آرتش لينكس [systemd](/index.php/Systemd "Systemd") كمُمهِّد (init)، الذي يكون مدير نظام وخدمات لِلينكس. لصيانة تثبيت آرتش لينكس لديك، ستكون فكرة جيّدة أن تتعلّم الأساسيات حولها. يتمّ التفاعل مع systemd بالأمر `systemctl`. اقرأ [الاستخدام الأوّلي لأداة systemctl](/index.php/Systemd_(%D8%A7%D9%84%D8%B9%D8%B1%D8%A8%D9%8A%D8%A9)#الاستخدام_الأوّلي_لأداة_systemctl "Systemd (العربية)") لمزيدٍ من المعلومات.

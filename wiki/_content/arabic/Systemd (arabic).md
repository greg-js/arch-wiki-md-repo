...
*   [2 التثبيت](#التثبيت)
    *   [2.1 معلومات إضافية](#معلومات_إضافية)
*   [3 الإعدادات الأصلية](#الإعدادات_الأصلية)
    *   [3.1 الطرفية الافتراضية](#الطرفية_الافتراضية)
    *   [3.2 ساعة العتاد](#ساعة_العتاد)
        *   [3.2.1 ساعة العتاد بالتوقيت المحلّي](#ساعة_العتاد_بالتوقيت_المحلّي)
    *   [3.3 وحدات النّواة](#وحدات_النّواة)
        *   [3.3.1 الوحدات الإضافية المعدّة للتحميل مع الإقلاع](#الوحدات_الإضافية_المعدّة_للتحميل_مع_الإقلاع)
        *   [3.3.2 إعداد خيارات الوحدات](#إعداد_خيارات_الوحدات)
        *   [3.3.3 الحظر](#الحظر)
    *   [3.4 وصل نظام الملفات](#وصل_نظام_الملفات)
        *   [3.4.1 الوصل التلقائي](#الوصل_التلقائي)
        *   [3.4.2 إدارة الأقسام المنطقية ( LVM )](#إدارة_الأقسام_المنطقية_(_LVM_))
    *   [3.5 إدارة الطاقة ( من خلال البوابة المتقدمة ACPI )](#إدارة_الطاقة_(_من_خلال_البوابة_المتقدمة_ACPI_))
        *   [3.5.1 المُعَلِّقات](#المُعَلِّقات)
            *   [3.5.1.1 ملفات خدمات التّعليق و الاستكمال](#ملفات_خدمات_التّعليق_و_الاستكمال)
            *   [3.5.1.2 الملف المُجَمَّع لخدمات التعليق و الاستكمال](#الملف_المُجَمَّع_لخدمات_التعليق_و_الاستكمال)
            *   [3.5.1.3 المُعَلِّقات في /usr/lib/systemd/system-sleep](#المُعَلِّقات_في_/usr/lib/systemd/system-sleep)
    *   [3.6 الملفات المؤقّتة](#الملفات_المؤقّتة)
    *   [3.7 الوحدات](#الوحدات)
*   [4 الاستخدام الأوّلي لأداة systemctl](#الاستخدام_الأوّلي_لأداة_systemctl)
    *   [4.1 تحليل حالة النظام](#تحليل_حالة_النظام)
    *   [4.2 استخدام الوحدات](#استخدام_الوحدات)
    *   [4.3 إدارة الطّاقة](#إدارة_الطّاقة)
*   [5 تشغيل المُخدّمات الرسومية في systemd](#تشغيل_المُخدّمات_الرسومية_في_systemd)
    *   [5.1 استخدام مدير الولوج systemd-logind](#استخدام_مدير_الولوج_systemd-logind)
*   [6 كتابة ملفات تخصصية بتنسيق .service](#كتابة_ملفات_تخصصية_بتنسيق_.service)
    *   [6.1 استنباط الاعتماديّات](#استنباط_الاعتماديّات)
    *   [6.2 النوع](#النوع)
    *   [6.3 تحرير ملفات الوحدات المضافة](#تحرير_ملفات_الوحدات_المضافة)
    *   [6.4 تسليط الضوء على بناء الوحدات بواسطة Vim](#تسليط_الضوء_على_بناء_الوحدات_بواسطة_Vim)
*   [7 الأهداف](#الأهداف)
    *   [7.1 الأهداف الحالية](#الأهداف_الحالية)
    *   [7.2 إنشاء هدف معيّن](#إنشاء_هدف_معيّن)
    *   [7.3 جدولة الاهداف](#جدولة_الاهداف)
    *   [7.4 تغيير الهدف الحالي](#تغيير_الهدف_الحالي)
    *   [7.5 تغيير الهدف الافتراضي للإقلاع من خلاله](#تغيير_الهدف_الافتراضي_للإقلاع_من_خلاله)
*   [8 الدّوريّات](#الدّوريّات)
    *   [8.1 تنقيح المُخرجات](#تنقيح_المُخرجات)
    *   [8.2 الحجم الأقصى للدّورية](#الحجم_الأقصى_للدّورية)
    *   [8.3 الترابط بين مدير الدّوريات journald و سجل النظام syslog](#الترابط_بين_مدير_الدّوريات_journald_و_سجل_النظام_syslog)
*   [9 التّحسين](#التّحسين)
    *   [9.1 تحليل عملية الإقلاع](#تحليل_عملية_الإقلاع)
        *   [9.1.1 استخدام أداة التحليل systemd-analyze](#استخدام_أداة_التحليل_systemd-analyze)
        *   [9.1.2 استخدام راسم خريطة الإقلاع systemd-bootchart](#استخدام_راسم_خريطة_الإقلاع_systemd-bootchart)
        *   [9.1.3 المرحلة الثانية من رسم خريطة الإقلاع](#المرحلة_الثانية_من_رسم_خريطة_الإقلاع)
*   [10 استكشاف الاخطاء و إصلاحها](#استكشاف_الاخطاء_و_إصلاحها)
    *   [10.1 الوقت الطّويل لإيقاف أو إعادة التّشغيل](#الوقت_الطّويل_لإيقاف_أو_إعادة_التّشغيل)
    *   [10.2 عدم وجود مُخرجات للتطبيقات قصيرة العُمر](#عدم_وجود_مُخرجات_للتطبيقات_قصيرة_العُمر)
    *   [10.3 تشخيص مشاكل الإقلاع](#تشخيص_مشاكل_الإقلاع)
    *   [10.4 تعطيل التطبيقات مسببة الانهيار](#تعطيل_التطبيقات_مسببة_الانهيار)
*   [11 انظر أيضًا](#انظر_أيضًا)

## تحضيرات قبل التحوّل

*   اقرأ [بعض المعلومات](http://freedesktop.org/wiki/Software/systemd/) عن systemd.
*   لاحظ أن حقيقة systemd أنه نظام **دوريّ** التسجيل يقوم مقام أداة **syslog** ، ومع ذلك يمكن لهما أن يتعايشا معًا . راجع [الدّوريّات](#الدّوريّات) أدناه .
